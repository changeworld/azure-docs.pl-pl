---
title: Zarządzanie usługą Azure Database for PostgreSQL — witryna Azure portal
description: Dowiedz się, jak zarządzać usługą Azure Database dla serwera PostgreSQL z witryny Azure portal.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="manage-an-azure-database-for-postgresql-server-using-the-azure-portal"></a>Zarządzanie usługą Azure Database dla serwera PostgreSQL przy użyciu portalu Azure
W tym artykule pokazano, jak zarządzać usługą Azure Database dla serwerów PostgreSQL. Zadania zarządzania obejmują skalowanie danych obliczeniowych i magazynowania, resetowanie hasła administratora oraz wyświetlanie szczegółów serwera.

## <a name="sign-in"></a>Logowanie
Zaloguj się do [Portalu Azure](https://portal.azure.com).

## <a name="create-a-server"></a>Tworzenie serwera
Odwiedź [przewodnik Szybki start,](quickstart-create-server-database-portal.md) aby dowiedzieć się, jak utworzyć i rozpocząć korzystanie z serwera usługi Azure Database for PostgreSQL.
...
- Dowiedz się więcej o [opcjach dostrajania i monitorowania w usłudze Azure Database for PostgreSQL](concepts-monitoring.md)
