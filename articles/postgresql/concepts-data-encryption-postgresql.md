...
description: Azure Database for PostgreSQL szyfrowanie danych na jednym serwerze z kluczem zarządzanym przez klienta
author: kummanish
ms.author: manishku
...
Key Vault administrator może również [włączyć rejestrowanie zdarzeń inspekcji Key Vault](https://docs.microsoft.com/azure/azure-monitor/insights/azure-key-Vault), aby mogły być później poddane inspekcji.
