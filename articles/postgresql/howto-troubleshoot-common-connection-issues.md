---
title: Rozwiązywać problemy z połączeniem do usługi Azure Database for PostgreSQL | Dokumentacja firmy Microsoft
...
* Konfiguracja zapory: — Azure Database for postgresql w warstwie serwera lub klienta zapory blokuje połączenia.
