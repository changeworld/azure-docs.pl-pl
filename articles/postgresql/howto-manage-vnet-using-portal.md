---
title: Twórz i Zarządzaj punktami końcowymi usługi sieci wirtualnej i regułami w Azure Database for PostgreSQL-pojedynczym serwerze przy użyciu Azure Portal
