...
- **Administrator bazy danych:** &nbsp; zaktualizowanie listy kontroli dostępu (ACL) w celu dodania danej podsieci do serwera Azure Database for PostgreSQL.
