...
* Funkcja nie może używać funkcji [Reference](resource-group-template-functions-resource.md#reference) ani żadnej z funkcji [list](resource-group-template-functions-resource.md#list) .
