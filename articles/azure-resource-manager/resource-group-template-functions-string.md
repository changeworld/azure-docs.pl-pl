...
| wartość właściwości totalLength |Yes |int |Całkowita liczba znaków w zwracanym ciągu. |
...
| Name (Nazwa) | Typ | Wartość |
| ---- | ---- | ----- |
| objectOutput | Ciąg | {"Wartośća": 10, "Wartośćb": "Przykład Text"} |
