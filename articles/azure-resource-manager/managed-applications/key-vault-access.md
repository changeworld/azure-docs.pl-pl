...
Aby przekazać klucz tajny z Key Vault do szablonu w aplikacji zarządzanej, należy użyć [połączonego szablonu](../templates/linked-templates.md) i odwołać się do Key Vault w parametrach dla połączonego szablonu. Podaj identyfikator zasobu Key Vault i nazwę wpisu tajnego.
