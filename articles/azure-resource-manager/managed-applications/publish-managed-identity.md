...
---|---|---
authorizationAudience | *znaleziono* | Identyfikator URI identyfikatora aplikacji dla zasobu docelowego. Jest to również `aud` (grupy odbiorców) wystawionego tokenu. Wartość domyślna to "https://management.azure.com/"
...
authorizationAudience | `aud` (odbiorcy) żądanie tokenu dostępu. Jest to takie samo, jak podane w żądaniu `listTokens`.
