...
* [Visual Studio Code](https://code.visualstudio.com/) z [rozszerzeniem narzędzi Menedżer zasobów Tools](./resource-manager-quickstart-create-templates-use-visual-studio-code.md#prerequisites).
