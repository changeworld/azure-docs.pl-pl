...
Aby przetestować wartości szablonu oraz parametrów bez faktycznego wdrażania zasobów, użyj [zweryfikować wdrożenie grupy az](/cli/azure/group/deployment#az_group_deployment_validate). 
