...
Aby uzyskać pełne informacje o limicie przydziału, zobacz [limity subskrypcji i usług platformy Azure, przydziały i ograniczenia](../azure-subscription-service-limits.md).
...
3. Wybierz **użycie i przydziały**
   ...
   ![Wybierz użycie i przydziały](./media/resource-manager-quota-errors/select-usage-quotas.png)

4. W prawym górnym rogu wybierz pozycję **Zwiększ liczbę żądań**.

   ![Zwiększ liczbę żądań](./media/resource-manager-quota-errors/request-increase.png)
