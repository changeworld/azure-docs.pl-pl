...
## <a name="batch-ai"></a>Usługa Batch — sztuczna inteligencja
| Typ zasobu | Obsługa tagów |
| ------------- | ----------- |
| Klastry | Yes | 
| zadania | Yes | 
| fileservers | Yes | 
| obszary robocze | Yes | 
| obszary robocze/klaster | Nie | 
| obszary robocze/fileservers | Nie | 
| obszary robocze/eksperymentów | Nie | 
| obszary robocze/eksperymentów/zadań | Nie | 
