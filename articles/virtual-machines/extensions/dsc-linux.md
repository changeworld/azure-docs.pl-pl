---
title: Rozszerzenie DSC platformy Azure dla systemu Linux | Dokumentacja firmy Microsoft
...
Rozszerzenie DSC w systemie Linux obsługuje wszystkie [rozszerzenia obsługiwane systemu operacyjnego](https://azurewiki.cloudapp.netVMAgentExtension/extensionSupportedOSs) z wyjątkiem:

| Dystrybucja | Wersja |
|---|---|
| CentOS Linux | 6,5 lub nowszy |
| Ubuntu| 12.04 LTS, 14.04 LTS, 16.04 LTS  |
| RHEL| 6,5 lub nowszy  |
| openSUSE| 13.1 lub nowszy  |
| SUSE Linux Enterprise Server| 11 z dodatkiem SP3 lub nowszy  |
