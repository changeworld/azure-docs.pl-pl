...
# Rozpoczęcie pracy
## [Tworzenie maszyny wirtualnej przy użyciu witryny Azure Portal](tutorial-classic.md)
## [Logowanie do maszyny wirtualnej](connect-logon-classic.md)
...
## Sieć
### [Jak konfigurować punkty końcowe](setup-endpoints.md)
### [Łączenie maszyn wirtualnych z siecią wirtualną lub usługą w chmurze](connect-vms-classic.md)
...
### [Konfigurowanie zestawu dostępności](configure-availability-classic.md)
### [Zmienianie rozmiaru maszyny wirtualnej z systemem Windows utworzonej w klasycznym modelu wdrażania](resize-vm-classic.md)
