...
Można utworzyć wiele maszyn wirtualnych w tej samej usłudze w chmurze. Aby dowiedzieć się, w tym scenariuszu maszyn wirtualnych, zobacz [jak połączyć maszyny wirtualne z siecią wirtualną lub chmurze usługą](/previous-versions/azure/virtual-machines/windows/classic/connect-vms-classic#connect-vms-in-a-standalone-cloud-service). Ten scenariusz jest, gdy klientowi na jednej maszynie wirtualnej próbuje połączyć się z programu SQL Server uruchomionego na innej maszynie wirtualnej w tej samej usłudze w chmurze.
