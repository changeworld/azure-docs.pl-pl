...
description: W tym temacie opisano sposób uruchamiania skryptów w przypadku maszyn wirtualnych systemu Windows
services: automation
...
[Niestandardowe rozszerzenie skryptu](../extensions/custom-script-windows.md) jest używany głównie do wdrożenia po instalacji konfigurację i oprogramowanie.
