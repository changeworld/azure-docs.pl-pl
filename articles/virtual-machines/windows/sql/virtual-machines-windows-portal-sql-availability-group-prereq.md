...
Na każdej maszynie Wirtualnej serwera SQL Skonfiguruj konto usługi programu SQL Server. Korzystanie z kont, które zostały utworzone, kiedy użytkownik [skonfigurowany kont domeny](#DomainAccounts).
