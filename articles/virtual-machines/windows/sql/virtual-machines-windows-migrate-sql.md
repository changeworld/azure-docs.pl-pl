...
---
# <a name="migrate-a-sql-server-database-to-sql-server-in-an-azure-vm"></a>Migrowanie bazy danych SQL Server do programu SQL Server na maszynie wirtualnej dla platformy Azure
