...
Analiza porównawcza to proces symulowania różnych obciążeń w aplikacji i pomiaru wydajności aplikacji dla każdego obciążenia. Wykonując kroki opisane w [artykule projektowanie dla wysokiej wydajności,](premium-storage-performance.md)zebrano wymagania dotyczące wydajności aplikacji. Uruchamiając narzędzia do analizy porównawczej na maszynach wirtualnych obsługujących aplikację, można określić poziomy wydajności, które aplikacja może osiągnąć za pomocą magazynu w wersji Premium. W tym artykule przedstawiamy przykłady analizy porównawczej standardowej maszyny wirtualnej DS14 aprowizowana za pomocą dysków usługi Azure Premium Storage.
