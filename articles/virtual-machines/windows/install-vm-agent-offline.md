...
### <a name="use-the-provisionguestagent-property-for-classic-vms"></a>Użyj właściwości ProvisionGuestAgent klasycznych maszyn wirtualnych
...
- [Omówienie usługi Azure agenta maszyny wirtualnej](../extensions/agent-windows.md)
