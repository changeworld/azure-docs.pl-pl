---
title: Azure Windows rozmiarów maszyn wirtualnych — Storage | Dokumentacja firmy Microsoft
description: Wyświetla listę rozmiarów różnych zoptymalizowane pod kątem magazynu dostępnymi dla maszyn wirtualnych Windows na platformie Azure. Wyświetla informacje o liczbie procesorów wirtualnych, dysków z danymi i kart sieciowych, a także magazynu przepustowości przepływność i sieci dla rozmiarów w tej serii.
