---
title: Często zadawane pytania dotyczące maszyn wirtualnych z systemem Windows na platformie Azure | Microsoft Docs
...
## <a name="what-can-i-run-on-an-azure-vm"></a>Co można uruchomić na maszynie wirtualnej platformy Azure?
Wszyscy subskrybenci mogą uruchamiać oprogramowanie serwera na maszynie wirtualnej platformy Azure. Aby uzyskać informacje na temat zasad pomocy technicznej dotyczących uruchamiania oprogramowania serwera firmy Microsoft na platformie Azure, zobacz [Microsoft Server Software Support for Azure Virtual Machines](https://support.microsoft.com/kb/2721672).

Niektóre wersje systemów Windows 7, Windows 8.1 i Windows 10 są dostępne dla subskrybentów korzyści MSDN platformy Azure oraz MSDN — Tworzenie i testowanie — płatność zgodnie z rzeczywistym użyciem. Aby uzyskać szczegółowe informacje, w tym instrukcje i ograniczenia, zobacz [obrazy klienta systemu Windows dla subskrybentów MSDN](https://azure.microsoft.com/blog/2014/05/29/windows-client-images-on-azure/). 

## <a name="how-much-storage-can-i-use-with-a-virtual-machine"></a>Ile miejsca do magazynowania można użyć z maszyną wirtualną?
Każdy dysk z danymi może mieć do 32 767 GiB. Liczba dysków z danymi, których można użyć, zależy od rozmiaru maszyny wirtualnej. Aby uzyskać szczegółowe informacje, zobacz [rozmiary dla Virtual Machines](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
Konta usługi Azure Storage mogą również udostępniać magazyn dla dysku systemu operacyjnego i dysków z danymi. Każdy dysk jest plikiem VHD przechowywanym jako stronicowy obiekt BLOB. Aby uzyskać szczegółowe informacje o cenach, zobacz [szczegóły cennika usługi Storage](https://azure.microsoft.com/pricing/details/storage/).
...
Nie używaj dysku tymczasowego do przechowywania danych. Jest to tylko magazyn tymczasowy, więc ryzyko utraty danych, których nie można odzyskać. Utrata danych może wystąpić, gdy maszyna wirtualna zostanie przeniesiona do innego hosta. Zmianę rozmiarów maszyny wirtualnej, aktualizowanie hosta lub awaria sprzętu na hoście to przyczyny, które mogą zostać przeniesione przez maszynę wirtualną.

Jeśli masz aplikację, która musi korzystać z litery D: dysku, możesz ponownie przypisać litery dysku, aby dysk tymczasowy używał czegoś innego niż D:. Aby uzyskać instrukcje, zobacz [zmiana litery dysku tymczasowego dysku systemu Windows](change-drive-letter.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json).


## <a name="how-can-i-change-the-drive-letter-of-the-temporary-disk"></a>Jak mogę zmienić literę dysku dysku tymczasowego?
Można zmienić literę dysku, przenosząc plik stronicowania i ponownie przypisując litery dysku, ale należy upewnić się, że kroki są wykonywane w określonej kolejności. Aby uzyskać instrukcje, zobacz [zmiana litery dysku tymczasowego dysku systemu Windows](change-drive-letter.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json).
...
Tak. Nazwa komputera może zawierać maksymalnie 15 znaków. Zobacz [reguły nazewnictwa i ograniczenia,](/azure/cloud-adoption-framework/ready/considerations/naming-and-tagging#sample-naming-convention) Aby uzyskać więcej informacji na temat nazywania zasobów.

## <a name="are-there-any-resource-group-name-requirements"></a>Czy istnieją jakieś wymagania dotyczące nazw grup zasobów?
Tak. Nazwa grupy zasobów może zawierać maksymalnie 90 znaków. Aby uzyskać więcej informacji na temat grup zasobów [, zobacz Reguły nazewnictwa i ograniczenia](/azure/cloud-adoption-framework/ready/considerations/naming-and-tagging#resource-naming) .
