...
Tak. Nazwa komputera może zawierać maksymalnie 15 znaków. Zobacz [reguły nazewnictwa i ograniczenia,](/azure/architecture/best-practices/naming-conventions#compute) Aby uzyskać więcej informacji na temat nazywania zasobów.

## <a name="are-there-any-resource-group-name-requirements"></a>Czy istnieją jakieś wymagania dotyczące nazw grup zasobów?
Tak. Nazwa grupy zasobów może zawierać maksymalnie 90 znaków. Aby uzyskać więcej informacji na temat grup zasobów [, zobacz Reguły nazewnictwa i ograniczenia](/azure/architecture/best-practices/naming-conventions#naming-rules-and-restrictions) .
