---
title: Uruchamianie skryptów w maszynie Wirtualnej systemu Linux platformy Azure
...
[Rozszerzenia niestandardowego skryptu](../extensions/custom-script-linux.md) jest używany głównie dla wpisu wdrożenia Konfiguracja i Instalacja oprogramowania.
