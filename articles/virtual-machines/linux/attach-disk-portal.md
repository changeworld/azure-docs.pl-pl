...
### <a name="partion-a-new-disk"></a>Partion nowy dysk
...
Użyj `fdisk` partycji dysku, stał się podstawowym dysku na partycji 1 i zaakceptuj ustawienia domyślne. Poniższy przykład rozpoczyna się `fdisk` proces */dev/sdc*:
