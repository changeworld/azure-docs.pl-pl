---
title: Wdróż niezarządzaną ofertę portalu OpenShift na platformie Azure | Microsoft Docs
description: Wdróż niezarządzaną ofertę portalu OpenShift na platformie Azure.
...
ms.locfileid: "70091910"
---
# <a name="configure-prerequisites"></a>Konfigurowanie wymagań wstępnych

Przed rozpoczęciem korzystania z oferty portalu Marketplace w celu wdrożenia samozarządzanego klastra platformy kontenerów OpenShift na platformie Azure należy skonfigurować kilka wymagań wstępnych.  Przeczytaj artykuł dotyczący [wymagań wstępnych OpenShift](https://docs.microsoft.com/azure/virtual-machines/linux/openshift-prerequisites) , aby uzyskać instrukcje dotyczące tworzenia klucza SSH (bez hasła), magazynu kluczy platformy Azure, wpisu tajnego magazynu kluczy i nazwy głównej usługi.

 
## <a name="deploy-using-the-marketplace-offer"></a>Wdrażanie przy użyciu oferty Marketplace

Najprostszym sposobem wdrożenia klastra platformy kontenera OpenShift z własnym zarządzaniem na platformie Azure jest użycie [oferty portalu Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/redhat.openshift-container-platform?tab=Overview).
...
- **Węzły główne**: Trzy (3) węzły nadrzędne z konfigurowalnym typem wystąpienia.
...
- **Dostawca chmury platformy Azure**: Domyślnie włączone, można je wyłączyć.
...
Na liście zostanie otwarta strona wyniki z funkcją **Red Hat OpenShift Container platform** . 
...
| Subscription | Subskrypcja platformy Azure do wdrożenia klastra |
