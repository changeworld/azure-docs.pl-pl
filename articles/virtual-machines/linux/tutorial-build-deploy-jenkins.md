---
title: Samouczek — CI/CD z Jenkins do maszyn wirtualnych platformy Azure z Azure DevOps Services
...
W tym samouczku zalecamy używanie [tej przykładowej aplikacji dostępnej w serwisie GitHub](https://github.com/azure-devops/fabrikam-node). Ten samouczek zawiera przykładowy skrypt używany do instalowania platformy Node.js i aplikacji. Jeśli chcesz pracować z własnym repozytorium, musisz skonfigurować podobny przykład.
