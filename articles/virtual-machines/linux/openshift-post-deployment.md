...
Aby monitorować OpenShift z usługą Log Analytics, należy użyć jednej z dwóch opcji: Instalacja agenta pakietu OMS na hoście maszyny Wirtualnej lub kontenera pakietu OMS. Ten artykuł zawiera instrukcje dotyczące wdrażania kontenera pakietu OMS.
...
Wdrożenie zestawu demona agenta pakietu OMS:
