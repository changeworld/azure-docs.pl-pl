...
Tworzenie maszyny wirtualnej może potrwać kilka minut. Po utworzeniu maszyny wirtualnej interfejs wiersza polecenia platformy Azure wyświetla informacje o maszynie wirtualnej. Zanotuj wartość `zones`, która wskazuje strefę dostępności, w której działa maszyna wirtualna. 
