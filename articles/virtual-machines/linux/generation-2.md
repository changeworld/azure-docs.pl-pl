...
Najważniejsze funkcje pomocy technicznej maszyn wirtualnych generacji 2, takie jak: zwiększenie pamięci, Intel® Software Guard rozszerzenia (SGX) i wirtualnej pamięci trwałej (vPMEM), które nie są obsługiwane na maszynach wirtualnych generacji 1. Maszyny wirtualne generacji 2 mają niektóre funkcje, które nie są jeszcze obsługiwane na platformie Azure. Aby uzyskać więcej informacji, zobacz [funkcje i możliwości](#features-and-capabilities) sekcji. 
