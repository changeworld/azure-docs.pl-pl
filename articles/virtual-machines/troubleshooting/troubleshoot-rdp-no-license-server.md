...
3. Jeśli w środowisku nie ma Pulpit zdalny serwera licencji, możesz [zainstalować usługę roli licencjonowanie pulpit zdalny](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc731765(v=ws.11)). Następnie [Skonfiguruj Licencjonowanie usług pulpitu zdalnego](https://blogs.technet.microsoft.com/askperf/2013/09/20/rd-licensing-configuration-on-windows-server-2012/).
