...
1.  Aby włączyć lub wyłączyć reguły zapory, zapoznaj się [włączyć lub wyłączyć regułę zapory w systemie operacyjnym gościa dla maszyn wirtualnych w usłudze Azure](enable-disable-firewall-rule-guest-os.md).
