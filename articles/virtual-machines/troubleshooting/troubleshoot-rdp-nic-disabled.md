...
Aby zresetować interfejsu sieciowego, należy zmienić adres IP na inny adres IP, który jest dostępny w tej podsieci. Aby to zrobić, należy użyć witryny Azure portal lub programu Azure PowerShell. Aby uzyskać więcej informacji, zobacz [Resetowanie interfejsu sieciowego](reset-network-interface.md).
