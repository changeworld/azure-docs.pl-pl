...
- Korzystanie z konsoli szeregowej
    - [Maszyna wirtualna z systemem Linux](serial-console-linux.md)
        - [Konsola szeregowa — tryb GRUB/pojedynczego użytkownika](serial-console-grub-single-user-mode.md)
        - [Konsola szeregowa — NMI/SysRq](serial-console-nmi-sysrq.md)
...
- Dostęp do odzyskiwania maszyny wirtualnej
    - Windows
        - [Program PowerShell](troubleshoot-recovery-disks-windows.md)
