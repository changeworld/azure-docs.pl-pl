---
title: Wydajność rozmiaru maszyny wirtualnej z serii HB — maszyny wirtualne platformy Azure | Dokumenty firmy Microsoft
description: Dowiedz się więcej o wynikach testów wydajności dla rozmiarów maszyn wirtualnych z serii HB na platformie Azure.
...
Przeprowadzono kilka testów wydajności w rozmiarach serii HB. Poniżej przedstawiono niektóre z wyników tego badania wydajności.


| Obciążenie                                        | HB                    |
|-------------------------------------------------|-----------------------|
| Triada STREAM                                    | ~260 GB/s (32-33 GB/s na CCX)  |
| Wysokowydajny linpack (HPL)                  | ~1000 GigaFLOPS (Rpeak), ~860 GigaFLOPS (Rmax) |
| Przepustowość & opóźnienia RDMA                        | 2,35 s, 96,5 Gb/s   |
| FIO na lokalnym NVMe SSD                           | ~1,7 GB/s odczytów, zapis ~1,0 GB/s      |  
| IOR na 4 * dyski SSD premium platformy Azure (dyski zarządzane P30, RAID0)**  | ~725 MB/s odczytów, ~780 MB/zapis   |
...
| #bytes  | Opóźnienie [mikrosekunda] (MPICH 3.3 + CH4) | Opóźnienie [mikrosekunda] (OpenMPI 4.0.0) | Opóźnienie [mikrosekunda] (MVAPICH2 2.3) | Opóźnienie [mikrosekunda] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
