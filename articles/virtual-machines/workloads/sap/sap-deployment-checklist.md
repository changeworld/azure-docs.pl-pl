...
3. Sprawdzanie poprawności Technical Preview 
   1. Typy maszyn wirtualnych
      ...
      2.  Ponownie sprawdź rozmiar aplikacji i infrastruktury, wdrażanej na platformie Azure. W przypadku przenoszenia istniejących aplikacji, często można uzyskać niezbędnych protokoły SAP z infrastrukturą użyjesz i [SAP testów wydajności strony sieci Web](https://www.sap.com/dmc/exp/2018-benchmark-directory/#/sd) i porównać go z listy numerów protokoły SAP w nocie pomocy technicznej SAP [#1928533](https://launchpad.support.sap.com/#/notes/1928533). Przechowuje też [w tym artykule](https://blogs.msdn.microsoft.com/saponsqlserver/2018/11/04/saps-ratings-on-azure-vms-where-to-look-and-where-you-can-get-confused/) pamiętać
   ...
   2. Magazyn
      1.  Używanie usługi Azure Premium Storage dla maszyn wirtualnych bazy danych
