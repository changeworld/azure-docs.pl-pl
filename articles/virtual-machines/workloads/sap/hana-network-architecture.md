...
Cały ruch tych rozwiązań jest kierowany za pośrednictwem sieci wirtualnej platformy Azure. w związku z tym ten ruch może być dodatkowo ograniczany przez urządzenia miękkie używane lub przez grupy zabezpieczeń sieci platformy Azure, więc niektóre adresy IP lub zakresy adresów IP z w środowisku lokalnym można zablokować lub jawnie zezwolić na dostęp do dużych wystąpień platformy HANA. 
