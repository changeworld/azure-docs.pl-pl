...
Jeśli domena nie jest możliwa, można także użyć certyfikatów dla punktów końcowych dublowania baz danych, jak opisano tutaj: <https://docs.microsoft.com/sql/database-engine/database-mirroring/use-certificates-for-a-database-mirroring-endpoint-transact-sql>
