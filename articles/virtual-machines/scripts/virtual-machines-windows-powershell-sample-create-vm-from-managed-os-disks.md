...
W przypadku obrazów w portalu Marketplace użyj polecenia [Set-AzureRmVMPlan](https://docs.microsoft.com/en-us/powershell/module/azurerm.compute/set-azurermvmplan?view=azurermps-6.7.0), aby ustawić informacje o planie
```powershell
