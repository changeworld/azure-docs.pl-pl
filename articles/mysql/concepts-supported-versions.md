...
Wersja poprawki: 5.6.39

Zapoznaj się MySQL [informacje o wersji](https://dev.mysql.com/doc/relnotes/mysql/5.6/en/news-5-6-39.html) Aby dowiedzieć się więcej na temat ulepszeń i poprawek w bazie danych MySQL 5.6.39.

## <a name="mysql-version-57"></a>Wersja programu MySQL 5.7

Wersja poprawki: 5.7.21

Zapoznaj się MySQL [informacje o wersji](https://dev.mysql.com/doc/relnotes/mysql/5.7/en/news-5-7-21.html) Aby dowiedzieć się więcej na temat ulepszeń i poprawek w bazie danych MySQL 5.7.21.
