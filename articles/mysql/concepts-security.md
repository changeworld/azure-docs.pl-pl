---
title: Zabezpieczenia w Azure Database for MySQL — pojedynczy serwer
description: Omówienie funkcji zabezpieczeń w ramach Azure Database for MySQL-jednego serwera.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
---
# <a name="security-in-azure-database-for-mysql---single-server"></a>Zabezpieczenia w Azure Database for MySQL — pojedynczy serwer
