---
title: Zalecenia dotyczące wydajności — usługa Azure Database for MySQL
description: W tym artykule opisano funkcję zalecenia dotyczące wydajności w bazie danych platformy Azure dla mysql
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
Otwórz **rekomendacje dotyczące wydajności** z sekcji **Inteligentna wydajność** na pasku menu na stronie portalu Azure dla serwera MySQL.
