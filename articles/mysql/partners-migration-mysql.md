---
title: Bazy danych platformy Azure dla partnerów migracji MySQL | Dokumentacja firmy Microsoft
description: Lista partnerów migracji innych firm z rozwiązaniami, które obsługują bazy danych platformy Azure dla programu MySQL.
services: mysql
author: HJToland3
ms.author: jtoland
manager: craigg
...
ms.locfileid: "36304563"
---
# <a name="azure-database-for-mysql-migration-partners"></a>Bazy danych platformy Azure dla partnerów usługi MySQL migracji
Do rozwiązania MySQL szeroko obsługi bazy danych Azure, wybierz z różnych partnerów branży i narzędzi. W tym artykule omówiono firm partnerskich firmy Microsoft z rozwiązaniami migracji do obsługi bazy danych platformy Azure dla programu MySQL.
