...
ms.locfileid: "39116024"
---
# <a name="azure-database-for-mysql-migration-partners"></a>Usługa Azure Database for MySQL — partnerzy migracji
Aby szeroko obsługuje usługi Azure Database dla MySQL rozwiązania, wybierz z wielu różnych partnerów wiodące w branży i narzędzi. W tym artykule przedstawiono firm partnerskich firmy Microsoft przy użyciu migracji rozwiązania obsługi usługi Azure Database for MySQL.
