...
1. W lewym górnym rogu ekranu w Azure Portal wybierz pozycję **Utwórz zasób** > **bazy danych** > **Azure Database for MySQL**.
...
8. W obszarze **Tworzenie prywatnego punktu końcowego (wersja zapoznawcza) — Konfiguracja**wprowadź lub wybierz następujące informacje:
    ...
    |Strefa Prywatna strefa DNS |SELECT *(New) privatelink. Database. Azure. com* |
    |||
...
2. Wprowadź `nslookup  myServer.mysql.privatelink.database.azure.com`. 
