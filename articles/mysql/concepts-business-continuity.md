---
title: Omówienie ciągłości działalności biznesowej z bazą danych Azure dla programu MySQL
description: Omówienie ciągłości działalności biznesowej z bazą danych Azure dla programu MySQL.
services: mysql
author: kamathsun
ms.author: sukamat
manager: kfile
...
---
# <a name="overview-of-business-continuity-with-azure-database-for-mysql"></a>Omówienie ciągłości działalności biznesowej z bazą danych Azure dla programu MySQL

Ten przegląd zawiera opis możliwości, które bazy danych Azure dla programu MySQL zapewnia ciągłość prowadzenia działalności biznesowej i odzyskiwania po awarii. Więcej informacji na temat opcji odzyskiwania z destrukcyjne zdarzenia, które mogą spowodować utratę danych lub spowodować bazy danych i aplikacji staną się niedostępne. Dowiedz się, co robić, gdy błąd użytkownika albo aplikacji wpływa na integralność danych, region platformy Azure ma awarii lub aplikacja wymaga konserwacji.
...
Druga opcja to korzystanie z bazy danych Azure MySQL na geograficzne funkcji, która przywraca na serwerze przy użyciu kopii zapasowych geograficznie nadmiarowy. Te kopie zapasowe są dostępne, nawet wtedy, gdy region, który serwer znajduje się w jest w trybie offline. Można przywrócić z tych kopii zapasowych innego regionu i przełączyć serwer w tryb online.
...
- Aby dowiedzieć się więcej na temat automatycznego tworzenia kopii zapasowych, zobacz [kopii zapasowych w bazie danych Azure dla programu MySQL](concepts-backup.md).
