---
title: Query Performance Insight — usługa Azure Database for MySQL
description: W tym artykule opisano funkcję wglądu w dane dotyczące wydajności kwerend w bazie danych platformy Azure dla mysql
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
Na stronie portalu usługi Azure Database dla serwera MySQL wybierz opcję **Query Performance Insight** w sekcji **Inteligentna wydajność** na pasku menu.
...
- Dowiedz się więcej o [monitorowaniu i dostrajaniu](concepts-monitoring.md) w usłudze Azure Database for MySQL.