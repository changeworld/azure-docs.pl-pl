---
title: Tworzenie kopii zapasowych i przywracanie w Azure Database for MySQL
...
W Azure Database for MySQL wykonanie przywracania powoduje utworzenie nowego serwera na podstawie kopii zapasowych oryginalnego serwera.
...
- Aby przywrócić do punktu w czasie za pomocą interfejsu wiersza polecenia platformy Azure, zobacz [przywracanie bazy danych do punktu w czasie za pomocą interfejsu wiersza polecenia](howto-restore-server-cli.md).
