---
title: Konfigurowanie alertów metryk — witryna Azure portal — usługa Azure Database for MySQL
...
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-mysql"></a>Konfigurowanie alertów dotyczących metryk usługi Azure Database dla mysql za pomocą witryny Azure Portal 

W tym artykule pokazano, jak skonfigurować usługę Azure Database dla alertów MySQL przy użyciu witryny Azure portal. Możesz otrzymać alert na podstawie monitorowania metryk dla usług platformy Azure.
...
1. W [witrynie Azure portal](https://portal.azure.com/)wybierz usługę Azure Database dla serwera MySQL, który chcesz monitorować.
