...
* Włącz wykrywanie dwukierunkowego przekazywania (BFD) na prywatnej komunikacji równorzędnej Azure obwodu usługi ExpressRoute. BFD jest domyślnie włączona, jeśli obwód ExpressRoute jest tworzony po 1 sierpnia 2018. Jeśli obwód został utworzony przed tym, BFD nie został włączony. Możesz włączyć BFD, wyłączając komunikację równorzędną i włączając ją ponownie. Należy zauważyć, że BFD jest obsługiwany tylko w prywatnej komunikacji równorzędnej Azure.
