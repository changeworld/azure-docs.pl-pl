...
Zapoznaj się z tematem [Networking considerations for Azure Active Directory Domain Services](network-considerations.md) (Zagadnienia dotyczące sieci w usłudze Azure Active Directory Domain Services).
