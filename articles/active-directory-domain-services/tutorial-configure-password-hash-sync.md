...
ms.locfileid: "70014034"
---
# <a name="tutorial-enable-password-synchronization-in-azure-active-directory-domain-services-for-hybrid-environments"></a>Samouczek: Włącz synchronizację haseł w Azure Active Directory Domain Services dla środowisk hybrydowych
...
1. Skopiuj i wklej następujący skrypt programu PowerShell na komputerze z zainstalowanym Azure AD Connect. Skrypt wyzwala pełną synchronizację haseł, która zawiera starsze skróty haseł. Zaktualizuj zmienne `$adConnector` i przy użyciu nazw łączników z poprzedniego kroku. `$azureadConnector`
