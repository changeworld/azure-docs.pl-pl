...
1. Zaloguj się do maszyny Wirtualnej Windows służy do administrowania domeny zarządzanej. Jeśli nie masz, postępuj zgodnie z instrukcjami, aby [administrowanie domeną zarządzaną](active-directory-ds-admin-guide-administer-domain.md)
...
* [Dowiedz się więcej o zasady szczegółowe hasło w dobrym stanie usługi Active Directory](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc770394)
