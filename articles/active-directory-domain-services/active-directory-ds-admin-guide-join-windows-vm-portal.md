...
* [Usługa Azure AD DS Wprowadzenie — przewodnik](active-directory-ds-getting-started.md)
* [Administrowanie domeną usługi Azure AD DS, zarządzane](active-directory-ds-admin-guide-administer-domain.md)
