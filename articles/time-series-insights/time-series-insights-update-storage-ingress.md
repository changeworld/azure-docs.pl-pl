---
title: Dane czasu Series Insights w wersji zapoznawczej platformy Azure — magazyn danych i transferu danych przychodzących w wersji zapoznawczej Azure czas serii szczegółowych informacji | Dokumentacja firmy Microsoft
...
Czas Series Insights w wersji zapoznawczej obsługuje skali początkowy ruch przychodzący do 6 megabitów na sekundę (MB/s) na środowisko. Trwa rozszerzoną obsługę skalowania. Firma Microsoft planuje aktualizację naszej dokumentacji w celu odzwierciedlenia tych ulepszeń.
