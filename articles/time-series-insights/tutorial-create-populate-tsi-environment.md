---
title: Tworzenie środowiska usługi Azure Time Series Insights
...
Twoje konto logowania platformy Azure musi być członkiem subskrypcji roli „Właściciel”. Aby uzyskać więcej informacji, zobacz [Dodawanie lub zmienianie administratorów subskrypcji platformy Azure](/azure/billing/billing-add-change-azure-subscription-administrator)
...
Teraz, gdy już wiesz, jak utworzyć własne środowisko TSI, dowiedz się więcej o procesie planowania. W tym celu przejdź do następnego artykułu:
