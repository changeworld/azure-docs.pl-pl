...
W tym filmie pokazujemy, jak używać akceleratora rozwiązań IoT na platformie Azure do generowania danych, które mogą służyć do rozpoczęcia pracy z usługą Time Series Insights.
