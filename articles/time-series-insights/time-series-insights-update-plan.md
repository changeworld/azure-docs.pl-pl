...
> [!NOTE]
> Zobacz [Planowanie środowiska Azure czas serii szczegółowych informacji w wersji Ogólnodostępnej](time-series-insights-environment-planning.md), najlepsze rozwiązania dotyczące zaplanować wystąpienia usługi TSI ogólnie dostępne.
...
Aby utworzyć nowego środowiska usługi Time Series Insights, wybierz **identyfikator serii czasu**. Spowoduje to więc działa jako partycji logicznej dla swoich danych. Jak wspomniano, upewnij się, że masz swoim identyfikatorem serii czasu gotowe.
...
* Tryb serii czasu, pól wystąpień i zdarzenia obejmują tylko niezbędne informacje, takie jak **identyfikator serii czasu** lub **sygnatura czasowa**.
