---
title: Uwierzytelnianie usługi Azure Time Series Insights — jak uwierzytelnianie i autoryzacja w interfejsie API w usłudze Azure Time Series Insights | Dokumentacja firmy Microsoft
...
- Aby uzyskać informacje referencyjne interfejsu API, zobacz [dokumentację interfejsu API zapytań](/rest/api/time-series-insights/time-series-insights-reference-queryapi).

> [!div class="nextstepaction"]
> [Tworzenie jednostki usługi](../active-directory/develop/howto-create-service-principal-portal.md)
