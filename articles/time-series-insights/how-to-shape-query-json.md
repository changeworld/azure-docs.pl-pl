...
## <a name="scenario-one-only-a-few-measurements-exist"></a>Scenariusz jeden: Istnieje tylko kilka pomiarów
...
- Należy unikać niepotrzebnych właściwości, na przykład informacje dotyczące marki i modelu. Ze względu na to, że w przyszłości nie będą wysyłane zapytania do właściwości, eliminuje to lepszą wydajność sieci i magazynu.
...
## <a name="scenario-two-several-measures-exist"></a>Scenariusz dwa: Istnieje kilka miar
