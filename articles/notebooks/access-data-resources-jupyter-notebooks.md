...
- [Tworzenie aplikacji Flask za pomocą usługi Azure Cosmos DB dla interfejsu API usługi MongoDB](https://docs.microsoft.com/azure/cosmos-db/create-mongodb-flask)
