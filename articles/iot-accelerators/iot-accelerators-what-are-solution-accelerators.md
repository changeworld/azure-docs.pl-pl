...
Poniższe wideo przedstawia omówienie akcelerator rozwiązań monitorowania zdalnego:
...
* [Zdalne monitorowanie](iot-accelerators-remote-monitoring-explore.md)
* [Konserwacja predykcyjna](iot-accelerators-predictive-overview.md)
* [Połączona fabryka](iot-accelerators-connected-factory-overview.md)
...
| ------------------------------------------------------------ | -- | -- | -- | -- | -- | -- | -- |
| [Zdalne monitorowanie](iot-accelerators-remote-monitoring-explore.md)  |Yes |Yes |Yes |-   |Yes |Yes |-   |
| [Konserwacja predykcyjna](iot-accelerators-predictive-overview.md)   |Yes |Yes |-   |-   |Yes |Yes |Yes |
| [Połączona fabryka](iot-accelerators-connected-factory-overview.md) |Yes |- |- |Yes |Yes |Yes |-   |
...
> [!NOTE]
> Aby wdrożyć akcelerator rozwiązania i uzyskać więcej informacji o sposobie jego dostosowywania, odwiedź stronę [Akceleratory rozwiązań usługi Microsoft Azure IoT](https://www.azureiotsolutions.com/).
...
* [Azure Stream Analytics](../stream-analytics/index.yml). Usługa ta jest używana do przetwarzania przychodzących telemetrii, wykonaj agregacji i wykrywania zdarzeń akcelerator rozwiązań konserwacji predykcyjnej. To wstępnie skonfigurowane rozwiązanie używa również analizy strumienia do przetwarzania komunikatów informacyjnych, które zawierają metadane lub odpowiedzi urządzeń na wysyłane polecenia.
...
Omówienie architektury typowego rozwiązania IoT można znaleźć w artykule [Platforma Azure i Internet rzeczy](iot-accelerators-what-is-azure-iot.md).
...
Nowa wersja akcelerator rozwiązań monitorowania zdalnego korzysta z architektury mikrousług. Ten akcelerator rozwiązania składa się z wielu mikrousług, takich jak *menedżer usługi IoT Hub* i *menedżer magazynowania*. Poszczególne mikrousługi można pobrać zarówno w wersji Java, jak i .NET, wraz z pokrewną dokumentacją dla deweloperów. Aby uzyskać więcej informacji na temat mikrousług, zobacz [Architektura zdalnego monitorowania](iot-accelerators-remote-monitoring-sample-walkthrough.md).
...
Podczas wdrażania nowej wersji monitorowania zdalnego, musisz wybrać jedną z następujących opcji wdrażania:
...
* [Poznaj rozwiązanie do zdalnego monitorowania](iot-accelerators-remote-monitoring-explore.md)
* [Omówienie akceleratora rozwiązania do konserwacji zapobiegawczej](iot-accelerators-predictive-overview.md)
* [Wprowadzenie do akceleratora rozwiązania połączonej fabryki](iot-accelerators-connected-factory-overview.md)

Aby uzyskać więcej informacji na temat architektury rozwiązań IoT, zobacz dokument [Microsoft Azure IoT services: Reference Architecture](https://aka.ms/iotrefarchitecture) (Usługi Microsoft Azure IoT: architektura referencyjna).
