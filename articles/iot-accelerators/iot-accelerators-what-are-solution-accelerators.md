...
* [Konserwacja predykcyjna](../iot-suite/iot-suite-predictive-overview.md)
...
| [Konserwacja predykcyjna](../iot-suite/iot-suite-predictive-overview.md)   |Yes |Yes |-   |-   |Yes |Yes |Yes |
...
* [Azure Event Hubs](../active-directory-domain-services/index.md). Ta usługa umożliwia wprowadzanie dużej liczby zdarzeń do chmury. Zobacz [Porównanie Centrum IoT Azure i usługi Azure Event Hubs](../iot-hub/iot-hub-compare-event-hubs.md).
...
* [Omówienie akceleratora rozwiązania do konserwacji zapobiegawczej](../iot-suite/iot-suite-predictive-overview.md)
