...
description: Opis akcelerator rozwiązań konserwacji predykcyjnej Azure
author: dominicbetts
manager: timlt
...
Na tej stronie aplikacji internetowej są używane kontrolki JavaScript usługi Power BI (zobacz [repozytorium PowerBI-visuals][lnk-powerbi]), które umożliwiają wizualizację następujących elementów:
