...
>[!div class="checklist"]
> * [Wdrażanie zdalne monitorowanie akcelerator rozwiązań lokalnie](iot-accelerators-remote-monitoring-deploy-local.md)
...
![Komunikat aktywności i dobrze Postman](./media/iot-accelerators-microservices-example/postman-alive-well.png)
...
![Obraz pomyślnie docker](./media/iot-accelerators-microservices-example/successful-docker-image.png)
...
![Obraz docker w Centrum docker](./media/iot-accelerators-microservices-example/docker-image-in-docker-hub.png)
...
![Nowy edytuje wprowadzone w tym miejscu postman komunikat](./media/iot-accelerators-microservices-example/new-postman-message.png)
...
Operacją dalej, aby spróbować jest [Dostosowywanie mikrousługi symulator urządzeń w rozwiązaniu Monitorowanie zdalne](iot-accelerators-remote-monitoring-test.md)
