...
# [Dokumentacja akceleratorów rozwiązań IoT](index.md)
...
### [Często zadawane pytania](../iot-suite/iot-suite-v1-faq.md)

### Rozpoczęcie pracy
#### [Rozpoczynanie pracy z akceleratorami rozwiązań](../iot-suite/iot-suite-v1-getstarted-preconfigured-solutions.md)
#### [Uprawnienia w witrynie azureiotsuite.com](../iot-suite/iot-suite-v1-permissions.md)
#### [Przewodnik po rozwiązaniu do zdalnego monitorowania](../iot-suite/iot-suite-v1-remote-monitoring-sample-walkthrough.md)
#### [Łączenie urządzenia Raspberry Pi](../iot-suite/iot-suite-v1-raspberry-pi-kit-get-started.md)
##### Korzystanie z języka C
###### [Symulowane dane](../iot-suite/iot-suite-v1-raspberry-pi-kit-c-get-started-simulator.md)
###### [Korzystanie z rzeczywistych czujników](../iot-suite/iot-suite-v1-raspberry-pi-kit-c-get-started-basic.md)
###### [Wdrażanie aktualizacji oprogramowania układowego](../iot-suite/iot-suite-v1-raspberry-pi-kit-c-get-started-advanced.md)
##### Korzystanie ze środowiska Node.js
###### [Symulowane dane](../iot-suite/iot-suite-v1-raspberry-pi-kit-node-get-started-simulator.md)
###### [Korzystanie z rzeczywistych czujników](../iot-suite/iot-suite-v1-raspberry-pi-kit-node-get-started-basic.md)
###### [Wdrażanie aktualizacji oprogramowania układowego](../iot-suite/iot-suite-v1-raspberry-pi-kit-node-get-started-advanced.md)
#### [Łączenie zestawu MXChip IoT DevKit](../iot-hub/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoring.md)

### Przewodniki z instrukcjami
#### Podłączanie symulowanego urządzenia
##### [C w systemie Windows](../iot-suite/iot-suite-v1-connecting-devices.md)
##### [C w systemie Linux](../iot-suite/iot-suite-v1-connecting-devices-linux.md)
##### [Node.js](../iot-suite/iot-suite-v1-connecting-devices-node.md)
#### [Łączenie aplikacji logiki z rozwiązaniem do zdalnego monitorowania](../iot-suite/iot-suite-v1-logic-apps-tutorial.md)
#### [Dostosowywanie akceleratora rozwiązań](../iot-suite/iot-suite-v1-guidance-on-customizing-preconfigured-solutions.md)
#### [Korzystanie z telemetrii dynamicznej z rozwiązaniem do zdalnego monitorowania](../iot-suite/iot-suite-v1-dynamic-telemetry.md)
#### [Tworzenie reguły niestandardowej w rozwiązaniu do zdalnego monitorowania](../iot-suite/iot-suite-v1-custom-rule.md)
#### [Informacje o urządzeniu w rozwiązaniu do zdalnego monitorowania](../iot-suite/iot-suite-v1-remote-monitoring-device-info.md)
...
## [Zabezpieczenia od podstaw](/azure/iot-fundamentals/iot-security-ground-up?context=azure/iot-accelerators/rc/rc)
## [Najlepsze rozwiązania dotyczące zabezpieczeń](/azure/iot-fundamentals/iot-security-best-practices?context=azure/iot-accelerators/rc/rc)
## [Architektura zabezpieczeń](/azure/iot-fundamentals/iot-security-architecture?context=azure/iot-accelerators/rc/rc)
## [Zabezpieczanie wdrożenia IoT](/azure/iot-fundamentals/iot-security-deployment?context=azure/iot-accelerators/rc/rc)
