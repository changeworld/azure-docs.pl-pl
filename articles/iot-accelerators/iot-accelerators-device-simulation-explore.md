...
Jeśli wdrożono nie jeszcze symulacji urządzenia, ale należy wykonać [wdrażanie symulacji urządzenia IoT Azure](iot-accelerators-device-simulation-deploy.md) samouczka.

## <a name="configuring-device-simulation"></a>Konfigurowanie symulacji urządzenia

Można skonfigurować i uruchomić symulacji urządzenia całkowicie z poziomu pulpitu nawigacyjnego. Otwórz pulpit nawigacyjny z akceleratorów rozwiązania IoT [elastycznie rozwiązań](https://www.azureiotsolutions.com/) strony. Kliknij przycisk **uruchamianie** w nowe wdrożenia symulacji urządzenia.
...
![Centrum IoT docelowego](./media/iot-accelerators-device-simulation-explore/targethub.png)
...
![Centrum IoT docelowego](./media/iot-accelerators-device-simulation-explore/connectionstring.png)
...
![Model urządzenia](./media/iot-accelerators-device-simulation-explore/devicemodel.png)
...
![Dodawanie czujników](./media/iot-accelerators-device-simulation-explore/customsensors.png)
...
![Liczba urządzeń](./media/iot-accelerators-device-simulation-explore/numberofdevices.png)
...
![Częstotliwość telemetrii](./media/iot-accelerators-device-simulation-explore/frequency.png)
...
![Czas trwania symulacji](./media/iot-accelerators-device-simulation-explore/duration.png)
...
![Rozpocznij symulację](./media/iot-accelerators-device-simulation-explore/start.png)
...
![Zatrzymaj symulację](./media/iot-accelerators-device-simulation-explore/stop.png)
