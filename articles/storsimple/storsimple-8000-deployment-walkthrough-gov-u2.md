...
Usługa Menedżer urządzeń StorSimple umożliwia zarządzanie wieloma urządzeniami StorSimple. Wykonaj poniższe kroki, aby utworzyć nowe wystąpienie usługi Menedżer StorSimple urządzenia.
...
Po skonfigurowaniu i uruchomieniu usługi Menedżer urządzeń StorSimple musisz pobrać klucz rejestracji usługi. Ten klucz służy do rejestrowania i połączyć się z usługą urządzenia StorSimple.
...
Wykonaj poniższe kroki w portalu Azure dla instytucji rządowych przeprowadzić minimalną konfigurację urządzenia.
...
Wykonaj poniższe kroki w portalu dla instytucji rządowych na **usługi Menedżer StorSimple urządzenia** strony.
