...
| [Wymagania wstępne dotyczące wdrożenia](#deployment-prerequisites) |Sprawdzają, czy środowisko jest gotowe do wdrożenia. |
|  | |
...
| [Krok 4. Ukończ minimalną konfigurację urządzenia](#step-4-complete-minimum-device-setup) </br>Opcjonalnie: Zaktualizuj urządzenie StorSimple. |Skorzystaj z usługi zarządzania, aby skonfigurować urządzenie i umożliwić przechowywanie w nim danych. |
...
| [Krok 7: Instalowanie, inicjowanie i formatowanie woluminu](#step-7-mount-initialize-and-format-a-volume) </br>Opcjonalnie: Skonfiguruj wielościeżkowe wejście/wyjście. |Połącz serwery z magazynem iSCSI udostępnianym przez urządzenie. Opcjonalnie Skonfiguruj funkcję MPIO, aby zapewnić, że serwery mogą tolerować awarie łączy, sieci i interfejsu. |
| [Krok 8. Utwórz kopię zapasową](#step-8-take-a-backup) |Skonfiguruj zasady tworzenia kopii zapasowej, aby chronić dane. |
|  | |
...
| [Skanuj i stosuj aktualizacje](#scan-for-and-apply-updates) | |
...
## <a name="step-3-configure-and-register-the-device-through-windows-powershell-for-storsimple"></a>Krok 3: Konfigurowanie i rejestrowanie urządzenia za pomocą program Windows PowerShell dla usługi StorSimple
...
## <a name="step-8-take-a-backup"></a>Krok 8: Utwórz kopię zapasową
