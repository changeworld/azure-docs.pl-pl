---
title: Instalowanie aktualizacji na macierzy wirtualnej Usługi StorProsze platformy Microsoft | Dokumenty firmy Microsoft
description: W tym artykule opisano sposób używania interfejsu użytkownika sieci Web Tablicy wirtualnej StorSimple do stosowania aktualizacji przy użyciu metody portalu i poprawki
services: storsimple
...
---
# <a name="install-updates-on-your-storsimple-virtual-array---azure-portal"></a>Instalowanie aktualizacji w tablicy wirtualnej StorSimple — portal Azure

## <a name="overview"></a>Omówienie

W tym artykule opisano kroki wymagane do zainstalowania aktualizacji w tablicy wirtualnej StorSimple za pośrednictwem lokalnego interfejsu użytkownika sieci web i za pośrednictwem witryny Azure portal. Aby mieć aktualną aktualizację wirtualną tablicy StorSimple, należy zastosować aktualizacje oprogramowania lub poprawki. 
...
3. W polu wyszukiwania katalogu Microsoft Update należy wprowadzić numer bazy wiedzy (KB) poprawki, którą chcesz pobrać. Wprowadź **3182061** dla aktualizacji 0.3, a następnie kliknij przycisk **Wyszukaj**.
