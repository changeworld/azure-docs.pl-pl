---
title: StorSimple Virtual Array Update 0.6 informacje o wersji| Dokumenty firmy Microsoft
description: W tym artykule opisano krytyczne otwarte problemy i rozwiązania dla tablicy wirtualnej StorSimple z aktualizacją 0.6.
services: storsimple
documentationcenter: ''
author: alkohli
manager: timlt
...
> [!IMPORTANT]
> - Aktualizacje są destrukcyjne i uruchom ponownie urządzenie. Jeśli we/wy są w toku, urządzenie ponosi przestoje. Aby uzyskać szczegółowe instrukcje dotyczące stosowania aktualizacji, przejdź do [instalacji aktualizacji 0.6](storsimple-virtual-array-install-update-06.md).
>
> - Zdecydowanie zaleca się natychmiastowe zainstalowanie aktualizacji 0.6, ponieważ zawiera ona krytyczne poprawki zabezpieczeń.


## <a name="whats-new-in-the-update-06"></a>Co nowego w aktualizacji 0.6
Aktualizacja 0.6 jest aktualizacją krytyczną i powinna zostać wdrożona natychmiast. Ta aktualizacja zawiera następujące poprawki: 

- **Poprawki zabezpieczeń systemu Windows** — w tej wersji są **ważne poprawki zabezpieczeń systemu Windows**. Przejrzyj następujące aktualizacje zabezpieczeń, aby uzyskać więcej informacji na temat problemów z zabezpieczeniami i skojarzonych z nimi poprawek:
    - [Aktualizacja jakości tylko do zabezpieczeń z grudnia 2016 r. dla systemów Windows 8.1 i Windows Server 2012 R2](https://support.microsoft.com/help/3205400/december-2016-security-only-quality-update-for-windows-8.1-and-windows-server-2012-r2)
    - [Aktualizacja jakości tylko do zabezpieczeń z marca 2017 r. dla systemów Windows 8.1 i Windows Server 2012 R2](https://support.microsoft.com/help/4012213/march-2017-security-only-quality-update-for-windows-8-1-and-windows-server-2012-r23)
...
- **Poprawkę przywracania** — we wcześniejszych wersjach wystąpił błąd, który uniemożliwiałby ukończenie przywracania. Ten błąd został naprawiony w tej wersji.
...
| 2 |Przywracanie| Podczas przywracania wystąpił stan wyścigu, który uniemożliwiałby wykonanie zadania przywracania. Poprawka błędu rozwiązuje ten stan wyścigu.|
...
[Zainstaluj aktualizację 0.6](storsimple-virtual-array-install-update-06.md) na tablicy wirtualnej StorSimple.
