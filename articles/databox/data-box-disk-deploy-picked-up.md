...
W tym samouczku opisano sposób planowania pobrania w celu zwrócenia Azure Data Box Disk. Instrukcje pobrania zależą od miejsca, w którym zwracasz urządzenie. 
...
Następne kroki są określane przez miejsce zwrócenia urządzenia. Instrukcje są różne dla Stanów Zjednoczonych/Kanady, Unii Europejskiej (UE), Australii lub krajów w Azji.
...
> [Weryfikuj przekazywanie danych z Azure Data Box Disk](./data-box-disk-deploy-picked-up.md)
