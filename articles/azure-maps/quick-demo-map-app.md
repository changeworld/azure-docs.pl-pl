...
3. Wypróbuj funkcję wyszukiwania interaktywnego. W polu wyszukiwania w lewym górnym rogu demonstracyjnej aplikacji internetowej wyszukaj **restauracje**. 
4. Przesuń wskaźnik myszy na listę adresów/lokalizacji wyświetlonych poniżej pola wyszukiwania i zaobserwuj, jak odpowiedni punkt na mapie wyświetla informacje o konkretnej lokalizacji. Ze względu na ochronę danych prywatnych firm wyświetlono fikcyjne nazwy i adresy. 
