...
2. Wybierz wyzwalacz żądania HTTP, a następnie wybierz pozycję „send and email” (Wyślij i wiadomość e-mail) jako akcję w łączniku programu Outlook
