...
| Wyrażenie | Return type | Opis |
|------------|-------------|-------------|
| `['at', number, array]` | obiekt | Retrieves an item from an array. |
| `['geometry-type']` | string | Gets the feature's geometry type: Point, MultiPoint, LineString, MultiLineString, Polygon, MultiPolygon. |
| `['get', string]` | wartość | Gets the property value from the current feature's properties. Returns null if the requested property is missing. |
| `['get', string, object]` | wartość | Gets the property value from the properties of the provided object. Returns null if the requested property is missing. |
| `['has', string]` | wartość logiczna | Determines if the properties of a feature have the specified property. |
| `['has', string, object]` | wartość logiczna | Determines if the properties of the object have the specified property. |
| `['id']` | wartość | Gets the feature's ID if it has one. |
| `['length', string | array]` | numer | Gets the length of a string or array. |
...
| Wyrażenie | Return type | Opis |
|------------|-------------|-------------|
| `['+', number, number, …]` | numer | Calculates the sum of the specified numbers. |
| `['-', number]` | numer | Subtracts 0 by the specified number. |
| `['-', number, number]` | numer | Subtracts the first numbers by the second number. |
| `['*', number, number, …]` | numer | Multiplies the specified numbers together. |
| `['/', number, number]` | numer | Divides the first number by the second number. |
| `['%', number, number]` | numer | Calculates the remainder when dividing the first number by the second number. |
| `['^', number, number]` | numer | Calculates the value of the first value raised to the power of the second number. |
| `['abs', number]` | numer | Calculates the absolute value of the specified number. |
| `['acos', number]` | numer | Calculates the arccosine of the specified number. |
| `['asin', number]` | numer | Calculates the arcsine of the specified number. |
| `['atan', number]` | numer | Calculates the arctangent of the specified number. |
| `['ceil', number]` | numer | Rounds the number up to the next whole integer. |
| `['cos', number]` | numer | Calculates the cos of the specified number. |
| `['e']` | numer | Returns the mathematical constant `e`. |
| `['floor', number]` | numer | Rounds the number down to the previous whole integer. |
| `['ln', number]` | numer | Calculates the natural logarithm of the specified number. |
| `['ln2']` | numer | Returns the mathematical constant `ln(2)`. |
| `['log10', number]` | numer | Calculates the base-ten logarithm of the specified number. |
| `['log2', number]` | numer | Calculates the base-two logarithm of the specified number. |
| `['max', number, number, …]` | numer | Calculates the maximum number in the specified set of numbers. |
| `['min', number, number, …]` | numer | Calculates the minimum number in the specified set of numbers. |
| `['pi']` | numer | Returns the mathematical constant `PI`. |
| `['round', number]` | numer | Rounds the number to the nearest integer. Halfway values are rounded away from zero. For example, `['round', -1.5]` evaluates to -2. |
| `['sin', number]` | numer | Calculates the sine of the specified number. |
| `['sqrt', number]` | numer | Calculates the square root of the specified number. |
| `['tan', number]` | numer | Calculates the tangent of the specified number. |
...
| Wyrażenie | Return type | Opis |
|------------|-------------|-------------|
| `['! ', boolean]` | wartość logiczna | Logical negation. Returns `true` if the input is `false`, and `false` if the input is `true`. |
| `['!= ', value, value]` | wartość logiczna | Returns `true` if the input values are not equal, `false` otherwise. |
| `['<', value, value]` | wartość logiczna | Returns `true` if the first input is strictly less than the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['<=', value, value]` | wartość logiczna | Returns `true` if the first input is less than or equal to the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['==', value, value]` | wartość logiczna | Returns `true` if the input values are equal, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['>', value, value]` | wartość logiczna | Returns `true` if the first input is strictly greater than the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['>=' value, value]` | wartość logiczna | Returns `true` if the first input is greater than or equal to the second, `false` otherwise. The arguments are required to be either both strings or both numbers. |
| `['all', boolean, boolean, …]` | wartość logiczna | Returns `true` if all the inputs are `true`, `false` otherwise. |
| `['any', boolean, boolean, …]` | wartość logiczna | Returns `true` if any of the inputs are `true`, `false` otherwise. |
...
| `['to-boolean', value]` | wartość logiczna | Converts the input value to a boolean. The result is `false` when the input is an empty string, `0`, `false`, `null`, or `NaN`; otherwise its `true`. |
...
| Liniowe  | Wykładnicze | Cubic Bezier |
|---------|-------------|--------------|
