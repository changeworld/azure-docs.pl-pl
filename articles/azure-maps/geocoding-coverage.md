...
Aby uzyskać więcej informacji na temat geokodowanie mapy Azure, zobacz [wyszukiwania](https://docs.microsoft.com/rest/api/azure-maps/search) odwołania stron.
