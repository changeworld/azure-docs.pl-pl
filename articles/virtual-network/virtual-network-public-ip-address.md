...
4. Wprowadź lub wybierz wartości dla następujących ustawień, w obszarze **Utwórz publiczny adres IP**, a następnie wybierz pozycję **Utwórz**:
   ...
   |Subscription|Tak|Musi znajdować się w tej samej [subskrypcji](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#subscription) co zasób, do którego chcesz skojarzyć publiczny adres IP.|
   |Resource group|Tak|Może istnieć w tej samej lub innej [grupie zasobów](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#resource-group) co zasób, do którego chcesz skojarzyć publiczny adres IP.|
   |Location|Tak|Musi znajdować się w tej samej [lokalizacji](https://azure.microsoft.com/regions), nazywanej również regionem, jako zasób, do którego chcesz skojarzyć publiczny adres IP.|
...
- [Application Gateway platformy Azure](../application-gateway/application-gateway-create-gateway-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
