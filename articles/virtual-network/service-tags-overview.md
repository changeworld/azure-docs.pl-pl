...
| **AppService**    | Usługa App Service. Ten tag jest zalecany w przypadku reguł zabezpieczeń wychodzących WebApp frontony. | Wychodzący | Tak | Tak |
| **AppServiceManagement** | Ruch związany z zarządzaniem App Service Environment dedykowane wdrożenia. | Oba | Nie | Tak |
| **Usługi azureactivedirectory** | Usługa Azure Active Directory. | Wychodzący | Nie | Tak |
...
| **AzureBackup** |Usługa Azure Backup.<br/><br/>*Uwaga:* Ten tag ma zależność od tagów **Storage** i **usługi azureactivedirectory** . | Wychodzący | Nie | Tak |
| **AzureCloud** | Wszystkie [publiczne adresy IP centrum](https://www.microsoft.com/download/details.aspx?id=41653)danych. | Wychodzący | Tak | Tak |
| **AzureConnectors** | Logic Apps łączniki dla połączeń sondy/zaplecza. | Przychodzący | Tak | Tak |
| **AzureContainerRegistry** | Usługa Azure Container Registry. | Wychodzący | Tak | Tak |
| **AzureCosmosDB** | Usługa Azure Cosmos Database. | Wychodzący | Tak | Tak |
| **AzureDataLake** | Usługa Azure Data Lake. | Wychodzący | Nie | Tak |
| **AzureKeyVault** | Usługa magazynu kluczy platformy Azure.<br/><br/>*Uwaga:* Ten tag ma zależność od znacznika **usługi azureactivedirectory** . | Wychodzący | Tak | Tak |
...
| **AzureMachineLearning** | Usługa Azure Machine Learning. | Wychodzący | Nie | Tak |
| **AzureMonitor** | Log Analytics, App Insights, AzMon i metryki niestandardowe (rdzeniowym procesorem Endpoints).<br/><br/>*Uwaga:* W przypadku Log Analytics ten tag ma zależność od tagu **magazynu** . | Wychodzący | Nie | Tak |
...
| **EventHub** | Usługa EventHub platformy Azure. | Wychodzący | Tak | Tak |
