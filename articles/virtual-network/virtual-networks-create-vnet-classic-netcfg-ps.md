...
ms.locfileid: "31797839"
---
# <a name="create-a-virtual-network-classic-using-a-network-configuration-file-with-powershell"></a>Tworzenie sieci wirtualnej (wdrożenia klasyczne) przy użyciu pliku konfiguracji sieci przy użyciu programu PowerShell
...
W tym dokumencie opisano tworzenie sieci wirtualnej przy użyciu klasycznego modelu wdrażania. Możesz również [utworzyć sieć wirtualną w modelu wdrażania usługi Resource Manager](quick-create-powershell.md).
