---
title: Przykład skryptu programu Azure PowerShell — konfigurowanie frontendu IPv6 za pomocą standardowego modułu równoważenia obciążenia (wersja zapoznawcza)
...
---
# <a name="configure-ipv6-frontend-in-virtual-network-script-sample-with-standard-load-balancerpreview"></a>Konfigurowanie frontendu IPv6 w przykładzie skryptu sieci wirtualnej za pomocą standardowego modułu równoważenia obciążenia (podglądu)
