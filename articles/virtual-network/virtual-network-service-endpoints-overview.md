...
- **[Azure Key Vault](../key-vault/key-vault-overview-vnet-service-endpoints.md)**: ogólnie dostępna we wszystkich regionach chmury publicznej platformy Azure.
