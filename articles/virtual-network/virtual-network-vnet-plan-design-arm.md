...
- Czy masz wszystkie wymagania w zakresie zasobów organizacyjnych administracji w różnych sieciach wirtualnych? Jeśli tak, może być oddzielnych zasoby do oddzielnych sieci wirtualnej, aby uprościć [przypisanie uprawnień](#permissions) do osób w Twojej organizacji lub, aby przypisać różne [zasady](#policies) na różne wirtualne sieci.
