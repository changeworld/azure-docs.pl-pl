...
4. <a name = "security-rule-settings"></a>Wybierz **+ Dodaj**.  Wybierz lub Dodaj wartości dla następujących ustawień, a następnie wybierz **OK**:
    ...
    |Zakresy portów źródła     | Określ pojedynczym portem, np. 80, zakres portów, np. 1024 – 65535 lub rozdzielaną przecinkami listę pojedynczego portów i/lub zakresów portów, np. 80, 1024 – 65 535. Wprowadź znak gwiazdki, aby zezwolić na ruch na dowolnym porcie. | Porty i zakresy należy określić, jaki ruch portów jest dozwolony lub odrzucany przez tę zasadę. Brak ograniczeń dotyczących liczbę portów, które można określić. Zobacz [Azure ogranicza](../azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits) szczegółowe informacje.  |
    ...
    |Zakresy portów docelowego     | Określ pojedynczą wartość lub listę wartości oddzielanych przecinkami. | Podobnie jak **źródła zakresy portów**, można określić jeden lub wiele porty i zakresy i istnieją ograniczenia do liczby można określić. |
