...
```
Połącz definicje konfiguracji, aby utworzyć maszynę wirtualną o nazwie **myVM** z opcją [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) w **myResourceGroupNAT**.
