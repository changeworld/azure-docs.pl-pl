...
- Nie można zmodyfikować zasad tworzenia kopii zapasowych po zastosowaniu ich do SAP HANA kopii zapasowych. Jeśli chcesz utworzyć kopię zapasową przy użyciu różnych ustawień, Utwórz nowe zasady lub Przypisz inne zasady.
  - Aby utworzyć nowe zasady, w magazynie kliknij pozycje **zasady** > **Tworzenie kopii zapasowych** > i**Dodaj** > **SAP HANA na maszynie wirtualnej platformy Azure**, a następnie określ ustawienia zasad.
...
3. Aby to zrobić, kliknij dwukrotnie pozycję**Konfiguracja** >  **systemdb** > **Wybierz pozycję Filtr bazy danych** >  **(log)** .
