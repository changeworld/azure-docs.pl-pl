...
| Resource |Tekst |Jest to zasób, dla którego zbierane są dane, zawiera Recovery Services nazwa magazynu |
...
| Kategoria |Tekst |Kategoria danych diagnostycznych wypychanych do dzienników Azure Monitor. Zawsze AzureBackupReport |
| Resource |Tekst |Zasób, dla którego zbierane są dane, na przykład Recovery Services nazwa magazynu |
| SourceSystem |Tekst |System źródłowy bieżących danych — Azure |
