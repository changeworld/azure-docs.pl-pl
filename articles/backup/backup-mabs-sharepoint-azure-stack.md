...
Usługa Azure Backup dla serwera usługi Mab obsługuje następujące scenariusze:
...
Przed kontynuowaniem upewnij się, że masz [zainstalowane i przygotowanie serwera usługi Azure Backup](backup-mabs-install-azure-stack.md) do ochrony obciążeń.
...
Zobacz [kopii zapasowych programu SQL Server w usłudze Azure Stack](backup-mabs-sql-azure-stack.md) artykułu.
