...
Przed kontynuowaniem upewnij się, że masz [zainstalowane i przygotować serwer kopii zapasowej Azure](backup-mabs-install-azure-stack.md) ochrony obciążeń.
...
Zobacz [kopii zapasowej programu SQL Server na stosie Azure](backup-mabs-sql-azure-stack.md) artykułu.
