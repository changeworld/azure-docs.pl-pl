...
Można chronić maksymalnie 2000 źródeł danych/elementów we wszystkich obciążeniach (IaaS VM, SQL, AFS itp.) w magazynie.
...
Tak. Aby przenieść magazyn Recovery Services, zapoznaj się z tym [artykułem](backup-azure-move-recovery-services-vault.md)
...
### <a name="if-a-backup-is-kept-for-a-long-time-does-it-take-more-time-to-recover-an-older-data-point"></a>Jeśli kopia zapasowa jest przechowywana przez dłuższy czas, czy odzyskiwanie starszego punktu danych trwa dłużej?
