...
Błąd | Możliwe przyczyny | Zalecane działania
--- | --- | ---
Bieżąca operacja nie powiodła się z powodu błędu usługi wewnętrznej "Zasób nie aprowizowany w sieczmię serwisowym". Po pewnym czasie ponów próbę wykonania operacji. (ID: 230006) | Zmieniono nazwę chronionego serwera. | <li> Zmień nazwę serwera z powrotem na oryginalną nazwę zarejestrowaną w przechowalni. <br> <li> Ponownie zarejestruj serwer w przechowalni z nową nazwą.
