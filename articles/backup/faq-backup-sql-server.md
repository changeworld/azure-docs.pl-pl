...
Ten artykuł zawiera odpowiedzi na często zadawane pytania dotyczące tworzenia kopii zapasowych SQL Server baz danych działających na maszynach wirtualnych platformy Azure, które korzystają z usługi [Azure Backup](backup-overview.md) .
...
4. W wystąpieniu programu SQL Server otwórz **Menedżera zadań**. Uruchom ponownie usługę **AzureWLBackupCoordinatorSvc**.<br/> <br/>
 Chociaż ta metoda pomaga, jeśli aplikacja do tworzenia kopii zapasowych zużywa wiele zasobów, SQL Server [Gubernatorów zasobów](https://docs.microsoft.com/sql/relational-databases/resource-governor/resource-governor?view=sql-server-2017) jest bardziej ogólnym sposobem określania limitów ilości procesora CPU, fizycznego wejścia/wyjścia i pamięci, które mogą być używane przez przychodzące żądania aplikacji.
...
Baza danych o ponownej nazwie jest traktowana jako nowa baza danych. W związku z tym usługa będzie traktować tę sytuację tak, jakby baza danych nie została znaleziona, a kopie zapasowe kończą się niepowodzeniem.
...
Baza danych, którą można [dodać do wystąpienia](backup-sql-server-database-azure-vms.md#enable-auto-protection) z ochroną chronioną, może nie być natychmiast widoczna w obszarze chronione elementy. Dzieje się tak, ponieważ odnajdywanie jest zazwyczaj uruchamiane co 8 godzin. Można jednak odnajdywać i chronić nowe bazy danych natychmiast, jeśli odnajdywanie zostanie wykonane ręcznie przez wybranie opcji **Odzyskaj baz danych**, jak pokazano na poniższej ilustracji.
