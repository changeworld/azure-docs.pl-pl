---
title: Tworzenie kopii zapasowych maszyn wirtualnych platformy Azure w magazynie Recovery Services przy użyciu Azure Backup
...
3. W obszarze **Zakres przechowywania**Określ, jak długo mają być przechowywane codziennie lub cotygodniowe punkty kopii zapasowych.
4. W obszarze **przechowywanie miesięcznego punktu kopii zapasowej**Określ, czy chcesz przechowywać kopię zapasową codziennych, czy cotygodniowych kopii zapasowych.
5. Kliknij przycisk **OK** , aby zapisać zasady.
...
6. W obszarze **zakresy portów docelowych**wybierz port.
    ...
    - Maszyna wirtualna korzystająca z usługi Managed disks: 8443.
...
2. Kliknij prawym przyciskiem myszy pozycję >  **reguły ruchu przychodzącego** **Nowa reguła**.
3. W obszarze **Typ reguły**wybierz > pozycję niestandardowa**dalej**.
...
Zamiast zezwalać na ruch wychodzący do wszystkich publicznych adresów internetowych, można określić zakres adresów`-DestinationPortRange`IP () lub użyć znacznika usługi Storage. region.   
