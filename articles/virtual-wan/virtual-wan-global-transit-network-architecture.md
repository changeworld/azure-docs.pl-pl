...
Gałąź do sieci wirtualnej jest ścieżką podstawową obsługiwaną przez wirtualną sieć WAN platformy Azure. Ta ścieżka umożliwia łączenie gałęzi z obciążeniami platformy Azure IAAS Enterprise, które są wdrożone w usłudze Azure sieci wirtualnych. Gałęzie mogą być połączone z wirtualną siecią WAN za pośrednictwem ExpressRoute lub sieci VPN typu lokacja-lokacja. Ruch do sieci wirtualnych podłączony do wirtualnych koncentratorów sieci WAN za pośrednictwem połączeń VNet.
