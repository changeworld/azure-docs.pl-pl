...
Pula SQL nie obsługuje obecnie [@@NESTLEVEL](/sql/t-sql/functions/nestlevel-transact-sql). W związku z tym należy śledzić poziom gniazda. Jest mało prawdopodobne, że przekroczysz limit poziomu ośmiu gniazd. Ale jeśli to zrobisz, należy przerobić kod, aby dopasować poziomy zagnieżdżenia w tym limicie.
