...
description: Dowiedz się, jak uwierzytelnić się w usłudze Azure Synapse Analytics przy użyciu usługi Azure Active Directory (AAD) lub uwierzytelniania programu SQL Server.
...
* Zarządzanie uprawnieniami do bazy danych przy użyciu zewnętrznych grup (AAD).
