...
- Odp.: Każdy skrypt automatyzacji, który odwołuje się do celu poziomu usług, należy zmienić na odpowiadający równoważniek Gen2.  Zobacz szczegóły [tutaj](upgrade-to-latest-generation.md#sign-in-to-the-azure-portal).
