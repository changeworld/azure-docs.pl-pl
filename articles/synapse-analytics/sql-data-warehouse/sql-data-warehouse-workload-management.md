...
Zarządzanie obciążeniem usługi SQL Analytics w usłudze Azure Synapse składa się z trzech koncepcji wysokiego poziomu: [klasyfikacja obciążenia,](sql-data-warehouse-workload-classification.md) [ważność obciążenia](sql-data-warehouse-workload-importance.md) i [izolacja obciążenia.](sql-data-warehouse-workload-isolation.md)  Te możliwości zapewniają większą kontrolę nad tym, jak obciążenie wykorzystuje zasoby systemowe.
