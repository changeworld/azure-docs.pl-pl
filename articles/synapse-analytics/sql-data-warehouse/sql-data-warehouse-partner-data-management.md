...
description: Listy partnerów do zarządzania danymi innych firm z rozwiązaniami obsługującymi usługę Azure Synapse Analytics.
...
| ------- | ----------- | -------------------- |
| ![Coffing Data Warehousing](./media/sql-data-warehouse-partner-data-management/coffing-data-warehousing-logo.png) |**Coffing Data Warehousing**<br>Coffing Data Warehousing zapewnia Nexus Chameleon, narzędzie z 10 lat projektowania dedykowane do systemów zapytań. Nexus jest dostępny jako narzędzie kwerendy dla puli SQL Usługi Azure Synapse. Nexus umożliwia wykonywanie zapytań na wewnętrznych i chmurowych komputerach oraz dołączanie danych na różnych platformach. Point-Click-Raport! |[Strona produktu](https://www.coffingdw.com/software/nexus/)<br> |
| ![Inbrein (wabrow)](./media/sql-data-warehouse-partner-data-management/inbrein-logo.png) |**Mikroerd inbreiny**<br>Inbrein MicroERD zapewnia narzędzia potrzebne do stworzenia precyzyjnego modelu danych, zmniejszenia nadmiarowości danych, zwiększenia wydajności i przestrzegania standardów. Korzystając z interfejsu użytkownika, który został opracowany w oparciu o rozległe doświadczenia użytkownika, modelarz może pracować nad modelami DB łatwo i wygodnie. Możesz stale korzystać z nowych i ulepszonych funkcji MicroERD poprzez szybkie ulepszenia funkcjonalne i aktualizacje. |[Strona produktu](http://microerd.com/)<br> |
| ![Infolibrarian](./media/sql-data-warehouse-partner-data-management/infolibrarian-logo.png) |**Infolibrarian (serwer zarządzania metadanymi)**<br>InfoLibrarian katalogi, przechowuje i zarządza metadanych, aby pomóc w rozwiązywaniu kluczowych punktów bólu zarządzania danymi. Ponadto Infolibrarian oferuje rozwiązania do zarządzania metadanymi, zarządzania danymi i oprogramowania do zarządzania zasobami do zarządzania metadanymi i publikowania ich z różnych narzędzi i technologii. |[Strona produktu](http://www.infolibcorp.com/metadata-management/software-tools)<br> [Azure Marketplace](https://azure.microsoft.com/marketplace/partners/infolibrarian/infolibrarian-metadata-management-server/)<br> |
