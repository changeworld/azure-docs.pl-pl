...
1. Wykonaj kroki opisane w temacie [tworzenie pierwszej maszyny Wirtualnej w laboratorium](devtest-lab-create-first-vm.md) umożliwiającą utworzenie maszyny wirtualnej.
