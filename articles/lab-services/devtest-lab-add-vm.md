...
Po zapisaniu można użyć szablonu Azure Resource Manager, aby [wdrożyć nowe maszyny wirtualne z Azure PowerShell](../azure-resource-manager/template-deployment-overview.md).
