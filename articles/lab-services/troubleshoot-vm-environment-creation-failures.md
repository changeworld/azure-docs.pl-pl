...
Jeśli Twoje środowisko lub maszyna wirtualna została utworzona za pomocą automatyzacji, ma jeden ostatnie miejsce do wyszukiwania informacji o błędzie. To dziennik wdrażania szablonu usługi Azure Resource Manager. Po utworzeniu zasobu laboratorium za pomocą automatyzacji go często odbywa się za pośrednictwem wdrażania szablonu usługi Azure Resource Manager. Zobacz[ https://github.com/Azure/azure-devtestlab/tree/master/Samples ](https://github.com/Azure/azure-devtestlab/tree/master/Samples) dla przykładowych szablonów usługi Azure Resource Manager, które tworzą zasoby usługi DevTest Labs. 
