...
1. W definicji wydania wybierz **dodawać zadania** a następnie na **Wdróż** kartę, należy dodać *usuwania maszyny Wirtualnej programu platformy Azure DevTest Labs* zadania. Skonfiguruj w następujący sposób:
...
* Jeśli to konieczne, zobacz [Rozwiązywanie problemów z usługi VSTS](https://docs.microsoft.com/vsts/build-release/actions/troubleshooting) strony.
