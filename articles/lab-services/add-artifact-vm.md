...
Poniższy skrypt dotyczy określonego artefaktu określoną maszynę Wirtualną. [Invoke AzureRmResourceAction](/powershell/module/azurerm.resources/invoke-azurermresourceaction?view=azurermps-6.13.0) polecenia jest tą, która wykonuje operację.  
