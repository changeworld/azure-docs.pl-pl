...
| ----------- | ------------ |  
| Obrazy z witryny Marketplace | Włącz obraz [Ubuntu Server 18,04 LTS](https://azuremarketplace.microsoft.com/marketplace/apps/Canonical.UbuntuServer1804LTS) do użycia w ramach Twojego konta laboratorium. Aby uzyskać więcej informacji, zobacz [Określanie obrazów z portalu Marketplace dostępnych dla twórców laboratorium](tutorial-setup-lab-account.md#specify-marketplace-images-available-to-lab-creators) | 
