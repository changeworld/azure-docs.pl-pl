...
3. **Zatrzymaj** maszynę wirtualną szablonu, wybierając pozycję **Zatrzymaj szablon**. 
4. Wykonaj kroki opisane w następnej sekcji, aby **opublikować** zaktualizowany szablon maszyny wirtualnej. 
...
4. Stan procesu publikowania można zobaczyć na stronie szablon. Poczekaj na zmianę stanu szablonu na **opublikowany**. 
