...
> [!Note]
> Przykłady kodu, przedstawiający definicje pól z analizatory języków, zobacz [definiowania indeksu (.NET)](https://docs.microsoft.com/azure/search/search-create-index-dotnet) i [definiowania indeksu (REST)](search-create-index-rest-api.md).
