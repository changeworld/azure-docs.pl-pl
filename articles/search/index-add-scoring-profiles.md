...
```  
 ...
 To zapytanie wyszukuje wystąpienia terminu "numer identyfikacyjny" i przekazuje w bieżącej lokalizacji. Należy pamiętać, że to zapytanie zawiera inne parametry takich jak `scoringParameter`. Parametry zapytania są opisane w [wyszukiwania dokumentów &#40;interfejsu API REST usługi Azure Search&#41;](https://docs.microsoft.com/rest/api/searchservice/Search-Documents).  
...
|`Functions`|Opcjonalny. Należy pamiętać, że funkcji oceniania można stosować tylko do pól, które są filtrowania.|  
