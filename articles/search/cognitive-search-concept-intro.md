...
> [!NOTE]
> Usługa cognitive search jest w publicznej wersji zapoznawczej i wykonywanie zestawu umiejętności jest obecnie oferowana za darmo. Cennik dla tej możliwości zostanie opublikowany w późniejszym czasie. 
