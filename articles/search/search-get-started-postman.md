...
description: Dowiedz się, jak wywoływać interfejsy API REST platformy Azure Wyszukiwanie poznawcze przy użyciu programu Poster oraz dane przykładowe i definicje.
author: HeidiSteen
manager: nitinme
ms.author: heidist
