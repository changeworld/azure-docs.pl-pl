...
![Alerty wyświetlane na pulpicie nawigacyjnym](media/iot-suite-remote-monitoring-maintain/dashboardalarm.png)

Aby zbadać problem, wybierz **Eksploruj Alert** opcję obok alertu:

![Eksploruj alert z poziomu pulpitu nawigacyjnego](media/iot-suite-remote-monitoring-maintain/dashboardexplorealarm.png)
...
![Szczegóły alertu](media/iot-suite-remote-monitoring-maintain/maintenancealarmdetail.png)
...
![Potwierdzić alerty](media/iot-suite-remote-monitoring-maintain/maintenanceacknowledge.png)
...
![Utwórz listę urządzeń, co powoduje alertu](media/iot-suite-remote-monitoring-maintain/maintenanceresponsibledevice.png)
