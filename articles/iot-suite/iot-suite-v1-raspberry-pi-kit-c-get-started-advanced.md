---
title: Łączenie urządzenia Raspberry Pi przy użyciu języka C do obsługi aktualizacji oprogramowania układowego pakietu Azure IoT Suite | Dokumentacja firmy Microsoft
...
---
# <a name="connect-your-raspberry-pi-3-to-the-remote-monitoring-solution-and-enable-remote-firmware-updates-using-c"></a>Łączenie z urządzeniem Raspberry Pi 3 z rozwiązaniem do zdalnego monitorowania i Włącz aktualizacje oprogramowania układowego zdalnego przy użyciu języka C
...
Zastąp wartości symboli zastępczych identyfikator i Centrum IoT Hub informacji o urządzeniu została utworzona i zapisana na początku tego samouczka.
...
Jeśli jeszcze tego nie zrobiono, zainstaluj wstępnie wymagane pakiety dla zestawu SDK urządzenia Microsoft Azure IoT dla języka C, uruchamiając następujące polecenia w terminalu na urządzenia Raspberry Pi:
...
Przykładowe rozwiązanie można teraz tworzyć na urządzenia Raspberry Pi:
