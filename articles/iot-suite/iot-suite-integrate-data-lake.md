...
1. W portalu Azure kliknij **powłoki chmury** przycisku.
    ...
    ![Ikona uruchamiania portalu](media/iot-suite-integrate-data-lake/portal-launch-icon.png)
...
1. Kliknij przycisk **Utwórz zasób**, wybierz Internetu rzeczy z witryny Marketplace i kliknij przycisk **zadanie usługi Stream Analytics**.
    ...
    ![Nowe zadanie analizy strumienia](media/iot-suite-integrate-data-lake/new-stream-analytics-job.png)
...
1. Kliknij przycisk **Utwórz**.
    ...
    ![Tworzenie zadania usługi analiza strumienia](media/iot-suite-integrate-data-lake/create-stream-analytics-job.png)
...
1. Na stronie Przegląd kliknij **dane wejściowe**.
    ...
    ![Strona przeglądu](media/iot-suite-integrate-data-lake/stream-analytics-overview.png)

1. Kliknij przycisk **dodać strumienia danych wejściowych** i wybierz **Centrum IoT** z listy rozwijanej.

    ![Dodawanie danych wejściowych](media/iot-suite-integrate-data-lake/stream-analytics-add-input.png)
...
1. Z odbiorców grupy listy rozwijanej wybierz utworzony wcześniej grupy odbiorców. W tym miejscu używamy **streamanalyticsjob**.
    ...
    ![Wybierz dane wejściowe](media/iot-suite-integrate-data-lake/stream-analytics-new-input.png)

1. Kliknij pozycję **Zapisz**.

1. Na stronie Przegląd kliknij **dane wyjściowe**.

    ![Dodawanie usługi Data Lake Store](media/iot-suite-integrate-data-lake/stream-analytics-overview-2.png)

1. Kliknij przycisk **Dodaj** i wybierz **usługi Data Lake Store** z listy rozwijanej.

    ![Dodawanie danych wyjściowych](media/iot-suite-integrate-data-lake/stream-analytics-output.png)
...
1. Wprowadź w polu format daty **/streaming/ {date} / {time}**. Pozostaw domyślny format RRRR/MM/dd. daty i czasu formacie gg.
    ...
    ![Podaj struktury folderów](media/iot-suite-integrate-data-lake/stream-analytics-new-output.png)
...
1. Kliknij przycisk **autoryzować**.
    ...
    ![Autoryzowanie usługi Stream Analytics do usługi Data Lake Store](media/iot-suite-integrate-data-lake/stream-analytics-out-authorize.png)
...
1. Na karcie Ogólne kliknij **edycji zapytania**.
    ...
    ![Edytuj zapytanie](media/iot-suite-integrate-data-lake/stream-analytics-edit-query.png)
...
1. W edytorze zapytań zastąp [YourOutputAlias] i symboli zastępczych [YourInputAlias] z wartości zdefiniowanych w wcześniej.
    ...
    ![Zapytanie usługi analiza strumienia](media/iot-suite-integrate-data-lake/stream-analytics-query.png)
...
1. Na karcie Ogólne kliknij **Start**.
    ...
    ![Uruchom zadania usługi analiza strumienia](media/iot-suite-integrate-data-lake/stream-analytics-start.png)
...
1. Kliknij przycisk **Start**.
    ...
    ![Wybierz datę niestandardowych](media/iot-suite-integrate-data-lake/stream-analytics-start-custom.png)
    ...
    ![Uruchomione zadanie](media/iot-suite-integrate-data-lake/stream-analytics-running.png)
...
1. W Eksploratorze danych Drąż w dół do **przesyłania strumieniowego audio /** folderu. Wyświetlona zostanie utworzony w formacie RRRR/MM/DD/HH folderów.
    ...
    ![Eksploruj dane przesyłane strumieniowo](media/iot-suite-integrate-data-lake/data-lake-store-data-explorer.png)

    Zostanie wyświetlone pliki z jednego pliku na godzinę w formacie json.

    ![Eksploruj dane przesyłane strumieniowo](media/iot-suite-integrate-data-lake/data-lake-store-file-preview.png)
