---
title: Instalowanie usługi Azure IoT Edge w Windows za pomocą kontenerów systemu Linux | Dokumentacja firmy Microsoft
description: Instrukcje instalacji usługi Azure IoT Edge na urządzeniach Windows skonfigurowana dla kontenerów systemu Linux
author: kgremban
manager: philmea
ms.reviewer: veyalla
ms.service: iot-edge
