...
* Wykonaj pełne przekazywanie obiektów BLOB (przy użyciu `Put Blob` operacji) i przekazywanie na poziomie bloku (przy użyciu operacji `Put Block`, `Put Block List` i `Append Block`).
