...
W tym samouczku pokazano, jak utworzyć moduł **C#** w programie przy użyciu **programu Visual Studio 2019** i wdrożyć go na **urządzeniu z systemem Windows**. Jeśli tworzysz moduły dla urządzeń z systemem Linux, przejdź do [obszaru C# opracowywanie modułu IoT Edge dla urządzeń z systemem Linux](tutorial-csharp-module.md) .
