---
title: Uczenie i wdrażanie modelu — Machine Learning na Azure IoT Edge | Microsoft Docs
description: Uczenie modelu uczenia maszynowego przy użyciu Azure Machine Learning, a następnie pakowanie modelu jako obrazu kontenera, który można wdrożyć jako moduł Azure IoT Edge.
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 06/13/2019
