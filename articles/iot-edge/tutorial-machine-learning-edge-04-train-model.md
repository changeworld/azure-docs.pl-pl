...
description: 'Samouczek: uczenie modelu uczenia maszynowego przy użyciu Azure Machine Learning, a następnie pakowanie modelu jako obrazu kontenera, który można wdrożyć jako moduł Azure IoT Edge.'
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 11/11/2019
