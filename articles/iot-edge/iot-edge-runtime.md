...
![Centrum usługi Edge jest brama między urządzeniami fizycznymi i IoT Hub](./media/iot-edge-runtime/Gateway.png)
...
![Centrum usługi Edge usprawnia komunikację na moduł](./media/iot-edge-runtime/module-endpoints.png)
...
![Trasy między modułami przechodzą przez Centrum usługi Edge](./media/iot-edge-runtime/module-endpoints-with-routes.png)
