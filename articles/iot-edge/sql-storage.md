...
3. Zastąp `<docker registry address>` z adresem w samouczku ukończone [wdrażanie funkcji platformy Azure jako moduł krawędzi IoT](tutorial-deploy-function.md).
