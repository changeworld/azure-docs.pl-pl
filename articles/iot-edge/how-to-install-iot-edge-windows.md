...
>
> W celu obejścia tego problemu Użyj polecenia `Stop-Service iotedge`, aby zatrzymać wszystkie uruchomione moduły IoT Edge przed użyciem tych stanów. 
...
* [Tworzenie i Inicjowanie symulowanego urządzenia brzegowego modułu TPM w systemie Windows](how-to-auto-provision-simulated-device-windows.md)
...
Aby uzyskać więcej informacji na temat tych opcji aktualizacji, użyj polecenia `Get-Help Update-IoTEdge -full` lub zapoznaj się ze [wszystkimi parametrami instalacji](#all-installation-parameters).
