---
title: Samouczek — opracowywanie C# modułu dla systemu Linux przy użyciu Azure IoT Edge
...
W tym samouczku pokazano, jak utworzyć moduł **C#** w programie przy użyciu **Visual Studio Code** i wdrożyć go na **urządzeniu z systemem Linux**. Jeśli tworzysz moduły dla urządzeń z systemem Windows, przejdź do [obszaru C# opracowywanie modułu IoT Edge dla urządzeń z systemem Windows](tutorial-csharp-module-windows.md) .
