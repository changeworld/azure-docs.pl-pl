...
## [Korzystanie z usługi Key Vault z poziomu aplikacji internetowej](key-vault-use-from-web-application.md)
# Przykłady
...
## Node.js
### [Zarządzanie magazynem](https://docs.microsoft.com/javascript/api/azure-keyvault/index?view=azure-node-latest)
### [Zarządzanie zawartością magazynu](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/index?view=azure-node-latest)
...
### [Rozpoczynanie pracy z certyfikatami](certificate-scenarios.md)
### [Metody tworzenia certyfikatów](create-certificate.md)
...
## [Funkcje danych klienta](key-vault-customer-data.md)
## [Wspólne parametry i nagłówki](common-parameters-and-headers.md)
## [Wersje magazynu kluczy](key-vault-versions.md)
## [Harmonogram działania dla platformy Azure](https://azure.microsoft.com/roadmap/?category=security-identity)
## [Blog](http://blogs.technet.com/b/kv/)
## [Przykłady kodu](https://github.com/Azure-Samples?utf8=%E2%9C%93&q=key+vault&type=&language=)
