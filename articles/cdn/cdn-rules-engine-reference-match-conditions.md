---
title: Usługa Azure CDN reguł warunki dopasowań aparatu | Dokumentacja firmy Microsoft
description: Dokumentacja dotycząca usługi Azure Content Delivery Network reguł warunki dopasowań aparatu.
services: cdn
documentationcenter: ''
author: Lichard
manager: akucer
...
- Wartość pliku cookie: 
  ...
  - Wartość pliku cookie korzystać z zalet [wartości symboli wieloznacznych](cdn-rules-engine-reference.md#wildcard-values). 
...
Warunek dopasowania wyrażenia regularnego parametr plików Cookie definiuje nazwę pliku cookie i wartość. Możesz użyć [wyrażeń regularnych](cdn-rules-engine-reference.md#regular-expressions) do definiowania wartości żądanego pliku cookie. 
...
Regex    | Wybierz tę opcję, aby użyć [wyrażeń regularnych](cdn-rules-engine-reference.md#regular-expressions). Wyrażenia regularne są przydatne w przypadku definiowania wzorzec znaków.
...
- Ten warunek dopasowania obsługuje [wartości symboli wieloznacznych](cdn-rules-engine-reference.md#wildcard-values).
...
- Wartość nagłówka: 
  - Wartość nagłówka korzystać z zalet [wartości symboli wieloznacznych](cdn-rules-engine-reference.md#wildcard-values).
  - Użyj **Ignoruj przypadek** opcja kontrolowania uwzględnianie wielkości liter dla porównania wartości nagłówka.
...
- Specyfikacja ścieżki adresu URL korzystać z zalet [wartości symboli wieloznacznych](cdn-rules-engine-reference.md#wildcard-values).
...
- Wartość nazwy pliku korzystać z zalet [wartości symboli wieloznacznych](cdn-rules-engine-reference.md#wildcard-values). Na przykład każdy wzorzec nazwy pliku może składać się z przynajmniej jednej gwiazdki (*), gdzie każdy gwiazdka odpowiada sekwencji co najmniej jeden znak.
...
Porównuje ścieżki adresu URL żądania do określonej [wyrażenia regularnego](cdn-rules-engine-reference.md#regular-expressions).
...
- Wartość określona dla ścieżki adresu URL korzystać z zalet [wartości symboli wieloznacznych](cdn-rules-engine-reference.md#wildcard-values). Każdy wzorzec ścieżki adresu URL może zawierać jeden lub więcej gwiazdek (*), gdzie każdy gwiazdki można dopasować sekwencji jednego lub większej liczby znaków.
...
- Może zawierać wartości parametrów [wartości symboli wieloznacznych](cdn-rules-engine-reference.md#wildcard-values).
...
Identyfikuje żądań, które zawierają parametr ciągu zapytania określona. Ten parametr jest ustawiona na wartość, która pasuje do określonej [wyrażenia regularnego](cdn-rules-engine-reference.md#regular-expressions).
