...
Istnieją trzy produkty Azure Content Delivery Network (CDN): **Azure CDN Standard from Akamai**, **Azure CDN Standard from Verizon** i **Azure CDN Premium from Verizon**. W poniższej tabeli przedstawiono porównanie funkcji dostępnych w poszczególnych produktach.

| **Funkcje wydajności i optymalizacje** | Standard Akamai | Standard Verizon | Premium Verizon |
| --- | --- | --- | --- |
...
||||
 **Bezpieczeństwo** | **Standard Akamai** | **Standard Verizon** | **Premium Verizon** | 
...
||||
| **Analiza i raportowanie** | **Standard Akamai** | **Standard Verizon** | **Premium Verizon** | 
...
||||
| **Łatwość obsługi** | **Standard Akamai** | **Standard Verizon** | **Premium Verizon** | 
...
\* Firma Verizon obsługuje bezpośrednie dostarczanie dużych plików i multimediów za pomocą optymalizacji ogólnego dostarczania w Internecie.
