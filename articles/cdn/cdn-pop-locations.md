---
title: Azure lokalizacje POP w sieci CDN według regionu | Dokumentacja firmy Microsoft
description: W tym artykule wymieniono lokalizacje POP w sieci CDN Azure, posortowane według regionu Azure CDN produktów.
services: cdn
documentationcenter: ''
author: dksimpson
manager: akucer
...
ms.locfileid: "34010588"
---
# <a name="azure-cdn-pop-locations-by-region"></a>Azure lokalizacje POP w sieci CDN według regionu
...
W tym artykule wymieniono bieżąca punktu z obecności (POP) z lokalizacji, posortowane według regionu Azure sieci dostarczania zawartości (CDN) produktów.

> [!IMPORTANT]
> Lokalizacje POP miasta **Azure CDN from Akamai** nie są indywidualnie ujawnione.  
> 
> Ponieważ każdego produktu Azure CDN ma różne sposób tworzenia jego infrastruktury sieci CDN w warstwie, firma Microsoft zaleca się przed przy użyciu lokalizacji POP podjęcie decyzji, które produktu Azure CDN do użycia. Zamiast tego należy wziąć pod uwagę swoje funkcje i wydajność użytkownika końcowego. Testowanie wydajności z każdego produktu Azure CDN, aby wybrać odpowiedniego produktu dla użytkowników. 
> 
...
| Azja | Hongkong<br />Osaka, Japonia<br />Tokio, Japonia<br />Kuala Lumpur, Malezji<br />Manila, Filipiny<br />Singapur<br />Seoul, Korea Południowa<br />Tajpej, Tajwan<br />Bangkok, Tajlandia | Hongkong<br />Batam, Indonesia<br />Jakarta, Indonesia<br />Osaka, Japonia<br />Tokio, Japonia<br />Singapur<br />Busan, Korea Południowa<br />Seoul, Korea Południowa<br />Kaohsiung, Tajwan | Hongkong<br />Indonezja<br />Japonia<br />Malezja<br />Filipiny<br />Singapur<br />Tajwan<br />Tajlandia<br />Wietnam |
| Australia i Nowa Zelandia | Melbourne, Australia<br />Sydney, Australia<br />Auckland, Nowa Zelandia | Melbourne, Australia<br />Sydney, Australia<br />Auckland, Nowa Zelandia | Australia<br />Nowa Zelandia |


## <a name="next-steps"></a>Kolejne kroki
* Aby uzyskać najnowsze adresy IP na listę dozwolonych podobnej, zobacz [interfejsu API usługi Azure CDN krawędzi węzłów](https://docs.microsoft.com/rest/api/cdn/edgenodes).
