...
> [!NOTE]
> Aplikacja logiki wymusza transport layer security (TLS) 1.2 podczas odbierania wywołania z powrotem do wyzwalacza lub akcji elementu webhook HTTP. Jeśli widzisz błędy uzgadniania SSL, upewnij się, że używasz protokołu TLS 1.2. W przypadku połączeń przychodzących oto obsługiwane mechanizmy szyfrowania:
>
