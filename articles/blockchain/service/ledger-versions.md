...
Przechowywanie wersji w kworum odbywa się za pomocą głównych i pomocniczych wersji. Na przykład jeśli wersja kworum to 2.0.1, typ wydania zostanie skategoryzowany w następujący sposób:

|Główne | Pomocnicza  | Poprawka  |
| :--- | :----- | :----- |
| 2 | 0 | 1 | 
