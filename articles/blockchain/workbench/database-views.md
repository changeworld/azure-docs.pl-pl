...
| StateName                          | nvarchar(50)  | Yes         | Jeśli ta właściwość zawiera stan zamówienia, jest nazwa wyświetlana stanu. Jeśli nie jest skojarzony ze stanem, wartość będzie równa null. |
