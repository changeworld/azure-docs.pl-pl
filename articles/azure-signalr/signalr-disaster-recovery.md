...
Rys. 1 Przed przejściem w tryb failover ![Przed przejściem w tryb failover](media/signalr-disaster-recovery/before-failover.png)

Rys. 2 Po przejściu w tryb failover ![Po przejściu w tryb failover](media/signalr-disaster-recovery/after-failover.png)

Rys. 3 Krótko po odzyskaniu wystąpienia podstawowego ![Krótko po odzyskaniu wystąpienia podstawowego](media/signalr-disaster-recovery/after-recover.png)
