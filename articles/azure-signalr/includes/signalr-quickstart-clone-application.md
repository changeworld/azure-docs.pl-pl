...
ms.locfileid: "67183600"
---
## <a name="clone-the-sample-application"></a>Klonowanie przykładowej aplikacji

W czasie, gdy usługa jest wdrażana, przejdźmy do pracy z kodem. Sklonuj [przykładową aplikację z witryny GitHub](https://github.com/Azure-Samples/signalr-service-quickstart-serverless-chat), ustaw parametry połączenia usługi SignalR Service i uruchom aplikację lokalnie.
