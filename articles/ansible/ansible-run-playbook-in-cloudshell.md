...
ms.service: ansible
keywords: ansible, azure, metodyki devops, bash, cloudshell, podręcznikowym, bash
author: tomarcher
manager: routlaw
ms.author: tarcher
ms.date: 02/01/2018
