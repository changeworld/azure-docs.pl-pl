...
[Funkcja Azure App Service Web Apps](https://docs.microsoft.com/azure/app-service/app-service-web-overview) (lub po prostu Web Apps) hostuje aplikacje internetowe, interfejsy API REST i zaplecze aplikacji mobilnych. Możesz programować w ulubionym języku &mdash; .NET, .NET Core, Java, Ruby, Node.js, PHP lub Python.
