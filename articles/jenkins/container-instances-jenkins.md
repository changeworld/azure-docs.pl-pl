...
Aby uzyskać więcej informacji na temat Azure Container Instances, zobacz [Informacje o Azure Container Instances](../container-instances/container-instances-overview.md).
...
4. W przypadku integracji głównej usługi wybierz opcję **automatycznie (msi)** , aby [zarządzane tożsamości dla zasobów platformy Azure](../active-directory/managed-identities-azure-resources/overview.md) automatycznie utworzyły tożsamość uwierzytelniania dla wystąpienia Jenkins. Wybierz pozycję **ręcznie** , aby podać własne poświadczenia nazwy głównej usługi.
