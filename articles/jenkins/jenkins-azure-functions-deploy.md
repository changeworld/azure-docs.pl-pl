...
1. Wprowadź adres URL repozytorium narzędzia SCM oraz ścieżkę skryptu przy użyciu dostarczonego [przykładowego skryptu](https://github.com/VSChina/odd-or-even-function/blob/master/doc/resources/jenkins/JenkinsFile).
