...
- Dla danych magazynowanych za pomocą [technologii transparent data encryption](http://go.microsoft.com/fwlink/?LinkId=526242).
...
-   [Usługa Azure Key Vault z programem SQL Server w Maszynie wirtualnej platformy Azure](http://blogs.technet.com/b/kv/archive/2015/01/12/using-the-key-vault-for-sql-server-encryption.aspx), jeśli potrzebujesz sprzętowego modułu zabezpieczeń lub centralnego zarządzania hierarchią kluczy szyfrowania.
