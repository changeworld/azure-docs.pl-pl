---
title: Zakres inspekcji usług platformy Azure w FedRAMP i DoD SRG
description: Ten artykuł zawiera tabele dla usług Azure Public i Azure Government, które ilustrują, co FedRAMP (umiarkowany a Wysoka) i DoD SRG (poziom wpływu na 2, 4 lub 5) w zakresie inspekcji osiągnięto daną usługę.
author: Jain-Garima
ms.author: gjain
ms.date: 5/17/2019
ms.topic: article
...
ms.locfileid: "71076616"
---
# <a name="azure-services-by-fedramp-and-dod-cc-srg-audit-scope"></a>Zakres inspekcji usług platformy Azure według FedRAMP i DoD CC SRG

Usługi w chmurze dla instytucji rządowych firmy Microsoft spełniają wymagania dotyczące wymagań programu zarządzania autoryzacją w & Stanach Zjednoczonych (FedRAMP) i Departamentu Obrony USA, od poziomów wpływu na informacje od 2 do 5. Przez wdrożenie usług chronionych, w tym Azure Government, Office 365 w Stanach Zjednoczonych Instytucje rządowe i Dynamics 365 dla instytucji rządowych, federalne i obronne mogą korzystać z bogatej tablicy zgodnych usług.

Ten artykuł zawiera szczegółową listę usług w chmurze w zasięgu na platformie Azure publiczną i Azure Government dla ofert zgodności FedRAMP i DoD CC SRG.

#### <a name="terminologysymbols-used"></a>Używane terminologia/symbole

* DoD CC SRG = Departament Obrony w chmurze dotyczący wymagań zabezpieczeń
* IL = poziom wpływu
* FedRAMP = Federal Risk and Authorization Management Program  
* : heavy_check_mark: = wskazuje, że usługa osiągnęła ten zakres inspekcji.
* Planowana 2019 = wskazuje, że przegląd usługi jest w toku i osiągnie certyfikat w 2019.

## <a name="azure-public-services-by-audit-scope"></a>Usługi publiczne platformy Azure według zakresu inspekcji
| _Ostatnia aktualizacja: 2019 września_ |

| Usługa platformy Azure| DoD CC SRG IL 2 | FedRAMP Moderate | FedRAMP High | Planowana 2019 |
| ------------ |:---------------:|:----------------:|:------------:|:------------:|
...
| [Automatyzacja](https://azure.microsoft.com/services/automation/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Azure Active Directory (bezpłatna i podstawowa)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Azure Active Directory usługi aprowizacji](https://docs.microsoft.com/en-us/azure/active-directory/manage-apps/user-provisioning)| :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Zaawansowana ochrona przed zagrożeniami na platformie Azure](https://azure.microsoft.com/features/azure-advanced-threat-protection/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Interfejs API platformy Azure dla usługi FHIR](https://azure.microsoft.com/services/azure-api-for-fhir/) |  |  |  | :heavy_check_mark: |
...
| [Usługi Azure Cosmos DB](https://azure.microsoft.com/services/cosmos-db/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Eksplorator danych platformy Azure](https://azure.microsoft.com/services/data-explorer/) | |  |  | :heavy_check_mark: |
| [Usługa Azure Data Lake Storage 1. generacji](https://azure.microsoft.com/services/storage/data-lake-storage/) |  |  |  | :heavy_check_mark: |
...
| [Dedykowany moduł HSM platformy Azure](https://azure.microsoft.com/services/azure-dedicated-hsm/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Azure DevOps (dawniej VSTS)](https://azure.microsoft.com/services/devops/) | |  |  | |
| [Azure DevTest Labs](https://azure.microsoft.com/services/devtest-lab/) |  |  |  | :heavy_check_mark: |
| [System DNS platformy Azure](https://azure.microsoft.com/services/dns/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Moje drzwi platformy Azure](https://azure.microsoft.com/services/frontdoor/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Usługa Azure Intune](https://docs.microsoft.com/intune/what-is-intune) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Usługa Azure Kubernetes Service (AKS)](https://azure.microsoft.com/services/kubernetes-service/) | |  |  | :heavy_check_mark: |
...
| [Azure Service Manager (frontonu reddog)](https://docs.microsoft.com/previous-versions/azure/ee460799(v=azure.100)) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Wskaźnik na platformie Azure](https://azure.microsoft.com/services/azure-sentinel/) |  |  |  | :heavy_check_mark: |
| [Azure Site Recovery](https://azure.microsoft.com/services/site-recovery/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Tworzenie kopii zapasowych](https://azure.microsoft.com/services/backup/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Cognitive Services: Przetwarzanie obrazów](https://azure.microsoft.com/services/cognitive-services/computer-vision/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Cognitive Services: Stoi](https://azure.microsoft.com/services/cognitive-services/face/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Cognitive Services: Usługi mowy](https://azure.microsoft.com/services/cognitive-services/directory/speech/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Cognitive Services: Analiza tekstu](https://azure.microsoft.com/services/cognitive-services/text-analytics/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Cognitive Services: Tłumaczenie tekstu w usłudze Translator](https://azure.microsoft.com/services/cognitive-services/speech-translation/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Wykaz danych](https://azure.microsoft.com/services/data-catalog/) |  |  |  | :heavy_check_mark: |
| [Fabryka danych](https://azure.microsoft.com/services/data-factory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Dynamics 365 dla finansów i operacji](https://dynamics.microsoft.com/en-us/finance-and-operations/overview/) |  |  |  | :heavy_check_mark: |
| [Event Grid](https://azure.microsoft.com/services/event-grid/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Zaawansowana ochrona przed zagrożeniami w usłudze Microsoft Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Przepływ](https://docs.microsoft.com/flow/getting-started) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Funkcje](https://azure.microsoft.com/services/functions/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | |
| [HDInsight](https://azure.microsoft.com/services/hdinsight/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Importuj/Eksportuj](https://azure.microsoft.com/services/storage/import-export/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Centrala IoT](https://azure.microsoft.com/services/iot-central/) |  |  |  | :heavy_check_mark: |
| [IoT Hub](https://azure.microsoft.com/services/iot-hub/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Usługa Key Vault](https://azure.microsoft.com/services/key-vault/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Network Watcher Analiza ruchu](https://docs.microsoft.com/azure/network-watcher/traffic-analytics) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Pamięć podręczna Redis](https://azure.microsoft.com/services/cache/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Magazyn: Liczba](https://azure.microsoft.com/services/storage/blobs/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Magazyn: Dyski (w tym Managed Disks)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Magazyn: Plikach](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Magazyn: Tworzone](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Magazyn: Tabelę](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Virtual Machines (łącznie z wystąpieniami zarezerwowanymi)](https://azure.microsoft.com/services/virtual-machines/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
## <a name="azure-government-services-by-audit-scope"></a>Azure Government usług według zakresu inspekcji
| _Ostatnia aktualizacja: 2019 września_ |

| Usługa platformy Azure | DoD CC SRG IL 2 | DoD CC SRG IL 4 | DoD CC SRG IL 5 | FedRAMP High | Planowana 2019
| ------------- |:---------------:|:---------------:|:---------------:|:------------:|:------------:
...
| [Automatyzacja](https://azure.microsoft.com/services/automation/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: |
| [Azure Active Directory (bezpłatna i podstawowa)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Zaawansowana ochrona przed zagrożeniami na platformie Azure](https://azure.microsoft.com/features/azure-advanced-threat-protection/)  |  |  |  |  | :heavy_check_mark:
...
| [Usługi Azure Cosmos DB](https://azure.microsoft.com/services/cosmos-db/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Azure Cost Management](https://azure.microsoft.com/services/cost-management/)  |  |  |  |  | :heavy_check_mark:
...
| [Azure DB dla MySQL](https://azure.microsoft.com/services/mysql/)| :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Azure DB dla PostgreSQL](https://azure.microsoft.com/services/postgresql/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Azure DB dla MariaDB](https://azure.microsoft.com/services/mariadb/)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [System DNS platformy Azure](https://azure.microsoft.com/services/dns/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Azure Firewall](https://azure.microsoft.com/services/azure-firewall/) |  |  |  |  | :heavy_check_mark:
| [Moje drzwi platformy Azure](https://azure.microsoft.com/services/frontdoor/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Usługa Azure Intune](https://docs.microsoft.com/intune/what-is-intune) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Usługa Azure Kubernetes Service (AKS)](https://azure.microsoft.com/services/kubernetes-service/) |  |  |  |  | :heavy_check_mark:
...
| [Azure Service Manager (frontonu reddog)](https://docs.microsoft.com/previous-versions/azure/ee460799(v=azure.100)) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Tworzenie kopii zapasowych](https://azure.microsoft.com/services/backup/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Cognitive Services: Przetwarzanie obrazów](https://azure.microsoft.com/services/cognitive-services/computer-vision/)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Cognitive Services: Stoi](https://azure.microsoft.com/services/cognitive-services/face/)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Cognitive Services: Usługi mowy](https://azure.microsoft.com/services/cognitive-services/directory/speech/) |  |  |  |  | :heavy_check_mark:
| [Cognitive Services: Analiza tekstu](https://azure.microsoft.com/services/cognitive-services/text-analytics/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Cognitive Services: Tłumaczenie tekstu w usłudze Translator](https://azure.microsoft.com/services/cognitive-services/speech-translation/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Przepływ](https://docs.microsoft.com/flow/getting-started) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Funkcje](https://azure.microsoft.com/services/functions/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Importuj/Eksportuj](https://azure.microsoft.com/services/storage/import-export/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [IoT Hub](https://azure.microsoft.com/services/iot-hub/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Usługa Key Vault](https://azure.microsoft.com/services/key-vault/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Zaawansowana ochrona przed zagrożeniami w usłudze Microsoft Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Pamięć podręczna Redis](https://azure.microsoft.com/services/cache/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Magazyn: Liczba](https://azure.microsoft.com/services/storage/blobs/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Magazyn: Dyski (w tym Managed Disks)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Magazyn: Plikach](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Magazyn: Tworzone](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Magazyn: Tabelę](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
**&ast;** Niektóre usługi, takie jak Azure Portal i Azure Resource Manager nie przechowują ani nie przetwarzają zawartości DoD CC SRG IIL 5, jednak nadal dziedziczą zestaw kontrolek IIL5.
