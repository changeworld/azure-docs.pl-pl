---
title: Zabezpieczenia platformy Azure i zgodności planu — magazynu danych na potrzeby FFIEC
description: Zabezpieczenia platformy Azure i zgodności planu — magazynu danych na potrzeby FFIEC
services: security
author: meladie
...
ms.locfileid: "60609199"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-ffiec-financial-services"></a>Zabezpieczenia platformy Azure i zgodności planu: Magazyn danych dla usług finansowych FFIEC

## <a name="overview"></a>Omówienie

Tych samych zabezpieczeń platformy Azure i zgodności planu znajdują się wskazówki dotyczące wdrażania architektury magazynu danych na platformie Azure jest odpowiedni dla zbierania, przechowywania i pobierania danych finansowych regulowane przez Radę Federalną badania instytucji finansowych (FFIEC).
...
![Magazyn danych dla FFIEC referencyjny diagram architektury](images/ffiec-dw-architecture.png "magazynu danych na potrzeby FFIEC referencyjny diagram architektury")
...
Diagram przepływu danych dla tej architektury referencyjnej jest dostępne dla [Pobierz](https://aka.ms/ffiec-dw-tm/) lub znajdują się poniżej. Ten model może pomóc klientom w zrozumieniu punkty potencjalne ryzyko w ramach infrastruktury systemu podczas wprowadzania zmian.

![Data Warehouse, model zagrożeń FFIEC](images/ffiec-dw-threat-model.png "magazynu danych na potrzeby FFIEC model zagrożeń")
...
[Zabezpieczeń platformy Azure i zgodności planu — macierz wdrożenia magazynu danych FFIEC](https://aka.ms/ffiec-dw-cim) zawiera informacje, na które FFIEC cele są rozwiązywane przez architektury magazynu danych, w tym szczegółowy opis działania Implementacja spełnia wymagania każdego celu objętego usługą.
