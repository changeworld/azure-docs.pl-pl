---
title: Strategia zabezpieczeń i zgodności z przepisami platformy Azure — analiza danych dla FFIEC
description: Strategia zabezpieczeń i zgodności z przepisami platformy Azure — analiza danych dla FFIEC
services: security
author: meladie
...
![Analiza diagramu architektury referencyjnej FFIEC](images/ffiec-analytics-architecture.png "Analiza diagramu architektury referencyjnej FFIEC")
...
Diagram przepływu danych dla tej architektury referencyjnej jest dostępny do [pobrania](https://aka.ms/ffiec-analytics-tm) lub można go znaleźć poniżej. Ten model może pomóc klientom zrozumieć punkty potencjalnego ryzyka w infrastrukturze systemu podczas wprowadzania modyfikacji.

![Analiza dla modelu zagrożeń FFIEC](images/ffiec-analytics-threat-model.png "Analiza dla modelu zagrożeń FFIEC")
...
[Macierz implementacji usługi FFIEC Data Analytics —](https://aka.ms/ffiec-analytics-cim) informacje o tym, które cele FFIEC są rozwiązywane przez architekturę analizy danych, łącznie z szczegółowymi opisami tego, jak implementacja strategia zabezpieczeń i zgodności z przepisami platformy Azure spełnia wymagania poszczególnych zamierzeń objętych usługą.
