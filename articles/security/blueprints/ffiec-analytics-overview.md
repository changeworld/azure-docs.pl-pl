---
title: Zabezpieczenia platformy Azure i zgodności planu — analiza danych dla FFIEC
description: Zabezpieczenia platformy Azure i zgodności planu — analiza danych dla FFIEC
services: security
author: meladie
...
ms.locfileid: "60585883"
---
# <a name="azure-security-and-compliance-blueprint-analytics-for-ffiec-financial-services"></a>Zabezpieczenia platformy Azure i zgodności planu: Analiza dla usług finansowych FFIEC

## <a name="overview"></a>Omówienie

Tych samych zabezpieczeń platformy Azure i zgodności planu znajdują się wskazówki dotyczące wdrażania architektury analizy danych na platformie Azure jest odpowiedni dla zbierania, przechowywania i pobierania danych finansowych regulowane przez Radę Federalną badania instytucji finansowych (FFIEC).
...
![Diagram architektury dokumentacja usługi analizy dla FFIEC](images/ffiec-analytics-architecture.png "analizy FFIEC odwołania diagram architektury")
...
**Usługa Azure Machine Learning**: [Usługa Azure Machine Learning](https://docs.microsoft.com/azure/machine-learning/service/) to technika do nauki o danych, która zezwala na komputerach, aby korzystać z istniejących danych w celu przewidywania przyszłych zachowań, rezultatów i trendów.
...
Diagram przepływu danych dla tej architektury referencyjnej jest dostępne dla [Pobierz](https://aka.ms/ffiec-analytics-tm) lub znajdują się poniżej. Ten model może pomóc klientom w zrozumieniu punkty potencjalne ryzyko w ramach infrastruktury systemu podczas wprowadzania zmian.

![Analiza FFIEC zagrożeń modelu](images/ffiec-analytics-threat-model.png "FFIEC analizy zagrożeń modelu")

## <a name="compliance-documentation"></a>Dokumentacja zgodności

[Zabezpieczeń platformy Azure i zgodności planu — macierz odpowiedzialności klienta FFIEC](https://aka.ms/ffiec-crm) Wyświetla listę wszystkich celów wymagane przez FFIEC. Ta macierz szczegółowe informacje, czy odpowiedzialność firmy Microsoft, klienta i wykonania każdego celu lub współużytkowana przez dwa.

[Zabezpieczeń platformy Azure i zgodności planu — macierz wdrażania analizy danych FFIEC](https://aka.ms/ffiec-analytics-cim) zawiera informacje, na które FFIEC cele są rozwiązywane przez architektury analizy danych, w tym szczegółowy opis działania Implementacja spełnia wymagania każdego celu objętego usługą.
