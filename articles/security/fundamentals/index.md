---
title: Dokumentacja dotycząca podstaw zabezpieczeń platformy Azure
description: Dowiedz się więcej o zabezpieczeniach platformy Azure.
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "72792364"
---
# <a name="azure-security-fundamentals-documentation"></a>Dokumentacja dotycząca podstaw zabezpieczeń platformy Azure

Dowiedz się więcej o zabezpieczeniach platformy Azure.
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Tworzenie i wdrażanie bezpiecznych aplikacji</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">Najlepsze rozwiązania dotyczące bezpiecznego tworzenia</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Zabezpieczenia sieci na platformie Azure</a>
                            </li>
                            <li style="list-style: none;">
