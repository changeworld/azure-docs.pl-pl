...
### <a name="example"></a>Przykład
Przykład kontraktu operacji dla `ProtectionLevel.Sign` (dla kontrolki szczegółowej): poniżej przedstawiono przykład użycia `ProtectionLevel.Sign` na poziomie OperationContract:
