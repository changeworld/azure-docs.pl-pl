...
| **Centrum zdarzeń platformy Azure** | <ul><li>[Użyj poświadczeń uwierzytelniania na urządzeniu przy użyciu tokenów SaS](#authn-sas-tokens)</li></ul> |
...
| **Attributes**              | Wersja SQL — wszystkie |
...
## <a id="multi-factor-azure-admin"></a>Włączanie usługi Azure Multi-Factor Authentication dla administratorów platformy Azure
...
| **Faza SDL**               | Wdrażanie |  
| **Odpowiednie technologie** | Ogólnego |
| **Attributes**              | Środowisko — Azure  |
| **Wołują**              | [Scenariusze zabezpieczeń klastra Service Fabric](https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security) |
...
| **Faza SDL**               | Wdrażanie |  
| **Odpowiednie technologie** | Ogólnego |
| **Attributes**              | Środowisko — platforma Azure, środowisko autonomiczne |
...
W elemencie `<netMsmqBinding/>` pliku konfiguracji WCF poniżej nakazuje programowi WCF wyłączenie uwierzytelniania podczas nawiązywania połączenia z kolejką usługi MSMQ na potrzeby dostarczania komunikatów.
```
<bindings>
    <netMsmqBinding>
        <binding>
...
| **Attributes**              | Typ poświadczeń klienta — brak |
| **Wołują**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [wzmacnianie](https://community.microfocus.com/t5/UFT-Discussions/UFT-API-Test-with-WCF-wsHttpBinding/m-p/600927) |
...
| **Attributes**              | Nie dotyczy, wybór bramy — Azure IoT Hub |
...
| **Odpowiednie technologie** | Ogólnego |
| **Attributes**              | ND |
| **Wołują**              | [Sygnatury dostępu współdzielonego, część 1: zrozumienie modelu SAS](https://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/), [sygnatury dostępu współdzielonego, część 2: Tworzenie i używanie SAS z magazynem obiektów BLOB](https://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-2/), [jak delegować dostęp do obiektów na koncie przy użyciu sygnatur dostępu współdzielonego i zapisanego dostępu Zasady](https://azure.microsoft.com/documentation/articles/storage-security-guide/#_how-to-delegate-access-to-objects-in-your-account-using-shared-access-signatures-and-stored-access-policies) |
