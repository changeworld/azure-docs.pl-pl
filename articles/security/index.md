        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Dowiedz się więcej o zabezpieczeniach platformy Azure</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Rozważam zastosowanie platformy Azure w mojej firmie. Jakie zabezpieczenia oferuje platforma Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="http://aka.ms/sharedresponsibility">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Jak firma Microsoft dzieli się obowiązkami związanymi z bezpieczeństwem z moją organizacją?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-isolation">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Jak platforma Azure izoluje moje zasoby od innych klientów platformy Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-storage-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Omówienie zabezpieczeń magazynu</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-network-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Omówienie zabezpieczeń sieci</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-azure-encryption-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Omówienie szyfrowania danych</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-log-audit">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Jakie opcje monitorowania i rejestrowania są dostępne na platformie Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-encryption-atrest">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Jak platforma Azure zabezpiecza dane magazynowane?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Jak mogę zaszyfrować maszyny wirtualne platformy Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <h3>Oficjalne dokumenty</h3>
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="http://aka.ms/SecurityResponsepaper">Reagowanie na zdarzenia zabezpieczeń platformy Azure w chmurze</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-threat-detection">Zaawansowane wykrywanie zagrożeń na platformie Azure</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-network-security">Zabezpieczenia sieci na platformie Azure</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="cardPadding">
            <div class="card">
                <div class="cardText">
                     ...
                     <h3>Listy kontrolne</h3>
                     <ul class="noBullet">
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-database-security-checklist">Zabezpieczanie baz danych</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-operational-security-checklist">Bezpieczeństwo działania</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-service-fabric-security-checklist">Zabezpieczenia usługi Service Fabric</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Zgodność</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Zasoby i usługi</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a href="https://www.microsoft.com/en-us/trustcenter/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Centrum zaufania MSFT</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=security&page=1">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Partnerzy platformy Azure w zakresie zabezpieczeń</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-cyber-services">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Doradztwo z zakresu cyberbezpieczeństwa</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-pen-testing">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Testowanie penetracyjne</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Szyfrowanie dysków</p>
                        </div>
                    </div>
                </div>
            </div>
