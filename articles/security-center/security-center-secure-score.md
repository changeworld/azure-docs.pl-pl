...
Aby sprawdzić, które zalecenia mają największy wpływ na bezpieczeństwo, możesz wyświetlić trzy najważniejsze zalecenia na pulpicie nawigacyjnym Security Center lub sortować zalecenia w bloku listy rekomendacji przy użyciu **bezpiecznego wpływu na ocenę** . kolumna.
