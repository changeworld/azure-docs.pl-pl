...
|SQL|15|Należy włączyć Transparent Data Encryption baz danych SQL|Włącz technologię Transparent Data Encryption, aby chronić dane magazynowane i spełniać wymagania dotyczące zgodności.|
...
|SQL|20|Aprowizuj administratora usługi Azure AD dla programu SQL Server|Aby włączyć uwierzytelnianie usługi Azure AD, Udostępnij administratorowi usługi Azure AD dla programu SQL Server. Uwierzytelnianie usługi Azure AD umożliwia uproszczone zarządzanie uprawnieniami oraz scentralizowane zarządzanie tożsamościami użytkowników baz danych i innych usług firmy Microsoft.|
