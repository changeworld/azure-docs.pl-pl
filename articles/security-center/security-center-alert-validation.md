...
Aby uzyskać więcej informacji, zobacz [alerty zabezpieczeń w Azure Security Center](security-center-alerts-overview.md) i [Zarządzanie alertami zabezpieczeń i reagowanie na nie w programie Azure Security Center](security-center-managing-and-responding-alerts.md)
...
## Sprawdzanie poprawności alertu na maszynie wirtualnej z systemem Windows<a name="validate-windows"></a>
...
## Sprawdzanie poprawności alertu na maszynie wirtualnej z systemem Linux<a name="validate-linux"></a>
