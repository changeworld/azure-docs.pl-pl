...
> [!NOTE]
> Musisz mieć uprawnienia zapisu w obszarze roboczym wybranej do przechowywania niestandardowych alertu.
>
>
...
8.  Wybierz obszar roboczy, który chcesz monitorować przy użyciu tej reguły w **obszaru roboczego** pola, a następnie w **zapytania wyszukiwania** pola zapytanie, do którego chcesz użyć w celu uzyskania wyników. Musisz mieć uprawnienia zapisu w obszarze roboczym wybranej do przechowywania niestandardowych alertu. Wynik zapytania wyzwala alert. Zauważ, że po wpisaniu prawidłowego zapytania w prawym rogu tego pola pojawia się zielony znacznik wyboru:
