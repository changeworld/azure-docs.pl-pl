...
Połączenia wideo
* [Ochrona obciążeń w chmurze hybrydowej przy użyciu usługi Security Center](https://mva.microsoft.com/training-courses/hybrid-cloud-workload-protection-with-azure-security-center-18173?l=X4WqTA3jE_1106218965)
...
* [Ochrona maszyn wirtualnych w usłudze Azure Security Center](https://docs.microsoft.com/azure/security-center/security-center-virtual-machine-recommendations)
...
* [Ochrona aplikacji w usłudze Azure Security Center](https://docs.microsoft.com/azure/security-center/security-center-application-recommendations)
...
Aby zmniejszyć koszty i straty, ważne jest dysponowanie planem reagowania na takie zdarzenia jeszcze przed wystąpieniem ataku. Usługi Azure Security Center można używać na różnych etapach reagowania na zdarzenia.
...
* [Automatyzowanie reakcji przy użyciu podręcznika dotyczącego zabezpieczeń](https://docs.microsoft.com/azure/security-center/security-center-playbooks)

## <a name="advanced-cloud-defense"></a>Zaawansowana ochrona w chmurze

Maszyny wirtualne platformy Azure mogą wykorzystywać zaawansowane możliwości ochrony w chmurze w usłudze Security Center. Te możliwości obejmują dostęp JIT do maszyny wirtualnej oraz adaptacyjne kontrolki aplikacji.
...
Artykuły    
* [Zarządzanie dostępem maszyny wirtualnej przy użyciu funkcji „dokładnie na czas”](https://docs.microsoft.com/azure/security-center/security-center-just-in-time)
...
* [Podręcznik dotyczący zaleceń zapory aplikacji sieci Web (WAF) w usłudze Security Center](https://gallery.technet.microsoft.com/ASC-Playbook-Protect-38bd47ff)
...
* [Klienci pakietu OMS mogą teraz używać usługi Azure Security Center do ochrony obciążeń w chmurze hybrydowej](https://blogs.technet.microsoft.com/msoms/2017/09/25/oms-customers-can-now-use-azure-security-center-to-protect-their-hybrid-cloud-workloads/)
