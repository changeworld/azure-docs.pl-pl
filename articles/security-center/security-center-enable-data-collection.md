...
**Obszar roboczy: DefaultWorkspace-[identyfikator subskrypcji]-[geograficzna]<br> grupy zasobów: DefaultResouceGroup-[geograficzna]**
...
5.  Aby wdrożyć rozszerzeń na istniejących maszynach wirtualnych, postępuj zgodnie z instrukcjami [zbierać dane o maszynach wirtualnych Azure](../log-analytics/log-analytics-quick-collect-azurevm.md).
  ...
  >
6. Aby wdrożyć rozszerzenie przy użyciu programu PowerShell: skorzystaj z poniższego przykładu programu PowerShell:
