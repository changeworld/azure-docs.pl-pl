...
**Bezpośrednie rejestracje z datą rozpoczęcia wcześniejszą niż 1 maja 2018**: klienci z bezpośrednią umową Enterprise Azure (EA) są konfigurowani jako roczny cykl rozliczeniowy dla usług platformy Azure (z wyłączeniem usług Marketplace). Twój cykl rozliczeniowy jest oparty na dacie rocznicy. Data rocznicy to data wejścia w życie Twojej umowy. Aby otrzymać pierwszą fakturę nadwyżkową platformy Azure, musisz przekroczyć 150% swojego progu zobowiązania pieniężnego.  Gdy łączne użycie usług przekroczy 150% progu zobowiązania pieniężnego, nastąpi automatyczna konwersja na kwartalny cykl rozliczeniowy zgodnie z datą rocznicy.  Jeśli nie przekroczysz 150% progu zobowiązania pieniężnego, rejestracja pozostanie objęta rocznym cyklem rozliczeniowym, a faktura nadwyżkowa zostanie wstawiona na koniec roku zobowiązania.

**Bezpośrednie rejestracje z datą rozpoczęcia od 1 maja 2018**: użycie platformy Azure przez klienta i opłaty naliczane osobno faktury będą naliczane w comiesięcznym cyklu rozliczeniowym.  Opłaty, które nie są objęte zobowiązaniem pieniężnym platformy Azure, będą należne jako płatności nadwyżkowe.  

**Pośrednie rejestracje z rejestracją rozpoczętą przed 1 maja 2018**: pośredni klienci przedsiębiorstwa Azure (EA) są konfigurowani jako cykl rozliczeń kwartalnych.  Partner handlowy będzie wystawiać faktury bezpośrednio klientowi.  

**Pośrednie rejestracje z datą rozpoczęcia późniejszą od 1 maja 2018**: każda umowa pośrednia z datą rozpoczęcia większą lub równą 1 maja 2018 będzie rozliczana miesięcznie.  
...
### <a name="overage"></a>Użycie nadwyżkowe
...
Od cyklu rozliczeniowego przypadającego na kwiecień 2019 r. klienci zaczną otrzymywać pojedynczą fakturę dla platformy Azure, ponieważ połączyliśmy wszystkie opłaty za platformę Azure i witrynę Azure Marketplace w ramach jednej faktury, która zastępuje dwie oddzielne faktury. (Ta zmiana nie ma wpływu na klientów w Australii, Japonii lub Singapuru). W trakcie przejścia do faktury skonsolidowanej otrzymasz częściową fakturę w portalu Marketplace. Końcowa oddzielna faktura będzie zawierać opłaty za witrynę Marketplace sprzed daty aktualizacji rozliczeń. Opłaty za witrynę Marketplace po tej dacie będą widoczne na fakturze za platformę Azure. Po okresie przejściowym zobaczysz wszystkie opłaty za platformę Azure i witrynę Marketplace na skonsolidowanej fakturze.  
...
1. W tym wierszu zobaczysz kredyty zastosowane do rejestracji, a także krótkie wyjaśnienie na przykład: Umowa dotycząca poziomu usług kredyt.
...
### <a name="enterprise-msdn-devtest"></a>MSDN: tworzenie i testowanie (przedsiębiorstwo)
...
Nowe pomiary zaczęły obowiązywać w okresie między 27 stycznia a 28 stycznia 2016 r. W pliku CSV do wdrożenia w tym okresie przejściowym zobaczysz dwa elementy wierszy: jeden do użycia emitowany przez licznik a1 i drugi do użycia emitowanego na nowym dedykowanym mierniku odpowiadającym rozmiarowi wdrożenia.
...
- **Na podstawie braku użycia:** Opłata jednorazowa lub cykliczna opłata miesięczna, która jest niezależna od użycia.
...
- **Ogólnego przeznaczenia**: rozszerzona Power BI Pro dla oferty wersji próbnej pakietu zawartości "Microsoft Azure Enterprise" ("Oferta") jest dostępna dla istniejących użytkowników w ramach oferty, aby umożliwić im dostęp do pewnych szczegółowych informacji związanych z ich Microsoft Azurem zużyciem przez użycie określonego pakietu zawartości Power BI.
- **Uprawnienie**: Użytkownicy korzystający z Umowa Enterprise (EA) mogą uczestniczyć w ofercie, jeśli posiadają funkcję powiązaną z rozliczeniami, usługami, usługami i/lub zarządzaniem kosztami w Microsoft Azure organizacji.
- **Wykluczenia**:
  ...
  - Termin: Oferta rozpocznie się w dniu 1 czerwca 2017 i kończy 31 maja 2018.  Zgody można udzielić w dowolnym momencie 12-miesięcznego okresu, jednak oferta zostanie zakończona 31 maja 2018 r. dla wszystkich użytkowników niezależnie od tego, czy zaakceptowali Ofertę.
...
**Łączna liczba NIEPRZEtworzonych jednostek:** Zużyta ilość w raporcie szczegółowym użycia.
**MOCP zasób na jednostkę:** Nadrzędny system użycia emituje użycie dla każdej usługi w różnych jednostkach. Ustawion **Użycie na jednostkę:** Jednostka miary EA. Ustawion **Cena:** Cena jednostkowa z poziomu portalu Azure EA.
**Łączny koszt:** Przedłużony koszt z szczegółowego raportu użycia lub użycia zobowiązania + nadwyżka w portalu Azure EA.
