...
4. Znajdź adres URL na stronie **przeglądu bramy** ![zrzut ekranu PiggyMetrics uruchomionego](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
