---
title: 'Samouczek: Tworzenie, publikowanie, Odpowiedz QnA Maker'
...
Jeśli chcesz ograniczyć odpowiedź do tylko pytań, Dodaj właściwość `[rankerType](Learn more about [rankerType](../concepts/best-practices.md#choosing-ranker-type).
)` do treści, na przykład: 
