---
title: 'Szybki start: środowisko Node.js dla interfejsu API usługi QnA Maker (wersja 4)'
...
ms.locfileid: "49387416"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-nodejs"></a>Przewodnik Szybki start dotyczący interfejsu API usługi Microsoft QnA Maker przy użyciu środowiska Node.js 
<a name="HOLTop"></a>

W tym artykule dowiesz się, jak używać [interfejsu API usługi Microsoft QnA Maker](../Overview/overview.md) w środowisku Node.js do wykonywania poniższych czynności.
