---
title: Interfejs API REST (V4) — środowisko Node.js — QnA Maker
...
ms.locfileid: "50214991"
---
# <a name="qna-maker-rest-api-with-nodejs"></a>Interfejs API REST usługi QnA Maker przy użyciu środowiska Node.js 
<a name="HOLTop"></a>
