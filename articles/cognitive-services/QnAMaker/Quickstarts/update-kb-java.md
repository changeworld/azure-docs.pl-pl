---
title: Szybki start — aktualizowanie bazy wiedzy za pomocą języka Java — Azure Cognitive Services | Microsoft Docs
...
1. Będziesz potrzebować biblioteki [apache httpclient](http://hc.apache.org/downloads.cgi). Na przykład pobierz plik binarny HttpClient 4.x.x.tar.gz, aby znaleźć wszystkie pliki JAR, które musisz zaimportować do projektu.
