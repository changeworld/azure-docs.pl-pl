...
Aby uzyskać więcej informacji na temat programu Visual Studio i języka Python, zobacz [Work with Python in Visual Studio on Windows (Praca w języku Python w programie Visual Studio w systemie Windows)](https://docs.microsoft.com/en-us/visualstudio/python/overview-of-python-tools-for-visual-studio).
