...
1. W portalu QnA Maker wybierz usługę QnA Maker z listy rozwijanej. Jeśli utworzono nową usługę QnA Maker, pamiętaj o odświeżeniu strony.
...
1. Wybierz pozycję **Utwórz swoją KB**.
...
1. W portalu QnA Maker na stronie **Edycja** wybierz pozycję **Dodaj parę QNA**.
...
1. Na stronie tworzenia Azure Bot Service zostanie otwarta nowa karta przeglądarki dla Azure Portal. Skonfiguruj usługę Azure bot. 
    ...
    * Bot i QnA Maker mogą korzystać z planu usługi aplikacji sieci Web, ale nie mogą udostępniać aplikacji sieci Web. Oznacza to, że **Nazwa aplikacji** dla bot musi być inna niż nazwa aplikacji dla usługi QNA Maker. 
...
* [Format promocji w odpowiedziach](../concepts/data-sources-supported.md)
* [Testowanie promocji](../concepts/data-sources-supported.md#testing-your-markdown)
* QnA Maker [źródła danych](../Concepts/data-sources-supported.md). 
