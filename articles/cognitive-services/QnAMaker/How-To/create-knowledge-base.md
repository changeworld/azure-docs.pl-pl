...
Aby uzyskać środki oszczędnościowe, możesz [udostępnić](set-up-qnamaker-service-azure.md#share-existing-services-with-qna-maker) kilka zasobów platformy Azure utworzonych dla QNA Maker.

> [!div class="nextstepaction"]
> [Dodawanie pytań za pomocą metadanych](../quickstarts/add-question-metadata-portal.md)
