...
|400|Błąd servererror, Subcode ResourceError: nie można skontaktować się z żądanym adresem URL|
|400|Błąd servererror, Subcode ResourceError: żądany adres URL nie zwrócił kodu sukcesu (w tym, czy zwrócił on HTTP 404)|
|400|InvalidRequest, kod podkodu zablokowany: żądany adres URL może zawierać zawartość dla dorosłych i został zablokowany|
