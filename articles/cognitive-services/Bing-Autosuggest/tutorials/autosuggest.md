---
title: 'Samouczek: Pobieranie automatycznych wyników sugestii przy użyciu interfejsu API autosuggest Bing'
titleSuffix: Azure Cognitive Services
description: W tym samouczku zostanie zbudowana strona sieci web, która umożliwia użytkownikom wykonywanie zapytań do interfejsu API autosuggestu Bing i wyświetla wyniki kwerendy.
...
---
# <a name="tutorial-get-search-suggestions-on-a-web-page"></a>Samouczek: Uzyskaj sugestie dotyczące wyszukiwania na stronie internetowej
...
Aby skorzystać z tego samouczka, potrzebny jest klucz subskrypcji interfejsu API automatycznego sugerowania Bing. Jeśli go nie masz, [utwórz zasób autosuggest Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingAutosuggest-v7) w witrynie Azure portal. Można również użyć [klucza próbnego](https://azure.microsoft.com/try/cognitive-services/).
...
Utwórz formularz HTML z polem tekstowym. Obsługa `oninput` zdarzenia i `bingAutosuggest()` wywołanie funkcji, przekazując zawartość pola tekstowego i klucza interfejsu API autosuggest Bing.
