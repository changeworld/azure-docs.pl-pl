...
Utwórz formularz HTML z polem tekstowym. Obsłuż zdarzenie `oninput` i wywołaj funkcję `bingAutosuggest()`, przekazując zawartość pola tekstowego i klucz interfejs API automatycznego sugerowania Bing.
