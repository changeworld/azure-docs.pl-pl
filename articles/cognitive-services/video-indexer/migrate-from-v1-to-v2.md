---
title: Migrowanie z interfejsu API indeksatora wideo platformy Azure w wersji 1 do 2 | Dokumentacja firmy Microsoft
...
Definicje interfejsu API indeksatora wideo zostały odpowiednio aktualizowana i są dostępne do pobrania za pośrednictwem [portal interfejsów API](https://api-portal.videoindexer.ai/docs/services/authorization/operations/Get-Account-Access-Token).
