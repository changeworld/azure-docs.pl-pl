...
> [!TIP]
> Aby poprawić czas oczekiwania, interfejs API Klasyfikacja jest uwidaczniany za pomocą protokołu HTTP zamiast HTTPS, podobnie jak w `http://ds.microsoft.com/api/v2/<appId>/rank/*`.
