...
> [!NOTE]
> ¹ LUIS, Video Indexer, analiza tekstu i zamiana mowy na tekst nie są obsługiwane.
...
Poniższe Cognitive Services są niezależny od języka i nie mają ograniczeń opartych na języku.

* [Personalizacja (wersja zapoznawcza)](https://docs.microsoft.com/azure/cognitive-services/personalizer/)
* [Detektor anomalii (wersja zapoznawcza)](https://docs.microsoft.com/azure/cognitive-services/anomaly-detector/overview)
