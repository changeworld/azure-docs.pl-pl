...
Przewodniki Szybki Start są również dostępne dla [mowy na tekst](quickstart-csharp-uwp.md) i [głosu pierwszego wirtualnego Asystenta](quickstart-virtual-assistant-csharp-uwp.md).
