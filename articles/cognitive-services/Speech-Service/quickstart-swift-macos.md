...
description: Dowiedz się, jak rozpoznawanie mowy w języku Swift w systemie macOS przy użyciu zestawu SDK rozpoznawania mowy
...
ms.locfileid: "67561517"
---
# <a name="quickstart-recognize-speech-in-swift-on-macos-using-the-speech-sdk"></a>Szybki start: Rozpoznawanie mowy w języku Swift w systemie macOS przy użyciu zestawu SDK rozpoznawania mowy

[!INCLUDE [Selector](../../../includes/cognitive-services-speech-service-quickstart-selector.md)]

W tym artykule dowiesz się, jak utworzyć aplikację dla systemu macOS w języku Swift transkrypcja mowy rejestrowane z mikrofonu do tekstu za pomocą Cognitive Services SDK rozpoznawania mowy.
...
Cognitive Services mowy zestawu SDK dla systemu macOS jest dystrybuowane jako pakiet framework.
