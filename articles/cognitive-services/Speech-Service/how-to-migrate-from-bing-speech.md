...
Funkcja | Rozpoznawanie mowy Bing | Usługa mowy | Szczegóły
-|-|-|-
C++ZESTAWIE | : heavy_minus_sign: | :heavy_check_mark: | Usługa Speech obsługuje systemy Windows i Linux.
Zestaw Java SDK | :heavy_check_mark: | :heavy_check_mark: | Usługa Speech obsługuje urządzenia z systemem Android i Speech.
...
Miejscowość punktu końcowego | Cały świat | Regionalna | Regionalne punkty końcowe poprawiają opóźnienia.
...
Jeśli ty lub Twoja organizacja ma aplikacje w programowaniu lub środowisku produkcyjnym, które używają interfejs API rozpoznawania mowy Bing, należy je zaktualizować tak szybko, jak to możliwe. Zobacz [dokumentację usługi Speech](index.md) dla dostępnych zestawów SDK, przykłady kodu i samouczki.
