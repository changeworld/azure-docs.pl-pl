...
Przewodniki Szybki Start są również dostępne dla [funkcji rozpoznawania mowy](quickstart-objectivec-ios.md).
...
1. Skompiluj i uruchom przykładowy kod w symulatorze systemu iOS, wybierając pozycję **Product** > **Run** (Produkt > Uruchom) z menu lub klikając przycisk **Play** (Odtwórz).
   ...
   ![Symulowana aplikacja systemu iOS](media/sdk/qs-objectivec-simulated-app-tts.png)
