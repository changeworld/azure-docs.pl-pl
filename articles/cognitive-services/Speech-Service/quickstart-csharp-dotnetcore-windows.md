...
1. W `Program.cs` plików w projekcie programu Visual Studio, Zastąp cały kod następującym kodem:
...
Wynik rozpoznawanie jest wyświetlany na ekranie.
