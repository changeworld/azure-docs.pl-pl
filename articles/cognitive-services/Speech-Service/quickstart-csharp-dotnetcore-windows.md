---
title: 'Szybki start: Rozpoznawanie mowy w języku C# na platformie .NET Core w systemie Windows za pomocą zestawu Speech SDK usługi Cognitive Services'
titleSuffix: Microsoft Cognitive Services
description: Dowiedz się, jak rozpoznawać mowę w języku C# na platformie .NET Core w systemie Windows za pomocą zestawu Speech SDK usługi Cognitive Services
