---
title: 'Szybki Start: konfiguracja zestawu C# Speech SDK dla platformy .NET Core — usługa mowy'
titleSuffix: Azure Cognitive Services
description: Skorzystaj z tego przewodnika, aby skonfigurować platformę dla C# platformy .NET Core w systemie Windows lub MACOS z zestawem SDK usługi Speech Service.
...
---
W tym przewodniku przedstawiono sposób instalowania [zestawu Speech SDK](~/articles/cognitive-services/speech-service/speech-sdk.md) dla C# platformy .NET Core. Jeśli chcesz, aby nazwa pakietu została już rozpoczęta, uruchom `Install-Package Microsoft.CognitiveServices.Speech` w konsoli NuGet.
