...
description: Skorzystaj z tego przewodnika, aby skonfigurować platformę dla C# platformy .NET Core w systemie Windows lub MACOS z zestawem SDK usługi Speech Services.
...
ms.locfileid: "73502499"
---
W tym przewodniku przedstawiono sposób instalowania [zestawu Speech SDK](~/articles/cognitive-services/speech-service/speech-sdk.md) dla C# platformy .NET Core.
