...
Przed zainicjowaniem obiektu `IntentRecognizer` należy utworzyć konfigurację, która korzysta z klucza i regionu LUIS Endpoing. Wstaw ten kod w metodzie `recognizeIntent()`.
...
W przypadku usługi similicity Zaczekamy na przyszłość.
...
W tym momencie kod powinien wyglądać następująco: (dodaliśmy Komentarze do tej wersji) [!code-cpp[](~/samples-cognitive-services-speech-sdk/quickstart/cpp/windows/intent-recognition/helloworld/helloworld.cpp?range=6-81)]
