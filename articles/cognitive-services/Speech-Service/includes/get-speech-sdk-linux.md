...
ms.locfileid: "80656571"
---
:::row:::
    :::column span="3":::
        Zestaw SDK mowy obsługuje tylko **Ubuntu 16.04/18.04**, **Debian 9**, **Red Hat Enterprise Linux (RHEL) 8**i **CentOS 7/8** na następujących architekturach docelowych, gdy jest używany z Linuksem:
        - x86
        - x64
        - ARM32
        - ARM64
...
# <a name="rhel-8-and-centos-78"></a>[RHEL 8 i CentOS 7/8](#tab/rhel-centos)
