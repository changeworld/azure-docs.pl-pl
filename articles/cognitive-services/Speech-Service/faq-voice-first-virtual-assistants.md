...
**Odp.:** W wersji zapoznawczej bezpośrednie mowy wiersz ma ograniczenia bardzo szczegółowych subskrypcja używana. Sprawdź, czy używasz **mowy** zasobów (Microsoft.CognitiveServicesSpeechServices, "Mowa") i *nie* **usług Cognitive Services** (zasobów Microsoft.CognitiveServicesAllInOne, "Wszystkie usługi Cognitive Services"). Ponadto należy pamiętać, że tylko **westus2** region jest obecnie obsługiwane.
...
**Odp.:** Rejestrowanie opartych na plikach zapewnia znacznie więcej szczegółów i mogą pomóc przyspieszyć żądania pomocy technicznej. Aby włączyć tę opcję, zobacz [jak używać rejestrowania w pliku](how-to-use-logging.md).
