...
description: >
  Przedstawia różne sposoby, aby rozpoznać intencje z wypowiedzi (z pliku z mikrofonu) przy użyciu zestaw SDK rozpoznawania mowy, języka C++.
