---
title: 'Szybki start: rozpoznawanie mowy w języku C++ w systemie Linux przy użyciu zestawu Speech SDK w usłudze Cognitive Services'
titleSuffix: Microsoft Cognitive Services
description: Dowiedz się, jak rozpoznawać mowę w języku C++ w systemie Linux przy użyciu zestawu Speech SDK w usłudze Cognitive Services
