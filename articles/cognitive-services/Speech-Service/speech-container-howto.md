...
Kontener zawiera punkt końcowy REST API, który można znaleźć [tutaj](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-apis#text-to-speech-api) i przykładów można znaleźć [tutaj](https://azure.microsoft.com/resources/samples/cognitive-speech-tts/).
