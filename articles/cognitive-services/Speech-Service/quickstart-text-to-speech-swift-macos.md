...
Przewodniki Szybki Start są również dostępne dla [funkcji rozpoznawania mowy](quickstart-swift-macos.md).
...
1. Zastąp ciąg `YourServiceRegion` z regionem skojarzonym z subskrypcją (na przykład `westus` dla subskrypcji bezpłatnej wersji próbnej).
