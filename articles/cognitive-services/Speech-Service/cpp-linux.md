...
> [!NOTE]
> Jeśli szukasz szybkiego startu dla języka C++ i Windows, przejdź [tutaj](cpp-windows.md).
...
Zamień klucz subskrypcji w kodzie, który został uzyskany.
...
Jeśli wszystko przebiegnie poprawnie, powinny być widoczne dane wyjściowe podobne do następującego:
