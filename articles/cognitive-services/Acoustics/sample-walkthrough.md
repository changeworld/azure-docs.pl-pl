...
Przykład obejmuje scenę pokaz **Assets/AcousticsDemo/ProjectAcousticsDemo.unity**. Ta sceny ma pojedyncze źródło audio spatialized odtwarzanie z przestawnym modułu (o nazwie **AudioHolder** w **hierarchii**). Aby skrypt rodzajowy nawigacji, kamera główny jest element podrzędny obiektu CameraHolder. 
...
Posłuchaj, jak brzmi sceny, klikając przycisk odtwarzania w programie Unity editor. Użyj W, A, S, D i myszy, aby poruszać się. Aby porównać, jak sceny brzmi z lub bez Akustyka, kliknij lewy przycisk myszy lub przycisk kontroler podstawowy. Aby przechodzić między różnymi źródłami dźwięku, kliknij prawym przyciskiem myszy lub przycisku Wstecz na kontrolerze.
