...
1. Klucz subskrypcji można uzyskać w witrynie Azure portal w jeden z dwóch sposobów:
    ...
    * Przejdź do [witryny Azure portal](https://ms.portal.azure.com), i Dodaj nowy interfejs API usług Cognitive, wyszukując _Cognitive Services_ , a następnie wybierając **interfejsy API usług Cognitive Services**.
