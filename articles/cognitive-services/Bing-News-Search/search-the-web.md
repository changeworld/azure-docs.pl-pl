---
title: Czym jest funkcja wyszukiwania wiadomości Bing? | Microsoft Docs
description: Pokazuje sposób wyszukiwania artykułów z wiadomościami w Internecie przy użyciu interfejsu API wyszukiwania wiadomości Bing.
...
ms.locfileid: "47096993"
---
# <a name="what-is-bing-news-search"></a>Czym jest funkcja wyszukiwania wiadomości Bing?

Interfejs API wyszukiwania wiadomości Bing zapewnia podobne (ale nie takie samo) środowisko co aplikacja [Wiadomości Bing](https://www.bing.com/news). Dzięki interfejsowi API wyszukiwania wiadomości Bing możesz wysłać zapytanie wyszukiwania i otrzymać listę stosownych artykułów z wiadomościami.

Jeśli tworzysz stronę z wynikami wyszukiwania składającą się z samych wiadomościami w celu znalezienia wiadomości odpowiednich dla zapytania wyszukiwania użytkownika, wywołaj ten interfejs API zamiast wywoływać bardziej ogólny [interfejs API wyszukiwania w Internecie Bing](../bing-web-search/search-the-web.md). Jeśli oprócz wiadomości chcesz otrzymać także inne typy zawartości, takie jak strony internetowe, obrazy i wideo, wywołaj interfejs API wyszukiwania w Internecie Bing.
...
## <a name="getting-general-news"></a>Pobieranie wiadomości ogólnych
...
Aby pobrać wiadomości z określonej domeny, należy użyć operatora zapytania [site:](http://msdn.microsoft.com/library/ff795613.aspx).

```http
GET https://api.cognitive.microsoft.com/bing/v7.0/news/search?q=sailing+dinghies+site:contososailing.com&mkt=en-us HTTP/1.1
```

Poniżej przedstawiono odpowiedź na poprzednie zapytanie. Każdy artykuł z wiadomościami należy wyświetlać w kolejności podanej w odpowiedzi. Jeśli artykuł zawiera klastrowane artykuły, należy wskazać, że pokrewne artykuły istnieją i wyświetlić je, jeśli użytkownik tego zażąda.
...
## <a name="getting-todays-top-news"></a>Pobieranie najważniejszych wiadomości z dnia dzisiejszego
...
## <a name="getting-news-by-category"></a>Pobieranie wiadomości według kategorii
...
## <a name="getting-headline-news"></a>Pobieranie wiadomości z nagłówków
...
## <a name="getting-trending-news"></a>Pobieranie popularnych wiadomości
