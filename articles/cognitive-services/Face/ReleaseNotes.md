...
* Dodano funkcję migawki, aby obsługiwać migrację danych między subskrypcjami: [Migawka](https://docs.microsoft.com/rest/api/cognitiveservices/face/snapshot). Więcej szczegółów w [jak przeprowadzić migrację danych twarzy do innej subskrypcji twarzy](Face-API-How-to-Topics/how-to-migrate-face-data.md).
