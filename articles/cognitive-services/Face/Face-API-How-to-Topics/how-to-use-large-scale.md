...
Na przykład w przypadku szkolenia grupy LargePersonGroup składającej się z 1 000 000 osób wartość elementu `timeIntervalInMilliseconds` może wynosić 60 000 (będzie zwana również interwałem 1-minutowym).
