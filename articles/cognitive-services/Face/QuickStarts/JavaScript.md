---
title: 'Szybki start: wykrywanie twarzy na obrazie — interfejs API rozpoznawania twarzy, język JavaScript'
...
ms.locfileid: "46129407"
---
# <a name="quickstart-detect-faces-in-an-image-using-javascript"></a>Szybki start: wykrywanie twarzy na obrazie przy użyciu języka JavaScript
...
3. Zmień wartość `uriBase`, aby użyć lokalizacji, z której uzyskano klucze subskrypcji, jeśli jest to konieczne.
4. Przeciągnij plik i upuść go w przeglądarce.
5. Kliknij przycisk `Analyze faces`.
