...
Dodaj następującą metodę do klasy **Program**. Służy ona do formatowania danych wejściowych w formacie JSON, aby można je było łatwiej odczytać. Aplikacja zapisze te dane ciągu do konsoli.
