...
|{BILLING_ENDPOINT_URI} | Rozliczeń wartości punktu końcowego, w tym regionie i routing twarzy.|`https://westcentralus.api.cognitive.microsoft.com/face/v1.0`|
