...
|Kod | Język | Kod | Język |
|-----|-----|-----|-----|
| ar EG | Arabski (Egipt), standard nowoczesne | w | Hindi (Indie) |
| ES urzędu certyfikacji | Kataloński | IT-IT | Włoski (Włochy)  |
| Akcelerator deweloperski w wersji DK | Duński (Dania) | ja-JP | Japoński (Japonia) |
| de-DE. | Niemiecki (Niemcy) |ko-KR | Koreański (Korea) |
| EN-AU | Angielski (Australia) |nb-NO | Norweski (Bokmal) (Norwegia)  |
| EN-CA | Angielski (Kanada) | NL-NL | Holenderski (Holandia)   |
