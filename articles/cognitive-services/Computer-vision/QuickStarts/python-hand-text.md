---
title: Przewodnik Szybki start dla języka Python dotyczący rozpoznawania tekstu odręcznego przy użyciu funkcji przetwarzania obrazów | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: W tym przewodniku Szybki start wyodrębnisz tekst odręczny z obrazu przy użyciu funkcji przetwarzania obrazów i języka Python w usługach Cognitive Services.
...
ms.locfileid: "43771965"
---
# <a name="quickstart-extract-handwritten-text---rest-python"></a>Szybki start: wyodrębnianie tekstu odręcznego — REST, Python
...
## <a name="extract-handwritten-text"></a>Wyodrębnianie tekstu odręcznego
