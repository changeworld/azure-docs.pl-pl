---
title: 'Szybki Start: Wyodrębnianie wydrukowanych i odręcznych tekstu — REST, Java'
...
1. Opcjonalnie należy zastąpić wartość `imageToAnalyze` adresem URL innego obrazu, z którego ma zostać wyodrębniony tekst.
