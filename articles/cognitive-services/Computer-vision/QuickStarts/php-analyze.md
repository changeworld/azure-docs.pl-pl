...
Jeśli plik nie jest już potrzebny, usuń to, a następnie odinstaluj pakiet `HTTP_Request2` PHP5. Aby odinstalować pakiet, wykonaj następujące czynności:
