---
title: 'Szybki Start: przetwarzanie obrazów 2,0 i 2,1 — wyodrębnianie wydrukowanych i odręcznych tekstu — RESTC#'
...
---
# <a name="quickstart-extract-printed-and-handwritten-text-using-the-computer-vision-20-and-21-rest-api-and-c"></a>Szybki Start: Wyodrębnij drukowany i odręczny tekst za pomocą interfejsu API REST przetwarzanie obrazów 2,0 i 2,1 orazC#
