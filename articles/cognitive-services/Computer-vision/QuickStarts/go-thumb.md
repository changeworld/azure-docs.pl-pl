...
- Musisz mieć klucz subskrypcji funkcji przetwarzania obrazów. Aby uzyskać klucz subskrypcji, zobacz [Obtaining Subscription Keys ](../Vision-API-How-to-Topics/HowToSubscribe.md) (Uzyskiwanie kluczy subskrypcji).
