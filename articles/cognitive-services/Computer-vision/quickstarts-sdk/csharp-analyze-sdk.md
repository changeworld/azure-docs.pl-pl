---
title: Przewodnik Szybki start dla dotyczący analizowania obrazów przy użyciu interfejsu API przetwarzania obrazów i zestawu SDK języka C# | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: W tym przewodniku Szybki start przeprowadzisz analizę obrazu za pomocą biblioteki klienta przetwarzania obrazów dla systemu Windows w języku C# w usługach Cognitive Services.
...
ms.locfileid: "43772329"
---
# <a name="quickstart-analyze-an-image---sdk-c35"></a>Szybki start: analizowanie obrazu — SDK, C&#35;
...
## <a name="analyzeimageasync-response"></a>Odpowiedź na żądanie AnalyzeImageAsync

Po pomyślnym przetworzeniu żądania zostanie wyświetlony najbardziej odpowiedni podpis dla każdego obrazu.

Zobacz [API Quickstarts: Analyze a local image with C# (Podręczniki szybki start dotyczące interfejsów API: analizowanie obrazu lokalnego za pomocą języka C#)](../QuickStarts/CSharp-analyze.md#analyze-image-response), aby uzyskać przykład nieprzetworzonych danych wyjściowych w formacie JSON.
