...
ms.locfileid: "49647106"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-c"></a>Szybki start: rozpoznawanie języka tekstu przy użyciu interfejsu API REST tłumaczenia tekstu w usłudze Translator (C#)
