...
ms.locfileid: "49648483"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-nodejs"></a>Szybki start: tłumaczenie tekstu przy użyciu interfejsu API REST tłumaczenia tekstu w usłudze Translator (Node.js)
