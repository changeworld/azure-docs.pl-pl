...
description: W tym przewodniku Szybki start przetłumaczysz tekst z jednego języka na inny przy użyciu interfejsu API tłumaczenia tekstu w usłudze Translator i języka Go.
...
ms.locfileid: "49648313"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-go"></a>Szybki start: tłumaczenie tekstu przy użyciu interfejsu API REST tłumaczenia tekstu w usłudze Translator (Go)
