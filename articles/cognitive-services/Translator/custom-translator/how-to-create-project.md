...
2.  Wprowadź następujące szczegóły dotyczące projektu w oknie dialogowym:
    ...
    d.  Kategoria (wymagane): Wybierz kategorię, która jest najbardziej odpowiednie dla Twojego projektu. Kategoria opisuje terminologii i stylu dokumentów, które mają zostać tłumaczenie.
...
- Dodawanie przycisku dokumentów: Użyj tego przycisku, aby [przekazywać dokumenty](how-to-upload-document.md).
