---
title: 'Szybki start: uzyskiwanie długości zdań — tłumaczenie tekstu w usłudze Translator, Node.js'
titleSuffix: Azure Cognitive Services
description: W tym przewodniku Szybki start odnajdziesz długość zdań w tekście przy użyciu interfejsu API tłumaczenia tekstu w usłudze Translator w środowisku Node.js.
