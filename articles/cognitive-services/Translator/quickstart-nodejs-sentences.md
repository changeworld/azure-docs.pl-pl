...
ms.locfileid: "49644915"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-nodejs"></a>Szybki start: uzyskiwanie długości zdań przy użyciu interfejsu API REST tłumaczenia tekstu w usłudze Translator (Node.js)
