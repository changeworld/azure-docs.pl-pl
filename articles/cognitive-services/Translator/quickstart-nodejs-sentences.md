---
title: Tłumaczenie tekstu w usłudze Translator — uzyskiwanie długości zdań przy użyciu oprogramowania Node.js | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: W tym przewodniku Szybki start określisz długość zdań w tekście przy użyciu interfejsu API tłumaczenia tekstu w usłudze Translator i oprogramowania Node.js w usługach Cognitive Services.
...
ms.locfileid: "43770955"
---
# <a name="quickstart-get-sentence-lengths-with-nodejs"></a>Szybki start: uzyskiwanie długości zdań przy użyciu oprogramowania Node.js
