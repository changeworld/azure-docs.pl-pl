...
Utwórz nowy projekt Go za pomocą ulubionego edytora IDE/ lub nowego folderu na pulpicie. Następnie skopiuj ten fragment kodu do projektu/folderu w pliku o nazwie `dictionaryLookup.go`.
