---
title: 'Szybki start: Uzyskiwanie długości zdań, Ruby — interfejs API tłumaczenia tekstu w usłudze Translator'
...
ms.locfileid: "55975453"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-ruby"></a>Szybki start: Uzyskiwanie długości zdań przy użyciu interfejsu API REST tłumaczenia tekstu w usłudze Translator (Ruby)
