...
>[!TIP]
> Jeśli chcesz zobaczyć cały kod na raz, kod źródłowy dla tego przykładu jest dostępny w witrynie [GitHub](https://github.com/MicrosoftTranslator/Text-Translation-API-V3-Python).
