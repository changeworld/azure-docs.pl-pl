...
1. Skonstruuj identyfikator URI dla żądania wyszukiwania. Należy pamiętać, że wyszukiwany termin `SearchTerm` musi być sformatowany przed dołączeniem do ciągu.
