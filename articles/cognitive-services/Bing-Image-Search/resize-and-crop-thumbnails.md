...
Jeśli użytkownik kliknie miniaturę, możesz użyć parametru [contentUrl](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-images-api-v7-reference#image-contenturl) do wyświetlenia użytkownikowi obrazu w pełnym rozmiarze. Pamiętaj o podaniu źródła obrazu.
...
Aby uzyskać szczegółowe informacje dotyczące obrazu, takie jak strony internetowe zawierające ten obraz lub osoby, które zostały rozpoznane na obrazie, użyj parametru [imageInsightsToken](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-images-api-v7-reference#image-imageinsightstoken). Aby uzyskać więcej informacji, zobacz [Szczegółowe informacje o obrazach](image-insights.md).
...
> [!NOTE]
> Pamiętaj, aby po powiększeniu obrazu podać informacje o jego źródle. Możesz to zrobić na przykład przez wyodrębnienie hosta z parametru [hostPageDisplayUrl](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-images-api-v7-reference#image-hostpagedisplayurl) i wyświetlenie go pod obrazem.
