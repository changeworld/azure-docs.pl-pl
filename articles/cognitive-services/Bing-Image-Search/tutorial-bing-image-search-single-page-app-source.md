...
ms.locfileid: "35346973"
---
# <a name="tutorial-single-page-web-app"></a>Samouczek: Aplikacji jednej strony sieci Web

To jest kod źródłowy pełną omówione w [samouczek aplikacji jednej strony](tutorial-bing-image-search-single-page-app.md) dla wyszukiwania usługi Bing obrazu. Aby uruchomić aplikację, skopiuj kod źródłowy w Notatniku lub w innym edytorze tekstu i zapisz go jako `bing.html`. Następnie otwórz zapisany plik w Microsoft Edge lub innej popularne przeglądarki.
