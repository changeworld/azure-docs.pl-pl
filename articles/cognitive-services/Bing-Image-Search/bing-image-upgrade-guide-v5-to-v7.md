---
title: Uaktualnienia z usługi Bing do 7 — interfejs API wyszukiwania obrazów Bing w wersji 5 interfejsu API wyszukiwania obrazów
titleSuffix: Azure Cognitive Services
description: Ten przewodnik uaktualniania identyfikuje zmiany między w wersji 5 i interfejsu API wyszukiwania obrazów Bing w wersji 7. Użyj tego przewodnika, aby pomóc w zidentyfikowaniu części Twojej aplikacji, należy zaktualizować do używania w wersji 7.
...
ms.locfileid: "46296366"
---
# <a name="image-search-api-upgrade-guide"></a>Przewodnik uaktualniania interfejs API wyszukiwania obrazów
