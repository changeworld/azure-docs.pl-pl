---
title: Dopisków fonetycznych szybkiego startu dla usług Azure kognitywnych, wideo wyszukiwania usługi Bing interfejsu API | Dokumentacja firmy Microsoft
...
ms.locfileid: "35348976"
---
# <a name="quickstart-for-bing-video-search-api-with-ruby"></a>Szybki Start dla wideo wyszukiwania usługi Bing interfejs API w języku Ruby

W tym artykule przedstawiono, jak używać API wyszukiwania wideo Bing, część kognitywnych usług Microsoft Azure. W tym artykule używa Ruby, interfejsu API jest zgodny z żadnego języka programowania, które mogą wysyłać żądania HTTP i przeanalizować składni JSON usługi sieci RESTful Web. 
