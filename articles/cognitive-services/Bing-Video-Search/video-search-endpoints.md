...
**Punkt końcowy 3:** Zwraca filmów wideo, które stają się popularne na podstawie żądania wyszukiwania wykonywanymi przez innych użytkowników. Filmy wideo są podzielone na różne kategorie, na przykład, na podstawie warte zauważenia osób lub zdarzenia.
```
