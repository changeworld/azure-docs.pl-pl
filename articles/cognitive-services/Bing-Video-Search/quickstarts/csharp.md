---
title: 'Szybki start: wyszukiwanie klipów wideo za pomocą interfejsu API REST i języka C# — wyszukiwanie wideo bing'
...
---
# <a name="quickstart-search-for-videos-using-the-bing-video-search-rest-api-and-c"></a>Szybki start: wyszukiwanie klipów wideo za pomocą interfejsu API REST wyszukiwania wideo bing i języka C #
...
2. Dodaj zmienne dla klucza subskrypcji, punktu końcowego i terminu wyszukiwania. `uriBase`może to być globalny punkt końcowy poniżej lub niestandardowy punkt końcowy [poddomeny](../../../cognitive-services/cognitive-services-custom-subdomains.md) wyświetlany w witrynie Azure portal dla zasobu.
