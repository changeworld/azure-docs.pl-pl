...
description: Poznaj nowe postępy z usługą analiza tekstu
...
## <a name="sentiment-analysis-v3-public-preview---july-2019"></a>Analiza tonacji v3 (publiczna wersja zapoznawcza) — lipiec 2019
...
Obsługuje ona język angielski i jest dostępna w trzech regionach: Kanada środkowa, Azja Wschodnia i środkowe stany USA. Poszukaj dodatkowych języków i regionów, które mają zostać dodane w kolejnych wersjach.
