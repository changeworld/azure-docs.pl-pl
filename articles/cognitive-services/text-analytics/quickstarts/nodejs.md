---
title: Szybki Start node.js dla usług Azure kognitywnych, analiza tekstu interfejsu API | Dokumentacja firmy Microsoft
...
ms.locfileid: "35348717"
---
# <a name="quickstart-for-text-analytics-api-with-nodejs"></a>Szybki Start dla interfejsu API za pomocą języka Node.js. Analiza tekstu 
<a name="HOLTop"></a>

W tym artykule opisano sposób do [wykrywać język](#Detect), [analizowanie wskaźniki nastrojów klientów](#SentimentAnalysis), [wyodrębnić klucza fraz](#KeyPhraseExtraction), i [zidentyfikować połączonych jednostek](#Entities) przy użyciu [interfejsów API Analytics tekst](//go.microsoft.com/fwlink/?LinkID=759711) za pomocą języka Node.JS.
