...
1. Zamień `<Endpoint>` na adres URL punktu końcowego dla zasobu aparatu rozpoznawania formularza w regionie świadczenia usługi Azure, w którym uzyskano klucze subskrypcji.
...
Otrzymasz `200 (Success)` odpowiedź z tym wyjściem JSON:
...
Zwróć uwagę `"modelId"` na wartość. Będzie on potrzebny do wykonania następujących kroków.
