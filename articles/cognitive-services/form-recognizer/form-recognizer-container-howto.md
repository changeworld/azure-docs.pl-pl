...
Kontener zawiera punkt końcowy REST API, który można znaleźć [tutaj](https://westus2.dev.cognitive.microsoft.com/docs/services/form-recognizer-api/operations/AnalyzeWithCustomModel).
