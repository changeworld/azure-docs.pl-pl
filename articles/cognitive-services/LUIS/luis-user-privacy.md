...
Z wyjątkiem danych aktywne uczenie (szczegóły przedstawiono poniżej), następuje LUIS [rozwiązań magazynu danych dla usług regionalnych](http://azuredatacentermap.azurewebsites.net/). 
