...
Zalewanie mowy umożliwia usługi rozpoznawania mowy w celu zalewany, Twój model usługi LUIS. Zobacz [Włącz zalewanie mowy ](luis-how-to-publish-app.md#enable-speech-priming).
...
[Testowanie](interactive-test.md#test-your-app) aplikacją usługi LUIS oznacza, że powoduje przekazanie wypowiedź do usługi LUIS i przeglądanie za pomocą pliku JSON.
