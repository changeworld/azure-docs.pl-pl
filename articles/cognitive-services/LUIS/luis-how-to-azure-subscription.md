...
ms.locfileid: "80754352"
---
# <a name="create-luis-resources"></a>Tworzenie zasobów usługi LUIS
...
Gdy będziesz gotowy do opublikowania punktu końcowego przewidywania, [należy utworzyć](#create-luis-resources) i [przypisać](#assign-a-resource-to-an-app) klucze środowiska wykonawczego tworzenia i przewidywania, aby zastąpić funkcjonalność klucza startowego.
