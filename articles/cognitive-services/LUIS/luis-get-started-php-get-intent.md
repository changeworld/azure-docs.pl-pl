---
title: Wywoływanie aplikacji Language Understanding (LUIS) przy użyciu języka PHP | Microsoft Docs
...
ms.locfileid: "36265130"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>Samouczek: Wywoływanie punktu końcowego aplikacji LUIS przy użyciu języka PHP
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>Korzystanie z wyniku aplikacji LUIS przy użyciu interfejsu API punktu końcowego za pomocą języka PHP 
...
3. Uruchom aplikację w języku PHP. Wyświetli ona ten sam wynik JSON, który został wyświetlony wcześniej w oknie przeglądarki.
