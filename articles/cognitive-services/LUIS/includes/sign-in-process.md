...
ms.locfileid: "70258131"
---
## <a name="sign-in-to-luis-portal"></a>Zaloguj się do portalu LUIS

Nowy użytkownik do LUIS musi wykonać następującą procedurę:

1. Zaloguj się do [portalu Luis](https://www.luis.ai), wybierz swój kraj i zaakceptuj warunki użytkowania.
...
1. Zostanie wyświetlone podsumowanie zasobu, który ma zostać utworzony. Wybierz opcję **Dalej**.
    ...
    ![Utwórz zasób tworzenia](./media/sign-in-confirm-key-selection.png)

1. Krok 3 to potwierdzenie. Potwierdź wybór, wybierając pozycję **Kontynuuj**. 

    ![Utwórz zasób tworzenia](./media/sign-in-confirm-continue.png)