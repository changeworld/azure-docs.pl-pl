...
1. 1. Zaloguj się do [portalu Luis](https://www.luis.ai) i zaakceptuj warunki użytkowania.
...
1. Jeśli dowolna z aplikacji ma współpracowników, zostanie wyświetlony monit o **wysłanie wiadomości e-mail** z informacją o migracji. Jest to krok opcjonalny. Domyślna aplikacja poczty e-mail otwiera się z lekko sformatowaną wiadomością e-mail. 

    ![Wyślij wiadomość e-mail z współpracownikami dotyczącą migracji](./media/migrate-authoring-key/send-collaborators-email.png)
...
1. W następnym oknie wprowadź informacje o kluczu zasobu. Po wprowadzeniu informacji wybierz pozycję **Utwórz zasób**. 
