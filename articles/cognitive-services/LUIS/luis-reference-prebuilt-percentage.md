...
Liczby procentowe mogą być wyświetlane jako ułamki, `3 1/2`lub jako procent, `2%`. Ponieważ przeprowadzono już uczenie tej jednostki, nie musisz Dodawanie wypowiedzi przykład zawierający procent w celu intencji aplikacji. Jednostka procentowa jest obsługiwana w [wielu kulturach](luis-reference-prebuilt-entities.md).
