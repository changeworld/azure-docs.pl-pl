...
ms.locfileid: "69559394"
---
# <a name="configuration-based-on-stig"></a>Konfiguracja oparta na STIG
...
Po wygenerowaniu konfiguracji można użyć [skryptów konfiguracji DSC](/powershell/dsc/configurations) do wygenerowania plików MOF i [przekazania plików MOF do Azure Automation](/azure/automation/tutorial-configure-servers-desired-state#create-and-upload-a-configuration-to-azure-automation).
