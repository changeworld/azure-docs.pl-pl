...
![Suwak usług Windows](./media/change-tracking/windowservices.png)
...
Możesz wyświetlić zmiany na komputerach i następnie wejdź do szczegółów dla każdego zdarzenia. Listy rozwijane są dostępne w górnej części wykresu, aby ograniczyć wykresu i szczegółowe informacje, w zależności od zakresów czasu i typ zmiany. Można również kliknąć i przeciągnąć na wykresie, aby wybrać niestandardowy zakres czasu. **Zmień typ** będzie jedną z następujących wartości **zdarzenia**, **demonów**, **pliki**, **rejestru**,  **Oprogramowanie**, **usług Windows**. Kategoria pokazuje typ zmiany i może być **dodano**, **zmodyfikowane**, lub **usunięto**.

![Obraz przedstawiający pulpit nawigacyjny z Change Tracking](./media/change-tracking/change-tracking-dash01.png)
...
![Wykres przedstawiający hosty zmian plików](./media/change-tracking/changes.png)
...
![Obraz przedstawiający zapytania zmiany, śledzić zmiany w pliku hosts](./media/change-tracking/change-query.png)
...
![Obraz konfigurowania grupy akcji alert w przypadku zmiany](./media/change-tracking/action-groups.png)
