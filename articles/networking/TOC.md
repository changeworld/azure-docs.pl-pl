...
### [Serwery publiczne równoważenia obciążenia aplikacji](../application-gateway/quick-create-portal.md?toc=%2fazure%2fnetworking%2ftoc.json)
...
## Zarządzanie
### [Omówienie monitorowania sieci](network-monitoring-overview.md)
### [Porównywanie użycia zasobów z limitami platformy Azure](check-usage-against-limits.md)
...
## Samouczki
### [Równoważenie obciążenia maszyn wirtualnych](../virtual-machines/linux/tutorial-load-balancer.md?toc=%2fazure%2fnetworking%2ftoc.json)
