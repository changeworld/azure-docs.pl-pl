...
If you enter data for **Authentication Phone** or **Authentication Email**, it's not visible in the global directory. Jedynie Ty i Twoi administratorzy mogą wyświetlać te dane. Only you can see the answers to your security questions.
...
| Error case| What error do you see?| Rozwiązanie |
| --- | --- | --- |
