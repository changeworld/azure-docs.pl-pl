...
ms.locfileid: "37448173"
---
# <a name="using-the-audit-log-in-pim"></a>Korzystanie z dziennika inspekcji w usłudze PIM
Korzystanie z dziennika inspekcji Privileged Identity Management (PIM), aby zobaczyć wszystkie przypisania użytkownika i aktywacji w danym okresie czasu. Jeśli chcesz wyświetlić pełną historię inspekcji aktywności w swojej dzierżawie, w tym administratora, użytkownik końcowy i działanie synchronizacji, można użyć [raportów dostępu i użycia usługi Azure Active Directory.](active-directory-view-access-usage-reports.md)
