...
5. Po użytkownik udziela zgody, Kod autoryzacji jest zwracana do aplikacji jest zrealizowany uzyskiwanie tokenu dostępu i token odświeżania. Aby uzyskać więcej informacji na temat tego przepływu Zobacz [API]](web-api.md) sieci Web.
...
5. Aby dodać uprawnienia dostępu do zasobu interfejsy API z klienta
  ...
  ![Aktualizowanie rejestracji aplikacji — uprawnienia interfejsu api](./media/quickstart-v1-integrate-apps-with-azure-ad/update-app-registration-settings-permissions-api.png)
