...
> [!IMPORTANT]
> [Przyznawanie niejawne](v2-oauth2-implicit-grant-flow.md) nie można użyć przepływu w imieniu z - aplikacji jednostronicowych musi przekazać ich token dostępu (niejawny przepływ) do warstwy środkowej poufne klienta do wykonania przepływu OBO. Zobacz [ograniczenia](#client-limitations) Aby uzyskać więcej informacji, na których klienci będą mogli wykonywać w imieniu z wywołania.  
...
| zakres |wymagane | Spacjami listy zakresów dla żądania tokenu. Aby uzyskać więcej informacji, zobacz [zakresy](v2-permissions-and-consent.md).|
