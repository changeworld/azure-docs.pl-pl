...
5.  W **Test rejestracji jednokrotnej** bloku, użyj firmowych poświadczeń do logowania do aplikacji docelowej. Można zalogować się jako bieżący użytkownik lub innego użytkownika. Jeśli logujesz się jako inny użytkownik monit wyświetli monit do uwierzytelnienia.
    ...
    ![Test SAML strony](media/active-directory-saml-debugging/testing.png)
...
3. Zwróć uwagę, te elementy w tokenie języka SAML odpowiedzi:
    ...
    - Certyfikat używany do podpisywania tokenu. Aby uzyskać informacji na temat sposobu przeglądania odpowiedzi SAML, zobacz [protokołu SAML rejestracji jednokrotnej](active-directory-single-sign-on-protocol-reference.md).
4. Aby uzyskać więcej informacji na temat odpowiedzi SAML, zobacz [protokołu SAML rejestracji jednokrotnej](active-directory-single-sign-on-protocol-reference.md).
