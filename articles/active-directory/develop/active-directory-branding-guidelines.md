...
![Typy aplikacji i scenariuszy](./media/active-directory-branding-guidelines/add-to-my-org.png)
...
| Zasób                                | PNG format | Formacie SVG |
| ------------------------------------ | ---------- | ---------- |
| Zaloguj się przy użyciu konta Microsoft (ciemny)  | ![Zaloguj się w przycisk ciemnego motywu PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![Zaloguj się przy użyciu Microsoft przycisk ciemny SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Zaloguj się przy użyciu konta Microsoft (motyw jasny) | ![Zaloguj się w przycisk motyw jasny PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![Zaloguj się przy użyciu przycisku firmy Microsoft — motyw jasny SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| Zaloguj się (ciemny)                 | ![Zaloguj się w skrócie motyw ciemny przycisk PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![Zaloguj się w skrócie motyw ciemny przycisk SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| Zaloguj się (motyw jasny)                | ![Zaloguj się w skrócie motyw jasny przycisk PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![Zaloguj się w skrócie motyw jasny przycisk SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
