---
title: Autoryzacji OAuth 2.0 usługa Azure AD kodu przepływu | Dokumentacja firmy Microsoft
...
![Przepływ kodu autoryzacji OAuth](../../media/active-directory-v2-flows/convergence_scenarios_native.png)
...
| scope                 | Wymagane    | Listę rozdzielonych spacjami [zakresy](active-directory-v2-scopes.md) ma użytkownika o zgodę na.           |
...
| Parametr | Opis                                                                                                                                                                                                                        |
|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Kod      | Authorization_code, który zażądał aplikacji. Aplikacja może używać kodu autoryzacji do żądania tokenu dostępu dla zasobu docelowego. Authorization_codes są bardzo krótkotrwałe, zwykle wygasają po upływie około 10 minut. |
...
| unsupported_response_type | Serwer autoryzacji nie obsługuje typu odpowiedzi w żądaniu.                                         | Usuń i ponownie prześlij żądanie. To rozwinięcie błąd jest zwykle przechwycono w początkowej fazie testowania.                                                                                                                                     |
...
> [!TIP]
> Spróbuj wykonać tego żądania w narzędziu Postman! (Nie zapomnij zastąpić `code`) [ ![uruchamianie w narzędziu Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
| Kod          | Wymagane              | Authorization_code, uzyskanego w pierwszej gałęzi przepływu.                                                                                                                                                                                                                                                                                                                                                                   |
...
> [!TIP]
> Wykonanie tego żądania w narzędziu Postman! (Zastąp `Authorization` nagłówek pierwszego) [ ![uruchamianie w narzędziu Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Spróbuj wykonać tego żądania w narzędziu Postman! (Nie zapomnij zastąpić `refresh_token`) [ ![uruchamianie w narzędziu Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
