...
Aby uzyskać więcej informacji na temat protokołu w imieniu z, zobacz [platforma tożsamości firmy Microsoft i przepływ OAuth 2.0 "w imieniu"](https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-on-behalf-of-flow)
