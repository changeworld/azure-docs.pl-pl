...
| Błyskawiczne uwierzytelniania |Rejestruje datę i godzinę wystąpienia uwierzytelniania. <br><br> **Przykładowa wartość SAML**: <br> `<AuthnStatement AuthnInstant="2011-12-29T05:35:22.000Z">` | |
...
| `unique_name` |Name (Nazwa) |Udostępnia ludzi, można odczytać wartość, która identyfikuje podmiotu tokenu. Ta wartość nie musi być unikatowa w ramach dzierżawy i jest przeznaczony do użycia tylko w celach wyświetlania. <br><br> **Przykładowa wartość SAML**: <br> `<Attribute Name=”http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name”>`<br>`<AttributeValue>frankm@contoso.com<AttributeValue>` <br><br> **Przykładowa wartość tokenu JWT**: <br> `"unique_name": "frankm@contoso.com"` |
