...
### [.NET (aplikacje klasyczne systemu Windows)](active-directory-devquickstarts-dotnet.md)
### [.NET (aplikacje uniwersalne systemu Windows)](active-directory-devquickstarts-windowsstore.md)
...
## [Przykłady kodu według scenariusza](active-directory-code-samples.md)
...
### [Konfigurowanie opcjonalnych i niestandardowych oświadczeń aplikacji](active-directory-optional-claims.md)
...
#### [Platforma uniwersalna systemu Windows](guidedsetups/active-directory-uwp-v2.md)
### Aplikacje sieci Web
...
### [Przykłady kodu w wersji 2.0 według scenariusza](active-directory-v2-code-samples.md)
...
### [Zakresy i zgoda](active-directory-v2-scopes.md)
# Zasoby
