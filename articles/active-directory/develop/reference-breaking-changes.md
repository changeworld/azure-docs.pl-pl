...
System uwierzytelniania zmienia i dodaje funkcje na bieżąco, aby zwiększyć bezpieczeństwo i zgodność ze standardami. Na bieżąco o najnowszych zmianach, w tym artykule przedstawiono informacje na następujące tematy:
...
10 października 2018 r. usługi Azure AD będzie akceptować kody wcześniej używane do uwierzytelniania dla aplikacji. Ta zmiana zabezpieczeń pomaga do usługi Azure AD zgodnie ze specyfikacją protokołu OAuth i będzie wymuszany w punktach końcowych v1 i v2.
...
> [!NOTE]
> W ramach działań zmierzających do przerwania w kilku aplikacjach, jak to możliwe, a istniejące aplikacje, które opierają się na temat tej funkcji otrzymanych wyjątek dotyczący tego wymagania.  Dowolnej aplikacji za pomocą logowania do więcej niż 10 dni, opierając się na ten wzorzec został uznany na niej się opierać.  
