...
![Omówienie logowania jednokrotnego do aplikacji sieci web](./media/authentication-scenarios/basics_of_auth_in_aad.png)
...
![Pojedynczy diagramu strony aplikacji](./media/authentication-scenarios/single_page_app.png)
...
Po zarejestrowaniu aplikacji musi być skonfigurowany do używania protokołu przyznawanie niejawne protokołu OAuth 2.0. Domyślnie ten protokół jest wyłączone dla aplikacji. Aby włączyć protokół przyznawanie niejawne protokołu OAuth2 dla aplikacji, Edytuj manifest aplikacji w witrynie Azure portal, a następnie ustaw wartość "oauth2AllowImplicitFlow" na true. Aby uzyskać szczegółowe instrukcje, zobacz [włączenie protokołu OAuth 2.0 przyznawanie niejawne dla aplikacje jednostronicowe](quickstart-v1-integrate-apps-with-azure-ad.md).
