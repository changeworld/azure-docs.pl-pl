...
1. In the **Advanced settings** section, set **Logout URL** to **http://localhost:8080/msal4jsample/sign_out** . Następnie wybierz pozycję **Zapisz**.
...
1. Select the **Authentication** section. In **Advanced settings**, set **Logout URL** to **http://localhost:5000/logout** . Następnie wybierz pozycję **Zapisz**.
...
1. In the **Client Secrets** section, select **New client secret**, and then:
   ...
   1. Wybierz pozycję **Dodaj**.
   1. When the key value appears, copy it. Będzie on potrzebny później.
---
