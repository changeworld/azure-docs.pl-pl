...
| Platforma | Biblioteka | Pobieranie | Kod źródłowy | Sample | Dokumentacja | Dokument koncepcyjny | Harmonogram działania |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Platforma | Biblioteka | Pobieranie | Kod źródłowy | Sample | Dokumentacja
| --- | --- | --- | --- | --- | --- |
