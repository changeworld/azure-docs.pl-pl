...
| Błyskawiczne uwierzytelniania | |Rejestruje datę i godzinę wystąpienia uwierzytelniania. | `<AuthnStatement AuthnInstant="2011-12-29T05:35:22.000Z">` | 
...
|Name (Nazwa) | `unique_name` |Udostępnia ludzi, można odczytać wartość, która identyfikuje podmiotu tokenu. Ta wartość nie musi być unikatowa w ramach dzierżawy i jest przeznaczony do użycia tylko w celach wyświetlania. | `<Attribute Name=”http://schemas.xmlsoap.org/ws/2005/05/identity/claims/name”>`<br>`<AttributeValue>frankm@contoso.com<AttributeValue>`|
