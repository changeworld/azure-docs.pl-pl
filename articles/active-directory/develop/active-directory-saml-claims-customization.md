...
| **Trwała** | Usługa Azure AD będzie używać trwały jako format identyfikatora NameID. |
| **EmailAddress** | Usługa Azure AD będzie używać EmailAddress jako format identyfikatora NameID. |
| **Nieokreślona** | Usługa Azure AD będzie używać nieokreślony jako format identyfikatora NameID. |
