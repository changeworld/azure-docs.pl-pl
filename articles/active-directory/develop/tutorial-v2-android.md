...
3. W **aplikacji** > **src** > **main** > **res** > **raw**, `auth_config_single_account.json` utwórz nowy plik JSON o nazwie i wklej konfigurację MSAL, która została zapisana wcześniej. 
