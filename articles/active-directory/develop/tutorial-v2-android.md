---
title: Usługa Azure Active Directory v2.0 wprowadzenie do systemu Android | Dokumentacja firmy Microsoft
description: Jak aplikacji systemu Android można uzyskać token dostępu i wywołania interfejsu API Microsoft Graph lub interfejsów API, które wymagają tokenów dostępu z punktu końcowego v2.0 usługi Azure Active Directory.
