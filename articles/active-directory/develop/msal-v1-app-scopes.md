...
Jeśli chcesz uzyskać tokeny dla określonych zakresów aplikacji w wersji 1.0 (na przykład wykres usługi Azure AD, która jest https://graph.windows.net), należy utworzyć zakresy przez złączenie identyfikatorem żądanego zasobu z uprawnieniem OAuth2 odpowiednią dla tego zasobu.
