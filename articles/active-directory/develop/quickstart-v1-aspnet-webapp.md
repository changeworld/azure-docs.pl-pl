...
W przypadku nowych aplikacji sieci Web zalecamy korzystanie z usługi Microsoft Identity platform (v 2.0) i MSAL w celu uzyskiwania tokenów i uzyskiwania dostępu do zabezpieczonych interfejsów API sieci Web: [Szybki start: Dodaj logowanie z firmą Microsoft do aplikacji](quickstart-v2-aspnet-webapp.md)sieci Web ASP.NET.