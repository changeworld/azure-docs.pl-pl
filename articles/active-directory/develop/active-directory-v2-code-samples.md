...
> [!NOTE]
> Jeśli interesuje Cię V1 przykładów, zobacz [przykładów kodu usługi Azure AD (punkt końcowy w wersji 1)](active-directory-code-samples.md).
