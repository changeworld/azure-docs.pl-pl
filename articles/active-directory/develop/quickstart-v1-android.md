---
title: Logowanie użytkowników i wywoływanie interfejsu API Microsoft Graph z poziomu aplikacji systemu Android (wersja 1.0) | Microsoft Docs
...
ms.locfileid: "73150279"
---
# <a name="quickstart-sign-in-users-and-call-the-microsoft-graph-api-from-an-android-app-v10"></a>Szybki Start: Logowanie użytkowników i wywoływanie interfejsu API Microsoft Graph z aplikacji systemu Android (v 1.0)
...
W przypadku nowych aplikacji dla systemu Android zalecamy korzystanie z usługi Microsoft Identity platform (v 2.0) i MSAL w celu uzyskiwania tokenów i uzyskiwania dostępu do zabezpieczonych interfejsów API sieci Web. Aby rozpocząć pracę [, zobacz Szybki Start: Logowanie użytkowników i wywoływanie interfejsu API Microsoft Graph z poziomu aplikacji systemu Android](quickstart-v2-android.md) .
