...
Dowiedz się, [sposób włączenia logowania jednokrotnego dla wielu aplikacji w systemie Android przy użyciu biblioteki ADAL](active-directory-sso-android.md). 
