...
### <a name="error-cases-and-actionable-steps-single-page-applications-adaljs"></a>W przypadku wystąpienia błędów i kroki z możliwością działania: aplikacji jednostronicowych (adal.js)
