...
Znajomości [pojedynczego](quickstart-v1-integrate-apps-with-azure-ad.md) i [wielodostępnych](active-directory-devhowto-multi-tenant-overview.md) aplikacji i [typowych wzorców uwierzytelniania](authentication-scenarios.md) zakłada, że.
...
![Uzyskiwanie dostępu do programu Microsoft Graph diagramu przepływu aplikacji](media/active-directory-conditional-access-developer/app-accessing-microsoft-graph-scenario.png)
...
![Uzyskiwanie dostępu do wielu usług diagramu przepływu aplikacji](media/active-directory-conditional-access-developer/app-accessing-multiple-services-scenario.png)
...
![Uzyskiwanie dostępu do wielu usług, żądanie nowego tokenu aplikacji](media/active-directory-conditional-access-developer/app-accessing-multiple-services-new-token.png)
...
![Aplikacji jednostronicowej przy użyciu biblioteki ADAL diagramu przepływu](media/active-directory-conditional-access-developer/spa-using-adal-scenario.png)
...
* Aby dowiedzieć się więcej na temat scenariuszy z wieloma dzierżawami, zobacz [jak logować użytkowników za pomocą wzorca wielodostępnych](active-directory-devhowto-multi-tenant-overview.md).
