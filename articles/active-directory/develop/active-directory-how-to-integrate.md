...
description: Przewodnik dotyczący korzyści i zasoby dotyczące integracji z usługą Azure Active Directory.
...
### <a name="get-access-to-users-profile-calendar-email-contacts-files-and-more"></a>Uzyskiwanie dostępu do profilu użytkownika, kalendarza, poczty E-mail, kontakty, pliki i więcej
...
### <a name="promote-your-application-in-the-azure-and-office-365-marketplaces"></a>Promuj swoją aplikację na platformie Azure i rynków w portalu usługi Office 365
...
**Standardowe protokoły.**  Firma Microsoft jest zaangażowana w obsłudze standardów branżowych. Usługa Azure AD obsługuje protokoły uwierzytelniania SAML 2.0, OpenID Connect 1.0, OAuth 2.0 i WS-Federation 1.2. Interfejs API programu Graph jest OData 4.0 zgodne. Jeśli aplikacja już obsługuje protokoły uwierzytelniania SAML 2.0 lub OpenID Connect 1.0 federacyjnego logowania, dodania oferty pomocy technicznej dla usługi Azure AD może być prosta. Dowiedz się więcej o [usługi Azure AD obsługuje protokoły uwierzytelniania](active-directory-authentication-protocols.md).
...
[Rozpocznij pisanie kodu](active-directory-developers-guide.md#get-started).
