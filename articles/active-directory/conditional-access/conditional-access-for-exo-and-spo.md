...
ms.locfileid: "40162192"
---
# <a name="how-to-set-up-sharepoint-online-and-exchange-online-for-azure-active-directory-conditional-access"></a>Instrukcje: Konfigurowanie programu SharePoint Online i Exchange Online dla dostępu warunkowego usługi Azure Active Directory 
...
- Można skonfigurować tylko warunek platformy urządzeń  
...
- Skonfiguruj zasady dostępu warunkowego obsługiwanych, wykonaj następujące czynności:
    ...
    b. Wybierz **programu Exchange Active Sync** jako **aplikację kliencką**, a następnie wybierz pozycję **Zastosuj zasady tylko do obsługiwanych platform**.  
