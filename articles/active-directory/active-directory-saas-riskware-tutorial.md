...
4. W polu wyszukiwania wpisz **Riskware**, wybierz pozycję **Riskware** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Riskware na liście wyników](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_addfromgallery.png)
...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Okno dialogowe rejestracji jednokrotnej](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_samlbase.png)

3. Na **Riskware domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Adresy URL i domeny Riskware pojedynczy informacje logowania jednokrotnego](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/active-directory-saas-riskware-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji Riskware** , kliknij przycisk **skonfigurować Riskware** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adresu URL i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfiguracja Riskware](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_configure.png) 
...
8. W górnym rogu kliknij **konserwacji** aby otworzyć stronę konserwacji. 
    ...
    ![Obsługa konfiguracji Riskware](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)

9. Na stronie konserwacji, kliknij przycisk **uwierzytelniania**.

    ![Authen Riskware konfiguracji](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_authen.png)

10. W **konfiguracji uwierzytelniania** wykonaj następujące czynności:

    ![Authenconfig Riskware konfiguracji](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_config.png)
...
1. W portalu Azure, w okienku po lewej stronie kliknij **usługi Azure Active Directory** przycisku.
    ...
    ![Przycisk usługi Azure Active Directory](./media/active-directory-saas-riskware-tutorial/create_aaduser_01.png)

2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.

    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/active-directory-saas-riskware-tutorial/create_aaduser_02.png)

3. Aby otworzyć **użytkownika** okno dialogowe, kliknij przycisk **Dodaj** w górnej części **wszyscy użytkownicy** okno dialogowe.

    ![Przycisk Dodaj](./media/active-directory-saas-riskware-tutorial/create_aaduser_03.png)

4. W **użytkownika** okna dialogowego wykonaj następujące czynności:

    ![Okno dialogowe użytkownika](./media/active-directory-saas-riskware-tutorial/create_aaduser_04.png)
...
2. W górnym rogu kliknij **konserwacji** aby otworzyć stronę konserwacji. 
    ...
    ![Przechowuje Riskware konfiguracji](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)

3. Na stronie konserwacji, kliknij przycisk **osób**.

    ![Osoby Riskware konfiguracji](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_people.png)

4. Na **szczegóły** karcie, wykonaj następujące czynności:
    
    ![Szczegóły konfiguracji Riskware](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_details.png)
...
5. Na **zabezpieczeń** karcie, wykonaj następujące czynności:    
    ...
    ![Riskware konfiguracji zabezpieczeń](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_security.png)
...
6. Na **organizacji** karcie, wykonaj następujące czynności:
    ...
    ![Org Riskware konfiguracji](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_org.png)
...
2. Na liście aplikacji zaznacz **Riskware**.
    ...
    ![Łącze Riskware na liście aplikacji](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_app.png)  
