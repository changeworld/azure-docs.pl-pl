...
4. W polu wyszukiwania wpisz **BA**, wybierz pozycję **BA** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![BA na liście wyników](./media/versal-tutorial/tutorial_versal_addfromgallery.png)
...
3. Na **BA domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i domeny versal pojedynczy informacje logowania jednokrotnego](./media/versal-tutorial/tutorial_versal_url.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/versal-tutorial/tutorial_versal_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/versal-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/versal-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **BA**.
    ...
    ![BA łącza na liście aplikacji](./media/versal-tutorial/tutorial_versal_app.png)  
