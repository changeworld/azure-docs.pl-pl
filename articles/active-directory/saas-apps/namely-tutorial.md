---
title: 'Samouczek: Integracja usługi Azure Active Directory z mianowicie | Dokumentacja firmy Microsoft'
...
1. Na **: domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.namely.com`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.namely.com/saml/metadata`

    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta mianowicie](https://www.namely.com/contact/) do uzyskania tych wartości. 
