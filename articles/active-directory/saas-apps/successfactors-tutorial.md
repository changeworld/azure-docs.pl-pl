...
ms.locfileid: "68989502"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-successfactors"></a>Samouczek: Azure Active Directory integrację logowania jednokrotnego (SSO) z usługą SuccessFactors
...
2. **[Skonfiguruj logowanie](#configure-successfactors-sso)** jednokrotne w usłudze SuccessFactors, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
