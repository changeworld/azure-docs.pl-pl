...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/skillport-tutorial/tutorial_skillport_samlbase.png)

3. Na **Skillport domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/skillport-tutorial/tutorial_skillport_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik XML na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/skillport-tutorial/tutorial_skillport_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/skillport-tutorial/tutorial_general_400.png)
...
2. Na liście aplikacji zaznacz **Skillport**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/skillport-tutorial/tutorial_skillport_app.png) 
