---
title: 'Samouczek: Integracja usługi Azure Active Directory z Skillport | Dokumentacja firmy Microsoft'
...
3. **[Tworzenie użytkownika testowego Skillport](#creating-a-skillport-test-user)**  — aby odpowiednikiem Britta Simon w Skillport połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Skillport domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **Skillport** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Skillport](https://www.skillsoft.com/contact.asp). One skonfiguruje je połączenia logowania jednokrotnego SAML prawidłowo po obu stronach.
