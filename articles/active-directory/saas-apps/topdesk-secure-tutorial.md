...
4. W polu wyszukiwania wpisz **TOPdesk - bezpiecznego**, wybierz pozycję **TOPdesk - bezpiecznego** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![TOPdesk - Secure na liście wyników](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_addfromgallery.png)
...
3. Na **TOPdesk - Secure domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Informacje logowania z jednym TOPdesk - bezpiecznej domeny i adres URL](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/topdesk-secure-tutorial/tutorial_general_400.png)
...
6. Na **TOPdesk - Secure konfiguracji** , kliknij przycisk **TOPdesk skonfigurować - bezpiecznego** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![TOPdesk - bezpiecznej konfiguracji](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_configure.png)
...
11. W **bezpiecznego** sekcji **logowania SAML** konfiguracji sekcji, wykonaj następujące czynności:
    ...
    ![Usługa konsumenta potwierdzenia](./media/topdesk-secure-tutorial/ic790856.png "potwierdzenia klienta usługi")
...
14. Na **Asystenta konfiguracji SAML** okna dialogowego strony, należy wykonać następujące czynności:
    ...
    ![Asystent konfiguracji SAML](./media/topdesk-secure-tutorial/ic790608.png "Asystenta konfiguracji SAML")
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/topdesk-secure-tutorial/create_aaduser_02.png)
