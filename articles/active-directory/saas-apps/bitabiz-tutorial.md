...
4. W polu wyszukiwania wpisz **BitaBIZ**, wybierz opcję **BitaBIZ** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego BitaBIZ](#create-a-bitabiz-test-user)**  — aby odpowiednikiem Britta Simon w BitaBIZ połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **BitaBIZ domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w trybie zainicjował dostawcy tożsamości należy wykonać następujące czynności:
...
7. Na **konfiguracji BitaBIZ** , kliknij przycisk **skonfigurować BitaBIZ** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego adres URL usługi** z **krótki przewodnik po sekcji.**

    ![Konfiguracja BitaBIZ](./media/bitabiz-tutorial/tutorial_bitabiz_configure.png) 

8. W oknie przeglądarki internetowej innej logowanie jednokrotne do swojej dzierżawy BitaBIZ jako administrator.

9. Kliknij pozycję **ustawienia administratora**.

    ![Konfiguracja BitaBIZ](./media/bitabiz-tutorial/settings1.png)

10. Kliknij pozycję **integracji Microsoft** w obszarze **ulepszyć swoje** sekcji.
...
2. Kliknij pozycję **ustawienia administratora**.

    ![BitaBIZ Dodaj użytkownika](./media/bitabiz-tutorial/settings1.png)

3. Kliknij pozycję **dodawania użytkowników** w obszarze **organizacji** sekcji.

    ![BitaBIZ Dodaj użytkownika](./media/bitabiz-tutorial/user1.png)

4. Kliknij przycisk **Dodaj nowego pracownika**.

    ![BitaBIZ Dodaj użytkownika](./media/bitabiz-tutorial/user2.png)

5. Na **"Dodaj nowe employee"** okna dialogowego strony, wykonaj następujące czynności:
...
2. Na liście aplikacji wybierz **BitaBIZ**.
