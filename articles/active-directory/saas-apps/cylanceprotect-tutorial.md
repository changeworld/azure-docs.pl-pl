...
4. W polu wyszukiwania wpisz **CylancePROTECT**, wybierz opcję **CylancePROTECT** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego CylancePROTECT](#create-a-cylanceprotect-test-user)**  — aby odpowiednikiem Britta Simon w CylancePROTECT połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **CylancePROTECT domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji CylancePROTECT** , kliknij przycisk **skonfigurować CylancePROTECT** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja CylancePROTECT](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **CylancePROTECT** stronie, musisz wysłać pobrany **Certificate(Base64), adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** do konsoli administratora. Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **CylancePROTECT**.
