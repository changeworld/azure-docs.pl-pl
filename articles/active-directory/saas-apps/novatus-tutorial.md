...
3. **[Tworzenie użytkownika testowego Novatus](#creating-a-novatus-test-user)**  — aby odpowiednikiem Britta Simon w Novatus połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Novatus domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji Novatus** , kliknij przycisk **skonfigurować Novatus** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/novatus-tutorial/tutorial_novatus_configure.png) 

7. Aby uzyskać logowanie Jednokrotne skonfigurowane pod kątem swojej aplikacji, skontaktuj się z Twojego [zespołu pomocy technicznej Novatus](mailto:jvinci@novatusinc.com). Dołącz **pobrany certyfikat** pliku do wiadomości e-mail i udziału **adresy URL metadanych** (**adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL**) przy użyciu Novatus zespół, aby skonfigurować logowanie Jednokrotne na bok.
