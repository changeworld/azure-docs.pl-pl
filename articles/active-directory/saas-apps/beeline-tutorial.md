---
title: 'Samouczek: Integracja usługi Azure Active Directory z rozwiązaniem BeeLine | Microsoft Docs'
...
Aby skonfigurować logowanie jednokrotne po stronie rozwiązania **BeeLine**, musisz wysłać pobrany **kod XML metadanych federacji** i odpowiednie adresy URL skopiowane z witryny Azure Portal [zespołowi pomocy technicznej rozwiązania BeeLine](https://www.beeline.com/contact-us/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
Po kliknięciu kafelka BeeLine w panelu dostępu powinno nastąpić automatyczne zalogowanie do rozwiązania BeeLine, dla którego skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
