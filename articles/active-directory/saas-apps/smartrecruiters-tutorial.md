...
* Aby umożliwić użytkownikom można automatycznie zalogowany do SmartRecruiters (logowanie jednokrotne) przy użyciu konta usługi Azure AD.
...
* SmartRecruiters pojedynczego logowania jednokrotnego włączonych subskrypcji

## <a name="scenario-description"></a>Opis scenariusza

W tym samouczku skonfigurujesz i przetestujesz logowanie jednokrotne usługi Azure AD w środowisku testowym.

* Obsługuje SmartRecruiters **dodatkiem SP oraz dostawców tożsamości** jednokrotne logowanie inicjowane przez
...
4. W polu wyszukiwania wpisz **SmartRecruiters**, wybierz opcję **SmartRecruiters** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.

     ![SmartRecruiters na liście wyników](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfiguracja i testowanie usługi Azure AD logowania jednokrotnego

W tej sekcji, konfigurowanie i testowanie usługi Azure AD logowanie jednokrotne za pomocą SmartRecruiters w oparciu o użytkownika testu o nazwie **Britta Simon**.
Dla logowania jednokrotnego do pracy relację łącza między użytkownika usługi Azure AD i powiązanego użytkownika w SmartRecruiters musi zostać ustanowione.
...
2. **[Konfigurowanie SmartRecruiters logowania jednokrotnego](#configure-smartrecruiters-single-sign-on)**  — Aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)**  — do przetestowania usługi Azure AD logowanie jednokrotne za pomocą Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)**  — Aby włączyć Britta Simon korzystać z usługi Azure AD logowania jednokrotnego.
5. **[Tworzenie użytkownika testowego SmartRecruiters](#create-smartrecruiters-test-user)**  — aby odpowiednikiem Britta Simon w SmartRecruiters połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. W [witryny Azure portal](https://portal.azure.com/)na **SmartRecruiters** strona integracji aplikacji, wybierz opcję **logowanie jednokrotne**.
...
5. Kliknij przycisk **Ustaw dodatkowe adresy URL** i wykonaj następujący krok, jeśli chcesz skonfigurować aplikację w trybie inicjowania przez **dostawcę usług**:
    ...
    ![SmartRecruiters domena i adresy URL pojedynczego logowania jednokrotnego informacji](common/metadata-upload-additional-signon.png)
    ...
    > [!NOTE]
    > Te wartości nie są prawdziwe. Należy je zastąpić rzeczywistymi wartościami identyfikatora, adresu URL odpowiedzi i adresu URL logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta SmartRecruiters](https://www.smartrecruiters.com/about-us/contact-us/) do uzyskania tych wartości. Przydatne mogą się również okazać wzorce przedstawione w sekcji **Podstawowa konfiguracja protokołu SAML** w witrynie Azure Portal.

6. Na stronie **Konfigurowanie logowania jednokrotnego za pomocą protokołu SAML** w sekcji **Certyfikat podpisywania SAML** kliknij link **Pobierz**, aby pobrać **certyfikat (Base64)** z podanych opcji zgodnie z wymaganiami i zapisać go na komputerze.

    ![Link pobierania certyfikatu](common/certificatebase64.png)

7. Na **Konfigurowanie SmartRecruiters** sekcji, skopiuj odpowiednie adresy URL, zgodnie z wymaganiami.
...
### <a name="configure-smartrecruiters-single-sign-on"></a>Konfigurowanie SmartRecruiters logowanie jednokrotne
...
1. W **konfiguracji dostawcy tożsamości**, wykonaj następujące czynności:
    ...
    a. W **adres URL dostawcy tożsamości** pola tekstowego, Wklej wartość **adres URL logowania** skopiowanej w witrynie Azure portal.

    b. Otwórz **certificate(Base64)** który został pobrany z witryny Azure portal w programie Notatnik, skopiuj jego zawartość i Wklej do **certyfikatu dostawcy tożsamości** pola tekstowego.
...
1. W witrynie Azure portal wybierz **aplikacje dla przedsiębiorstw**, wybierz opcję **wszystkie aplikacje**, a następnie wybierz **SmartRecruiters**.

    ![Blok Aplikacje dla przedsiębiorstw](common/enterprise-applications.png)

2. Na liście aplikacji wybierz **SmartRecruiters**.
...
### <a name="create-smartrecruiters-test-user"></a>Tworzenie użytkownika testowego SmartRecruiters
...
Po kliknięciu kafelka SmartRecruiters w panelu dostępu, powinien zostać automatycznie zarejestrowaniu w usłudze SmartRecruiters, dla którego skonfigurować logowanie Jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
