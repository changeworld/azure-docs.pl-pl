---
title: 'Samouczek: Integracja usługi Azure Active Directory z konsolą administracyjną Mimecast | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-mimecast-admin-console"></a>Samouczek: Integracja usługi Azure Active Directory z konsolą administracyjną Mimecast
...
5. W sekcji **Profil uwierzytelniania** wykonaj następujące kroki:
    ...
    g. Otwórz certyfikat base-64 pobrany z witryny Azure portal w*--* notatniku, usuń*--* pierwszy wiersz (" ") i ostatni wiersz (" "), skopiuj pozostałą jego zawartość do schowka, a następnie wklej ją do pola tekstowego **Certyfikat dostawcy tożsamości (Metadane).**
