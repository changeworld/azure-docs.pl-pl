...
4. Przejdź do obszaru **Administracja > Uwierzytelnianie > Ustawienia uwierzytelniania** i wykonaj następujące kroki:
    ...
    ![Administracyjnego](./media/zscaler-zscloud-tutorial/ic800206.png "Administracja")
...
Po kliknięciu kafelka rozwiązania Zscaler ZSCloud w panelu dostępu należy automatycznie zalogować się do ZSCloud rozwiązania Zscaler, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
