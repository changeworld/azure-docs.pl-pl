...
1. Na **Sugar CRM domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE] 
    > Wartość nie jest prawdziwe. Zaktualizuj wartość za pomocą adresu URL logowania rzeczywistych. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta CRM Sugar](https://support.sugarcrm.com/) można uzyskać wartość. 
