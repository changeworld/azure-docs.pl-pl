...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sugarcrm-tutorial/tutorial_sugarcrm_samlbase.png)

3. Na **Sugar CRM domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/sugarcrm-tutorial/tutorial_sugarcrm_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sugarcrm-tutorial/tutorial_sugarcrm_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/sugarcrm-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji CRM Sugar** , kliknij przycisk **skonfigurować CRM Sugar** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adresu URL i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sugarcrm-tutorial/tutorial_sugarcrm_configure.png) 

7. W oknie przeglądarki innej witryny sieci web należy zalogować się jako administrator do witryny firmy Sugar CRM.

8. Przejdź do **Admin**.
   
    ![Administrator](./media/sugarcrm-tutorial/ic795888.png "administratora")

9. W **administracji** kliknij **zarządzania hasłami**.
   
    ![Administracja](./media/sugarcrm-tutorial/ic795889.png "administracji")

10. Wybierz **włączyć uwierzytelnianie SAML**.
   
    ![Administracja](./media/sugarcrm-tutorial/ic795890.png "administracji")
...
3. W **administracji** kliknij **Zarządzanie użytkownikami**.
    ...
    ![Administracja](./media/sugarcrm-tutorial/ic795893.png "administracji")
...
5. Na **profilu użytkownika** karcie, wykonaj następujące czynności:
    ...
    ![Nowy użytkownik](./media/sugarcrm-tutorial/ic795895.png "nowego użytkownika")
...
7. Na karcie hasło wykonaj następujące czynności:
    ...
    ![Nowy użytkownik](./media/sugarcrm-tutorial/ic795896.png "nowego użytkownika")
...
2. Na liście aplikacji zaznacz **Sugar CRM**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sugarcrm-tutorial/tutorial_sugarcrm_app.png) 
