...
1. Na **Mercer BenefitsCentral (MBC), domena i adresy URL** sekcji, wykonaj następujące czynności:
...
1. Na liście aplikacji wybierz **Mercer BenefitsCentral (MBC)**.
