---
title: 'Samouczek: Integracja usługi Azure Active Directory z LiquidFiles | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39446102"
---
# <a name="tutorial-azure-active-directory-integration-with-liquidfiles"></a>Samouczek: Integracja usługi Azure Active Directory z LiquidFiles
...
1. Na **LiquidFiles domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<YOUR_SERVER_URL>/saml/init`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<YOUR_SERVER_URL>`

    c. b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<YOUR_SERVER_URL>/saml/consume`

    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywisty adres URL logowania, identyfikator i adres URL odpowiedzi. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta LiquidFiles](https://www.liquidfiles.com/support.html) do uzyskania tych wartości. 
