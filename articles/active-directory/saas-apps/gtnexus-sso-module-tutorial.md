---
title: 'Samouczek: Integracja usługi Azure Active Directory z systemem SSO GTNexus | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-gtnexus-sso-system"></a>Samouczek: Integracja usługi Azure Active Directory z systemem SSO GTNexus
...
W tej sekcji utworzysz użytkownika Britta Simon w aplikacji GTNexus SSO System. Współpracuj z  [zespołem wsparcia SYSTEMU SSO GTNexus,](mailto:support@gtnexus.com)aby dodać użytkowników na platformie SYSTEM SSO GTNexus. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
