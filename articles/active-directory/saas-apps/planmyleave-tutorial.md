...
3. **[Tworzenie użytkownika testowego PlanMyLeave](#create-a-planmyleave-test-user)**  — aby odpowiednikiem Britta Simon w PlanMyLeave połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **PlanMyLeave domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji PlanMyLeave** , kliknij przycisk **skonfigurować PlanMyLeave** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja PlanMyLeave](./media/planmyleave-tutorial/tutorial_planmyleave_configure.png) 
7. W oknie przeglądarki internetowej innej Zaloguj się do dzierżawy PlanMyLeave jako administrator.

8. Przejdź do **konfiguracji systemu**. Następnie na **Zarządzanie zabezpieczeniami** kliknij sekcję **ustawienia języka SAML firmy** .

    ![Konfigurowanie logowania jednokrotnego w aplikacji po stronie](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

9. Na **ustawienia języka SAML** sekcji, kliknij ikonę edytora.

    ![Konfigurowanie logowania jednokrotnego w aplikacji po stronie](./media/planmyleave-tutorial/tutorial_planmyleave_003.png)

10. Na **ustawienia języka SAML aktualizacji** sekcji, wykonaj następujące czynności:
