---
title: 'Samouczek: Integracji Azure Active Directory z Manabi Pocket | Dokumentacja firmy Microsoft'
description: Informacje o sposobie konfigurowania rejestracji jednokrotnej między usługą Azure Active Directory i Manabi Pocket.
...
Z tego samouczka dowiesz się integrowanie Manabi Pocket z usługi Azure Active Directory (Azure AD).

Integracja z usługą Azure AD Manabi Pocket zapewnia następujące korzyści:

- Można kontrolować w usłudze Azure AD, który ma dostęp do Manabi Pocket.
- Umożliwia użytkownikom automatycznie pobrać zalogowane do Manabi Pocket (logowanie jednokrotne) z konta usługi Azure AD.
...
Aby skonfigurować integrację usługi Azure AD Manabi Pocket, należy dodać Manabi Pocket z galerii do listy zarządzanych aplikacji SaaS.
...
4. W polu wyszukiwania wpisz **Manabi Pocket**, wybierz pozycję **Manabi Pocket** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
W tej sekcji możesz skonfigurować i test usługi Azure AD rejestracji jednokrotnej z Manabi Pocket w oparciu o nazwie "Britta Simona" użytkownika testowego.

Dla rejestracji jednokrotnej do pracy usługi Azure AD musi wiedzieć, użytkownik odpowiednika w Manabi Pocket jest dla użytkownika, w usłudze Azure AD. Innymi słowy link relację między użytkownikiem usługi Azure AD i danemu użytkownikowi w Manabi Pocket musi się.

Aby skonfigurować i przetestować usługi Azure AD rejestracji jednokrotnej z Manabi Pocket, należy wykonać poniższe bloki konstrukcyjne:

1. **[Konfigurowanie usługi Azure AD rejestracji jednokrotnej](#configure-azure-ad-single-sign-on)**  — aby umożliwić użytkownikom korzystać z tej funkcji.
2. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)**  — do przetestowania usługi Azure AD rejestracji jednokrotnej z Simona Britta.
3. **[Tworzenie użytkownika testowego Manabi Pocket](#create-a-manabi-pocket-test-user)**  — w celu zapewnienia odpowiednikiem Simona Britta Manabi Pocket, połączonej z usługi Azure AD reprezentację użytkownika.
4. **[Przypisz użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)**  — aby umożliwić Simona Britta do użycia usługi Azure AD rejestracji jednokrotnej.
5. **[Test rejestracji jednokrotnej](#test-single-sign-on)**  — Aby sprawdzić, czy konfiguracja działa.

### <a name="configure-azure-ad-single-sign-on"></a>Konfigurowanie usługi Azure AD rejestracji jednokrotnej

W tej sekcji można włączyć usługi Azure AD rejestracji jednokrotnej w portalu Azure i skonfigurować logowanie jednokrotne w aplikacji Manabi Pocket.

**Aby skonfigurować usługi Azure AD rejestracji jednokrotnej z Manabi Pocket, wykonaj następujące czynności:**

1. W portalu Azure na **Manabi Pocket** strona integracji aplikacji, kliknij przycisk **logowanie jednokrotne**.
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/manabipocket-tutorial/create_aaduser_02.png)
...
W tej sekcji należy utworzyć użytkownika o nazwie Simona Britta w Manabi Pocket. Praca z [zespołem pomocy technicznej Manabi Pocket](mailto:info-ed-cl@ntt.com) Aby dodać użytkowników do platformy Manabi Pocket. Użytkownicy muszą utworzyć i aktywowana, aby użyć rejestracji jednokrotnej.

### <a name="assign-the-azure-ad-test-user"></a>Przypisz użytkownika testowego usługi Azure AD

W tej sekcji można włączyć Simona Britta do używania Azure logowania jednokrotnego za udzielanie dostępu Manabi Pocket.

![Przypisanie roli użytkownika][200] 

**Aby przypisać Simona Britta Manabi Pocket, wykonaj następujące czynności:**

1. W portalu Azure Otwórz widok aplikacji, a następnie przejdź do widoku katalogu i przejdź do **aplikacje dla przedsiębiorstw** kliknięcie **wszystkie aplikacje**.

    ![Przypisz użytkownika][201] 

2. Na liście aplikacji zaznacz **Manabi Pocket**.

    ![Łącze Manabi Pocket na liście aplikacji](./media/manabipocket-tutorial/tutorial_manabipocket_app.png)  
...
Po kliknięciu kafelka Manabi Pocket w panelu dostępu użytkownik powinien pobrać automatycznie zalogowane do aplikacji Manabi Pocket.
