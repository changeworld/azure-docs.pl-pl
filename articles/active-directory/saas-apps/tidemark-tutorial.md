...
1. W polu wyszukiwania wpisz **Tidemark**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/tidemark-tutorial/tutorial_tidemark_search.png)

1. W panelu wyników wybierz **Tidemark**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego Tidemark](#creating-a-tidemark-test-user)**  — aby odpowiednikiem Britta Simon w Tidemark połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **Tidemark domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE] 
    > Te wartości nie są prawdziwe. Zaktualizuj je, używając faktycznego adresu URL i identyfikatora logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta Tidemark](http://www.tidemark.com/contact-us) do uzyskania tych wartości. 
...
1. Na **konfiguracji Tidemark** , kliknij przycisk **skonfigurować Tidemark** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/tidemark-tutorial/tutorial_tidemark_configure.png) 

1. Aby skonfigurować logowanie jednokrotne na **Tidemark** stronie, musisz wysłać pobrany **Certificate(Base64), identyfikator jednostki SAML, adres URL wylogowania i SAML pojedynczego logowania jednokrotnego usługi adresu URL** do [Tidemark zespołu pomocy technicznej](http://www.tidemark.com/contact-us). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
1. Na liście aplikacji wybierz **Tidemark**.
