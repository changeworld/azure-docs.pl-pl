...
1. **[Tworzenie użytkownika testowego RFPIO](#creating-a-rfpio-test-user)**  — aby odpowiednikiem Britta Simon w RFPIO połączonego z usługi Azure AD reprezentacja użytkownika.
