---
title: 'Samouczek: Integracja usługi Azure Active Directory z PlanGrid | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39046069"
---
# <a name="tutorial-azure-active-directory-integration-with-plangrid"></a>Samouczek: Integracja usługi Azure Active Directory z PlanGrid
...
6. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/plangrid-tutorial/tutorial_general_400.png)
    
7. Aby skonfigurować logowanie jednokrotne na **PlanGrid** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej PlanGrid](mailto:help@plangrid.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
