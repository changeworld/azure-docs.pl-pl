...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_samlbase.png)

3. Na **HackerOne jeden adres URL logowania i identyfikator** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji HackerOne** , kliknij przycisk **skonfigurować HackerOne** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_configure.png) 

7. Zaloguj się na dzierżawcy HackerOne jako administrator.

8. W menu u góry kliknij pozycję "**ustawienia**."
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_001.png) 

9. Przejdź do "**uwierzytelniania**"i kliknij przycisk"**Dodaj ustawienia SAML**."
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_003.png) 

10. Na **ustawienia SAML** okna dialogowego, wykonaj następujące czynności:
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_004.png) 
...
11. W oknie dialogowym Ustawienia uwierzytelniania wykonaj następujące czynności:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_005.png) 
...
2. Na liście aplikacji zaznacz **HackerOne**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/hackerone-tutorial/tutorial_hackerone_app.png) 
