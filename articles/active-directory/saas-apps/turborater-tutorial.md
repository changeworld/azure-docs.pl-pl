...
3. **[Tworzenie użytkownika testowego TurboRater](#create-a-turborater-test-user)**  — aby odpowiednikiem Britta Simon w TurboRater połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **TurboRater domena i adresy URL** sekcji, wykonaj następujące czynności:
...
7. Aby skonfigurować logowanie jednokrotne na **TurboRater** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej TurboRater](https://www.getitc.com/support). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
