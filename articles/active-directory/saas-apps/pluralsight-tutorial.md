...
1. W polu wyszukiwania wpisz **Pluralsight**, wybierz opcję **Pluralsight** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego Pluralsight](#create-a-pluralsight-test-user)**  — aby odpowiednikiem Britta Simon w Pluralsight, połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **Pluralsight, domena i adresy URL** sekcji, wykonaj następujące czynności:
...
1. Celem tej sekcji jest, aby włączyć usługi Azure AD logowania jednokrotnego w witrynie Azure portal oraz konfigurowania logowania jednokrotnego w aplikacji w witrynie Pluralsight.
...
1. Aby dodać wymagane **atrybuty tokenu języka SAML**, dla każdego wiersza pokazano w poniższej tabeli, wykonaj następujące czynności:
...
1. Aby uzyskać logowanie Jednokrotne skonfigurowane pod kątem swojej aplikacji, skontaktuj się z pomocą [Pluralsight specjalistyczne](mailTo:professionalservices@pluralsight.com) zespołu i określ plik metadanych pobrany.
...
1. Na liście aplikacji wybierz **Pluralsight**.
