...
Aby skonfigurować logowanie jednokrotne na **Imagineer WebVision** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [zespołem pomocy technicznej Imagineer WebVision](mailto:support@itgny.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
