---
title: 'Samouczek: Integracja usługi Azure Active Directory z SafeConnect | Dokumentacja firmy Microsoft'
...
ms.locfileid: "40025091"
---
# <a name="tutorial-azure-active-directory-integration-with-safeconnect"></a>Samouczek: Integracja usługi Azure Active Directory z SafeConnect
...
3. Na **SafeConnect domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    ![SafeConnect domena i adresy URL pojedynczego logowania jednokrotnego informacji](./media/safeconnect-tutorial/tutorial_safeconnect_url.png)
     ...
     W **adres URL logowania** pole tekstowe, wpisz adres URL: `https://portal.myweblogon.com:8443/saml/login`
