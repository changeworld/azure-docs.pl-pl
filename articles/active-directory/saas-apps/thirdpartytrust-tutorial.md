...
6. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie przycisku Zapisz logowania jednokrotnego](./media/thirdpartytrust-tutorial/tutorial_general_400.png)
    
7. Aby skonfigurować logowanie jednokrotne na **ThirdPartyTrust** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej ThirdPartyTrust](mailto:support@thirdpartytrust.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
