---
title: 'Samouczek: Integracja rejestracji jednokrotnej usługi Azure Active Directory (Logowanie jednokrotne) z usługą LinkedIn Learning | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-linkedin-learning"></a>Samouczek: Integracja rejestracji jednokrotnej usługi Azure Active Directory (Logowanie jednokrotne) z usługą LinkedIn Learning

W tym samouczku dowiesz się, jak zintegrować usługę LinkedIn Learning z usługą Azure Active Directory (Azure AD). Po zintegrowaniu usługi LinkedIn Learning z usługą Azure AD można:

* Kontrola w usłudze Azure AD, która ma dostęp do usługi LinkedIn Learning.
* Włącz użytkownikom automatyczne logowanie do usługi LinkedIn Learning za pomocą ich kont usługi Azure AD.
...
* Subskrypcja z włączoną funkcją logowania jednokrotnego linkedin learning.LinkedIn Learning single sign-on (SSO) enabled subscription.
...
* Po skonfigurowaniu usługi LinkedIn Learning można wymusić kontrolę sesji, która chroni eksfiltrację i infiltrację poufnych danych organizacji w czasie rzeczywistym. Kontrola sesji rozciąga się od dostępu warunkowego. [Dowiedz się, jak wymusić kontrolę nad sesją za pomocą programu Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-aad)
...
1. W sekcji **Dodaj z galerii** wpisz **linkedin learning** w polu wyszukiwania.
1. Wybierz **pozycję LinkedIn Learning** z panelu wyników, a następnie dodaj aplikację. Poczekaj kilka sekund, gdy aplikacja zostanie dodana do dzierżawy.


## <a name="configure-and-test-azure-ad-single-sign-on-for-linkedin-learning"></a>Konfigurowanie i testowanie logowania jednokrotnego usługi Azure AD dla usługi LinkedIn Learning

Konfigurowanie i testowanie usługi Azure AD SSO za pomocą usługi LinkedIn Learning przy użyciu użytkownika testowego o nazwie **B.Simon**. Aby użytkownik łączony sytuować działał, należy ustanowić relację łącza między użytkownikiem usługi Azure AD a powiązanym użytkownikiem w usłudze LinkedIn Learning.

Aby skonfigurować i przetestować przychylić do usługi Azure AD sytuować za pomocą usługi LinkedIn Learning, wykonaj następujące bloki konstrukcyjne:

1. **[Skonfiguruj samouszeńcę usługi Azure AD](#configure-azure-ad-sso)** — aby umożliwić użytkownikom korzystanie z tej funkcji.
    1. **[Utwórz użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD za pomocą usługi B.Simon.
    1. **[Przypisz użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić B.Simon używać logowania jednokrotnego usługi Azure AD.
1. **[Skonfiguruj logowanie jednokrotne usługi LinkedIn Learning](#configure-linkedin-learning-sso)** — aby skonfigurować ustawienia logowania jednokrotnego po stronie aplikacji.
    1. **[Utwórz użytkownika testowego usługi LinkedIn Learning](#create-linkedin-learning-test-user)** — aby mieć odpowiednik B.Simon w usłudze LinkedIn Learning, który jest połączony z reprezentacją użytkownika usługi Azure AD.
...
1. W [witrynie Azure portal](https://portal.azure.com/)— na stronie integracji aplikacji **Usługi LinkedIn Learning** znajdź sekcję **Zarządzaj** i wybierz **opcję logowanie jednokrotne**.
...
1. W sekcji **Podstawowa konfiguracja SAML,** jeśli chcesz skonfigurować aplikację w trybie inicjowanym **przez IDP,** wprowadź wartości dla następujących pól:
    ...
    > [!NOTE]
    > Wartości te nie są wartościami rzeczywistymi. Te wartości zostaną zaktualizowane za pomocą rzeczywistego adresu URL identyfikatora i odpowiedzi, co zostanie wyjaśnione w dalszej części sekcji **Konfigurowanie samouczek samounikacwojenia SSO uczenia LinkedIn** w samouczku.

1. Aplikacja LinkedIn Learning oczekuje potwierdzeń SAML w określonym formacie, który wymaga dodania mapowań atrybutów niestandardowych do konfiguracji atrybutów tokenu SAML. Na poniższym zrzucie ekranu przedstawiono listę atrybutów domyślnych, gdzie atrybut **nameidentifier** jest mapowany na atrybut **user.userprincipalname**. Aplikacja LinkedIn Learning oczekuje, że atrybut **nameidentifier** będzie zamapowany na atrybut **user.mail**, dlatego należy zmodyfikować mapowanie atrybutów, klikając ikonę **Edytuj** i zmieniając mapowanie atrybutów.
...
1. W sekcji **Konfigurowanie usługi LinkedIn Learning** skopiuj odpowiednie adresy URL na podstawie wymagań.
...
W tej sekcji włączysz B.Simon do korzystania z logowania jednokrotnego platformy Azure, przyznając dostęp do usługi LinkedIn Learning.

1. W portalu Azure wybierz pozycję **Aplikacje dla przedsiębiorstw**, a następnie wybierz pozycję **Wszystkie aplikacje**.
1. Na liście aplikacji wybierz pozycję **LinkedIn Learning**.
...
## <a name="configure-linkedin-learning-sso"></a>Konfigurowanie usługi linkedin learning sytego
...
- [Wypróbuj usługę LinkedIn Learning za pomocą usługi Azure AD](https://aad.portal.azure.com/)
