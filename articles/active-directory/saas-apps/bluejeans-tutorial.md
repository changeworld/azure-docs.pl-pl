...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bluejeans-tutorial/tutorial_bluejeans_samlbase.png)

3. Na **BlueJeans domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/bluejeans-tutorial/tutorial_bluejeans_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **Certificate(Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bluejeans-tutorial/tutorial_bluejeans_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/bluejeans-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji BlueJeans** , kliknij przycisk **skonfigurować BlueJeans** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, Zmień adres URL hasła i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bluejeans-tutorial/tutorial_bluejeans_configure.png) 
...
11. Przenieś następujące czynności:
    ...
    ![Zapisz zmiany](./media/bluejeans-tutorial/IC785874.png "zapisać zmiany")
...
Celem tej sekcji jest utworzenie użytkownika o nazwie Simona Britta w BlueJeans. BlueJeans obsługę automatycznego użytkownika, który jest domyślnie włączone. Więcej informacji można znaleźć [tutaj](bluejeans-provisioning-tutorial.md) na temat konfigurowania użytkowników automatycznego inicjowania obsługi administracyjnej.
...
2. Na liście aplikacji zaznacz **BlueJeans**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bluejeans-tutorial/tutorial_bluejeans_app.png)
...
* [Skonfiguruj Inicjowanie obsługi użytkowników](bluejeans-provisioning-tutorial.md)
