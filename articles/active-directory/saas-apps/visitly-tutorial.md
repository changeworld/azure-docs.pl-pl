...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w aplikacji Visitly. Współpracuj z [zespołem pomocy technicznej](mailto:support@visitly.io) w celu dodania użytkowników na platformie. Użytkownicy muszą być tworzone i aktywowana, aby używać logowania jednokrotnego.
