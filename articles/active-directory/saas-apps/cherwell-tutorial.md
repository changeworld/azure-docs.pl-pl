---
title: 'Samouczek: Integracja usługi Azure Active Directory z programem Cherwell | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-cherwell"></a>Samouczek: Integracja usługi Azure Active Directory z programem Cherwell
...
Aby umożliwić użytkownikom usługi Azure AD zalogować się do Cherwell, muszą one być aprowizowana w Cherwell. W przypadku aplikacji Cherwell konta użytkowników muszą zostać utworzone przez Twój [zespół pomocy technicznej aplikacji Cherwell](https://cherwellsupport.com/CherwellPortal).
