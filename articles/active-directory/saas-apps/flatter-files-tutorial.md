...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatterfiles_samlbase.png)
...
3. Na **płaska domeny plików i adresy URL** sekcji, użytkownik nie trzeba wykonywać żadnych czynności, jak aplikacja już jest wstępna Integracja z usługą Azure.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatterfiles_url.png)
 
4. Na **certyfikat podpisywania SAML** kliknij **Certificate(Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.

    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatterfiles_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_general_400.png)
...
6. Na **płaska pliki konfiguracji** , kliknij przycisk **skonfigurować płaska pliki** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatterfiles_configure.png) 

7. Logowanie do aplikacji płaska plików jako administrator.

8. Kliknij przycisk **pulpitu NAWIGACYJNEGO**. 
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatter_files_05.png)  

9. Kliknij przycisk **ustawienia**, a następnie wykonaj następujące czynności na **firmy** karty: 
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatter_files_06.png)  
...
8. Na **Konfiguracja SAML** okna dialogowego, wykonaj następujące czynności: 
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatter_files_08.png)  
...
2. W okienku nawigacji po lewej stronie kliknij **ustawienia**, a następnie kliknij przycisk **użytkowników** kartę.
    ...
    ![Utwórz użytkownika płaska plików](./media/flatter-files-tutorial/tutorial_flatter_files_09.png)

3. Kliknij przycisk **dodać użytkownika**. 

4. Na **Dodaj użytkownika** okna dialogowego, wykonaj następujące czynności:
   
    ![Utwórz użytkownika płaska plików](./media/flatter-files-tutorial/tutorial_flatter_files_10.png)
...
2. Na liście aplikacji zaznacz **płaska pliki**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/flatter-files-tutorial/tutorial_flatterfiles_app.png) 
