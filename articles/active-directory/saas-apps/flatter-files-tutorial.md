...
4. W polu wyszukiwania wpisz **płaski pliki**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/flatter-files-tutorial/tutorial_flatterfiles_search.png)

5. W panelu wyników wybierz **płaski pliki**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego płaski pliki](#creating-a-flatter-files-test-user)**  — aby odpowiednikiem Britta Simon w płaski plików, które jest połączone z usługi Azure AD reprezentacja użytkownika.
...
3. Na **płaski domena plików i adresy URL** sekcji, użytkownik nie ma do wykonywania żadnych czynności, jak aplikacja już jest wstępnie zintegrowana z platformą Azure.
...
6. Na **płaski pliki konfiguracji** , kliknij przycisk **Konfigurowanie plików płaski** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/flatter-files-tutorial/tutorial_flatterfiles_configure.png) 

7. Logowanie jednokrotne do aplikacji płaski plików jako administrator.

8. Kliknij przycisk **pulpit NAWIGACYJNY**. 
...
8. Na **plik konfiguracji SAML** okno dialogowe, należy wykonać następujące czynności: 
...
2. W okienku nawigacji po lewej stronie kliknij pozycję **ustawienia**, a następnie kliknij przycisk **użytkowników** kartę.
...
4. Na **Dodaj użytkownika** okno dialogowe, należy wykonać następujące czynności:
...
2. Na liście aplikacji wybierz **płaski pliki**.
