---
title: 'Samouczek: Konfigurowanie Fuze na potrzeby automatycznego aprowizacji użytkowników przy użyciu Azure Active Directory | Microsoft Docs'
...
5. W sekcji **poświadczenia administratora** wprowadź `https://api.fuze.com/scim/v2` **adres URL dzierżawy**. Wprowadź wartość **tokenu uwierzytelniania Standard scim** , która została pobrana wcześniej zprzedstawiciela Fuze w tokenie tajnym. Kliknij pozycję **Testuj połączenie** , aby upewnić się, że usługa Azure AD może się połączyć z usługą Fuze. Jeśli połączenie nie powiedzie się, upewnij się, że konto usługi Fuze ma uprawnienia administratora, a następnie spróbuj ponownie.
