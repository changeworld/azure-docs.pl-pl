...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-cbre-serviceinsight"></a>Samouczek: Azure Active Directory integrację logowania jednokrotnego (SSO) z usługą CBRE ServiceInsight
...
Aby skonfigurować logowanie jednokrotne po stronie aplikacji **CBRE ServiceInsight**, musisz wysłać **adres URL metadanych federacyjnych aplikacji** do [zespołu pomocy technicznej aplikacji CBRE ServiceInsight](mailto:SISupport@cbre.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
