...
4. W polu wyszukiwania wpisz **SafetyNet**, wybierz opcję **SafetyNet** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego SafetyNet](#create-a-safetynet-test-user)**  — aby odpowiednikiem Britta Simon w SafetyNet, połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **SafetyNet domena i adresy URL** sekcji, wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
    ...
    a. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.predictivesolutions.com/sp`

    b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.predictivesolutions.com/CRMApp/saml/SSO`
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** zainicjowano tryb:
    ...
    W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.predictivesolutions.com`
     
    > [!NOTE] 
    > Te wartości są prawdziwe. Rzeczywisty identyfikator, adres URL odpowiedzi i adres URL logowania, należy zaktualizować te wartości. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta SafetyNet](mailto:dev@predictivesolutions.com) do uzyskania tych wartości.
...
5. Na **certyfikat podpisywania SAML** sekcji, kliknij przycisk kopiowania, aby skopiować **adres Url metadanych Federacji aplikacji** i wklej go w Notatniku.
    ...
    ![Link pobierania certyfikatu](./media/safetynet-tutorial/tutorial_safetynet_certificate.png)

6. Kliknij przycisk **Zapisz** przycisku.

    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/safetynet-tutorial/tutorial_general_400.png)

7. Aby skonfigurować logowanie jednokrotne na **SafetyNet** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [zespołem pomocy technicznej SafetyNet](mailto:dev@predictivesolutions.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **SafetyNet**.
