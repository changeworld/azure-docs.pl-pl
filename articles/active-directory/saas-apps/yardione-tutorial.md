...
1. Aby skonfigurować logowanie jednokrotne na **YardiOne** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [zespołem pomocy technicznej YardiOne](https://clientcentral.yardi.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
