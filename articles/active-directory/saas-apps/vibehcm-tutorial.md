...
Aby skonfigurować logowanie jednokrotne na **Vibe HCM** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [Vibe HCM wsparcia zespołu](mailto:support@vibehcm.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
