...
4. W polu wyszukiwania wpisz **przyjęcia LMS**, wybierz pozycję **przyjęcia LMS** w wyniku panelu, a następnie wybierz **Dodaj** przycisku.
    ...
    ![Przyjęcia LMS na liście wyników](./media/absorblms-tutorial/tutorial_absorblms_addfromgallery.png)
...
3. W **adresy URL i przyjęcia domeny LMS** sekcji, wykonaj następujące czynności:
    ...
    ![Przyjęcia LMS domeny i adres URL pojedynczego logowania jednokrotnego informacji](./media/absorblms-tutorial/tutorial_absorblms_url.png)
...
4. W **certyfikat podpisywania SAML** sekcji w **Pobierz** kolumny wybierz **XML metadanych**, a następnie zapisz plik metadanych do komputera.
    ...
    ![Łącze pobierania certyfikatu podpisywania](./media/absorblms-tutorial/tutorial_absorblms_certificate.png) 

5. Wybierz pozycję **Zapisz**.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/absorblms-tutorial/tutorial_general_400.png)
...
6. W **przyjęcia konfiguracji LMS** wybierz opcję **skonfigurować LMS przyjęcia** otworzyć **Konfigurowanie logowania jednokrotnego** okna, a następnie skopiuj **Sign-Out adresu URL** w **sekcji krótkimi opisami.**
    ...
    ![W okienku przyjęcia LMS konfiguracji](./media/absorblms-tutorial/tutorial_absorblms_configure.png) 
...
8. Wybierz **konta** u góry po prawej stronie. 
    ...
    ![Przycisk Konto](./media/absorblms-tutorial/1.png)

9. Wybierz w okienku konta **ustawienia portalu**.

    ![Łącze Ustawienia portalu](./media/absorblms-tutorial/2.png)
...
2. Aby wyświetlić listę użytkowników, wybierz **użytkowników i grup** > **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/absorblms-tutorial/create_aaduser_02.png) 
...
2. W okienku po lewej stronie wybierz **użytkowników**.
    ...
    ![Łącze przyjęcia użytkowników LMS](./media/absorblms-tutorial/absorblms_users.png)
...
4. W **Dodaj nowy** listy rozwijanej wybierz **użytkownika**.
    ...
    ![Dodaj nowy listy rozwijanej](./media/absorblms-tutorial/absorblms_createuser.png)
...
2. W **aplikacji** listy, wybierz **przyjęcia LMS**.
    ...
    ![Łącze przyjęcia LMS na liście aplikacji](./media/absorblms-tutorial/tutorial_absorblms_app.png) 
...
W panelu dostępu wybierając **przyjęcia LMS** kafelków automatycznie loguje się użytkownik do przyjęcia LMS aplikacji. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../active-directory-saas-access-panel-introduction.md).
