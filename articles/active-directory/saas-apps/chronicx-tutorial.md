---
title: 'Samouczek: Integracja usługi Azure Active Directory z ChronicX® | Dokumentacja firmy Microsoft'
...
3. **[Tworzenie użytkownika testowego ChronicX®](#create-a-chronicx®-test-user)**  — aby odpowiednikiem Britta Simon w ChronicX® połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **ChronicX® domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.chronicx.com/ups/processlogonSSO.jsp`

    b. W **identyfikator** pole tekstowe, wpisz adres URL: `ups.chronicx.com`

    > [!NOTE] 
    > Wartość adres URL logowania nie jest prawdziwe. Zaktualizuj wartość za pomocą adresu URL logowania rzeczywistych. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta® ChronicX](https://www.casebank.com/contact-us/) można uzyskać wartość. 
...
5. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/chronicx-tutorial/tutorial_general_400.png)

6. Aby skonfigurować logowanie jednokrotne na **ChronicX®** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej ChronicX®](https://www.casebank.com/contact-us/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
Celem tej sekcji jest, aby utworzyć użytkownika o nazwie Britta Simon w ChronicX®. ChronicX® obsługę just-in-time, który jest domyślnie włączona. Brak elementu akcji dla Ciebie w tej sekcji. Nowy użytkownik jest tworzony podczas próby dostępu ChronicX®, jeśli go jeszcze nie istnieje.
