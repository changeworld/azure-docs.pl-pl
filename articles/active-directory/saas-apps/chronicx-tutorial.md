...
1. **[Tworzenie użytkownika testowego ChronicX®](#create-a-chronicx®-test-user)**  — aby odpowiednikiem Britta Simon w ChronicX® połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Aby skonfigurować logowanie jednokrotne na **ChronicX®** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej ChronicX®](https://www.casebank.com/contact-us/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
