...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-iserver-portal"></a>Samouczek: Azure Active Directory integrację logowania jednokrotnego (SSO) z portalem iServer
...
1. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** wprowadź wartości dla następujących pól:
    ...
    a. W polu **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `iserver-portal-<myiserverportal>`
...
Aby skonfigurować Logowanie jednokrotne na stronie **portalu iServer** , należy wysłać **wartość odcisku palca** i odpowiednie skopiowane adresy URL z Azure Portal do [zespołu pomocy technicznej portalu iServer](mailto:support@orbussoftware.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.

### <a name="create-iserver-portal-test-user"></a>Utwórz użytkownika testowego portalu iServer

W tej sekcji utworzysz użytkownika o nazwie B. Simon w portalu iServer. Współpracuj z [zespołem pomocy technicznej portalu iServer](mailto:support@orbussoftware.com) , aby dodać użytkowników na platformie portalu iServer. Użytkownicy muszą być tworzone i aktywowana, aby używać logowania jednokrotnego.

## <a name="test-sso"></a>Testuj Logowanie jednokrotne 

W tej sekcji służy do testowania konfiguracji usługi Azure AD pojedynczego logowania jednokrotnego przy użyciu panelu dostępu.

Po kliknięciu kafelka portalu iServer w panelu dostępu należy automatycznie zalogować się do portalu usługi iServer, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
