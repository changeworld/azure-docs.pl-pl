...
ms.locfileid: "39045244"
---
# <a name="tutorial-azure-active-directory-integration-with-tango-analytics"></a>Samouczek: Integracja usługi Azure Active Directory z usługą Tango Analytics
...
3. **[Tworzenie użytkownika testowego Tango Analytics](#creating-a-tango-analytics-test-user)**  — aby odpowiednikiem Britta Simon w analizy Tango, połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Tango Analytics domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://mts.tangoanalytics.com/saml2/sp/acs/post`

    > [!NOTE] 
    > Wartość adresu URL odpowiedzi nie jest prawdziwe. Zaktualizować to rzeczywisty adres URL odpowiedzi. Skontaktuj się z pomocą [zespołu pomocy technicznej Tango Analytics](mailto:support@tangoanalytics.com) aby zyskać tę wartość.
...
6. Aby skonfigurować logowanie jednokrotne na **Tango Analytics** stronie, musisz wysłać pobrany **XML metadanych** do [Tango Analytics zespołu pomocy technicznej](mailto:support@tangoanalytics.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
