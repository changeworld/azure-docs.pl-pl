...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjowanym przez **dostawcę tożsamości**, w sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące kroki:
    ...
    a. W polu tekstowym **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `https://mobilexpense.com/ServiceProvider`
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Mobile Xpense. Praca z [zespołem pomocy technicznej Mobile Xpense](https://www.mobilexpense.net/contact) Aby dodać użytkowników na platformie Mobile Xpense. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
