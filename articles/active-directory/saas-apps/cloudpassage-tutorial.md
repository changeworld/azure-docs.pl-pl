---
title: 'Samouczek: integracja Azure Active Directory z usługą CloudPassage | Microsoft Docs'
...
ms.locfileid: "73157359"
---
# <a name="tutorial-azure-active-directory-integration-with-cloudpassage"></a>Samouczek: integracja Azure Active Directory z usługą CloudPassage
...
1. W sekcji **Add New User (Dodaj nowego użytkownika)** wykonaj następujące kroki: 
    ...
    d. W polu tekstowym **Username (Nazwa użytkownika)** , polu tekstowym{b> <b}**Email (Adres e-mail)** i polu tekstowym **Retype Email (Wpisz ponownie adres e-mail)** wpisz nazwę użytkownika Britta w usłudze Azure AD.
