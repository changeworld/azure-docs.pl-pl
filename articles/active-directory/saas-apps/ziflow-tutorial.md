...
3. Na **Ziflow domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i domeny Ziflow pojedynczy informacje logowania jednokrotnego](./media/ziflow-tutorial/tutorial_ziflow_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/ziflow-tutorial/tutorial_ziflow_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/ziflow-tutorial/tutorial_general_400.png)
...
10. Na **rejestracji jednokrotnej** wykonaj następujące czynności:
    ...
    ![Ziflow konfiguracji pojedynczej](./media/ziflow-tutorial/tutorial_ziflow_page.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/ziflow-tutorial/create_aaduser_02.png)
...
2. Przejdź do **osób** u góry.
    ...
    ![Osoby Ziflow konfiguracji](./media/ziflow-tutorial/tutorial_ziflow_people.png)

3. Kliknij przycisk **Dodaj** , a następnie kliknij przycisk **Dodaj użytkownika**.

    ![Dodawanie użytkownika Ziflow konfiguracji](./media/ziflow-tutorial/tutorial_ziflow_add.png)

4. Na **dodać użytkownika** menu podręczne, wykonaj następujące czynności:

    ![Dodawanie użytkownika Ziflow konfiguracji](./media/ziflow-tutorial/tutorial_ziflow_adduser.png)
...
2. Na liście aplikacji zaznacz **Ziflow**.
    ...
    ![Łącze Ziflow na liście aplikacji](./media/ziflow-tutorial/tutorial_ziflow_app.png)  
