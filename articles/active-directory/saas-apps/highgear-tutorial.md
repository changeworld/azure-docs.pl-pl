---
title: 'Samouczek: Integracja usługi Azure Active Directory z highgear | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-highgear"></a>Samouczek: Integracja usługi Azure Active Directory z highgear
...
1. W obszarze **Nazwa dostawcy tożsamości** wpisz krótki opis, który będzie wyświetlany na przycisku logowania jednokrotnego w aplikacji HighGear na stronie logowania. Na przykład: usługa Azure AD
