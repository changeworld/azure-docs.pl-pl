...
3. **[Tworzenie użytkownika testowego Skytap](#create-a-skytap-test-user)**  — aby odpowiednikiem Britta Simon w Skytap połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Skytap domena i adresy URL** sekcji, wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. Aby skonfigurować logowanie jednokrotne na **Skytap** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Skytap](mailto:support@skytap.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
