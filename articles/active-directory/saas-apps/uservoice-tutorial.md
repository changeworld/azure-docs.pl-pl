...
3. Na **UserVoice domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i domeny UserVoice pojedynczy informacje logowania jednokrotnego](./media/uservoice-tutorial/tutorial_uservoice_url.png)
...
4. Na **certyfikat podpisywania SAML** sekcji, skopiuj **odcisk PALCA** wartości certyfikatu.
    ...
    ![Łącze pobierania certyfikatu](./media/uservoice-tutorial/tutorial_uservoice_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/uservoice-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/uservoice-tutorial/create_aaduser_02.png)
...
4. Kliknij przycisk **agentów i uprawnienia**.
    ...
    ![Agenci i uprawnienia](./media/uservoice-tutorial/ic777812.png "agentów i uprawnień")
...
6. Na **zaprosić Administratorzy** okna dialogowego, wykonaj następujące czynności:
    ...
    ![Zaproś Administratorzy](./media/uservoice-tutorial/ic777814.png "zaprosić Administratorzy")
...
2. Na liście aplikacji zaznacz **UserVoice**.
    ...
    ![Łącze UserVoice na liście aplikacji](./media/uservoice-tutorial/tutorial_uservoice_app.png)  
