...
4. W polu wyszukiwania wpisz **rozwiązaniem SAP Cloud klienta**.
...
5. W panelu wyników wybierz **rozwiązaniem SAP Cloud klienta**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie chmury SAP dla użytkownika testowego klienta](#creating-a-sap-cloud-for-customer-test-user)**  — aby odpowiednikiem Britta Simon w chmurze SAP dla klienta, który jest połączony z usługi Azure AD reprezentacja użytkownika.
...
3. Na **chmura SAP dla klientów, domena i adresy URL** sekcji, wykonaj następujące czynności:
...
4. Na **atrybutów użytkownika** sekcji, wykonaj następujące czynności:
...
7. Na **rozwiązaniem SAP Cloud klienta konfiguracji** , kliknij przycisk **skonfigurować rozwiązaniem SAP Cloud klienta** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/sap-customer-cloud-tutorial/tutorial_sapcloudforcustomer_configure.png) 

8. Aby skonfigurować logowanie Jednokrotne, wykonaj następujące czynności:
...
2. Na liście aplikacji wybierz **rozwiązaniem SAP Cloud klienta**.
