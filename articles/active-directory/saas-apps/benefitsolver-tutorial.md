...
4. W polu wyszukiwania wpisz **Benefitsolver**, wybierz opcję **Benefitsolver** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego Benefitsolver](#create-a-benefitsolver-test-user)**  — aby odpowiednikiem Britta Simon w Benefitsolver połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Benefitsolver domena i adresy URL** sekcji, wykonaj następujące czynności:
...
4. Twoja aplikacja Benefitsolver oczekuje twierdzenia SAML w określonym formacie, który wymaga dodania mapowań atrybutów niestandardowych, aby Twoje **atrybuty tokenu języka saml** konfiguracji.
...
8. Aby skonfigurować logowanie jednokrotne na **Benefitsolver** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Benefitsolver](https://www.businessolver.com/contact).
...
2. Na liście aplikacji wybierz **Benefitsolver**.
