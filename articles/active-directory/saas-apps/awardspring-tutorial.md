...
Aby skonfigurować logowanie jednokrotne po stronie aplikacji **AwardSpring**, musisz wysłać pobrany **plik XML metadanych federacji** i odpowiednie adresy URL skopiowane z witryny Azure Portal do [zespołu pomocy technicznej aplikacji AwardSpring](mailto:support@awardspring.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
