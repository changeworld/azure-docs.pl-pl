...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bridge-tutorial/tutorial_bridge_samlbase.png)

3. Na **Mostek domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/bridge-tutorial/tutorial_bridge_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **Certificate(Raw)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bridge-tutorial/tutorial_bridge_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/bridge-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji mostu** , kliknij przycisk **Mostek Konfiguruj** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bridge-tutorial/tutorial_bridge_configure.png) 
...
2. Na liście aplikacji zaznacz **Mostek**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/bridge-tutorial/tutorial_bridge_app.png) 
