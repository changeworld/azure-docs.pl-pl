...
4. W polu wyszukiwania wpisz **Encompass**, wybierz pozycję **Encompass** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Obejmować na liście wyników](./media/encompass-tutorial/tutorial_encompass_addfromgallery.png)
...
3. Na **adresy URL i obejmować domeny** sekcji, wykonaj następujące czynności:
    ...
    ![Wszystkie domeny i adres URL pojedynczego logowania jednokrotnego informacji](./media/encompass-tutorial/tutorial_encompass_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **Certificate(Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/encompass-tutorial/tutorial_encompass_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/encompass-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji obejmują** , kliknij przycisk **skonfigurować obejmować** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adresu URL i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Obejmować konfiguracji](./media/encompass-tutorial/tutorial_encompass_configure.png) 
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/encompass-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **Encompass**.
    ...
    ![Łącze Encompass na liście aplikacji](./media/encompass-tutorial/tutorial_encompass_app.png)  
