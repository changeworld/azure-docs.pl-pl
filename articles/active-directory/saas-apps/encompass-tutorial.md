...
4. W polu wyszukiwania wpisz **Encompass**, wybierz opcję **Encompass** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego Encompass](#create-a-encompass-test-user)**  — aby odpowiednikiem Britta Simon w Encompass połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **uwzględniający domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji obejmują** , kliknij przycisk **skonfigurować uwzględniający** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Uwzględniający konfiguracji](./media/encompass-tutorial/tutorial_encompass_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **Encompass** stronie, musisz wysłać pobrany **Certificate(Base64), adres URL wylogowania i SAML pojedynczego logowania jednokrotnego usługi adresu URL** do [zespołem pomocy technicznej Encompass](http://www.voxmobile.com/contact/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Encompass**.
