...
1. W polu wyszukiwania wpisz **Klue**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/klue-tutorial/tutorial_klue_search.png)

1. W panelu wyników wybierz **Klue**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego Klue](#creating-a-klue-test-user)**  — aby odpowiednikiem Britta Simon w Klue połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **Klue domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
1. Aplikacja Klue oczekuje twierdzenia SAML w określonym formacie, który wymaga dodania mapowania atrybutów niestandardowych konfiguracji atrybuty tokenu języka SAML. Możesz zarządzać wartości te atrybuty z "**atrybutów użytkownika**" sekcji na stronie integracji aplikacji. 
...
1. Na **konfiguracji Klue** , kliknij przycisk **skonfigurować Klue** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego adres URL usługi** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/klue-tutorial/tutorial_klue_configure.png) 

1. Aby skonfigurować logowanie jednokrotne na **Klue** stronie, musisz wysłać pobrany **Certificate(Base64), SAML pojedynczego logowania jednokrotnego usługi adresu URL i identyfikator jednostki SAML** do [zespołem pomocy technicznej Klue](mailto:support@klue.com).
