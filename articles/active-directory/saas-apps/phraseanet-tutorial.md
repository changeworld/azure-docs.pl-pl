---
title: 'Samouczek: Integracja usługi Azure Active Directory z Phraseanet | Dokumentacja firmy Microsoft'
...
ms.locfileid: "49118658"
---
# <a name="tutorial-azure-active-directory-integration-with-phraseanet"></a>Samouczek: Integracja usługi Azure Active Directory z Phraseanet
...
4. Na **podstawową konfigurację protokołu SAML** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE] 
    > Wartość adres URL logowania nie jest prawdziwe. Zaktualizuj wartość za pomocą adresu URL logowania rzeczywistych. Skontaktuj się z pomocą [zespołem pomocy technicznej Phraseanet](mailto:support@alchemy.fr) można uzyskać wartość.
...
6. Aby skonfigurować logowanie jednokrotne na **Phraseanet** stronie, musisz wysłać pobrany **XML metadanych Federacji** do [zespołem pomocy technicznej Phraseanet](mailto:support@alchemy.fr). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
