...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/soonr-tutorial/tutorial_soonr_samlbase.png)

3. Na **Soonr Dołączanie domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/soonr-tutorial/tutorial_soonr_url.png)
...
4. Na **Soonr Dołączanie domeny i adres URL** sekcji, jeśli chcesz skonfigurować aplikację w **SP zainicjował tryb**, wykonaj następujące czynności:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/soonr-tutorial/tutorial_soonr_url1.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/soonr-tutorial/tutorial_soonr_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/soonr-tutorial/tutorial_general_400.png)
...
7. Na **Soonr pracy konfiguracji** , kliknij przycisk **skonfigurować miejsce pracy Soonr** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/soonr-tutorial/tutorial_soonr_configure.png) 
...
2. Na liście aplikacji zaznacz **pracy Soonr**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/soonr-tutorial/tutorial_soonr_app.png) 
