...
1. Na **menedżera o podwyższonym ryzyku IMPAC domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w trybie zainicjował dostawcy tożsamości należy wykonać następujące czynności:
...
1. Na liście aplikacji wybierz **menedżera o podwyższonym ryzyku IMPAC**.
