...
4. W polu wyszukiwania wpisz **Dow Jones Factiva**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/dowjones-factiva-tutorial/tutorial_dowjonesfactiva_search.png)

5. W panelu wyników wybierz **Dow Jones Factiva**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego Dow Jones Factiva](#creating-a-dow-jones-factiva-test-user)**  — aby odpowiednikiem Britta Simon w Dow Factiva Jones, połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Dow Jones Factiva domena i adresy URL** sekcji, użytkownik nie ma do wykonywania żadnych czynności, jak aplikacja już jest wstępnie zintegrowana z platformą Azure.
...
6. Aby skonfigurować logowanie jednokrotne na **Dow Jones Factiva** stronie, musisz wysłać pobrany **XML metadanych** do [Dow Jones Factiva zespołem pomocy technicznej](https://www.dowjones.com/contact/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Dow Jones Factiva**.
