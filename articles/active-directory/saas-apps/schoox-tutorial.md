---
title: 'Samouczek: Integracja usługi Azure Active Directory z Schoox | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39051404"
---
# <a name="tutorial-azure-active-directory-integration-with-schoox"></a>Samouczek: Integracja usługi Azure Active Directory z Schoox
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** zainicjowano tryb:
    ...
    W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://saml.schoox.com/saml/login?idpUrl=<entityID>`
...
6. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/schoox-tutorial/tutorial_general_400.png)
...
8. Aby skonfigurować logowanie jednokrotne na **Schoox** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Schoox](https://www.schoox.com/help/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Schoox. Praca z [zespołem pomocy technicznej Schoox](https://www.schoox.com/help/) Aby dodać użytkowników na platformie Schoox. Użytkownicy muszą być tworzone i aktywowana, aby używać logowania jednokrotnego.
