---
title: 'Samouczek: Integracja usługi Azure Active Directory z przekazywaniem obrazów | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-image-relay"></a>Samouczek: Integracja usługi Azure Active Directory z przekazywaniem obrazów
...
7. W oknie dialogowym **SAML Settings** (Ustawienia SAML) wykonaj następujące czynności:
    ...
    d. Jako format **Name Id Format** (Format identyfikatora nazwy) wybierz pozycję **urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress**.
