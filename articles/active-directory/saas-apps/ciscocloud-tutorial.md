...
4. W polu wyszukiwania wpisz **chmury Cisco**, wybierz pozycję **chmury Cisco** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Chmura Cisco na liście wyników](./media/ciscocloud-tutorial/tutorial_ciscocloud_addfromgallery.png)
...
3. Na **adresy URL i domenę chmury Cisco** sekcji, wykonaj następujące kroki, aby skonfigurować aplikację w **IDP** inicjowane tryb:
    ...
    ![Adresy URL i domenę chmury Cisco pojedynczy informacje logowania jednokrotnego](./media/ciscocloud-tutorial/tutorial_ciscocloud_url.png)
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** inicjowane tryb:
    ...
    ![Adresy URL i domenę chmury Cisco pojedynczy informacje logowania jednokrotnego](./media/ciscocloud-tutorial/tutorial_ciscocloud_url1.png)
...
5. Na **certyfikat podpisywania SAML** sekcji, kliknij przycisk Kopiuj, aby skopiować **adres Url metadanych Federacji aplikacji** i wklej go do Notatnika.
    ...
    ![Łącze pobierania certyfikatu](./media/ciscocloud-tutorial/tutorial_ciscocloud_certificate.png)

6. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/ciscocloud-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/ciscocloud-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **chmury Cisco**.
    ...
    ![Łącze Cisco chmury na liście aplikacji](./media/ciscocloud-tutorial/tutorial_ciscocloud_app.png)  
