...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/heroku-tutorial/tutorial_heroku_samlbase.png)

3. Na **Heroku domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/heroku-tutorial/tutorial_heroku_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/heroku-tutorial/tutorial_heroku_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/heroku-tutorial/tutorial_general_400.png)
...
6. Aby włączyć logowanie Jednokrotne w Heroku, wykonaj następujące czynności:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/heroku-tutorial/tutorial_heroku_52.png) 
...
2. Na liście aplikacji zaznacz **Heroku**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/heroku-tutorial/tutorial_heroku_app.png) 
