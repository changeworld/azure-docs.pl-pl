...
3. **[Tworzenie użytkownika testowego Qualtrics](#create-a-qualtrics-test-user)**  — aby odpowiednikiem Britta Simon w Qualtrics połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Qualtrics domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **Qualtrics** stronie, musisz wysłać pobrany **XML metadanych** do [zespołu pomocy technicznej Qualtrics](https://www.qualtrics.com/support/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
