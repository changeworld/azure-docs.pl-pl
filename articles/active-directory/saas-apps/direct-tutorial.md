...
3. **[Tworzenie użytkownika testowego bezpośredniego](#creating-a-direct-test-user)**  — aby odpowiednikiem Britta Simon w bezpośrednich, połączonego z usługi Azure AD reprezentacja użytkownika.
