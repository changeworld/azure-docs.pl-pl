...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/tutorial_kantegassoforjira_samlbase.png)

3. W **IDP** inicjowane w trybie **logowania jednokrotnego Kantega JIRA domeny i adresów URL** sekcji wykonaj następujące kroki:

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/tutorial_kantegassoforjira_url1.png)
...
4. W **SP** inicjowane trybie wyboru **Pokaż zaawansowane ustawienia adresu URL** i wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/tutorial_kantegassoforjira_url2.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/tutorial_kantegassoforjira_certificate.png) 
...
8. Umieść kursor na koło zębate, a następnie kliknij przycisk **dodatki**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon1.png)
...
9. W sekcji Karta dodatki, kliknij przycisk **znaleźć nowe dodatki**. Wyszukiwanie **Kantega Usługa rejestracji Jednokrotnej dla JIRA (SAML i protokołu Kerberos)** i kliknij przycisk **zainstalować** przycisk, aby zainstalować nowy wtyczki SAML.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon2.png)

10. Uruchamia instalację dodatku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon3.png)

11. Po zakończeniu instalacji. Kliknij przycisk **Zamknij**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon33.png)

12. Kliknij pozycję **Zarządzaj**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon34.png)
    
13. Nowej wtyczki znajduje się w obszarze **integracji**. Kliknij przycisk **Konfiguruj** do skonfigurowania nowej wtyczki.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon35.png)

14. W **SAML** sekcji. Wybierz **usługi Azure Active Directory (Azure AD)** z **dostawcy tożsamości Dodaj** listy rozwijanej.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon4.png)

15. Wybierz poziom subskrypcji jako **podstawowe**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon5.png)       

16. Na **właściwości aplikacji** sekcji, wykonaj następujące kroki: 

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon6.png)
...
17. Na **importu metadanych** sekcji, wykonaj następujące kroki: 
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon7.png)
...
18. Na **nazwę i logowania jednokrotnego lokalizację** sekcji, wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon8.png)
...
19. Sprawdź certyfikatu podpisywania, a następnie kliknij przycisk **dalej**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon9.png)

20. Na **kont użytkowników JIRA** sekcji, wykonaj następujące kroki:

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon10.png)
...
21. Kliknij przycisk **Zakończ**.   
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon11.png)

22. Na **znanych domeny dla usługi Azure AD** sekcji, wykonaj następujące kroki: 

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/addon12.png)
...
2. Na liście aplikacji zaznacz **Kantega Usługa rejestracji Jednokrotnej dla JIRA**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforjira-tutorial/tutorial_kantegassoforjira_app.png) 
