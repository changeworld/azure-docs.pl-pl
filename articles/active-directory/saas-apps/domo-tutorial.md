---
title: 'Samouczek: Integracja usługi Azure Active Directory z Domo | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39443300"
---
# <a name="tutorial-azure-active-directory-integration-with-domo"></a>Samouczek: Integracja usługi Azure Active Directory z Domo
...
1. Na **Domo domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<companyname>.domo.com`
    ...
    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta Domo](mailto:support@domo.com) do uzyskania tych wartości.
...
Brak elementu akcji dla Ciebie w tej sekcji. Nowy użytkownik jest tworzony podczas próby dostępu Domo, jeśli go jeszcze nie istnieje.
