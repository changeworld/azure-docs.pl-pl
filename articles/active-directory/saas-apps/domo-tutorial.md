...
3. **[Tworzenie użytkownika testowego Domo](#creating-a-domo-test-user)**  — aby odpowiednikiem Britta Simon w Domo połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Domo domena i adresy URL** sekcji, wykonaj następujące czynności:
...
4. Aplikacja Domo oczekuje twierdzenia SAML w określonym formacie. Skonfiguruj następujące oświadczenia dla tej aplikacji. Możesz zarządzać wartości te atrybuty z "**atrybutów użytkownika**" sekcji na stronie integracji aplikacji. Poniższy zrzut ekranu przedstawia przykład w przypadku tej konfiguracji. 
...
8. Na **konfiguracji Domo** , kliknij przycisk **skonfigurować Domo** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**   

   ![Konfigurowanie logowania jednokrotnego](./media/domo-tutorial/tutorial_domo_configure.png) 

9. Aby skonfigurować logowanie jednokrotne na **Domo** po stronie, przejdź do artykułu bazy wiedzy firmy Domo znaleziono [tutaj](http://knowledge.domo.com?cid=azuread)i postępuj zgodnie z instrukcjami.
...
2. Na liście aplikacji wybierz **Domo**.
