...
Aby skonfigurować logowanie jednokrotne po stronie rozwiązania **Blackboard Learn — Shibboleth**, musisz wysłać pobrany **kod XML metadanych federacji** i odpowiednie adresy URL skopiowane z witryny Azure Portal [zespołowi pomocy technicznej rozwiązania Blackboard Learn — Shibboleth](https://www.blackboard.com/forms/contact-us_form.aspx). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
