---
title: 'Samouczek: Integracja usługi Azure Active Directory z Workstars | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39055544"
---
# <a name="tutorial-azure-active-directory-integration-with-workstars"></a>Samouczek: Integracja usługi Azure Active Directory z Workstars
...
3. **[Tworzenie użytkownika testowego Workstars](#create-a-workstars-test-user)**  — aby odpowiednikiem Britta Simon w Workstars połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Workstars domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.workstars.com/saml/login_check`

    > [!NOTE] 
    > Wartość nie jest prawdziwe. Zaktualizuj wartość za pomocą rzeczywisty adres URL odpowiedzi. Skontaktuj się z pomocą [zespołu pomocy technicznej Workstars](https://support.workstars.com) można uzyskać wartość.
 
4. Na **certyfikat podpisywania SAML** kliknij **certyfikat (Base64)** , a następnie zapisz plik certyfikatu na komputerze.

    ![Link pobierania certyfikatu](./media/workstars-tutorial/tutorial_workstars_certificate.png) 

5. Kliknij przycisk **Zapisz** przycisku.

    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/workstars-tutorial/tutorial_general_400.png)

6. Na **konfiguracji Workstars** , kliknij przycisk **skonfigurować Workstars** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja Workstars](./media/workstars-tutorial/tutorial_workstars_configure.png) 

7. W innym oknie przeglądarki Zaloguj się do witryny firmy Workstars jako administrator.

8. Na głównym pasku narzędzi kliknij polecenie **ustawienia**.

    ![Ustawien Workstars](./media/workstars-tutorial/tutorial_workstars_sett.png)
...
10. Na **pojedynczy znak na (SAML) — ustawienia** strony, wykonaj następujące czynności:
