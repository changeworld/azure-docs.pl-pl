...
3. **[Tworzenie użytkownika testowego sieci Skyhigh](#create-a-skyhigh-networks-test-user)**  — aby odpowiednikiem Britta Simon w sieciach Skyhigh, połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Skyhigh sieci domena i adresy URL** sekcji, wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. Na **konfiguracji sieci Skyhigh** , kliknij przycisk **Konfigurowanie sieci Skyhigh** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja sieci Skyhigh](./media/skyhighnetworks-tutorial/tutorial_skyhighnetworks_configure.png) 

8. Aby skonfigurować logowanie jednokrotne na **sieci Skyhigh** stronie, musisz wysłać pobrany **certyfikat (Base64), adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** do [ Zespołu pomocy technicznej sieci Skyhigh](mailto:support@skyhighnetworks.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
