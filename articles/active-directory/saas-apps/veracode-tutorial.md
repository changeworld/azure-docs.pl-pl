...
3. Na **Veracode domeny i adres URL** sekcji, użytkownik nie trzeba wykonywać żadnych czynności, jak aplikacja już jest wstępna Integracja z usługą Azure. 
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/veracode-tutorial/tutorial_veracode_url.png)

4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.

    ![Łącze pobierania certyfikatu](./media/veracode-tutorial/tutorial_veracode_certificate.png) 
...
7. Kliknij przycisk **zapisać** przycisku.
    ...
    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/veracode-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/veracode-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **Veracode**.
    ...
    ![Łącze Veracode na liście aplikacji](./media/veracode-tutorial/tutorial_veracode_app.png)  
