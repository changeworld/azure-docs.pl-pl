...
4. W polu wyszukiwania wpisz **angażowanie Moxi**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/moxiengage-tutorial/tutorial_moxiengage_search.png)

5. W panelu wyników wybierz **angażowanie Moxi**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego angażowanie Moxi](#creating-a-moxi-engage-test-user)**  — aby odpowiednikiem Britta Simon w Moxi angażowanie połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Moxi angażowanie domena i adresy URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie logowania jednokrotnego](./media/moxiengage-tutorial/tutorial_moxiengage_url.png)

    W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://svc.<moxiworks-integration-domain>/service/v1/auth/inbound/saml/aad`
...
6. Aby skonfigurować logowanie jednokrotne na **angażowanie Moxi** stronie, musisz wysłać pobrany **XML metadanych** do [Moxi skontaktuj się z zespołem pomocy technicznej](mailto:support@moxiworks.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
