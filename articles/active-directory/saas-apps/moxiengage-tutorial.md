...
Aby skonfigurować logowanie jednokrotne na **Moxi angażowanie** stronie, musisz wysłać pobrany **XML metadanych Federacji** i odpowiednie skopiowany adresy URL z portalu Azure, aby [Moxi Zaangażuj zespół pomocy technicznej](mailto:support@moxiworks.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Moxi zaangażowania. Praca z [Moxi skontaktuj się z zespołem pomocy technicznej](mailto:support@moxiworks.com) Aby dodać użytkowników na platformie Moxi zaangażowania. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
