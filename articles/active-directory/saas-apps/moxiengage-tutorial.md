...
1. Aby skonfigurować logowanie jednokrotne na **angażowanie Moxi** stronie, musisz wysłać pobrany **XML metadanych** do [Moxi skontaktuj się z zespołem pomocy technicznej](mailto:support@moxiworks.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
