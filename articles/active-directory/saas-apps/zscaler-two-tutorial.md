...
1. W polu wyszukiwania wpisz **dwa rozwiązania Zscaler**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/zscaler-two-tutorial/tutorial_zscalertwo_search.png)

1. W panelu wyników wybierz **dwa rozwiązania Zscaler**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego dwa rozwiązania Zscaler](#creating-a-zscaler-two-test-user)**  — aby odpowiednikiem Britta Simon w rozwiązania Zscaler dwóch połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **rozwiązania Zscaler dwóch domena i adresy URL** sekcji, wykonaj następujące czynności:
...
1. Na **dwóch konfiguracji rozwiązania Zscaler** kliknij **skonfigurować dwa rozwiązania Zscaler** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/zscaler-two-tutorial/tutorial_zscalertwo_configure.png) 

1. W oknie przeglądarki innej witryny sieci web należy zalogować się jako administrator do rozwiązania ZScaler dwie witryny firmy.
...
1. Na liście aplikacji wybierz **dwa rozwiązania Zscaler**.
