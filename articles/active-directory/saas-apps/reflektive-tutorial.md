...
6. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie przycisku Zapisz logowania jednokrotnego](./media/reflektive-tutorial/tutorial_general_400.png)

7. Aby skonfigurować logowanie jednokrotne na **Reflektive** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Reflektive](https://support@reflektive.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
