...
Aby skonfigurować logowanie jednokrotne na **ProMaster (przez Inlogik)** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [zespołem pomocy technicznej ProMaster (przez Inlogik)](mailto:michael.boldiston@inlogik.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
