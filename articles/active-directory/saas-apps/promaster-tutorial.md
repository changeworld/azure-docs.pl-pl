...
* Umożliwia użytkownikom można automatycznie zalogowany do ProMaster (przez Inlogik) (logowanie jednokrotne) przy użyciu konta usługi Azure AD.
...
* ProMaster (przez Inlogik) obsługuje **SP** i **tożsamości** jednokrotne logowanie inicjowane przez
...
W tej sekcji możesz skonfigurować i przetestować usługi Azure AD logowanie jednokrotne za pomocą ProMaster (przez Inlogik), w oparciu o użytkownika testu o nazwie **Britta Simon**.
Dla logowania jednokrotnego do pracy relację łącza między użytkownika usługi Azure AD i powiązanego użytkownika w ProMaster (przez Inlogik) musi zostać ustanowione.
...
2. **[Konfigurowanie ProMaster (przez Inlogik) logowanie jednokrotne](#configure-promaster-by-inlogik-single-sign-on)**  — Aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD z użytkownikiem Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić użytkownikowi Britta Simon korzystanie z logowania jednokrotnego usługi Azure AD.
5. **[Tworzenie użytkownika testowego ProMaster (przez Inlogik)](#create-promaster-by-inlogik-test-user)**  — aby odpowiednikiem Britta Simon w ProMaster (przez Inlogik), połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. W [witryny Azure portal](https://portal.azure.com/)na **ProMaster (przez Inlogik)** strona integracji aplikacji, wybierz opcję **logowanie jednokrotne**.
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjowanym przez **dostawcę tożsamości**, w sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące kroki:
    ...
    ![ProMaster (przez Inlogik) domena i adresy URL pojedynczy informacje logowania jednokrotnego](common/idp-intiated.png)
...
5. Kliknij przycisk **Ustaw dodatkowe adresy URL** i wykonaj następujący krok, jeśli chcesz skonfigurować aplikację w trybie inicjowania przez **dostawcę usług**:
    ...
    ![ProMaster (przez Inlogik) domena i adresy URL pojedynczy informacje logowania jednokrotnego](common/metadata-upload-additional-signon.png)
    ...
    > [!NOTE]
    > Te wartości nie są prawdziwe. Należy je zastąpić rzeczywistymi wartościami identyfikatora, adresu URL odpowiedzi i adresu URL logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta ProMaster (przez Inlogik)](mailto:michael.boldiston@inlogik.com) do uzyskania tych wartości. Przydatne mogą się również okazać wzorce przedstawione w sekcji **Podstawowa konfiguracja protokołu SAML** w witrynie Azure Portal.
...
### <a name="configure-promaster-by-inlogik-single-sign-on"></a>Konfigurowanie ProMaster (przez Inlogik) logowanie jednokrotne

Aby skonfigurować logowanie jednokrotne na **ProMaster (przez Inlogik)** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [zespołem pomocy technicznej ProMaster (przez Inlogik)](mailto:michael.boldiston@inlogik.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
### <a name="create-promaster-by-inlogik-test-user"></a>Tworzenie użytkownika testowego ProMaster (przez Inlogik)
