...
Aby skonfigurować logowanie jednokrotne na **Teamwork.com** stronie, musisz wysłać pobrany **XML metadanych Federacji** i odpowiednie skopiowany adresy URL z portalu Azure, aby [Teamwork.com zespołem pomocy technicznej ](mailto:support@teamwork.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
