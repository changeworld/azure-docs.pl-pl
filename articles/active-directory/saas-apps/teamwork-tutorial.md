...
1. Aby skonfigurować logowanie jednokrotne na **Teamwork.com** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Teamwork.com](mailto:support@teamwork.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
