...
3. Na **Teamwork.com domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i domeny Teamwork.com pojedynczy informacje logowania jednokrotnego](./media/teamwork-tutorial/tutorial_teamwork_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/teamwork-tutorial/tutorial_teamwork_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/teamwork-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/teamwork-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **Teamwork.com**.
    ...
    ![Łącze Teamwork.com na liście aplikacji](./media/teamwork-tutorial/tutorial_teamwork_app.png)  
