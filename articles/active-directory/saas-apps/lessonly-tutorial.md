...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_lesson.ly_samlbase.png)

3. Na **Lesson.ly domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_lesson.ly_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **Certificate(Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_lesson.ly_certificate.png)
...
5. Aplikacja Lesson.ly oczekuje potwierdzenia języka SAML w określonym formacie, musisz dodać mapowania atrybutu niestandardowego do Twojej **atrybuty tokenu SAML** konfiguracji. Poniższy zrzut ekranu przedstawia przykład tego.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_lessonly_06.png)
...
6. W **atrybuty użytkownika** sekcji na **logowanie jednokrotne** okna dialogowego, skonfiguruj atrybut tokenu SAML, jak pokazano na powyższej ilustracji i wykonaj następujące czynności:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_attribute_04.png)

    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_attribute_05.png)
...
7. Kliknij przycisk **zapisać** przycisku.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_general_400.png)
...
8. Na **konfiguracji Lesson.ly** , kliknij przycisk **skonfigurować Lesson.ly** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_lesson.ly_configure.png)
...
2. Na liście aplikacji zaznacz **Lesson.ly**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lessonly-tutorial/tutorial_lesson.ly_app.png) 
