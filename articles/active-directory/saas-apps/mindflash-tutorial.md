...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/mindflash-tutorial/tutorial_mindflash_samlbase.png)

3. Na **Mindflash domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/mindflash-tutorial/tutorial_mindflash_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/mindflash-tutorial/tutorial_mindflash_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/mindflash-tutorial/tutorial_general_400.png)
...
2. Przejdź do **Zarządzanie użytkownikami**.
    ...
    ![Zarządzaj użytkownikami](./media/mindflash-tutorial/ic787140.png "Zarządzanie użytkownikami")
...
2. Na liście aplikacji zaznacz **Mindflash**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/mindflash-tutorial/tutorial_mindflash_app.png) 
