...
1. W polu wyszukiwania wpisz **Mindflash**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/mindflash-tutorial/tutorial_mindflash_search.png)

1. W panelu wyników wybierz **Mindflash**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego Mindflash](#creating-a-mindflash-test-user)**  — aby odpowiednikiem Britta Simon w Mindflash połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **Mindflash domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    b. W polu tekstowym **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `https://<companyname>.mindflash.com`

    > [!NOTE] 
    > Te wartości nie są prawdziwe. Zaktualizuj je, używając faktycznego adresu URL i identyfikatora logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta Mindflash](https://www.mindflash.com/contact/) do uzyskania tych wartości. 
...
1. Aby skonfigurować logowanie jednokrotne na **Mindflash** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Mindflash](https://www.mindflash.com/contact/).
...
1. Na liście aplikacji wybierz **Mindflash**.
