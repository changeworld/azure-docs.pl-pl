---
title: 'Samouczek: Integracja usługi Azure Active Directory z Kindling | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39428655"
---
# <a name="tutorial-azure-active-directory-integration-with-kindling"></a>Samouczek: Integracja usługi Azure Active Directory z Kindling
...
1. Na **Kindling domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<companyname>.kindlingapp.com`

    b.  W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<companyname>.kindlingapp.com/saml/module.php/saml/sp/metadata.php/clientIDP`

    > [!NOTE] 
    > Te wartości nie są rzeczywiste. Zaktualizuj te wartości przy użyciu rzeczywisty adres URL logowania i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej Kindling](mailto:support@kindlingapp.com) do uzyskania tych wartości.
