...
3. **[Tworzenie użytkownika testowego LoginRadius](#create-a-loginradius-test-user)**  — aby odpowiednikiem Britta Simon w LoginRadius połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **LoginRadius domena i adresy URL** sekcji, wykonaj następujące czynności:
...
7. Aby skonfigurować logowanie jednokrotne na **LoginRadius** stronie, musisz wysłać pobrany **XML metadanych** do [zespołu pomocy technicznej LoginRadius](mailto:support@loginradius.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
