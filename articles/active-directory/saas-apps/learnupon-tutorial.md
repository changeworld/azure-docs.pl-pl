---
title: 'Samouczek: Integracja usługi Azure Active Directory z LearnUpon | Dokumentacja firmy Microsoft'
...
3. Na **LearnUpon domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<companyname>.learnupon.com/saml/consumer`
...
Brak elementu akcji dla Ciebie w tej sekcji. Nowy użytkownik zostanie utworzony podczas próby dostępu LearnUpon, jeśli go jeszcze nie istnieje. [Konfigurowanie usługi Azure AD jednokrotnej](#configuring-azure-ad-single-single-sign-on).
