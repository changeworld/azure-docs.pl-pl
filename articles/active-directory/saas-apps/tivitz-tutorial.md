...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/tivitz-tutorial/tutorial_tivitz_samlbase.png)

3. Na **TiViTz domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/tivitz-tutorial/tutorial_tivitz_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/tivitz-tutorial/tutorial_tivitz_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/tivitz-tutorial/tutorial_general_400.png)
...
2. Na liście aplikacji zaznacz **TiViTz**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/tivitz-tutorial/tutorial_tivitz_app.png) 
