...
1. Na **umiejętności Menedżera domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE] 
    > Te wartości nie są prawdziwe. Zastąp te wartości rzeczywistymi wartościami identyfikatora i adresu URL odpowiedzi. Skontaktuj się z pomocą [Menedżera umiejętności zespołu pomocy technicznej](https://www.ibm.com/support/uk/?lnk=msu_uk) do uzyskania tych wartości.
 
1. Na **certyfikat podpisywania SAML** kliknij **Certificate(Base64)** , a następnie zapisz plik certyfikatu na komputerze.

    ![Link do pobierania certyfikatu](./media/skillsmanager-tutorial/tutorial_skillsmanager_certificate.png) 

1. Kliknij przycisk **Zapisz** przycisku.

    ![Konfigurowanie przycisku Zapisz logowania jednokrotnego](./media/skillsmanager-tutorial/tutorial_general_400.png)
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Menedżerze umiejętności. Praca z [Menedżera umiejętności zespołu pomocy technicznej](https://www.ibm.com/support/uk/?lnk=msu_uk) Aby dodać użytkowników na platformie Menedżera umiejętności. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
