...
4. W polu wyszukiwania wpisz **Menedżera umiejętności**, wybierz pozycję **Menedżera umiejętności** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Menedżer umiejętności z listy wyników](./media/skillsmanager-tutorial/tutorial_skillsmanager_addfromgallery.png)
...
3. Na **domeny Menedżera umiejętności i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i domeny Menedżera umiejętności pojedynczy informacje logowania jednokrotnego](./media/skillsmanager-tutorial/tutorial_skillsmanager_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **Certificate(Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/skillsmanager-tutorial/tutorial_skillsmanager_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/skillsmanager-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/skillsmanager-tutorial/create_aaduser_02.png)
