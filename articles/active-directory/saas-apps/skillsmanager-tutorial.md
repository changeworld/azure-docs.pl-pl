...
3. **[Tworzenie użytkownika testowego Menedżera umiejętności](#create-a-skills-manager-test-user)**  — aby odpowiednikiem Britta Simon w Menedżer umiejętności, który jest połączony z usługi Azure AD reprezentacja użytkownika.
...
3. Na **umiejętności Menedżera domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **umiejętności Menedżera konfiguracji** kliknij **Konfigurowanie Menedżera umiejętności** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Umiejętności Menedżera konfiguracji](./media/skillsmanager-tutorial/tutorial_skillsmanager_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **Menedżera umiejętności** stronie, musisz wysłać pobrany **Certificate(Base64)**, **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** do [Menedżera umiejętności zespołu pomocy technicznej](https://www.ibm.com/support/uk/?lnk=msu_uk). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
