...
4. W polu wyszukiwania wpisz **detalicznej Infor — Zarządzanie informacji**, wybierz pozycję **detalicznej Infor — Zarządzanie informacji** z panelu wyników następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikacja.
    ...
    ![Infor detalicznej — Zarządzanie informacji z listy wyników](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_addfromgallery.png)
...
3. Na **Infor detalicznej — informacje o domenie zarządzania i adres URL** sekcji, wykonaj następujące kroki, aby skonfigurować aplikację w trybie IDP inicjowane:
    ...
    ![Informacje logowania jednokrotnego IDP pojedynczy infor detalicznej — informacje o domenie zarządzania i adres URL](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url.png)
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** inicjowane tryb:
    ...
    ![Infor detalicznej — informacje o domenie zarządzania i adresy URL pojedynczego logowania jednokrotnego informacji SP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url1.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/inforretailinformationmanagement-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/inforretailinformationmanagement-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **detalicznej Infor — Zarządzanie informacji**.
    ...
    ![Detaliczne Infor — Zarządzanie informacji łącza na liście aplikacji](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_app.png)  
