...
3. **[Utwórz handlu detalicznego Infor — Zarządzanie informacji użytkownika testowego](#create-an-infor-retail--information-management-test-user)**  — aby odpowiednikiem Britta Simon w sprzedaży detalicznej Infor — Zarządzanie informacji, połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Infor handlu detalicznego — informacje o zarządzanie domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w trybie zainicjował dostawcy tożsamości należy wykonać następujące czynności:
...
7. Aby skonfigurować logowanie jednokrotne na **handlu detalicznego Infor — Zarządzanie informacji** stronie, musisz wysłać pobrany **XML metadanych** do [handlu detalicznego Infor — informacje o zarządzanie zespołem pomocy technicznej](mailto:innovate@infor.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
