...
4. W sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące czynności:
    ...
    a. W polu tekstowym **Adres URL logowania** wpisz adres URL, korzystając z następującego wzorca: `https://<subdomain>.lcvista.com/rainier/login`
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w LCVista. Praca z [zespołem pomocy technicznej klienta LCVista](https://lcvista.com/contact) Aby dodać użytkowników na platformie LCVista. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
