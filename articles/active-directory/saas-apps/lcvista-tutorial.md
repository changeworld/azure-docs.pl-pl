...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lcvista-tutorial/tutorial_lcvista_samlbase.png)

3. Na **LCVista domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/lcvista-tutorial/tutorial_lcvista_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lcvista-tutorial/tutorial_lcvista_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/lcvista-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji LCVista** , kliknij przycisk **skonfigurować LCVista** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML identyfikator jednostki** i **SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lcvista-tutorial/tutorial_lcvista_configure.png) 
...
8. W **SAML Config** sekcji wyboru **Włącz SAML logowania** i wprowadź szczegóły, jak wspomniano w poniżej obrazu. 
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lcvista-tutorial/tutorial_lcvista_config.png)
...
2. Na liście aplikacji zaznacz **LCVista**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/lcvista-tutorial/tutorial_lcvista_app.png) 
