...
3. **[Tworzenie użytkownika testowego TrackVia](#create-a-trackvia-test-user)**  — aby odpowiednikiem Britta Simon w TrackVia połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **TrackVia domena i adresy URL** sekcji, wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. Na **konfiguracji TrackVia** , kliknij przycisk **skonfigurować TrackVia** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **identyfikator jednostki SAML** z **krótki przewodnik po sekcji.**

    ![Konfiguracja TrackVia](./media/trackvia-tutorial/tutorial_trackvia_configure.png)
    
8. W oknie innej przeglądarki Zaloguj się do witryny firmy TrackVia jako administrator.

9. Kliknij pozycję Trackvia **Moje konto** ustawienia, a następnie wybierz **logowanie jednokrotne** karcie, wykonaj następujące czynności:
