...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_samlbase.png)

3. Na **adresy URL i małej domeny ulepszenia** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_general_400.png)
...
6. Na **małych konfiguracji ulepszenia** , kliknij przycisk **skonfigurować małych ulepszenia** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_configure.png) 
...
8. Na stronie głównej pulpitu nawigacyjnego kliknij **administracji** przycisku po lewej stronie.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_06.png) 

9. Kliknij przycisk **logowania jednokrotnego SAML** przycisk z **integracji** sekcji.
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_07.png) 

10. Na stronie Ustawienia logowania jednokrotnego wykonaj następujące czynności:
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_08.png)  
...
2. Na liście aplikacji zaznacz **ulepszenia małych**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/smallimprovements-tutorial/tutorial_smallimprovements_app.png) 
