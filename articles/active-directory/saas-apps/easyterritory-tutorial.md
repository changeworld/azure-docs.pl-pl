...
4. W polu wyszukiwania wpisz **EasyTerritory**, wybierz opcję **EasyTerritory** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego EasyTerritory](#create-a-easyterritory-test-user)**  — aby odpowiednikiem Britta Simon w EasyTerritory połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **EasyTerritory domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w trybie zainicjował dostawcy tożsamości należy wykonać następujące czynności:
...
7. Aby skonfigurować logowanie jednokrotne na **EasyTerritory** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej EasyTerritory](mailto:sales@easyterritory.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **EasyTerritory**.
