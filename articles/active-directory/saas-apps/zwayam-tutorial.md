---
title: 'Samouczek: Integracja usługi Azure Active Directory z Zwayam | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39050089"
---
# <a name="tutorial-azure-active-directory-integration-with-zwayam"></a>Samouczek: Integracja usługi Azure Active Directory z Zwayam
...
3. **[Tworzenie użytkownika testowego Zwayam](#create-a-zwayam-test-user)**  — aby odpowiednikiem Britta Simon w Zwayam połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Zwayam domena i adresy URL** sekcji, wykonaj następujące czynności:

    ![Zwayam domena i adresy URL pojedynczego logowania jednokrotnego informacji](./media/zwayam-tutorial/tutorial_Zwayam_url.png)

    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://sso.zwayam.com/zwayam-saml/zwayam-saml/saml/login?idp=<SAML Entity ID>`

    b. W **identyfikator** pole tekstowe, wpisz adres URL: `https://sso.zwayam.com/zwayam-saml/saml/metadata`

    > [!NOTE] 
    > Wartość adres URL logowania nie jest prawdziwe. **Identyfikator jednostki SAML** wartość zostało wyjaśnione w dalszej części tego samouczka.
...
5. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/zwayam-tutorial/tutorial_general_400.png)

6. Na **konfiguracji Zwayam** , kliknij przycisk **skonfigurować Zwayam** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopii **identyfikator jednostki SAML** z **krótki przewodnik po sekcji** i Wklej **identyfikator jednostki SAML** wartość w **adres URL logowania** polu tekstowym w  **Zwayam domena i adresy URL** sekcji.

    ![Konfiguracja Zwayam](./media/zwayam-tutorial/tutorial_Zwayam_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **Zwayam** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Zwayam](mailto:opendoors@zwayam.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
