...
1. Aby skonfigurować logowanie jednokrotne na **Zwayam** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Zwayam](mailto:opendoors@zwayam.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
