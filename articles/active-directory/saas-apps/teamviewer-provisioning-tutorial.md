---
title: 'Samouczek: Konfigurowanie programu TeamViewer do automatycznego inicjowania obsługi administracyjnej za pomocą usługi Azure Active Directory | Dokumenty firmy Microsoft'
description: Dowiedz się, jak automatycznie aprowizować i usuwać aprowizyję kont użytkowników z usługi Azure AD do programu TeamViewer.
...
---
# <a name="tutorial-configure-teamviewer-for-automatic-user-provisioning"></a>Samouczek: Konfigurowanie programu TeamViewer do automatycznego inicjowania obsługi administracyjnej przez użytkowników

W tym samouczku opisano kroki, które należy wykonać zarówno w usłudze TeamViewer, jak i w usłudze Azure Active Directory (Azure AD) w celu skonfigurowania automatycznego inicjowania obsługi administracyjnej użytkowników. Po skonfigurowaniu usługa Azure AD automatycznie aprowizacji i usuwania przepisów użytkowników i grup [do TeamViewer](https://www.teamviewer.com/buy-now/) przy użyciu usługi Azure AD inicjowania obsługi administracyjnej usługi. Aby uzyskać ważne informacje na temat działania tej usługi, działania i często zadawanych pytań, zobacz [Automatyzacja inicjowania obsługi administracyjnej i usuwania obsługi administracyjnej aplikacji SaaS za pomocą usługi Azure Active Directory](../manage-apps/user-provisioning.md). 


## <a name="capabilities-supported"></a>Obsługiwane możliwości
> [!div class="checklist"]
> * Tworzenie użytkowników w teamviewer
> * Usuwanie użytkowników w programie TeamViewer, gdy nie wymagają już dostępu
> * Synchronizacja atrybutów użytkownika między usługą Azure AD i TeamViewer
> * [Logowanie jednokrotne w](https://docs.microsoft.com/azure/active-directory/saas-apps/teamviewer-tutorial) programie TeamViewer (zalecane)
...
* Ważna [licencja Tensor](https://www.teamviewer.com/de/teamviewer-tensor/) dla TeamViewer.
* Prawidłowy identyfikator niestandardowy z dostępnej konfiguracji [logowania jednokrotnego.](https://community.teamviewer.com/t5/Knowledge-Base/Single-Sign-On-with-Azure-Active-Directory/ta-p/60209#toc-hId--473669723)
...
3. Określ, jakie dane mają [być mapowane między usługą Azure AD a programem TeamViewer](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-teamviewer-to-support-provisioning-with-azure-ad"></a>Krok 2. Configure TeamViewer to support provisioning with Azure AD

1. Zaloguj się do [Konsoli zarządzania TeamViewer](https://login.teamviewer.com). Przejdź do **pozycji Edytuj profil**.

    ![Konsola administracyjna TeamViewer](./media/teamviewer-provisioning-tutorial/admin.png)

2.  Przejdź do **aplikacji**. Kliknij **pozycję Utwórz token skryptu**.

    ![TeamViewer Utwórz token](./media/teamviewer-provisioning-tutorial/createtoken.png)

3.  Podaj nazwę tokenu skryptu. Kliknij przycisk **Zapisz.**

    ![Nazwa tokenu TeamViewer](./media/teamviewer-provisioning-tutorial/tokenname.png)

4. Skopiuj **token** i kliknij przycisk **OK**. Ta wartość zostanie wprowadzona w polu **Tajny token** aplikacji TeamViewer w witrynie Azure portal.
...
Dodaj TeamViewer z galerii aplikacji usługi Azure AD, aby rozpocząć zarządzanie inicjowania obsługi administracyjnej do TeamViewer. Jeśli wcześniej skonfigurowałeś TeamViewer dla aplikacji jednośliowe, możesz użyć tej samej aplikacji. Jednak zaleca się utworzenie oddzielnej aplikacji podczas testowania integracji początkowo. Dowiedz się więcej o dodawaniu aplikacji z galerii [tutaj](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
## <a name="step-5-configure-automatic-user-provisioning-to-teamviewer"></a>Krok 5. Konfigurowanie automatycznego inicjowania obsługi administracyjnej dla programu TeamViewer 
...
### <a name="to-configure-automatic-user-provisioning-for-teamviewer-in-azure-ad"></a>Aby skonfigurować automatyczne inicjowanie obsługi administracyjnej dla programu TeamViewer w usłudze Azure AD:

1. Zaloguj się do [Portalu Azure](https://portal.azure.com). Wybierz pozycję **Aplikacje przedsiębiorstwa**, a następnie wybierz pozycję **Wszystkie aplikacje**.

    ![Blok Aplikacje dla przedsiębiorstw](common/enterprise-applications.png)

2. Na liście aplikacji wybierz **teamviewer**.

    ![Łącze TeamViewer na liście Aplikacje](common/all-applications.png)
...
5. W sekcji **Poświadczenia administratora** wprowadź `ttps://webapi.teamviewer.com/scim/v2` w polu **Adres URL tentant** i wprowadź token skryptu utworzony wcześniej w **tokenie tajnym**. Kliknij **przycisk Testuj połączenie,** aby upewnić się, że usługa Azure AD może łączyć się z programem TeamViewer. Jeśli połączenie nie powiedzie się, upewnij się, że twoje konto TeamViewer ma uprawnienia administratora i spróbuj ponownie.

    ![Inicjowania obsługi](./media/teamViewer-provisioning-tutorial/provisioning.png)
...
8. W sekcji **Mapowania** wybierz pozycję **Synchronizuj użytkowników usługi Azure Active Directory z programem TeamViewer**.

9. Przejrzyj atrybuty użytkownika, które są synchronizowane z usługi Azure AD do TeamViewer w sekcji **Mapowanie atrybutów.** Atrybuty wybrane jako **pasujące** właściwości są używane do dopasowania kont użytkowników w TeamViewer dla operacji aktualizacji. Jeśli zdecydujesz się zmienić [pasujący atrybut docelowy,](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)musisz upewnić się, że interfejs API TeamViewer obsługuje filtrowanie użytkowników na podstawie tego atrybutu. Wybierz przycisk **Zapisz,** aby zatwierdzić wszelkie zmiany.
...
11. Aby włączyć usługę inicjowania obsługi administracyjnej usługi Azure AD dla programu TeamViewer, zmień **stan inicjowania obsługi administracyjnej** **na Włączone** w sekcji **Ustawienia.**

    ![Stan inicjowania obsługi administracyjnej włączony](common/provisioning-toggle-on.png)

12. Zdefiniuj użytkowników i/lub grupy, które chcesz udostępnić programowi TeamViewer, wybierając żądane wartości w **zakresie** w sekcji **Ustawienia.**
