...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/smarteru-tutorial/tutorial_smarteru_samlbase.png)

3. Na **SmarterU domeny i adres URL** sekcji, wykonaj następujące czynności: 

    ![Konfigurowanie rejestracji jednokrotnej](./media/smarteru-tutorial/tutorial_smarteru_url.png)

    W **identyfikator** tekstowym, wpisz adres URL: `https://www.smarteru.com/`

4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.

    ![Konfigurowanie rejestracji jednokrotnej](./media/smarteru-tutorial/tutorial_smarteru_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/smarteru-tutorial/tutorial_general_400.png)
...
8. Na stronie konfiguracji konta wykonaj następujące czynności:
    ...
    ![Autoryzację zewnętrzne](./media/smarteru-tutorial/IC777327.png "autoryzację zewnętrzne") 
...
2. Na liście aplikacji zaznacz **SmarterU**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/smarteru-tutorial/tutorial_smarteru_app.png) 
