---
title: 'Samouczek: Integracja usługi Azure Active Directory za pomocą HappyFox | Dokumentacja firmy Microsoft'
...
ms.locfileid: "54825820"
---
# <a name="tutorial-azure-active-directory-integration-with-happyfox"></a>Samouczek: Integracja usługi Azure Active Directory za pomocą HappyFox
...
1. Na **HappyFox domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W polu tekstowym **Adres URL logowania** wpisz adres URL, korzystając z następującego wzorca: `https://<subdomain>.happyfox.com/`

    b. W polu tekstowym **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `https://<subdomain>.happyfox.com/saml/metadata/`

    > [!NOTE] 
    > Te wartości nie są prawdziwe. Zaktualizuj je, używając faktycznego adresu URL i identyfikatora logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta HappyFox](https://support.happyfox.com/home) do uzyskania tych wartości. 
