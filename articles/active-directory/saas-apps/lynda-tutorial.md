...
* Możesz kontrolować, czy w usłudze Azure AD, kto ma dostęp do Lynda.com.
* Aby umożliwić użytkownikom można automatycznie zalogowany do Lynda.com (logowanie jednokrotne) przy użyciu konta usługi Azure AD.
...
* Lynda.com logowanie jednokrotne włączone subskrypcji

## <a name="scenario-description"></a>Opis scenariusza

W tym samouczku skonfigurujesz i przetestujesz logowanie jednokrotne usługi Azure AD w środowisku testowym.

* Obsługuje lynda.com **SP** jednokrotne logowanie inicjowane przez
* Obsługuje lynda.com **Just In Time** aprowizacji użytkowników
...
4. W polu wyszukiwania wpisz **Lynda.com**, wybierz opcję **Lynda.com** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
Dla logowania jednokrotnego do pracy relację łącza między użytkownika usługi Azure AD i powiązanego użytkownika w Lynda.com musi zostać ustanowione.
...
2. **[Konfigurowanie Lynda.com logowania jednokrotnego](#configure-lyndacom-single-sign-on)**  — Aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)**  — do przetestowania usługi Azure AD logowanie jednokrotne za pomocą Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)**  — Aby włączyć Britta Simon korzystać z usługi Azure AD logowania jednokrotnego.
5. **[Tworzenie użytkownika testowego Lynda.com](#create-lyndacom-test-user)**  — aby odpowiednikiem Britta Simon w Lynda.com połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. W [witryny Azure portal](https://portal.azure.com/)na **Lynda.com** strona integracji aplikacji, wybierz opcję **logowanie jednokrotne**.
...
6. Na **Konfigurowanie Lynda.com** sekcji, skopiuj odpowiednie adresy URL, zgodnie z wymaganiami.
...
Aby skonfigurować logowanie jednokrotne na **Lynda.com** stronie, musisz wysłać pobrany **XML metadanych Federacji** i odpowiednie skopiowany adresy URL z portalu Azure, aby [zespołem pomocy technicznej Lynda.com](https://www.linkedin.com/help/lynda/ask). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
1. W witrynie Azure portal wybierz **aplikacje dla przedsiębiorstw**, wybierz opcję **wszystkie aplikacje**, a następnie wybierz **Lynda.com**.
...
### <a name="create-lyndacom-test-user"></a>Tworzenie użytkownika testowego Lynda.com
...
Po kliknięciu kafelka Lynda.com w panelu dostępu, powinien zostać automatycznie zarejestrowaniu w usłudze Lynda.com, dla którego skonfigurować logowanie Jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
