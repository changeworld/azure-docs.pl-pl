...
1. Na **Pantheon domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W polu tekstowym **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `urn:auth0:pantheon:<orgname>-SSO`
    ...
    > [!NOTE] 
    > Te wartości nie są prawdziwe. Zastąp te wartości rzeczywistymi wartościami identyfikatora i adresu URL odpowiedzi. Skontaktuj się z pomocą [zespołem pomocy technicznej Pantheon](https://pantheon.io/docs/getting-support/) do uzyskania tych wartości.
