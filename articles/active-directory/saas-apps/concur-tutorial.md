...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/concur-tutorial/tutorial_concur_samlbase.png)

3. Na **cząstkowe domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/concur-tutorial/tutorial_concur_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik XML na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/concur-tutorial/tutorial_concur_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/concur-tutorial/tutorial_general_400.png)
<CS>
...
2. Na liście aplikacji zaznacz **Concur**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/concur-tutorial/tutorial_concur_app.png) 
...
* [Skonfiguruj Inicjowanie obsługi użytkowników](concur-provisioning-tutorial.md)
