...
3. **[Tworzenie użytkownika testowego Concur](#creating-a-concur-test-user)**  — aby odpowiednikiem Britta Simon w Concur, połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Concur domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **Concur** stronie, musisz wysłać pobrany **XML metadanych** do działu pomocy technicznej Concur. Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Concur**.
