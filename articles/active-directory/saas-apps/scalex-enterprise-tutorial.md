...
2. **[Skonfiguruj scaleX Enterprise SSO](#configure-scalex-enterprise-sso)** -aby skonfigurować ustawienia logowania jednokrotnego po stronie aplikacji.
...
5. **[Utwórz obiekt scaleX Enterprise test User](#create-scalex-enterprise-test-user)** -by miał odpowiednik B. Simon w elemencie scaleX Enterprise, który jest połączony z reprezentacją użytkownika w usłudze Azure AD.
...
1. Aby skonfigurować Logowanie jednokrotne na stronie **scaleX Enterprise** , zaloguj się do witryny programu scaleX Enterprise firmy jako administrator.
...
1. Wypełnij formularz w następujący sposób:
    ...
    g. Zaznacz następujące pola wyboru: **Włączone, szyfrowanie NameID i podpisywanie AuthnRequests.**
