---
title: 'Samouczek: Integracja usługi Azure Active Directory za pomocą Condeco | Dokumentacja firmy Microsoft'
...
ms.locfileid: "54816950"
---
# <a name="tutorial-azure-active-directory-integration-with-condeco"></a>Samouczek: Integracja usługi Azure Active Directory za pomocą Condeco
...
1. Aby skonfigurować logowanie jednokrotne na **Condeco** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Condeco](mailTo:supportna@condecosoftware.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
W tej sekcji nie musisz niczego robić. Nowy użytkownik jest tworzony podczas próby dostępu Condeco, jeśli go jeszcze nie istnieje.
