...
3. **[Tworzenie użytkownika testowego Condeco](#creating-a-condeco-test-user)**  — aby odpowiednikiem Britta Simon w Condeco połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Condeco domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **Condeco** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Condeco](mailTo:supportna@condecosoftware.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Condeco**.
