...
* Aby umożliwić użytkownikom można automatycznie zalogowany do InTime (logowanie jednokrotne) przy użyciu konta usługi Azure AD.
...
* Obsługuje inTime **SP** jednokrotne logowanie inicjowane przez
...
W tej sekcji, konfigurowanie i testowanie usługi Azure AD logowanie jednokrotne za pomocą InTime w oparciu o użytkownika testu o nazwie **Britta Simon**.
Dla logowania jednokrotnego do pracy relację łącza między użytkownika usługi Azure AD i powiązanego użytkownika w InTime musi zostać ustanowione.
...
2. **[Konfigurowanie InTime logowania jednokrotnego](#configure-intime-single-sign-on)**  — Aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD z użytkownikiem Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić użytkownikowi Britta Simon korzystanie z logowania jednokrotnego usługi Azure AD.
5. **[Tworzenie użytkownika testowego InTime](#create-intime-test-user)**  — aby odpowiednikiem Britta Simon w InTime połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. W [witryny Azure portal](https://portal.azure.com/)na **InTime** strona integracji aplikacji, wybierz opcję **logowanie jednokrotne**.
...
7. Na **Konfigurowanie InTime** sekcji, skopiuj odpowiednie adresy URL, zgodnie z wymaganiami.
...
### <a name="configure-intime-single-sign-on"></a>Konfigurowanie InTime logowania jednokrotnego

Aby skonfigurować logowanie jednokrotne na **InTime** stronie, musisz wysłać pobrany **XML metadanych Federacji** i odpowiednie skopiowany adresy URL z portalu Azure, aby [zespołem pomocy technicznej InTime](mailto:hdollard@intimesoft.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
1. W witrynie Azure portal wybierz **aplikacje dla przedsiębiorstw**, wybierz opcję **wszystkie aplikacje**, a następnie wybierz **InTime**.

    ![Blok Aplikacje dla przedsiębiorstw](common/enterprise-applications.png)

2. Na liście aplikacji wybierz **InTime**.

    ![InTime łącze na liście aplikacji](common/all-applications.png)
...
### <a name="create-intime-test-user"></a>Tworzenie użytkownika testowego InTime
...
Po kliknięciu kafelka InTime w panelu dostępu, powinien zostać automatycznie zarejestrowaniu w usłudze InTime, dla którego skonfigurować logowanie Jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
