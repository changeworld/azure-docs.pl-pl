...
3. **[Tworzenie użytkownika testowego LMS stanowisko Learning](#creating-a-learnconnect-test-user)**  — aby odpowiednikiem Britta Simon w stanowisko edukacją LMS, Learning połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Learning stanowisko LMS domena i adresy URL** sekcji, wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. Aby skonfigurować logowanie jednokrotne na **LMS stanowisko Learning** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej stanowisko Learning](http://help.learningseatlms.com/help).
...
2. Na liście aplikacji wybierz **LMS stanowisko Learning**.
