...
4. W polu wyszukiwania wpisz **FiscalNote**, wybierz opcję **FiscalNote** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego FiscalNote](#create-a-fiscalnote-test-user)**  — aby odpowiednikiem Britta Simon w FiscalNote połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **FiscalNote domena i adresy URL** sekcji, wykonaj następujące czynności:
...
8. Na **konfiguracji FiscalNote** , kliknij przycisk **skonfigurować FiscalNote** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja FiscalNote](./media/fiscalnote-tutorial/tutorial_fiscalnote_configure.png) 

9. Aby skonfigurować logowanie jednokrotne na **FiscalNote** stronie, musisz wysłać pobrany **Certificate(Raw), adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL** do [FiscalNote zespołu pomocy technicznej](mailto:support@fiscalnote.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
