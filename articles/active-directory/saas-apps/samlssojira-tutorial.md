...
4. W polu wyszukiwania wpisz **logowania jednokrotnego SAML dla programu Jira przez rozwiązania GmbH**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/samlssojira-tutorial/tutorial_samlssojira_search.png)

5. W panelu wyników wybierz **logowania jednokrotnego SAML dla programu Jira przez rozwiązania GmbH**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
3. Na **logowania jednokrotnego SAML, Jira, rozpoznawanie domeny GmbH i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. W oknie przeglądarki internetowej innej, zaloguj się do Twojej **logowania jednokrotnego SAML dla programu Jira przez portal administracyjny GmbH rozpoznawania** jako administrator.
...
10. W sekcji Karta dodatki, kliknij przycisk **Znajdź nowe dodatki**. Wyszukiwanie **SAML logowanie jednokrotne (SSO) dla programu JIRA** i kliknij przycisk **zainstalować** przycisk, aby zainstalować nowe wtyczki SAML.

    ![Konfigurowanie logowania jednokrotnego](./media/samlssojira-tutorial/addon7.png)

11. Rozpocznie się instalacja dodatku plug-in. Kliknij przycisk **Zamknij**.
...
14. Na **plik konfiguracji wtyczki SAML SingleSignOn** kliknij **Dodaj nowy dostawca tożsamości** przycisk, aby skonfigurować ustawienia dostawcy tożsamości.

    ![Konfigurowanie logowania jednokrotnego](./media/samlssojira-tutorial/addon4.png)

15. Na **wybierz dostawcy tożsamości SAML** strony, wykonaj następujące czynności:
...
16. Na **konfiguracji dostawcy tożsamości** kliknij **dalej** przycisku.

    ![Konfigurowanie logowania jednokrotnego](./media/samlssojira-tutorial/addon5b.png)

17. Na **Importuj metadane dostawcy tożsamości SAML** strony, wykonaj następujące czynności:
...
18. Na **atrybutu nazwy użytkownika i transformacji** kliknij **dalej** przycisku.

    ![Konfigurowanie logowania jednokrotnego](./media/samlssojira-tutorial/addon5d.png)
    
19. Na **użytkownika tworzenia i aktualizowania** kliknij **z & apisz dalej** można zapisać ustawień.   
    
    ![Konfigurowanie logowania jednokrotnego](./media/samlssojira-tutorial/addon6a.png)
    
20. Na **testowanie ustawień usługi** kliknij **pominąć test & ręcznie skonfigurować** Aby pominąć test użytkownika teraz. Odbędzie się w następnej sekcji i wymaga niektóre ustawienia w witrynie Azure portal. 
    
    ![Konfigurowanie logowania jednokrotnego](./media/samlssojira-tutorial/addon6b.png)
    
21. Podczas odczytywania okna dialogowego apprearing **pomijanie testów oznacza, że...** , kliknij przycisk **OK**.
...
2. Na liście aplikacji wybierz **logowania jednokrotnego SAML dla programu Jira przez rozwiązania GmbH**.
