...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/logicmonitor-tutorial/tutorial_logicmonitor_samlbase.png)

3. Na **LogicMonitor domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/logicmonitor-tutorial/tutorial_logicmonitor_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/logicmonitor-tutorial/tutorial_logicmonitor_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/logicmonitor-tutorial/tutorial_general_400.png)
...
9. W **ustawień rejestracji jednokrotnej (SSO)** sekcji, wykonaj następujące czynności:
   ...
   ![Single Sign-On ustawienia](./media/logicmonitor-tutorial/ic790054.png "Single Sign-On ustawienia")
...
2. W menu u góry kliknij **ustawienia**, a następnie kliknij przycisk **ról i użytkowników**.
   ...
   ![Role i użytkownicy](./media/logicmonitor-tutorial/ic790056.png "ról i użytkowników")
...
2. Na liście aplikacji zaznacz **LogicMonitor**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/logicmonitor-tutorial/tutorial_logicmonitor_app.png) 
