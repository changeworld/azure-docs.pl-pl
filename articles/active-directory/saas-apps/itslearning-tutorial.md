---
title: 'Samouczek: Integracja usługi Azure Active Directory z itslearning | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39042806"
---
# <a name="tutorial-azure-active-directory-integration-with-itslearning"></a>Samouczek: Integracja usługi Azure Active Directory z itslearning
...
3. **[Tworzenie użytkownika testowego itslearning](#creating-an-itslearning-test-user)**  — aby mają odpowiednika w pozycji Britta simon w itslearning połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **itslearning domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **itslearning** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej itslearning](mailto:support@itslearning.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w itslearning. Praca z [zespołem pomocy technicznej klienta itslearning](mailto:support@itslearning.com) Aby dodać użytkowników na platformie itslearning. Użytkownicy muszą być tworzone i aktywowana, aby używać logowania jednokrotnego.
