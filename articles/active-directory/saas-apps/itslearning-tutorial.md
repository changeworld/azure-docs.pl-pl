...
1. Aby skonfigurować logowanie jednokrotne na **itslearning** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej itslearning](mailto:support@itslearning.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
