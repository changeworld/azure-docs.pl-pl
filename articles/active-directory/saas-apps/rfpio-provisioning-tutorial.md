---
title: 'Samouczek: Konfigurowanie RFPIO na potrzeby automatycznego aprowizacji użytkowników przy użyciu Azure Active Directory | Microsoft Docs'
...
5. W sekcji **poświadczenia administratora** wprowadź `https://<RFPIO tenant instance>.rfpio.com/rfpserver/scim/v2 ` **adres URL dzierżawy**. Przykładowa wartość to `https://Azure-test1.rfpio.com/rfpserver/scim/v2`. Wprowadź wartość **tokenu interfejsu API Standard scim** pobranąwcześniej w tokenie tajnym. Kliknij pozycję **Testuj połączenie** , aby upewnić się, że usługa Azure AD może się połączyć z usługą RFPIO. Jeśli połączenie nie powiedzie się, upewnij się, że konto usługi RFPIO ma uprawnienia administratora, a następnie spróbuj ponownie.
