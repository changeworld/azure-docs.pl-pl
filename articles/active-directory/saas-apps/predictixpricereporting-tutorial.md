...
4. W polu wyszukiwania wpisz **raportowania cen Predictix**, wybierz pozycję **raportowania cen Predictix** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Predictix cen raportowania z listy wyników](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_addfromgallery.png)
...
3. Na **Predictix cen raportowania domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Predictix cen raportowania domeny i adres URL z jednym informacje logowania jednokrotnego](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/predictixpricereporting-tutorial/tutorial_general_400.png)
...
6. Na **Konfiguracja raportowania cen Predictix** , kliknij przycisk **Konfiguruj raportowanie cenie Predictix** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfiguracja raportowania Predictix cen](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_configure.png) 
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/predictixpricereporting-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **raportowania cen Predictix**.
    ...
    ![Raportowanie cenie Predictix łącza na liście aplikacji](./media/predictixpricereporting-tutorial/tutorial_predictixpricereporting_app.png)  
