---
title: 'Samouczek: Integracja usługi Azure Active Directory z SimpleNexus | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39433871"
---
# <a name="tutorial-azure-active-directory-integration-with-simplenexus"></a>Samouczek: Integracja usługi Azure Active Directory z SimpleNexus
...
1. Na **SimpleNexus domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://simplenexus.com/<companyname>_login`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://simplenexus.com/<companyname>`

    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta SimpleNexus](https://simplenexus.com/sn/contact-us/) do uzyskania tych wartości. 
...
1. Aby skonfigurować logowanie jednokrotne na **SimpleNexus** stronie, musisz wysłać pobrany **XML metadanych** do [zespołu pomocy technicznej SimpleNexus](https://simplenexus.com/sn/contact-us/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
