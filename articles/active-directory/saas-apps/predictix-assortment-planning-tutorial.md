...
* Użytkownikom można automatycznie zalogowany Predictix asortymentu planowanie (logowanie jednokrotne) można włączyć za pomocą kont usługi Azure AD.
...
* Planowanie asortymentu Predictix obsługuje **SP** jednokrotne logowanie inicjowane przez
...
4. W polu wyszukiwania wpisz **planowania asortymentu Predictix**, wybierz opcję **planowania asortymentu Predictix** z panelu wynik następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.

     ![Predictix asortymentu planowania na liście wyników](common/search-new-app.png)
...
Dla logowania jednokrotnego do pracy relację łącza między użytkownika usługi Azure AD i powiązanego użytkownika w ramach planowania asortymentu Predictix musi zostać ustanowione.
...
2. **[Konfigurowanie Predictix asortymentu planowania rejestracji jednokrotnej](#configure-predictix-assortment-planning-single-sign-on)**  — Aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD z użytkownikiem Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić użytkownikowi Britta Simon korzystanie z logowania jednokrotnego usługi Azure AD.
5. **[Tworzenie użytkownika testowego planowania asortymentu Predictix](#create-predictix-assortment-planning-test-user)**  — aby odpowiednikiem Britta Simon w Predictix asortymentu planowania, które jest połączone z usługi Azure AD reprezentacja użytkownika.
...
4. W sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące czynności:
    ...
    ![Predictix asortymentu planowania domena i adresy URL pojedynczego logowania jednokrotnego informacji](common/sp-identifier.png)
    ...
    > [!NOTE]
    > Te wartości nie są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego identyfikatora i adresu URL logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta planowania asortymentu Predictix](https://www.infor.com/support) do uzyskania tych wartości. Przydatne mogą się również okazać wzorce przedstawione w sekcji **Podstawowa konfiguracja protokołu SAML** w witrynie Azure Portal.

5. Na stronie **Konfigurowanie logowania jednokrotnego za pomocą protokołu SAML** w sekcji **Certyfikat podpisywania SAML** kliknij link **Pobierz**, aby pobrać **certyfikat (Base64)** z podanych opcji zgodnie z wymaganiami i zapisać go na komputerze.

    ![Link do pobierania certyfikatu](common/certificatebase64.png)

6. Na **Konfigurowanie planowania asortymentu Predictix** sekcji, skopiuj odpowiednie adresy URL, zgodnie z wymaganiami.
...
### <a name="configure-predictix-assortment-planning-single-sign-on"></a>Konfigurowanie asortymentu Predictix planowania logowania jednokrotnego

Aby skonfigurować logowanie jednokrotne na **planowania asortymentu Predictix** stronie, musisz wysłać pobrany **certyfikat (Base64)** i odpowiednie skopiowany adresy URL z portalu Azure, aby [Predictix Zespół pomocy technicznej planowanie asortymentu](https://www.infor.com/support). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
1. W witrynie Azure portal wybierz **aplikacje dla przedsiębiorstw**, wybierz opcję **wszystkie aplikacje**, a następnie wybierz **planowania asortymentu Predictix**.

    ![Blok Aplikacje dla przedsiębiorstw](common/enterprise-applications.png)

2. Na liście aplikacji wybierz **planowania asortymentu Predictix**.

    ![Planowanie asortymentu Predictix łącze na liście aplikacji](common/all-applications.png)
...
### <a name="create-predictix-assortment-planning-test-user"></a>Tworzenie użytkownika testowego Predictix asortymentu planowania

W tej sekcji utworzysz użytkownika o nazwie Britta Simon Predictix asortymentu planowania. Praca z [planowania asortymentu Predictix zespołem pomocy technicznej](https://www.infor.com/support) Aby dodać użytkowników do planowania asortymentu Predictix platformy. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
