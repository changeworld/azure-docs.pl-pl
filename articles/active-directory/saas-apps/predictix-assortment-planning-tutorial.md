...
3. **[Tworzenie użytkownika testowego planowania asortymentu Predictix](#create-a-predictix-assortment-planning-test-user)**  — aby odpowiednikiem Britta Simon w Predictix asortymentu planowania, które jest połączone z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Predictix asortymentu planowania domena i adresy URL** sekcji, wykonaj następujące czynności:
