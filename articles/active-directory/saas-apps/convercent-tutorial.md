...
3. **[Tworzenie użytkownika testowego Convercent](#creating-a-convercent-test-user)**  — aby odpowiednikiem Britta Simon w Convercent połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Convercent domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w **tryb inicjowane przez dostawcę tożsamości**, wykonaj następujące kroki:
...
4. Jeśli chcesz skonfigurować aplikację w **SP zainicjowano tryb**na **Convercent domena i adresy URL** sekcji należy wykonać następujące czynności:
...
7. Aby uzyskać logowanie Jednokrotne skonfigurowane pod kątem swojej aplikacji, skontaktuj się z pomocą [zespołem pomocy technicznej Convercent](mailto:support@convercent.com) i udostępniać je pobrany **XML metadanych**.
...
2. Na liście aplikacji wybierz **Convercent**.
