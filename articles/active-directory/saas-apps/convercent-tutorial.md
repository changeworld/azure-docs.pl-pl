---
title: 'Samouczek: Integracja usługi Azure Active Directory z convercent | Dokumenty firmy Microsoft'
...
5. Kliknij przycisk **Ustaw dodatkowe adresy URL** i wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w trybie inicjowania przez **dostawcę usług**:
    ...
    a. W polu **tekstowym Podpisywania adresu URL** wpisz adres URL, używając następującego wzorca:`https://<instancename>.convercent.com/`
