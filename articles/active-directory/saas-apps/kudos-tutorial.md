...
4. W polu wyszukiwania wpisz **pochwałę**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/kudos-tutorial/tutorial_kudos_search.png)

5. W panelu wyników wybierz **pochwałę**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego pochwałę](#creating-a-kudos-test-user)**  — aby odpowiednikiem Britta Simon w pochwałę połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **pochwałę domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji pochwałę** , kliknij przycisk **skonfigurować pochwałę** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/kudos-tutorial/tutorial_kudos_configure.png) 

7. W oknie przeglądarki internetowej innej Zaloguj się do witryny firmy pochwałę, jako administrator.

8. W menu u góry kliknij **ustawienia**.
   
    ![Ustawienia](./media/kudos-tutorial/ic787806.png "ustawienia")

9. Kliknij przycisk **integracje \> logowania jednokrotnego**.
...
4. Kliknij przycisk **użytkowników** kartę, a następnie kliknij przycisk **Dodawanie użytkownika**.
   
   ![Użytkownik Administrator](./media/kudos-tutorial/ic787809.png "użytkownika administratora")

5. W **Dodawanie użytkownika** sekcji, wykonaj następujące czynności:
