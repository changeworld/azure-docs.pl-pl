...
Do skonfigurowania integracji usługi Azure AD z aplikacją Netop Portal potrzebne są następujące elementy:

* Subskrypcja usługi Azure AD. Jeśli nie masz środowiska usługi Azure AD, możesz skorzystać z miesięcznej wersji próbnej [tutaj](https://azure.microsoft.com/pricing/free-trial/)
* Subskrypcja aplikacji Netop Portal z obsługą logowania jednokrotnego
...
**Aby dodać Netop Portal z galerii, wykonaj następujące czynności:**
...
Aby skonfigurować logowanie jednokrotne usługi Azure AD z aplikacją Netop Portal, wykonaj następujące kroki:
...
4. W sekcji **Podstawowa konfiguracja protokołu SAML** użytkownik nie musi wykonywać żadnych kroków, ponieważ aplikacja jest już wstępnie zintegrowana z platformą Azure.
    ...
    ![Informacje o domenie i adresach URL logowania jednokrotnego aplikacji Netop Portal](common/preintegrated.png)

5. Aplikacja Netop Portal oczekuje asercji SAML w określonym formacie, który wymaga dodania mapowań atrybutów niestandardowych do konfiguracji atrybutów tokenów języka SAML. Poniższy zrzut ekranu przedstawia listę atrybutów domyślnych. Kliknij ikonę **Edytuj**, aby otworzyć okno dialogowe Atrybuty użytkownika.
...
W tej sekcji włączysz dla użytkownika Britta Simon możliwość korzystania z logowania jednokrotnego platformy Azure, udzielając dostępu do aplikacji Netop Portal.

1. W witrynie Azure Portal wybierz pozycję **Aplikacje dla przedsiębiorstw**, pozycję **Wszystkie aplikacje**, a następnie pozycję **Netop Portal**.

    ![Blok Aplikacje dla przedsiębiorstw](common/enterprise-applications.png)

2. Na liście aplikacji wybierz pozycję **Netop Portal**.

    ![Link aplikacji Netop Portal na liście aplikacji](common/all-applications.png)
