...
3. **[Tworzenie użytkownika testowego Workfront](#creating-a-workfront-test-user)**  — aby odpowiednikiem Britta Simon w Workfront połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Workfront domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta Workfront](https://www.workfront.com/contact-us/) do uzyskania tych wartości. 
...
6. Na **konfiguracji Workfront** , kliknij przycisk **skonfigurować Workfront** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania i SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/workfront-tutorial/tutorial_workfront_configure.png) 

7. Zaloguj się do witryny firmy Workfront jako administrator.

8. Przejdź do **Rejestracja jednokrotna w konfiguracji**.

9. Na **logowania jednokrotnego** okno dialogowe, należy wykonać następujące czynności
