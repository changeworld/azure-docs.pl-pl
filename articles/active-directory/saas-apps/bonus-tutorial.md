...
3. Na **Bonusly domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i domeny bonusly pojedynczy informacje logowania jednokrotnego](./media/bonus-tutorial/tutorial_bonusly_url.png)

    W **adres URL odpowiedzi** tekstowym, wpisz adres URL, używając następującego wzorca: `https://Bonus.ly/saml/<tenant-name>`

    > [!NOTE] 
    > Wartość nie jest prawdziwe. Zaktualizuj tę wartość do rzeczywistego adresu URL odpowiedzi. Skontaktuj się z [zespołem pomocy technicznej Bonusly](https://bonus.ly/contact) można uzyskać wartość.
 
4. Na **certyfikat podpisywania SAML** sekcji, skopiuj **odcisk PALCA** wartości z certyfikatu.

    ![Łącze pobierania certyfikatu](./media/bonus-tutorial/tutorial_bonusly_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/bonus-tutorial/tutorial_general_400.png)
...
8. Na pasku narzędzi u góry kliknij **ustawienia**, a następnie wybierz **integracji i aplikacje**.
    ...
    ![Sekcja społecznościowych bonusly](./media/bonus-tutorial/ic773686.png "Bonusly")
...
10. Na **SAML** okna dialogowego strony, należy wykonać następujące czynności:
    ...
    ![Strony okna dialogowego Saml bonusly](./media/bonus-tutorial/ic773687.png "Bonusly")
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup** i kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/bonus-tutorial/create_aaduser_02.png) 
...
3. Kliknij przycisk **użytkowników i dodatki** kartę.
    ...
    ![Użytkownicy i dodatki](./media/bonus-tutorial/ic781042.png "użytkowników i dodatki")

4. Kliknij przycisk **Zarządzanie użytkownikami**.
   
    ![Zarządzaj użytkownikami](./media/bonus-tutorial/ic781043.png "Zarządzanie użytkownikami")
...
2. Na liście aplikacji zaznacz **Bonusly**.
    ...
    ![Bonusly łącza na liście aplikacji](./media/bonus-tutorial/tutorial_bonusly_app.png) 
