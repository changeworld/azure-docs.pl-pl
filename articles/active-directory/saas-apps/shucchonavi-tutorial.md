...
* Użytkownikom można automatycznie zalogowany do Shuccho Navi (logowanie jednokrotne) można włączyć za pomocą kont usługi Azure AD.
...
* Obsługuje Shuccho Navi **SP** jednokrotne logowanie inicjowane przez
...
W tej sekcji skonfigurujesz i test usługi Azure AD logowanie jednokrotne za pomocą Shuccho Navi w oparciu o nazwie użytkownika testowego **Britta Simon**.
Dla logowania jednokrotnego do pracy relację łącza między użytkownika usługi Azure AD i powiązanych użytkowników w Shuccho Navi musi zostać ustanowione.
...
2. **[Konfigurowanie Shuccho Navi logowania jednokrotnego](#configure-shuccho-navi-single-sign-on)**  — Aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD z użytkownikiem Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić użytkownikowi Britta Simon korzystanie z logowania jednokrotnego usługi Azure AD.
5. **[Tworzenie użytkownika testowego Shuccho Navi](#create-shuccho-navi-test-user)**  — aby odpowiednikiem Britta Simon w Shuccho Navi, połączonego z usługi Azure AD reprezentacja użytkownika.
...
4. W sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące czynności:
    ...
    ![Shuccho Navi domena i adresy URL pojedynczego logowania jednokrotnego informacji](common/sp-signonurl.png)
    ...
    > [!NOTE]
    > Ta wartość nie jest prawdziwa. Zastąp tę wartość rzeczywistym adresem URL logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta Navi Shuccho](mailto:sys_ntabtm@nta.co.jp) można uzyskać wartość. Przydatne mogą się również okazać wzorce przedstawione w sekcji **Podstawowa konfiguracja protokołu SAML** w witrynie Azure Portal.

5. Na stronie **Konfigurowanie logowania jednokrotnego za pomocą protokołu SAML** w sekcji **Certyfikat podpisywania SAML** kliknij link **Pobierz**, aby pobrać **kod XML metadanych federacji** na podstawie podanych opcji zgodnie z wymaganiami i zapisać go na komputerze.

    ![Link do pobierania certyfikatu](common/metadataxml.png)

6. Na **Konfigurowanie Shuccho Navi** sekcji, skopiuj odpowiednie adresy URL, zgodnie z wymaganiami.
...
### <a name="configure-shuccho-navi-single-sign-on"></a>Konfigurowanie Shuccho Navi logowania jednokrotnego

Aby skonfigurować logowanie jednokrotne na **Shuccho Navi** stronie, musisz wysłać pobrany **XML metadanych** i odpowiednie skopiowany adresy URL z portalu Azure, aby [zespołem pomocy technicznej Shuccho Navi](mailto:sys_ntabtm@nta.co.jp). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
1. W witrynie Azure portal wybierz **aplikacje dla przedsiębiorstw**, wybierz opcję **wszystkie aplikacje**, a następnie wybierz **Shuccho Navi**.
...
### <a name="create-shuccho-navi-test-user"></a>Tworzenie użytkownika testowego Shuccho Navi
...
Po kliknięciu kafelka Shuccho Navi w panelu dostępu, powinien zostać automatycznie zarejestrowaniu w usłudze Shuccho Navi, dla którego skonfigurować logowanie Jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
