...
Aby skonfigurować logowanie jednokrotne na **Shuccho Navi** stronie, musisz wysłać pobrany **XML metadanych** i odpowiednie skopiowany adresy URL z portalu Azure, aby [zespołem pomocy technicznej Shuccho Navi](mailto:sys_ntabtm@nta.co.jp). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
