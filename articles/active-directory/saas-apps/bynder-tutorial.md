...
4. W polu wyszukiwania wpisz **Bynder**, wybierz opcję **Bynder** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego Bynder](#create-a-bynder-test-user)**  — aby odpowiednikiem Britta Simon w Bynder połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Bynder domena i adresy URL** sekcji, wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. Aby skonfigurować logowanie jednokrotne na **Bynder** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Bynder](https://www.bynder.com/en/support/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Bynder**.
