...
1. Aby skonfigurować logowanie jednokrotne na **SumTotalCentral** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej SumTotalCentral](http://www.sumtotalsystems.com/support/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
