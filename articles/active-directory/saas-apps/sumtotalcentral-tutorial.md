---
title: 'Samouczek: Integracja usługi Azure Active Directory z SumTotalCentral | Dokumentacja firmy Microsoft'
...
3. **[Tworzenie użytkownika testowego SumTotalCentral](#create-a-sumtotalcentral-test-user)**  — aby odpowiednikiem Britta Simon w SumTotalCentral połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **SumTotalCentral domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.sumtotalsystems.com/sites/default`

    b. W **identyfikator** pole tekstowe, wpisz wartość: `SumTotalFederationGateway`

    > [!NOTE] 
    > Wartość adres URL logowania nie jest prawdziwe. Zaktualizuj wartość za pomocą adresu URL logowania rzeczywistych. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta SumTotalCentral](http://www.sumtotalsystems.com/support/) można uzyskać wartość. 
...
5. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/sumtotalcentral-tutorial/tutorial_general_400.png)

6. Aby skonfigurować logowanie jednokrotne na **SumTotalCentral** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej SumTotalCentral](http://www.sumtotalsystems.com/support/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
