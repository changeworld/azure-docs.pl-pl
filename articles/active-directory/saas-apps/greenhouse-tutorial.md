---
title: 'Samouczek: Integracja usługi Azure Active Directory z aplikacją Greenhouse | Microsoft Docs'
...
ms.locfileid: "65898532"
---
# <a name="tutorial-azure-active-directory-integration-with-greenhouse"></a>Samouczek: Integracja usługi Azure Active Directory z aplikacją Greenhouse
...
Aby skonfigurować logowanie jednokrotne po stronie aplikacji **Greenhouse**, musisz wysłać pobrany **kod XML metadanych federacji** i odpowiednie adresy URL skopiowane z witryny Azure Portal [zespołowi pomocy technicznej aplikacji Greenhouse](https://www.greenhouse.io/contact). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
