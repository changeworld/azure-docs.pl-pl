...
1. Aby skonfigurować logowanie jednokrotne na **Atomic uczenia** stronie, musisz wysłać pobrany **XML metadanych** do [Atomic Learning zespołem pomocy technicznej](mailto:cs@atomiclearning.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
