...
3. Na **IBM OpenPages domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![IBM OpenPages domeny i adresów URL jednym informacje logowania jednokrotnego](./media/ibmopenpages-tutorial/tutorial_ibmopenpage_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/ibmopenpages-tutorial/tutorial_ibmopenpage_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/ibmopenpages-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/ibmopenpages-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **IBM OpenPages**.
    ...
    ![Łącze IBM OpenPages na liście aplikacji](./media/ibmopenpages-tutorial/tutorial_ibmopenpage_app.png)  
