...
3. Na **amplitudy domeny i adres URL** sekcji, wykonaj następujące kroki, aby skonfigurować aplikację w **IDP** inicjowane tryb:
    ...
    ![Adresy URL i domeny amplitudy pojedynczy informacje logowania jednokrotnego](./media/amplitude-tutorial/tutorial_amplitude_url.png)
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** inicjowane tryb:
    ...
    ![Adresy URL i domeny amplitudy pojedynczy informacje logowania jednokrotnego](./media/amplitude-tutorial/tutorial_amplitude_url1.png)

    W **adres URL logowania** tekstowym, wpisz adres URL: `https://analytics.amplitude.com/sso`

5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.

    ![Łącze pobierania certyfikatu](./media/amplitude-tutorial/tutorial_amplitude_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/amplitude-tutorial/tutorial_general_400.png)
...
8. Polecenie **planowanie Admin** na pasku nawigacyjnym po lewej stronie.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/amplitude-tutorial/configure1.png)

9. Wybierz **platformy Microsoft Azure Active Directory metadanych** z **integracji logowania jednokrotnego**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/amplitude-tutorial/configure2.png)

10. Na **ustawić zapasowej rejestracji jednokrotnej** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/amplitude-tutorial/configure3.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/amplitude-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **amplitudy**.
    ...
    ![Łącze amplitudy na liście aplikacji](./media/amplitude-tutorial/tutorial_amplitude_app.png)  
