...
1. Aby skonfigurować logowanie jednokrotne na **Spacio** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [zespołem pomocy technicznej Spacio](mailto:support@spac.io). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
