...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_samlbase.png)

3. Na **Kiteworks domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji Kiteworks** , kliknij przycisk **skonfigurować Kiteworks** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_configure.png) 

7. Zalogować się do witryny firmy Kiteworks jako administrator.

8. Na pasku narzędzi u góry kliknij **ustawienia**.
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_06.png) 

9. W **uwierzytelniania i autoryzacji** kliknij **ustawienia logowania jednokrotnego**. 
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_07.png)
 
10. Na stronie Ustawienia logowania jednokrotnego wykonaj następujące czynności:
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_09.png)   
...
2. Na liście aplikacji zaznacz **Kiteworks**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kiteworks-tutorial/tutorial_kiteworks_app.png) 
