...
1. Aby skonfigurować logowanie jednokrotne na **Getabstract** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Getabstract](https://www.getabstract.com/en/contact). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
