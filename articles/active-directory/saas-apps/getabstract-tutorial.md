...
3. Na **Getabstract domeny i adres URL** sekcji, wykonaj następujące kroki, aby skonfigurować aplikację w **IDP** inicjowane tryb:
    ...
    ![Adresy URL i domeny Getabstract pojedynczy informacje logowania jednokrotnego](./media/getabstract-tutorial/tutorial_getabstract_url.png)
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** inicjowane tryb:
    ...
    ![Adresy URL i domeny Getabstract pojedynczy informacje logowania jednokrotnego](./media/getabstract-tutorial/tutorial_getabstract_url1.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/getabstract-tutorial/tutorial_getabstract_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/getabstract-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/getabstract-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **Getabstract**.
    ...
    ![Łącze Getabstract na liście aplikacji](./media/getabstract-tutorial/tutorial_getabstract_app.png)  
