...
1. Na **PatentSQUARE domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W polu tekstowym **Adres URL logowania** wpisz adres URL, korzystając z następującego wzorca: `https://<companysubdomain>.pat-dss.com:443/patlics/secure/aad`

    b. W polu tekstowym **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `https://<companysubdomain>.pat-dss.com:443/patlics`
...
1. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie przycisku Zapisz logowania jednokrotnego](./media/patentsquare-tutorial/tutorial_general_400.png)

1. Aby skonfigurować logowanie jednokrotne na **PatentSQUARE** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej PatentSQUARE](https://www.panasonic.com/jp/business/its/patentsquare.html). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
