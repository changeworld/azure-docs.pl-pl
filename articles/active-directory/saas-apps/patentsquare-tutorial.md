...
Aby skonfigurować logowanie jednokrotne na **PatentSQUARE** stronie, musisz wysłać pobrany **XML metadanych Federacji** i odpowiednie skopiowany adresy URL z portalu Azure, aby [PatentSQUARE zespołem pomocy technicznej ](https://www.panasonic.com/jp/business/its/patentsquare.html). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
