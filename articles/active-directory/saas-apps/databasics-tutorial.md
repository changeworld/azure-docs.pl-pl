...
3. Na **DATABASICS domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i domeny DATABASICS pojedynczy informacje logowania jednokrotnego](./media/databasics-tutorial/tutorial_databasics_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/databasics-tutorial/tutorial_databasics_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/databasics-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/databasics-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **DATABASICS**.
    ...
    ![Łącze DATABASICS na liście aplikacji](./media/databasics-tutorial/tutorial_databasics_app.png)  
