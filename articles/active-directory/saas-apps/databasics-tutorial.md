---
title: 'Samouczek: Integracja usługi Azure Active Directory za pomocą DATABASICS | Dokumentacja firmy Microsoft'
...
ms.locfileid: "54818306"
---
# <a name="tutorial-azure-active-directory-integration-with-databasics"></a>Samouczek: Integracja usługi Azure Active Directory za pomocą DATABASICS
...
1. W polu wyszukiwania wpisz **DATABASICS**, wybierz opcję **DATABASICS** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego DATABASICS](#create-a-databasics-test-user)**  — aby odpowiednikiem Britta Simon w DATABASICS połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **DATABASICS domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    b. W polu tekstowym **Adres URL logowania** wpisz adres URL, korzystając z następującego wzorca: `https://<sitenumber>.data-basics.net/<clientname>/saml_sso.jsp`

    > [!NOTE] 
    > Te wartości nie są prawdziwe. Zaktualizuj je, używając faktycznego adresu URL i identyfikatora logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta DATABASICS](https://www.data-basics.com/support/) do uzyskania tych wartości.
...
1. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie przycisku Zapisz logowania jednokrotnego](./media/databasics-tutorial/tutorial_general_400.png)

1. Aby skonfigurować logowanie jednokrotne na stronie DATABASICS, wypełnij formularz przy użyciu adresu URL poniżej. Po przesłaniu formularza [zespołem pomocy technicznej klienta DATABASICS](https://www.data-basics.com/support/) skontaktuje się z Tobą.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w DATABASICS. Praca z [zespołu pomocy technicznej DATABASICS](https://www.data-basics.com/support/) Aby dodać użytkowników na platformie DATABASICS. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
...
1. Na liście aplikacji wybierz **DATABASICS**.
