---
title: 'Samouczek: Integracja usługi Azure Active Directory z RedVector | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39448611"
---
# <a name="tutorial-azure-active-directory-integration-with-redvector"></a>Samouczek: Integracja usługi Azure Active Directory z RedVector
...
1. Na **RedVector domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://sso2.redvector.com/adfs/<Companyname>`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<Companyname>.redvector.com/saml2`

    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta RedVector](mailto:sso@redvector.com) do uzyskania tych wartości. 
