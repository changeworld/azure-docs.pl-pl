...
3. **[Tworzenie użytkownika testowego Sedgwick CMS](#create-a-sedgwick-cms-test-user)**  — aby odpowiednikiem Britta Simon w CMS Sedgwick, połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Sedgwick CMS domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **Sedgwick CMS** stronie, musisz wysłać pobrany **XML metadanych** do [Sedgwick CMS zespołem pomocy technicznej](https://www.sedgwick.com/contact/Pages/contactform.aspx). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
