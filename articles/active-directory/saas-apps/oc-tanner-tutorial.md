...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/oc-tanner-tutorial/tutorial_octannerappreciatehub_samlbase.png)

3. Na **O.C. Napisu Czarnecka - AppreciateHub domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/oc-tanner-tutorial/tutorial_octannerappreciatehub_url.png)

    a. W **adres URL odpowiedzi** tekstowym, wpisz adres URL, używając następującego wzorca: `https://<companyname>.octanner.net/sp/ACS.saml2`
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/oc-tanner-tutorial/tutorial_octannerappreciatehub_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/oc-tanner-tutorial/tutorial_general_400.png)
...
2. Na liście aplikacji zaznacz **O.C. Napisu Czarnecka - AppreciateHub**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/oc-tanner-tutorial/tutorial_octannerappreciatehub_app.png) 
