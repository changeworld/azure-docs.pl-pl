---
title: 'Samouczek: Integracja usługi Azure Active Directory z zastępcą | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-deputy"></a>Samouczek: Integracja usługi Azure Active Directory z zastępcą
...
1. Przejdź do następującego`https://(your-subdomain).deputy.com/exec/config/system_config`adresu URL: . Przejdź do pozycji **Security Settings (Ustawienia zabezpieczeń)** i kliknij przycisk **Edit (Edytuj)**.
...
2. W górnym okienku nawigacji kliknij pozycję **People (Osoby)**.
    ...
    ![Ludzi](./media/deputy-tutorial/tutorial_deputy_001.png "People")
...
5. Posiadacz konta usługi Azure AD otrzymuje wiadomość e-mail i następuje łącze, aby potwierdzić swoje konto, zanim stanie się aktywne. Można użyć innych narzędzi do tworzenia kont zastępców użytkownika lub interfejsów API dostarczonych przez zastępcę do aprowizowania kont użytkowników usługi Azure AD.
