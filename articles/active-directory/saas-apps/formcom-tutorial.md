...
4. W polu wyszukiwania wpisz **Form.com**, wybierz opcję **Form.com** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego Form.com](#create-a-formcom-test-user)**  — aby odpowiednikiem Britta Simon w Form.com połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Form.com domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji Form.com** , kliknij przycisk **skonfigurować Form.com** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja Form.com](./media/formcom-tutorial/tutorial_form.com_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **Form.com** stronie, musisz wysłać pobrany **certyfikat (Base64)**, **adres Url metadanych Federacji aplikacji**, i **SAML Pojedynczy adres URL logowania jednokrotnego usługi** do [zespołem pomocy technicznej Form.com](https://form.com/about/company/contact-us/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Form.com**.
