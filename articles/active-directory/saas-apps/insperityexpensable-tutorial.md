...
3. **[Tworzenie Insperity ExpensAble użytkownika testowego](#creating-an-insperity-expensable-test-user)**  — aby odpowiednikiem Britta Simon w Insperity ExpensAble połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Insperity ExpensAble domena i adresy URL** sekcji, wykonaj następujące czynności:
