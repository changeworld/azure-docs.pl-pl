...
* Możesz kontrolować, czy w usłudze Azure AD, kto ma dostęp do Insperity ExpensAble.
* Użytkownikom można automatycznie zalogowany do Insperity ExpensAble (logowanie jednokrotne) można włączyć za pomocą kont usługi Azure AD.
...
* Insperity ExpensAble logowanie jednokrotne włączone subskrypcji

## <a name="scenario-description"></a>Opis scenariusza

W tym samouczku skonfigurujesz i przetestujesz logowanie jednokrotne usługi Azure AD w środowisku testowym.

* Obsługuje Insperity ExpensAble **SP** jednokrotne logowanie inicjowane przez
...
4. W polu wyszukiwania wpisz **Insperity ExpensAble**, wybierz opcję **Insperity ExpensAble** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.

     ![Insperity ExpensAble na liście wyników](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurowanie i testowanie logowania jednokrotnego usługi Azure AD

W tej sekcji, konfigurowania i testowania usługi Azure AD logowanie jednokrotne za pomocą Insperity ExpensAble w oparciu o nazwie użytkownika testowego **Britta Simon**.
Dla logowania jednokrotnego do pracy relację łącza między użytkownika usługi Azure AD i powiązanych użytkowników w Insperity ExpensAble musi zostać ustanowione.
...
2. **[Konfigurowanie Insperity ExpensAble logowania jednokrotnego](#configure-insperity-expensable-single-sign-on)**  — Aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD z użytkownikiem Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić użytkownikowi Britta Simon korzystanie z logowania jednokrotnego usługi Azure AD.
5. **[Tworzenie użytkownika testowego Insperity ExpensAble](#create-insperity-expensable-test-user)**  — aby odpowiednikiem Britta Simon w Insperity ExpensAble połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. W [witryny Azure portal](https://portal.azure.com/)na **Insperity ExpensAble** strona integracji aplikacji, wybierz opcję **logowanie jednokrotne**.
...
4. W sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące czynności:
    ...
    ![Insperity ExpensAble domena i adresy URL pojedynczego logowania jednokrotnego informacji](common/sp-signonurl.png)
...
6. Na **Konfigurowanie Insperity ExpensAble** sekcji, skopiuj odpowiednie adresy URL, zgodnie z wymaganiami.
...
1. W witrynie Azure portal wybierz **aplikacje dla przedsiębiorstw**, wybierz opcję **wszystkie aplikacje**, a następnie wybierz **Insperity ExpensAble**.

    ![Blok Aplikacje dla przedsiębiorstw](common/enterprise-applications.png)

2. Na liście aplikacji wybierz **Insperity ExpensAble**.

    ![Insperity ExpensAble łącze na liście aplikacji](common/all-applications.png)
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Insperity ExpensAble. Praca z [Insperity ExpensAble zespołem pomocy technicznej](http://expensable.com/support/support-overview) Aby dodać użytkowników do Insperity ExpensAble platformy. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

### <a name="test-single-sign-on"></a>Testowanie logowania jednokrotnego

W tej sekcji służy do testowania konfiguracji usługi Azure AD pojedynczego logowania jednokrotnego przy użyciu panelu dostępu.

Po kliknięciu kafelka Insperity ExpensAble w panelu dostępu, powinien zostać automatycznie zarejestrowaniu w usłudze dla którego skonfigurować logowanie Jednokrotne ExpensAble Insperity. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
