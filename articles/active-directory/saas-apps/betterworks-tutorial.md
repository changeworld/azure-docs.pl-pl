---
title: 'Samouczek: Integracja usługi Azure Active Directory z BetterWorks | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39433147"
---
# <a name="tutorial-azure-active-directory-integration-with-betterworks"></a>Samouczek: Integracja usługi Azure Active Directory z BetterWorks
...
1. Na **BetterWorks domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w **tryb inicjowane przez dostawcę tożsamości**:
    ...
    a. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://app.betterworks.com/saml2/metadata/`

    b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://app.betterworks.com/saml2/acs/`
...
1. Aplikacja BetterWorks oczekuje twierdzenia SAML w określonym formacie. Skonfiguruj następujące oświadczenia dla tej aplikacji. Możesz zarządzać wartości te atrybuty z "**atrybut**" kartę w aplikacji. Poniższy zrzut ekranu przedstawia przykład tego. 
