...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_betterworks_samlbase.png)

3. Na **BetterWorks domeny i adres URL** sekcji, jeśli chcesz skonfigurować aplikację w **IDP zainicjował tryb**:

    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_betterworks_url.png)
...
4. Na **BetterWorks domeny i adres URL** sekcji, jeśli chcesz skonfigurować aplikację w **SP zainicjował tryb**, wykonaj następujące czynności:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_betterworks_url1.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_betterworks_certificate.png)  
...
5. Aplikacja BetterWorks oczekuje potwierdzenia języka SAML w określonym formacie. Skonfiguruj następujące oświadczeń dla tej aplikacji. Możesz zarządzać wartości tych atrybutów z "**atrybutu**" aplikacji. Poniższy zrzut ekranu przedstawia przykład tego. 
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_betterworks_attribute.png)
...
6. Na **atrybuty tokenu SAML** okna dialogowego, dla każdego wiersza w tabeli poniżej, wykonaj następujące czynności:
   ...
   a. Kliknij przycisk **Dodaj atrybut** otworzyć **Dodawanie atrybutu** okna dialogowego.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_officespace_04.png)

    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_officespace_05.png)
...
7. Kliknij przycisk **zapisać** przycisku.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_general_400.png)
...
2. Na liście aplikacji zaznacz **BetterWorks**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/betterworks-tutorial/tutorial_betterworks_app.png) 
