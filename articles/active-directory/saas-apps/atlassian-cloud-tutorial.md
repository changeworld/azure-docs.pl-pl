...
3. Aby skonfigurować aplikację w trybie inicjowanych przez dostawców tożsamości, w obszarze **adresy URL i domenę chmury Atlassian**, wykonaj następujące czynności:
    ...
    ![Adresy URL i domenę chmury Atlassian pojedynczy informacje logowania jednokrotnego](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_url.png)
...
4. Aby skonfigurować aplikację w trybie zainicjował SP, wybierz **Pokaż zaawansowane ustawienia adresu URL** , a następnie w **Zaloguj się na adres URL** wpisz adres URL przy użyciu następującej składni: **`https://<instancename>.atlassian.net`** .
    ...
    ![Adresy URL i domenę chmury Atlassian pojedynczy informacje logowania jednokrotnego](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_url1.png)
...
5. W obszarze **certyfikat podpisywania SAML**, wybierz pozycję **Certificate(Base64)**, a następnie zapisz plik certyfikatu na komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_certificate.png)
...
6. Aplikacja chmury Atlassian oczekuje można znaleźć potwierdzenia języka SAML w określonym formacie, musisz dodać mapowania atrybutu niestandardowego do konfiguracji atrybuty tokenu SAML. 
    ...
    ![Łącze pobierania certyfikatu](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_attribute.png)

7. Wybierz pozycję **Zapisz**.

    ![Konfigurowanie rejestracji jednokrotnej przycisk zapisywania](./media/atlassian-cloud-tutorial/tutorial_general_400.png)
...
12. W okienku po lewej stronie wybierz **SAML logowania jednokrotnego**. Jeśli jeszcze tego nie zrobiono, subskrypcja do Atlassian Identity Manager.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_11.png)

13. W **Konfiguracja SAML dodać** okna, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_12.png)
...
14. Aby upewnić się, że skonfigurowano poprawne adresy URL, należy zaktualizować ustawienia usługi Azure AD w następujący sposób:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_13.png)
...
15. W portalu Azure wybierz **zapisać**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/atlassian-cloud-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, wybierz **użytkowników i grup** > **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/atlassian-cloud-tutorial/create_aaduser_02.png)
...
4. W **użytkownika** okna, wykonaj następujące czynności:
    ...
    ![Okno użytkownika](./media/atlassian-cloud-tutorial/create_aaduser_04.png)
...
1. W **administracji** okienku wybierz **użytkowników**.
    ...
    ![Łącze Atlassian użytkownicy w chmurze](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_14.png)

2. Aby utworzyć użytkownika w chmurze Atlassian, wybierz **użytkownika zaproszenia**.

    ![Utwórz użytkownika Atlassian chmury](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_15.png)

3. W **adres E-mail** wprowadź adres e-mail użytkownika, a następnie przypisz dostęp do aplikacji.

    ![Utwórz użytkownika Atlassian chmury](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_16.png)
...
2. W **aplikacji** listy, wybierz **chmury Atlassian**.
    ...
    ![Łącze Atlassian chmury na liście aplikacji](./media/atlassian-cloud-tutorial/tutorial_atlassiancloud_app.png)
