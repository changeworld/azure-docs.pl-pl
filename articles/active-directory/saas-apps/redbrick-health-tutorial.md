---
title: 'Samouczek: Azure Active Directory integrację logowania jednokrotnego (SSO) z usługą RedBrick Health | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-redbrick-health"></a>Samouczek: Azure Active Directory integrację logowania jednokrotnego (SSO) z usługą RedBrick Health
