---
title: 'Samouczek: Integracja rejestracji jednokrotnej usługi Azure Active Directory (Logowanie jednokrotne) z usługą RedBrick Health | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-redbrick-health"></a>Samouczek: Integracja logowania jednokrotnego usługi Azure Active Directory (SSO) z usługą RedBrick Health

W tym samouczku dowiesz się, jak zintegrować kondycję firmy RedBrick z usługą Azure Active Directory (Azure AD). Po zintegrowaniu usługi RedBrick Health z usługą Azure AD można:

* Kontrola w usłudze Azure AD, który ma dostęp do RedBrick Zdrowia.
* Włącz użytkownikom automatyczne logowanie do usługi RedBrick Health za pomocą ich kont usługi Azure AD.
...
* Subskrypcja z włączoną funkcją logowania jednokrotnego redbrick health (SSO).
...
1. Wybierz **RedBrick Zdrowia** z panelu wyników, a następnie dodać aplikację. Poczekaj kilka sekund, gdy aplikacja zostanie dodana do dzierżawy.

## <a name="configure-and-test-azure-ad-single-sign-on-for-redbrick-health"></a>Konfigurowanie i testowanie logowania jednokrotnego usługi Azure AD dla usługi RedBrick Health

Konfigurowanie i testowanie usługi Azure AD SSO przy użyciu usługi RedBrick Health przy użyciu użytkownika testowego o nazwie **B.Simon**. Aby użytkownik łączony sytuować działał, należy ustanowić relację łącza między użytkownikiem usługi Azure AD a powiązanym użytkownikiem w usłudze RedBrick Health.

Aby skonfigurować i przetestować usługę Azure AD SSO przy pracy redbrick health, wykonaj następujące bloki konstrukcyjne:

1. **[Skonfiguruj samouszeńcę usługi Azure AD](#configure-azure-ad-sso)** — aby umożliwić użytkownikom korzystanie z tej funkcji.
    1. **[Utwórz użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD za pomocą usługi B.Simon.
    1. **[Przypisz użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić B.Simon używać logowania jednokrotnego usługi Azure AD.
1. **[Skonfiguruj logowanie jednokrotne usługi RedBrick Health](#configure-redbrick-health-sso)** — aby skonfigurować ustawienia logowania jednokrotnego po stronie aplikacji.
    1. **[Utwórz użytkownika testowego RedBrick Health](#create-redbrick-health-test-user)** — aby mieć odpowiednik B.Simon w RedBrick Health, który jest połączony z reprezentacją użytkownika usługi Azure AD.
...
1. W [witrynie Azure portal](https://portal.azure.com/)na stronie integracji aplikacji **RedBrick Health** znajdź sekcję **Zarządzaj** i wybierz **opcję logowanie jednokrotne**.
...
W tej sekcji włączysz B.Simon do korzystania z logowania jednokrotnego platformy Azure, przyznając dostęp do Usługi RedBrick Health.
...
## <a name="configure-redbrick-health-sso"></a>Konfigurowanie sytcha liczby ujeżdżanych w redbrick health
...
W tej sekcji utworzysz użytkownika o nazwie B.Simon w RedBrick Zdrowia. We współpracy z  [zespołem pomocy technicznej aplikacji RedBrick Health](https://home.redbrickhealth.com/contact/) dodaj użytkowników na platformie RedBrick Health. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
...
- [Wypróbuj usługę RedBrick Health w usłudze Azure AD](https://aad.portal.azure.com/)