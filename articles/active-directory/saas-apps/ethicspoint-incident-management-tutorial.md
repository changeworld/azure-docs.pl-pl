...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_samlbase.png)

3. Na **domeny zarządzania zdarzeniami EthicsPoint (EPIM) i adresy URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/ethicspoint-incident-management-tutorial/tutorial_general_400.png)
...
2. Na liście aplikacji zaznacz **EthicsPoint zdarzenie zarządzania (EPIM)**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_app.png) 
