---
title: 'Samouczek: Azure Active Directory Integracja z logowaniem jednokrotnym (SSO) przy użyciu oprogramowania Oracle Fusion ERP | Microsoft Docs'
...
ms.locfileid: "68989545"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-oracle-fusion-erp"></a>Samouczek: Azure Active Directory integrację logowania jednokrotnego (SSO) z usługą Oracle Fusion ERP
...
1. **[Skonfiguruj logowanie](#configure-oracle-fusion-erp-sso)** jednokrotne w usłudze Oracle Fusion — aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
W tej sekcji w aplikacji Oracle Fusion ERP utworzysz użytkownika o nazwie Britta Simon. Pracuj z [zespołem pomocy technicznej programu Oracle Fusion](mailto:jinshu.peethambaran@oracle.com) , aby dodać użytkowników na platformie ERP Oracle Fusion. Użytkownicy muszą być tworzone i aktywowana, aby używać logowania jednokrotnego.
