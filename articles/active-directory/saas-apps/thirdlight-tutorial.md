...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/thirdlight-tutorial/tutorial_thirdlight_samlbase.png)

3. Na **ThirdLight domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/thirdlight-tutorial/tutorial_thirdlight_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik XML na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/thirdlight-tutorial/tutorial_thirdlight_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/thirdlight-tutorial/tutorial_general_400.png)
...
7. Przejdź do **konfiguracji \> Administracja systemu**, a następnie kliknij przycisk **SAML2**.
    ...
    ![Administrowanie systemem](./media/thirdlight-tutorial/ic805843.png "administracji systemu")
...
2. Na liście aplikacji zaznacz **ThirdLight**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/thirdlight-tutorial/tutorial_thirdlight_app.png) 
