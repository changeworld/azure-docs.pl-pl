...
3. Aby dodać Atlassian chmury, kliknij **nową aplikację** przycisk u góry okna dialogowego.

    ![Przycisk Nowa aplikacja][3]

4. W polu wyszukiwania wpisz **chmury Atlassian**.

    ![Atlassian aprowizacji w chmurze](./media/atlassian-cloud-provisioning-tutorial/app-search.png)

5. W panelu wyników wybierz **chmury Atlassian**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać Atlassian chmury do swojej listy aplikacji SaaS.

    ![Atlassian aprowizacji w chmurze](./media/atlassian-cloud-provisioning-tutorial/app-create.png)

    ![Atlassian aprowizacji w chmurze](./media/atlassian-cloud-provisioning-tutorial/app-instance.png)
...
2. Wybierz chmurę Atlassian z listy aplikacji SaaS.
 
    ![Atlassian aprowizacji w chmurze](./media/atlassian-cloud-provisioning-tutorial/application-instance-search.png)
