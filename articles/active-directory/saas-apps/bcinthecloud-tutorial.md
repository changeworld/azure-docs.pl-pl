---
title: 'Samouczek: Usługa Azure integracji usługi Active Directory za pomocą BC w chmurze | Dokumentacja firmy Microsoft'
...
ms.locfileid: "55149105"
---
# <a name="tutorial-azure-active-directory-integration-with-bc-in-the-cloud"></a>Samouczek: Usługa Azure integracji usługi Active Directory za pomocą BC w chmurze
...
1. Na **BC w domenie w chmurze i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W polu tekstowym **Adres URL logowania** wpisz adres URL, korzystając z następującego wzorca: `https://app.bcinthecloud.com/router/loginSaml/<customerid>`
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w BC w chmurze. Praca z [zespołu pomocy technicznej BC w kliencie chmury](https://www.bcinthecloud.com/supportcenter/) Aby dodać użytkowników w BC w aplikacji w chmurze. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego. 
