...
3. Aby dodać nową aplikację, kliknij **Dodaj** przycisk u góry okna dialogowego.
...
3. **[Tworzenie BC w chmurze użytkownika testowego](#creating-a-bc-in-the-cloud-test-user)**  — aby odpowiednikiem Britta Simon w BC w chmurze, która jest połączona z usługi Azure AD reprezentacja użytkownika.
...
3. Na **BC w domenie w chmurze i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **BC w chmurze** stronie, musisz wysłać pobrany **XML metadanych** do [zespołu pomocy technicznej BC w chmurze](https://www.bcinthecloud.com/supportcenter/).
...
2. Na liście aplikacji wybierz **BC w chmurze**.
