---
title: 'Samouczek: Integracja usługi Azure Active Directory z aplikacją Cisco Umbrella | Microsoft Docs'
...
3. Na stronie **Konta** kliknij przycisk **Dodaj** w prawej górnej części strony i wykonaj poniższe kroki.
    ...
    d. W **adres E-mail** wprowadź emailaddress użytkownika, takich jak **brittasimon\@contoso.com**.
