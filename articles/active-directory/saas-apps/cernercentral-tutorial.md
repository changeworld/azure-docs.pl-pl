...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/cernercentral-tutorial/tutorial_cernercentral_samlbase.png)

3. Na **Cerner centralnej domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/cernercentral-tutorial/tutorial_cernercentral_url.png)
...
4. Na **certyfikat podpisywania SAML** sekcji, kliknij przycisk Kopiuj, aby skopiować **adres Url metadanych Federacji aplikacji** i wklej go do Notatnika.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/cernercentral-tutorial/tutorial_metadataurl.png)

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/cernercentral-tutorial/tutorial_general_400.png)
...
2. Na liście aplikacji zaznacz **centralnego Cerner**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/cernercentral-tutorial/tutorial_cernercentral_app.png)
...
* [Skonfiguruj Inicjowanie obsługi użytkowników](cernercentral-provisioning-tutorial.md)
