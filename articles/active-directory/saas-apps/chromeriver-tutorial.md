---
title: 'Samouczek: Integracja usługi Azure Active Directory z Chromeriver | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39048375"
---
# <a name="tutorial-azure-active-directory-integration-with-chromeriver"></a>Samouczek: Integracja usługi Azure Active Directory z Chromeriver
...
3. **[Tworzenie użytkownika testowego Chromeriver](#creating-a-chromeriver-test-user)**  — aby odpowiednikiem Britta Simon w Chromeriver połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Chromeriver domena i adresy URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie logowania jednokrotnego](./media/chromeriver-tutorial/tutorial_chromeriver_url.png)

    a. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.chromeriver.com`

    b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.chromeriver.com/login/sso/saml/consume?customerId=<uniqueid>`

    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego identyfikatora i adres URL odpowiedzi. Skontaktuj się z pomocą [zespołem pomocy technicznej Chromeriver](https://www.chromeriver.com/services/support) do uzyskania tych wartości.
...
6. Aby skonfigurować logowanie jednokrotne na **Chromeriver** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Chromeriver](https://www.chromeriver.com/services/support). Po włączeniu rejestracji Jednokrotnej dla Twojej subskrypcji, otrzyma powiadomienie o.
...
2. Na liście aplikacji wybierz **Chromeriver**.
