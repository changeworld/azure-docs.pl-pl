...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/itrp-tutorial/tutorial_itrp_samlbase.png)

3. Na **ITRP domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/itrp-tutorial/tutorial_itrp_url.png)
...
4. Na **certyfikat podpisywania SAML** sekcji, skopiuj **odcisk PALCA** wartości certyfikatu.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/itrp-tutorial/tutorial_itrp_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/itrp-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji ITRP** , kliknij przycisk **skonfigurować ITRP** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczy znak na adres URL usługi i adres URL Sign-Out** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/itrp-tutorial/tutorial_itrp_configure.png) 
...
3. Wybierz z menu podręcznego **osób**.
    ...
    ![Osoby](./media/itrp-tutorial/ic775587.png "osób")
...
2. Na liście aplikacji zaznacz **ITRP**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/itrp-tutorial/tutorial_itrp_app.png) 
