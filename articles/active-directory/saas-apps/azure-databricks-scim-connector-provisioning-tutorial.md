...
* Obecnie żądania dotyczące interfejsu API Standard scim "Azure Databricks" dla użytkowników uwzględniają wielkość liter, dlatego jeśli wyślemy zapytanie do USER@contoso.com zostanie on wyświetlony w postaci 0 wyników w miarę ich przechowywania jako user@contoso.com.
