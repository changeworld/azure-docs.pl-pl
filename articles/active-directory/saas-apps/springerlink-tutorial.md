...
4. **[Testowanie logowania jednokrotnego](#test-single-sign-on)**  — Aby sprawdzić, czy konfiguracja działa.
...
3. Na **Springer łącze domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. Aby skonfigurować logowanie jednokrotne na **Springer łącze** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [łącze Springer zespołem pomocy technicznej](mailto:identity@springernature.com).
