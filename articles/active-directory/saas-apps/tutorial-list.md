---
title: Samouczki integracji aplikacji SaaS do użycia z usługą Azure AD | Dokumentacja firmy Microsoft
description: Skonfiguruj usługę Azure Active Directory pojedynczego logowania jednokrotnego integrację z różnymi rodzajami oprogramowania innych firm w postaci aplikacji usługi.
...
Ułatwia integrowanie z obsługą chmury [(SaaS)](https://azure.microsoft.com/overview/what-is-saas/) aplikacji za pomocą usługi Azure Active Directory, opracowaliśmy kolekcji samouczków, które umożliwia przeprowadzenie konfiguracji.

Gdzie mamy wskazówki inicjowania obsługi administracyjnej użytkowników, wprowadzono samouczek aplikacji do aprowizowania użytkowników w prawej kolumnie obok samouczek aplikacji.

Aby uzyskać pełną listę aplikacji SaaS, które zostały wstępnie zintegrowane w usłudze Azure AD, zobacz [Active Directory Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/category/azure-active-directory-apps).

## <a name="non-alphabetic"></a>Niealfabetyczne
...
| ![logo](./media/tutorial-list/active-directory-saas-10000ftplans-tutorial.png)| [10 000 stóp plany](10000ftplans-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-23video-tutorial.png)| [23 wideo](23video-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-8x8virtualoffice-tutorial.png)| [8 x 8 wirtualnych pakietu Office](8x8virtualoffice-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-absorblms-tutorial.png)| [Ochrony przed rozproszonymi LMS](absorblms-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-adaptivesuite-tutorial.png)| [Funkcje adaptacyjnego sterowania szczegółowych informacji](adaptivesuite-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-alcumus-info-tutorial.png)| [Informacje o Alcumus programu Exchange](alcumus-info-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-aws-multi-accounts-tutorial.png)| [Amazon Web Services (AWS) do łączenia z wieloma kontami](aws-multi-accounts-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-amplitude-tutorial.png)| [Amplitudy](amplitude-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-apexportal-tutorial.png)| [Portal wierzchołka](apexportal-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-appneta-tutorial.png)| [Monitor wydajności AppNeta](appneta-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-arc-tutorial.png)| [Publikowanie łuk — Usługa rejestracji Jednokrotnej](arc-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-arcgis-tutorial.png)| [Komponent ArcGIS Online](arcgis-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-ariba-tutorial.png)| [Ariba](ariba-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-asana-tutorial.png)| [Asana](asana-tutorial.md)|[Asana — Inicjowanie obsługi użytkowników](asana-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-asccontracts-tutorial.png)| [Kontrakty usługi ASC](asccontracts-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-assetbank-tutorial.png)| [Bank zasobów](assetbank-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Chmura Atlassian](atlassian-cloud-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-atomiclearning-tutorial.png)| [Niepodzielne nauki](atomiclearning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-attendancemanagementservices-tutorial.png)| [Usługi zarządzania produkcją](attendancemanagementservices-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-autotaskendpointbackup-tutorial.png)| [Punkt końcowy Autotask kopii zapasowej](autotaskendpointbackup-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-autotaskworkplace-tutorial.png)| [Autotask w miejscu pracy](autotaskworkplace-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-bambubysproutsocial-tutorial.png)| [Bambu według społeczne główką](bambubysproutsocial-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-bcinthecloud-tutorial.png)| [BC w chmurze](bcinthecloud-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-beeline-tutorial.png)| [Z usługi beeLine](beeline-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-bgsonline-tutorial.png)| [Ekspresyjne w trybie Online](bgsonline-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-bime-tutorial.png)| [Bime](bime-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-birst-tutorial.png)| [Analiza biznesowa Agile Birst](birst-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-bitabiz-tutorial.png)| [BitaBIZ](bitabiz-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-blackboard-learn-tutorial.png)| [Dowiedz się, tablica](blackboard-learn-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-bridgelineunbound-tutorial.png)| [Anulowano powiązanie Bridgeline](bridgelineunbound-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-brightspace-desire2learn-tutorial.png)| [Brightspace przez Desire2Learn](brightspace-desire2learn-tutorial.md)|
...
| Logo | Samouczek dotyczący aplikacji dla logowania jednokrotnego | Samouczek dotyczący aplikacji dla aprowizacji użytkowników |
| :---: | :--- | :--- |
| ![logo](./media/tutorial-list/active-directory-saas-cappm-tutorial.png)| [PPM URZĘDU CERTYFIKACJI](cappm-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-canvas-lms-tutorial.png)| [Lms kanwy](canvas-lms-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-capriza-tutorial.png)| [Platforma Capriza](capriza-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-carlsonwagonlit-tutorial.png)| [Carlson Wagonlit podróży](carlsonwagonlit-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-central-desktop-tutorial.png)| [Centralnym pulpicie](central-desktop-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-cernercentral-tutorial.png)| [Cerner środkowa](cernercentral-tutorial.md)|[Środkowe Cerner — Inicjowanie obsługi użytkowników](cernercentral-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-certainadminsso-tutorial.png)| [Usługa rejestracji Jednokrotnej w niektórych administratora](certainadminsso-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-certify-tutorial.png)| [Certyfikowanie](certify-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-cezannehrsoftware-tutorial.png)| [Oprogramowanie Cezanne HR](cezannehrsoftware-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-newsignature-tutorial.png)| [Chmura portalu zarządzania platformy Microsoft Azure](newsignature-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-cloudpassage-tutorial.png)| [CloudPassage](cloudpassage-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-collaborativeinnovation-tutorial.png)| [Współpracy innowacji](collaborativeinnovation-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-comeetrecruitingsoftware-tutorial.png)| [Comeet rekrutacji oprogramowania](comeetrecruitingsoftware-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-comm100livechat-tutorial.png)| [Czat na żywo Comm100](comm100livechat-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-complianceelf-tutorial.png)| [Zgodność ELF](complianceelf-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-concur-tutorial.png)| [Concur](concur-tutorial.md)|[Concur — Inicjowanie obsługi użytkowników](concur-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-condeco-tutorial.png)| [Condeco](condeco-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-confluencemicrosoft-tutorial.png)| [Logowania jednokrotnego SAML confluence przez firmę Microsoft](confluencemicrosoft-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-cornerstone-ondemand-tutorial.png)| [OnDemand podstawy](cornerstone-ondemand-tutorial.md)|[OnDemand podstawy — Inicjowanie obsługi użytkowników](cornerstone-ondemand-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-coupa-tutorial.png)| [Coupa](coupa-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-cs-stars-tutorial.png)| [CS gwiazdek](cs-stars-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-deputy-tutorial.png)| [Zastępca](deputy-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-digicert-tutorial.png)| [DigiCert](digicert-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-direct-tutorial.png)| [Bezpośrednie](direct-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-directions-microsoft-tutorial.png)| [Kierunki na firmie Microsoft](directions-microsoft-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-docusign-tutorial.png)| [DocuSign](docusign-tutorial.md)|[DocuSign — Inicjowanie obsługi użytkowników](docusign-provisioning-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-dossier-tutorial.png)| [Dokumentacja](dossier-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-efidigitalstorefront-tutorial.png)| [Witryna sklepu cyfrowego EFI](efidigitalstorefront-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-elionboarding-tutorial.png)| [Dołączanie eli](elionboarding-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-encompass-tutorial.png)| [Obejmują](encompass-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-envimmis-tutorial.png)| [Envi MMIS](envimmis-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-envoy-tutorial.png)| [Usługa envoy](envoy-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-ethicspoint-incident-management-tutorial.png)| [Zarządzanie zdarzeniami EthicsPoint (EPIM)](ethicspoint-incident-management-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-fidelitynetbenefits-tutorial.png)| [NetBenefits wierności](fidelitynetbenefits-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-firmplay-tutorial.png)| [FirmPlay - propagowanie pracowników dla rekrutacji](firmplay-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-fiscalnote-tutorial.png)| [FiscalNote](fiscalnote-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-five9-tutorial.png)| [Five9 oraz karty (CTI, skontaktuj się z Centrum agentów)](five9-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-flatter-files-tutorial.png)| [Płaski plików](flatter-files-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-flock-tutorial.png)| [Stada](flock-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-floqast-tutorial.png)| [FloQast](floqast-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-fluxxlabs-tutorial.png)| [Laboratoria Fluxx](fluxxlabs-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-fm-systems-tutorial.png)| [FM:Systems](fm-systems-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-foreseecxsuite-tutorial.png)| [Przewiduje się CX Suite](foreseecxsuite-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-formcom-tutorial.png)| [Form.com](formcom-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-freshdesk-tutorial.png)| [Usługi FreshDesk](freshdesk-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-front-tutorial.png)| [Frontonu](front-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-github-tutorial.png)| [GitHub](github-tutorial.md)|[GitHub — Inicjowanie obsługi użytkowników](github-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-citrix-gotomeeting-tutorial.png)| [GoToMeeting](citrix-gotomeeting-tutorial.md)|[GoToMeeting — Inicjowanie obsługi użytkowników](citrixgotomeeting-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-greenhouse-tutorial.png)| [Cieplarnianych](greenhouse-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-halogen-software-tutorial.png)| [Oprogramowanie chlorowców](halogen-software-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-helpscout-tutorial.png)| [Pomoc programu Scout](helpscout-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-hostedgraphite-tutorial.png)| [Grafitu hostowanej](hostedgraphite-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-hpesaas-tutorial.png)| [System HPE SaaS](hpesaas-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-hr2day-tutorial.png)| [HR2day przez Merces](hr2day-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-kenexasurvey-tutorial.png)| [IBM ankiety Kenexa przedsiębiorstwa](kenexasurvey-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-ibmopenpages-tutorial.png)| [IBM OpenPages](ibmopenpages-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-icertisicm-tutorial.png)| [Platforma zarządzania Icertis kontraktu](icertisicm-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-igloo-software-tutorial.png)| [Igloo oprogramowania](igloo-software-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-ilms-tutorial.png)| [iLMS](ilms-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-imagerelay-tutorial.png)| [Przekazywania obrazów](imagerelay-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-imageworks-tutorial.png)| [OBRAZ DZIAŁA](imageworks-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-impacriskmanager-tutorial.png)| [Menedżer ryzyka IMPAC](impacriskmanager-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-infogix-tutorial.png)| [Określają Infogix Data3Sixty](infogix-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-inforretailinformationmanagement-tutorial.png)| [WinMgmt handlu detalicznego infor Information Management](inforretailinformationmanagement-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-innovationhub-tutorial.png)| [Centrum innowacji](innovationhub-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-insidertrack-tutorial.png)| [Śledź niejawnego programu testów](insidertrack-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-iqnavigatorvms-tutorial.png)| [IQNavigator maszyn wirtualnych](iqnavigatorvms-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-jive-tutorial.png)| [Jive](jive-tutorial.md)|[Jive — Inicjowanie obsługi użytkowników](jive-provisioning-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-kantegassoforbamboo-tutorial.png)| [Kantega Usługa rejestracji Jednokrotnej dla Bambus](kantegassoforbamboo-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-kantegassoforbitbucket-tutorial.png)| [Kantega Usługa rejestracji Jednokrotnej dla Bitbucket](kantegassoforbitbucket-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-kantegassoforconfluence-tutorial.png)| [Kantega Usługa rejestracji Jednokrotnej dla Confluence](kantegassoforconfluence-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-kantegassoforfisheyecrucible-tutorial.png)| [Kantega Usługa rejestracji Jednokrotnej dla typu rybie oko/Crucible](kantegassoforfisheyecrucible-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-kantegassoforjira-tutorial.png)| [Logowanie Jednokrotne Kantega, do programu JIRA](kantegassoforjira-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-keeperpasswordmanager-tutorial.png)| [Menedżer haseł hodowca & cyfrowego magazynu](keeperpasswordmanager-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-kindling-tutorial.png)| [Kindling](kindling-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-kintone-tutorial.png)| [Platformy Kintone](kintone-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-kiteworks-tutorial.png)| [Platforma Kiteworks](kiteworks-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-klue-tutorial.png)| [Klue](klue-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-knowbe4-tutorial.png)| [Szkolenia w zakresie rozpoznawania KnowBe4 zabezpieczeń](knowbe4-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-kudos-tutorial.png)| [Pochwałę](kudos-tutorial.md)|

## <a name="l---m"></a>L - M

| Logo | Samouczek dotyczący aplikacji dla logowania jednokrotnego | Samouczek dotyczący aplikacji dla aprowizacji użytkowników |
| :---: | :--- | :--- |
| ![logo](./media/tutorial-list/active-directory-saas-landgorilla-tutorial.png)| [Klient Gorilla ziemi](landgorilla-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-learning-at-work-tutorial.png)| [Nauka w miejscu pracy](learning-at-work-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-learningseatlms-tutorial.png)| [Stanowisko Learning LMS](learningseatlms-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-lucidchart-tutorial.png)| [Lucidchart](lucidchart-tutorial.md)| [Lucidchart — Inicjowanie obsługi użytkowników](lucidchart-provisioning-tutorial.md)| 
...
| ![logo](./media/tutorial-list/active-directory-saas-menlosecurity-tutorial.png)| [Menlo zabezpieczeń](menlosecurity-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-mercell-tutorial.png)| [Mercell](mercell-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-mercerhrs-tutorial.png)| [BenefitsCentral mercer (MBC)](mercerhrs-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-merchlogix-tutorial.png)| [Merchlogix](merchlogix-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-metanetworksconnector-tutorial.png)| [Meta sieci łącznika](metanetworksconnector-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-mimecast-admin-console-tutorial.png)| [Konsola administracyjna Mimecast](mimecast-admin-console-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-mimecast-personal-portal-tutorial.png)| [Portal Mimecast osobiste](mimecast-personal-portal-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-mobilexpense-tutorial.png)| [Przenośne Xpense](mobilexpense-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-montageonline-tutorial.png)| [Montażowy w trybie Online](montageonline-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-moveittransfer-tutorial.png)| [MOVEit Transfer — Integracja usługi Azure AD](moveittransfer-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-moxiengage-tutorial.png)| [Moxi Nawiąż kontakt](moxiengage-tutorial.md)|
...
| Logo | Samouczek dotyczący aplikacji dla logowania jednokrotnego | Samouczek dotyczący aplikacji dla aprowizacji użytkowników |
| :---: | :--- | :--- |
| ![logo](./media/tutorial-list/active-directory-saas-n2fexpensereports-tutorial.png)| [N2F — raporty wydatków](n2f-expensereports-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-namely-tutorial.png)| [To znaczy](namely-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-netsuite-tutorial.png)| [Netsuite](netsuite-tutorial.md)|[Netsuite — Inicjowanie obsługi użytkowników](netsuite-provisioning-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-oc-tanner-tutorial.png)| [O.C. Napisu Czarnecka - AppreciateHub](oc-tanner-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-onetrust-tutorial.png)| [Oprogramowanie do zarządzania zachowania OneTrust](onetrust-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-orgchartnow-tutorial.png)| [Teraz schematu organizacyjnego](orgchartnow-tutorial.md)|
...
| Logo | Samouczek dotyczący aplikacji dla logowania jednokrotnego | Samouczek dotyczący aplikacji dla aprowizacji użytkowników |
| :---: | :--- | :--- |
| ![logo](./media/tutorial-list/active-directory-saas-pacific-timesheet-tutorial.png)| [Pacyficznego grafiku](pacific-timesheet-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-pagerduty-tutorial.png)| [PagerDuty](pagerduty-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-paloaltonetworks-aperture-tutorial.png)| [Palo Alto Networks - przysłony](paloaltonetworks-aperture-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-paloaltonetworks-captiveportal-tutorial.png)| [Palo Alto Networks — Portal wewnętrzne](paloaltonetworks-captiveportal-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-perceptionunitedstates-tutorial.png)| [Stany Zjednoczone wrażenie (inne niż UltiPro)](perceptionunitedstates-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-pingboard-tutorial.png)| [Pingboard](pingboard-tutorial.md)|[Pingboard — Inicjowanie obsługi użytkowników](pingboard-provisioning-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-predictix-assortment-planning-tutorial.png)| [Planowanie asortymentu Predictix](predictix-assortment-planning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-predictixordering-tutorial.png)| [Kolejność Predictix](predictixordering-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-predictixpricereporting-tutorial.png)| [Cena Predictix raportowania](predictixpricereporting-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-printix-tutorial.png)| [Printix](printix-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-procoresso-tutorial.png)| [Procore logowania jednokrotnego](procoresso-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-promaster-tutorial.png)| [ProMaster (przez Inlogik)](promaster-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-proofpoint-ondemand-tutorial.png)| [Proofpoint na żądanie](proofpoint-ondemand-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-questetra-bpm-suite-tutorial.png)| [Pakiet Questetra BPM](questetra-bpm-suite-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-quickhelp-tutorial.png)| [QuickHelp](quickhelp-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-qumucloud-tutorial.png)| [Qumu chmury](qumucloud-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-rally-software-tutorial.png)| [Rally oprogramowania](rally-software-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-rollbar-tutorial.png)| [Pałąka zabezpieczającego](rollbar-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-salesforce-sandbox-tutorial.png)| [Piaskownica usługi SalesForce](salesforce-sandbox-tutorial.md)|[Piaskownica usługi SalesForce — Inicjowanie obsługi użytkowników](salesforce-sandbox-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-samanage-tutorial.png)| [Samanage](samanage-tutorial.md)|[Samanage — Inicjowanie obsługi użytkowników](samanage-provisioning-tutorial.md)
| ![logo](./media/tutorial-list/active-directory-saas-saml-tutorial.png)| [Aplikacji LOB z obsługą tokenu języka SAML 1.1](saml-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-bamboo-tutorial.png)| [Logowania jednokrotnego SAML dla Bambus przez rozwiązania GmbH](bamboo-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-bitbucket-tutorial.png)| [Logowania jednokrotnego SAML dla Bitbucket, rozpoznawanie GmbH](bitbucket-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-samlssoconfluence-tutorial.png)| [Logowania jednokrotnego SAML dla Confluence przez rozwiązania GmbH](samlssoconfluence-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-samlssojira-tutorial.png)| [Logowania jednokrotnego SAML dla programu Jira przez rozwiązania GmbH](samlssojira-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sansan-tutorial.png)| [Sansan](sansan-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sapbusinessbydesign-tutorial.png)| [Oprogramowaniem SAP Business ByDesign](sapbusinessbydesign-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sapboc-tutorial.png)| [Obiekt chmury dla oprogramowania SAP Business](sapboc-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sap-customer-cloud-tutorial.png)| [Chmura SAP dla klientów](sap-customer-cloud-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.png)| [Uwierzytelnianie tożsamości platformy SAP w chmurze](sap-hana-cloud-platform-identity-authentication-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-saphana-tutorial.png)| [SAP HANA](saphana-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sap-netweaver-tutorial.png)| [Oprogramowanie SAP NetWeaver](sap-netweaver-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-saucelabs-tutorial.png)| [Sos Labs — Mobile i testowanie sieci Web](saucelabs-mobileandwebtesting-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-screencast-tutorial.png)| [Zrzut ekranu O-obie](screencast-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-sciquest-spend-director-tutorial.png)| [SciQuest wydatki, Dyrektor ds.](sciquest-spend-director-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-secretserver-on-premises-tutorial.png)| [Tajne Server (lokalnie)](secretserver-on-premises-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-securedeliver-tutorial.png)| [BEZPIECZNE DOSTARCZANIE](securedeliver-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-securew2joinnowconnector-tutorial.png)| [Łącznik JoinNow SecureW2](securejoinnow-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sedgwickcms-tutorial.png)| [System CMS Sedgwick](sedgwickcms-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sensoscientific-tutorial.png)| [System monitorowania temperatury SensoScientific sieci bezprzewodowej](sensoscientific-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-settlingmusic-tutorial.png)| [Rozliczanie utworów muzycznych](settlingmusic-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-sharepoint-on-premises-tutorial.png)| [Lokalny program SharePoint](sharepoint-on-premises-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-shmoopforschools-tutorial.png)| [Shmoop dla szkół](shmoopforschools-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-skillsbase-tutorial.png)| [Podstawa umiejętności](skillsbase-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-skillsmanager-tutorial.png)| [Menedżer umiejętności](skillsmanager-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-skydeskemail-tutorial.png)| [SkyDesk wiadomości E-mail](skydeskemail-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-skyhighnetworks-tutorial.png)| [Skyhigh sieci](skyhighnetworks-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-skytap-tutorial.png)| [Skytap](skytap-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-slack-tutorial.png)| [Slack](slack-tutorial.md)|[Slack — Inicjowanie obsługi użytkowników](slack-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-smallimprovements-tutorial.png)| [Ulepszenia małe](smallimprovements-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-soonr-tutorial.png)| [Soonr w miejscu pracy](soonr-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.png)| [Platformy Splunk Enterprise i w chmurze Splunk](splunkenterpriseandsplunkcloud-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-symantec-tutorial.png)| [Usługa zabezpieczeń firmy Symantec w sieci Web (WSS)](symantec-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-tableauonline-tutorial.png)| [TABLEAU w trybie Online](tableauonline-tutorial.md)|[Tryb Online — TABLEAU aprowizacji użytkowników](tableau-online-provisioning-tutorial.md)
| ![logo](./media/tutorial-list/active-directory-saas-tableauserver-tutorial.png)| [Serwer firmy TABLEAU](tableauserver-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-talentlms-tutorial.png)| [TalentLMS](talentlms-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-tangoanalytics-tutorial.png)| [Analiza Tango](tangoanalytics-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-tangoe-tutorial.png)| [Polecenie Tangoe Premium Mobile](tangoe-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-thefundingportal-tutorial.png)| [Finansowania portalu](thefundingportal-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-thousandeyes-tutorial.png)| [ThousandEyes](thousandeyes-tutorial.md)|[ThousandEyes — Inicjowanie obsługi użytkowników](thousandeyes-provisioning-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-tidemark-tutorial.png)| [Tidemark](tidemark-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-tigertext-tutorial.png)| [Bezpieczne Messenger TigerText](tigertext-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-tinfoil-security-tutorial.png)| [USŁUGI TINFOIL SECURITY](tinfoil-security-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-topdesk-public-tutorial.png)| [TOPdesk — publiczny](topdesk-public-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-topdesk-secure-tutorial.png)| [TOPdesk — bezpieczne](topdesk-secure-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-trisotechdigitalenterpriseserver-tutorial.png)| [Cyfrowy Trisotech Enterprise Server](trisotechdigitalenterpriseserver-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-veritas-tutorial.png)| [Usługa rejestracji Jednokrotnej w VERITAS Enterprise Vault.cloud](veritas-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-versal-tutorial.png)| [Uniwersalny](versal-tutorial.md)|
...
| Logo | Samouczek dotyczący aplikacji dla logowania jednokrotnego | Samouczek dotyczący aplikacji dla aprowizacji użytkowników |
| :---: | :--- | :--- |
| ![logo](./media/tutorial-list/active-directory-saas-waywedo-tutorial.png)| [Prowadzenia](waywedo-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-wizergosproductivitysoftware-tutorial.png)| [Oprogramowanie biurowe Wizergos](wizergosproductivitysoftware-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-work-com-tutorial.png)| [Work.com](work-com-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-workday-tutorial.png)| [Dzień roboczy](workday-tutorial.md)| [Dzień roboczy — Inicjowanie obsługi użytkowników](workday-inbound-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-workplacebyfacebook-tutorial.png)| [Obszar roboczy w serwisie Facebook](workplacebyfacebook-tutorial.md)|[Obszar roboczy w usłudze Facebook — Inicjowanie obsługi użytkowników](workplacebyfacebook-provisioning-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-yonyx-tutorial.png)| [Przewodniki interaktywne Yonyx](yonyx-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-youearnedit-tutorial.png)| [YouEarnedIt](youearnedit-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-zendesk-tutorial.png)| [Zendesk](zendesk-tutorial.md)|[Zendesk — Inicjowanie obsługi użytkowników](zendesk-provisioning-tutorial.md)|
...
| ![logo](./media/tutorial-list/active-directory-saas-zscaler-one-tutorial.png)| [Jednego rozwiązania Zscaler](zscaler-one-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-zscalerprivateaccess-tutorial.png)| [Dostęp prywatny rozwiązania Zscaler (ZPA)](zscalerprivateaccess-tutorial.md)|
| ![logo](./media/tutorial-list/active-directory-saas-zscalerprivateaccessadministrator-tutorial.png)| [Administrator dostępu prywatnego rozwiązania Zscaler](zscalerprivateaccessadministrator-tutorial.md)|
