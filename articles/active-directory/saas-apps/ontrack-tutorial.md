...
1. Aby skonfigurować logowanie jednokrotne na **OnTrack** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej OnTrack](mailto:CustomerService@insigniagroup.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
