---
title: 'Samouczek: Integracja usługi Azure Active Directory z programem IdeaScale | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-ideascale"></a>Samouczek: Integracja usługi Azure Active Directory z programem IdeaScale
...
3. Wybierz pozycję **Security \> Single Signon Settings** (Ustawienia > Ustawienia logowania jednokrotnego).
    ...
    ![Ustawienia logowania jednokrotnego](./media/ideascale-tutorial/ic790848.png "Ustawienia logowania jednokrotnego")

4. W polu **Single-Signon Type** (Typ logowania jednokrotnego) wybierz opcję **SAML 2.0**.

    ![Typ logowania jednokrotnego](./media/ideascale-tutorial/ic790849.png "Typ logowania jednokrotnego")

5. W oknie dialogowym **Single Signon Settings** (Ustawienia logowania jednokrotnego) wykonaj następujące kroki:

    ![Ustawienia logowania jednokrotnego](./media/ideascale-tutorial/ic790850.png "Ustawienia logowania jednokrotnego")
...
4. Kliknij pozycję **Add Member** (Dodaj członka).
    ...
    ![Zarządzanie członkami](./media/ideascale-tutorial/ic790852.png "Zarządzanie członkami")

5. W sekcji Add New Member (Dodaj nowego członka) wykonaj następujące kroki:

    ![Dodaj nowego członka](./media/ideascale-tutorial/ic790853.png "Dodaj nowego członka")
...
> [!NOTE]
> Do aprowizowania kont użytkowników usługi Azure AD można użyć dowolnych innych narzędzi do tworzenia kont użytkowników IdeaScale lub interfejsów API udostępnianych przez aplikację IdeaScale.
