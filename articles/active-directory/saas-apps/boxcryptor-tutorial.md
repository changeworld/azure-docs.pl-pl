...
4. W polu wyszukiwania wpisz **Boxcryptor**, wybierz opcję **Boxcryptor** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego Boxcryptor](#create-a-boxcryptor-test-user)**  — aby odpowiednikiem Britta Simon w Boxcryptor połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Boxcryptor domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji Boxcryptor** , kliknij przycisk **skonfigurować Boxcryptor** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego adres URL usługi** i **SAML identyfikator jednostki** z **krótki przewodnik po sekcji.**

    ![Konfiguracja funkcji SCM Andromeda](./media/boxcryptor-tutorial/tutorial_boxcryptor_configure.png)

7. Aby skonfigurować logowanie jednokrotne na **Boxcryptor** stronie, musisz wysłać pobrany **certyfikat (Base64)**, **SAML pojedynczego logowania jednokrotnego usługi adresu URL** i **SAML Identyfikator jednostki** do [zespołem pomocy technicznej Boxcryptor](mailto:support@boxcryptor.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Boxcryptor**.
