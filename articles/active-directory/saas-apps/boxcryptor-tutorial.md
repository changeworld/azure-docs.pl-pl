---
title: 'Samouczek: Integracja usługi Azure Active Directory za pomocą Boxcryptor | Dokumentacja firmy Microsoft'
...
ms.locfileid: "55181099"
---
# <a name="tutorial-azure-active-directory-integration-with-boxcryptor"></a>Samouczek: Integracja usługi Azure Active Directory za pomocą Boxcryptor
...
1. Na **certyfikat podpisywania SAML** kliknij **certyfikat (Base64)** , a następnie zapisz plik certyfikatu na komputerze.
    ...
    ![Link do pobierania certyfikatu](./media/boxcryptor-tutorial/tutorial_boxcryptor_certificate.png) 

1. Kliknij przycisk **Zapisz** przycisku.

    ![Konfigurowanie przycisku Zapisz logowania jednokrotnego](./media/boxcryptor-tutorial/tutorial_general_400.png)
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Boxcryptor. Praca z [zespołem pomocy technicznej Boxcryptor](mailto:support@boxcryptor.com) można dodać użytkowników lub domeny, który jest wymagany do listy dozwolonych na platformie Boxcryptor. Jeśli domena jest dodawany przez zespół, użytkownicy będą automatycznie aprowizowany platformę Boxcryptor. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
