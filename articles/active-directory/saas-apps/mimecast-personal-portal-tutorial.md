---
title: 'Samouczek: Integracja usługi Azure Active Directory z osobistym portalem Mimecast | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-mimecast-personal-portal"></a>Samouczek: Integracja usługi Azure Active Directory z osobistym portalem Mimecast
...
5. W sekcji **Profil uwierzytelniania** wykonaj następujące kroki:
    ...
    e. W polu tekstowym **Adres URL logowania** wklej wartość adresu URL **logowania,** który został skopiowany z witryny Azure portal.
   
    f. W polu tekstowym **adresu URL wylogowania** wklej wartość **adresu URL wylogowania,** który został skopiowany z witryny Azure Portal.
...
5. W oknie dialogowym Nowy adres wykonaj następujące kroki dla prawidłowego konta usługi Azure AD, które chcesz aprowizować:
    ...
    a. W polach **tekstowych Adres e-mail** wpisz **adres e-mail** użytkownika jako **BrittaSimon\@contoso.com**.
