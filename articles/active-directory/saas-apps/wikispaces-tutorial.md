...
3. **[Tworzenie użytkownika testowego Wikispaces](#creating-a-wikispaces-test-user)**  — aby odpowiednikiem Britta Simon w Wikispaces połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Wikispaces domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Aby skonfigurować logowanie jednokrotne na **Wikispaces** stronie, musisz wysłać pobrany **XML metadanych** do [zespołu pomocy technicznej Wikispaces](https://www.wikispaces.com/site/help). Otrzymasz powiadomienie, zaraz po zakończeniu konfiguracji.
