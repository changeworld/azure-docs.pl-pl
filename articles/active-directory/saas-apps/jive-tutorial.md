...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/jive-tutorial/tutorial_jive_samlbase.png)

3. Na **Jive domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/jive-tutorial/tutorial_jive_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik XML na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/jive-tutorial/tutorial_jive_certificate.png)

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/jive-tutorial/tutorial_general_400.png)
...
7. W menu u góry kliknij pozycję "**Saml**."
    ...
    ![Konfigurowanie rejestracji jednokrotnej po stronie aplikacji](./media/jive-tutorial/tutorial_jive_002.png)
...
8. Przejdź do "**metadanych Idp**" kartę.
    ...
    ![Konfigurowanie rejestracji jednokrotnej po stronie aplikacji](./media/jive-tutorial/tutorial_jive_003.png)
...
9. Przejdź do "**mapowanie atrybutu użytkownika**" kartę.
    ...
    ![Konfigurowanie rejestracji jednokrotnej po stronie aplikacji](./media/jive-tutorial/tutorial_jive_004.png)
...
2. Na liście aplikacji zaznacz **Jive**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/jive-tutorial/tutorial_jive_app.png) 
...
* [Skonfiguruj Inicjowanie obsługi użytkowników](jive-provisioning-tutorial.md)
