...
1. Aby skonfigurować logowanie jednokrotne na **MOBI** stronie, musisz wysłać pobrany **XML metadanych** do [zespołu pomocy technicznej MOBI](mailto:sso@mobiwm.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
