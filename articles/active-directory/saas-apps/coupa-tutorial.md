---
title: 'Samouczek: Integracja usługi Azure Active Directory za pomocą Coupa | Dokumentacja firmy Microsoft'
...
ms.locfileid: "55153934"
---
# <a name="tutorial-azure-active-directory-integration-with-coupa"></a>Samouczek: Integracja usługi Azure Active Directory za pomocą Coupa
...
1. Na **Coupa domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE]
    > Wartość adresu URL logowania nie jest prawdziwa. Zaktualizuj tę wartość przy użyciu rzeczywisty adres URL logowania. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta Coupa](https://success.coupa.com/Support/Contact_Us?) aby zyskać tę wartość.
...
1. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie przycisku Zapisz logowania jednokrotnego](./media/coupa-tutorial/tutorial_general_400.png)
