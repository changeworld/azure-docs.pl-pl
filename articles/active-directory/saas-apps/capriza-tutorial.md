---
title: 'Samouczek: Integracja usługi Azure Active Directory z platformą Capriza | Dokumenty firmy Microsoft'
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w aplikacji Capriza. Aplikacja Capriza obsługuje aprowizację typu just in time, która jest domyślnie włączona. **Upewnij się, że nazwa domeny jest skonfigurowana z Capriza do inicjowania obsługi administracyjnej przez użytkowników. Po tym tylko just-in-time inicjowania obsługi administracyjnej będzie działać.**
