---
title: 'Samouczek: Integracja usługi Azure Active Directory z aplikacją Communifire | Microsoft Docs'
...
ms.locfileid: "67104991"
---
# <a name="tutorial-azure-active-directory-integration-with-communifire"></a>Samouczek: Integracja usługi Azure Active Directory z aplikacją Communifire
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjowanym przez **dostawcę tożsamości**, w sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące kroki:
    ...
    a. W polu **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `https://<subdomain>.communifire.com`
...
Aby skonfigurować logowanie jednokrotne po stronie aplikacji **Communifire**, musisz wysłać pobrany **plik XML metadanych federacji** i odpowiednie adresy URL skopiowane z witryny Azure Portal [zespołowi pomocy technicznej aplikacji Communifire](mailto:support@axerosolutions.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
Po kliknięciu kafelka Communifire w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji Communifire, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
