---
title: 'Samouczek: Integracja usługi Azure Active Directory z Communifire | Dokumentacja firmy Microsoft'
...
4. W polu wyszukiwania wpisz **Communifire**, wybierz opcję **Communifire** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego Communifire](#create-a-communifire-test-user)**  — aby odpowiednikiem Britta Simon w Communifire połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Communifire domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w trybie zainicjował dostawcy tożsamości należy wykonać następujące czynności:
    ...
    a. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.communifire.com`

    b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.communifire.com/SAML/AssertionConsumerService.aspx`
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** zainicjowano tryb:
    ...
    W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<subdomain>.communifire.com/login`
     
    > [!NOTE] 
    > Te wartości są prawdziwe. Rzeczywisty identyfikator, adres URL odpowiedzi i adres URL logowania, należy zaktualizować te wartości. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta Communifire](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome) do uzyskania tych wartości. 

5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.

    ![Link pobierania certyfikatu](./media/communifire-tutorial/tutorial_communifire_certificate.png) 

6.  Sprawdź **Pokaż zaawansowane ustawienia podpisywania certyfikatów** i wybierz **opcja podpisywania** jako **odpowiedź i potwierdzenie SAML logowania**.
...
7. Kliknij przycisk **Zapisz** przycisku.
    ...
    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/communifire-tutorial/tutorial_general_400.png)
    
8. Aby skonfigurować logowanie jednokrotne na **Communifire** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej Communifire](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **Communifire**.
