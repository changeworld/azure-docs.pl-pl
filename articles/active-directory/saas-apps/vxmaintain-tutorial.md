...
4. W polu wyszukiwania wpisz **vxMaintain**.
    ...
    ![Na liście rozwijanej "Pojedynczy znak na tryb"](./media/vxmaintain-tutorial/tutorial_vxmaintain_search.png)
...
2. Aby włączyć logowanie Jednokrotne, w **tryb rejestracji jednokrotnej** listy rozwijanej wybierz **na języku SAML logowania jednokrotnego**.
    ...
    ![Polecenie "na podstawie SAML logowania"](./media/vxmaintain-tutorial/tutorial_vxmaintain_samlbase.png)

3. W obszarze **vxMaintain domeny i adres URL**, wykonaj następujące czynności:

    ![VxMaintain sekcji domeny i adresy URL](./media/vxmaintain-tutorial/tutorial_vxmaintain_url.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup** > **wszyscy użytkownicy**.
    ...
    ![Łącze "Wszyscy użytkownicy"](./media/vxmaintain-tutorial/create_aaduser_02.png)  
