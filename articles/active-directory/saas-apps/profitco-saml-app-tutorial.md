...
* Włącz użytkownikom automatyczne logowanie do Profit.co aplikacji SAML za pomocą swoich kont usługi Azure AD.
...
* Profit.co aplikacja SAML obsługuje jednostkę SSO inicjowane przez **protokół IDP**

* Po skonfigurowaniu Profit.co aplikacji SAML można wymusić kontrolę sesji, które chronią eksfiltrację i infiltrację poufnych danych organizacji w czasie rzeczywistym. Kontrola sesji rozciąga się od dostępu warunkowego. [Dowiedz się, jak wymusić kontrolę nad sesją za pomocą programu Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-profitco-saml-app-from-the-gallery"></a>Dodawanie Profit.co aplikacji SAML z galerii
...
Konfigurowanie i testowanie usługi Azure AD SSO za pomocą Profit.co aplikacji SAML przy użyciu użytkownika testowego o nazwie **B.Simon**. Aby użytkownik łączony sytuować działał, należy ustanowić relację łącza między użytkownikiem usługi Azure AD a powiązanym użytkownikiem w aplikacji Profit.co SAML.

Aby skonfigurować i przetestować usługę Azure AD SSO za pomocą Profit.co aplikacji SAML, wykonaj następujące bloki konstrukcyjne:
...
1. **[Skonfiguruj Profit.co logowania jednokrotnego aplikacji SAML](#configure-profitco-saml-app-sso)** — aby skonfigurować ustawienia logowania jednokrotnego po stronie aplikacji.
    1. **[Utwórz Profit.co użytkownika testowego aplikacji SAML](#create-profitco-saml-app-test-user)** — aby mieć odpowiednik B.Simon w Profit.co aplikacji SAML, która jest połączona z reprezentacją użytkownika usługi Azure AD.
...
1. W [witrynie Azure portal](https://portal.azure.com/)na stronie integracji aplikacji **SAML Profit.co** znajdź sekcję **Zarządzaj** i wybierz **opcję logowanie jednokrotne**.
...
W tej sekcji włączysz B.Simon do korzystania z logowania jednokrotnego platformy Azure, przyznając dostęp do Profit.co aplikacji SAML.
...
Aby skonfigurować logowanie jednokrotne po stronie **Profit.co aplikacji SAML,** musisz wysłać **adres URL metadanych federacji aplikacji,** aby [Profit.co zespół pomocy technicznej aplikacji SAML](mailto:support@profit.co). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.

### <a name="create-profitco-saml-app-test-user"></a>Utwórz Profit.co użytkownika testowego aplikacji SAML

W tej sekcji utworzysz użytkownika o nazwie Britta Simon w aplikacji Profit.co SAML. Praca z [Profit.co zespołem pomocy technicznej aplikacji SAML,](mailto:support@profit.co) aby dodać użytkowników na platformie aplikacji PROFIT.CO SAML. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

## <a name="test-sso"></a>Test SSO 

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka aplikacji PROFIT.CO SAML w Panelu dostępu należy automatycznie zalogować się do aplikacji SAML Profit.co, dla której skonfigurowano logującą się do rejestru jednośmiębnie. Aby uzyskać więcej informacji na temat Panelu dostępu, zobacz [Wprowadzenie do Panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
