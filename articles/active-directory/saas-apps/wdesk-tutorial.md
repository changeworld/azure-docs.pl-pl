...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_samlbase.png)
...
3. Na **Wdesk domeny i adres URL** sekcji, jeśli chcesz skonfigurować aplikację w **IDP** tryb inicjowane, wykonaj następujące czynności:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_url.png)
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL**. Jeśli chcesz skonfigurować aplikację w **SP** inicjowane tryb, wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_url1.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_general_400.png)
...
8. W lewym dolnym rogu, kliknij przycisk **Admin** i wybierz polecenie **administrator konta**:
     ...
     ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig1.png)

9. W Wdesk administratora, przejdź do **zabezpieczeń**, następnie **SAML** > **ustawienia SAML**:

    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig2.png)

10. W obszarze **ustawienia ogólne**, sprawdź **Włącz SAML rejestrację jednokrotną**:

    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig3.png)

11. W obszarze **szczegóły dostawcy usług**, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig4.png)
...
12. Kliknij przycisk **Konfigurowanie ustawień IdP** otworzyć **edytowanie ustawień dostawców tożsamości** okna dialogowego. Kliknij przycisk **wybierz plik** zlokalizować **Metadata.xml** następnie przekazać plik zapisany w portalu Azure.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig5.png)
  
13. Kliknij przycisk **zapisać zmiany**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_ssoconfigsavebutton.png)
...
2. Na liście aplikacji zaznacz **Wdesk**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/wdesk-tutorial/tutorial_wdesk_app.png) 
