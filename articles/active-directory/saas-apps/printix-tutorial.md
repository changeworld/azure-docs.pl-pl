...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_samlbase.png)

3. Na **Printix domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_general_400.png)
...
7. W menu u góry kliknij ikonę w prawym górnym rogu i wybierz pozycję "**uwierzytelniania**".
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_06.png)

8. Na **Instalator** wybierz opcję **uwierzytelniania Włącz Azure/Office 365**
   
    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_07.png)
...
9. Na **Azure** karcie, wprowadź adres URL metadanych Federacji pole tekstowe z "**dokument metadanych usług federacyjnych**". 
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_08.png)
...
10. Kliknij przycisk "**Test**"przycisk i kliknij przycisk"**OK**" przycisku, jeśli test zakończyło się pomyślnie.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_09.png)
...
2. Na liście aplikacji zaznacz **Printix**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/printix-tutorial/tutorial_printix_app.png) 
