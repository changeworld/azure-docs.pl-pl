...
3. **[Tworzenie użytkownika testowego Trisotech cyfrowego Enterprise Server](#create-a-trisotech-digital-enterprise-server-test-user)**  — aby odpowiednikiem Britta Simon w Trisotech cyfrowego Enterprise Server, która jest połączona z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Trisotech cyfrowego Enterprise Server domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. W oknie przeglądarki innej witryny sieci web należy zalogować się jako administrator do witryny firmy Trisotech cyfrowego Enterprise serwera konfiguracji.

7. Kliknij pozycję **ikonę Menu** , a następnie wybierz **administracji**.
