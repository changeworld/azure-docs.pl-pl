...
4. W polu wyszukiwania wpisz **Trisotech cyfrowe Enterprise Server**, wybierz pozycję **Trisotech cyfrowe Enterprise Server** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikacja.
    ...
    ![Trisotech cyfrowe Enterprise Server na liście wyników](./media/trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_addfromgallery.png)
...
3. Na **Trisotech cyfrowe Enterprise Server domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Adresy URL i Trisotech cyfrowe przedsiębiorstwa serwera domeny pojedynczy informacje logowania jednokrotnego](./media/trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_url.png)
...
4. Na **certyfikat podpisywania SAML** sekcji, kliknij przycisk Kopiuj, aby skopiować **adres Url metadanych Federacji aplikacji** i wklej go do Notatnika. 
    ...
    ![Łącze pobierania certyfikatu](./media/trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_certificate.png)

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/trisotechdigitalenterpriseserver-tutorial/tutorial_general_400.png)
...
7. Polecenie **ikonę Menu** , a następnie wybierz **administracji**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/trisotechdigitalenterpriseserver-tutorial/user1.png)

8. Wybierz **dostawca użytkownika**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/trisotechdigitalenterpriseserver-tutorial/user2.png)

9. W **konfiguracji dostawcy użytkowników** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/trisotechdigitalenterpriseserver-tutorial/user3.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/trisotechdigitalenterpriseserver-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **Trisotech cyfrowe Enterprise Server**.
    ...
    ![Łącze Trisotech cyfrowe Enterprise Server na liście aplikacji](./media/trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_app.png)  
