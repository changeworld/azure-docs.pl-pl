---
title: 'Samouczek: Integracja usługi Azure Active Directory z NetDocuments | Dokumentacja firmy Microsoft'
...
- Możesz kontrolować w usłudze Azure AD, kto ma dostęp do NetDocuments
- Umożliwia użytkownikom automatyczne pobieranie zalogowanych do NetDocuments (logowanie jednokrotne) przy użyciu konta usługi Azure AD
...
W tej sekcji służy do konfigurowania i testowanie usługi Azure AD logowanie jednokrotne za pomocą NetDocuments w oparciu o użytkownika testu o nazwie "Britta Simon".

Dla logowania jednokrotnego do pracy usługi Azure AD musi znać użytkownika odpowiednika w NetDocuments do użytkownika w usłudze Azure AD. Innymi słowy relację łącza między użytkownika usługi Azure AD i powiązanego użytkownika w NetDocuments musi można ustanowić.

W NetDocuments, należy przypisać wartość **nazwa_użytkownika** w usłudze Azure AD jako wartość **Username** do ustanawiania relacji łączy.
...
W tej sekcji możesz włączyć usługi Azure AD logowania jednokrotnego w witrynie Azure portal i konfigurowanie logowania jednokrotnego w aplikacji NetDocuments.

**Aby skonfigurować usługę Azure AD logowanie jednokrotne z NetDocuments, wykonaj następujące czynności:**

1. W witrynie Azure portal na **NetDocuments** strona integracji aplikacji, kliknij przycisk **logowanie jednokrotne**.
...
1. Na **NetDocuments domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://vault.netvoyage.com/neWeb2/docCent.aspx?whr=<user identifier>`

    b. W **adres URL odpowiedzi** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://vault.netvoyage.com/neWeb2/docCent.aspx?whr=<user identifier>`
...
**Aby przypisać Britta Simon NetDocuments, wykonaj następujące czynności:**
...
Po kliknięciu kafelka NetDocuments w panelu dostępu, użytkownik powinien uzyskać automatycznie zalogowanych do aplikacji NetDocuments.
