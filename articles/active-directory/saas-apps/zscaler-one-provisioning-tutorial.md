...
3. Aby dodać jednego rozwiązania Zscaler, kliknij **nową aplikację** przycisk u góry okna dialogowego.

    ![Przycisk Nowa aplikacja][3]

4. W polu wyszukiwania wpisz **jednego rozwiązania Zscaler**.

    ![Inicjowanie obsługi administracyjnej jednego rozwiązania Zscaler](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. W panelu wyników wybierz **jednego rozwiązania Zscaler**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać jednego rozwiązania Zscaler do listy aplikacji SaaS.

    ![Inicjowanie obsługi administracyjnej jednego rozwiązania Zscaler](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Inicjowanie obsługi administracyjnej jednego rozwiązania Zscaler](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Wybierz jednego rozwiązania Zscaler z listy aplikacji SaaS.

    ![Inicjowanie obsługi administracyjnej jednego rozwiązania Zscaler](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
