...
4. W polu wyszukiwania wpisz **sygnałów dynamicznych**, wybierz pozycję **sygnałów dynamicznych** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Sygnałów dynamicznych na liście wyników](./media/dynamicsignal-tutorial/tutorial_dynamicsignal_addfromgallery.png)
...
3. Na **adresy URL i dynamicznych domeny sygnału** sekcji, wykonaj następujące czynności:
    ...
    ![Dynamiczne adresy URL i domeny sygnału pojedynczy informacje logowania jednokrotnego](./media/dynamicsignal-tutorial/tutorial_dynamicsignal_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/dynamicsignal-tutorial/tutorial_dynamicsignal_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/dynamicsignal-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/dynamicsignal-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **sygnałów dynamicznych**.
    ...
    ![Łącze sygnałów dynamicznych na liście aplikacji](./media/dynamicsignal-tutorial/tutorial_dynamicsignal_app.png)  
