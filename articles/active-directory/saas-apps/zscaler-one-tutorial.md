...
5. W panelu wyników wybierz **jednego rozwiązania Zscaler**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
4. **[Tworzenie użytkownika testowego jednego rozwiązania Zscaler](#creating-a-zscaler-one-test-user)**  — aby odpowiednikiem Britta Simon w rozwiązania Zscaler jednego połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **adresy URL i jednej domenie rozwiązania Zscaler** sekcji, wykonaj następujące czynności:
...
6. Na **jedną konfigurację rozwiązania Zscaler** kliknij **konfigurowanie jednego rozwiązania Zscaler** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

7. W oknie przeglądarki innej witryny sieci web należy zalogować się jako administrator do jednego rozwiązania Zscaler witryny firmy.
