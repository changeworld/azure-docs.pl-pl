---
title: 'Samouczek: Integracja usługi Azure Active Directory z Merchlogix | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39052071"
---
# <a name="tutorial-azure-active-directory-integration-with-merchlogix"></a>Samouczek: Integracja usługi Azure Active Directory z Merchlogix
...
3. **[Tworzenie użytkownika testowego Merchlogix](#create-a-merchlogix-test-user)**  — aby odpowiednikiem Britta Simon w Merchlogix połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Merchlogix domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<DOMAIN>/login.php?saml=true`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<DOMAIN>/simplesaml/module.php/saml/sp/metadata.php/<SAML_NAME>`
    
    > [!NOTE]
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej Merchlogix](http://www.merchlogix.com/contact/) do uzyskania tych wartości.

4. Na **certyfikat podpisywania SAML** kliknij **certyfikat (Base64)** , a następnie zapisz plik certyfikatu na komputerze.

    ![Link pobierania certyfikatu](./media/merchlogix-tutorial/tutorial_merchlogix_certificate.png) 

5. Kliknij przycisk **Zapisz** przycisku.

    ![Konfigurowanie pojedynczego logowania jednokrotnego Zapisz przycisku](./media/merchlogix-tutorial/tutorial_general_400.png)

6. Na **konfiguracji Merchlogix** , kliknij przycisk **skonfigurować Merchlogix** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania, identyfikator jednostki SAML,** i **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja Merchlogix](./media/merchlogix-tutorial/tutorial_merchlogix_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **Merchlogix** stronie, musisz wysłać pobrany **certyfikat (Base64)**, **adres URL wylogowania, identyfikator jednostki języka SAML i SAML pojedynczego logowania jednokrotnego usługi adresu URL**do [zespołem pomocy technicznej Merchlogix](http://www.merchlogix.com/contact/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Merchlogix. Praca z [zespołem pomocy technicznej Merchlogix](http://www.merchlogix.com/contact/) Aby dodać użytkowników na platformie Merchlogix.
