...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sumologic-tutorial/tutorial_sumologic_samlbase.png)

3. Na **SumoLogic domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/sumologic-tutorial/tutorial_sumologic_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sumologic-tutorial/tutorial_sumologic_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/sumologic-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji SumoLogic** , kliknij przycisk **skonfigurować SumoLogic** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sumologic-tutorial/tutorial_sumologic_configure.png) 
...
8. Przejdź do **zarządzanie \> zabezpieczeń**.
    ...
    ![Zarządzanie](./media/sumologic-tutorial/ic778556.png "zarządzania")
...
10. Z **wybierz konfigurację lub Utwórz nową** wybierz **usługi Azure AD**, a następnie kliknij przycisk **Konfiguruj**.
    ...
    ![Skonfigurować SAML 2.0](./media/sumologic-tutorial/ic778558.png "skonfigurować SAML 2.0")

11. Na **skonfigurować SAML 2.0** okna dialogowego, wykonaj następujące czynności:
   
    ![Skonfigurować SAML 2.0](./media/sumologic-tutorial/ic778559.png "skonfigurować SAML 2.0")
...
2. Na liście aplikacji zaznacz **SumoLogic**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/sumologic-tutorial/tutorial_sumologic_app.png) 
