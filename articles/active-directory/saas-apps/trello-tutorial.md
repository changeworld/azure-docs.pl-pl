...
1. W polu wyszukiwania wpisz **Trello**, wybierz opcję **usługi Trello** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego usługi Trello](#create-a-trello-test-user)**  — aby odpowiednikiem Britta Simon w aplikacji Trello, połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **usługi Trello, domena i adresy URL** sekcji, jeśli chcesz skonfigurować aplikację w **tryb inicjowane przez dostawcę tożsamości**, wykonaj następujące czynności:
...
1. Aplikacja usługi Trello oczekuje twierdzenia SAML w celu uwzględnienia określonych atrybutów. Skonfiguruj następujące atrybuty dla tej aplikacji. Możesz zarządzać wartości te atrybuty z **"Atrybuty użytkownika"** aplikacji. Poniższy zrzut ekranu przedstawia przykład tego.
...
1. Na **certyfikat podpisywania SAML** kliknij **certyfikat (Base64)** , a następnie zapisz plik metadanych na tym komputerze.
...
1. Na liście aplikacji wybierz **Trello**.
