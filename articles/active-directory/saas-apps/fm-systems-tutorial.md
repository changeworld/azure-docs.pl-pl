...
1. Aby skonfigurować logowanie jednokrotne na **FM:Systems** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej FM:Systems](https://fmsystems.com/ask-us/). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML. Po włączeniu rejestracji Jednokrotnej dla Twojej subskrypcji, otrzyma powiadomienie o.
