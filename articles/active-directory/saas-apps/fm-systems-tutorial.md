...
1. W polu wyszukiwania wpisz **FM:Systems**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/fm-systems-tutorial/tutorial_fmsystems_search.png)

1. W panelu wyników wybierz **FM:Systems**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
1. **[Tworzenie użytkownika testowego FM:Systems](#creating-an-fmsystems-test-user)**  — aby mają odpowiednika w pozycji Britta simon w FM:Systems połączonego z usługi Azure AD reprezentacja użytkownika.
...
1. Na **FM:Systems domena i adresy URL** sekcji, wykonaj następujące czynności:
...
1. Aby skonfigurować logowanie jednokrotne na **FM:Systems** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej FM:Systems](https://fmsystems.com/ask-us/). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach. Gdy logowanie jednokrotne zostanie włączone dla Twojej subskrypcji, otrzymasz o tym powiadomienie.
...
1. Przejdź do **administrowania systemem \> zarządzania zabezpieczeniami \> użytkowników \> listy użytkowników**.
   
    ![Administrowanie systemem](./media/fm-systems-tutorial/ic795905.png "Administracja systemu")

1. Kliknij przycisk **Utwórz nowego użytkownika**.
...
1. Na liście aplikacji wybierz **FM:Systems**.
