...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/tutorial_kantegassoforfisheyecrucible_samlbase.png)
...
3. W **IDP** inicjowane w trybie **logowania jednokrotnego Kantega FishEye/tygiel domeny i adresów URL** sekcji wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/tutorial_kantegassoforfisheyecrucible_url1.png)
...
4. W **SP** inicjowane trybie wyboru **Pokaż zaawansowane ustawienia adresu URL** i wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/tutorial_kantegassoforfisheyecrucible_url2.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/tutorial_kantegassoforfisheyecrucible_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/tutorial_general_400.png)
    
7. W oknie przeglądarki innej witryny sieci web należy zalogować się jako administrator do serwera lokalnego FishEye/tygiel.

8. Umieść kursor na koło zębate, a następnie kliknij przycisk **dodatki**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon1.png)

9. W sekcji Ustawienia systemu, kliknij przycisk **znaleźć nowe dodatki**. 

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/add-on2.png)
...
10. Wyszukiwanie **Kantega Usługa rejestracji Jednokrotnej dla tygiel** i kliknij przycisk **zainstalować** przycisk, aby zainstalować nowy wtyczki SAML.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon2.png)

11. Uruchamia instalację dodatku. 

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon33.png)

12. Po zakończeniu instalacji. Kliknij przycisk **Zamknij**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon34.png)

13. Kliknij pozycję **Zarządzaj**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon35.png)

14. Kliknij przycisk **Konfiguruj** do skonfigurowania nowej wtyczki.    

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon3.png)

15. W **SAML** sekcji. Wybierz **usługi Azure Active Directory (Azure AD)** z **dostawcy tożsamości Dodaj** listy rozwijanej.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon4.png)

16. Wybierz poziom subskrypcji jako **podstawowe**.

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon5.png)

17. Na **właściwości aplikacji** sekcji, wykonaj następujące kroki:

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon6.png)
...
18. Na **importu metadanych** sekcji, wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon7.png)
...
19. Na **nazwę i logowania jednokrotnego lokalizację** sekcji, wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon8.png)
...
20. Sprawdź certyfikatu podpisywania, a następnie kliknij przycisk **dalej**.  
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon9.png)

21. Na **kont użytkowników typu rybie oko** sekcji, wykonaj następujące kroki:

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon10.png)
...
22. Kliknij przycisk **Zakończ**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon11.png)

23. Na **znanych domeny dla usługi Azure AD** sekcji, wykonaj następujące kroki: 

    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/addon12.png)
...
1. Zaloguj się do serwera lokalnego tygiel jako administrator.
...
2. Na liście aplikacji zaznacz **Kantega Usługa rejestracji Jednokrotnej dla FishEye/tygiel**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/kantegassoforfisheyecrucible-tutorial/tutorial_kantegassoforfisheyecrucible_app.png) 
