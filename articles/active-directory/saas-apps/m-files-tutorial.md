---
title: 'Samouczek: Integracja usługi Azure Active Directory z plikami M | Dokumenty firmy Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-m-files"></a>Samouczek: Integracja usługi Azure Active Directory z plikami M
