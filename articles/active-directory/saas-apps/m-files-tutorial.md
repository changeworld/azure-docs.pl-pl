---
title: 'Samouczek: Integracja usługi Azure Active Directory z M-Files | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39424956"
---
# <a name="tutorial-azure-active-directory-integration-with-m-files"></a>Samouczek: Integracja usługi Azure Active Directory z M-Files
...
1. Na **M-Files domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<tenantname>.cloudvault.m-files.com/authentication/MFiles.AuthenticationProviders.Core/sso`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://<tenantname>.cloudvault.m-files.com`

    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta M-Files](mailto:support@m-files.com) do uzyskania tych wartości. 
