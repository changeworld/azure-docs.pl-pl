---
title: 'Samouczek: Integracja usługi Azure Active Directory z aplikacją Allbound SSO | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-integration-with-allbound-sso"></a>Samouczek: Integracja usługi Azure Active Directory z aplikacją Allbound SSO
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjowanym przez **dostawcę tożsamości**, w sekcji **Podstawowa konfiguracja protokołu SAML** wykonaj następujące kroki:
    ...
    a. W polu **Identyfikator** wpisz adres URL, korzystając z następującego wzorca: `https://<SUBDOMAIN>.allbound.com/`
