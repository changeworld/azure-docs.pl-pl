---
title: 'Samouczek: Integracja usługi Azure Active Directory z Dealpath | Dokumentacja firmy Microsoft'
...
3. Na **Dealpath domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://app.dealpath.com/account/login`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://api.dealpath.com/saml/metadata/<ID>`
