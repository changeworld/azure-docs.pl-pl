...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-darwinbox"></a>Samouczek: Azure Active Directory integrację logowania jednokrotnego (SSO) z usługą Darwinbox
...
1. **[Skonfiguruj logowanie](#configure-darwinbox-sso)** jednokrotne w usłudze Darwinbox, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
Aby skonfigurować Logowanie jednokrotne na stronie **Darwinbox** , musisz wysłać pobrany **XML metadanych Federacji** i odpowiednie skopiowane adresy URL z Azure Portal do [zespołu pomocy technicznej Darwinbox](https://darwinbox.com/contact-us.php). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.

### <a name="create-darwinbox-test-user"></a>Utwórz użytkownika testowego Darwinbox

W tej sekcji utworzysz użytkownika o nazwie B. Simon w Darwinbox. Aby dodać użytkowników na platformie Darwinbox, Pracuj z [zespołem pomocy technicznej Darwinbox](https://darwinbox.com/contact-us.php) . Użytkownicy muszą być tworzone i aktywowana, aby używać logowania jednokrotnego.

## <a name="test-sso"></a>Testuj Logowanie jednokrotne 

W tej sekcji służy do testowania konfiguracji usługi Azure AD pojedynczego logowania jednokrotnego przy użyciu panelu dostępu.

Po kliknięciu kafelka Darwinbox w panelu dostępu należy automatycznie zalogować się do Darwinbox, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) (Wprowadzenie do panelu dostępu).
