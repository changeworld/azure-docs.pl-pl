...
4. W polu wyszukiwania wpisz **aplikacji LOB z obsługą tokenu języka SAML 1.1**, wybierz opcję **aplikacji LOB z obsługą tokenu języka SAML 1.1** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie tokenu języka SAML 1.1 włączone użytkownika testowego aplikacji LOB](#create-a-saml-11-token-enabled-lob-app-test-user)**  — aby aplikacji LOB, połączonego z usługi Azure AD reprezentacja użytkownika z włączoną obsługą odpowiednikiem Britta Simon w tokenu języka SAML 1.1.
...
3. Na **włączone tokenu języka SAML 1.1, domena aplikacji LOB i adresy URL** sekcji, wykonaj następujące czynności:
...
2. Na liście aplikacji wybierz **aplikacji LOB z obsługą tokenu języka SAML 1.1**.
