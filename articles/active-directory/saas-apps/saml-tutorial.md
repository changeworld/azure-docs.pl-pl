...
Aby skonfigurować logowanie jednokrotne po stronie aplikacji **SAML 1.1 Token enabled LOB App**, należy wysłać pobrany **certyfikat (Base64)** i odpowiednie adresy URL skopiowane z witryny Azure Portal zespołowi pomocy technicznej aplikacji SAML 1.1 Token enabled LOB App. Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w aplikacji SAML 1.1 Token enabled LOB App. Aby dodać użytkowników do platformy aplikacji SAML 1.1 Token enabled LOB App, skontaktuj się z pomocą techniczną tej platformy. Użytkownicy muszą być tworzone i aktywowana, aby używać logowania jednokrotnego.
