---
title: 'Samouczek: Integracja usługi Azure Active Directory z FreshGrade | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39047165"
---
# <a name="tutorial-azure-active-directory-integration-with-freshgrade"></a>Samouczek: Integracja usługi Azure Active Directory z FreshGrade
...
3. **[Tworzenie użytkownika testowego FreshGrade](#creating-a-freshgrade-test-user)**  — aby odpowiednikiem Britta Simon w FreshGrade połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **FreshGrade domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta FreshGrade](mailTo:support@freshgrade.com) do uzyskania tych wartości.
...
6. Na **konfiguracji FreshGrade** , kliknij przycisk **skonfigurować FreshGrade** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfigurowanie logowania jednokrotnego](./media/freshgrade-tutorial/tutorial_freshgrade_configure.png)

7. Aby skonfigurować logowanie jednokrotne na **FreshGrade** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** i **SAML pojedynczego logowania jednokrotnego usługi adresu URL** do [ Zespół pomocy technicznej FreshGrade](mailTo:support@freshgrade.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **FreshGrade**.
