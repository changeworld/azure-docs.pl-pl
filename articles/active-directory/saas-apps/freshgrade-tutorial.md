...
Z tego samouczka dowiesz się integrowanie FreshGrade z usługi Azure Active Directory (Azure AD).

Integracja z usługą Azure AD FreshGrade zapewnia następujące korzyści:

- Można kontrolować w usłudze Azure AD, który ma dostęp do FreshGrade
- Umożliwia użytkownikom automatycznie pobrać zalogowane do FreshGrade (logowanie jednokrotne) przy użyciu ich kont usługi Azure AD
...
Aby skonfigurować integrację usługi Azure AD z FreshGrade, potrzebne są następujące elementy:
...
Aby skonfigurować integrację usługi Azure AD FreshGrade, należy dodać FreshGrade z galerii do listy zarządzanych aplikacji SaaS.
...
4. W polu wyszukiwania wpisz **FreshGrade**.

    ![Tworzenie użytkownika testowego usługi Azure AD](./media/freshgrade-tutorial/tutorial_freshgrade_search.png)

5. W panelu wyników wybierz **FreshGrade**, a następnie kliknij przycisk **Dodaj** przycisk, aby dodać aplikację.
...
Dla rejestracji jednokrotnej do pracy usługi Azure AD musi wiedzieć, użytkownik odpowiednika w FreshGrade jest dla użytkownika, w usłudze Azure AD. Innymi słowy link relację między użytkownikiem usługi Azure AD i danemu użytkownikowi w FreshGrade musi się.

W FreshGrade, należy przypisać wartość **nazwy użytkownika** w usłudze Azure AD jako wartość **Username** do ustanawiania relacji łącza.

Aby skonfigurować i przetestować usługi Azure AD rejestracji jednokrotnej z FreshGrade, należy wykonać poniższe bloki konstrukcyjne:

1. **[Konfigurowanie usługi Azure AD rejestracji jednokrotnej](#configuring-azure-ad-single-sign-on)**  — aby umożliwić użytkownikom korzystać z tej funkcji.
2. **[Tworzenie użytkownika testowego usługi Azure AD](#creating-an-azure-ad-test-user)**  — do przetestowania usługi Azure AD rejestracji jednokrotnej z Simona Britta.
3. **[Tworzenie użytkownika testowego FreshGrade](#creating-a-freshgrade-test-user)**  — w celu zapewnienia odpowiednikiem Simona Britta FreshGrade połączonego z usługi Azure AD reprezentację użytkownika.
4. **[Przypisanie użytkownika testowego usługi Azure AD](#assigning-the-azure-ad-test-user)**  — aby umożliwić Simona Britta do użycia usługi Azure AD rejestracji jednokrotnej.
5. **[Testowanie rejestracji jednokrotnej](#testing-single-sign-on)**  — Aby sprawdzić, czy konfiguracja działa.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurowanie usługi Azure AD rejestracji jednokrotnej

W tej sekcji można włączyć usługi Azure AD rejestracji jednokrotnej w portalu Azure i skonfigurować logowanie jednokrotne w aplikacji FreshGrade.

**Aby skonfigurować usługi Azure AD rejestracji jednokrotnej z FreshGrade, wykonaj następujące czynności:**

1. W portalu Azure na **FreshGrade** strona integracji aplikacji, kliknij przycisk **logowanie jednokrotne**.

    ![Konfigurowanie rejestracji jednokrotnej][4]

2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.

    ![Konfigurowanie rejestracji jednokrotnej](./media/freshgrade-tutorial/tutorial_freshgrade_samlbase.png)

3. Na **FreshGrade domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/freshgrade-tutorial/tutorial_freshgrade_url.png)
...
4. Na **certyfikat podpisywania SAML** sekcji, kliknij przycisk Kopiuj, aby skopiować **adres Url metadanych Federacji aplikacji** i wklej go do Notatnika.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/freshgrade-tutorial/tutorial_metadataurl.png)
     
5. Kliknij przycisk **zapisać** przycisku.

    ![Konfigurowanie rejestracji jednokrotnej](./media/freshgrade-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji FreshGrade** , kliknij przycisk **skonfigurować FreshGrade** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/freshgrade-tutorial/tutorial_freshgrade_configure.png)
...
W tej sekcji należy utworzyć użytkownika o nazwie Simona Britta w FreshGrade. We współpracy z [zespołem pomocy technicznej FreshGrade](mailTo:support@freshgrade.com) Aby dodać użytkowników do platformy FreshGrade.

### <a name="assigning-the-azure-ad-test-user"></a>Przypisanie użytkownika testowego usługi Azure AD

W tej sekcji można włączyć Simona Britta do używania Azure logowania jednokrotnego za udzielanie dostępu FreshGrade.
...
2. Na liście aplikacji zaznacz **FreshGrade**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/freshgrade-tutorial/tutorial_freshgrade_app.png) 
