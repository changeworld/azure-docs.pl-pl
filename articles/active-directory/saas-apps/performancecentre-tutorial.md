---
title: 'Samouczek: Integracja usługi Azure Active Directory z PerformanceCentre | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39428183"
---
# <a name="tutorial-azure-active-directory-integration-with-performancecentre"></a>Samouczek: Integracja usługi Azure Active Directory z PerformanceCentre
...
1. Na **PerformanceCentre domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    a. W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `http://companyname.performancecentre.com/saml/SSO`

    b. W **identyfikator** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `http://companyname.performancecentre.com`

    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z pomocą [zespołem pomocy technicznej klienta PerformanceCentre](https://www.performancecentre.com/contact-us/) do uzyskania tych wartości. 
