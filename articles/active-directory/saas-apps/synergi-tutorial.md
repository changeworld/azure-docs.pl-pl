...
3. **[Tworzenie użytkownika testowego Synergi](#create-a-synergi-test-user)**  — aby odpowiednikiem Britta Simon w Synergi połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Synergi domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji Synergi** , kliknij przycisk **skonfigurować Synergi** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **adres URL wylogowania i identyfikator jednostki SAML** z **krótki przewodnik po sekcji.**

    ![Konfiguracja Synergi](./media/synergi-tutorial/tutorial_synergi_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **Synergi** stronie, musisz wysłać pobrany **Certificate(Base64), adres URL wylogowania i identyfikator jednostki SAML** do [Synergi zespołem pomocy technicznej](https://www.irmsecurity.com/contact/).
