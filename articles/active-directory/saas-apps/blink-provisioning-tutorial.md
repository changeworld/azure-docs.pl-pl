---
title: 'Samouczek: Skonfiguruj migotanie w celu automatycznego aprowizacji użytkowników przy użyciu Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "71156126"
---
# <a name="tutorial-configure-blink-for-automatic-user-provisioning"></a>Samouczek: Skonfiguruj migotanie w celu automatycznego aprowizacji użytkowników
...
1. Zaloguj się support@joinblink.com do pomocy [technicznej](https://help.joinblink.com/hc/requests/new) w **celu** zażądania tokenu Standard scim. .
