...
4. W polu wyszukiwania wpisz **YouEarnedt**, wybierz opcję **YouEarnedt** z panelu wynik kliknięcie **Dodaj** przycisk, aby dodać aplikację.
...
3. **[Tworzenie użytkownika testowego YouEarnedIt](#create-a-youearnedit-test-user)**  — aby odpowiednikiem Britta Simon w YouEarnedIt połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **YouEarnedIt domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    > [!NOTE] 
    > Te wartości są prawdziwe. Zaktualizuj te wartości przy użyciu rzeczywistego adresu URL logowania jednokrotnego i identyfikator. Skontaktuj się z Menedżera YouEarnedIt sukces klientów przypisanych do uzyskania tych wartości.
...
6. Na **konfiguracji YouEarnedIt** , kliknij przycisk **skonfigurować YouEarnedIt** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w YouEarnedIt. Skontaktuj się z przypisanego Menedżera YouEarnedIt sukcesie klienta można dodać użytkowników na platformie YouEarnedIt.
...
2. Na liście aplikacji wybierz **YouEarnedIt**.
