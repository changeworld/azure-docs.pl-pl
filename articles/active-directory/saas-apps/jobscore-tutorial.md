---
title: 'Samouczek: Integracja usługi Azure Active Directory z JobScore | Dokumentacja firmy Microsoft'
...
ms.locfileid: "39449149"
---
# <a name="tutorial-azure-active-directory-integration-with-jobscore"></a>Samouczek: Integracja usługi Azure Active Directory z JobScore
...
1. Na **JobScore domena i adresy URL** sekcji, wykonaj następujące czynności:
    ...
    W **adres URL logowania** pole tekstowe, wpisz adres URL przy użyciu następującego wzorca: `https://hire.jobscore.com/auth/adfs/<company name>`
