...
4. W polu wyszukiwania wpisz **Proofpoint na żądanie**, wybierz pozycję **Proofpoint na żądanie** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Proofpoint na żądanie z listy wyników](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_addfromgallery.png)
...
3. Na **Proofpoint na żądanie domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Proofpoint na żądanie domeny i adres URL pojedynczego logowania jednokrotnego informacji](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_url.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **Certificate(Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/proofpoint-ondemand-tutorial/tutorial_general_400.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/proofpoint-ondemand-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **Proofpoint na żądanie**.
    ...
    ![Proofpoint na żądanie łącza na liście aplikacji](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_app.png)  
