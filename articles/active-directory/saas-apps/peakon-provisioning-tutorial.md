---
title: 'Samouczek: Skonfiguruj Peakon automatyczne Inicjowanie obsługi użytkowników przy użyciu Azure Active Directory | Microsoft Docs'
...
* Wszystkie niestandardowe atrybuty użytkownika w Peakon muszą zostać rozszerzone z niestandardowego rozszerzenia `urn:ietf:params:scim:schemas:extension:peakon:2.0:User`użytkownika Standard scim Peakon.
