...
3. **[Tworzenie użytkownika testowego Peoplecart](#create-a-peoplecart-test-user)**  — aby odpowiednikiem Britta Simon w Peoplecart połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Peoplecart domena i adresy URL** sekcji, wykonaj następujące czynności:
...
6. Na **konfiguracji Peoplecart** , kliknij przycisk **skonfigurować Peoplecart** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **SAML pojedynczego logowania jednokrotnego usługi adresu URL** z **krótki przewodnik po sekcji.**

    ![Konfiguracja Peoplecart](./media/peoplecart-tutorial/tutorial_peoplecart_configure.png) 

7. Aby skonfigurować logowanie jednokrotne na **Peoplecart** stronie, musisz wysłać pobrany **XML metadanych** i **SAML pojedynczego logowania jednokrotnego usługi adresu URL** do [Peoplecart zespołu pomocy technicznej](https://peoplecart.com/ContactUs.aspx). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
