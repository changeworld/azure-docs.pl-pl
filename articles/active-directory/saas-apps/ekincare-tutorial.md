...
3. **[Tworzenie użytkownika testowego eKincare](#creating-a-ekincare-test-user)**  — aby mają odpowiednika w pozycji Britta simon w eKincare połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **eKincare domena i adresy URL** sekcji, wykonaj następujące czynności:
...
4. Aplikacja eKincare oczekuje twierdzenia SAML w określonym formacie. Skonfiguruj następujące oświadczenia dla tej aplikacji. Możesz zarządzać wartości te atrybuty z "**atrybutów użytkownika**" sekcji na stronie integracji aplikacji. Poniższy zrzut ekranu przedstawia przykład w przypadku tej konfiguracji.
...
8. Aby skonfigurować logowanie jednokrotne na **eKincare** stronie, musisz wysłać pobrany **XML metadanych** do [zespołem pomocy technicznej eKincare](mailto:tech@ekincare.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
...
2. Na liście aplikacji wybierz **eKincare**.
