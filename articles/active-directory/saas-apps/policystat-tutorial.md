...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/policystat-tutorial/tutorial_policystat_samlbase.png)

3. Na **PolicyStat domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Konfigurowanie rejestracji jednokrotnej](./media/policystat-tutorial/tutorial_policystat_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/policystat-tutorial/tutorial_policystat_certificate.png) 
...
6. Aby dodać mapowania wymaganego atrybutu, wykonaj następujące czynności:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/policystat-tutorial/tutorial_policystat_04.png)

    ![Konfigurowanie rejestracji jednokrotnej](./media/policystat-tutorial/tutorial_policystat_addatribute.png)
...
7. Kliknij przycisk **zapisać** przycisku.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/policystat-tutorial/tutorial_general_400.png)
...
2. Na liście aplikacji zaznacz **PolicyStat**.
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/policystat-tutorial/tutorial_policystat_app.png) 
