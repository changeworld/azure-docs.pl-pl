...
3. **[Tworzenie użytkownika testowego Bpm'online](#create-a-bpmonline-test-user)**  — aby odpowiednikiem Britta Simon w Bpm'online połączonego z usługi Azure AD reprezentacja użytkownika.
...
3. Na **Bpm'online domena i adresy URL** sekcji, wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w **tożsamości** zainicjowano tryb:
...
7. Aby skonfigurować logowanie jednokrotne na **Bpm'online** stronie, musisz wysłać **adres Url metadanych Federacji aplikacji** do [zespołem pomocy technicznej Bpm'online](mailto:support@bpmonline.com). Ustawiają to ustawienie, aby były prawidłowo po obu stronach połączenia logowania jednokrotnego SAML.
