...
3. Na **Expensify domeny i adres URL** sekcji, wykonaj następujące czynności:
    ...
    ![Expensify domeny i adres URL pojedynczego logowania jednokrotnego informacji](./media/expensify-tutorial/tutorial_expensify_url.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/expensify-tutorial/tutorial_expensify_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/expensify-tutorial/tutorial_general_400.png)
...
6. Aby włączyć logowanie Jednokrotne w Expensify, należy najpierw włączyć **kontroli domeny** w aplikacji. Formant domeny można włączyć w aplikacji za pomocą kroków opisanych [tutaj](http://help.expensify.com/domain-control). Aby uzyskać dodatkową pomoc, Praca z [zespołem pomocy technicznej klienta Expensify](mailto:help@expensify.com). Po utworzeniu włączona funkcja Kontrola domeny, wykonaj następujące kroki:
    ...
    ![Konfigurowanie rejestracji jednokrotnej](./media/expensify-tutorial/tutorial_expensify_51.png)
...
2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.
    ...
    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/expensify-tutorial/create_aaduser_02.png)
...
2. Na liście aplikacji zaznacz **Expensify**.
    ...
    ![Łącze Expensify na liście aplikacji](./media/expensify-tutorial/tutorial_expensify_app.png)  
