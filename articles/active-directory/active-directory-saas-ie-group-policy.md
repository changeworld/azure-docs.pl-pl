...
2. W **Menedżera serwera** okna, przejdź do **plików i magazynowania**.
    ...
    ![Otwartych plików i magazynowania](./media/active-directory-saas-ie-group-policy/files-services.png)
3. Przejdź do **udziałów** kartę. Następnie kliknij przycisk **zadania** > **nowy udział...**
   
    ![Otwartych plików i magazynowania](./media/active-directory-saas-ie-group-policy/shares.png)
...
2. W Menedżerze serwera, przejdź do **narzędzia** > **Zarządzanie zasadami grupy**.
    ...
    ![Przejdź do pozycji Narzędzia > zarządzania zasadami grupy](./media/active-directory-saas-ie-group-policy/tools-gpm.png)
...
5. W **nowego obiektu zasad grupy** wiersza, wpisz nazwę dla nowego obiektu zasad grupy.
    ...
    ![Nadaj nazwę nowego obiektu zasad grupy](./media/active-directory-saas-ie-group-policy/name-gpo.png)
...
2. Kliknij prawym przyciskiem myszy **lista dodatków**i wybierz **Edytuj**.
    ![Edytuj listę dodatku.](./media/active-directory-saas-ie-group-policy/edit-add-on-list.png)
3. W **lista dodatków** wybierz **włączone**. Następnie w obszarze **opcje** kliknij **Pokaż...** .
   
    ![Kliknij pozycję Włącz, a następnie kliknąć pozycję Pokaż...](./media/active-directory-saas-ie-group-policy/edit-add-on-list-window.png)
4. W **Pokaż zawartość** okna, wykonaj następujące czynności:
   ...
   3. Kliknij przycisk **OK** zamknąć **Pokaż zawartość** okna.
      ...
      ![Wypełnij wartości, jak określono powyżej.](./media/active-directory-saas-ie-group-policy/show-contents.png)
...
2. Znajdź ustawienie o nazwie **włączyć funkcję automatycznego uzupełniania dla nazw użytkownika i hasła w formularzach**.
   ...
   > 
    ...
    ![Pamiętaj wyszukać to w obszarze Ustawienia użytkownika.](./media/active-directory-saas-ie-group-policy/disable-auto-complete.png)
...
4. Po ponownym uruchomieniu komputera, należy otworzyć **programu Internet Explorer**. W prawym górnym rogu okna, kliknij polecenie **narzędzia** (ikonę koła zębatego), a następnie wybierz pozycję **zarządzać dodatkami**.
    ...
    ![Przejdź do pozycji Narzędzia > Zarządzanie dodatkami](./media/active-directory-saas-ie-group-policy/manage-add-ons.png)
5. W **Zarządzanie dodatkami** okna, upewnij się, że **rozszerzenia Panelu dostępu do** został zainstalowany i czy jego **stan** został ustawiony na **włączone**.
    ...
    ![Sprawdź, czy rozszerzenie panelu dostępu jest zainstalowane i włączone.](./media/active-directory-saas-ie-group-policy/verify-install.png)
...
* [Rozwiązywanie problemów z rozszerzenia Panelu dostępu do programu Internet Explorer](active-directory-saas-ie-troubleshooting.md)
