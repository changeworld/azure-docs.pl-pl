...
![Diagnozowanie scenariusz typowych błędów synchronizacji](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixCommonCase.png)
...
![Diagnozowanie scenariusz obiektu oddzielonego błąd synchronizacji](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Kroki diagnozy błędu synchronizacji](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixSteps.png)
...
![Diagnozowanie obiektu oddzielonego błąd synchronizacji * istnieje użytkownik * scenariusza](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Diagnozowanie obiektu oddzielonego błąd synchronizacji * ten sam scenariusz użytkownika *](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
