...
## <a name="august-2018"></a>Sierpnia 2018 
...
* [Test narzędzia łączności dla usługi Azure AD Connect kondycji agentów](active-directory-aadconnect-health-agent-install.md#test-connectivity-to-azure-ad-connect-health-service)
...
* [Azure AD Connect Health do celów synchronizacji](active-directory-aadconnect-health-sync.md).
...
Dowiedz się więcej o [monitorować swoje lokalne tożsamości infrastruktury i usług synchronizacji w chmurze](active-directory-aadconnect-health.md).
