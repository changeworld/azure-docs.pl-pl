...
4. W polu wyszukiwania wpisz **G Suite**, wybierz pozycję **G Suite** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Pakiet G na liście wyników](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_addfromgallery.png)
...
3. Na **G Suite domeny i adres URL** sekcji, aby skonfigurować dla **Gmail** należy wykonać następujące czynności:
    ...
    ![Adresy URL i domeny Suite G pojedynczy informacje logowania jednokrotnego](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_urlgmail.png)
...
4. Na **G Suite domeny i adres URL** sekcji, aby skonfigurować dla **usługi Google Cloud Platform** należy wykonać następujące czynności:
    ...
    ![Adresy URL i domeny Suite G pojedynczy informacje logowania jednokrotnego](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_url1.png)
...
7. Na **G pakiet konfiguracji** kliknij **skonfigurować pakiet G** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, SAML pojedynczy znak na adres URL usługi i zmień adres URL hasła** z **sekcji krótkimi opisami.**
    ...
    ![G pakietu konfiguracji](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_configure.png) 
...
2. Na liście aplikacji zaznacz **G Suite**.
    ...
    ![Łącze G Suite na liście aplikacji](./media/active-directory-saas-googleapps-tutorial/tutorial_googleapps_app.png)  
