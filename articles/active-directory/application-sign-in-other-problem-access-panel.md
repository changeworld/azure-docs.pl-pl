...
Może również Pobierz rozszerzenie dla programu Chrome i Microsoft Edge z bezpośrednie linki poniżej:
...
-   [Rozszerzenie panelu dostępu usługi Edge](https://www.microsoft.com/store/apps/9pc9sckkzk84)
...
11. Wprowadź wymagane wartości w **domena i adresy URL.** Te wartości należy uzyskać od dostawcy aplikacji.
  ...
  2. **Opcjonalnie:** do konfigurowania aplikacji jako zainicjowanego przez dostawcę usług rejestracji Jednokrotnej adres URL logowania jest wymaganą wartością.
...
9.  Aby dodać atrybuty użytkownika, kliknij **Wyświetl i Edytuj wszystkie inne atrybuty użytkownika** atrybuty do wysłania do aplikacji w tokenie języka SAML, gdy użytkownicy logują się.
   ...
   Kliknij 2 **Zapisz.** Zostanie wyświetlony nowy atrybut w tabeli.
...
[Udostępnij logowanie jednokrotne do aplikacji serwera Proxy aplikacji](manage-apps/application-proxy-configure-single-sign-on-with-kcd.md)
