...
---
# <a name="use-a-windows-vm-msi-to-access-azure-cosmos-db"></a>Umożliwia dostęp do bazy danych Azure rozwiązania Cosmos MSI maszyny Wirtualnej systemu Windows
