...
![Tworzenie zasad](./media/active-directory-conditional-access-tou/5555.png)
...
- **Konto testowe o nazwie Isabella Simonsen** — Jeśli nie wiesz, jak tworzyć konta testowego, zobacz [Dodawanie użytkowników w chmurze](fundamentals/add-users-azure-active-directory.md#add-cloud-based-users).
...
4. W witrynie Azure portal, w lewym pasku nawigacyjnym kliknij **usługi Azure Active Directory**. 
    ...
    ![Usługa Azure Active Directory](./media/active-directory-conditional-access-tou/02.png)

5. Na **usługi Azure Active Directory** stronie **Zarządzaj** kliknij **dostępu warunkowego**.

    ![Dostęp warunkowy](./media/active-directory-conditional-access-tou/03.png) 

6. W **Zarządzaj** kliknij **warunki użytkowania**.

    ![Warunki użytkowania](./media/active-directory-conditional-access-tou/04.png) 

7. W menu u góry kliknij **nowe warunki**.

    ![Warunki użytkowania](./media/active-directory-conditional-access-tou/05.png) 

8. Na **nowe warunki użytkowania** strony:

    ![Warunki użytkowania](./media/active-directory-conditional-access-tou/112.png) 
...
![Tworzenie zasad](./media/active-directory-conditional-access-tou/1234.png)
...
1. Na **nowy** stronie **nazwa** polu tekstowym wpisz **wymagają warunków użytkowania dla Isabella**.
    ...
    ![Name (Nazwa)](./media/active-directory-conditional-access-tou/71.png)

2. W **przypisania** kliknij **użytkowników i grup**.

    ![Użytkownicy i grupy](./media/active-directory-conditional-access-tou/06.png)

3. Na **użytkowników i grup** strony:

    ![Użytkownicy i grupy](./media/active-directory-conditional-access-tou/24.png)
...
4. Kliknij przycisk **aplikacje w chmurze**.
    ...
    ![Aplikacje w chmurze](./media/active-directory-conditional-access-tou/08.png)

5. Na **aplikacje w chmurze** strony:

    ![Wybierz aplikacje w chmurze](./media/active-directory-conditional-access-tou/26.png)
...
6. W **kontrole dostępu** kliknij **Grant**.
    ...
    ![Kontrole dostępu](./media/active-directory-conditional-access-tou/10.png)

7. Na **Grant** strony:

    ![Udziel](./media/active-directory-conditional-access-tou/111.png)
...
8. W **Włącz zasady** kliknij **na**.
    ...
    ![Włącz zasady](./media/active-directory-conditional-access-tou/18.png)
...
![Co zrobić, jeśli narzędzie zasad](./media/active-directory-conditional-access-tou/79.png)
...
2. Kliknij przycisk **użytkowników**, wybierz opcję **Isabella Simonsen**, a następnie kliknij przycisk **wybierz**.
    ...
    ![Użytkownik](./media/active-directory-conditional-access-tou/15.png)

2. Aby wybrać aplikację w chmurze:

    ![Aplikacje w chmurze](./media/active-directory-conditional-access-tou/16.png)
...
![Warunki użytkowania](./media/active-directory-conditional-access-tou/57.png)
...
- Jeśli nie wiesz, jak usunąć użytkownika usługi Azure AD, zobacz [usunąć użytkowników z usługi Azure AD](fundamentals/add-users-azure-active-directory.md#delete-users-from-azure-ad).

- Aby usunąć zasady, wybierz zasady, a następnie kliknij przycisk **Usuń** na pasku narzędzi Szybki dostęp.

    ![Uwierzytelnianie wieloskładnikowe](./media/active-directory-conditional-access-tou/33.png)

- Aby usunąć warunki użytkowania, zaznacz go, a następnie kliknij **warunków usuwania** na pasku narzędzi u góry. 

    ![Uwierzytelnianie wieloskładnikowe](./media/active-directory-conditional-access-tou/29.png)

## <a name="next-steps"></a>Kolejne kroki

> [!div class="nextstepaction"]
> [Wymagać uwierzytelniania Wieloskładnikowego dla określonych aplikacji](./active-directory-conditional-access-app-based-mfa.md)
> [zablokować dostęp po wykryciu zagrożenia sesji](./active-directory-conditional-access-app-sign-in-risk.md)
