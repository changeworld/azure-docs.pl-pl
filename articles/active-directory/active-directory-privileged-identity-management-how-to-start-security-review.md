...
Przypisania ról nieodświeżone "", gdy użytkownicy mają uprzywilejowany dostęp, które nie wymagają już. W celu zmniejszenia ryzyka związanego z te przypisania ról starych ról uprzywilejowanych administratorów globalnych lub należy regularnie tworzyć recenzje dostępu poprosić administratorom przejrzeć role, które użytkownicy mają prawo. W tym dokumencie opisano kroki dotyczące uruchomienia Przegląd dostępu w usłudze Azure AD Privileged Identity Management (PIM).
