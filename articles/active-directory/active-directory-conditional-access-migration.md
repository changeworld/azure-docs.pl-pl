...
- [Najlepsze rozwiązania dotyczące dostępu warunkowego w usłudze Azure Active Directory](conditional-access/best-practices.md) Aby uzyskać wskazówki dotyczące wdrażania dostępu warunkowego w Twojej organizacji.

- [Wymagać uwierzytelniania Wieloskładnikowego dla określonych aplikacji przy użyciu dostępu warunkowego usługi Azure Active Directory](conditional-access/app-based-mfa.md) możliwość zapoznania się z interfejsem użytkownika w witrynie Azure portal.
...
- Jeśli chcesz wiedzieć, jak skonfigurować zasady dostępu warunkowego, zobacz [GRequire MFA dla określonych aplikacji przy użyciu dostępu warunkowego usługi Azure Active Directory](conditional-access/app-based-mfa.md).
