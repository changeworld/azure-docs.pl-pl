...
* [Jak przeprowadzić migrację użytkowników z licencjami indywidualnymi do licencjonowania opartego na grupy w usłudze Azure Active Directory](users-groups-roles/licensing-groups-migrate-users.md)
* [Usługa Azure Active Directory na podstawie grupy licencjonowania dodatkowe scenariusze](users-groups-roles/licensing-group-advanced.md)
