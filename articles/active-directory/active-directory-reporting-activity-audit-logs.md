...
- Aby uzyskać pełną listę wszystkich działań inspekcji, zobacz artykuł[Azure AD audit activity reference (Informacje o działaniach inspekcji usługi Azure AD)](active-directory-reporting-activity-audit-reference.md)
