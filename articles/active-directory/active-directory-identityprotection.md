...
Możesz powiązać badanie działań mających na celu [powiadomienia](identity-protection/notifications.md) ochrony usługi Azure Active Directory, wysyła wiadomości e-mail.
...
* [Ryzykowne logowania odzyskiwania](identity-protection/flows.md#risky-sign-in-recovery)
* [Ryzykowne logowanie zablokowane](identity-protection/flows.md#risky-sign-in-blocked)  
* [Środowisko logowania za pomocą usługi Azure AD Identity Protection](identity-protection/flows.md)  
...
* [Naruszenia zabezpieczeń konta odzyskiwania przepływ](identity-protection/flows.md#compromised-account-recovery).  
* [Naruszone zablokowano konto przepływu](identity-protection/flows.md#compromised-account-blocked).  
...
* [Uwierzytelnianie wieloskładnikowe rejestracji w usłudze flow](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Logowania środowisk przy użyciu usługi Azure AD Identity Protection](identity-protection/flows.md).  
...
* [Luki w zabezpieczeniach wykryte przez usługi Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md)

* [Zdarzenia o podwyższonym ryzyku w usłudze Azure Active Directory](active-directory-identity-protection-risk-events.md)

* [Powiadomienia usługi Azure Active Directory Identity Protection](identity-protection/notifications.md)

* [Podręcznik usługi Azure Active Directory Identity Protection](identity-protection/playbook.md)

* [Słownik platformy Azure Active Directory Identity Protection](identity-protection/glossary.md)

* [Środowisko logowania za pomocą usługi Azure AD Identity Protection](identity-protection/flows.md)

* [Usługa Azure Active Directory Identity Protection - sposób odblokowania użytkowników](identity-protection/howto-unblock-user.md)

* [Rozpoczynanie pracy z usługą Azure Active Directory Identity Protection i Microsoft Graph](identity-protection/graph-get-started.md)
