...
|   |   |
|---|---|
|![Zaznacz][1]|Review your scenarios|
|![Zaznacz][1]|Review your identity infrastructure|
|![Zaznacz][1]|Assess your device management|
|![Zaznacz][1]|Understand considerations for applications and resources|
|![Zaznacz][1]|Understand your provisioning options|
|![Zaznacz][1]|Configure enterprise state roaming|
|![Zaznacz][1]|Configure Conditional Access|
...
| --- | --- | --- | --- |
| Require user interaction to set up | Tak | Tak | Nie |
| Require IT effort | Nie | Tak | Tak |
| Applicable flows | OOBE & Settings | OOBE only | OOBE only |
| Local admin rights to primary user | Yes, by default | Configurable | Nie |
| Require device OEM support | Nie | Tak | Nie |
