...
![Tworzenie zasad](./media/active-directory-conditional-access-app-sign-in-risk/1000.png)
...
- **Ochrona tożsamości** — scenariusz, w tym przewodniku Szybki Start wymaga włączenia ochrony tożsamości. Jeśli nie wiesz, jak włączyć usługę Identity Protection, zobacz [włączania usługi Azure Active Directory Identity Protection](active-directory-identityprotection-enable.md).

- **Przeglądarka tor** — [przeglądarki Tor](https://www.torproject.org/projects/torbrowser.html.en) zaprojektowano w celu zachowania prywatności w trybie online. Identity Protection wykrywa logowania w przeglądarce sieci Tor jako **logowania z anonimowych adresów IP**, który ma poziom średniego ryzyka. Aby uzyskać więcej informacji, zobacz [Zdarzenia o podwyższonym ryzyku w usłudze Azure Active Directory](active-directory-reporting-risk-events.md).  
...
2. W witrynie Azure portal, w lewym pasku nawigacyjnym kliknij **usługi Azure Active Directory**. 
    ...
    ![Usługa Azure Active Directory](./media/active-directory-conditional-access-app-sign-in-risk/02.png)

3. Na **usługi Azure Active Directory** stronie **Zarządzaj** kliknij **dostępu warunkowego**.

    ![Dostęp warunkowy](./media/active-directory-conditional-access-app-sign-in-risk/03.png)
 
4. Na **dostępu warunkowego** w pasku narzędzi u góry, kliknij **Dodaj**.

    ![Name (Nazwa)](./media/active-directory-conditional-access-app-sign-in-risk/108.png)

5. Na **New** strony w **nazwa** polu tekstowym wpisz **zablokować dostęp dla poziomu średniego ryzyka**.

    ![Name (Nazwa)](./media/active-directory-conditional-access-app-sign-in-risk/104.png)

6. W **przypisania** kliknij **użytkowników i grup**.

    ![Użytkownicy i grupy](./media/active-directory-conditional-access-app-sign-in-risk/06.png)

7. Na **użytkowników i grup** strony:

    ![Dostęp warunkowy](./media/active-directory-conditional-access-app-sign-in-risk/107.png)
...
8. Kliknij przycisk **aplikacje w chmurze**.
    ...
    ![Aplikacje w chmurze](./media/active-directory-conditional-access-app-sign-in-risk/08.png)

9. Na **aplikacje w chmurze** strony:

    ![Dostęp warunkowy](./media/active-directory-conditional-access-app-sign-in-risk/109.png)
...
10. W **kontrole dostępu** kliknij **Grant**.
    ...
    ![Kontrole dostępu](./media/active-directory-conditional-access-app-sign-in-risk/10.png)

11. Na **Grant** strony:

    ![Dostęp warunkowy](./media/active-directory-conditional-access-app-sign-in-risk/105.png)
...
12. W **Włącz zasady** kliknij **na**.
    ...
    ![Włącz zasady](./media/active-directory-conditional-access-app-sign-in-risk/18.png)
...
![Użytkownik](./media/active-directory-conditional-access-app-sign-in-risk/117.png)
...
2. Kliknij przycisk **użytkownika**, wybierz opcję **Alan Charon** na **użytkowników** strony, a następnie kliknij przycisk **wybierz**.
    ...
    ![Użytkownik](./media/active-directory-conditional-access-app-sign-in-risk/116.png)

3. Jako **ryzyka logowania**, wybierz opcję **średni**.

    ![Użytkownik](./media/active-directory-conditional-access-app-sign-in-risk/119.png)
...
![Uwierzytelnianie wieloskładnikowe](./media/active-directory-conditional-access-app-sign-in-risk/118.png)
...
- Aby usunąć zasady, wybierz zasady, a następnie kliknij przycisk **Usuń** na pasku narzędzi Szybki dostęp.
    ...
    ![Uwierzytelnianie wieloskładnikowe](./media/active-directory-conditional-access-app-sign-in-risk/33.png)
...
> [Wymagane warunki użytkowania, należy zaakceptować](./active-directory-conditional-access-tou.md)
> [wymagają usługi MFA dla określonych aplikacji](./active-directory-conditional-access-app-based-mfa.md)
