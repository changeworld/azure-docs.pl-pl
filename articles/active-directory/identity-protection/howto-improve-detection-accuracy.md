...
ms.locfileid: "54913982"
---
# <a name="how-to-improve-the-detection-accuracy"></a>Jak: Zwiększania dokładności wykrywania 
...
- Tę akcję można wykonać tylko, jeśli usługi AD zarządza poświadczeń użytkownika. (Ten średniej?)
