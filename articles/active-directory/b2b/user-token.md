---
title: Opis tokenów użytkowników we współpracy b2b — usługa Azure AD
description: Odwołanie do tokenu użytkownika dla współpracy B2B usługi Azure Active Directory
...
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Opis tokenów użytkowników we współpracy z usługą Azure AD B2B

Jeśli chcesz wiedzieć, jak wygląda token dla użytkownika współpracy B2B, oto szczegóły tokenu nośnika i zawartość tokenu dla gościa usługi Azure Active Directory (Azure AD) i gościa konta Microsoft w dzierżawie zasobów (dla tenantid 04dcc6ab-388a-4559-b527-fbec656300ea). Aby wyświetlić zawartość tokenu JSON Web [https://jwt.io/](https://jwt.io/) Token [https://jwt.ms/](https://jwt.ms/)(JWT), użyj lub .
