...
Zasady zabezpieczeń i zgodność: Zarządzana przez hosta/zapraszanie organizacji (na przykład za pomocą [zasady dostępu warunkowego](https://docs.microsoft.com/azure/active-directory/b2b/conditional-access)).  | Zasady zabezpieczeń i zgodność: zarządzane przez aplikację.
