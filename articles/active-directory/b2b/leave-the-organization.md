...
3. Obok pozycji **organizacji**, wybierz ikonę ustawień (koło zębate).
   ...
   ![Zrzut ekranu przedstawiający ustawień użytkownika w panelu dostępu](media/leave-the-organization/UserSettings.png) 

3. W obszarze **organizacji**, Znajdź organizacji, który chcesz pozostawić, a następnie wybierz **pozostaw organizacji**.

   ![Zrzut ekranu przedstawiający pozostaw opcję organizacji w interfejsie użytkownika](media/leave-the-organization/LeaveOrg.png)
