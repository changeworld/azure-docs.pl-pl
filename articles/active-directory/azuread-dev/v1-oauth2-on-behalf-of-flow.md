...
Następujące HTTP POST żąda tokenu dostępu dla internetowego interfejsu API https://graph.microsoft.com. `client_id` identyfikuje usługę, która żąda tokenu dostępu.
...
Następujące HTTP POST żąda tokenu dostępu dla internetowego interfejsu API https://graph.microsoft.com z certyfikatem. `client_id` identyfikuje usługę, która żąda tokenu dostępu.
