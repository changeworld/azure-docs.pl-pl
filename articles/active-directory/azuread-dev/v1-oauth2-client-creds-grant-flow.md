...
Poniższe żądanie HTTP POST żąda [tokenu dostępu](../develop/access-tokens.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json) dla usługi sieci Web https://service.contoso.com/. `client_id` identyfikuje usługę sieci Web, która żąda tokenu dostępu.
