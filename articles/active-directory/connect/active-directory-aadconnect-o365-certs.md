...
![Powiadomienia portalu usługi Office 365](./media/active-directory-aadconnect-o365-certs/notification.png)
...
> [!NOTE]
> Jeśli wymagana jest obsługa wielu domen najwyższego poziomu, np. contoso.com i fabrikam.com, należy użyć **SupportMultipleDomain** przełącznika za pomocą polecenia cmdlet. Aby uzyskać więcej informacji, zobacz [Obsługa wielu domen poziom górnej](active-directory-aadconnect-multiple-domains.md).
>
