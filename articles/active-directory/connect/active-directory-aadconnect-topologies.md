---
title: 'Azure AD Connect: Obsługiwane topologie | Dokumentacja firmy Microsoft'
...
| Opis | Symbol |
| --- | --- |
| W środowisku lokalnym lesie usługi Active Directory |![W środowisku lokalnym lesie usługi Active Directory](./media/active-directory-aadconnect-topologies/LegendAD1.png) |
| Lokalnej usługi Active Directory przy użyciu filtrowane importu |![Usługi Active Directory z filtrowanych importu](./media/active-directory-aadconnect-topologies/LegendAD2.png) |
| Serwer synchronizacji programu Azure AD Connect |![Serwer synchronizacji programu Azure AD Connect](./media/active-directory-aadconnect-topologies/LegendSync1.png) |
| Usługa Azure AD Connect serwer synchronizacji "staging tryb" |![Usługa Azure AD Connect serwer synchronizacji "staging tryb"](./media/active-directory-aadconnect-topologies/LegendSync2.png) |
| GALSync za pomocą programu Forefront Identity Manager (FIM) 2010 lub Microsoft Identity Manager (MIM) 2016 |![GALSync za pomocą programu FIM 2010 lub programu MIM 2016](./media/active-directory-aadconnect-topologies/LegendSync3.png) |
| Serwer synchronizacji programu Azure AD Connect, szczegółowe |![Serwer synchronizacji programu Azure AD Connect, szczegółowe](./media/active-directory-aadconnect-topologies/LegendSync4.png) |
...
![Nieobsługiwana filtrowane topologia przypadku pojedynczego lasu](./media/active-directory-aadconnect-topologies/SingleForestFilteredUnsupported.png)
...
Można znaleźć więcej szczegółów w [opis konfiguracji domyślnej](active-directory-aadconnectsync-understanding-default-configuration.md).
...
![Nieobsługiwana topologii dla wielu lasów i wielu serwerów synchronizacji](./media/active-directory-aadconnect-topologies/MultiForestMultiSyncUnsupported.png)
...
![Opcja do reprezentowania tylko raz użytkowników we wszystkich katalogach](./media/active-directory-aadconnect-topologies/MultiForestUsersOnce.png)

![Sceny wiele lasów i oddzielne topologie](./media/active-directory-aadconnect-topologies/MultiForestSeperateTopologies.png)
...
![Opcji korzystania z funkcji atrybut poczty do dopasowania, gdy tożsamości użytkowników istnieją w wielu katalogach](./media/active-directory-aadconnect-topologies/MultiForestUsersMail.png)
...
![Opcji korzystania z funkcji atrybuty ObjectSID i msExchMasterAccountSID do dopasowania, gdy tożsamości istnieje między wieloma katalogami](./media/active-directory-aadconnect-topologies/MultiForestUsersObjectSID.png)

![Topologią lasu kont zasobów dla wielu lasów](./media/active-directory-aadconnect-topologies/MultiForestAccountResource.png)
...
Jeśli masz większych organizacji, a następnie należy wziąć pod uwagę do użycia [Office 365 PreferredDataLocation](active-directory-aadconnectsync-feature-preferreddatalocation.md) funkcji. Dzięki temu można zdefiniować w regionie centrum danych, które znajdują się zasoby użytkownika.

## <a name="staging-server"></a>Serwer przejściowy
![Serwer przejściowy w topologii](./media/active-directory-aadconnect-topologies/MultiForestStaging.png)
...
![Topologia wiele lasów i wielu dzierżaw](./media/active-directory-aadconnect-topologies/MultiForestMultiDirectory.png)
...
![Nieobsługiwana topologii dla jednego lasu i wielu dzierżaw](./media/active-directory-aadconnect-topologies/SingleForestMultiDirectoryUnsupported.png) ![Nieobsługiwana topologii dla jednego lasu i obsługę wielu łączników](./media/active-directory-aadconnect-topologies/SingleForestMultiConnectorsUnsupported.png)
...
![Nieobsługiwana topologii dla wielu lasów i wiele katalogów przy użyciu usługi GALSync, skupiając się na usłudze Azure AD](./media/active-directory-aadconnect-topologies/MultiForestMultiDirectoryGALSync1Unsupported.png) ![Nieobsługiwana topologii dla wielu lasów i wiele katalogów przy użyciu usługi GALSync, koncentrując się na lokalnej usługi Active Directory](./media/active-directory-aadconnect-topologies/MultiForestMultiDirectoryGALSync2Unsupported.png)
...
![GALSync w topologii dla wielu lasów i wieloma katalogami](./media/active-directory-aadconnect-topologies/MultiForestMultiDirectoryGALSync.png)
...
Aby dowiedzieć się, jak zainstalować program Azure AD Connect dla tych scenariuszy, zobacz [instalację niestandardową programu Azure AD Connect](active-directory-aadconnect-get-started-custom.md).

Dowiedz się więcej o [synchronizacji programu Azure AD Connect](active-directory-aadconnectsync-whatis.md) konfiguracji.
