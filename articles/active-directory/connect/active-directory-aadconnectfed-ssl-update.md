...
![Aktualizacja zadania protokołu SSL](./media/active-directory-aadconnectfed-ssl-update/updatessltask.png)
...
![Serwer w trybie offline na liście](./media/active-directory-aadconnectfed-ssl-update/offlineserverlist.png)
...
- [Zarządzania w usłudze Active Directory Federation Services i dostosowywania za pomocą usługi Azure AD Connect](active-directory-aadconnect-federation-management.md)
