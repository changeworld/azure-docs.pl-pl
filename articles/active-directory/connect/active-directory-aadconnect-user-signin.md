...
* [Synchronizacja skrótów haseł](#password-hash-synchronization) z [bezproblemowego logowania jednokrotnego (SSO)](active-directory-aadconnect-sso.md)
* [Uwierzytelnianie przekazywane](active-directory-aadconnect-pass-through-authentication.md) z [bezproblemowego logowania jednokrotnego (SSO)](active-directory-aadconnect-sso.md)
...
Ponadto, aby umożliwić [bezproblemowe logowanie Jednokrotne](active-directory-aadconnect-sso.md) dla użytkowników na komputerach przyłączonych do domeny, znajdujących się w sieci firmowej. Za pomocą logowania jednokrotnego włączonych użytkowników wystarczy wprowadzić nazwę użytkownika, aby pomóc im bezpiecznego dostępu do zasobów w chmurze.

![Synchronizacja skrótów haseł](./media/active-directory-aadconnect-user-signin/passwordhash.png)

Aby uzyskać więcej informacji, zobacz [synchronizacji skrótów haseł](active-directory-aadconnectsync-implement-password-hash-synchronization.md) artykułu.
...
![Uwierzytelnianie przekazywane](./media/active-directory-aadconnect-user-signin/pta.png)
...
<center>![Federacja z usługami AD FS w systemie Windows Server 2012 R2](./media/active-directory-aadconnect-user-signin/federatedsignin.png)</center>
...
Aby uzyskać więcej informacji, zobacz [Konfigurowanie logowania jednokrotnego z usługami AD FS](active-directory-aadconnect-get-started-custom.md#configuring-federation-with-ad-fs).
...
Aby uzyskać informacje na temat konfigurowania usługi Azure AD Connect przy użyciu serwera PingFederate, zobacz [instalacji niestandardowej usługi Azure AD Connect](active-directory-aadconnect-get-started-custom.md#configuring-federation-with-pingfederate)
...
![Strona logowania usługi AD systemu Azure](./media/active-directory-aadconnect-user-signin/custom_azure_sign_in.png)
...
- Dowiedz się więcej o [pojęć dotyczących projektowania usługi Azure AD Connect](active-directory-aadconnect-design-concepts.md).
