...
4. W polu wyszukiwania wpisz **sieci Skyhigh**, wybierz pozycję **sieci Skyhigh** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![Skyhigh sieci na liście wyników](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_addfromgallery.png)
...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Okno dialogowe rejestracji jednokrotnej](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_samlbase.png)

3. Na **Skyhigh sieci domeny i adres URL** sekcji, wykonaj następujące kroki, aby skonfigurować aplikację w **IDP** inicjowane tryb:

    ![Adresy URL i domen sieci Skyhigh pojedynczy informacje logowania jednokrotnego](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_url.png)
...
4. Sprawdź **Pokaż zaawansowane ustawienia adresu URL** i wykonać następujący krok, jeśli chcesz skonfigurować aplikację w **SP** inicjowane tryb:
    ...
    ![Adresy URL i domen sieci Skyhigh pojedynczy informacje logowania jednokrotnego](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_url1.png)
...
5. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Base64)** , a następnie zapisz plik certyfikatu na tym komputerze.
    ...
    ![Łącze pobierania certyfikatu](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_certificate.png) 

6. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_general_400.png)
...
7. Na **konfiguracji sieci Skyhigh** , kliknij przycisk **Konfigurowanie sieci Skyhigh** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfiguracja sieci Skyhigh](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_configure.png) 
...
1. W portalu Azure, w okienku po lewej stronie kliknij **usługi Azure Active Directory** przycisku.
    ...
    ![Przycisk usługi Azure Active Directory](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_01.png)

2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.

    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_02.png)

3. Aby otworzyć **użytkownika** okno dialogowe, kliknij przycisk **Dodaj** w górnej części **wszyscy użytkownicy** okno dialogowe.

    ![Przycisk Dodaj](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_03.png)

4. W **użytkownika** okna dialogowego wykonaj następujące czynności:

    ![Okno dialogowe użytkownika](./media/active-directory-saas-skyhighnetworks-tutorial/create_aaduser_04.png)
...
2. Na liście aplikacji zaznacz **sieci Skyhigh**.
    ...
    ![Link sieci Skyhigh na liście aplikacji](./media/active-directory-saas-skyhighnetworks-tutorial/tutorial_skyhighnetworks_app.png)  
