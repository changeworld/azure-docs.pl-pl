...
### <a name="new-riskdetections-api-for-microsoft-graph-public-preview"></a>RiskDetections nowego interfejsu API dla programu Microsoft Graph (publiczna wersja zapoznawcza)

**Typ:** Nowa funkcja  
**Kategoria usług:** Identity Protection  
**Możliwości produktu:** Ochrona i zabezpieczanie tożsamości

Cieszymy się, mogąc riskDetections nowego interfejsu API dla programu Microsoft Graph jest teraz w publicznej wersji zapoznawczej. Ten nowy interfejs API można użyć, aby wyświetlić listę użytkowników dotyczące ochrony tożsamości i wykrywanie ryzyka logowania Twojej organizacji. Ten interfejs API umożliwia również bardziej wydajnego wykonywania zapytań o usługi Wykrywanie ryzyka, w tym szczegółowe informacje o typie wykrywania, stan, poziom i.

Aby uzyskać więcej informacji, zobacz [ryzyka wykrywania dokumentacji interfejsu API](https://docs.microsoft.com/graph/api/resources/riskdetection?view=graph-rest-beta).
...
W czerwcu 2019 r Dodaliśmy obsługę tych 22 nowe aplikacje z Federacją w galerii aplikacji:

[Zestaw narzędzi Azure AD SAML](https://docs.microsoft.com/azure/active-directory/saas-apps/saml-toolkit-tutorial), [Otsuka Shokai (大塚商会)](https://docs.microsoft.com/azure/active-directory/saas-apps/otsuka-shokai-tutorial), [ANAQUA](https://docs.microsoft.com/azure/active-directory/saas-apps/anaqua-tutorial), [klienta sieci VPN platformy Azure](https://portal.azure.com/), [ExpenseIn](https://docs.microsoft.com/azure/active-directory/saas-apps/expensein-tutorial), [ Pomocnik Pomocnika](https://docs.microsoft.com/azure/active-directory/saas-apps/helper-helper-tutorial), [Costpoint](https://docs.microsoft.com/azure/active-directory/saas-apps/costpoint-tutorial), [GlobalOne](https://docs.microsoft.com/azure/active-directory/saas-apps/globalone-tutorial), [Office Mercedes Benz w samochodzie](https://me.secure.mercedes-benz.com/), [Skore](https://app.justskore.it/), [ Oracle chmurze infrastruktury konsoli](https://docs.microsoft.com/azure/active-directory/saas-apps/oracle-cloud-tutorial), [uwierzytelnianie CyberArk SAML](https://docs.microsoft.com/azure/active-directory/saas-apps/cyberark-saml-authentication-tutorial), [Scrible Edu](https://www.scrible.com/sign-in/#/create-account), [PandaDoc](https://docs.microsoft.com/azure/active-directory/saas-apps/pandadoc-tutorial), [Perceptyx ](https://apexdata.azurewebsites.net/docs.microsoft.com/azure/active-directory/saas-apps/perceptyx-tutorial), [Proptimise OS](https://proptimise.co.uk/software/), [Vtiger CRM (SAML)](https://docs.microsoft.com/azure/active-directory/saas-apps/vtiger-crm-saml-tutorial), Menedżer dostępu do oprogramowania Oracle dla handlu detalicznego Oracle promocji i Menedżer dostępu do oprogramowania Oracle, Oracle E-Business Suite, Oracle IDCS dla E-Business Suite, Oracle IDCS dla PeopleSoft, Oracle IDCS dla rozwiązań JD Edwards
...
### <a name="automate-user-account-provisioning-for-these-newly-supported-saas-apps"></a>Zautomatyzuj obsługę konta użytkowników dla tych nowo obsługiwanych aplikacji SaaS
...
- [Usługa envoy](https://docs.microsoft.com/azure/active-directory/saas-apps/envoy-provisioning-tutorial)

- [Proxyclick](https://docs.microsoft.com/azure/active-directory/saas-apps/proxyclick-provisioning-tutorial)

- [4me](https://docs.microsoft.com/azure/active-directory/saas-apps/4me-provisioning-tutorial)

Aby uzyskać więcej informacji na temat lepiej zabezpieczyć Twoją organizację przy użyciu Inicjowanie obsługi administracyjnej konta użytkownika automatycznych, zobacz [automatyczne Inicjowanie obsługi użytkowników do aplikacji SaaS z usługą Azure AD](https://docs.microsoft.com/azure/active-directory/manage-apps/user-provisioning)

---

### <a name="view-the-real-time-progress-of-the-azure-ad-provisioning-service"></a>Wyświetl postęp w czasie rzeczywistym usługi aprowizacji usługi Azure AD
...
Zaktualizowaliśmy programu Azure AD aprowizacji obejmują nowy pasek postępu, który pokazuje, jak daleko jest przez niego użytkownika, w procesie inicjowania obsługi. To zaktualizowane środowisko także informacje o liczbie użytkowników wykorzystanych podczas bieżącego cyklu oraz jak wielu użytkowników zostały udostępnione do daty.

Aby uzyskać więcej informacji, zobacz [Sprawdź stan aprowizacji użytkowników](https://docs.microsoft.com/azure/active-directory/manage-apps/application-provisioning-when-will-provisioning-finish-specific-user).

---

### <a name="company-branding-now-appears-on-sign-out-and-error-screens"></a>Teraz oznaczanie marką firmy pojawi się w Wyloguj się i ekrany błąd

**Typ:** Zmieniona funkcja  
**Kategoria usług:** Uwierzytelnienia (logowania)  
**Możliwości produktu:** Uwierzytelnianie użytkowników

Zaktualizowaliśmy usługi Azure AD, aby teraz oznaczenie marką firmy pojawia się w Wyloguj się i ekrany błąd, a także stronę logowania. Nie trzeba nic robić, aby włączyć tę funkcję, usługa Azure AD po prostu używa zasoby zostały już skonfigurowane w **marką firmy** obszaru w witrynie Azure Portal.

Aby uzyskać więcej informacji o konfigurowaniu logo Twojej firmy, zobacz [dodawać oznaczenia marki do strony usługi Azure Active Directory w Twojej organizacji](https://docs.microsoft.com/azure/active-directory/fundamentals/customize-branding).

---

### <a name="azure-multi-factor-authentication-mfa-server-is-no-longer-available-for-new-deployments"></a>Serwer Azure Multi-Factor Authentication (MFA) nie jest już dostępna w przypadku nowych wdrożeń.

**Typ:** Przestarzałe  
**Kategoria usług:** UWIERZYTELNIANIE WIELOSKŁADNIKOWE  
**Możliwości produktu:** Ochrona i zabezpieczanie tożsamości

Począwszy od 1 lipca 2019 firma Microsoft będzie oferować już serwer MFA w przypadku nowych wdrożeń. Nowi klienci, którzy chcą wymagać stosowania uwierzytelniania wieloskładnikowego w organizacji muszą teraz używać oparte na chmurze usługi Azure Multi-Factor Authentication. Klientów, którzy aktywowali usługę MFA Server przed 1 lipca zobaczą zmiany. Nadal będzie można pobrać najnowszą wersję, Pobierz przyszłe aktualizacje oraz Generuj poświadczenia aktywacji.

Aby uzyskać więcej informacji, zobacz [wprowadzenie do usługi Azure Multi-Factor Authentication](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfaserver-deploy). Aby uzyskać więcej informacji na temat oparte na chmurze usługi Azure Multi-Factor Authentication, zobacz [Planowanie wdrożenia usługi Azure Multi-Factor Authentication oparte na chmurze](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-getstarted).
