...
Aby uzyskać dostęp do danych logowania, zamiast witryny Azure Portal można również użyć [interfejsu API raportowania](concept-reporting-api.md).
...
Więcej informacji można znaleźć w temacie [Raporty dotyczące logowań w portalu usługi Azure Active Directory](concept-sign-ins.md).
