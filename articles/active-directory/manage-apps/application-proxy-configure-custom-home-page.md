...
1. Wybierz **usługi Azure Active Directory**, a następnie **rejestracje aplikacji**. Zostanie wyświetlona lista zarejestrowanych aplikacji.
1. Wybierz aplikację z listy. Zostanie wyświetlona strona przedstawiający szczegółowe informacje o zarejestrowanych aplikacji.
1. W obszarze **Zarządzaj**, wybierz opcję **znakowania**.
1. Aktualizacja **adres URL strony głównej** z Twojej nowej ścieżki.
...
1. Znajdź wartość identyfikator obiektu aplikacji.
...
1. Podczas instalacji należy wybrać **Y** zainstalować dwa pakiety z witryny Nuget.org. Wymagane są oba pakiety.
...
1. Znajdź aplikację. W tym przykładzie użyto programu PowerShell, aby znaleźć identyfikator obiektu, wyszukując aplikacji z nazwą wyświetlaną `SharePoint`.
...
1. Czy na pewno masz poprawną aplikacją, uruchamiając następujące polecenie. Dane wyjściowe powinny być identyczne z danych wyjściowych widoczny w poprzedniej sekcji ([znaleźć identyfikator obiektu aplikacji](#find-the-objectid-of-the-app)).
...
1. Należy je na stronie głównej.

   ```powershell
   Set-AzureADApplication -ObjectId $objguid -Homepage $homepage
   ```

1. Aby sprawdzić, czy zmiana zakończyła się pomyślnie, ponownie uruchom następujące polecenie z kroku 2.
...
1. Uruchom ponownie aplikację, aby sprawdzić, czy strona główna ma być wyświetlany jako pierwszy ekran, zgodnie z oczekiwaniami.
