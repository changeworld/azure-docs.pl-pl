...
4. Aktualizacja **adres URL strony głównej** pole z nowej ścieżki. 
   ...
   ![Podaj adres URL nowej strony głównej](./media/application-proxy-configure-custom-home-page/homepage.png)
...
- [Włącz serwer Proxy aplikacji w portalu Azure](application-proxy-enable.md)
