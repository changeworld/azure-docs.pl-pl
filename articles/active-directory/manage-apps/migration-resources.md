...
Zasoby pomagające w migracji do usługi Azure Active Directory (Azure AD) dostęp do aplikacji i uwierzytelniania. 
...
| [Narzędzie: Usługi Active Directory Federation usług migracji gotowości skryptu](https://aka.ms/migrateapps/adfsscript) | To jest skrypt można uruchomić na serwerze usługi Active Directory Federation Services (AD FS) w środowisku lokalnym w celu określenia gotowości aplikacji pod kątem migracji do usługi Azure AD.|
