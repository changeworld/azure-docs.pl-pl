...
![Aplikacje połączone bezpośrednio w środowisku lokalnym](media/migrate-adfs-apps-to-azure/migrate1.png)
...
![Wyświetla listę atrybutów, które możesz wysłać jako oświadczenia](media/migrate-adfs-apps-to-azure/migrate4.png)

Wybierz wiersz konkretnego atrybutu, aby go edytować, lub wybierz pozycję **Dodaj atrybut**, aby dodać nowy atrybut.

![Przedstawia okienko "Edytowanie atrybutu"](media/migrate-adfs-apps-to-azure/migrate5.png)
...
![Przedstawia okienko "Dodawanie przypisania"](media/migrate-adfs-apps-to-azure/migrate7.png)
