...
![Ograniczenia ruchu dzierżawy — diagram](./media/tenant-restrictions/traffic-flow.png)
...
![Strona dla użytkowników w dzierżaw z systemem innym niż dozwolone odmowa dostępu](./media/tenant-restrictions/end-user-denied.png)
...
![Użyj portalu Azure, aby wyświetlić ograniczeniami prób logowania](./media/tenant-restrictions/portal-report.png)
