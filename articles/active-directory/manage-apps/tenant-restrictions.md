...
Przykładowy użytkownik znajduje się w sieci firmy Contoso, ale próbuje uzyskać dostęp Fabrikam wystąpienie udostępnione aplikacji SaaS takich jak program Outlook online. Jeśli firma Contoso ma dzierżawy nie jest dozwolone dla tego wystąpienia, użytkownik zobaczy następujące strony:
...
Dla programu Outlook, Windows klientów może zadecydować o stosowaniu ograniczenia uniemożliwia użytkownikom dodawanie kont pocztowych niezatwierdzonych do ich profile. Na przykład zobacz [Zapobiegaj dodawanie kont innych niż domyślne Exchange konta](http://gpsearch.azurewebsites.net/default.aspx?ref=1) ustawienie zasad grupy.
...
1.  [Pobierz i zainstaluj program Fiddler](http://www.telerik.com/fiddler).
2.  Konfigurowanie narzędzia Fiddler do odszyfrowywania ruchu HTTPS na [dokumentacji pomocy w narzędziu Fiddler](http://docs.telerik.com/fiddler/Configure-Fiddler/Tasks/DecryptHTTPS).
