...
|8 | Zobacz dodatkową pomoc dotyczącą rozwiązywania problemów | Jeśli problemy będą nadal występować, Znajdź dodatkowe artykuły dotyczące rozwiązywania problemów w [dokumentacji rozwiązywania problemów z serwerem proxy aplikacji](application-proxy-page-appearance-broken-problem.md). |
