...
1. Wybierz **logowanie jednokrotne**.
   ...
   ![Wybierz opcję jednokrotne logowanie ze strony Przegląd aplikacji](./media/application-proxy-configure-single-sign-on-password-vaulting/select-sso.png)
