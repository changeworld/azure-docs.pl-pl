---
title: Przykład programu PowerShell — aplikacje proxy aplikacji przy użyciu domeny domyślnej
description: Przykład programu PowerShell zawierający listę wszystkich aplikacji proxy aplikacji usługi Azure Active Directory (Azure AD), które używają domen domyślnych (msappproxy.net).
...
---
# <a name="get-all-application-proxy-apps-using-default-domains-msappproxynet"></a>Pobierz wszystkie aplikacje proxy aplikacji przy użyciu domen domyślnych (msappproxy.net)

W tym przykładzie skryptu programu PowerShell wymieniono wszystkie aplikacje proxy aplikacji usługi Azure Active Directory (Azure AD), które używają domen domyślnych (msappproxy.net).
