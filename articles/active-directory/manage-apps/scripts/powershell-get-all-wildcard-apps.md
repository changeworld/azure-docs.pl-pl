---
title: Przykład programu PowerShell — lista aplikacji proxy aplikacji przy użyciu symboli wieloznacznych
description: Przykład programu PowerShell zawierający listę wszystkich aplikacji proxy aplikacji usługi Azure Active Directory (Azure AD), które używają symboli wieloznacznych.
...
---
# <a name="get-all-application-proxy-apps-using-wildcard-publishing"></a>Pobierz wszystkie aplikacje proxy aplikacji przy użyciu publikowania symboli wieloznacznych

W tym przykładzie skryptu programu PowerShell wymieniono wszystkie aplikacje proxy aplikacji usługi Azure Active Directory (Azure AD), które używają publikowania symboli wieloznacznych.
