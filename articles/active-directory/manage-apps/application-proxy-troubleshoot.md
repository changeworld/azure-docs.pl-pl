...
| Tej aplikacji firmowych nie jest dostępny w tej chwili. Spróbuj ponownie później... Upłynął limit czasu łącznika. | Błąd ten może wystąpić użytkowników, podczas próby dostępu do aplikacji, opublikowane, jeśli nie zostały prawidłowo określone dla tej aplikacji na stronie lokalnie. Upewnij się, czy użytkownicy mają odpowiednie uprawnienia, zgodnie z definicją dla tej aplikacji wewnętrznej bazy danych na komputerze lokalnym. |
