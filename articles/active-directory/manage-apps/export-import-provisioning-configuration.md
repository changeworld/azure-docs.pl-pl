...
## <a name="step-3-retrieve-the-provisioning-job-id-of-the-provisioning-app"></a>Krok 3: Pobierz identyfikator zadania aprowizacji dla aplikacji aprowizacji
...
## <a name="step-4-download-the-provisioning-schema"></a>Krok 4: Pobierz schemat aprowizacji
...
Na karcie "nagłówki żądań" Dodaj atrybut nagłówka Content-Type z wartością "Application/JSON"
   ...
   [![Nagłówki żądań](./media/export-import-provisioning-mappings/wd_export_05.png)](./media/export-import-provisioning-mappings/wd_export_05.png#lightbox)
