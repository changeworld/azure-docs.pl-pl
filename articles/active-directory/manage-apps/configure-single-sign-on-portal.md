...
![Blok aplikacje dla przedsiębiorstw](./media/configure-single-sign-on-portal/enterprise-apps-blade.png)
...
Aby uzyskać więcej informacji na temat trybów, zobacz [jak logowanie jednokrotne z usługą Azure Active Directory](what-is-single-sign-on.md#how-does-single-sign-on-with-azure-active-directory-work).
...
![Osadzony dokumentów](./media/configure-single-sign-on-portal/enterprise-apps-blade-embedded-docs.png)
