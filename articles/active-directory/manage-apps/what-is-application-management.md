...
Aby rozpocząć Integrowanie aplikacji z usługą Azure AD, Przyjrzyjmy się [przewodnik Wprowadzenie do integracji Azure Active Directory z aplikacjami pobierania](plan-an-application-integration.md).
