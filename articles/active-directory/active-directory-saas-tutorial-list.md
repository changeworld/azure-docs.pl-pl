---
title: SaaS samouczków integracji aplikacji do użycia z usługą Azure AD | Dokumentacja firmy Microsoft
...
Aby zintegrować z włączoną obsługę chmury [(SaaS)](https://azure.microsoft.com/overview/what-is-saas/) aplikacji za pomocą usługi Azure Active Directory, opracowaliśmy kolekcji samouczków, które umożliwia przeprowadzenie konfiguracji.

Gdzie mamy wskazówki inicjowania obsługi administracyjnej użytkowników, firma Microsoft uwzględniła samouczek aplikacji użytkownika alokacji w prawej kolumnie obok samouczek aplikacji.

Aby uzyskać pełną listę aplikacji SaaS, które zostały wstępnie zintegrowanych z usługą Azure AD, zobacz [Active Directory Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/category/azure-active-directory-apps).
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adaptivesuite-tutorial.png)| [Adaptacyjną Insights](active-directory-saas-adaptivesuite-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobe-creative-cloud-tutorial.png)| [Adobe Creative chmury](active-directory-saas-adobe-creative-cloud-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobeexperiencemanager-tutorial.png)| [Menedżer obsługi Adobe](active-directory-saas-adobeexperiencemanager-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobe-echosign-tutorial.png)| [Adobe logowania](active-directory-saas-adobe-echosign-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-alcumus-info-tutorial.png)| [Informacje o Alcumus programu Exchange](active-directory-saas-alcumus-info-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Usług Amazon Web Services (AWS)](active-directory-saas-amazon-web-service-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-aws-multi-accounts-tutorial.png)| [Usługi sieci Web firmy Amazon (AWS) można połączyć wiele kont](active-directory-saas-aws-multi-accounts-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-amplitude-tutorial.png)| [Amplitudy](active-directory-saas-amplitude-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-apexportal-tutorial.png)| [Portal wierzchołku](active-directory-saas-apexportal-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-assetbank-tutorial.png)| [Bank zasobów](active-directory-saas-assetbank-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-atomiclearning-tutorial.png)| [Niepodzielne Learning](active-directory-saas-atomiclearning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-attendancemanagementservices-tutorial.png)| [Obecności usługi zarządzania](active-directory-saas-attendancemanagementservices-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-autotaskworkplace-tutorial.png)| [Autotask w miejscu pracy](active-directory-saas-autotaskworkplace-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bambubysproutsocial-tutorial.png)| [Bambu przez społecznego główką](active-directory-saas-bambubysproutsocial-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bcinthecloud-tutorial.png)| [BC w chmurze](active-directory-saas-bcinthecloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-blackboard-learn-tutorial.png)| [Tablica Dowiedz się więcej.](active-directory-saas-blackboard-learn-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-blackboard-learn-shibboleth-tutorial.png)| [Tablica informacji - Shibboleth](active-directory-saas-blackboard-learn-shibboleth-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bluejeans-tutorial.png)| [BlueJeans](active-directory-saas-bluejeans-tutorial.md)|[BlueJeans — Inicjowanie obsługi użytkowników](active-directory-saas-bluejeans-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-central-desktop-tutorial.png)| [Centralna pulpitu](active-directory-saas-central-desktop-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cernercentral-tutorial.png)| [Cerner środkowe](active-directory-saas-cernercentral-tutorial.md)|[Środkowe Cerner — Inicjowanie obsługi użytkowników](active-directory-saas-cernercentral-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-ciscocloud-tutorial.png)| [Chmura firmy Cisco](active-directory-saas-ciscocloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-clarizen-tutorial.png)| [Clarizen](active-directory-saas-clarizen-tutorial.md)|[Clarizen — Inicjowanie obsługi użytkowników](active-directory-saas-clarizen-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-clearreview-tutorial.png)| [Wyczyść przeglądu](active-directory-saas-clearreview-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-newsignature-tutorial.png)| [Chmura portalu zarządzania Microsoft Azure](active-directory-saas-newsignature-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cornerstone-ondemand-tutorial.png)| [Podstawy na żądanie](active-directory-saas-cornerstone-ondemand-tutorial.md)|[Podstawy OnDemand - Inicjowanie obsługi użytkowników](active-directory-saas-cornerstone-ondemand-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cs-stars-tutorial.png)| [CS gwiazdek](active-directory-saas-cs-stars-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-deputy-tutorial.png)| [Zastępcy](active-directory-saas-deputy-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-directions-microsoft-tutorial.png)| [Instrukcje w systemie Microsoft](active-directory-saas-directions-microsoft-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dome9arc-tutorial.png)| [Dome9 łuk](active-directory-saas-dome9arc-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dowjones-factiva-tutorial.png)| [Factiva Nowak knie](active-directory-saas-dowjones-factiva-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dropboxforbusiness-tutorial.png)| [Dropbox dla firm](active-directory-saas-dropboxforbusiness-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dynamicsignal-tutorial.png)| [Dynamiczne sygnału](active-directory-saas-dynamicsignal-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-efidigitalstorefront-tutorial.png)| [EFI cyfrowe sklepu](active-directory-saas-efidigitalstorefront-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-fidelitynetbenefits-tutorial.png)| [NetBenefits wierności](active-directory-saas-fidelitynetbenefits-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-flock-tutorial.png)| [Stada](active-directory-saas-flock-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-fluxxlabs-tutorial.png)| [Laboratoria Fluxx](active-directory-saas-fluxxlabs-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-foreseecxsuite-tutorial.png)| [Przewidują CX Suite](active-directory-saas-foreseecxsuite-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Pakiet G](active-directory-saas-google-apps-tutorial.md)|[G Suite — Inicjowanie obsługi użytkowników](active-directory-saas-google-apps-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-github-tutorial.png)| [GitHub](active-directory-saas-github-tutorial.md)|[GitHub — Inicjowanie obsługi użytkowników](active-directory-saas-github-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-citrix-gotomeeting-tutorial.png)| [GoToMeeting](active-directory-saas-citrix-gotomeeting-tutorial.md)|[GoToMeeting — Inicjowanie obsługi użytkowników](active-directory-saas-citrixgotomeeting-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-halogen-software-tutorial.png)| [Chlorowców oprogramowania](active-directory-saas-halogen-software-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-helpscout-tutorial.png)| [Scout pomocy](active-directory-saas-helpscout-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-impacriskmanager-tutorial.png)| [Menedżer ryzyka IMPAC](active-directory-saas-impacriskmanager-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-infogix-tutorial.png)| [Decydować Infogix Data3Sixty](active-directory-saas-infogix-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-landgorilla-tutorial.png)| [Ziemi Gorilla klienta](active-directory-saas-landgorilla-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-learning-at-work-tutorial.png)| [Learning w miejscu pracy](active-directory-saas-learning-at-work-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-learningseatlms-tutorial.png)| [Learning stanowisko LMS](active-directory-saas-learningseatlms-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-linkedinsalesnavigator-tutorial.png)| [Nawigator sprzedaży LinkedIn](active-directory-saas-linkedinsalesnavigator-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-netsuite-tutorial.png)| [Netsuite](active-directory-saas-netsuite-tutorial.md)|[Netsuite — Inicjowanie obsługi użytkowników](active-directory-saas-netsuite-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-orgchartnow-tutorial.png)| [Teraz schematu organizacyjnego](active-directory-saas-orgchartnow-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-pegasystems-tutorial.png)| [Systemy Pega](active-directory-saas-pegasystems-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictix-assortment-planning-tutorial.png)| [Planowanie wybór Predictix](active-directory-saas-predictix-assortment-planning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictixpricereporting-tutorial.png)| [Cena Predictix raportowania](active-directory-saas-predictixpricereporting-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-procoresso-tutorial.png)| [Procore logowania jednokrotnego](active-directory-saas-procoresso-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-qumucloud-tutorial.png)| [Qumu chmury](active-directory-saas-qumucloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-replicon-tutorial.png)| [Replicon](active-directory-saas-replicon-tutorial.md)|[Replicon — Inicjowanie obsługi użytkowników](active-directory-saas-replicon-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-rollbar-tutorial.png)| [Pałąka zabezpieczającego](active-directory-saas-rollbar-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-tutorial.png)| [Salesforce](active-directory-saas-salesforce-tutorial.md)|[SalesForce — Inicjowanie obsługi użytkowników](active-directory-saas-salesforce-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-sandbox-tutorial.png)| [Piaskownica usług SalesForce](active-directory-saas-salesforce-sandbox-tutorial.md)|[Piaskownica SalesForce — Inicjowanie obsługi użytkowników](active-directory-saas-salesforce-sandbox-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bamboo-tutorial.png)| [Logowania jednokrotnego SAML dla Bambus przez rozpoznawania GmbH](active-directory-saas-bamboo-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bitbucket-tutorial.png)| [Logowania jednokrotnego SAML dla Bitbucket przez rozpoznawania GmbH](active-directory-saas-bitbucket-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samlssoconfluence-tutorial.png)| [Logowania jednokrotnego SAML dla zlewiska przez rozpoznawania GmbH](active-directory-saas-samlssoconfluence-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samlssojira-tutorial.png)| [Logowania jednokrotnego SAML dla Jira przez rozpoznawania GmbH](active-directory-saas-samlssojira-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sapboc-tutorial.png)| [SAP Business obiektu chmury](active-directory-saas-sapboc-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-hana-cloud-platform-tutorial.png)| [Platforma chmury SAP](active-directory-saas-sap-hana-cloud-platform-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.png)| [Uwierzytelnianie tożsamości platformy chmury SAP](active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-secretserver-on-premises-tutorial.png)| [Tajny serwer (lokalnego)](active-directory-saas-secretserver-on-premises-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sharepoint-on-premises-tutorial.png)| [Programu SharePoint](active-directory-saas-sharepoint-on-premises-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.png)| [Splunk Enterprise i Splunk chmury](active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-trisotechdigitalenterpriseserver-tutorial.png)| [Cyfrowy Trisotech Enterprise Server](active-directory-saas-trisotechdigitalenterpriseserver-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-wizergosproductivitysoftware-tutorial.png)| [Oprogramowanie Wizergos](active-directory-saas-wizergosproductivitysoftware-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-xmatters-ondemand-tutorial.png)| [xMatters na żądanie](active-directory-saas-xmatters-ondemand-tutorial.md)|[xMatters OnDemand - Inicjowanie obsługi użytkowników](active-directory-saas-xmatters-ondemand-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-yardielearning-tutorial.png)| [Szkoleń elektronicznych Yardi](active-directory-saas-yardielearning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-zendesk-tutorial.png)| [Zendesk](active-directory-saas-zendesk-tutorial.md)|[Zendesk — Inicjowanie obsługi użytkowników](active-directory-saas-zendesk-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-zohoone-tutorial.png)| [Zoho co](active-directory-saas-zohoone-tutorial.md)|
