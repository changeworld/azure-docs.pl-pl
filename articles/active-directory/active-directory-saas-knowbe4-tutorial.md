...
4. W polu wyszukiwania wpisz **świadomości szkolenia w zakresie zabezpieczeń KnowBe4**, wybierz pozycję **świadomości szkolenia w zakresie zabezpieczeń KnowBe4** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikacja.

    ![Szkolenie świadomości bezpieczeństwa KnowBe4 na liście wyników](./media/active-directory-saas-knowbe4-tutorial/tutorial_knowbe4_addfromgallery.png)
...
3. **[Tworzenie użytkownika testowego świadomości szkolenia w zakresie zabezpieczeń KnowBe4](#create-a-knowbe4-security-awareness-training-test-user)**  — w celu zapewnienia odpowiednikiem Simona Britta KnowBe4 świadomości szkolenia w zakresie zabezpieczeń połączonego z usługi Azure AD reprezentację użytkownika.
...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Okno dialogowe rejestracji jednokrotnej](./media/active-directory-saas-knowbe4-tutorial/tutorial_knowbe4_samlbase.png)

3. Na **KnowBe4 zabezpieczeń świadomości szkolenia domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![Adresy URL i domeny szkolenia pogłębianie wiedzy na temat zabezpieczeń KnowBe4 pojedynczy informacje logowania jednokrotnego](./media/active-directory-saas-knowbe4-tutorial/tutorial_knowbe4_url.png)

    a. W **adres URL logowania** tekstowym, wpisz adres URL, używając następującego wzorca: `https://<companyname>.KnowBe4.com/auth/saml/<instancename>`

    > [!NOTE] 
    > Zaloguj się na wartość adresu URL nie jest prawdziwe. Zaktualizuj tę wartość przy rzeczywisty adres URL logowania. Skontaktuj się z [zespołem pomocy technicznej klienta szkolenia świadomości bezpieczeństwa KnowBe4](mailto:support@KnowBe4.com) aby zyskać tę wartość. 

    b. W **identyfikator** tekstowym, wpisz wartość ciągu: `KnowBe4`

    > [!NOTE]
    >To jest rozróżniana wielkość liter

4. Na **certyfikat podpisywania SAML** kliknij **certyfikatu (Raw)** , a następnie zapisz plik certyfikatu na tym komputerze.

    ![Łącze pobierania certyfikatu](./media/active-directory-saas-knowbe4-tutorial/tutorial_knowbe4_certificate.png) 

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media/active-directory-saas-knowbe4-tutorial/tutorial_general_400.png)
...
6. Na **konfiguracji szkolenia świadomości bezpieczeństwa KnowBe4** , kliknij przycisk **skonfigurować KnowBe4 świadomości szkolenia w zakresie zabezpieczeń** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **Sign-Out adres URL, identyfikator jednostki SAML i SAML pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfiguracja szkolenia pogłębianie wiedzy na temat zabezpieczeń KnowBe4](./media/active-directory-saas-knowbe4-tutorial/tutorial_knowbe4_configure.png) 
...
1. W portalu Azure, w okienku po lewej stronie kliknij **usługi Azure Active Directory** przycisku.
    ...
    ![Przycisk usługi Azure Active Directory](./media/active-directory-saas-knowbe4-tutorial/create_aaduser_01.png)

2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.

    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media/active-directory-saas-knowbe4-tutorial/create_aaduser_02.png)

3. Aby otworzyć **użytkownika** okno dialogowe, kliknij przycisk **Dodaj** w górnej części **wszyscy użytkownicy** okno dialogowe.

    ![Przycisk Dodaj](./media/active-directory-saas-knowbe4-tutorial/create_aaduser_03.png)

4. W **użytkownika** okna dialogowego wykonaj następujące czynności:

    ![Okno dialogowe użytkownika](./media/active-directory-saas-knowbe4-tutorial/create_aaduser_04.png)
...
### <a name="create-a-knowbe4-security-awareness-training-test-user"></a>Tworzenie użytkownika testowego świadomości szkolenia w zakresie zabezpieczeń KnowBe4
...
2. Na liście aplikacji zaznacz **świadomości szkolenia w zakresie zabezpieczeń KnowBe4**.
    ...
    ![Łącze świadomości szkolenia w zakresie zabezpieczeń KnowBe4 na liście aplikacji](./media/active-directory-saas-knowbe4-tutorial/tutorial_knowbe4_app.png)  
