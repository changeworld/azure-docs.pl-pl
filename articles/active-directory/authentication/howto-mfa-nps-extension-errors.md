---
title: Rozwiązywanie problemów z kodami błędów rozszerzenia serwera NPS dla usługi Azure MFA | Dokumentacja firmy Microsoft
...
Jeśli wystąpią błędy rozszerzenia serwera NPS dla usługi Azure Multi-Factor Authentication, należy użyć w tym artykule Aby szybciej dotrzeć do rozwiązania. 
...
| ---------- | ------------- | ----------------- |
| **OathCodeIncorrect** | Nieprawidłowy kod entered\OATH niepoprawny kod | Nie jest błąd, użytkownik wprowadził nieprawidłowy kod. | Użytkownik wprowadził nieprawidłowy kod. Niech spróbuje skorzystać z ponownie przez zażądanie nowego kodu lub zalogować się ponownie. | 
