...
| --- | --- | --- | --- |
| Microsoft Authenticator | Yes (maximum of 5) | Nie | Tak |
| Other authenticator app | Yes (maximum of 5) | Nie | Tak |
| Hardware token | Nie | Nie | Tak |
| Numer telefonu | Tak | Tak | Tak |
| Alternate phone | Tak | Tak | Tak |
| Office phone | Nie | Nie | Nie |
