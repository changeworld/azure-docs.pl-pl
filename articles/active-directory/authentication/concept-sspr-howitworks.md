...
| Number of methods required to reset | One | Dwa |
| :---: | :---: | :---: |
| Mobile app features available | Kod | Code or Notification |
...
| Number of methods registered | Number of methods required | Wynik |
| :---: | :---: | :---: |
