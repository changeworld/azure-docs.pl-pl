...
| **Metody uwierzytelniania** | Authentication methods required to register | Always 1 more than required for reset |
...
| **Customization** | Customize helpdesk link | Tak |
|   | Custom helpdesk email or URL | Support site or email address |
| **Integracja lokalna** | Write back passwords to on-premises AD | Tak |
|   | Allow users to unlock account without resetting password | Tak |
...
| Analiza biznesowa | Expected result |
| --- | --- |
