...
Dane te są dostępne za pośrednictwem [witryny Azure portal](https://portal.azure.com) i [interfejsu API raportowania](../active-directory-reporting-api-getting-started-azure-portal.md).
