---
title: Zarządzanie ustawieniami weryfikacji dwuetapowej — usługi Azure AD | Dokumentacja firmy Microsoft
...
**Aby przejść do strony weryfikacji dodatkowe zabezpieczenia**
...
Jeśli kliknięcie tego łącza nie działa, możesz również pobrać do **dodatkowej weryfikacji zabezpieczeń** strony, wykonując następujące czynności:
...
1. Na **dodatkowej weryfikacji zabezpieczeń** wybierz pole tekstowe z bieżący numer telefonu i edytować za pomocą nowy numer telefonu.  
2. Wybierz pozycję **Zapisz**.  
3. Ten numer telefonu jest liczbą, której korzystasz z preferowaną opcję weryfikacji, należy sprawdzić nowy numer, zanim będzie można go zapisać.  
