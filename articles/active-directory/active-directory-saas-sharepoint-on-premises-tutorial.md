...
4. W polu wyszukiwania wpisz **programu SharePoint**, wybierz pozycję **SharePoint lokalnymi** z panelu wyników kliknięcie **Dodaj** przycisk, aby dodać aplikację.
    ...
    ![SharePoint lokalnie na liście wyników](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_addfromgallery.png)
...
2. Na **logowanie jednokrotne** okno dialogowe, wybierz opcję **tryb** jako **na języku SAML logowania jednokrotnego** Aby włączyć logowanie jednokrotne.
    ...
    ![Okno dialogowe rejestracji jednokrotnej](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_samlbase.png)

3. Na **SharePoint lokalnej domeny i adres URL** sekcji, wykonaj następujące czynności:

    ![SharePoint lokalnej domeny i adres URL pojedynczego logowania jednokrotnego informacji](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_url1.png)
...
4. Na **certyfikat podpisywania SAML** kliknij **XML metadanych** , a następnie zapisz plik metadanych na komputerze z rozszerzeniem cer. Skopiuj i Wklej Pełna ścieżka pliku metadanych pobranych do Notatnika.
    ...
    ![Łącze pobierania certyfikatu](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_certificate.png)

5. Kliknij przycisk **zapisać** przycisku.

    ![Skonfiguruj przycisk pojedynczego logowania jednokrotnego Zapisz](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_general_400.png)
...
6. Na **SharePoint lokalnej konfiguracji** kliknij **Konfigurowanie programu SharePoint** otworzyć **Konfigurowanie logowania jednokrotnego** okna. Kopiuj **pojedynczy znak na adres URL usługi** z **sekcji krótkimi opisami.**
    ...
    ![Konfiguracja lokalnego programu SharePoint](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_configure.png)
...
8. **Konfigurowanie nowego dostawcę zaufanych tożsamości w SharePoint Server 2016**
    ...
    ![Konfigurowanie dostawcy uwierzytelniania](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig10-configauthprovider.png)
...
1. W portalu Azure, w okienku po lewej stronie kliknij **usługi Azure Active Directory** przycisku.
    ...
    ![Przycisk usługi Azure Active Directory](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_01.png)

2. Aby wyświetlić listę użytkowników, przejdź do **użytkowników i grup**, a następnie kliknij przycisk **wszyscy użytkownicy**.

    !["Użytkownicy i grupy" i "Wszyscy użytkownicy" łącza](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_02.png)

3. Aby otworzyć **użytkownika** okno dialogowe, kliknij przycisk **Dodaj** w górnej części **wszyscy użytkownicy** okno dialogowe.

    ![Przycisk Dodaj](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_03.png)

4. W **użytkownika** okna dialogowego wykonaj następujące czynności:

    ![Okno dialogowe użytkownika](./media\active-directory-saas-sharepoint-on-premises-tutorial/create_aaduser_04.png)
...
4. W zasadach dla aplikacji sieci Web, kliknij przycisk **Dodaj użytkowników**.
    ...
    ![Wyszukiwanie według ich oświadczenia nazwy użytkownika](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig11-searchbynameclaim.png)
...
9. W polu uprawnienia kliknij **Pełna kontrola**.
    ...
    ![Udzielanie uprawnień Pełna kontrola do oświadczenia użytkownika](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig12-grantfullcontrol.png)
...
![Wyniki wyszukiwania oświadczeń](./media\active-directory-saas-sharepoint-on-premises-tutorial/fig16-claimssearchresults.png)
...
2. Na liście aplikacji zaznacz **SharePoint lokalnymi**.
    ...
    ![Łącza programu SharePoint na liście aplikacji](./media\active-directory-saas-sharepoint-on-premises-tutorial/tutorial_sharepointonpremises_app.png)
