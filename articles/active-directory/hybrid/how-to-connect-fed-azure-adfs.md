...
![Projekt wdrożenia](./media/how-to-connect-fed-azure-adfs/deployment.png)
...
![Tworzenie sieci wirtualnej](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![Podsieć](./media/how-to-connect-fed-azure-adfs/deploynetwork2.png)

![Podsieć DMZ](./media/how-to-connect-fed-azure-adfs/deploynetwork3.png)
...
![Tworzenie sieciowej grupy zabezpieczeń](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![Inicjowanie sieciowej grupy zabezpieczeń](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![Konfigurowanie sieciowej grupy zabezpieczeń](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![Podsieci skojarzone z sieciową grupą zabezpieczeń](./media/how-to-connect-fed-azure-adfs/nsgconfigure2.png)
...
![Tworzenie kont magazynu](./media/how-to-connect-fed-azure-adfs/storageaccount1.png)
...
![Zestawy dostępności](./media/how-to-connect-fed-azure-adfs/availabilityset1.png)
...
![Wdrożone maszyny wirtualne](./media/how-to-connect-fed-azure-adfs/virtualmachinesdeployed_noadfs.png)
...
![Przeglądanie modułu równoważenia obciążenia](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![Wewnętrzny moduł równoważenia obciążenia](./media/how-to-connect-fed-azure-adfs/ilbdeployment1.png)
...
![Moduły równoważenia obciążenia po skonfigurowaniu wewnętrznego modułu równoważenia obciążenia](./media/how-to-connect-fed-azure-adfs/ilbdeployment2.png)
...
![Konfigurowanie puli zaplecza wewnętrznego modułu równoważenia obciążenia](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![Konfigurowanie sondy wewnętrznego modułu równoważenia obciążenia](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
![Konfigurowanie reguł wewnętrznego modułu równoważenia obciążenia](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![Moduł równoważenia obciążenia połączony z Internetem](./media/how-to-connect-fed-azure-adfs/elbdeployment1.png)

Wdrożony moduł pojawi się na liście modułów równoważenia obciążenia.

![Lista modułów równoważenia obciążenia](./media/how-to-connect-fed-azure-adfs/elbdeployment2.png)
...
![Konfigurowanie modułu równoważenia obciążenia połączonego z Internetem](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![Konfigurowanie modułu równoważenia obciążenia połączonego z Internetem (DNS)](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![Konfigurowanie puli zaplecza modułu równoważenia obciążenia połączonego z Internetem](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![Konfigurowanie sondy modułu równoważenia obciążenia połączonego z Internetem](./media/how-to-connect-fed-azure-adfs/elbdeployment6.png)
...
![Konfigurowanie reguł modułu równoważenia obciążenia połączonego z Internetem](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
![Reguły dostępu WEWN. (ruch przychodzący)](./media/how-to-connect-fed-azure-adfs/nsg_int.png)
...
![Reguły dostępu ZEWN. (ruch przychodzący)](./media/how-to-connect-fed-azure-adfs/nsg_dmz.png)
...
![Testowa strona logowania](./media/how-to-connect-fed-azure-adfs/test1.png)

Po pomyślnym zalogowaniu zostanie wyświetlony poniższy komunikat:

![Test zakończony powodzeniem](./media/how-to-connect-fed-azure-adfs/test2.png)
...
* [Konfigurowanie usług AD FS i zarządzanie nimi za pomocą programu Azure AD Connect](how-to-connect-fed-whatis.md)
