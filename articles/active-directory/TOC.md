...
#### [Moduł Azure AD PowerShell MSOnline (wersja 1)](active-directory-accessmanagement-groups-settings-cmdlets.md)
...
#### [Warunek lokalizacji](active-directory-conditional-access-locations.md)
