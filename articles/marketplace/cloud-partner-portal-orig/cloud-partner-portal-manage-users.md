---
title: Zarządzanie użytkownikami w portalu cloud partner
...
Cloud Partner Portal umożliwia dodawanie użytkowników opartej na rolach dostęp do oferty maszyny wirtualnej. Ułatwia zarządzanie dostępem i uprawnieniami, gdy wiele osób pracuje nad oferty.

Aby **dodawać użytkowników i przypisywać role** do opublikowania oferty, wykonaj następujące czynności:

<a name="step-1-to-add-users-and-assign-roles-click-the-users-tab-on-the-left-side-navigation-pane"></a>Krok 1. Aby dodać użytkowników i przypisywania ról, kliknij kartę użytkowników, w okienku nawigacji po lewej stronie.
--------------------------------------------------------------------------------------------

![Na karcie Użytkownicy](./media/cloud-partner-portal-how-to-manage-users/userstab.png)
...
Obecnie tylko właściciele będą mogli kartach wypłaty platformy Azure i klientami platformy Azure w szczegółowych informacji.
...
Jeśli potrzebujesz usunąć użytkownika, który został dodany, jest wszystko, co należy zrobić, wyszukiwanie poczty e-mail na karcie Użytkownicy, a następnie naciśnij przycisk Usuń po prawej stronie.
