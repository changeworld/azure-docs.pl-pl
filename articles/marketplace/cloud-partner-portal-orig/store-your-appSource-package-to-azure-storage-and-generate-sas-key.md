...
1.  Przejdź do <http://azure.microsoft.com> i Utwórz bezpłatne konto wersji próbnej lub rozliczane.

2.  Zaloguj się do [Portalu Azure](http://portal.azure.com/).
...
6.  Jeśli jeszcze tego nie zrobiono, Pobierz i zainstaluj program Microsoft [Eksploratora usługi Azure Storage](http://storageexplorer.com/).
