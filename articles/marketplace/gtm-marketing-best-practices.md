---
title: Usług go-To-Market — najlepsze rozwiązania marketingu | Azure
description: Usług go-To-Market — w tej sekcji opisano najlepsze rozwiązania w zakresie marketingu wydawcom portalu Azure Marketplace
...
ms.locfileid: "64938539"
---
# <a name="marketing-best-practices"></a>Najlepsze rozwiązania marketingowe

Publikowanie oferty w portalu marketplace jest tylko pierwszy krok. Ponadto musisz określić, jak zoptymalizować swoje listy do dysku dla maksymalnego wpływu. Dobra wiadomość jest taka, publikując listę w witrynie marketplace, Rozpoczęcie do odblokowania znaczące wspólnych działań na rynek (GTM) z firmą Microsoft.  Aby maksymalnie wykorzystać możliwości tej nowej inicjatywy GTM i naprawdę Rozwijaj swoją firmę, chcesz dołączyć z nową listę jako część istniejącej działania sprzedaży i marketingu.

Jakość oferty w portalu marketplace i zobowiązania skoncentrowanych na żądanie pomocy, aby wspomóc rozwój Twojej firmy. Swoje zaangażowanie w tych działaniach pomaga firmy Microsoft, aby wzmocnić służbowy GTM w celu rozwiązania kluczowych funkcji dla sklepów w portalu marketplace.

Po utworzeniu listy doskonałe następujących działań marketingowych pomogą rozwój Twojej firmy:

* *Twórz silne korzyści.* <br>Identyfikowanie potencjalnych klientów i kluczowych różnic rozwiązania.

* *Utwórz stronę docelową unikatowy w witrynie, aby wprowadzić swoje listy aplikacji, wyróżnij.* <br> Zachęć klientów z witryny do oferty i wprowadź wspaniałe wrażenia pierwszy. Oparte na swojej liście oferty, klienci zdecyduj, czy chcą dowiedzieć się więcej, a następnie spróbuj rozwiązania.

* *Włącz wersję testową lub innych wersja próbna.* <br> Użytkownicy chcą środowisko aplikacji ręki. Wydawcy w przeszłości przejrzane znacznie wyższa współczynników konwersji potencjalnych klientów z ofert, które oferują wersji testowej lub wersji próbnej.

* *Optymalizuj swoje listy pomagające w aparatach zwiększenie wydajności wyszukiwania.* <br> Uwzględniaj słów kluczowych, nazwa aplikacji, podsumowanie i listy. 
...
Kampanii marketingowej to seria działań promocyjne lub marketingowych taktyka, które mają na celu kierowania odbiorców do wykonania żądanej akcji lub dotrzeć do wyniku. Projektujesz kampanię należy wziąć pod uwagę następujące najlepsze rozwiązania:
...
Różni się odbiorców dla każdej branży. Jest odbiorców nauka w trybie online, za pośrednictwem poczty e-mail na targach, za pośrednictwem mediów społecznościowych, lub rozmów z zaufanych doradców? W zależności od tego, gdzie i jak uczy się krąg swoich odbiorców należy zaprojektować działań i w związku z tym dystrybucji ds. Kombinacja tych taktyka staje się strategii kampanii.

### <a name="create-clear-campaign-goals"></a>Tworzenie celów wyczyść kampanii

Należy zdefiniować Powodzenie kampanii w portalu marketplace i tworzenie wyczyść kluczowych wskaźników wydajności (KPI). Możesz uruchomić wiele kampanii zakończenia różnych celów. Oczywiście ostatecznym celem jest zwykle zwiększone uzyskania przychodu lub klienta; jednak swoje kampanie marketingowe, może być powiązany cele w niektórych innych etapów w cyklu kupowania. Oto kilka przykładów:
...
* *Masz wersję próbną, skonfigurowane w portalu marketplace.* Produkt wymaga pewien stopień zaangażowania i środowisko, przed dokonaniem zakupu. Należy wziąć pod uwagę kampanii celem liczba prób pobrane. W takim przypadku wywołania akcji dla kampanii taktykę będzie skupić gwałtownie zachęcanie do korzystania z wersji próbnej w witrynie marketplace.
...
* Pozostają ukierunkowane na celach.
* Zamapuj zbiór zintegrowane marketingu taktyka, które są wyrównane do Twoich celów.

Jako część jest nowy wydawcy w portalu marketplace otrzymasz szereg korzyści GTM marketplace wolnego od firmy Microsoft. Zastanów się niezwykle sposób używania tych korzyści w strategii kampanii. Pozwól naszego zespołu ds. marketingu znać Twoje cele kampanii w portalu marketplace i akcję odbiorców. Firma Microsoft może pomóc dostosować te cele do zrealizowania pracować w swoim planie.
...
### <a name="available-on-appsource-or-azure-marketplace-badge"></a>Dostępne wskaźniku AppSource lub witrynie Azure Marketplace

Gdy Twoja oferta znajduje się w usłudze AppSource lub witrynie Azure Marketplace, uzyskały korzyści wyświetlania *dostępne w usłudze AppSource* lub *dostępne w portalu Azure Marketplace* wskaźnika w witrynie sieci Web.
...
Znaczek portalu Azure Marketplace jest dostarczana jako część bezpłatnie [korzyści go-to-market](./gtm-your-marketplace-benefits.md).
