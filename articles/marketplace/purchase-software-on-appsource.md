...
- Konto służbowe.
    ...
    > [!Note]
    > Jeśli nie masz konta służbowego, musisz utworzyć dzierżawę Azure Active Directory, do której można dodać konto służbowe. Aby dowiedzieć się więcej, zobacz [Szybki Start: Tworzenie nowej dzierżawy w Azure Active Directory](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-access-create-new-tenant).

- Prawidłowa karta kredytowa.

    > [!Note]
    > Karta kredytowa musi należeć do kraju/regionu, w którym klient kupuje ofertę. Aby wybrać inny kraj, wybierz pozycję "Zmień kraj/region rozliczeniowy" w dolnej części strony.
