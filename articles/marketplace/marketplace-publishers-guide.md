---
title: Przewodnik dotyczący wydawcy witrynę Azure Marketplace i AppSource
...
Na koniec tego przewodnika możesz dowiedzieć się więcej na temat każdego z tych tematów i wiedzieć, gdzie można znaleźć bardziej szczegółowe informacje:

- Jakie są zalety listę w jednym z sklepy marketplace
- Jak używać sklepy
...
- **Zwiększyć wartość biznesową i zwiększyć rozmiar transakcji z istniejących i nowych klientów**. Wzrostu wielkości umowy i rozwiązywania problemów klienta, w przypadku przenoszenia obciążeń w chmurze. Zmniejsz cykle sprzedaży i zwiększyć rentowność transakcji o tym docelowych określonych obciążeń i scenariusze branży sprzedaży kompletnych rozwiązań.
...
|---------|---------|---------|
|Odbiorcy docelowi     |Informatycy i deweloperzy (specjalistyczne ról Dołącz DevOps DBAs, SecOP)    | Biznesowych podejmującym (specjalistyczne ról Dołącz zamówień, produkcyjny, ewidencjonowanie aktywności)      |
|Skompilowany, albo aby rozszerzyć     |Azure         | Azure, Dynamics 365, Office 365, Power BI, PowerApps       |
|Typy rozwiązań i usług     |  Rozwiązań infrastruktury, specjalistów usług   | Zakończono aplikacji biznesowych z chmury, dodatki usługi Office 365, professional usług        |
...
|---------|---------|---------|
|**Lista**    |    Skontaktować się ze mną usługi doradcze     |  Azure Marketplace, AppSource       |
...
**Azure Marketplace Obsługa publikowania**

|Obsługa kanału  |Opis  |
|---------|---------|
|Adres e-mail: azurecertified@microsoft.com |   Obsługa partnerów Azure Marketplace w przypadku publikowania aplikacji. Godziny pracy znajdują się w strefie czas pacyficzny.      |
|Adres e-mail: AzureMarketOnboard@microsoft.com |   Obsługa proces i portalu Azure Marketplace rozwiązanie wyznaczenie formularza. Godziny pracy znajdują się w strefie czas pacyficzny.      |
|Adres e-mail: Amp-testdrive@microsoft.com |   Dostęp do dołączania do testowania dysków. Godziny pracy znajdują się w strefie czas pacyficzny. | 

**Marketplace portalu pomocy technicznej platformy Azure**

|Obsługa kanału  |Opis  |
|---------|---------|
|Adres e-mail: [pomocy technicznej](https://go.microsoft.com/fwlink/?linkid=844975)    |   Obsługa publikowania portalu Marketplace. Pomoc techniczna jest świadczona przez cały czas, i dzień w nocy.        |
...
|Obsługa kanału  |Opis  |
|---------|---------|
|Adres e-mail: cosell@microsoft.com    |  Obsługa procesów dołączania i pytania dotyczące programu wspólnej sprzedaży. W oparciu o czas pacyficzny strefy.        |
...
>[!IMPORTANT]
>Umożliwia wielu użytkownikom na dostęp do tego konta Centrum deweloperów, zaleca się przy użyciu usługi Azure Active Directory, aby przypisać role do poszczególnych użytkowników. Tych użytkowników można uzyskać dostępu do konta poprzez zalogowanie za pomocą ich indywidualne poświadczenia usługi Azure AD. Aby uzyskać więcej informacji, zobacz [domeny federacyjnej wskazówki dotyczące IDs firmy Microsoft w usłudze Azure AD](#guidance-for-microsoft-ids-in-an-azure-ad-federated-domain). Utwórz konto Microsoft przy użyciu adresu e-mail, który należy do domeny firmy, ale nie do osoby. Może to być na przykład windowsapps@fabrikam.com.

- Ograniczanie dostępu do tego konta Microsoft na najmniejszą możliwą liczbę deweloperów.
- Konfigurowanie listy dystrybucyjnej firmowej poczty e-mail, która zawiera wszystkich użytkowników potrzebuje uzyskiwać dostęp do konta dewelopera, a następnie dodać ten adres e-mail do informacji zabezpieczających. Dzięki temu wszyscy pracownicy na liście do odbierania kody zabezpieczeń w razie potrzeby i zarządzać informacji o zabezpieczeniach konta Microsoft. Jeśli skonfigurowanie listy dystrybucyjnej nie jest to możliwe, właściciel konta e-mail poszczególnych musi być dostępna do uzyskania dostępu i udostępniania kodu zabezpieczeń po wyświetleniu monitu. (Na przykład właściciela jest monitowany podczas dodawania nowych informacji o zabezpieczeniach do konta lub muszą być dostępne z nowego urządzenia.)
- Dodaj numer telefonu firmy, który nie wymaga rozszerzenia i jest dostępna dla członków zespołu klucza.
- Ogólnie rzecz biorąc mieć deweloperzy Użyj zaufanego urządzenia do logowania się na konto dewelopera w firmie. Wszyscy członkowie zespołu kluczy powinien mieć dostęp do tych zaufanych urządzeń. Dostęp zmniejsza potrzebę kody zabezpieczeń do wysłania, gdy ktoś jest dostęp do tego konta.
...
- Często Przejrzyj informacje o zabezpieczeniach w firmie na [strony Zarządzanie](https://account.live.com/proofs/Manage) się upewnić, że jest ona wszystkie bieżące.
...
1. Przejdź do [strony rejestracyjnej](https://signup.live.com/signup) i wybierz **Pobierz nowy adres e-mail**.
...
2. Utwórz nowy adres e-mail, a następnie wprowadź hasło. Spowoduje to utworzenie zarówno nowy identyfikator firmy Microsoft, jak i skrzynki pocztowej poczty e-mail w usłudze outlook.com. Proces rejestracji należy kontynuować do momentu utworzenia konta.
   ...
   >[!IMPORTANT]
   >Upewnij się, że listy e-mail identyfikator lub dystrybucji, która będzie używana do rejestracji w Centrum deweloperów jest zarejestrowany jako konta Microsoft. (Zalecamy listę dystrybucyjną, aby usunąć zależności od osób). Jeśli nie, [zarejestrować teraz](https://signup.live.com/signup?uaid=e479342fe2824efeb0c3d92c8f961fd3&lic=1).
   >
   >Ponadto *identyfikator żadnego e-mail w domenie firmy Microsoft* nie może służyć do rejestracji w Centrum deweloperów.

3. Po utworzeniu Identyfikatora Microsoft z tego konta, zaloguj się do konta [skrzynki pocztowej](https://outlook.live.com/owa/). [Utwórz wiadomość e-mail przekazywania reguły](https://support.office.com/en-us/article/Use-rules-in-Outlook-Web-App-to-automatically-forward-messages-to-another-account-1433e3a0-7fb0-4999-b536-50e05cb67fed) można przenieść tej skrzynki pocztowej wszystkie wiadomości e-mail na adres e-mail utworzony w danej domenie, aby zarządzać kontem portalu Azure Marketplace.

Po wykonaniu ostatniego kroku programu Outlook wysyłać wiadomości e-mail/korespondencji od Identyfikatora Microsoft na Twoje konto e-mail w domenie. Należy użyć @outlook.com wiadomości e-mail adres do uwierzytelniania w chmurze Portal dla partnerów i Microsoft Developer Center.

### <a name="instructions-on-how-to-register-in-the-developer-center"></a>Instrukcje dotyczące rejestrowania w Centrum deweloperów
...
2. Przejdź do [Centrum deweloperów](http://dev.windows.com/registration?accountprogram=azure) Aby zarejestrować się jako sprzedawcy.
3. Zakończenie **Pomóż nam chronić Twoje konto** kreatora, który będzie zweryfikować Twoją tożsamość za pomocą numeru telefonu lub poczty e-mail adresu.

   ![Pola informacji telefonu w kreatorze "Pomóż nam chronić Twoje konto"](./media/marketplace-publishers-guide/registerdevcenteremail.png)

4. W **informacje o koncie rejestracji** wybierz swój kraj/region konta z menu rozwijanego.

   ![Informacje o koncie z polem w kraju/regionie](./media/marketplace-publishers-guide/devcenterregistrationaccountinfo.png)
   
   >[!WARNING]
   >Sprzedaż usług w witrynie Azure Marketplace, upewnij się, czy zarejestrowanych jednostki pochodzi z jednego z krajów zatwierdzonych "sprzedaje — od". To ograniczenie jest ze względu na wypłaty i podatków. Aby uzyskać więcej informacji, zobacz [zasady udziału Marketplace](https://azure.microsoft.com/support/legal/marketplace/participation-policies/).
...
6. Aby uzyskać **wydawcy, nazwa wyświetlana**, wprowadź nazwę wyświetlaną (zazwyczaj nazwa firmy).
   ...
   >[!TIP]
   >Wprowadzona w Centrum deweloperów wydawcy wyświetlana nazwa nie jest wyświetlana w portalu Azure Marketplace, po to wymienione ofertę. Jednak musi wypełnić to pole, aby ukończyć proces rejestracji.

7. Aby uzyskać **informacje kontaktowe**, wprowadź informacje dotyczące weryfikacji konta.

   >[!IMPORTANT]
   >Należy podać dokładnych informacji kontaktowych. Proces weryfikacji będą używać go do zatwierdzenia w Centrum deweloperów firmy.

8. Aby uzyskać **osoba zatwierdzająca w firmie**, podaj informacje kontaktowe osoby zatwierdzającej. Osoba zatwierdzająca jest osobą, która można zweryfikować, że masz uprawnienia do tworzenia konta w Centrum deweloperów w imieniu swojej organizacji. Wybierz **dalej** po zakończeniu.

   !["Account info" strony z sekcjami wyróżnione](./media/marketplace-publishers-guide/devcenterregistrationpayment.png)

9. Wprowadź dane o płatności, aby zwrócić dla Twojego konta. Jeśli masz kod promocyjny, który obejmuje koszt rejestracji, które można wprowadzić w tym miejscu. W przeciwnym razie Podaj informacje o karcie kredytowej lub informacji PayPal obsługiwanych rynkach. Gdy skończysz, wybierz **dalej**.

   ![Informacje dotyczące płatności w Centrum deweloperów](./media/marketplace-publishers-guide/devcenterregistrationpayment2.png)

10. Przejrzyj informacje o koncie i upewnij się, że wszystkie ustawienia są poprawne. Następnie przeczytać i zaakceptować warunki i postanowienia umowy Microsoft Azure Marketplace wydawcy. Wybierz pole, aby wskazać, aby przeczytać i zaakceptować niniejsze warunki.
11. Wybierz **Zakończ** aby potwierdzić swoją rejestrację. Komunikat potwierdzający wyślemy Ci na adres e-mail.
12. Jeśli planujesz opublikować tylko wolnego oferty, wybierz **przejdź do portalu dla partnerów chmury**.

    Jeśli planowane jest publikowanie oferty komercyjnej (transakcji) — na przykład oferuje maszyny wirtualnej z godzinowe modelu rozliczeń — wybierz **zaktualizować informacje o Twoim koncie**. Następnie należy podać bank i podatek informacje w danych konta Centrum deweloperów, zgodnie z opisem w następnej sekcji.

#### <a name="add-bank-and-tax-information"></a>Dodawanie informacji bankowych i podatek

Jeśli chcesz opublikować komercyjnych oferty zakupu, należy dodać wypłaty i informacjami i przesłać je do weryfikacji w Centrum deweloperów. Jeśli zostanie opublikowany tylko lub oferuje BYOL, nie trzeba dodać te informacje. Można dodać go później, ale dopiero po pewnym czasie można sprawdzić poprawności informacji podatku. Jeśli znasz zaoferuje komercyjnych oferty zakupu, firma Microsoft zaleca, dodaj go jak najszybciej.

>[!IMPORTANT]
>W przypadku ofert komercyjnej (transaction) nie można wypchnąć oferty do środowiska produkcyjnego dopiero po wykonaniu informacji bankowych i podatku.

Aby dodać informacji bankowych:
1. Zaloguj się do witryny Microsoft Developer Center przy użyciu konta Microsoft.
2. Wybierz **konta wypłaty** w menu po lewej stronie. W obszarze **Wybierz formę płatności**, wybierz pozycję **konta bankowego** lub **PayPal**.
...
3. Wprowadź informacje dotyczące płatności, a następnie wybierz **zapisać** po zakończeniu.

   >[!IMPORTANT]
   >Jeśli trzeba zaktualizować lub zmienić ustawienia konta wypłaty, wykonaj te same czynności poprzedniego, ale Zamień bieżących informacji o nowe informacje. Zmiana konta wypłaty można opóźnić płatności przez maksymalnie jeden cykl płatności. To opóźnienie występuje, ponieważ musimy zweryfikować zmiany konta, jak robiliśmy po skonfigurowaniu konta wypłaty. Nadal będziesz uzyskać płatności za łączną ilość po Twoje konto zostało zweryfikowane. Płatności powodu dla bieżącej płatności cykl zostanie dodany do następnej.

4. Wybierz opcję **Dalej**. 

Aby dodać informacje podatkowe:

1. Zaloguj się do [Microsoft Developer Center](https://dev.windows.com) przy użyciu konta Microsoft (w razie potrzeby).
2. Wybierz **podatku profilu** w menu po lewej stronie.
3. Na **skonfigurować formularz podatku** strony, wybierz kraj lub region, w której są trwałe siedziby, a następnie wybierz kraj lub region, gdzie są przechowywane podstawowe możliwości dostępnych. Wybierz opcję **Dalej**.
4. Wprowadź szczegóły podatku, a następnie wybierz **dalej**.

Jeśli masz problemy z Centrum deweloperów rejestracji dziennika biletu pomocy technicznej:

1. Przejdź do [strony pomocy technicznej](https://developer.microsoft.com/windows/support).
2. W obszarze **skontaktuj się z nami**, wybierz pozycję **przesłać zdarzenia** przycisku.
