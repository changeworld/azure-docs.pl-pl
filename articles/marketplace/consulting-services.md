...
Azure Marketplace i AppSource obsługuje listę konsultacji oferty usług od partnerów systemu Integrator (SI) firmy Microsoft — celem jest oferowanie jakości usługi doradcze umożliwiające klientom łączenie się z usługami specjalistyczne, które są im potrzebne. Pomaga klientom ocenienie, oceny i wdrażania odpowiednie rozwiązania i implementację, która pomoże wraz z ich cele biznesowe i cele.  

Te oferty usług doradczych dotyczących są engagements właściwe dla klienta. Wydawcom opcję, aby określić typ oferty i przy stałej zakresu i czasu trwania, stałej cenie lub bez, i ma zdefiniowane planu z materiałami do klienta. Potencjalni klienci są odbierane za pośrednictwem powiadomienia w systemie CRM partnera i staraj się reagować na potrzeby klientów w ciągu 48 godzin. 
...
**Kwalifikujące się kompetencji są wymienione w poniższej tabeli dla witryny Azure Marketplace:**
...
|**Widoków**    |   Co sformułowania elementu dostarczanego klientowi mogą oczekiwać. Pamiętaj, że widoków muszą być dostarczane osobiście. Jeśli udostępniasz usługa wirtualnych, wybierz typ inną ofertę    |  Optymalizuj swoją ofertę podsumowania z najważniejsze słowa kluczowe optymalizacji dla aparatów wyszukiwania       |
