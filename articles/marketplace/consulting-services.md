...
Oferty usług konsultingowych, które są oparte na systemie Microsoft Dynamics 365, aplikacje zaawansowane i Power BI mogą być wymienione na Microsoft AppSource. Aby uzyskać więcej informacji, zobacz artykuł [Microsoft AppSource Information Services — wskazówki](https://go.microsoft.com/fwlink/?LinkId=828734&clcid=0x409).
...
1. [Microsoft Cloud włączania](https://aka.ms/CEDnominate) <br> Formularz nominacji z przewodnikiem w chmurze z obsługą chmury jest pomocny dla specjalisty programu w chmurze, który ideach korzyści MPN i służy jako przewodnik po osiągnięciu kompetencji.  
2. Jak uzyskać listę w Power BI pokazu? <br> Zacznij od wysłania żądania, aby uzyskać listę, zobacz [Zostań partnerem](https://powerbi.microsoft.com/become-a-partner/).
...
1. **Lista**: Rozpocznij tworzenie wersji roboczej nowej oferty, logując się do konta [Portal Cloud partner](https://cloudpartner.azure.com) . Wybierz pozycję "Nowa oferta" i "usługi doradcze" z menu rozwijanego. Wprowadź artefakt swojej aukcji i opublikuj go.
...
Pole title ma limit 50 znaków i musi przesłać czas trwania i typ usługi oferty, aby zmaksymalizować optymalizację aparatu wyszukiwania. Wymagany format jest następujący: NAME: typ czasu trwania
