...
Poniższej tabeli opisano te kroki i udostępnia Szacowanie maksymalny czas na ich zakończenie: <!-- we need to tell them that if an offer seems stuck in a step, to know that they should file a support ticket (link to support ticket doc) -->
...
| Aprowizowanie                   | 4 dni   | Oferty maszyny Wirtualnej jest replikowany w systemach produkcyjnych w portalu marketplace.               |
...
| Aprowizowanie                   | 4 dni | Ukończone oferty maszyny Wirtualnej jest replikowana w regionach i systemów produkcyjnych w portalu marketplace. | 
