---
title: Aplikacji systemu Azure oferują karta w portalu Marketplace | Dokumentacja firmy Microsoft
...
W poniższej tabeli opisano ustawienia służące do tworzenia storefront dla oferty.
...
|         Przydatne łącza           |        Łącza do różnych zasobów można podać dla użytkowników, oferty, takie jak obsługa, dokumentacji, forum itp. Upewnij się, że dodano co najmniej jedno połączenie się z dokumentacją.            |
|         Sugerowane kategorie (maks. 5)           |         Wybierz maksymalnie pięć kategorii. Wybrane kategorie są używane do mapowania oferty dostępne kategorie produktów w witrynie Azure Marketplace i witryny Azure Portal. Będą one wyświetlane na stronie przeglądania i na stronie szczegółów produktu.          |
...
|    **Pole**       |  **Opis**  |
|  ---------------   |  ---------------  |
|       Small             |        40 40 pikseli w formacie PNG           |
|       Medium             |        90 x 90 pikseli w formacie PNG           |
|       Large             |        115 x 115 pikseli w formacie PNG         |
|       Szerokie             |        255 x 115 pikseli w formacie PNG           |
|       Duży obraz             |        815 x 290 pikseli w formacie PNG. Opcjonalny. **Uwaga:** Nie można usunąć ikonę hero, po zakończeniu przekazywania.           |
...
|        Dodaj klip wideo            |        Filmy wideo są wyświetlane na stronie szczegółów produktu. Są one dobrym sposobem na wizualne przedstawianie działanie aplikacji i sposób jej działania. Aby dodać film wideo: <ul><li>Wybierz **+ Dodaj wideo** aby otworzyć okno wideo</li><li>**Nazwa** — wprowadź nazwę/tytuł (maksymalna długość 100 znaków).</li><li>**Link** — wprowadź adres URL dla witryny, który jest hostem wideo (działanie serwisu YouTube lub Vimeo)</li><li>**Miniatura** — Przekaż miniaturę. Musi być w formacie PNG, a rozmiar jest 533 x 324 pikseli.</li></ul>          |
