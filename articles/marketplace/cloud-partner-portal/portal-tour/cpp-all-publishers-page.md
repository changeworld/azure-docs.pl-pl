---
title: Wszystkie strony wydawcy dla witryny Azure Marketplace
description: Przegląd wszystkich wydawców w portalu Cloud Partner portalu Azure Marketplace.
...
![Strona profilu wydawcy firmy Contoso](./media/all-publishers-page2.png)


## <a name="next-steps"></a>Kolejne kroki

Wyświetla następny element paska menu nawigacji [stronę użytkownicy](./cpp-users-page.md), który zawiera listę wszystkich zarejestrowanych użytkowników. 
