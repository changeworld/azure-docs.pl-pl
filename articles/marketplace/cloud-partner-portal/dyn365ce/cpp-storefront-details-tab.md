...
Użyj **szczegóły Storefront** kartę, aby podać informacje o sprzedaży i marketingu i artefaktów.  Ta karta zawiera następujące sześć sekcji: **Szczegóły oferty**, **szczegółowe informacje dotyczące listy**, **marketingowych artefaktów**, **prawne**, **techniczną**,  **Zarządzanie potencjalnymi**.  Etykiety dołączany gwiazdką (*) wskazuje, że jest wymagane.


## <a name="offer-details-section"></a>Sekcja szczegóły oferty

Należy podać podsumowanie i opis oferty w tej sekcji.  Te informacje są zawsze wyświetlane w portalu marketplace.
...
Należy podać szczegóły dotyczące portalu marketplace, w tej sekcji.
...
W tej sekcji należy podać materiały marketingowe: obrazów logo, promocyjne lub instruktażowy filmów wideo, dokumentacji produktu i zrzuty ekranu interfejsu użytkownika.

![Marketing artefaktów części karty Szczegóły sklepu](./media/storefront-tab-market-artifacts.png)
...
Należy podać *zasady zachowania poufności informacji* i *warunki użytkowania* dla aplikacji w tej sekcji.

![Prawne części karty Szczegóły sklepu](./media/storefront-tab-legal.png)
...
W tej sekcji należy podać **adres URL pomocy technicznej** dla aplikacji.


## <a name="lead-management-section"></a>Prowadzić sekcji Zarządzanie

W tej sekcji należy podać mechanizmem do obsługi wygenerowanych przez listę Twoja oferta potencjalnych klientów.  Zazwyczaj potencjalnych klientów są przechowywane w systemach zarządzania (CRM) relacji klienta.  Obsługiwane są następujące lokalizacje docelowe: **Brak**, **tabeli platformy Azure**, **Dynamics CRM Online**, **punktu końcowego HTTPS**, **Marketo**, i **Salesforce** .  Aby uzyskać więcej informacji, zobacz [pozyskiwanie potencjalnych klientów](../../cloud-partner-portal-orig/cloud-partner-portal-get-customer-leads.md).


## <a name="next-steps"></a>Kolejne kroki

Następnie należy podać technicznych i obsługi klientów informacje zawarte w [kartę kontakty](./cpp-contacts-tab.md). 
