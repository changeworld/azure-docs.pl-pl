---
title: Sprzedaż SaaS za pośrednictwem interfejsów API platformy Azure | Portal Azure Marketplace
...
ms.locfileid: "64941940"
---
# <a name="saas-sell-through-azure---apis"></a>Sprzedaż SaaS za pośrednictwem platformy Azure — interfejsy API

W tym artykule opisano sposób tworzenia oferty SaaS za pomocą interfejsów API. Interfejsy API są niezbędne w przypadku sprzedaży za pośrednictwem wybrane platformy Azure, dzięki czemu subskrypcje do swojej oferty SaaS.  W tym artykule jest podzielona na dwie sekcje:
...
![SaaS oferują usługi flow interfejsu API](./media/saas-offer-publish-api-flow.png)
