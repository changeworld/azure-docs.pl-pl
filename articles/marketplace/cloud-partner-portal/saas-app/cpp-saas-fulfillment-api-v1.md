...
| Autoryzacja      | Tak          | JSON web token (JWT) token elementu nośnego.                    |
...
| Akcja                 | String        | Akcja, która jest przyczyną tego powiadomienia. Możliwe wartości - aktywowania, Usuń, Wstrzymaj, przywrócenie, aktualizację          |
