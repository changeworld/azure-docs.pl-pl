---
title: Portal Marketplace — często zadawane pytania | Azure
...
**Co to jest witryna Azure Marketplace?**
...
Portal Azure Marketplace oferuje aplikacje SaaS, maszyny wirtualne, szablony rozwiązań, aplikacje zarządzane platformy Azure i usług doradczych.
...
**Jakie korzyści zapewnia witryna Azure Marketplace?**
...
**W jaki sposób mogę kupować produkty z witryny Azure Marketplace?**
...
**W jakich krajach za zakup aplikacji i usług sprzedawane/dostarczanymi za pośrednictwem portalu Azure Marketplace?**

Portal Azure Marketplace jest dostępny dla klientów Microsoft Azure w krajach na liście [— zasady udziału](https://docs.microsoft.com/legal/marketplace/participation-policy).
...
**Azure Marketplace maszyn wirtualnych (VM) została wdrożona w subskrypcji, a teraz chcę migrować subskrypcję z jednego konta platformy Azure do innego. Czy jest to obecnie obsługiwane?**
...
**Chcę przeprowadzić migrację subskrypcji maszyny wirtualnej witryny Azure Marketplace Virtual Machine do mojej umowy Enterprise Agreement. Czy jest to obecnie obsługiwane?**
...
*Bezpłatna:* Bezpłatna jednostka SKU. Żadne opłaty są stosowane do opłat za licencje oprogramowania lub użytkowania oferty.
...
Szczegóły cen określonych ofert można znaleźć na stronie szczegółów rozwiązania w [ https://azure.microsoft.com/en-us/pricing/ ](https://azure.microsoft.com/pricing/) lub w ramach [portalu zarządzania Microsoft Azure](https://portal.azure.com/).
...
**Jak mogę zapłacić za te subskrypcje? Czy moje zakupy w portalu Azure Marketplace są wyświetlane na rachunku za platformę Azure, lub czy istnieje innym rachunku?**
...
**Gdzie mogę obejrzeć szczegóły swoich subskrypcji portalu Azure Marketplace i informacje rozliczeniowe?**
...
**Jak mogę przenieść zakupy dokonane w portalu Azure Marketplace z subskrypcji MOSP do subskrypcji bezpośredniej umowy Enterprise Agreement (EA)?**
...
**Z kim mam się kontaktować w przypadku ogólnych problemów dotyczących obsługi witryny Azure Marketplace?**
...
**Z kim mam się kontaktować, aby uzyskać pomoc techniczną dla rozwiązania zakupionego w witrynie Azure Marketplace?**
...
**Z kim mam się skontaktować w przypadku pytań dotyczących cen lub warunków związanych z rozwiązaniami partnerów sprzedawanymi w portalu Azure Marketplace?**
...
**Czy mogę zwrócić zakup, jeśli nie spełnia on moich oczekiwań?**
...
Klienci bezpośrednio skontaktuj się z wydawcą problemów technicznych związanych z ich usług witryny Marketplace lub zakupu. Informacje kontaktowe wydawcy i/lub link do witryny sieci Web pomocy technicznej można znaleźć na stronie szczegółów rozwiązania w portalu Azure Marketplace.
...
**Czy muszę być członkiem sieci Microsoft Partner Network (MPN), aby wystawić swoje aplikacje i usługi w witrynie Azure Marketplace?**
...
**Czy za publikowanie w witrynie Azure Marketplace naliczane są opłaty?**
...
**Jakie są niektóre z korzyści usług Go-To-Market zapewniane wydawcom widoczne w witrynie Azure Marketplace?**
...
### <a name="billing-and-payments"></a>Pomoc dotycząca rozliczeń i płatności
...
**Z kim mam się skontaktować, jeśli mam pytania dotyczące rozliczeń lub zarządzania ofertami?**
...
**Z kim mam się skontaktować, jeśli mam pytania dotyczące publikowania lub zarządzania ofertami?**
...
**Jeśli przypadkowo usunę zakup dokonany w portalu Azure Marketplace, czy mogę cofnąć tę akcję?**
...
**Kto może kupować aplikacje sprzedawane/których obsługa jest inicjowana w portalu Azure Marketplace?**

Portal Azure Marketplace jest dostępny dla klientów platformy Microsoft Azure w następujących krajach:

Algieria, Arabia Saudyjska, Argentyna, Australia, Austria, Bahrajn, Belgia, Białoruś, Brazylia, Bułgaria, Chile, Chorwacja, Cypr, Czarnogóra, Czechy, Dania, Dominikana, Egipt, Ekwador, Estonia, Filipiny, Finlandia, Francja, Grecja, Gwatemala, Hiszpania, Holandia, SRA Hongkong, Indie, Indonezja, Irlandia, Islandia, Izrael, Japonia, Jordania, Kanada, Katar, Kazachstan, Kenia, Kolumbia, Korea Południowa, Kostaryka, Kuwejt, Liechtenstein, Litwa, Luksemburg, Łotwa, Macedonia Północna, Malezja, Malta, Maroko, Meksyk, Niemcy, Nigeria, Norwegia, Nowa Zelandia, Oman, Pakistan, Panama, Paragwaj, Peru, Polska, Portoryko, Portugalia, Republika Południowej Afryki, Rosja, Rumunia, Salwador, Serbia, Singapur, Słowacja, Słowenia, Sri Lanka, Stany Zjednoczone, Szwajcaria, Szwecja, Tajlandia, Tajwan, Trynidad i Tobago, Tunezja, Turcja, Ukraina, Urugwaj, Wenezuela, Węgry, Włochy, Zjednoczone Emiraty Arabskie i Zjednoczone Królestwo

**Jak zdefiniować Moje dotyczącą dostępności geograficznej umożliwiające sprzedaży w różnych krajach?**

1.  W portalu Cloud Partner przejdź do jednostki SKU, do której chcesz dodać nowych krajach.  W ciągu "Szczegóły jednostki SKU" Przejdź do "Kraj/Region availability", a następnie kliknij przycisk "Wybierz regiony".

    ![Wybierz regiony](media/marketplace-publishers-guide/FAQ-choose-geo.png)

1.  Lista będzie się pojawiać, przy użyciu wszystkich krajów dostępne, aby je.  Kliknij pole wyboru obok każdego kraju, które chcesz udostępnić tej jednostki SKU. Kliknij przycisk "OK".

    ![Wybierz listę krajów](media/marketplace-publishers-guide/FAQ-select-countries.png)
...
Wydawcy mogą edytować istniejące oferty, wybierz nowych krajach, a następnie użyć funkcji pobierania/przekazywania arkusza kalkulacyjnego można ustawić, ceny.

**W jakich krajach klienci mogą kupować ofert portalu Azure Marketplace?**

Witryna Azure Marketplace obsługuje 141 zakup z różnych lokalizacji geograficznych, zgodnie z definicją adresu rozliczeniowego przez klienta. Zobacz [— zasady udziału](https://docs.microsoft.com/legal/marketplace/participation-policy) listę krajów.
...
**Azure Marketplace maszyn wirtualnych (VM) została wdrożona w subskrypcji, a teraz chcę migrować tę subskrypcję z jednego konta platformy Azure do innego. Czy jest to obecnie obsługiwane?**
...
Szczegóły można znaleźć na stronie szczegółów rozwiązania w [ https://azure.microsoft.com/en-us/pricing/ ](https://azure.microsoft.com/pricing/), lub w portalu zarządzania Microsoft Azure.

>[!Note]
>Z wyjątkiem opłat miesięcznych opłaty za użycie platformy Azure są mające zastosowanie do wszystkich modeli cenowych, chyba że określono inaczej.

**Jaka jest różnica między warstwą Bezpłatna a ofertą Bezpłatną wersją próbną oprogramowania?**
...
**Czy mogę kontrolować dostęp swoich pracowników do portalu Azure Marketplace i ich uprawnienia do dokonywania zakupów?**
...
**Czy zakupów w witrynie Azure Marketplace mogę dokonywać w ramach programu licencjonowania zbiorowego firmy Microsoft/na podstawie mojej umowy Enterprise Agreement?**
...
**Jak mogę zapłacić za te subskrypcje? Czy moje zakupy w portalu Azure Marketplace są wyświetlane na rachunku za platformę Azure, czy istnieje innym rachunku?**
...
**W jaki sposób mogę anulować dodatek witryny Azure Marketplace do maszyny wirtualnej platformy Azure?**
...
**Czym różnią się składniki „cena”, „cena oprogramowania” i „cena łączna” w strukturze kosztów ofert maszyn wirtualnych w portalu Azure Marketplace?**
...
**Z kim mam się kontaktować w przypadku problemów/pytań o rozliczenia dotyczących rozwiązania innej firmy zakupionego w witrynie Azure Marketplace?**
