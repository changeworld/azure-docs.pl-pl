...
ms.locfileid: "42889674"
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>Przygotowanie do hosta rozszerzenia dla usługi Azure Stack

Można użyć host rozszerzenia ułatwiające bezpieczne usługi Azure Stack, zmniejszając liczbę wymaganych portów TCP/IP. W tym artykule patrzy na hosta rozszerzenia, który jest włączany automatycznie za pomocą pakietu aktualizacji usługi Azure Stack po aktualizacji 1808 przygotowywanie usługi Azure Stack.
...
> [!Note]  
> Możesz pominąć ten krok w zależności od Twojego żądania certyfikatów SSL.
...
5. Zaimportuj certyfikat dla administratora hostingu punktu końcowego.
