...
1. Aby utworzyć konto magazynu, postępuj zgodnie z instrukcjami [Tworzenie konta magazynu](https://docs.microsoft.com/azure/storage/storage-create-storage-account#create-a-storage-account).
