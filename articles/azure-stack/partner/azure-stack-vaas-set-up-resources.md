...
Weryfikacja jako usługa (VaaS) jest usługą platformy Azure, który służy do sprawdzania poprawności i obsłudze usługi Azure Stack rozwiązań na rynku. Przed rozpoczęciem korzystania z usługi do sprawdzania poprawności rozwiązania, należy wykonać w tym artykule.

Ten samouczek zawiera informacje na temat wykonywania następujących czynności:

> [!div class="checklist"]
> * Przygotuj się do użycia VaaS przez ustawienie zapasowej usługi Azure Active Directory (AD).
> * Tworzenie konta magazynu

## <a name="configure-an-azure-ad-tenant"></a>Konfigurowanie dzierżawę usługi Azure AD

Dzierżawa usługi Azure AD jest używany do rejestracji organizacji i uwierzytelnianie użytkowników za pomocą VaaS. Partner użyje funkcji kontroli dostępu opartej na rolach dzierżawy do zarządzania, które osoby w organizacji partnerskiej służy VaaS. Aby uzyskać więcej informacji, zobacz [Co to jest usługa Azure Active Directory?](https://docs.microsoft.com/en-us/azure/active-directory/fundamentals/active-directory-whatis).

### <a name="create-a-tenant"></a>Tworzenie dzierżawy

Tworzenie dzierżawy używanego organizacji dostęp do usług VaaS. Na przykład użyj nazwy opisowej, `ContosoVaaS@onmicrosoft.com`.
...
4. Przegląd [konwencje nazewnictwa](https://docs.microsoft.com/en-us/azure/architecture/best-practices/naming-conventions#storage) dla kont usługi Azure Storage. Wprowadź nazwę konta magazynu.
...
7. Wybierz pozycję **Przejrzyj i utwórz**, aby przejrzeć ustawienia konta magazynu i utworzyć konto.
