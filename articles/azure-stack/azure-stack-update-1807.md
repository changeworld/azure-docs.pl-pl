...
- [KB 4467061 — usługi Azure Stack poprawki w usłudze Azure Stack poprawkę 1.1807.3.82](https://support.microsoft.com/help/4467061/)
...
- Wybierając rozmiar maszyny wirtualnej do wdrażania maszyn wirtualnych, niektóre rozmiary serii F maszyn wirtualnych nie są widoczne jako część selektor rozmiar podczas tworzenia maszyny Wirtualnej. W selektorze nie ma następujących rozmiarów maszyn wirtualnych: *F8s_v2*, *F16s_v2*, *F32s_v2*, i *F64s_v2*.  
  ...
  - **PowerShell:** Za pomocą programu PowerShell można użyć [New-AzureRMVMConfig](https://docs.microsoft.com/powershell/module/azurerm.compute/new-azurermvmconfig?view=azurermps-6.0.0) z parametrem, który określa rozmiar maszyny Wirtualnej, podobnie jak `-VMSize "Standard_F32s_v2"`.
