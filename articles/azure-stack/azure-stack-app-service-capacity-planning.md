...
Aby skonfigurować gotowy wdrożenia produkcyjnego usługi Azure App Service na stosie Azure, należy zaplanować pojemność oczekiwać systemu do obsługi.  

Ten artykuł zawiera wskazówki dotyczące minimalnej liczby wystąpień obliczeniowych i zasobów obliczeniowych jednostki SKU dla każdego wdrożenia produkcyjnego należy używać.
...
**Minimalna zalecana**: dwa wystąpienia standardowe A1
...
**Minimalna zalecana**: dwa wystąpienia A3 Standard
...
- **Zużycie pamięci średni**: zużycie pamięci średnia dla aplikacji w środowisku produkcyjnym wynosi około 70 MB. Korzystając z tego miejsca, pamięć przydzielona dla wszystkich komputerów roli procesu roboczego sieci Web lub maszyn wirtualnych można obliczyć w następujący sposób:
...
- klaster serwera plików z systemem innym niż Windows
- urządzenie NAS (Network Attached Storage)

Aby uzyskać więcej informacji, zobacz [obsługi administracyjnej serwera plików](azure-stack-app-service-before-you-get-started.md#prepare-the-file-server).
