...
Należy zauważyć, że domyślna strefa czasowa dla wszystkich wdrożeń usługi Azure Stack jest uniwersalny czas koordynowany (UTC). Strefa czasowa można wybrać podczas instalowania usługi Azure Stack, jednak automatycznie powraca on do UTC domyślnie podczas instalacji.
