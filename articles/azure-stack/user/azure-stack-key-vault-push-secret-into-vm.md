...
![Wyniki wdrożenia szablonu](media/azure-stack-key-vault-push-secret-into-vm/deployment-output.png)
...
* [Zezwolić aplikacji na dostęp do usługi Key Vault](azure-stack-key-vault-sample-app.md)
