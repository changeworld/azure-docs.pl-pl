...
Jeśli używasz ASDK należy traktować jako zaufany certyfikat główny urzędu certyfikacji na maszynie zdalnej. Nie należy to zrobić przy użyciu systemów intregrated.
