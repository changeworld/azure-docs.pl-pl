...
Aby uzyskać więcej informacji o scenariuszach łańcucha bloków, zobacz [szablon rozwiązania konsorcjum dowód uwierzytelniania Ethereum](../../blockchain/templates/ethereum-poa-deployment.md).
