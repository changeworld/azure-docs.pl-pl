...
|----------------|-------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|
| .NET | 9.2.0 | Pakiet Nuget:<br>https://www.nuget.org/packages/WindowsAzure.Storage/9.2.0<br> <br>Wersja usługi GitHub:<br>https://github.com/Azure/azure-storage-net/releases/tag/v9.2.0 | pliku App.config |
| Java | 7.0.0 | Pakiet maven:<br>https://mvnrepository.com/artifact/com.microsoft.azure/azure-storage/7.0.0<br> <br>Wersja usługi GitHub:<br>https://github.com/Azure/azure-storage-java/releases/tag/v7.0.0 | Ustawienia parametrów połączenia |
| Node.js | 2.8.3 | NPM link:<br>https://www.npmjs.com/package/azure-storage<br>(Uruchom: `npm install azure-storage@2.8.3`)<br> <br>Wersja usługi Github:<br>https://github.com/Azure/azure-storage-node/releases/tag/v2.8.3 | Deklaracja wystąpienia usługi |
| C++ | 5.2.0 | Pakiet Nuget:<br>https://www.nuget.org/packages/Microsoft.Azure.Storage.CPP.v140/5.2.0<br> <br>Wersja usługi GitHub:<br>https://github.com/Azure/azure-storage-cpp/releases/tag/v5.2.0 | Ustawienia parametrów połączenia |
| PHP | 1.2.0 | Wersja usługi GitHub:<br>Wspólne: https://github.com/Azure/azure-storage-php/releases/tag/v1.2.0-common<br>Obiekt blob: https://github.com/Azure/azure-storage-php/releases/tag/v1.2.0-blob<br>Kolejka:<br>https://github.com/Azure/azure-storage-php/releases/tag/v1.1.1-queue<br>Tabela: https://github.com/Azure/azure-storage-php/releases/tag/v1.1.0-table<br> <br>Instalowanie za pomocą Composer (Aby uzyskać więcej informacji, [Zobacz szczegóły poniżej](#install-php-client-via-composer---current).) | Ustawienia parametrów połączenia |
| Python | 1.1.0 | Wersja usługi GitHub:<br>Wspólne:<br>https://github.com/Azure/azure-storage-python/releases/tag/v1.1.0-common<br>Blob:<br>https://github.com/Azure/azure-storage-python/releases/tag/v1.1.0-blob<br>Kolejka:<br>https://github.com/Azure/azure-storage-python/releases/tag/v1.1.0-queue | Deklaracja wystąpienia usługi |
