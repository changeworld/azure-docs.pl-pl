...
ms.locfileid: "35294942"
---
# <a name="create-sql-databases"></a>Tworzenie bazy danych SQL
Samoobsługowe baz danych są realizowane za pośrednictwem portalu użytkowników. Użytkownik Azure stos musi subskrypcji, która ma oferty zawiera usługę bazy danych SQL.
