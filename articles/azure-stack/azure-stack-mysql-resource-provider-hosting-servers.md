...
5. Wybierz **jednostki SKU** otworzyć **Tworzenie jednostki SKU** okna dialogowego.
   ...
   >[!IMPORTANT]
   >Znaki specjalne, łącznie ze spacjami i okresów, nie są obsługiwane w **nazwa** lub **warstwy** po utworzeniu jednostki SKU dla dostawcy zasobów bazy danych MySQL.
