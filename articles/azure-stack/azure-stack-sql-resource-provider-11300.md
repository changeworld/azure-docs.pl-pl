...
- **Dostawcy zasobów bazy danych SQL Azure Stack PowerShell zgodności**. Dostawcy zasobów bazy danych SQL została zaktualizowana do pracy z profilem stosu 2018-03-01-hybrydowej platformy Azure PowerShell i w celu zapewnienia zgodności przy użyciu usługi AzureRM 1.3.0 lub nowszy.
