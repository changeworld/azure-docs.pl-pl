...
- **Aktualizacje do narzędzi i struktur aplikacji na następujących**:
  - Dodano platformy ASP.Net Core 2.1.2
  - Dodano NodeJS 10.0.0
  - Dodano OpenJDK Zulu 8.30.0.1
...
1. Dodaj [bazy danych do grupy dostępności](https://docs.microsoft.com/sql/database-engine/availability-groups/windows/availability-group-add-a-database)
...
Zapoznaj się z dokumentacją w [informacje o wersji usługi Azure Stack 1807](azure-stack-update-1807.md)
