...
Zwróć uwagę, że identyfikator serwera MariaDB jest podobny do ```/subscriptions/subscriptionId/resourceGroups/myResourceGroup/providers/Microsoft.DBforMariaDB/servers/servername.``` w następnym kroku zostanie użyty identyfikator serwera MariaDB. 
...
2. Wprowadź polecenie  `nslookup mydemoserver.mariadb.privatelink.database.azure.com`. 
