...
- **Pokaż**: wyświetlenie szczegółów dotyczących serwera usługi Azure MariaDB reguły zapory.
- **Aktualizuj**: aktualizowanie reguły zapory serwera MariaDB platformy Azure.
