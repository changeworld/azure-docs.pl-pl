...
| Ograniczenia | Nie | Jedną lub więcej właściwości, które są używane do dostosowywania zachowania poprawności elementu. Obsługiwane właściwości ograniczenia zależą od typu elementu. Niektóre typy elementu nie obsługuje dostosowywania zachowania poprawności, a zatem mieć żadnej właściwości ograniczenia. |
| opcje | Nie | Dodatkowe właściwości, które dostosować zachowanie elementu. Podobnie jak `constraints`, obsługiwanych właściwości zależą od typu elementu. |
