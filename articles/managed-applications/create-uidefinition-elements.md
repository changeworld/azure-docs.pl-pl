...
W tym artykule opisano schematu i właściwości dla wszystkich elementów obsługiwanych CreateUiDefinition. Schemat dla większości elementów jest następujący:
