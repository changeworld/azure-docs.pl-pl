...
ms.locfileid: "37048458"
---
# <a name="azure-data-factory---functions-and-system-variables"></a>Fabryki danych Azure — funkcje i zmienne systemu
> [!NOTE]
> Ten artykuł dotyczy wersji 1 fabryki danych. Jeśli używasz bieżącą wersję usługi fabryka danych, zobacz [zmienne systemowe w fabryce danych](../control-flow-system-variables.md).
