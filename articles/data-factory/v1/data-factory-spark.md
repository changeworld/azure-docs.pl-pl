...
1. Utwórz konto magazynu ogólnego przeznaczenia zgodnie z instrukcjami w [Tworzenie konta magazynu](../../storage/common/storage-create-storage-account.md#create-a-storage-account).
