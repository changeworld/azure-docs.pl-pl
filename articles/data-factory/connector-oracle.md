...
Aby skopiować dane z programu Oracle, należy ustawić typ źródła w działaniu kopiowania na `OracleSource`. Następujące właściwości są obsługiwane w działaniu kopiowania **źródła** sekcji.
