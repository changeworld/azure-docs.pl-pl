...
-   Subskrypcja platformy Azure połączona z programem Visual Studio Team Foundation Server lub Azure Repos, która korzysta z [punktu końcowego usługi Azure Resource Manager](https://docs.microsoft.com/azure/devops/pipelines/library/service-endpoints#sep-azure-rm).
...
1.  Wybierz pozycję **Dodaj artefakt**, a następnie wybierz repozytorium skonfigurowane z fabryką danych. Wybierz **adf_publish** dla **gałęzi domyślnej**. W polu **wersja domyślna**wybierz pozycję **Najnowsza z gałęzi domyślnej**.
    ...
    ![Dodaj artefakt](media/continuous-integration-deployment/continuous-integration-image7.png)
...
-  Dodaj wpisy tajne do pliku Parameters. Aby uzyskać więcej informacji, zobacz [używanie Azure Key Vault do przekazywania bezpiecznej wartości parametru podczas wdrażania](../azure-resource-manager/resource-manager-keyvault-parameter.md).
