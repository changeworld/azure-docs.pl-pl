---
title: Wykonaj potoki usługi Azure Machine Learning w potokach Azure Data Factory | Microsoft Docs
description: Dowiedz się, jak uruchamiać potoki usługi Azure Machine Learning w potokach Azure Data Factory.
...
ms.locfileid: "72301349"
---
# <a name="execute-azure-machine-learning-service-pipelines-in-azure-data-factory"></a>Wykonaj potoki usługi Azure Machine Learning w Azure Data Factory

Uruchom potoki usługi Azure Machine Learning w ramach Azure Data Factory potoków. Działanie Machine Learning wykonywania potoku włącza scenariusze prognozowania partii, takie jak identyfikowanie możliwych wartości domyślnych pożyczek, Określanie tonacji oraz analizowanie wzorców zachowania klientów.
...
linkedServiceName | Połączona usługa do Azure Machine Learning usługi | Odwołanie do połączonej usługi | Tak
...
mlParentRunId | Identyfikator uruchomienia potoku usługi Azure Machine Learning nadrzędnego | Ciąg (lub wyrażenie z typem ResultType ciągu) | Nie
