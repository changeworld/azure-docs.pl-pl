---
title: Kopiowanie danych z Couchbase przy użyciu fabryki danych Azure | Dokumentacja firmy Microsoft
...
---
# <a name="copy-data-from-couchbase-using-azure-data-factory"></a>Kopiowanie danych z Couchbase przy użyciu fabryki danych Azure
