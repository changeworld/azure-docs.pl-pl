...
-------- | ----------- | -------------- | --------
{1&gt;nazwa&lt;1} | Nazwa działania sieci Web | Ciąg | Tak
...
zbiory danych | Lista zestawów danych przeniesiona do punktu końcowego. | Tablica odwołań do zestawu danych. Może być pustą tablicą. | Tak
