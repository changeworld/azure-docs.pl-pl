---
title: Kopiowanie danych z Magento przy użyciu usługi Azure Data Factory (wersja zapoznawcza)
...
| host | Adres URL wystąpienia Magento. (czyli 192.168.222.110/magento3)  | Tak |
| accessToken | Token dostępu z Magento. Oznacz to pole jako SecureString, aby bezpiecznie przechowywać w usłudze Data Factory lub [odwołanie wpisu tajnego przechowywanych w usłudze Azure Key Vault](store-credentials-in-key-vault.md). | Tak |
...
| Właściwość | Opis | Wymagane |
|:--- |:--- |:--- |
| type | Właściwość typu elementu dataset musi być równa: **MagentoObject** | Tak |
