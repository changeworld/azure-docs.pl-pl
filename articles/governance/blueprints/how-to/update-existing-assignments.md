---
title: Jak zaktualizować istniejące przypisanie z portalu
description: Informacje o mechanizmie aktualizowania istniejącego przypisania z portalu w planach platformy Azure.
author: DCtheGeek
ms.author: dacoulte
ms.date: 10/25/2018
ms.topic: conceptual
...
1. Strona **Przypisz plan** spowoduje załadowanie wstępnie wypełnionych wszystkich wartości z oryginalnego przypisania. Można zmienić **wersję definicji**planu, stan **przypisania blokady** i wszystkie parametry dynamiczne, które istnieją w definicji strategii. Po wprowadzeniu zmian kliknij przycisk **Przypisz** .
...
- Przypisania zasad
  ...
  - Jeśli definicja przypisania zasad zostanie zmieniona, zostanie utworzone nowe przypisanie zasad. Wcześniej wdrożone przypisania zasad są pozostawione w miejscu.
