...
Wdrożenie planu jest wyzwalane przez przypisanie planu do subskrypcji lub [zaktualizowanie istniejącego przydziału](../how-to/update-existing-assignments.md). Podczas wdrażania planów platformy Azure wykonuje następujące kroki wysokiego poziomu:

> [!div class="checklist"]
> - Plany platformy Azure przyznały prawa właścicielom
> - Obiekt przydziału planu jest tworzony
> - Opcjonalnie — plany platformy Azure tworzą tożsamość zarządzaną **przypisaną do systemu**
> - Tożsamość zarządzana wdraża artefakty planu
> - Usługa Azure Blueprints i prawa tożsamości **zarządzanej przypisane do systemu** są odwoływane

## <a name="azure-blueprints-granted-owner-rights"></a>Plany platformy Azure przyznały prawa właścicielom

Podmiot usługi Azure Blueprints otrzymuje prawa właściciela do przypisanej subskrypcji lub subskrypcji, gdy używana jest tożsamość zarządzana [tożsamości przypisanej przez system.](../../../active-directory/managed-identities-azure-resources/overview.md) Przyznana rola umożliwia planom platformy Azure tworzenie, a później odwoływanie tożsamości **zarządzanej przypisanej przez system.** Jeśli przy użyciu tożsamości **zarządzanej przypisane przez użytkownika,** jednostki usługi Azure Blueprints nie pobiera i nie potrzebuje praw właściciela w ramach subskrypcji.
...
## <a name="optional---azure-blueprints-creates-system-assigned-managed-identity"></a>Opcjonalnie — plany platformy Azure tworzą tożsamość zarządzaną przypisaną do systemu

Gdy [tożsamość zarządzana przypisana do systemu](../../../active-directory/managed-identities-azure-resources/overview.md) jest zaznaczona podczas przypisywania, plany platformy Azure tworzy tożsamość i przyznaje tożsamości zarządzanej roli [właściciela.](../../../role-based-access-control/built-in-roles.md#owner) Jeśli [istniejące przypisanie zostanie uaktualnione,](../how-to/update-existing-assignments.md)usługa Azure Blueprints używa wcześniej utworzonej tożsamości zarządzanej.
...
Po zakończeniu wdrażania plany platformy Azure odwołają prawa tożsamości zarządzanej **przypisanej przez system** z subskrypcji. Następnie usługa Azure Blueprints odwołuje swoje prawa z subskrypcji. Usuwanie praw uniemożliwia usługi Azure Blueprints staje się stałym właścicielem w ramach subskrypcji.
