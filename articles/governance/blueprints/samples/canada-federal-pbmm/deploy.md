---
title: Wdrażanie przykładowego planu federalnego pbmm w Kanadzie
description: Wdrażanie kroków dla przykładu planu federalnego pbmm w Kanadzie, w tym szczegółów parametru artefaktu planu.
ms.date: 09/05/2019
ms.topic: sample
...
---
# <a name="deploy-the-canada-federal-pbmm-blueprint-samples"></a>Wdrażanie próbek planu kanadyjskiego federalnego pbmm

Aby wdrożyć próbki planu kanadyjskiego federalnego pbmm, należy podjąć następujące kroki:
...
1. Znajdź przykład planu **Kanadyjskiego Federalnego PBMM** w obszarze _Inne próbki_ i wybierz **użyj tego przykładu**.
...
1. Wybierz **pozycję Publikuj plan** u góry strony. Na nowej stronie po prawej stronie podaj **wersję** dla kopii przykładu planu. Ta właściwość jest przydatna, jeśli dokonasz modyfikacji później. Podaj **informacje o zmianach,** takie jak "Pierwsza wersja opublikowana z przykładowego planu kanadyjskiego federalnego pbmm". Następnie wybierz **pozycję Publikuj** u dołu strony.
...
|\[Wersja\]zapoznawcza : Inspekcja kontroli federalnego pbmm w Kanadzie i wdrażanie określonych rozszerzeń maszyn wirtualnych w celu obsługi wymagań inspekcji |Przypisywanie zasad |Grupa administratorów |Grupa. Przykład: `Administrator; myUser1; myUser2` |
...
Teraz, gdy przejrzysz kroki wdrażania próbki kanadyjskiego federalnego pbmm, odwiedź następujące artykuły, aby dowiedzieć się więcej o mapowaniu przeglądowym i sterującym:

> [!div class="nextstepaction"]
> [Kanada Federalne PBMM plany - Przegląd](./index.md)
> [Kanada Federalne PBMM plany - Mapowanie kontroli](./control-mapping.md)
