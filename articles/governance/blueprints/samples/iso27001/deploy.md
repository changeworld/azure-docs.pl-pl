...
|Dozwolone jednostki SKU maszyn wirtualnych|Przypisywanie zasad|Lista dozwolonych jednostek SKU maszyn wirtualnych|Lista jednostek SKU, które można określić dla maszyn wirtualnych.|
...
> Strategia [iso 27001 — omówienie](./index.md)
