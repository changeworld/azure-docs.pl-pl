---
title: Przykład — FedRAMP wysokie plany — kroki wdrażania
...
|Wersja zapoznawcza \[\]: Inspekcja FedRAMP wysoka kontrola i wdrażanie określonych rozszerzeń maszyn wirtualnych do obsługi wymagań inspekcji|Przypisywanie zasad|Ocena luk w zabezpieczeniach powinna być włączona na Twoich serwerach SQL|Informacje dotyczące efektów zasad można znaleźć w [opisie efektów Azure Policy](../../../policy/concepts/effects.md).|
...
|Wersja zapoznawcza \[\]: Inspekcja FedRAMP wysoka kontrola i wdrażanie określonych rozszerzeń maszyn wirtualnych do obsługi wymagań inspekcji|Przypisywanie zasad|Funkcja aplikacji powinny być dostępne tylko za pośrednictwem protokołu HTTPS|Informacje dotyczące efektów zasad można znaleźć w [opisie efektów Azure Policy](../../../policy/concepts/effects.md).|
...
> [FedRAMP High plan —](./index.md)
> Omówienie [FedRAMP wysokiego planu kontroli planów](./control-mapping.md)
