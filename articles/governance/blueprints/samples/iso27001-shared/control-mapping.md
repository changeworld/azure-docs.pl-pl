---
title: Przykładowe kontrole planu usług udostępnionych ISO 27001
description: Mapowanie sterowania przykładem planu usług udostępnionych ISO 27001. Każdy formant jest mapowany na jedną lub więcej zasad platformy Azure, które pomagają w ocenie.
ms.date: 01/13/2020
ms.topic: sample
...
---
# <a name="control-mapping-of-the-iso-27001-shared-services-blueprint-sample"></a>Mapowanie sterowania przykładowym planem usług udostępnionych ISO 27001

W poniższym artykule opisano, jak plan usług udostępnionych azure blueprints ISO 27001 mapuje przykładowe mapy do formantów ISO 27001. Aby uzyskać więcej informacji na temat kontrolek, zobacz [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
Teraz, po przejrzeniu mapowania sterowania planu usług udostępnionych ISO 27001, odwiedź następujące artykuły, aby dowiedzieć się więcej o architekturze i jak wdrożyć ten przykład:

> [!div class="nextstepaction"]
> [Plan usług udostępnionych ISO 27001 — omówienie](./index.md)
> [planu usług udostępnionych ISO 27001 — kroki wdrażania](./deploy.md)
