---
title: Wdrażanie przykładowego planu NIST SP 800-53 R4
description: Wdrażanie kroków dla przykładu planu NIST SP 800-53 R4, w tym szczegółów parametru artefaktu planu.
ms.date: 11/18/2019
ms.topic: sample
...
---
# <a name="deploy-the-nist-sp-800-53-r4-blueprint-sample"></a>Wdrażanie przykładowego planu NIST SP 800-53 R4

Aby wdrożyć przykład planu Azure Blueprints NIST SP 800-53 R4, należy wykonać następujące kroki:
...
1. Znajdź przykład planu **NIST SP 800-53 R4** w obszarze _Inne próbki_ i wybierz **użyj tego przykładu**.
...
Teraz, gdy przejrzysz kroki wdrażania przykładu planu NIST SP 800-53 R4, odwiedź następujące artykuły, aby dowiedzieć się więcej o mapowaniu planu i kontroli:

> [!div class="nextstepaction"]
> [NIST SP 800-53 R4 plan - Przegląd](./index.md)
> [NIST SP 800-53 R4 plan - Mapowanie sterowania](./control-mapping.md)
