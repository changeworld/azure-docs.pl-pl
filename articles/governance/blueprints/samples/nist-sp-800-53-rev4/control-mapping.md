---
title: NIST SP 800-53 R4 kontroli przykładu planu
description: Mapowanie sterowania próbki planu NIST SP 800-53 R4. Każdy formant jest mapowany na jedną lub więcej zasad platformy Azure, które pomagają w ocenie.
ms.date: 11/18/2019
ms.topic: sample
...
---
# <a name="control-mapping-of-the-nist-sp-800-53-r4-blueprint-sample"></a>Mapowanie sterowania przykładem planu NIST SP 800-53 R4

W poniższym artykule opisano, jak azure blueprints NIST SP 800-53 R4 planu przykładowe mapy do NIST SP 800-53 R4 formantów. Aby uzyskać więcej informacji na temat elementów sterujących, zobacz [NIST SP 800-53](https://nvd.nist.gov/800-53).

Poniższe mapowania są do **NIST SP 800-53 (Rev. 4)** formanty. Użyj nawigacji po prawej stronie, aby przejść bezpośrednio do określonego mapowania sterowania. Wiele mapowanych formantów są implementowane za pomocą inicjatywy [azure policy.](../../../policy/overview.md) Aby przejrzeć pełną inicjatywę, otwórz **policy** w witrynie Azure portal i wybierz stronę **Definicje.** Następnie znajdź i wybierz ** \[podgląd:\]Inspekcja kontroli NIST SP 800-53 R4 i wdrożyć określone rozszerzenia maszyn wirtualnych, aby obsługiwać wbudowaną** inicjatywę zasad dotyczącą wymagań inspekcji.
...
## <a name="ac-16-security-attributes"></a>Ac-16 Atrybuty zabezpieczeń
...
Teraz, po przejrzeniu mapowania sterowania planu NIST SP 800-53 R4, odwiedź następujące artykuły, aby dowiedzieć się więcej o planie i jak wdrożyć ten przykład:

> [!div class="nextstepaction"]
> [NIST SP 800-53 R4 plan - Przegląd](./index.md)
