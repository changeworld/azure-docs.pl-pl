...
description: Kontrolowanie mapowania NIST SP 800-53 R4 planu próbki do usługi Azure Policy.
author: DCtheGeek
ms.author: dacoulte
ms.date: 06/24/2019
ms.topic: sample
...
- \[Podgląd\]: Przeprowadź inspekcję konta zewnętrzne z uprawnieniami do odczytu w ramach subskrypcji
...
- \[Podgląd\]: Monitoruj ewentualny dostęp tylko w czas (JIT) w usłudze Azure Security Center
...
- \[Podgląd\]: Inspekcja ograniczenia dostępu do zasobu CORS dla aplikacji sieci Web
...
- \[Podgląd\]: Przeprowadź inspekcję stanu debugowania zdalnego dla aplikacji funkcji
- \[Podgląd\]: Przeprowadź inspekcję stanu debugowania zdalnego dla aplikacji sieci Web
- \[Podgląd\]: Przeprowadź inspekcję stanu debugowania zdalnego dla aplikacji interfejsu API
- \[Podgląd\]: Przeprowadź inspekcję maszyn wirtualnych systemu Linux nie zezwalaj na połączenia zdalne z kont bez hasła
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej, aby przeprowadzić inspekcję maszyn wirtualnych systemu Linux nie zezwalaj na połączenia zdalne z kont bez hasła
...
- \[Podgląd\]: Inspekcja Analytics obszar roboczy usługi Log dla maszyny Wirtualnej — niezgodność raportu
- \[Podgląd\]: Wdrażanie programu Log Analytics Agent for Linux VM Scale Sets (zestawu skalowania maszyn wirtualnych)
- \[Podgląd\]: Wdrażanie programu Log Analytics Agent na maszynach wirtualnych systemu Linux
- \[Podgląd\]: Wdrażanie programu Log Analytics Agent Windows VM Scale Sets (zestawu skalowania maszyn wirtualnych)
...
- \[Podgląd\]: Monitorowanie bez inspekcji serwerów SQL w usłudze Azure Security Center
...
- \[Podgląd\]: Monitorowanie aplikacji możliwe umieszczania na białej liście w usłudze Azure Security Center
...
## <a name="cm-11-user-installed-software"></a>Oprogramowanie zainstalowane przez użytkowników zarządzania certyfikatami w usłudze – 11
...
- \[Podgląd\]: Przeprowadź inspekcję maszyn wirtualnych systemu Linux nie mają kont bez hasła
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej, aby przeprowadzić inspekcję maszyn wirtualnych systemu Linux nie mają kont bez hasła
- \[Podgląd\]: Przeprowadź inspekcję, maszyn wirtualnych systemu Linux ma uprawnienia do pliku haseł równa 0644
- \[Podgląd\]: Inspekcja, że maszyny wirtualne Windows przechowywanie haseł przy użyciu szyfrowania odwracalnego
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej, aby przeprowadzić inspekcję, maszyn wirtualnych systemu Linux ma uprawnienia do pliku haseł równa 0644
...
- \[Podgląd\]: Przeprowadź inspekcję maszyn wirtualnych Windows ponownie klauzuli poprzednich haseł 24
- \[Podgląd\]: Inspekcja, że maszyny wirtualne Windows mają maksymalny okres ważności hasła wynoszącego 70 dni
- \[Podgląd\]: Inspekcja, że maszyny wirtualne Windows mają minimalny okres ważności hasła 1 dzień
- \[Podgląd\]: Inspekcja, że maszyny wirtualne Windows mają włączone ustawienie złożoność hasła
- \[Podgląd\]: Inspekcja, że maszyny wirtualne Windows ograniczać przydziału obowiązków minimalnej długości hasła do 14 znaków
- \[Podgląd\]: Inspekcja, że maszyny wirtualne Windows przechowywanie haseł przy użyciu szyfrowania odwracalnego
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej do inspekcji, że maszyny wirtualne Windows ponownie nie mogą używać poprzednich haseł 24
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej do inspekcji, że maszyny wirtualne Windows mają maksymalny okres ważności hasła wynoszącego 70 dni
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej do inspekcji, że maszyny wirtualne Windows mają minimalny okres ważności hasła 1 dzień
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej do inspekcji, że maszyny wirtualne Windows mają włączone ustawienie złożoność hasła
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej do inspekcji, że maszyny wirtualne Windows ograniczać przydziału obowiązków minimalnej długości hasła do 14 znaków
- \[Podgląd\]: Wdrażanie rozszerzenia maszyny Wirtualnej do inspekcji, że maszyny wirtualne Windows przechowywanie haseł przy użyciu szyfrowania odwracalnego
...
- Serwery SQL bez zaawansowane zabezpieczenia danych inspekcji
- Wdrażanie zaawansowanych danych na serwerach SQL
- \[Podgląd\]: Luki w zabezpieczeniach inspekcji systemu operacyjnego w zestawie skalowania maszyn wirtualnych ustawia się w usłudze Azure Security Center
...
- \[Podgląd\]: Warstwa standardowa inspekcji DDoS Protection jest włączona dla sieci wirtualnej
...
- \[Podgląd\]: Monitorowanie maszyn wirtualnych z Internetu dla ruchu sieciowej grupy zabezpieczeń, rekomendacje dotyczące ograniczania funkcjonalności
...
- \[Podgląd\]: Monitoruj niezaszyfrowane bazy danych SQL w usłudze Azure Security Center
...
- \[Podgląd\]: Inspekcja dowolnych brakujących aktualizacji systemu na zestawach skalowania maszyn wirtualnych w usłudze Azure Security Center
- \[Podgląd\]: Luki w zabezpieczeniach inspekcji systemu operacyjnego w zestawie skalowania maszyn wirtualnych ustawia się w usłudze Azure Security Center
...
- \[Podgląd\]: Inspekcja rozwiązanie do ochrony punktu końcowego na zestawach skalowania maszyn wirtualnych w usłudze Azure Security Center
...
Teraz, gdy przejrzeniu mapowanie kontrolek planu R4 SP NIST 800-53, odwiedź następujące artykuły, aby dowiedzieć się więcej o planu i sposobu wdrażania w tym przykładzie:

> [!div class="nextstepaction"]
> [SP NIST 800-53 R4 planu — omówienie](./index.md)
> [R4 SP NIST 800-53 planu — wdrażanie kroki](./deploy.md)
