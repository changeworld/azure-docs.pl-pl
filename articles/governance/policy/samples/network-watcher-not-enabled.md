...
description: Ta przykładowa definicja zasad przeprowadza inspekcję, jeśli obserwator sieciowy nie jest włączony dla określonego regionu zdefiniowanego w parametrze.
ms.date: 01/23/2019
ms.topic: sample
