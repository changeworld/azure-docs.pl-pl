---
title: Przykładowe zasady usługi Azure Policy — Wymuszanie tagu i jego wartości
description: Te przykładowe zasady wymagają określonej nazwy i wartości tagu.
...
ms.locfileid: "46982872"
---
# <a name="enforce-tag-and-its-value"></a>Enforce tag and its value (Wymuś tag i jego wartość)

Ta zasada wymaga określonej nazwy i wartości tagu. Należy określić nazwę i wartość tagu do wymuszenia.
