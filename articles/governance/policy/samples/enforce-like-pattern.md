...
description: Ta przykładowa definicja zasad wymaga, aby zasoby spełniały wzorzec like zdefiniowany w parametrze konwencji nazewnictwa.
ms.date: 01/23/2019
ms.topic: sample
