...
description: Ta przykładowa definicja zasad wymaga, aby bramy aplikacji używały zatwierdzonej jednostki SKU zdefiniowanej w parametrze.
ms.date: 01/23/2019
ms.topic: sample
