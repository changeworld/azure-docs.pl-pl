---
title: Przykład — Wymuszaj tag i jego wartość w grupach zasobów
description: Ta przykładowa definicja zasad wymaga znacznika i wartości w grupie zasobów.
author: DCtheGeek
...
ms.locfileid: "71977171"
---
# <a name="sample---enforce-tag-and-its-value-on-resource-groups"></a>Przykład — Wymuszaj tag i jego wartość w grupach zasobów

Te zasady wymagają znacznika i wartości w grupie zasobów. Należy określić wymaganą nazwę i wartość tagu.
