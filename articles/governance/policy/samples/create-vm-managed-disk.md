---
title: Przykładowa Inspekcja maszyny wirtualnej z nieużywanym dyskiem zarządzanym
description: Ta definicja próbki JSON przeprowadza inspekcję podczas tworzenia maszyny wirtualnej, która nie korzysta z dysków zarządzanych.
author: DCtheGeek
...
ms.locfileid: "71980561"
---
# <a name="sample---audit-when-vm-does-not-use-managed-disk"></a>Próbkowanie — Inspekcja, gdy maszyna wirtualna nie korzysta z dysku zarządzanego

Przeprowadza inspekcję po utworzeniu maszyny wirtualnej, która nie korzysta z dysków zarządzanych.
