...
description: Ta przykładowa definicja w formacie JSON sprawdza, czy utworzona maszyna wirtualna nie korzysta z dysków zarządzanych.
author: DCtheGeek
manager: carmonm
...
ms.locfileid: "59271445"
---
# <a name="sample---audit-when-vm-does-not-use-managed-disk"></a>Przykład — sprawdzanie, czy maszyna wirtualna nie używa dysku zarządzanego

Sprawdza, czy utworzona maszyna wirtualna nie korzysta z dysków zarządzanych.
