...
description: Ta przykładowa definicja zasad wymaga, aby interfejsy sieciowe używały zatwierdzonej sieci wirtualnej zdefiniowanej w parametrze.
ms.date: 01/23/2019
ms.topic: sample
