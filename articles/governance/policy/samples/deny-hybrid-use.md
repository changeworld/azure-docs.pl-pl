...
description: Ta przykładowa definicja zasad zabrania korzystania z korzyści z używania hybrydowej platformy Azure (— AHUB) dla maszyn wirtualnych i zestawów skalowania maszyn wirtualnych.
ms.date: 01/23/2019
ms.topic: sample
