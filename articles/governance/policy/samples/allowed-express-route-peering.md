...
description: Ta przykładowa definicja zasad wymaga, aby ExpressRoute używać określonych lokalizacji komunikacji równorzędnej zdefiniowanych w parametrze.
ms.date: 01/23/2019
ms.topic: sample
