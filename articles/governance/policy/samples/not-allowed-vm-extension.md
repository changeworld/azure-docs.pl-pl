...
description: Ta przykładowa definicja zasad zabrania używania określonych rozszerzeń zdefiniowanych w parametrze na maszynach wirtualnych.
ms.date: 01/23/2019
ms.topic: sample
