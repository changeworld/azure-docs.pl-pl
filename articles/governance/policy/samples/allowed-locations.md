...
description: Ta przykładowa definicja zasad wymaga, aby wszystkie zasoby zostały wdrożone do zatwierdzonych lokalizacji zdefiniowanych w parametrze.
ms.date: 01/26/2019
ms.topic: sample
