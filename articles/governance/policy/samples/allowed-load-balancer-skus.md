---
title: Przykładowa dozwolona jednostka SKU modułu równoważenia obciążenia
description: Ta przykładowa definicja zasad wymaga, aby moduły równoważenia obciążenia używały zatwierdzonej jednostki SKU.
author: DCtheGeek
...
ms.locfileid: "71980657"
---
# <a name="sample---allowed-load-balancer-skus"></a>Przykładowa dozwolona jednostka SKU modułu równoważenia obciążenia

Te zasady wymagają, aby moduły równoważenia obciążenia używały zatwierdzonej jednostki SKU. Należy określić tablicę dozwolonych jednostek SKU.
