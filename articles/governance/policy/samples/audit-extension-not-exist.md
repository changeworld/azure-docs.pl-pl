...
description: Ta przykładowa definicja zasad przeprowadza inspekcję, jeśli rozszerzenie zdefiniowane w parametrze nie jest wdrożone na maszynie wirtualnej.
ms.date: 01/23/2019
ms.topic: sample
