...
1. Jeśli zestaw SDK identyfikuje **nieodwracalny błąd**, ponowną próbą zgodnie z zasadami określonego ponownych prób, dopóki nie upłynie zdefiniowanego limitu czasu.
...
- **Wycofywanie Wykładnicze z zakłócenia**: jest zwykle te domyślne zasady ponawiania agresywne na początku i spowolnić wraz z upływem czasu, aż do napotkania Maksymalne opóźnienie. Projekt będzie opierać się na [wskazówki dotyczące z Centrum architektury platformy Azure ponawiania prób](https://docs.microsoft.com/azure/architecture/best-practices/retry-service-specific).
