...
| Cele | Za pomocą pojedynczego urządzenia **deviceId**, lub wielu urządzeń przy użyciu [zadań](iot-hub-devguide-jobs.md). | Za pomocą pojedynczego urządzenia **deviceId**, lub wielu urządzeń przy użyciu [zadań](iot-hub-devguide-jobs.md). | Pojedyncze urządzenie przez **deviceId**. |
