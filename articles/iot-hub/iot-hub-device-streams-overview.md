...
Alternatywnie informacji punkty końcowe można pobrać przy użyciu wiersza polecenia platformy Azure w Centrum w sekcji właściwości, w szczególności `property.hostname` i `property.deviceStreams` kluczy.
