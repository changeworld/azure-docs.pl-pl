...
* Klucz `statusCode` w treści opinii ma jedną z następujących wartości: *Powodzenie*, *wygasło*, *DeliveryCountExceeded*, *odrzucone*lub *przeczyszczane*.
