...
1. Za pomocą edytora tekstu Utwórz plik testowy, który zostanie przekazany do magazynu obiektów blob. 
...
1. Dodaj następujący kod `import` instrukcji i zmienne na początku **FileUpload.py** pliku. 
