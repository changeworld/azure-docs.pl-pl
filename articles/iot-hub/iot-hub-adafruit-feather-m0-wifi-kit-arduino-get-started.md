...
W tym samouczku rozpoczniesz od nauki podstawy pracy z urządzeniem Arduino tablicy. Następnie dowiesz się, jak bezproblemowe łączenie urządzeń do chmury przy użyciu [usługi Azure IoT Hub](iot-hub-what-is-iot-hub.md).
