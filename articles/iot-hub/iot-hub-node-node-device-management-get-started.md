...
W tej sekcji zostaną wykonane następujące kroki:
...
5. Dodaj zmienną **connectionString** i użyj jej do utworzenia wystąpienia **Client**.  Zamień parametry połączenia na parametry połączenia urządzenia.  
