...
* Bliźniacza reprezentacja urządzenia i właściwości: [Wprowadzenie do bliźniaków urządzeń] [ lnk-get-started-twin] i [samouczka: Jak korzystać z właściwości bliźniaczych reprezentacji urządzeń][lnk-twin-props]
