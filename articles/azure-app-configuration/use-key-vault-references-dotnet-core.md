...
1. W poniższych poleceniach Dodaj wpisy tajne w miejscu *clientId* i *ClientSecret* do Menedżera kluczy tajnych. Polecenia należy uruchomić w tym samym katalogu, w którym znajduje się plik *. csproj* .
