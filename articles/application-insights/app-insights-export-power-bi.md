...
3. Na **wyeksportować** menu, wybierz **usługi Power BI (M)**. Zapisz plik tekstowy.
    ...
    ![Zrzut ekranu usługi Analytics, za pomocą menu eksportu wyróżniony](./media/app-insights-export-power-bi/analytics-export-power-bi.png)
...
3. W programie Power BI Desktop, wybierz **Pobierz dane** > **puste zapytanie**. Następnie w edytorze zapytań w ramach **widoku**, wybierz opcję **edytora zaawansowanego**.
   ...
   ![Zrzut ekranu programu Power BI Desktop z wyróżnionym przyciskiem puste zapytanie](./media/app-insights-export-power-bi/blankquery.png)

   Wklej wyeksportowanego skryptu języka M do edytora zaawansowanego. 

   ![Zrzut ekranu programu Power BI Desktop, za pomocą edytora zaawansowanego wyróżniony](./media/app-insights-export-power-bi/advancedquery.png)

4. Wybierz elementy z zapytania, a następnie wybierz wizualizację lejka.

   ![Zrzut ekranu usługi Power BI Desktop Opcje wizualizacji](./media/app-insights-export-power-bi/selectsequence.png)

5. Zmień tytuł na dowolnie zrozumiałe i opublikować raport do obszaru roboczego usługi Power BI chmury. 

   ![Zrzut ekranu programu Power BI Desktop, zmiana tytułu wyróżniony](./media/app-insights-export-power-bi/changetitle.png)
...
2. Otwórz **Pobierz dane** ![zrzut ekranu GetData ikony w lewym dolnym rogu](./media/app-insights-export-power-bi/001.png), **usług**.

    ![Zrzuty ekranu z uzyskiwanie źródła danych usługi Application Insights](./media/app-insights-export-power-bi/002.png)

3. Wybierz **Pobierz teraz** w ramach usługi Application Insights.

   ![Zrzuty ekranu z uzyskiwanie źródła danych usługi Application Insights](./media/app-insights-export-power-bi/003.png)
4. Podaj szczegóły zasobu usługi Application Insights, a następnie **logowania**.

    ![Zrzut ekranu z uzyskiwanie źródła danych usługi Application Insights](./media/app-insights-export-power-bi/005.png)

     Te informacje można znaleźć w okienku Omówienie usługi Application Insights:

     ![Zrzut ekranu z uzyskiwanie źródła danych usługi Application Insights](./media/app-insights-export-power-bi/004.png)

5. Otwórz nowo utworzony Application Insights aplikację Power BI.

6. Poczekaj minutę lub dwie dane do zaimportowania.

    ![Zrzut ekranu usługi Power BI karty](./media/app-insights-export-power-bi/010.png)
