...
- Dowiedz się, jak używać [interfejsu API usługi Application Insights dla niestandardowych zdarzeń i metryk](app-insights-api-custom-events-metrics.md#trackmetric).
