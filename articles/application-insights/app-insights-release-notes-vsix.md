...
![Narzędzie trendy usługi Application Insights](./media/app-insights-release-notes-vsix/Trends.png)
...
![Obsługa narzędzi diagnostycznych](./media/app-insights-release-notes-vsix/DiagnosticTools.png)
...
![Menu kontekstowe projektu dla aplikacji Universal Windows apps](./media/app-insights-release-notes-vsix/UniversalContextMenu.png)
...
![Okno dialogowe dla aplikacji Universal Windows apps przekazywanie](./media/app-insights-release-notes-vsix/UniversalUploadDialog.png)
...
![Powiadomienie o ukończeniu przekazywania](./media/app-insights-release-notes-vsix/UploadComplete.png)
...
![Okno dialogowe dla aplikacji Windows Forms przekazywanie](./media/app-insights-release-notes-vsix/WinFormsUploadDialog.png)
...
![Powiadamiania o rejestrowaniu](./media/app-insights-release-notes-vsix/LoggingToast.png)
...
![Ślady](./media/app-insights-release-notes-vsix/Traces.png)
...
![Znajdź dopasowanie](./media/app-insights-release-notes-vsix/FindMatch.png)
...
![Powiązane elementy](./media/app-insights-release-notes-vsix/RelatedItems.png)
...
![Wyszukaj w Eksploratorze rozwiązań](./media/app-insights-release-notes-vsix/searchentry.png)
...
![Powiadomienie o ukończeniu publikowania](./media/app-insights-release-notes-vsix/publishtoast.png)
...
![Strony narzędzia do diagnostyki](./media/app-insights-release-notes-vsix/diagtools.png)
...
![Okno dialogowe Nowy projekt](./media/app-insights-release-notes-vsix/newproject.png)
