...
Aby uzyskać więcej informacji o tym, jak zastąpić właściwości cloud_RoleName z inicjatorami telemetrii, zobacz [dodać właściwości: ITelemetryInitializer](app-insights-api-filtering-sampling.md#add-properties-itelemetryinitializer).
...
4. Upewnij się, [cloud_RoleName](app-insights-app-map.md#Set-cloud-RoleName) jest poprawnie skonfigurowana.
...
Aby przekazać opinię, użyj opcji opinii w portalu.
