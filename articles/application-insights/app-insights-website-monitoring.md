...
1. Wybierz pozycję **Przegląd**  >  **Podstawy** i skopiuj **klucz instrumentacji** aplikacji.
   ...
   ![Formularz nowego zasobu usługi App Insights](media/app-insights-website-monitoring/instrumentation-key-001.png)
