...
ms.locfileid: "69544476"
---
# <a name="configure-vsan-encryption-for-your-cloudsimple-private-cloud"></a>Skonfiguruj szyfrowanie sieci vSAN dla prywatnej chmury CloudSimple
...
W przypadku korzystania z szyfrowania sieci vSAN oprogramowanie VMware wymaga użycia zewnętrznego KMIP 1,1 zgodnego z serwerem zarządzania kluczami (KMS) innej firmy. Możesz użyć dowolnego obsługiwanego usługi KMS, który jest certyfikowany przez program VMware i jest dostępny dla platformy Azure.

Poniżej przedstawiono sposób korzystania z HyTrust kontroli usługi KMS uruchomionej w sieci wirtualnej platformy Azure. Podobne podejście może być używane w przypadku wszelkich innych certyfikowanych rozwiązań usługi KMS innych firm dla sieci vSAN.
...
![Klaster usługi KMS w usłudze Azure Virtual Network](media/vsan-kms-cluster.png)

## <a name="how-to-deploy-the-solution"></a>Jak wdrożyć rozwiązanie

Proces wdrażania obejmuje następujące kroki:

1. [Sprawdź, czy wymagania wstępne są spełnione](#verify-that-prerequisites-are-met)
...
### <a name="verify-that-prerequisites-are-met"></a>Sprawdź, czy wymagania wstępne są spełnione
...
Aby wdrożyć klaster kontroli HyTrust Azure Resource Manager w sieci wirtualnej, należy wykonać następujące zadania. Szczegółowe informacje znajdują się w <a href="https://docs.hytrust.com/DataControl/Admin_Guide-4.0/Default.htm#OLH-Files/Azure.htm%3FTocPath%3DHyTrust%2520DataControl%2520and%2520Microsoft%2520Azure%7C_____0" target="_blank">dokumentacji HyTrust</a> .
...
Przejdź do https://*Public-IP*, gdzie *Public-IP* jest publicznym adresem IP maszyny wirtualnej węzła kontrolki. Wykonaj te kroki z <a href="https://docs.hytrust.com/DataControl/Admin_Guide-4.0/Default.htm#OLH-Files/Azure.htm%3FTocPath%3DHyTrust%2520DataControl%2520and%2520Microsoft%2520Azure%7C_____0" target="_blank">dokumentacji HyTrust</a>.

1. <a href="https://docs.hytrust.com/DataControl/4.2/Admin_Guide-4.2/index.htm#Books/VMware-vSphere-VSAN-Encryption/configuring-kmip-server.htm%3FTocPath%3DHyTrust%2520KeyControl%2520with%2520VSAN%25C2%25A0and%2520VMware%2520vSphere%2520VM%2520Encryption%7C_____2" target="_blank">Konfigurowanie serwera KMIP</a>
2. <a href="https://docs.hytrust.com/DataControl/4.2/Admin_Guide-4.2/index.htm#Books/VMware-vSphere-VSAN-Encryption/creating-user-for-vmcrypt.htm%3FTocPath%3DHyTrust%2520KeyControl%2520with%2520VSAN%25C2%25A0and%2520VMware%2520vSphere%2520VM%2520Encryption%7C_____3" target="_blank">Tworzenie pakietu certyfikatów na potrzeby szyfrowania oprogramowania VMware</a>
...
Postępuj zgodnie z instrukcjami HyTrust, aby <a href="https://docs.hytrust.com/DataControl/4.2/Admin_Guide-4.2/index.htm#Books/VMware-vSphere-VSAN-Encryption/creating-KMS-Cluster.htm%3FTocPath%3DHyTrust%2520KeyControl%2520with%2520VSAN%25C2%25A0and%2520VMware%2520vSphere%2520VM%2520Encryption%7C_____4" target="_blank">utworzyć klaster usługi KMS w programie vCenter</a>.
