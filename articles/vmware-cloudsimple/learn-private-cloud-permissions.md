...
> [!NOTE]
> Domyślny użytkownik vCenter CloudSimple prywatnej chmury jest cloudowner@cloudsimple.local podczas tworzenia chmury prywatnej.
...
| **Operacje kryptograficzne** | Dodawanie dysku <br> Klonowanie <br> Odszyfrowywanie <br> Bezpośredni dostęp <br> Szyfrowanie <br> Szyfruj nowe <br> Zarządzanie usługą KMS <br> Zarządzanie zasadami szyfrowania <br> Zarządzanie kluczami <br> Migrate (Migracja) <br> Recrypt <br> Zarejestruj maszynę wirtualną <br> Zarejestruj hosta |
| **Grupa dvPort** | Tworzenie <br> Usuń <br> Modyfikuj <br> Operacja zasad <br> Operacja zakresu |
...
| **Interakcja > maszyny wirtualnej** | Odpowiedź na pytanie <br> Operacja tworzenia kopii zapasowej na maszynie wirtualnej <br> Konfigurowanie nośnika CD <br> Konfigurowanie dyskietki <br> Interakcja z konsolą <br> Utwórz zrzut ekranu <br> Defragmentacja wszystkich dysków <br> Połączenie z urządzeniem <br> Przeciągnij i upuść <br> Zarządzanie systemem operacyjnym gościa za pomocą interfejsu API VIX <br> Wstawianie kodów skanowania HID USB <br> Wstrzymywanie lub wstrzymywanie wstrzymania <br> Wykonywanie operacji czyszczenia lub zmniejszania <br> Zasilanie wyłączone <br> Włącz <br> Rejestruj sesję na maszynie wirtualnej <br> Odtwórz ponownie sesję na maszynie wirtualnej <br> Reset <br> Wznów odporność na uszkodzenia <br> Zawieszenia <br> Wstrzymywanie odporności na uszkodzenia <br> Testowanie pracy w trybie failover <br> Uruchom ponownie pomocniczą maszynę wirtualną <br> Wyłącz odporność na uszkodzenia <br> Włącz odporność na uszkodzenia <br> Instalacja narzędzi VMware |
| **Spis > maszyny wirtualnej** | Utwórz na podstawie istniejącego <br> Tworzenie nowego elementu <br> Move <br> Zarejestruj subskrypcję <br> Usuń <br> Unregister |
