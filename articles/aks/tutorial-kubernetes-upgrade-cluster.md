...
W poniższym przykładzie bieżąca wersja to *1.13.9*, a dostępne wersje są wyświetlane w kolumnie *uaktualnienia* .
...
Następujące przykładowe dane wyjściowe przedstawiają AKS klaster *KubernetesVersion 1.14.5*:
