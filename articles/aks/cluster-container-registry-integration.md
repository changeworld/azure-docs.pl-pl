...
Użyj poniższego polecenia, aby zalogować się do ACR.  Zastąp parametr <acrname> nazwą ACR.  Na przykład wartość domyślna to **aks < grupy zasobów > ACR**.
