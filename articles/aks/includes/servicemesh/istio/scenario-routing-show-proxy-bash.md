...
ms.locfileid: "72530162"
---
```bash
kubectl describe pod -l "app=voting-analytics, version=1.0" -n voting | egrep "istio-proxy:|voting-analytics:" -A2
```

Kontener `istio-proxy` został automatycznie wstrzyknięty przez Istio do zarządzania ruchem sieciowym do i ze składników, jak pokazano w następujących przykładowych danych wyjściowych:
