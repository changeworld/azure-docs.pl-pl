...
## <a name="enable-virtual-nodes"></a>Włącz wirtualne węzły

Aby zapewnić dodatkowe funkcje, łącznik wirtualnych węzłów używa rozszerzenia wiersza polecenia platformy Azure. Aby można było włączyć łącznik wirtualnych węzłów, najpierw zainstalować rozszerzenie przy użyciu polecenia [Dodaj rozszerzenie az] [ az-extension-add] polecenia:
