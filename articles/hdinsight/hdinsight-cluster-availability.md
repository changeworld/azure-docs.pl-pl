...
![Przykład Log Analytics blok dzienników obszaru roboczego "niedostępne komputery"](media/hdinsight-cluster-availability/portal-unavailable-computers.png)
...
![Reguła alertu Utwórz nową grupę akcji](media/hdinsight-cluster-availability/portal-create-new-action-group.png)
...
![Tworzenie grupy akcji przez regułę alertu](media/hdinsight-cluster-availability/portal-add-action-group.png)
...
![Zakończenie tworzenia reguły alertu portalu](media/hdinsight-cluster-availability/portal-create-alert-rule-finish.png)
