...
W tym samouczku użyjesz [notesu programu Jupyter](https://jupyter.org/) dostępne przy użyciu klastrów HDInsight Spark, aby uruchomić zadanie, która odczytuje dane z konta Data Lake Store.
