...
2. Wprowadź następujące wartości:
    ...
    | **Nazwa klastra**|Wprowadź nazwę klastra, który chcesz utworzyć. Nazwą nowego klastra używaną w tym przewodniku Szybki start jest **myspark20180403**.|
