...
Aby uzyskać więcej informacji, zobacz artykuł [dostępne z różnymi wersjami HDInsight składniki usługi Hadoop](../hdinsight-component-versioning.md#hadoop-components-available-with-different-hdinsight-versions)
