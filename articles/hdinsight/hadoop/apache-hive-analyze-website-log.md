---
title: Korzystanie z programu Hive przy użyciu technologii Apache Hadoop do analizy dzienników witryny sieci Web — Azure HDInsight
description: Dowiedz się, jak używać Apache Hive z HDInsight do analizowania dzienników witryn sieci Web. Będzie używany plik dziennika jako dane wejściowe do tabeli usługi HDInsight, a za pomocą języka HiveQL do wykonywania zapytań o dane.
services: hdinsight
