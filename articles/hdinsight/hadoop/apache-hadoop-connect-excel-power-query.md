...
* **HDInsight an klaster**. Aby je skonfigurować, zobacz [Rozpoczynanie pracy z usługą Azure HDInsight](./apache-hadoop-linux-tutorial-get-started.md).
