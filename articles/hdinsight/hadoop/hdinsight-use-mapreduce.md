...
Przykłady korzystania z usługi Hadoop, przesyłanie strumieniowe w HDInsight zobacz następujący dokument:
...
Aby uzyskać instrukcje dotyczące pisania własnych aplikacji MapReduce zobacz następujący dokument:
