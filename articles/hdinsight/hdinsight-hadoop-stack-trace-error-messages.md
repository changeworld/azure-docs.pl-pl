...
* [Dostęp do aplikacji YARN loguje opartych na systemie Linux platformą Hadoop w usłudze HDInsight](hdinsight-hadoop-access-yarn-app-logs-linux.md)
...
* [Informacje o wersji dla składników platformy Hadoop w usłudze Azure HDInsight](hdinsight-release-notes.md)
