...
Teraz, gdy wiesz jak zapisać do usługi Azure Storage i Azure Data Lake Store za pomocą platformy Apache Storm odnajdywania innych [przykłady Apache Storm HDInsight](apache-storm-example-topology.md).
