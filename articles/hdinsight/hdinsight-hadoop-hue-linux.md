...
1. W bloku **Konfiguracja opcjonalna** wybierz pozycję **Akcje skryptu**, a następnie podaj informacje, jak pokazano poniżej:
...
1. W dolnej części **akcji skryptu**Użyj przycisku **Wybierz** , aby zapisać konfigurację. Na koniec użyj przycisku **Wybierz** znajdującego się u dołu bloku **Konfiguracja opcjonalna** , aby zapisać opcjonalne informacje o konfiguracji.
