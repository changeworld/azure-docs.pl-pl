...
Aby postępować zgodnie z instrukcjami w tym artykule, potrzebne są:
...
* Azure PowerShell i/lub klasyczny interfejs wiersza polecenia platformy Azure.
