...
* [Zarządzanie klastrami Apache Hadoop w HDInsight przy użyciu wiersza polecenia platformy Azure](hdinsight-administer-use-command-line.md#scale-clusters)
