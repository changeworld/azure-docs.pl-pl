...
* Utwórz [klaster platformy Kafka usługi HDInsight, używając pakietu Enterprise Security](https://docs.microsoft.com/azure/hdinsight/domain-joined/apache-domain-joined-run-hive).
