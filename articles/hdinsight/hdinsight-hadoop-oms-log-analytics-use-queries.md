---
title: Zapytanie usługi Azure Log Analytics do monitorowania klastrów Azure HDInsight
description: Dowiedz się, jak uruchamiać zapytania dotyczące usługi Azure Log Analytics do monitorowania zadań uruchamianych w klastrze usługi HDInsight.
services: hdinsight
author: jasonwhowell
ms.reviewer: jasonh
...
Dowiedz się, niektóre podstawowe scenariusze dotyczące sposobu używania usługi Azure Log Analytics do monitorowania klastrów Azure HDInsight:
...
* Konieczne jest posiadanie skonfigurowane w klastrze usługi HDInsight w taki sposób, aby używać usługi Azure Log Analytics oraz dodać rozwiązania zarządzania usługi Log Analytics specyficzne dla klastra HDInsight z obszarem roboczym. Aby uzyskać instrukcje, zobacz [użycia usługi Azure Log Analytics przy użyciu klastrów HDInsight](hdinsight-hadoop-oms-log-analytics-tutorial.md).
...
1. Otwórz obszar roboczy pakietu OMS, który jest skojarzony z klastrem HDInsight w witrynie Azure portal.
2. Wybierz **wyszukiwanie w dzienniku** kafelka.
3. Wpisz następujące zapytanie w polu wyszukiwania, aby wyszukać wszystkie metryki dla wszystkie dostępne metryki dla wszystkich klastrów HDInsight skonfigurowany tak, aby używać usługi Azure Log Analytics, a następnie wybierz **Uruchom**.
...
1. Otwórz obszar roboczy pakietu OMS, który jest skojarzony z klastrem HDInsight w witrynie Azure portal.
2. Wybierz **wyszukiwanie w dzienniku** kafelka.
3. Wpisz następujące zapytanie, aby wyszukać wszystkie komunikaty o błędach dla wszystkich klastrów HDInsight skonfigurowany do używania usługi Azure Log Analytics, a następnie wybierz **Uruchom**. 
...
4. Dostępne są następujące opcje: **Zapisz**, **odrzucić**, **wyłączyć**, i **Usuń**.
    ...
    ![Edytuj alert delete HDInsight Log Analytics w pakiecie OMS](media/hdinsight-hadoop-oms-log-analytics-use-queries/hdinsight-log-analytics-edit-alert.png)

Aby uzyskać więcej informacji, zobacz [Praca z regułami alertów w usłudze Log Analytics](../log-analytics/log-analytics-alerts-creating.md).

## <a name="see-also"></a>Zobacz także

* [Praca z usługą Log Analytics](https://blogs.msdn.microsoft.com/wei_out_there_with_system_center/2016/07/03/oms-log-analytics-create-tiles-drill-ins-and-dashboards-with-the-view-designer/)
* [Tworzenie reguł alertów w usłudze Log Analytics](../log-analytics/log-analytics-alerts-creating.md)
