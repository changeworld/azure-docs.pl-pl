...
1. Zainstaluj [Python](https://www.python.org/) i [pip](https://pip.pypa.io/en/stable/installing/).
   
   + Zainstaluj język Python z [ https://pip.pypa.io/en/stable/installing ](https://www.python.org/).
