...
1. Utwórz konto magazynu Azure Data Lake Storage Gen2. Upewnij się, że **hierarchicznej przestrzeni nazw** opcja jest włączona. Aby uzyskać więcej informacji, zobacz temat [Szybki start: Tworzenie konta magazynu Azure Data Lake Storage Gen2](../storage/blobs/data-lake-storage-quickstart-create-account.md).
