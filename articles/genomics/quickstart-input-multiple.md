...
description: W tym artykule pokazano, jak przesłać przepływ pracy do usługi Microsoft Genomics, jeśli plik wejściowy zawiera wiele plików FASTQ lub BAM z tego samego przykładu.
services: genomics
ms.service: genomics
author: grhuynh
manager: cgronlund
