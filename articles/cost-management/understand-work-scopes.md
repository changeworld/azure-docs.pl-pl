...
- [**Grupy zarządzania**](../governance/management-groups/index.md) — kontenery hierarchiczne, do ośmiu poziomów, do organizowania subskrypcji platformy Azure.
