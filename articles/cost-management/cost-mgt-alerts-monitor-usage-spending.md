...
| Alert type | Umowa Enterprise | Umowa klienta firmy Microsoft | Web direct/Pay-As-You-Go |
|---|---|---|---|
| Budget | ✔ | ✔ | ✔ |
| Środki | ✔ |✘ | ✘ |
...
When you view the details of a dismissed alert, you can reactivate it if manual action is needed. Na poniższej ilustracji przedstawiono przykładowy raport.
