...
Następujące regiony i zasoby są dostępne dla grupy kontenerów wdrożonej w [sieci wirtualnej platformy Azure](container-instances-vnet.md) (wersja zapoznawcza).
