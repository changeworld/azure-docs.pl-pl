...
Poniższy szablon YAML definiuje grupę kontenerów z *secret* jednym `/mnt/secrets`kontenerem, który montuje tajny wolumin w pliku . Tajny tom ma dwie tajemnice: "mysecret1" i "mysecret2".
