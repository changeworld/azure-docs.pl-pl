...
Kiedy kontener będzie mieć stan **Powodzenie**, przejdź w przeglądarce do jego nazwy FQDN:
...
Dzienniki kontenera można pobrać przy użyciu polecenia [az container logs][az-container-logs]:
