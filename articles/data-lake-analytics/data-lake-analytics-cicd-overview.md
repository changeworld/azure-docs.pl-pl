...
2.  Ustaw argumenty MSBuild w narzędziach kompilacji Visual Studio lub w zadaniu programu MSBuild, jak pokazano w poniższym przykładzie. Lub można zdefiniować zmienne dla tych argumentów w potoku potoki kompilacji.
...
* Dowiedz się, jak [uruchamiania przypadków testowych w DevOps platformy Azure](data-lake-analytics-cicd-test.md#run-test-cases-in-azure-devops).

## <a name="deploy-a-u-sql-job"></a>Wdrażanie zadania U-SQL

Po zweryfikowaniu kodu w procesie kompilacji i testowania, można przesłać zadań U-SQL bezpośrednio z DevOps platformy Azure za pomocą zadań programu Azure PowerShell. Można także wdrożyć skrypt do usługi Azure Data Lake Store lub Azure Blob storage i [uruchamiać zaplanowane zadania za pomocą usługi Azure Data Factory](https://docs.microsoft.com/azure/data-factory/transform-data-using-data-lake-analytics).

### <a name="submit-u-sql-jobs-through-azure-devops-pipelines"></a>Przesyłanie zadań U-SQL za pomocą potoków metodyki DevOps platformy Azure

Dane wyjściowe kompilacji, za pomocą projektu U-SQL jest plikiem zip o nazwie **USQLProjectName.usqlpack**. Plik zip zawiera wszystkie skrypty U-SQL w projekcie. Możesz użyć [zadań programu Azure PowerShell](https://docs.microsoft.com/azure/devops/pipelines/tasks/deploy/azure-powershell?view=vsts) w potokach z następującego przykładowego skryptu programu PowerShell do przesyłania zadań U-SQL bezpośrednio z usługi Azure potoków metodyki DevOps.
...
Można przesyłać zadania U-SQL bezpośrednio z usługi Azure potoków metodyki DevOps. Lub możesz przekazać utworzonych skryptów do usługi Azure Data Lake Store lub Azure Blob storage i [uruchamiać zaplanowane zadania za pomocą usługi Azure Data Factory](https://docs.microsoft.com/azure/data-factory/transform-data-using-data-lake-analytics).

Użyj [zadań programu Azure PowerShell](https://docs.microsoft.com/azure/devops/pipelines/tasks/deploy/azure-powershell?view=vsts) w DevOps platformy Azure za pomocą następującego przykładowego skryptu programu PowerShell do przekazania skryptów U-SQL do konta usługi Azure Data Lake Store:
...
### <a name="continuous-integration-with-the-azure-devops-pipelines-service"></a>Ciągła Integracja z usługą Azure potoków metodyki DevOps

Oprócz wiersza polecenia można użyć Visual Studio Build lub zadanie programu MSBuild do kompilowania projektów bazy danych U-SQL w potoków metodyki DevOps platformy Azure. Aby skonfigurować zadanie kompilacji, upewnij się dodać dwa zadania w potoku kompilacji: zadanie przywracania NuGet i zadanie programu MSBuild.
...
2.  Ustaw argumenty MSBuild w narzędziach kompilacji Visual Studio lub w zadaniu programu MSBuild, jak pokazano w poniższym przykładzie. Lub można zdefiniować zmienne dla tych argumentów w potoku kompilacji DevOps platformy Azure.
...
## <a name="deploy-u-sql-database-through-the-azure-devops-pipelines-service"></a>Wdrażanie bazy danych U-SQL, za pośrednictwem usługi potoków metodyki DevOps platformy Azure
...
> [!NOTE]
>
> Obsługę wiersza polecenia programu PowerShell i potoków zwolnienie zadania Pomoc techniczna dotycząca wdrażania bazy danych U-SQL jest obecnie w stanie oczekiwania.
>

Wykonaj poniższe kroki, aby skonfigurować zadania wdrożenia bazy danych w potokach:
