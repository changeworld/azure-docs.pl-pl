...
description: Wykonaj ten samouczek, aby rozpocząć korzystanie z zaplecza aplikacji mobilnych platformy Azure dla rozwoju systemu iOS w języku Objective-C lub Swift.
...
## <a name="run-the-ios-app"></a>Uruchamianie aplikacji na iOS
