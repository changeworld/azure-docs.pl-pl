...
1. [Sprawdź](migrate-support-matrix-vmware.md#assessment-appliance-requirements) wymagania dotyczące konfigurowania urządzenia Azure Migrate w oprogramowaniu VMware.
