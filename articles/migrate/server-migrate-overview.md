...
**Przekazywanie dysków** | Brak obsługi | Obsługiwane
**Rozruch z interfejsem UEFI** | Brak obsługi | Migrowana maszyna wirtualna na platformie Azure zostanie automatycznie przekonwertowana na maszynę wirtualną rozruchową w systemie BIOS.<br/><br/> Dysk systemu operacyjnego powinien mieć maksymalnie cztery partycje, a woluminy powinny być sformatowane w systemie plików NTFS.
...
**Zadanie podrzędne** | **Szczegóły** |**Bez agenta** | **Na podstawie agenta**
--- | --- | --- | ---
