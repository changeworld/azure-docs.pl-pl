...
Upewnij się, że maszyna wirtualna urządzenia może nawiązać połączenie z wymaganymi [adresami URL platformy Azure](migrate-appliance.md#url-access).
