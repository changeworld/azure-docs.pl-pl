...
1. Zostanie otwarta karta powitalna rozszerzenia w Visual Studio Code, a na pasku działania zostanie dodany symbol platformy Azure (na czerwono na poniższym zrzucie ekranu).
   ...
   ![Ikona platformy Azure na pasku działania Visual Studio Code](./media/how-to-vscode-tools/azure-activity-bar.png)
...
1. Otwórz program **Train.py** i uruchom go, otwierając debuger i naciskając przycisk Run (lub po prostu naciskając klawisz F5).
   ...
   [![uruchomić szkolenie MNIST ręcznie](./media/how-to-vscode-tools/run-mnist.gif)](./media/how-to-vscode-tools/run-mnist.gif#lightbox)

Jeśli wszystko jest poprawnie zainstalowane, skrypt zostanie uruchomiony i utworzysz model TensorFlow w folderze Outputs.

[![Pokaż model TensorFlow](./media/how-to-vscode-tools/show-tensorflow-model.gif)](./media/how-to-vscode-tools/show-tensorflow-model.gif#lightbox)
...
Gotowe. Teraz po prostu Użyj rozszerzenia, aby uruchomić skrypt w chmurze! Należy zauważyć, że następujące instruktażowe wideo pobierają pewne kwestie związane z kompresowaniem czasu potrzebnego do utworzenia nowego obszaru roboczego Azure Machine Learning i obliczeń, a także czasu potrzebnego na uruchomienie skryptu szkoleniowego.

   [![uruchomić eksperyment z platformą Azure ML](./media/how-to-vscode-tools/start-golden-path.gif)](./media/how-to-vscode-tools/start-golden-path.gif#lightbox)
...
1. Wybierz opcję utworzenia *nowego* obszaru roboczego Azure Machine Learning.
...
1. Wykorzystaj i Wyłącz, gdy rozszerzenie ustawi wszystko za Ciebie i uruchomi swój skrypt.
    ...
    [Uczenie ![w chmurze](./media/how-to-vscode-tools/run-golden-path.gif)](./media/how-to-vscode-tools/run-golden-path.gif#lightbox)

W ciągu kilku sekund otrzymasz powiadomienie o tym, że eksperyment został przesłany na platformę Azure, w którym można wyświetlić postęp w programie Azure Machine Learning Studio, klikając link **Wyświetl uruchomienie eksperymentu** w powiadomieniu vs Code lub wewnątrz vs Code, naciskając przycisk Odśwież na karcie Azure.
...
[![przebiegu eksperymentu w portalu](./media/how-to-vscode-tools/experiment-run-on-portal.PNG)](./media/how-to-vscode-tools/experiment-run-on-portal.PNG#lightbox)
...
1. Na pasku działania Visual Studio Code wybierz ikonę platformy Azure. Zostanie wyświetlony pasek boczny Azure Machine Learning.
    ...
    [![utworzyć obszar roboczy](./media/how-to-vscode-tools/create-workspace.gif)](./media/how-to-vscode-tools/create-workspace.gif#lightbox)
...
1. W obszarze roboczym można kliknąć prawym przyciskiem myszy eksperyment, aby ustawić go jako **aktywny** eksperyment. **Aktywne** eksperymenty są połączone z tym folderem w chmurze do folderu, który jest obecnie otwarty w Visual Studio Code. Ten folder powinien zawierać lokalne skrypty języka Python. Po ustawieniu aktywnego eksperymentu kluczowe metryki dla wszystkich przebiegów szkoleniowych będą przechowywane w ramach eksperymentu, niezależnie od tego, gdzie są wykonywane.
    ...
    [![utworzyć eksperyment](./media/how-to-vscode-tools/create-experiment.gif)](./media/how-to-vscode-tools/create-experiment.gif#lightbox)
...
[![tworzyć obliczenia AML w Visual Studio Code](./media/how-to-vscode-tools/create-remote-compute.gif)](./media/how-to-vscode-tools/create-remote-compute.gif#lightbox)
...
[![utworzyć konfigurację uruchomieniową dla obliczeń](./media/how-to-vscode-tools/create-runconfig.gif)](./media/how-to-vscode-tools/create-runconfig.gif#lightbox)
...
[![uruchomić eksperyment lokalnie](./media/how-to-vscode-tools/run-experiment.gif)](./media/how-to-vscode-tools/run-experiment.gif#lightbox)
...
[![zarejestrować model do AML](./media/how-to-vscode-tools/register-model.gif)](./media/how-to-vscode-tools/register-model.gif#lightbox)
...
[![wdrożyć usługę sieci Web](./media/how-to-vscode-tools/create-image.gif)](./media/how-to-vscode-tools/create-image.gif#lightbox)
...
[![skróty klawiaturowe dla Azure Machine Learning Visual Studio Code](./media/how-to-vscode-tools/commands.gif)](./media/how-to-vscode-tools/commands.gif#lightbox)

## <a name="next-steps"></a>Następne kroki

* Aby poznać wskazówki dotyczące uczenia się z Azure Machine Learning poza Visual Studio Code, zobacz [Samouczek: uczenie modeli za pomocą Azure Machine Learning](tutorial-train-models-with-aml.md)
