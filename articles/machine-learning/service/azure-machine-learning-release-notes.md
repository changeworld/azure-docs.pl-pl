...
+ **Poprawki i ulepszenia błędów**
  ...
  + **Azure-automl-Core**
    ...
    + Zezwalaj na dane pośrednie w Azure Machine Learning pPipeline do przekonwertowania na tabelaryczny zestaw danych i używane w `AutoMLStep`.
