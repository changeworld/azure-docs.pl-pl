...
Aby filtrować kolumny, użyj `Dataflow.drop_columns()`. Ta metoda przyjmuje listę kolumn, aby porzucić lub bardziej złożone argument o nazwie [ `ColumnSelector` ](https://docs.microsoft.com/python/api/azureml-dataprep/azureml.dataprep.columnselector?view=azure-dataprep-py).
