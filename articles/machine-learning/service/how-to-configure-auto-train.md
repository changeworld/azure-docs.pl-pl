...
+ Potok przy użyciu określonego algorytmu (LogisticRegression z RobustScalar w tym przypadku):
...
+ Potok przy użyciu podejścia zespołu: W tym przypadku jest zespołu potoki różne 2
