...
1. Jeśli nie masz subskrypcji Azure, przed rozpoczęciem utwórz bezpłatne konto. Wypróbuj [bezpłatną lub płatną wersję usługi Azure Machine Learning](https://aka.ms/AMLFree).
...
![Strona główna projektanta](media/how-to-run-batch-predictions-ui/ui-batch-scoring-1.png)
...
![Tworzenie prostego eksperymentu](media/how-to-run-batch-predictions-ui/ui-batch-scoring-2.png)
...
![Tworzenie potoku wnioskowania partii](media/how-to-run-batch-predictions-ui/ui-batch-scoring-5.png)
...
![Domyślny potok wnioskowania o partie](media/how-to-run-batch-predictions-ui/ui-batch-scoring-6.png)
...
![Nowy węzeł](media/how-to-run-batch-predictions-ui/ui-batch-scoring-7.png)
...
![Ustawienia przykładowe](media/how-to-run-batch-predictions-ui/ui-batch-scoring-8.png)
...
![Parametr potoku](media/how-to-run-batch-predictions-ui/ui-batch-scoring-9.png)
...
![Wdrażanie potoku](media/how-to-run-batch-predictions-ui/ui-batch-scoring-10.png)
...
![Punkt końcowy konfiguracji](media/how-to-run-batch-predictions-ui/ui-batch-scoring-11.png)
...
![Łącze punktu końcowego](media/how-to-run-batch-predictions-ui/ui-batch-scoring-12.png)

Na tym ekranie są wyświetlane wszystkie opublikowane potoki w określonym punkcie końcowym. Kliknij potok inferencing.

![Potok wnioskowania](media/how-to-run-batch-predictions-ui/ui-batch-scoring-13.png)
...
![Szczegóły potoku](media/how-to-run-batch-predictions-ui/ui-batch-scoring-14.png)
...
![Uruchomienie potoku](media/how-to-run-batch-predictions-ui/ui-batch-scoring-15.png)
