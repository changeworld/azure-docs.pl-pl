...
[Azure Event Grid](https://docs.microsoft.com/azure/event-grid/) obsługuje zdarzenia usługi Azure Machine Learning. Można na przykład użyć zdarzeń od ukończenia przebiegu, rejestracji modelu, wdrożenia modelu i wykrywania dryfowania danych w zakresie obszaru roboczego.
...
* Dostęp współautora lub właściciela do obszaru roboczego usługi Azure Machine Learning, dla którego będą tworzone zdarzenia.
