...
To wywołanie interfejsu API `write_config()` utworzy plik konfiguracyjny w bieżącym katalogu. *.Azureml/config.json* plik zawiera następujące czynności:
