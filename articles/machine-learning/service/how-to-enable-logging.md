...
Użyj [przewodnik](https://docs.microsoft.com/python/api/overview/azure/ml/install?view=azure-ml-py) zainstalować zestaw SDK, i [wprowadzenie](https://docs.microsoft.com/azure/machine-learning/service/quickstart-create-workspace-with-python) przy użyciu zestawu SDK, aby utworzyć obszar roboczy w witrynie Azure Portal.
...
Zobacz odwołania do [dokumentacji](https://docs.microsoft.com/python/api/azureml-core/azureml.core.run(class)?view=azure-ml-py) dla `Run` klasy dla funkcji dodatkowe rejestrowanie.
...
Zobacz [porad](how-to-enable-app-insights.md#enable-and-disable-in-the-portal) Aby uzyskać więcej informacji na temat pracy z usługą Application Insights w witrynie Azure portal.
