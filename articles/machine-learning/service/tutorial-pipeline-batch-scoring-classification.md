...
1. Wpisz nazwę grupy zasobów. Then, select **Delete**.

Możesz też zachować grupę zasobów i usunąć jeden obszar roboczy. Display the workspace properties, and then select **Delete**.
