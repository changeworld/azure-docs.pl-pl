...
1. Utwórz skrypt szkolenia. Ten kod używa ```%%writefile%%``` do pisania kodu szkolenia w folderze skryptu, co ```train.py```.
...
### <a name="how-to-see-run-charts"></a>Jak zobaczyć wykresy przebiegu:
