...
Zestaw danych zawiera 14 funkcji i jedną kolumnę etykiety. Istnieje wiele typów funkcji, takich jak liczbowe i kategorii. Na poniższym diagramie przedstawiono fragment zestawu danych: ![dane](media/how-to-designer-sample-classification-predict-income/data.png)
...
![Oceń wyniki](media/how-to-designer-sample-classification-predict-income/evaluate-result.png)
