---
title: 'Samouczek nr 1: przygotowywanie danych do modelowania za pomocą usługi Azure Machine Learning Service'
...
ms.locfileid: "52884014"
---
# <a name="tutorial-1-prepare-data-for-regression-modeling"></a>Samouczek nr 1: przygotowywanie danych do modelowania regresji
...
Usuń plik `dflow` (bez względu na to, czy pracujesz lokalnie, czy w usłudze Azure Notebooks) ze swojego bieżącego katalogu, jeśli nie zamierzasz przechodzić drugiej części samouczka. Jeśli masz zamiar przejść drugą część, będziesz potrzebować pliku `dflow` w bieżącym katalogu.
...
> [Samouczek nr 2: trenowanie modelu regresji](tutorial-auto-train-models.md)
