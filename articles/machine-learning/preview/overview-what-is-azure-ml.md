...
Oprócz usługi Azure Machine Learning na platformie Azure dostępnych jest wiele różnych opcji umożliwiających tworzenie i wdrażania modeli uczenia maszynowego oraz zarządzanie nimi. [Więcej informacji na ten temat możesz uzyskać tutaj.](overview-more-machine-learning.md)
