...
Włączenie rejestrowania podczas tworzenia obrazu umożliwi wyświetlenie błędów podczas procesu kompilacji. Ustaw parametr `show_output` w funkcji `wait_for_deployment()`.
