...
Samouczek przedstawiający sposób tworzenia projektu TDSP w konsoli usługi Azure Machine Learning Workbench można znaleźć [zespołu danych nauki procesu samouczek: przychodów klasyfikowania UCI w konsoli usługi Azure Machine Learning Workbench](../desktop-workbench/scenario-tdsp-classifying-us-incomes.md) 
...
Dla przykładu korzystającego z projektem wystąpienia TDSP w konsoli usługi Azure Machine Learning Workbench, zobacz [przy użyciu języka naturalnego przetwarzania przy użyciu bezpośrednich Learning rozpoznawania biomedycznych jednostki](../desktop-workbench/scenario-tdsp-biomedical-recognition.md)
