...
Artefakty utworzone podczas tego etapu obejmują:
   ...
   * [Zestawy funkcji](https://github.com/Azure/Azure-TDSP-ProjectTemplate/blob/master/Docs/Data_Report/Data%20Defintion.md): funkcje rozwinięte modelowania są opisane w **zestawy funkcji** części **definicji danych** raportu. Zawiera wskaźniki kod służący do generowania funkcji i opis jak funkcja został wygenerowany.
