...
| Jak jest ona skonfigurowana / zainstalowanym maszyny DSVM?  | Tworzone są dwa środowiska `conda` globalne: <br /> * Środowisko `root`e znajdujące się w `/anaconda/` jest Python 3,7. <br/> * Środowisko `python2`e znajdujące się w `/anaconda/envs/python2` jest Python 2,7.       |
