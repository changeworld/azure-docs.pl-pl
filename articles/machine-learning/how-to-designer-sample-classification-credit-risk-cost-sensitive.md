...
**Przykład projektanta 4**

[!INCLUDE [applies-to-skus](../../includes/aml-applies-to-enterprise-sku.md)]

W tym artykule opisano sposób tworzenia złożonego potoku uczenia maszynowego przy użyciu narzędzia Projektant. Dowiesz się, jak wdrożyć logikę niestandardową przy użyciu skryptów języka Python i porównać wiele modeli, aby wybrać najlepszą opcję.
...
[![Graf potoku](./media/how-to-designer-sample-classification-credit-risk-cost-sensitive/graph.png)](./media/how-to-designer-sample-classification-credit-risk-cost-sensitive/graph.png#lightbox)
...
![Wykres potoku](./media/how-to-designer-sample-classification-credit-risk-cost-sensitive/score-part.png)
...
![Wizualizacja danych wyjściowych](media/how-to-designer-sample-classification-credit-risk-cost-sensitive/sample4-lastselect-1225.png)
