...
![Dodawanie elementów do kolekcji ze strony szczegółów](./media/gallery-collections/add-to-collection-from-details-page.png)
...
![Dodawanie elementów do kolekcji ze strony szczegółów](./media/gallery-collections/add-to-collection-from-item-details.png)
