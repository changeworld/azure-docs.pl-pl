...
Aby skonfigurować platformy Docker w systemie Linux do użycia przez użytkowników innych niż root, postępuj zgodnie z instrukcjami w tym miejscu: [Kroki po instalacji dla systemu Linux](https://docs.docker.com/engine/installation/linux/linux-postinstall/)
