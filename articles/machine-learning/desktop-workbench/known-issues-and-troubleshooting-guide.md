...
Mamy Forum MSDN, możesz zadać pytania. Zespół pracujący nad produktem, które aktywnie monitoruje forum. Forum, adres URL jest [ https://aka.ms/aml-forum-service ](https://aka.ms/aml-forum-service). 
...
- Maksymalny dopuszczalny rozmiar folderu projektu: 25 MB.
    >[!NOTE]
    >To ograniczenie nie ma zastosowania do `.git`, `docs` i `outputs` folderów. Te nazwy folderów jest rozróżniana wielkość liter. Jeśli pracujesz z dużymi plikami, zapoznaj się [wprowadzeniem trwałych zmian i postępowanie z dużymi plikami](how-to-read-write-files.md).
...
- Maksymalny rozmiar pliku śledzonych `outputs` folderu po uruchomieniu: 512 MB
  - Oznacza to, jeśli skrypt generuje plik przekracza 512 MB w folderze danych wyjściowych, go nie są zbierane istnieje. Jeśli pracujesz z dużymi plikami, zapoznaj się [wprowadzeniem trwałych zmian i postępowanie z dużymi plikami](how-to-read-write-files.md).
...
![Aktualizowanie obrazu](../service/media/known-issues-and-troubleshooting-guide/update.png)
