...
W tym artykule Dowiedz się, jak używać Azure Machine Learning pakietu przetwarzania komputera (AMLPCV) do uczenia, testowanie i wdrażanie modeli klasyfikacji obrazów. Aby uzyskać omówienie tego pakietu i jego ze szczegółową dokumentacją referencyjną [opublikujemy](https://aka.ms/aml-packages/vision).
