...
|`"featurization": 'auto'`| Wskazuje, że w ramach przetwarzania wstępnego [guardrails danych i kroki cechowania](how-to-create-portal-experiments.md#advanced-featurization-options) są wykonywane automatycznie.|
