...
|Komunikaty o wyjątkach|
|------------------------|
|Nie można zdeserializować modelu, ponieważ prawdopodobnie jest on serializowany ze starszym formatem serializacji. Poprowadź ponowne szkolenie i Zapisz model.|
...
|Określono nieobsługiwany typ parametru "{parameter_name}".|
|Określono nieobsługiwany typ parametru "{parameter_name}". Przyczyna: {powód}.|
...
## <a name="error-0154"></a>Błąd 0154  
 Wyjątek występuje, gdy użytkownik spróbuje dołączyć dane do kolumn klucza z niezgodnym typem kolumny.
