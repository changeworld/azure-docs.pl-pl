...
> [!TIP]
> W dowolnym potoku w interfejsie wizualizacji możesz uzyskać informacje o określonym module. Wybierz moduł, a następnie wybierz łącze **więcej pomocy** w okienku **szybkie pomoc** .
...
| Klasyfikacja | Przewidywanie klasy.  Wybierz jeden z dwuklasowego algorytmu lub algorytmów wieloklasowych.| [Las decyzyjny wieloklasowej](multiclass-decision-forest.md) <br/> [Wieloklasowe drzewo decyzyjne](multiclass-boosted-decision-tree.md) <br/> [Wieloklasowa regresja logistyczna](multiclass-logistic-regression.md)  <br/> [Wieloklasowa sieć neuronowych](multiclass-neural-network.md)  <br/>  [Regresja logistyczna dla dwóch klas](two-class-logistic-regression.md)  <br/>[Średnia Perceptron średniej klasy](two-class-averaged-perceptron.md) <br/> [Dwie klasy &nbsp;Boosted &nbsp;Decision &nbsp;Tree](two-class-boosted-decision-tree.md)  <br/> [Las decyzyjny dwóch klas](two-class-decision-forest.md)  <br/> [Sieć neuronowych z dwiema klasami](two-class-neural-network.md)  <br/> [Dwie&#8209;klasy &nbsp;Support &nbsp;Vector &nbsp;Machine](two-class-support-vector-machine.md) 
| Usługę | Grupuj dane jednocześnie.| [K-oznacza klastrowanie](k-means-clustering.md)
| Ubytk | Przewidywanie wartości. | [Regresja liniowa](linear-regression.md)  <br/> [Regresja sieci neuronowych](neural-network-regression.md)  <br/> [Regresja lasu decyzyjnego](decision-forest-regression.md)  <br/> [@No__t_1Decision &nbsp;Tree &nbsp;Regression](boosted-decision-tree-regression.md)
|  | **Kompiluj i Szacuj modele**: | |
| Uczenie   | Uruchom dane za pomocą algorytmu. | [Model uczenia](train-model.md)  <br/> [Model klastra uczenia](train-clustering-model.md)    |
| Ocena modelu | Zmierz dokładność nauczonego modelu. |  [Oceń model](evaluate-model.md)
| Wynik | Zyskaj przewidywania od modelu, który właśnie został przeszkolony. | [Zastosuj transformację](apply-transformation.md)<br/>[Przypisz &nbsp;to &nbsp;Data &nbsp;Clusters](assign-data-to-clusters.md) <br/>[Model oceny](score-model.md)
| Funkcje statystyczne | Zapewniają szeroką gamę metod numerycznych związanych z nauką danych. | [Zastosuj operacje matematyczne](apply-math-operation.md) <br/> [Podsumowywanie danych](summarize-data.md)|
