...
Skonfiguruj proces ciągłej integracji i ciągłego dostarczania dla aplikacji środowiska Ruby on Rails w **projekcie DevOps na platformie Azure**.  Projekt usługi Azure DevOps ułatwia początkową konfigurację potoku kompilacji i wydania w usłudze Azure DevOps Services.
