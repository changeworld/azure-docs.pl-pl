...
ms.locfileid: "64919862"
---
# <a name="refresh-with-logic-apps"></a>Odśwież za pomocą aplikacji logiki
...
|**Client ID (Identyfikator klienta)**     |Wprowadź swoje ClientID nazwę jednostki usługi         |
