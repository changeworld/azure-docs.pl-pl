...
Aby uzyskać listę rozmiarów, można użyć programu PowerShell lub interfejsu API REST. Interfejs API REST jest udokumentowany [tutaj](https://msdn.microsoft.com/library/azure/dn469422.aspx). Poniższy kod jest polecenia programu PowerShell, który znajduje się lista wszystkich dostępne rozmiary dla usługi w chmurze. 
