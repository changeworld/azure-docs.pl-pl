...
Uruchom `az network watcher test-ip-flow` polecenia cmdlet, aby przetestować ruchu. W tym przykładzie używany jest pierwszy adres IP z pierwszej karty Sieciowej.
