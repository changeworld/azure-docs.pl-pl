...
Dodatkowe informacje uzyskane za pośrednictwem pomiarów rzeczywistego użytkownika mają zastosowanie tylko w przypadku profilów, które należy użyć metody routingu wydajności. Należy zauważyć, że link pomiarów rzeczywistego użytkownika jest dostępna ze wszystkich profilów, wyświetlając za pośrednictwem witryny Azure portal.
...
### <a name="can-i-use-configure-real-user-measurements-with-only-the-azure-regions-i-want-to-measure"></a>Można użyć skonfigurować tylko regiony platformy Azure I chcesz zmierzyć pomiarów rzeczywistego użytkownika?
...
Nie, nie potrzebujesz do obsługi dowolnej składnik po stronie serwera na platformie Azure pomiarów rzeczywistego użytkownika do pracy. Obraz piksela pobierany przez pomiar JavaScript i usługi, uruchamiając go w różnych regionach platformy Azure jest hostowaną i zarządzaną przez platformę Azure. 
