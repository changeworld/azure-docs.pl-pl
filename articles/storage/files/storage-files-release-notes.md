...
## <a name="agent-version-7000"></a>Wersja agenta 7.0.0.0
Poniższe informacje o wersji dotyczą wersji 7.0.0.0 agenta usługi Azure File Sync (wydanej 19 czerwca 2019 r.).

### <a name="improvements-and-issues-that-are-fixed"></a>Ulepszenia i problemy, które zostały usunięte

- Obsługa większych udziału plików
    - W wersji zapoznawczej większych udziałów plików platformy Azure, firma Microsoft coraz naszych limitów pomocy technicznej Aby uzyskać plik synchronizacji. W pierwszym kroku usługi Azure File Sync teraz obsługuje do 25TB i 50million plików w ramach pojedynczej przestrzeni nazw synchronizacji. Zgłoszenie chęci udziału plików o dużym rozmiarze w wersji zapoznawczej, Wypełnij ten formularz https://aka.ms/azurefilesatscalesurvey. 
- Ulepszone przywracania na poziomie plików kopia zapasowa Azure
    - Pojedyncze pliki, przywracać za pomocą usługi Azure Backup są teraz wykryte i szybciej synchronizowane z usługą punktu końcowego serwera.
...
Lista problemów rozwiązanych w tej wersji:  
- Po utworzeniu punktu końcowego serwera wysokie użycie procesora CPU może wystąpić, gdy tło odwołania jest pobieranie plików z serwerem
- Synchronizacja i obsługi warstw operacji w chmurze może zakończyć się niepowodzeniem z powodu błędu ECS_E_SERVER_CREDENTIAL_NEEDED z powodu wygaśnięcia tokenu
- Odwoływania pliku może się nie powieść, jeśli adres URL, aby pobrać plik zawiera zastrzeżone znaki 

## <a name="agent-version-6100"></a>Wersja agenta 6.1.0.0
Poniższe informacje o wersji dotyczą wersji 6.1.0.0 agenta usługi Azure File Sync wydanej 6 maja 2019 r. Te informacje są uzupełnieniem informacji o wersji 6.0.0.0 informacje o wersji.

Lista problemów rozwiązanych w tej wersji:  
- Windows Admin Center nie powiedzie się wyświetlić konfigurację punktu końcowego wersji i serwera agenta na serwerach, których wersja agenta usługi Azure File Sync zainstalowany w wersji 6.0.
