...
**Mój usługodawca internetowy lub blokuje port 445, który kończy się niepowodzeniem Azure Files instalacji. Co zrobić?**
...
**Jakie rozmiary są dostępne dla udziałów plików platformy Azure?**  
    Rozmiary udziałów plików platformy Azure (Premium i standard) można skalować w górę do 100 TiB. Udziały plików w warstwie Premium o rozmiarze do 100 TiB są dostępne jako oferta GA. Standardowe rozmiary udziałów plików o rozmiarze do 5 TiB są dostępne jako oferta w wersji zapoznawczej, podczas gdy rozmiary do 100 TiB są aktualne. Zapoznaj się z sekcją dołączanie [do większej liczby udziałów plików (warstwa standardowa)](storage-files-planning.md#onboard-to-larger-file-shares-standard-tier) przewodnika planowania dla instrukcji dołączania do większej wersji zapoznawczej udziałów plików w warstwie Standardowa.
...
**Moja wydajność jest niska, gdy rozpakuję pliki w Azure Files. Co zrobić?**  
