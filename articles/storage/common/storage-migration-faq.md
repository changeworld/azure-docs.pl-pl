...
2.  Użyj [AzCopy](https://azure.microsoft.com/blog/azcopy-5-1-release/) skopiować zawartość z oryginalnego kontenera obiektów blob do kontenera obiektów blob innego.
