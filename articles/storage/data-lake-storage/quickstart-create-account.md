...
Aby uzyskać więcej informacji dotyczących typów kont magazynu, zobacz temat [Opcje konta usługi Azure Storage](../common/storage-account-options.md).
...
* [Przenoszenie danych do oraz z usługi Azure Blob Storage za pomocą usługi AzCopy](https://docs.microsoft.com/en-us/azure/machine-learning/team-data-science-process/move-data-to-azure-blob-using-azcopy)