...
description: W tym przewodniku Szybki start utworzysz kolejkę przy użyciu witryny Azure Portal. Następnie użyjesz witryny Azure Portal, aby ???.
services: storage
author: tamram
ms.custom: mvc
ms.service: storage
