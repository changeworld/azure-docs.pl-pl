...
1. Zainstaluj **WindowsAzure. Magazyn** pakietu do projektu z `dotnet add package` polecenia. Wykonaj następujące polecenie dotnet z folderu projektu w oknie konsoli.
