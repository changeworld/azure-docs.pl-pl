---
title: Wskazówki dotyczące dostrajania wydajności Azure Data Lake Storage Gen2 Hive | Microsoft Docs
description: Wskazówki dotyczące dostrajania wydajności Azure Data Lake Storage Gen2 Hive
author: normesta
...
ms.locfileid: "68847122"
---
# <a name="performance-tuning-guidance-for-hive-on-hdinsight-and-azure-data-lake-storage-gen2"></a>Wskazówki dotyczące dostrajania wydajności dla programu Hive w usłudze HDInsight i Azure Data Lake Storage Gen2
...
* **Konto Data Lake Storage Gen2**. Aby uzyskać instrukcje dotyczące sposobu tworzenia takiego elementu, [zobacz Szybki Start: Tworzenie konta usługi Azure Data Lake Storage Gen2](data-lake-storage-quickstart-create-account.md)
