...
|Usługa Azure Search | [Przeszukiwanie magazynu obiektów blob za pomocą usługi Azure Search](https://docs.microsoft.com/azure/search/search-blob-storage-integration)|
|Usługa Azure Stream Analytics| [Ruch wychodzący do Azure Data Lake Gen2](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-define-outputs#blob-storage-and-azure-data-lake-gen2) |
|DataBox|  [Używanie Azure Data Box do migrowania danych z lokalnego magazynu systemu plików HDFS do usługi Azure Storage](data-lake-storage-migrate-on-premises-hdfs-cluster.md)|
...
|Centrum IOT | [Używanie routingu komunikatów IoT Hub do wysyłania komunikatów z urządzenia do chmury do różnych punktów końcowych](https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messages-d2c)|
|Power BI|  [Analizowanie danych w Data Lake Storage Gen2 przy użyciu Power BI](data-lake-storage-use-power-bi.md) |
|Hurtownia danych SQL | [Używanie z Azure SQL Data Warehouse](https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#azure-sql-data-warehouse-polybase)|
