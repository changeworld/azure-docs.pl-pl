...
Aby ukończyć ten samouczek, musisz ukończyć poprzedni samouczek dotyczący magazynu: [przekazywanie dużych ilości danych losowych równolegle do usługi Azure Storage][previous-tutorial].
