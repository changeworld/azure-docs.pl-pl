...
![Klastry Hadoop używają interfejsu API systemu plików HDFS w celu dostępu do danych strukturalnych i bez struktury oraz przechowywania ich w usłudze Blob Storage.](./media/data-lake-storage-use-hdi-cluster/HDI.ABFS.Arch.png "Architektura usługi DHInsight Storage")
...
![HDInsight, hadoop, tworzenie źródła danych](./media/data-lake-storage-use-hdi-cluster/create-storage-account.png)
