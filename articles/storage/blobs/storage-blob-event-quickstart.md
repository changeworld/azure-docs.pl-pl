...
---
# <a name="quickstart-route-storage-events-to-web-endpoint-with-azure-cli"></a>Szybki start: kierowanie zdarzeń magazynu do punktu końcowego sieci Web za pomocą interfejsu wiersza polecenia platformy Azure
