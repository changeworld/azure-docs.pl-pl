---
title: 'Dostrajanie wydajności: Spark, HDInsight & Azure Data Lake Storage Gen2 | Dokumenty firmy Microsoft'
description: Wskazówki dotyczące dostrajania wydajności usługi Azure Data Lake Storage Gen2 Spark
services: storage
author: normesta
...
---
# <a name="tune-performance-spark-hdinsight--azure-data-lake-storage-gen2"></a>Dostrajanie wydajności: Spark, HDInsight & Azure Data Lake Storage Gen2
...
* **Uruchamianie klastra Platformy Spark w pamięci masowej data lake Gen2**.  Aby uzyskać więcej informacji, zobacz [Analizowanie danych w u źródła danych Gen2 za pomocą klastra HDInsight Spark](https://docs.microsoft.com/azure/hdinsight/hdinsight-apache-spark-use-with-data-lake-store)
...
Podczas uruchamiania zadań platformy Spark oto najważniejsze ustawienia, które można dostroić, aby zwiększyć wydajność w programie Data Lake Storage Gen2:
...
Podczas uruchamiania obciążeń analitycznych platformy Spark do pracy z danymi w urozwoju danych Lake Storage Gen2 zaleca się użycie najnowszej wersji usługi HDInsight, aby uzyskać najlepszą wydajność z pamięcią masową Data Lake Gen2. Gdy zadanie jest bardziej intensywne we/wy, niektóre parametry można skonfigurować w celu zwiększenia wydajności.  Data Lake Storage Gen2 to wysoce skalowalna platforma pamięci masowej, która może obsługiwać wysoką przepustowość.  Jeśli zadanie składa się głównie z odczytu lub zapisu, zwiększenie współbieżności dla we/wy do i z usługi Data Lake Storage Gen2 może zwiększyć wydajność.
...
**Oblicz ograniczenie procesora —** ograniczenie procesora jest obliczane jako całkowita liczba rdzeni wirtualnych podzielona przez liczbę rdzeni na wykonawcę.  Istnieją 2 rdzenie wirtualne dla każdego rdzenia fizycznego.  Podobnie jak ograniczenie pamięci, musimy podzielić przez liczbę aplikacji.
