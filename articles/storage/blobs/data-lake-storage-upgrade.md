...
| Zestaw Java SDK — system plików                  | @No__t [linku](https://docs.microsoft.com/java/api/overview/azure/datalake)-1                                                                                                                                                                                                                                        | *Jeszcze niedostępne*                                                | *Jeszcze niedostępne*                                                                                                                                             |
| Node. js — zarządzanie                   | @No__t [linku](https://www.npmjs.com/package/azure-arm-datalake-store)-1                                                                                                                                                                                                                                                               | Brak obsługi                                                      | *Dostępne teraz —* [link](https://azure.github.io/azure-storage-node/)                                                                                            |
| Node. js — system plików                   | @No__t [linku](https://www.npmjs.com/package/azure-arm-datalake-store)-1                                                                                                                                                                                                                                                               | *Jeszcze niedostępne*                                                | *Jeszcze niedostępne*                                                                                                                                             |
| Python — zarządzanie                    | @No__t [linku](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)-1                                                                                                                                                                                                                | *Nieobsługiwane*                                                      | *Dostępne teraz —* [link](https://docs.microsoft.com/python/api/overview/azure/storage/management?view=azure-python)                                       |
...
|                      | [Usługi SQL Server Integration Services](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *Jeszcze niedostępne*                                                                                                                                                          | *Jeszcze niedostępne*                                                                                                                             |
...
| IoT                  | [Event Hubs — Przechwyć](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-archive-eventhub-capture)                                                       | *Jeszcze niedostępne*                                                                                                                                                          | *Jeszcze niedostępne*                                                                                                                             |
...
|                     | HortonWorks  | HDP 3,0              | @No__t [linku](https://docs.hortonworks.com/HDPDocuments/HDP2/HDP-2.6.3/bk_cloud-data-access/content/adls-get-started.html)-1                                                                      | *Jeszcze niedostępne*                                                                                                  | *Jeszcze niedostępne*                                                                                                  |
...
| PRZYROST                 | StreamSets   |                      | [Link](https://streamsets.com/blog/ingest-data-azure)                                                                                                                                     | *Jeszcze niedostępne*                                                                                                  | *Jeszcze niedostępne*                                                                                                  |
...
|                     | Oprogramowanie alteryx      |                      | [Link](https://help.alteryx.com/2018.2/DataSources/AzureDataLake.htm)                                                                                                                     | *Jeszcze niedostępne*                                                                                                  | *Jeszcze niedostępne*                                                                                                  |
...
Schemat identyfikatora URI dla Data Lake Storage Gen1 został szczegółowo opisany w [tym miejscu](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-use-data-lake-store) , ale ogólnie mówiąc, jest to *ADL://mydatalakestore.azuredatalakestore.NET/\<file_path @ no__t-3.*
