...
| | Data Lake Storage 1. generacji | Data Lake Storage Gen2 - goal | Data Lake Storage Gen2 - availability status  |
|-|------------------------|-------------------------------|-----------------------------------------------|
...
| Przestrzeń nazw| Hierarchical | Hierarchical |  *Available now*  |
...
| Data Operations – Logs  | Tak | Tak | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).<br><br> Azure Monitoring integration – *Not yet available* |
...
| Dostępność regionalna | See [here](https://azure.microsoft.com/regions/) | All [Azure regions](https://azure.microsoft.com/global-infrastructure/regions/)                                                                                                                                                                                                                                                                                                                                       | *Available now*                                                                                                                           |
...
| Dostępność umowy SLA                            | [See SLA](https://azure.microsoft.com/support/legal/sla/data-lake-store/v1_0/)                                                                   | [See SLA](https://azure.microsoft.com/support/legal/sla/storage/v1_3/)                                                                                                                                                                                                                                                                                                                                                | *Available now*                                                                                                                           |
| Zarządzanie danymi                             | File Expiration                                                                                                                                        | Lifecycle policies                                                                                                                                                                                                                                                                                                                                                                                                          | Lifecycle policies *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).                                                                                                                     |
...
|  API set                           |  Data Lake Storage 1. generacji                                                                                                                                                                                                                                                                                                   | Availability for Data Lake Storage Gen2 - with Shared Key auth | Availability for Data Lake Storage Gen2 - with OAuth auth                                                                                                  |
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Zestaw SDK dla platformy .NET                  | [Link](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Available now* | *Available now* |
| Zestaw Java SDK                | [Link](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Available now*                                                      | *Available now*                                     |
| Node.js                | [Link](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *Available now*                                                     | *Available now*                                                                                           |
| Zestaw SDK dla języka Python                   | [Link](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                 | *Available now*                                                      | *Available now*                                        |
| Interfejs API REST                 | [Link](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Available now*                                                      | *Available now*                                                                                                                                               |
| PowerShell | [Link](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Available now* |
| Interfejs CLI                 | [Link](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Available now*                                                      | *Available now*                                                               |
...
| **Obszar**             | **Availability for Data Lake Storage Gen1**                                                                                                                                    | **Availability for Data Lake Storage Gen2 – with Shared Key auth**                                                                                                           | **Availability for Data Lake Storage Gen2 – with OAuth**                                                                                        |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
|                      | [SQL Data Warehouse](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store)                                            | *Nieobsługiwane*                                                                                                                                                              | *Available now* [Link](https://docs.microsoft.com/sql/t-sql/statements/create-external-data-source-transact-sql?view=sql-server-2017) |
...
|                      | [Usługi SQL Server Integration Services](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Zużycie          | [Program Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Produktywność         | [Azure Portal](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-get-started-portal)                                                                      | *Nieobsługiwane*                                                                                                                                                              | Account management *– Available now* <br><br>Data operations *–*  *Not yet available*                                                                   |
...
| Obszar            | Partner  | Product/Service  | Availability for Data Lake Storage Gen1                                                                                                                                               | Availability for Data Lake Storage Gen2 – with Shared Key auth                                                   | Availability for Data Lake Storage Gen2 – with Oauth                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
...
|                     | Cloudera     | Altus                | [Link](https://www.cloudera.com/more/news-and-blogs/press-releases/2017-09-27-cloudera-introduces-altus-data-engineering-microsoft-azure-hybrid-multi-cloud-data-analytic-workflows.html) | *Nieobsługiwane*                                                                                                                  | *Not yet available*                                                                                                  |
...
| Dzienniki aktywności                                                                                          | [Link](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#audit-logs)   | One-off requests for logs for specific duration using support ticket – *Available now* Azure Monitoring integration - *Not yet available* |
| Dzienniki diagnostyczne                                                                                        | [Link](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md). <br>Azure Monitoring integration - *Not yet available* |
| Metryki                                                                                                | *Nieobsługiwane*                                                                                               | *Available now -* [Link](https://docs.microsoft.com/azure/storage/common/storage-metrics-in-azure-monitor)                          |
...
| Strategia                   | Pros                                                                                  | Wady                                                           | When to use?                                                                                                                                                                                             |
|--------------------------------|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Strategia                       | Narzędzia                                                                                                             | Pros                                                                                                                             | Zagadnienia do rozważenia                                                                                                                                                                                                                                                                                                                |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
