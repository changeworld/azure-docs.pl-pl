...
W tej części serii samouczków do uzyskania dostępu do miniatur zostaną użyte tokeny SAS. W tym kroku ustawisz wartość _w konfiguracji publicznego dostępu do kontenera_thumbnails`off`.
