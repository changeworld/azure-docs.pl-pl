...
- Zainstaluj rozszerzenie Diagnostyka Azure Windows (WAD) na usługi [maszyny Wirtualnej platformy Azure](metrics-store-custom-guestos-resource-manager-vm.md), [zestawu skalowania maszyn wirtualnych](metrics-store-custom-guestos-resource-manager-vmss.md), [klasyczna maszyna wirtualna](metrics-store-custom-guestos-classic-vm.md), lub [klasycznej usługi w chmurze,](metrics-store-custom-guestos-classic-cloud-service.md) i wysłać liczników wydajności do usługi Azure Monitor. 
- Zainstaluj [agenta InfluxData Telegraf](metrics-store-custom-linux-telegraf.md) na maszynie Wirtualnej systemu Linux platformy Azure i wysyłanie metryk za pomocą usługi Azure Monitor danych wyjściowych wtyczki.
...
* **Min**: minimalna zaobserwowane wartość ze wszystkich przykładów i pomiary ciągu minuty.
* **Maksymalna liczba**: maksimum zaobserwowane WE wartość ze wszystkich przykładów i pomiary w ciągu minuty.
...
Niestandardowe metryki z różnymi usługami: 
 ...
 - [Maszyny wirtualne platformy Azure (wersja klasyczna)](metrics-store-custom-guestos-classic-vm.md)
 - [Maszyny wirtualnej systemu Linux przy użyciu agenta Telegraf](metrics-store-custom-linux-telegraf.md)
 - [Interfejs API REST](metrics-store-custom-rest-api.md)
 - [Usługi w chmurze klasycznego](metrics-store-custom-guestos-classic-cloud-service.md)
