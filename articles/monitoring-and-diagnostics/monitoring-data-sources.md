...
| Dzienniki diagnostyczne usługi Azure Monitor | Zdarzenia | [Zobacz tutaj](../azure-monitor/platform/tutorial-dashboards.md) | <ul><li>**Magazyn obiektów blob lub zdarzenia Centrum:** [Ustawienia diagnostyczne](monitoring-overview-of-diagnostic-logs.md#diagnostic-settings)</li></ul> |
