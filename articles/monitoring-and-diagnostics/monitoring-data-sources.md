...
| Obliczenia metryki systemu operacyjnego gościa (np.) liczniki wydajności) | Metryki | [Windows](/azure/vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines) i maszyn wirtualnych systemu Linux (wersja 2) [usług w chmurze](../cloud-services/cloud-services-dotnet-diagnostics-trace-flow.md), [usługi Service Fabric](../service-fabric/service-fabric-diagnostics-how-to-monitor-and-diagnose-services-locally.md) | <ul><li>**Tabela magazynu lub obiektu blob:** [diagnostyki Windows lub Linux, Azure](azure-diagnostics-storage.md)</li><li>**Centrum zdarzeń:** [usługi Windows Azure diagnostics](azure-diagnostics-streaming-event-hubs.md)</li></ul> |
...
| Raporty usługi Active Directory | Zdarzenia | Usługa Azure Active Directory | <ul><li>**Interfejs API REST:** [interfejsu API programu graph usługi Azure Active Directory](../active-directory/reports-monitoring/concept-reporting-api.md)</li></ul> |
