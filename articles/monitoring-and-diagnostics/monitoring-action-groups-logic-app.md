...
Po wyzwoleniu alertu danych usługi Azure Monitor, wywołuje [grupy akcji](monitoring-action-groups.md). Grupy akcji umożliwiają wyzwalanie co najmniej jedną akcję, aby powiadomić inne osoby o alercie, a także jego rozwiązania.
...
* Dowiedz się, jak [skonfigurować alerty, gdy zostaje opublikowany powiadomienie usługi Azure Service Health](monitoring-activity-log-alerts-on-service-notifications.md).
