...
* Zadanie automatycznego skalowania ma zawsze wartość skojarzona metrykę, aby skalować, sprawdzania, czy ma ona przekroczyła skonfigurowany próg dla skalowalnego w poziomie lub w skali. Można wyświetlić listę metryk tej Skalowanie automatyczne pozwala skalować przez na [typowe metryki automatycznego skalowania usługi Azure Monitor](insights-autoscale-common-metrics.md).
...
![Ustawienia automatycznego skalowania](./media/insights-autoscale-best-practices/insights-autoscale-best-practices-2.png)
