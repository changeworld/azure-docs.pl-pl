...
[Schemat konfiguracji usługi Diagnostyka 1.0](azure-diagnostics-schema-1dot0.md)  

[Schemat konfiguracji usługi Diagnostyka 1.2](azure-diagnostics-schema-1dot2.md)  

[Diagnostyka 1.3 i nowsze schemat konfiguracji](azure-diagnostics-schema-1dot3-and-later.md)  
...
>
> Aby uzyskać więcej informacji, zapoznaj się z odwołania [szczegółowa dokumentacja Schemat rozszerzenia diagnostyki.](azure-diagnostics-schema-1dot3-and-later.md)
...
Dodano element ujścia i możliwość wysyłania danych diagnostycznych [usługi Application Insights](../application-insights/app-insights-cloudservices.md) ułatwia diagnozowanie problemów z aplikacji, jak i w poziomie systemu i infrastruktury.
