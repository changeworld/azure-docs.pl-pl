...
![Publiczna Konfiguracja diagnostyki](media/azure-diagnostics-configure-application-insights/AzDiag_Channels_App_Insights.png)
...
![Diagnostyka wychwytywanie konfiguracji za pomocą usługi Application Insights](media/azure-diagnostics-configure-application-insights/Azure_Diagnostics_Sinks.png)
...
* Użyj [programu Visual Studio](../vs-azure-tools-diagnostics-for-cloud-services-and-virtual-machines.md) włączyć rozszerzenie diagnostyki platformy Azure dla aplikacji
