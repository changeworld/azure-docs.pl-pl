...
Aby zmienić domyślny limit oczekujących uruchomień, w definicji wyzwalacza źródłowego Dodaj właściwość `runtimeConfiguration.concurency.maximumWaitingRuns` z wartością między `1` i `100`. 
