...
| **pfx** | Yes | <*base64-encoded-pfx-file*> | Zawartość algorytmem Base64 z pliku wymiany informacji osobistych (PFX) |
...
| **audience** | Yes | <*resource-to-authorize*> | Zasób, który ma autoryzację do użycia, na przykład `https://management.core.windows.net/` |
...
| **pfx** | Tak — tylko typ poświadczeń "Certificate" | <*base64-encoded-pfx-file*> | Zawartość algorytmem Base64 z pliku wymiany informacji osobistych (PFX) |
| **Klucz tajny** | Tak, tylko w przypadku "Wpis tajny" typ poświadczeń | <*secret-for-authentication*> | Zakodowane w formacie base64 klucza tajnego, który klient korzysta z żądania autoryzacji |
|||||
