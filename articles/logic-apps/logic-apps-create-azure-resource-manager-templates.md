---
title: Tworzenie szablonów aplikacji logiki na potrzeby wdrożenia — Azure Logic Apps
...
Aby wygenerować szablon po zainstalowaniu modułu LogicAppTemplate, uruchom następujące polecenie programu PowerShell:
