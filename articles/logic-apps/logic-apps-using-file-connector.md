...
* Aby pomóc w ulepszaniu usługi Azure Logic Apps i łączniki, przesyłaj pomysły lub Głosuj na [witryny usługi Azure Logic Apps User Voice](http://aka.ms/logicapps-wish).
