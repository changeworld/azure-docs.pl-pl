...
1. Aby wyświetlić te metadane w definicji JavaScript Object Notation (JSON) dla konta integracji, wybierz **Edytuj jako dane JSON** , aby otwierała tego edytora JSON: 
