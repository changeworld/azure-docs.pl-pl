...
Aby uzyskać więcej informacji, zobacz [hosta interfejsu API RESTful z CORS w usłudze Azure App Service](../app-service/app-service-web-tutorial-rest-api.md).
