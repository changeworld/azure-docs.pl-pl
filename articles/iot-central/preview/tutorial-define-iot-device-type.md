...
![Urządzenie IoT](./media/tutorial-define-iot-device-type/gateway-downstream-new.png)

Zostanie wyświetlona strona przegląd. Kliknij przycisk **Utwórz** . 

![Urządzenie IoT](./media/tutorial-define-iot-device-type/gateway-downstream-review.png)

Utworzono nowy szablon urządzenia. 

![Urządzenie IoT](./media/tutorial-define-iot-device-type/occupancy-sensor.png)

Utworzysz szablon urządzenia dla czujnika S1. 

Kliknij pozycję Szablony urządzeń na lewym pasku nawigacyjnym, kliknij pozycję **+ Nowy**, wybierz kafelek **urządzenia IoT** i wybierz kafelek Czujnik zajętości, a następnie kliknij przycisk **Dalej: Dostosuj.**

![Urządzenie IoT](./media/tutorial-define-iot-device-type/s1-sensor.png)

Zostanie wyświetlona strona przegląd. Kliknij przycisk **Utwórz** . 

![Urządzenie podrzędne](./media/tutorial-define-iot-device-type/s1-review.png)

Utworzono nowy szablon urządzenia. 

![Urządzenie podrzędne](./media/tutorial-define-iot-device-type/s1-template.png)
...
![Strona aplikacji centralnej](./media/tutorial-define-iot-device-type/gatewaypattern.png)
...
![Strona aplikacji centralnej](./media/tutorial-define-iot-device-type/devicetemplate.png)

Kliknij pozycję **+ Nowy** , aby rozpocząć tworzenie nowego szablonu urządzenia.

![Szablony urządzeń — nowe](./media/tutorial-define-iot-device-type/devicetemplatenew.png)

![Wybór szablonów urządzeń — Brama](./media/tutorial-define-iot-device-type/gateway-review.png)
...
![Wybór szablonów urządzeń — Brama](./media/tutorial-define-iot-device-type/gateway-customize.png)

Zostanie wyświetlona strona przeglądu, a następnie kliknij pozycję **Utwórz** . 

![Szablon urządzenia — brama](./media/tutorial-define-iot-device-type/gateway-review.png)
...
![Szablon urządzenia — brama](./media/tutorial-define-iot-device-type/gateway-occupancy-s1-rel.png)
...
![Szablon urządzenia — brama](./media/tutorial-define-iot-device-type/smartbuildingdevice.png)
...
![Szablon urządzenia — zajętość](./media/tutorial-define-iot-device-type/occupancydevice.png)

Z poziomu Eksploratora urządzeń Utwórz symulowany czujnik S1. 

![Szablon urządzenia — S1](./media/tutorial-define-iot-device-type/s1device.png)
...
![Szablon urządzenia — S1](./media/tutorial-define-iot-device-type/connecttogateway.png)
