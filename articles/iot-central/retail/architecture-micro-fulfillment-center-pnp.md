...
Aplikację Azure IoT Central w ramach rozwiązania można skonfigurować do eksportowania surowych lub zagregowanych szczegółowych informacji do zestawu usług Azure PaaS (Platform-as-a-Service), które mogą wykonywać manipulowanie danymi i wzbogacać te informacje przed lądowaniem w firmie Aplikacji. 
