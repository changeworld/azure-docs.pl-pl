...
![Karta "Pulpit nawigacyjny" z wyświetlanych ustawień i właściwości dla kafelka](media/howto-personalize-dashboard-experimental/personaldashboard.png)
...
![Pulpit nawigacyjny przełącznika](media/howto-personalize-dashboard-experimental/switchdashboards.png)

Możesz edytować swoje osobiste pulpity nawigacyjne i usuń te, które nie są już potrzebne:

![Usuwanie pulpitu nawigacyjnego](media/howto-personalize-dashboard-experimental/managedashboards.png)
...
> [Dowiedz się, jak zarządzać swoimi preferencjami dotyczącymi aplikacji](howto-manage-preferences.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
