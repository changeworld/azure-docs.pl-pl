...
1. Aplikacja usługi Azure IoT Central, utworzone na podstawie **Devkits przykładowe** szablon aplikacji. Aby uzyskać więcej informacji, zapoznaj się z [przewodnikiem Szybki start dotyczącym tworzenia aplikacji](quick-deploy-iot-central-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
- Dane telemetryczne, zawierającą pomiarów urządzenia **wilgotności**, **temperatury**, **wykorzystanie**, **magnetometrów** (mierzoną wzdłuż X, Y osi Z), **przyspieszeniomierza** (mierzoną wzdłuż X, Y osi Z) i **Żyroskop** (mierzoną wzdłuż X, Y osi Z).
...
Można znaleźć szczegółowe informacje o konfiguracji [Szczegóły szablonu zestawu deweloperskiego urządzenia](#mxchip-device-template-details)
...
1. Upewnij się zapisać te informacje, jak będzie tymczasowo rozłączenia połączenia z Internetem podczas przygotowywania urządzenia Mxchip.
...
1. Otwórz przeglądarkę internetową i przejdź do [ http://192.168.0.1/start ](http://192.168.0.1/start). Następujące wyświetla stronę sieci web:
    ...
    ![Strona konfiguracji urządzenia](media/howto-connect-devkit-experimental/configpage.png)
...
1. Po wybraniu **Konfigurowanie urządzenia**, zostanie wyświetlona następująca strona:
    ...
    ![Urządzenia skonfigurowane](media/howto-connect-devkit-experimental/deviceconfigured.png)
...
1. Użyj **Device Explorer** można przejść do **pomiarów** strona rzeczywistego urządzenia zestawu deweloperskiego został dodany:
    ...
    ![Przejdź do rzeczywistego urządzenia](media/howto-connect-devkit-experimental/realdevicenew.png)

1. Na **pomiarów** strony, możesz zobaczyć dane telemetryczne pochodzące z urządzeń zestawu deweloperskiego:

    ![Wyświetlanie telemetrii z rzeczywistego urządzenia](media/howto-connect-devkit-experimental/devicetelemetrynew.png)

1. Na **właściwości** strony, można wyświetlić ostatni numer struktury i lokalizacji urządzenia zgłoszona przez urządzenie:

    ![Wyświetl właściwości urządzenia](media/howto-connect-devkit-experimental/devicepropertynew.png)

1. Na **ustawienia** strony, możesz zaktualizować ustawienia na urządzeniu zestawu deweloperskiego:

    ![Wyświetl ustawienia urządzenia](media/howto-connect-devkit-experimental/devicesettingsnew.png)

1. Na **pulpit nawigacyjny** stronie widać, lokalizacja, mapy

    ![Wyświetl pulpit nawigacyjny z urządzenia](media/howto-connect-devkit-experimental/devicedashboardnew.png)
