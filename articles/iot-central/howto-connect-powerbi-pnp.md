...
ms.locfileid: "69880074"
---
# <a name="visualize-and-analyze-your-azure-iot-central-data-in-a-power-bi-dashboard-preview-features"></a>Wizualizowanie i analizowanie danych IoT Central platformy Azure na pulpicie nawigacyjnym Power BI (funkcje w wersji zapoznawczej)

[!INCLUDE [iot-central-pnp-original](../../includes/iot-central-pnp-original-note.md)]

*Ten temat ma zastosowanie do administratorów.*

![Potok rozwiązania Power BI](media/howto-connect-powerbi-pnp/iot-continuous-data-export.png)
...
To rozwiązanie konfiguruje potok, który pobiera dane z konta usługi Azure Blob Storage z [ciągłego eksportu danych](howto-export-data-blob-storage-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json). Te dane są przesyłane przez program do Azure Functions, Azure Data Factory i Azure SQL Database do przetwarzania i przekształcania danych. Dane wyjściowe można wizualizować i analizować w Power BI raport, który można pobrać jako plik PBIX. Wszystkie te zasoby są tworzone w ramach subskrypcji platformy Azure, dzięki czemu można dostosować każdy składnik do swoich potrzeb.
...
- Wyeksportowane dane przy użyciu [ciągłego eksportu danych](howto-export-data-blob-storage-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) z aplikacji IoT Central. Zalecamy włączenie pomiarów, urządzeń i strumieni szablonów urządzeń w celu maksymalnego wykorzystania pulpitu nawigacyjnego Power BI.
...
![Strona raportu Power BI 1](media/howto-connect-powerbi-pnp/template-page1-hasdata.PNG)
...
![Strona raportu Power BI 2](media/howto-connect-powerbi-pnp/template-page2-hasdata.PNG)
...
![Widok grupy zasobów w witrynie Azure Portal](media/howto-connect-powerbi-pnp/azure-deployment.PNG)
...
> [Jak zarządzać urządzeniami](howto-manage-devices-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)