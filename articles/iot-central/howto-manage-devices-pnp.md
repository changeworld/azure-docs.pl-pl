...
1. Wybierz pozycję **urządzenia** w menu nawigacji po lewej stronie. W tym miejscu zostanie wyświetlona lista wszystkich urządzeń i szablonów urządzeń.
...
1. Wybierz pozycję **urządzenia** w menu nawigacji po lewej stronie.
...
1. Wybierz urządzenia, które chcesz wyeksportować, a następnie wybierz akcję **Eksportuj** .
    ...
    ![Eksportowanie](./media/howto-manage-devices-pnp/export1a.png)
...
Aby uzyskać więcej informacji na temat parametrów połączenia i łączenia rzeczywistych urządzeń z aplikacją IoT Central, zobacz [łączność urządzenia w usłudze Azure IoT Central](concepts-connectivity-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
1. Wybierz pozycję **urządzenia** w menu nawigacji.
