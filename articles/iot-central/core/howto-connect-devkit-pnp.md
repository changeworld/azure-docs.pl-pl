...
- Aplikacja IoT Central utworzona na podstawie szablonu **aplikacji w wersji zapoznawczej** . Możesz wykonać kroki opisane w temacie [Tworzenie aplikacji IoT Plug and Play](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
