...
Aby zapoznać się z omówieniem Azure IoT Edge, [zapoznaj się z tym artykułem](overview-iot-central-pnp.md). 
...
![Strona aplikacji centralnej](./media/tutorial-define-edge-device-type-pnp/gateway-transparent.png)
...
![Strona aplikacji centralnej](./media/tutorial-define-edge-device-type-pnp/gateway-module.png)
...
![Strona aplikacji centralnej](./media/tutorial-define-edge-device-type-pnp/gateway-module-transparent.png)
...
![Strona aplikacji centralnej](./media/tutorial-define-edge-device-type-pnp/gateway-module2-transparent.png)
...
![Strona aplikacji centralnej](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplate.png)

Kliknij pozycję **+ Nowy** , aby rozpocząć tworzenie nowego szablonu urządzenia.

![Szablony urządzeń — nowe](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplatenew.png)
...
![Wybór szablonów urządzeń — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/selectiotedge.png)
...
![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplateuploadmanifest.png)
...
![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-upload.png)
...
![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/deploymentmanifestvalidate.png)

Poniżej znajduje się przepływ cyklu życia manifestu wdrożenia w IoT Central.

![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/dmflow.png)
...
![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplatereview.png)

W przypadku wybrania urządzenia bramy zostanie wyświetlona strona przeglądu

![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-review.png)
...
![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgedevicetemplatelanding.png)
...
![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgemodelling.png)
...
* Kliknij pozycję **Zarządzaj** interfejsem modelu możliwości modułu SimulatedTemperatureSensor. Kliknij pozycję **Dodaj funkcję**. 
    ...
    ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplateaddcapability.png)
  
* Dodaj maszynę jako typ obiektu, ponieważ jest to typ złożony
  
    ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatemachineobject.png)
    ...
    ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatemachineattributes.png)
...
* Dodaj otoczenie jako typ obiektu, ponieważ jest to typ złożony
    ...
    ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplateambientattributes.png)

  
* Dodaj timeCreated jako typ DateTime i kliknij przycisk **Zapisz** .
  
    ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplateallattributes.png)
...
W przypadku wybrania urządzenia z systemem Azure IoT Edge jako urządzenie bramy można dodać relacje podrzędne do modeli możliwości urządzeń, które będą się łączyć z urządzeniem bramy.
  ...
  ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-add-relationship.png)

Relację można dodać na urządzeniu lub w module.
  
  ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-relationship-types.png)


Możesz wybrać model możliwości urządzenia podrzędnego lub wybrać pozycję gwiazdki. 
  
  ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-downstream-rel.png)
  ...
  ![Szablon urządzenia — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/gateway-add-relationship-asterix.png)
...
2. Wybierz pozycję **Zapisz** , aby zapisać zmiany:
    ...
    ![Właściwości chmury — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatecloudproperties.png)
...
![Dostosowania — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/edgetemplatecustomize.png)
...
![Widoki — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/visualizingthedevice.png)
...
![Widoki — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/sensorambientchart.png)
...
![Widoki — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/sensorambienttelemetrychart.png)
...
![Widoki — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/viewsdashboard.png)
...
![Widoki — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/editingdeviceandclouddata.png)
...
![Widoki — Azure IoT Edge](./media/tutorial-define-edge-device-type-pnp/views-properties.png)
...
2. Wybierz pozycję **Publikuj**.
    ...
    ![Widoki — publikowanie](./media/tutorial-define-edge-device-type-pnp/edgetemplatepublish.png)

1. W oknie dialogowym **Publikowanie szablonu urządzenia** wybierz pozycję **Publikuj**:
  
    ![Widoki — publikowanie](./media/tutorial-define-edge-device-type-pnp/edgepublishtemplate.png)
...
![Widoki — publikowanie](./media/tutorial-define-edge-device-type-pnp/publishedtemplate.png)
