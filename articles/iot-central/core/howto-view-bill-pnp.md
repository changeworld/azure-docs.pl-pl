...
1. Przejdź do strony **rozliczeń** w sekcji **Administracja** .
    ...
    ![Stan wersji próbnej](media/howto-view-bill-pnp/freetrialbilling.png)

1. Wybierz pozycję **Konwertuj na płatność zgodnie z rzeczywistym**użyciem.

    ![Konwertuj wersję próbną](media/howto-view-bill-pnp/convert.png)
...
Teraz, gdy wiesz już, jak zarządzać rozliczeniami w aplikacji IoT Central platformy Azure, sugerowanym następnym krokiem jest zapoznanie się z tematem [Dostosowywanie interfejsu użytkownika aplikacji](howto-customize-ui-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) na platformie Azure IoT Central.