---
title: 'Samouczek: Konfigurowanie reguł i akcji na platformie Azure IoT Central'
...
1. Aby dodać nową regułę opartą na telemetrii do aplikacji, w okienku po lewej stronie wybierz pozycję **Szablony urządzeń**:
