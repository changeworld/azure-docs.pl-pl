...
![Tworzenie szablonu aplikacji](media/howto-use-app-templates-pnp/create-template.png)
...
![Tworzenie aplikacji na podstawie szablonu](media/howto-use-app-templates-pnp/create-app.png)
...
Teraz, gdy wiesz już, jak korzystać z szablonów aplikacji, sugerowanym następnym krokiem jest zapoznanie się z tematem jak [zarządzać IoT Central z Azure Portal](howto-manage-iot-central-from-portal.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
