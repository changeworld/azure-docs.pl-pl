...
1. Utwórz [regułę telemetrii](tutorial-create-telemetry-rules-pnp.md). Zapisz regułę i Dodaj nową akcję.

    ![Ekran tworzenia elementu webhook](media/howto-create-webhooks-pnp/webhookcreate.png)
...
Teraz, gdy już wiesz, jak skonfigurować elementy webhook i korzystać z nich, zalecanym następnym krokiem jest zapoznanie się z tematem [Konfigurowanie grup akcji Azure monitor](howto-use-action-groups-pnp.md).
