...
![Wybieranie akcji](media/howto-use-action-groups-pnp/chooseaction.png)

Wybierz grupę akcji z subskrypcji platformy Azure:

![Wybierz grupę akcji](media/howto-use-action-groups-pnp/chooseactiongroup.png)
...
![Zapisano grupę akcji](media/howto-use-action-groups-pnp/savedactiongroup.png)
...
| Webhook     | {"schemaId": "AzureIoTCentralRuleWebhook", "Data": {[regularny ładunek elementu webhook](howto-create-webhooks-pnp.md#payload)}} |
...
Teraz, gdy wiesz już, jak używać grup akcji z regułami, sugerowanym następnym krokiem jest zapoznanie się z tematem [Zarządzanie urządzeniami](howto-manage-devices-pnp.md).
