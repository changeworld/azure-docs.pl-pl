...
2. wybierz subskrypcję. 
    ...
    > [!Note] 
    > Teraz możesz wyeksportować dane do innych subskrypcji, które nie są takie same jak dla standardowej aplikacji IoT Central. W tym przypadku zostanie nawiązane połączenie przy użyciu parametrów połączenia.
...
2. W lewym okienku wybierz pozycję **ciągły eksport danych**.

    > [!Note]
    > Jeśli nie widzisz ciągłego eksportu danych w okienku po lewej stronie, nie jesteś administratorem w swojej aplikacji. Skontaktuj się z administratorem, aby skonfigurować eksportowanie danych.
