...
1. W okienku po lewej stronie wybierz pozycję **Zestawy urządzeń** .

1. Wybierz pozycję **+ Nowy**.

    ![Nowy zestaw urządzeń](media/howto-use-device-sets/image1.png)

1. Nadaj urządzeniu nazwę, która jest unikatowa w całej aplikacji. Możesz również dodać opis. Zestaw urządzeń może zawierać tylko urządzenia z jednego szablonu urządzenia. Wybierz szablon urządzenia, który ma być używany dla tego zestawu.
...
Analiza w zestawach urządzeń jest taka sama jak główna Karta analityczna w okienku po lewej stronie. Więcej informacji na temat analiz można znaleźć w artykule na temat [tworzenia analiz](howto-use-device-sets.md).
