...
Przejdź do witryny sieci Web programu [Azure IoT Central Application Manager](https://aka.ms/iotcentral) . Musisz zalogować się przy użyciu osobistego konta Microsoft lub konta służbowego.
