...
1. Wybierz **Device Explorer** w menu nawigacji po lewej stronie. W tym miejscu możesz wyświetlić listę swoje [szablonów urządzeń](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
1. W okienku po prawej stronie **Device Explorer** strony, zobaczysz listę urządzeń utworzone na podstawie szablonu, którego urządzenia. Wybierz poszczególnych urządzeń, aby wyświetlić strony szczegółów urządzenia dla tego urządzenia:
    ...
    ![Strony szczegółów urządzenia](./media/howto-manage-devices-experimental/devicelist.png)
...
1. Po zakończeniu importowania w siatce urządzeń wyświetlany jest komunikat o powodzeniu.
    ...
    ![Powodzenie importu](./media/howto-manage-devices-experimental/BulkImport3.png)
...
1. W panelu po lewej stronie wybierz **Brak skojarzenia urządzenia**:
    ...
    ![Urządzenia nieskojarzone](./media/howto-manage-devices-experimental/UnassociatedDevices1.png)
...
> [Jak użyć zestawów urządzenia](howto-use-device-sets.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
