...
1. Kliknij przycisk **Wygeneruj Token**.
    ![Zrzut ekranu strony tokenu dostępu](media/howto-use-iotc-explorer-experimental/accesstokenspage.png)

1. Wprowadź nazwę tokenu, kliknij przycisk **dalej**, a następnie **kopiowania**.
    > [!NOTE]
    ...
    ![Kopiuj zrzut ekranu okna dialogowego tokenu dostępu](media/howto-use-iotc-explorer-experimental/copyaccesstoken.png)
...
![dane wyjściowe polecenia monitorowanie wiadomości](media/howto-use-iotc-explorer-experimental/monitormessages.png)
...
![dane wyjściowe polecenia GET-twin](media/howto-use-iotc-explorer-experimental/getdevicetwin.png)
...
Teraz, gdy wyjaśniono sposób za pomocą Eksploratora IoT Central, sugerowane następnym krokiem jest Eksplorowanie [zarządzanie urządzeniami IoT Central](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
