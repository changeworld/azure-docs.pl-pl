...
1. Otwórz **program.cs** i Zastąp zawartość następującym kodem. Zaktualizuj, i `{your Device ID}` zwartościami,którezostaływcześniejzanotowane`{your Device Primary Key}`: `{your Scope ID}`
