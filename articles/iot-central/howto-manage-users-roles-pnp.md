...
1. Aby dodać użytkownika do aplikacji IoT Central, przejdź do strony **Użytkownicy** w sekcji **Administracja** .
    ...
    ![Lista użytkowników](media/howto-manage-users-roles-pnp/image1.png)
...
1. Wybierz rolę dla użytkownika z menu rozwijanego **rola** . Dowiedz się więcej o rolach w sekcji [Zarządzanie rolami](#manage-roles) w tym artykule.
    ...
    ![Wybór roli](media/howto-manage-users-roles-pnp/image3.png)
...
Teraz, gdy wiesz już, jak zarządzać użytkownikami i rolami w usłudze Azure IoT Central, sugerowanym następnym krokiem jest zapoznanie się z informacjami na temat [wyświetlania rachunku](howto-view-bill-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) na platformie Azure IoT Central.
