...
4. W nowej funkcji kliknij pozycję **</> Pobierz adres URL funkcji**, po czym skopiuj i zapisz wartość. Ta wartość zostanie użyta do skonfigurowania elementu webhook. 
...
6. Zapisać reguły. Teraz po wyzwoleniu reguły, element webhook wywoła aplikację funkcji, aby uruchomić. W aplikacji funkcji, można kliknąć opcje **Monitor** Aby wyświetlić historię wywołania funkcji. App Insights lub widok klasyczny umożliwia Przyjrzyj się historii.
