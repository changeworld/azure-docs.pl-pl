...
## <a name="export-to-blob-storage"></a>Eksportowanie do magazynu obiektów Blob
...
## <a name="export-to-event-hubs-and-service-bus"></a>Eksportowanie do usługi Event Hubs i Service Bus
