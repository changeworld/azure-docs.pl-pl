...
ms.locfileid: "71091806"
---
# <a name="how-to-use-service-bus-queues-with-nodejs-and-the-azure-sb-package"></a>Jak używać kolejek Service Bus przy użyciu środowiska Node. js i pakietu Azure-SB
...
Do operacji wykonywanych za pomocą **ServiceBusService**można zastosować opcjonalne operacje filtrowania. Operacje filtrowania mogą obejmować rejestrowanie, automatyczne ponawianie próby itd. Filtry to obiekty, które implementują metodę o następującej sygnaturze:
...
Dwa filtry, które implementują logikę ponowień, `ExponentialRetryPolicyFilter` są dołączone do zestawu Azure SDK dla środowiska Node. js i. `LinearRetryPolicyFilter` Poniższy kod tworzy `ServiceBusService` obiekt, który `ExponentialRetryPolicyFilter`używa:
