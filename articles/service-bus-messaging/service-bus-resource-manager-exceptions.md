...
| Nieprawidłowe żądanie | 40000 | Kod Subcode = 40000. Nie można zmienić wartości właściwości "requiresDuplicateDetection" istniejącej kolejki. | Wykrywanie duplikatów musi być włączone/wyłączone w momencie tworzenia jednostki. Po utworzeniu nie można zmienić parametru konfiguracji wykrywania duplikatów. | Aby włączyć wykrywanie duplikatów dla wcześniej utworzonej kolejki/subskrypcji, można utworzyć nową kolejkę z wykrywaniem duplikatów, a następnie przesłać ją dalej z oryginalnej kolejki do nowej kolejki. |
...
| Nieprawidłowe żądanie | 40000 | Kod Subcode = 40000. Nie można zmienić partycjonowania dla kolejki. | Nie można zmienić partycjonowania dla jednostki. | Utwórz nową jednostkę i Włącz partycje. | 
