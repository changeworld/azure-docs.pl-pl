...
|**Kategoria**    |**Nazwa**                                 |
|----------------|-----------------------------------------|
|Narzędzia platformy Azure     |[Program Azure PowerShell (6.0.1)](https://docs.microsoft.com/powershell/azure/overview)<br> [Azure CLI (2.0.32)](https://docs.microsoft.com/cli/azure)|
