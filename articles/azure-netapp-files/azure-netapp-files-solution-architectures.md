...
## <a name="azure-kubernetes-service-aks-solutions"></a>Rozwiązania usługi Azure Kubernetes Service (AKS)

* [Integracja Azure NetApp Files z usługą AKS](https://github.com/andyzhangx/demo/tree/master/linux/nfs)
* [Integracja Azure NetApp Files z usługą Azure Kubernetes Service](https://docs.microsoft.com/azure/aks/azure-netapp-files)

## <a name="oracle-database-solutions"></a>Rozwiązania bazy danych Oracle
...
## <a name="sap-application-solutions"></a>Rozwiązania aplikacji SAP 
...
* [SAP HANA skalowanie w poziomie z węzłem gotowości na maszynach wirtualnych platformy Azure z Azure NetApp Files w systemie RedHat Enterprise Linux](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-scale-out-standby-netapp-files-rhel)
...
## <a name="talon-solutions"></a>Rozwiązania Talon

* [Globalnie rozproszone udostępnianie plików w przedsiębiorstwie za pomocą Azure NetApp Files i Talon FAST™](https://www.talonstorage.com/products/azure-netapp-files)

## <a name="windows-virtual-desktopvdi-solutions"></a>Pulpity wirtualne systemu Windows/infrastruktury VDI
