...
![Logo usługi Office 365](media/monitoring-solution-office-365/icon.png)
...
Rozpocznij od dodania [rozwiązanie usługi Office 365, aby Twoja subskrypcja](monitoring-solutions.md#install-a-management-solution). Po dodaniu, należy wykonać kroki konfiguracji w tej sekcji, aby umożliwić dostęp do subskrypcji usługi Office 365.
...
1. Kliknij pozycję **Rejestrowanie nowej aplikacji**.
    ...
    ![Dodawanie rejestracji aplikacji](media/monitoring-solution-office-365/add-app-registration.png)
1. Wprowadź aplikację **nazwa** i **adres URL logowania**.  Nazwa powinna być opisowe.  Użyj _http://localhost_ dla adresu URL i Zachowaj _aplikacji sieci Web / interfejs API_ dla **typ aplikacji**
    ...
    ![Utwórz aplikację](media/monitoring-solution-office-365/create-application.png)
1. Kliknij przycisk **Utwórz** i zweryfikować informacje o aplikacji.

    ![Zarejestrowana aplikacja](media/monitoring-solution-office-365/registered-app.png)
...
1. Wybierz **właściwości**. Zmiana **wielodostępnych** do _tak_.
    ...
    ![Ustawienia wielodostępnej](media/monitoring-solution-office-365/settings-multitenant.png)
...
1. Kliknij przycisk **wybierz interfejs API** i następnie **interfejsów API zarządzania usługi Office 365**. Kliknij przycisk **interfejsów API zarządzania usługi Office 365**. Kliknij pozycję **Wybierz**.
    ...
    ![Wybieranie interfejsu API](media/monitoring-solution-office-365/select-api.png)
...
1. W obszarze **wybierz uprawnienia** wybierz następujące opcje dla obu **uprawnienia aplikacji** i **delegowane uprawnienia**:
    ...
    ![Wybieranie interfejsu API](media/monitoring-solution-office-365/select-permissions.png)
...
1. Kliknij przycisk **udzielić uprawnień** a następnie kliknij przycisk **tak** po wyświetleniu monitu o weryfikację.
    ...
    ![Udzielenie uprawnień](media/monitoring-solution-office-365/grant-permissions.png)
...
1. Kliknij przycisk **Zapisz** , a następnie skopiuj **wartość** generowany.
    ...
    ![Klucze](media/monitoring-solution-office-365/keys.png)
...
1. Użytkownik zobaczy okno podobny do przedstawionego poniżej. Kliknij przycisk **zaakceptować**.
    ...
    ![Zgoda administratora](media/monitoring-solution-office-365/admin-consent.png)
...
### <a name="troublshooting"></a>Rozwiązywanie problemów
...
![Kafelek podsumowania usługi Office 365](media/monitoring-solution-office-365/tile.png)  

Kliknij pozycję **usługi Office 365** Kafelek, aby otworzyć **usługi Office 365** pulpitu nawigacyjnego.

![Pulpit nawigacyjny usługi Office 365](media/monitoring-solution-office-365/dashboard.png)  
