...
Aby ponownie włączyć monitorowania dla klastra, zobacz [Włącz monitorowanie przy użyciu wiersza polecenia platformy Azure](monitoring-container-insights-onboard.md#enable-monitoring-using-azure-cli).
...
4. Edytuj wartości **aksResourceId** i **aksResourceLocation** przy użyciu wartości klastra AKS, który można znaleźć na **właściwości** strona dla wybranego klastra .
    ...
    ![Strona właściwości kontenera](media/monitoring-container-insights-optout/container-properties-page.png)
