---
title: Zbieranie danych Cisco w wersji zapoznawczej Azure przez wartownika | Dokumentacja firmy Microsoft
description: Dowiedz się, jak zbierać dane Cisco w przez wartownika platformy Azure.
services: sentinel
...
Skonfiguruj Cisco ASA na udostępnianie dalej, komunikaty dziennika systemu do obszaru roboczego platformy Azure za pomocą agenta usługi Syslog:
...
6. Aby użyć odpowiednich schematu w usłudze Log Analytics dla zdarzenia Cisco, wyszukaj **CommonSecurityLog**.
