...
### <a name="use-autocluster-for-single-record-set-clustering"></a>Użyj `autocluster()` dla pojedynczego rekordu Ustaw klastrowania
...
| SegmentId | Licznik | Procent | Region | ScaleUnit | DeploymentId | ServiceHost |
|-----------|-------|------------------|--------|-----------|----------------------------------|--------------------------------------|
...
### <a name="use-basket-for-single-record-set-clustering"></a>Użyj `basket()` dla pojedynczego rekordu Ustaw klastrowania
...
| SegmentId | Licznik | Procent | Region | ScaleUnit | DeploymentId | Punkt śledzenia | ServiceHost |
|-----------|-------|------------------|--------|-----------|----------------------------------|------------|--------------------------------------|
| 0 | 639 | 65.7407407407407 | eau | su7 | b5d1d4df547d4a04ac15885617edba57 |  | e7f60c5d-4944-42b3-922a-92e98a8e7dec |
