...
Zaimportuj klasy z bibliotek oraz biblioteki analizy danych *datetime* i *pandas*.
...
## <a name="validate-that-data-was-ingested-into-the-table"></a>Sprawdzanie, czy dane zostały pozyskane do tabeli
