...
Zestaw wierszy jest również uznawana za serializacji, jeśli jest to wynikiem: **sortowania**, **górnej**, lub **zakres** operatorów i, opcjonalnie, **projektu**, **away projektu**, **rozszerzyć**, **gdzie**, **przeanalizować**, **mvexpand**, lub **zająć** operatorów.
