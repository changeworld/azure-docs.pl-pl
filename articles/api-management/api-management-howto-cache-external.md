...
ms.locfileid: "52620914"
---
# <a name="use-an-external-redis-cache-in-azure-api-management"></a>Używanie zewnętrznej pamięci podręcznej Redis w usłudze Azure API Management

Oprócz korzystania z wbudowanej pamięci podręcznej, usługa Azure API Management umożliwia także buforowanie odpowiedzi w zewnętrznej pamięci podręcznej Redis.
...
## <a name="create-cache"> </a> Tworzenie pamięci podręcznej Azure Redis Cache

W tej sekcji opisano, jak utworzyć pamięć podręczną Redis na platformie Azure. Jeśli masz już pamięć podręczną Redis w obrębie platformy Azure lub poza nią, możesz <a href="#add-external-cache">pominąć</a> te kroki i przejść do następnej sekcji.

[!INCLUDE [redis-cache-create](../../includes/redis-cache-create.md)]

## <a name="add-external-cache"> </a>Dodawanie zewnętrznej pamięci podręcznej

Wykonaj poniższe kroki, aby dodać zewnętrzną pamięć podręczną Redis w usłudze Azure API Management.

![Dodawanie własnej pamięci podręcznej do usługi APIM](media/api-management-howto-cache-external/add-external-cache.png)

> [!NOTE]
> Ustawienie **Używane z** określa, które wdrożenie regionalne usługi API Management będzie komunikować się za pomocą skonfigurowanej pamięci podręcznej w przypadku konfiguracji usługi API Management w wielu regionach. Pamięci podręczne określone jako **Domyślne** zostaną zastąpione przez pamięci podręczne z wartością regionalną.
>
...
### <a name="add-an-azure-redis-cache-from-the-same-subscription"></a>Dodawanie pamięci podręcznej Azure Redis Cache z tej samej subskrypcji
...
5. Wybierz pozycję **Domyślne** lub określ żądany region w polu rozwijanym **Używane z**.
6. Kliknij pozycję **Zapisz**.

### <a name="add-a-redis-cache-hosted-outside-of-the-current-azure-subscription-or-azure-in-general"></a>Dodawanie pamięci podręcznej Redis hostowanej poza bieżącą subskrypcją platformy Azure lub poza samą platformą Azure
