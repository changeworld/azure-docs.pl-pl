...
Wyrażenia pojedynczej instrukcji są zawarte w `@(expression)`, gdzie `expression` jest poprawnie sformułowaną C# instrukcją expression.

Wyrażenia wieloinstrukcji są zawarte w `@{expression}`. Wszystkie ścieżki kodu w wyrażeniach wieloinstrukcji muszą kończyć się instrukcją `return`.
...
|<a id="ref-context-request-headers"></a>kontekst ciągu. Request. Headers. GetValueOrDefault (headerName: String, DefaultValue: String)|headerName: ciąg<br /><br /> DefaultValue: ciąg<br /><br /> Zwraca wartości nagłówka żądania oddzielone przecinkami lub `defaultValue`, jeśli nie można odnaleźć nagłówka.|
...
|<a id="ref-context-response-headers"></a>kontekst ciągu. Response. Headers. GetValueOrDefault (headerName: String, DefaultValue: String)|headerName: ciąg<br /><br /> DefaultValue: ciąg<br /><br /> Zwraca wartości nagłówka odpowiedzi oddzielone przecinkami lub `defaultValue`, jeśli nie odnaleziono nagłówka.|
...
|Jwt|Algorytm: ciąg<br /><br /> Odbiorcy: < ciągu IEnumerable\><br /><br /> Oświadczenia: IReadOnlyDictionary < String, String [] ><br /><br /> ExpirationTime: DateTime?<br /><br /> ID: ciąg<br /><br /> Wystawca: ciąg<br /><br /> IssuedAt: DateTime?<br /><br /> NotBefore: DateTime?<br /><br /> Podmiot: ciąg<br /><br /> Typ: ciąg|
