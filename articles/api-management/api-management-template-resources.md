...
|WebAuthenticationTenantNotRegistered|Twoje konto należy do dzierżawy usługi Azure Active Directory, która nie ma autoryzacji do uzyskiwania dostępu do tego portalu.|  
