...
|różnią się przez-— parametr zapytania|Firmy rozpoczynają buforowanie odpowiedzi na wartości określonych parametrów zapytania. Wprowadź jeden lub wiele parametrów. Użyj średnika jako separatora. Jeśli nie jest określona, używane są wszystkie parametry zapytania.|Nie|  
...
|Name (Nazwa)|Opis|Wymagane|  
|----------|-----------------|--------------|  
|wartość w przypadku magazynu pamięci podręcznej|Element główny.|Yes|  
...
|Name (Nazwa)|Opis|Wymagane|  
|----------|-----------------|--------------|  
|wartość w przypadku usuwania pamięci podręcznej|Element główny.|Yes|  
