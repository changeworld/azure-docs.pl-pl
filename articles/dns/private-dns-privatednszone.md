...
Aby zrozumieć, ile prywatnych stref DNS można utworzyć w ramach subskrypcji i ile zestawów rekordów jest obsługiwanych w prywatnej strefie DNS, zobacz [limity Azure DNS](https://docs.microsoft.com/azure/azure-subscription-service-limits#azure-dns-limits)
