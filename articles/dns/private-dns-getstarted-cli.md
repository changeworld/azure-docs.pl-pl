...
---
# <a name="create-an-azure-dns-private-zone-using-azure-cli"></a>Tworzenie strefy prywatnej usługi Azure DNS przy użyciu interfejsu wiersza polecenia platformy Azure
