...
| Azure Cloud Services |[Publiczny adres IP](dns-custom-domain.md#public-ip-address) |W przypadku statycznie przyznanych adresów IP można utworzyć rekord DNS A. W przypadku dynamicznie przyznanych adresów IP należy utworzyć rekord CNAME, który jest mapowany na nazwę *cloudapp.NET* .|
