...
9. W trzecim i ostatnim kroku określ **Grupę akcji**, która gwarantuje, że za każdym razem, gdy zostaje wywołany alert, wykonywane są te same akcje, i która może być używana dla każdej zdefiniowanej reguły.  Skonfiguruj nową grupę akcji, wprowadzając następujące informacje:  
   ...
   e. W okienku **Wiadomość e-mail/SMS/wypychana/głosowa** włącz opcję **E-mail** i podaj prawidłowy adres e-mail SMTP, na który mają być wysyłane wiadomości. f. Kliknij przycisk **OK**, aby zapisać zmiany.<br><br> ![Tworzenie nowej grupy akcji](./media/log-analytics-tutorial-response/action-group-properties-01.png)<br>
