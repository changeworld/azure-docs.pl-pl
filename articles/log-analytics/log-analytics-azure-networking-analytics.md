...
* Użyj [przeszukiwanie dzienników w usłudze Log Analytics](log-analytics-queries.md) Aby wyświetlić szczegółowe dane diagnostyczne platformy Azure.
