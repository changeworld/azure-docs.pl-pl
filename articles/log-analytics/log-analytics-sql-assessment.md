...
![Sprawdzanie kondycji SQL symboli](./media/log-analytics-sql-assessment/sql-assessment-symbol.png)
...
![Obraz przedstawiający Kafelek SQL Health Check](./media/log-analytics-sql-assessment/sql-healthcheck-summary-tile.png)

![Obraz przedstawiający pulpit nawigacyjny z SQL Health Check](./media/log-analytics-sql-assessment/sql-healthcheck-dashboard-01.png)
...
6. Na wszystkich stronach obszar koncentracji uwagi można wyświetlać zaleceń z priorytetami wprowadzone dla danego środowiska. Kliknij przycisk rekomendacji w obszarze **wpływ na obiekty** Aby wyświetlić szczegóły dotyczące Dlaczego tworzone są zalecenia.<br><br> ![Obraz przedstawiający zalecenia SQL Health Check](./media/log-analytics-sql-assessment/sql-healthcheck-dashboard-02.png)<br>
...
2. Użyj następującego zapytania do zaleceń listy, które nie powiodły, na komputerach w danym środowisku.
    ...
    Poniżej przedstawiono zrzut ekranu przedstawiający zapytaniu przeszukiwania dzienników:<br><br> ![zalecenia nie powiodło się](./media/log-analytics-sql-assessment/sql-assess-failed-recommendations.png)<br>
