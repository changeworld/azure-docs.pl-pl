...
| Grupy zabezpieczeń sieci | Microsoft.Network/networksecuritygroups | Diagnostyka |             | [Analiza sieciowej grupy zabezpieczeń platformy Azure](log-analytics-azure-networking-analytics.md#azure-network-security-group-analytics-solution-in-log-analytics) |
...
| Witryny sieci Web               | Microsoft.Web/sites <br> Microsoft.Web/sites/slots |             | Diagnostyka | [Azure Web Apps Analytics (wersja zapoznawcza)](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-azure-web-apps-analytics) |
...
Zobacz [usługa blob storage dla usług IIS i magazynu table storage zdarzeń](log-analytics-azure-storage-iis-table.md) Aby dowiedzieć się więcej na temat sposobu Log Analytics może zbierać dzienniki.
