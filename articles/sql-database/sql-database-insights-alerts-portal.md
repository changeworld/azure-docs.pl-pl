...
| Pula elastyczna | log_write_percent | Procent operacji we/wy dziennika | Średnia | 10 minut |
| Pula elastyczna | dtu_consumption_percent | Procent użycia jednostek DTU | Średnia | 10 minut |
| Pula elastyczna | storage_percent | Procent miejsca do magazynowania | Średnia | 10 minut |
...
| Pula elastyczna | eDTU_used | użyta wartość eDTU | Średnia | 10 minut |
| Pula elastyczna | storage_used | Użyty magazyn | Średnia | 10 minut |
||||||               
| SQL Data Warehouse | cpu_percent | Procent użycia procesora CPU | Średnia | 10 minut |
| SQL Data Warehouse | physical_data_read_percent | Procent użycia operacji we/wy na danych | Średnia | 10 minut |
...
| SQL Data Warehouse | dwu_consumption_percent | JEDNOSTEK dwu procent | Średnia | 10 minut |
| SQL Data Warehouse | dwu_used | JEDNOSTEK dwu używane | Średnia | 10 minut |
||||||
...
* Zapoznaj się [z omówieniem dzienników diagnostycznych](../azure-monitor/platform/platform-logs-overview.md) i zbierz szczegółowe metryki o wysokiej częstotliwości dotyczące usługi.
