...
| ---:| ---:|:--- |
| 4060 |16 |Nie można otworzyć bazy danych "%. &#x2a;ls "żądana przez nazwę logowania. Logowanie nie powiodło się. Aby uzyskać więcej informacji, zobacz [błędy 4000 do 4999](https://docs.microsoft.com/sql/relational-databases/errors-events/database-engine-events-and-errors#errors-4000-to-4999)|
| 40197 |17 |Usługa napotkała błąd podczas przetwarzania żądania. Spróbuj ponownie. Kod błędu% d.<br/><br/>Ten błąd występuje, gdy usługa nie działa z powodu uaktualnień oprogramowania lub sprzętu, awarii sprzętu lub innych problemów z trybem failover. Kod błędu (% d) [osadzony w komunikacie o błędzie 40197](sql-database-develop-error-messages.md#embedded-error-codes) zawiera dodatkowe informacje o rodzaju awarii lub pracy awaryjnej, które wystąpiły. Niektóre przykłady kodów błędów są osadzone w komunikacie o błędzie 40197 to 40020, 40143, 40166 i 40540.<br/><br/>Ponowne nawiązywanie połączenia z serwerem SQL Database automatycznie nawiązuje połączenie z dobrą kopią bazy danych. Aplikacja musi obsłużyć błąd 40197, zarejestrować osadzony kod błędu (% d) w komunikacie w celu rozwiązywania problemów, a następnie spróbować ponownie nawiązać połączenie z SQL Database, dopóki zasoby nie będą dostępne, a połączenie zostanie nawiązane. Aby uzyskać więcej informacji, zobacz [Błędy przejściowe](sql-database-connectivity-issues.md#transient-errors-transient-faults).|
| 40501 |20 |Usługa jest obecnie zajęta. Ponów żądanie po 10 sekundach. Identyfikator zdarzenia:% ls. Kod:% d. Aby uzyskać więcej informacji, zobacz: <br/>&bull; &nbsp;[Limit zasobów serwera bazy danych](sql-database-resource-limits-database-server.md)<br/>&bull; &nbsp;[jednostek DTU dla pojedynczych baz danych](sql-database-service-tiers-dtu.md)<br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>limity &bull; &nbsp;[rdzeń wirtualny dla pojedynczych baz danych](sql-database-vcore-resource-limits-single-databases.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md)<br/>[limity zasobów wystąpienia zarządzanego](sql-database-managed-instance-resource-limits.md)&bull; &nbsp;.|
| 40613 |17 |Baza danych "%. &#x2a;ls "na serwerze"%. &#x2a;ls "jest obecnie niedostępny. Spróbuj ponownie nawiązać połączenie później. Jeśli problem będzie nadal występować, skontaktuj się z działem obsługi klienta i podaj identyfikator śledzenia sesji "%". &#x2a;ls '.<br/><br/> Ten błąd może wystąpić, jeśli istnieje już istniejące dedykowane połączenie administratora (DAC) dla bazy danych. Aby uzyskać więcej informacji, zobacz [Błędy przejściowe](sql-database-connectivity-issues.md#transient-errors-transient-faults).|
| 49918 |16 |Nie można przetworzyć żądania. Za mało zasobów, aby przetworzyć żądanie.<br/><br/>Usługa jest obecnie zajęta. Spróbuj ponownie wykonać żądanie później. Aby uzyskać więcej informacji, zobacz: <br/>&bull; &nbsp;[Limit zasobów serwera bazy danych](sql-database-resource-limits-database-server.md)<br/>&bull; &nbsp;[jednostek DTU dla pojedynczych baz danych](sql-database-service-tiers-dtu.md)<br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>limity &bull; &nbsp;[rdzeń wirtualny dla pojedynczych baz danych](sql-database-vcore-resource-limits-single-databases.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md)<br/>[limity zasobów wystąpienia zarządzanego](sql-database-managed-instance-resource-limits.md)&bull; &nbsp;. |
| 49919 |16 |Nie można przetworzyć żądania Create lub Update. Zbyt wiele operacji tworzenia lub aktualizacji w toku dla subskrypcji "% LD".<br/><br/>Usługa jest zajęta przetwarzaniem wielu żądań utworzenia lub aktualizacji dla Twojej subskrypcji lub serwera. Żądania są obecnie blokowane na potrzeby optymalizacji zasobów. Zapytanie [sys. DM _operation_status](https://msdn.microsoft.com/library/dn270022.aspx) dla operacji oczekujących. Zaczekaj na ukończenie oczekujących żądań utworzenia lub aktualizacji lub Usuń jedno z oczekujących żądań, a następnie ponów żądanie później. Aby uzyskać więcej informacji, zobacz: <br/>&bull; &nbsp;[Limit zasobów serwera bazy danych](sql-database-resource-limits-database-server.md)<br/>&bull; &nbsp;[jednostek DTU dla pojedynczych baz danych](sql-database-service-tiers-dtu.md)<br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>limity &bull; &nbsp;[rdzeń wirtualny dla pojedynczych baz danych](sql-database-vcore-resource-limits-single-databases.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md)<br/>[limity zasobów wystąpienia zarządzanego](sql-database-managed-instance-resource-limits.md)&bull; &nbsp;. |
| 49920 |16 |Nie można przetworzyć żądania. Zbyt wiele operacji w toku dla subskrypcji "% LD".<br/><br/>Usługa jest zajęta przetwarzaniem wielu żądań dla tej subskrypcji. Żądania są obecnie blokowane na potrzeby optymalizacji zasobów. Zapytanie [sys. DM _operation_status](https://msdn.microsoft.com/library/dn270022.aspx) dla stanu operacji. Zaczekaj na zakończenie oczekujących żądań lub Usuń jedno z oczekujących żądań, a następnie ponów żądanie później. Aby uzyskać więcej informacji, zobacz: <br/>&bull; &nbsp;[Limit zasobów serwera bazy danych](sql-database-resource-limits-database-server.md)<br/>&bull; &nbsp;[jednostek DTU dla pojedynczych baz danych](sql-database-service-tiers-dtu.md)<br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>limity &bull; &nbsp;[rdzeń wirtualny dla pojedynczych baz danych](sql-database-vcore-resource-limits-single-databases.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md)<br/>[limity zasobów wystąpienia zarządzanego](sql-database-managed-instance-resource-limits.md)&bull; &nbsp;. |
...
## <a name="embedded-error-codes"></a>Osadzone kody błędów

Następujące błędy są osadzone w bardziej ogólnym kodzie błędu 40197:
...
| Kod błędu | Ważność | Opis | 
| ---:| ---:|:---|
|  1104 |17 |Podczas rozlewania nie zakończył się wolne miejsce w bazie danych TEMPDB. Utwórz miejsce przez upuszczenie obiektów i/lub napisz ponownie zapytanie, aby użyć mniejszej liczby wierszy. Jeśli problem nadal występuje, rozważ uaktualnienie do wyższego celu poziomu usługi.|
| 40020 |16 |Baza danych znajduje się w stanie przejścia, przez co transakcje są przerywane.|
| 40143 |16 |Replika, którą węzeł danych obsługuje dla żądanych partycji, nie jest partycją podstawową.|
| 40166 |16 |Programu clouddb ponowna konfiguracja i wszystkie nowe transakcje użytkownika są przerywane.|
| 40540 |16 |Transakcja została przerwana, ponieważ baza danych została przeniesiona do trybu tylko do odczytu. Jest to sytuacja tymczasowa, a następnie spróbuj ponownie wykonać operację.|

Szczegóły dotyczące innych osadzonych błędów można znaleźć, wykonując zapytania o `sys.messages`:
...
| Kod błędu | Ważność | Opis |
| ---:| ---:|:--- |
| 40635 |16 |Klient z adresem IP "%. &#x2a;ls "jest tymczasowo wyłączona. |
...
* Aplikacja zużywa zbyt wiele miejsca `TempDb`.
...
| Kod błędu | Ważność | Opis |
| ---:| ---:|:--- |
| 10928 |20 |Identyfikator zasobu:% d. Limit% s dla bazy danych to% d i został osiągnięty. Aby uzyskać więcej informacji, zobacz [SQL Database limitów zasobów dla jednej i puli baz danych](sql-database-resource-limits-database-server.md).<br/><br/>Identyfikator zasobu wskazuje zasób, który osiągnął limit. W przypadku wątków roboczych identyfikator zasobu = 1. W przypadku sesji identyfikator zasobu = 2.<br/><br/>Aby uzyskać więcej informacji na temat tego błędu i sposobu jego rozwiązania, zobacz: <br/>&bull; &nbsp;[Limit zasobów serwera bazy danych](sql-database-resource-limits-database-server.md)<br/>&bull; &nbsp;[jednostek DTU dla pojedynczych baz danych](sql-database-service-tiers-dtu.md)<br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>limity &bull; &nbsp;[rdzeń wirtualny dla pojedynczych baz danych](sql-database-vcore-resource-limits-single-databases.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md)<br/>[limity zasobów wystąpienia zarządzanego](sql-database-managed-instance-resource-limits.md)&bull; &nbsp;. |
| 10929 |20 |Identyfikator zasobu:% d. Minimalna gwarancja% s wynosi% d, maksymalny limit wynosi% d, a bieżące użycie bazy danych to% d. Jednak serwer jest obecnie zbyt zajęty, aby obsługiwać żądania większe niż% d dla tej bazy danych. Identyfikator zasobu wskazuje zasób, który osiągnął limit. W przypadku wątków roboczych identyfikator zasobu = 1. W przypadku sesji identyfikator zasobu = 2. Aby uzyskać więcej informacji, zobacz: <br/>&bull; &nbsp;[Limit zasobów serwera bazy danych](sql-database-resource-limits-database-server.md)<br/>&bull; &nbsp;[jednostek DTU dla pojedynczych baz danych](sql-database-service-tiers-dtu.md)<br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>limity &bull; &nbsp;[rdzeń wirtualny dla pojedynczych baz danych](sql-database-vcore-resource-limits-single-databases.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md)<br/>[limity zasobów wystąpienia zarządzanego](sql-database-managed-instance-resource-limits.md)&bull; &nbsp;. <br/>W przeciwnym razie spróbuj ponownie później. |
...
|:--- |:--- |:--- |:--- |
| 1132 | 17 |Osiągnięto limit magazynowania elastycznej puli. Użycie magazynu dla puli elastycznej nie może przekroczyć (% d) MB. Podjęto próbę zapisu danych w bazie danych, gdy osiągnięto limit magazynowania puli elastycznej. Aby uzyskać informacje na temat limitów zasobów, zobacz: <br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md). <br/> |Rozważ zwiększenie DTU i/lub dodanie magazynu do puli elastycznej, jeśli jest to możliwe, aby zwiększyć jej limit magazynowania, zmniejszyć ilość miejsca używanego przez pojedyncze bazy danych w puli elastycznej lub usunąć bazy danych z puli elastycznej. Aby uzyskać skalowanie puli elastycznej, zobacz [skalowanie zasobów w puli elastycznej](sql-database-elastic-pool-scale.md).|
| 10929 | 16 |Minimalna gwarancja% s wynosi% d, maksymalny limit wynosi% d, a bieżące użycie bazy danych to% d. Jednak serwer jest obecnie zbyt zajęty, aby obsługiwać żądania większe niż% d dla tej bazy danych. Aby uzyskać informacje na temat limitów zasobów, zobacz: <br/>&bull; &nbsp;[jednostek DTU w przypadku pul elastycznych](sql-database-dtu-resource-limits-elastic-pools.md)<br/>&bull; &nbsp;[rdzeń wirtualny limity dla pul elastycznych](sql-database-vcore-resource-limits-elastic-pools.md). <br/> W przeciwnym razie spróbuj ponownie później. Wartość DTU/rdzeń wirtualny min na bazę danych; Maksymalna liczba jednostek DTU/rdzeń wirtualny na bazę danych. Całkowita liczba współbieżnych procesów roboczych (żądań) dla wszystkich baz danych w puli elastycznej podjęła próbę przekroczenia limitu puli. |Rozważ zwiększenie DTU lub rdzeni wirtualnych puli elastycznej, jeśli jest to możliwe, aby zwiększyć jej limit procesów roboczych lub usunąć bazy danych z puli elastycznej. |
...
| 40507 |16 |'%. &#x2a;nie można wywołać elementu LS z parametrami w tej wersji SQL Server. |
...
| 40510 |16 |Instrukcja "%. &#x2a;ls "jest nieobsługiwane w tej wersji SQL Server |
| 40511 |16 |Wbudowana funkcja "%. &#x2a;ls "jest nieobsługiwane w tej wersji programu SQL Server. |
| 40512 |16 |Przestarzała funkcja "% ls" nie jest obsługiwana w tej wersji programu SQL Server. |
| 40513 |16 |Zmienna serwera "%. &#x2a;ls "jest nieobsługiwane w tej wersji programu SQL Server. |
| 40514 |16 |element "% ls" nie jest obsługiwany w tej wersji programu SQL Server. |
| 40515 |16 |Odwołanie do bazy danych i/lub nazwy serwera w "%. &#x2a;ls "jest nieobsługiwane w tej wersji programu SQL Server. |
| 40516 |16 |Globalne obiekty tymczasowe są nieobsługiwane w tej wersji programu SQL Server. |
| 40517 |16 |Słowo kluczowe lub opcja instrukcji "%. &#x2a;ls "jest nieobsługiwane w tej wersji programu SQL Server. |
| 40518 |16 |Polecenie DBCC "%. &#x2a;ls "jest nieobsługiwane w tej wersji programu SQL Server. |
...
| 40522 |16 |Podmiot zabezpieczeń bazy danych "%. &#x2a;typ ls nie jest obsługiwany w tej wersji SQL Server. |
| 40523 |16 |Niejawny użytkownik "%. &#x2a;tworzenie ls nie jest obsługiwane w tej wersji programu SQL Server. Jawnie Utwórz użytkownika przed jego użyciem. |
| 40524 |16 |Typ danych "%. &#x2a;ls "jest nieobsługiwane w tej wersji programu SQL Server. |
| 40525 |16 |Element "%. ls" jest nieobsługiwany w tej wersji programu SQL Server. |
| 40526 |16 |'%. &#x2a;dostawca zestawów wierszy ls nie jest obsługiwany w tej wersji programu SQL Server. |
...
| 40529 |16 |Wbudowana funkcja "%. &#x2a;ls "w kontekście personifikacji nie jest obsługiwana w tej wersji programu SQL Server. |
| 40532 |11 |Nie można otworzyć serwera "%. &#x2a;ls "żądana przez nazwę logowania. Logowanie nie powiodło się. |
| 40553 |16 |Sesja została przerwana z powodu nadmiernego użycia pamięci. Spróbuj zmodyfikować zapytanie, aby przetworzyć mniej wierszy.<br/><br/> Zmniejszenie liczby operacji `ORDER BY` i `GROUP BY` w kodzie Transact-SQL pomaga zmniejszyć wymagania dotyczące pamięci zapytania. |
...
| 40627 |20 |Operacja na serwerze "{0}" i bazie danych "{1}" jest w toku. Zaczekaj kilka minut przed ponowieniem próby. |
