---
title: Indeksowane wideo, Azure SaaS SQL App | Microsoft Docs
...
- *Związane* [Wzorce dzierżawy bazy danych SaaS z wieloma dzierżawcami][saas-concept-design-patterns-563e]
- *Podręcznik* [Aplikacja SaaS bilety Wingtip][saas-how-welcome-wingtip-app-679t]
...
- [4. Aplikacja internetowa z wieloma dzierżawcami, 0:05:05](#anchor-image-wtip-min00505)
- [5. Formularz sieci Web aplikacji w działaniu, 0:05:55](#anchor-image-wtip-min00555)
- [6. Koszt dla dzierżawy (skala, izolacja, odzyskiwanie), 0:09:31](#anchor-image-wtip-min00931)
...
- [12. Formularz usługi Live App pokazujący Dojo, 0:20:29](#anchor-image-wtip-min02029)
- [13. Firma MYOB, a nie w szczegółowe informacje o 0:28:54](#anchor-image-wtip-min02854)
...
- [17. Kanoniczna hybrydowa aplikacja wielodostępna SaaS, 0:47:33](#anchor-image-wtip-min04733)
...
- [23. Dzierżawy i dołączanie, 0:57:44](#anchor-image-wtip-min05744)
- [24. Inicjowanie obsługi dzierżaw i połączenia aplikacji, 0:58:58](#anchor-image-wtip-min05858)
- [25. Demonstracja skryptów zarządzania aprowizacji pojedynczej dzierżawy, 0:59:43](#anchor-image-wtip-min05943)
...
- [29. Monitorowanie puli elastycznej, 1:06:39](#anchor-image-wtip-min10639)
...
- [32. Zapytania rozproszone w bazach danych dzierżaw, 1:12:21](#anchor-image-wtip-min11221)
- [33. Demonstracja generowania biletów, 1:12:32](#anchor-image-wtip-min11232)
- [34. Analiza ad hoc, 1:12:46](#anchor-image-wtip-min11246)
- [35. Wyodrębnienie danych dzierżawy do programu SQL DW 1:16:32](#anchor-image-wtip-min11632)
- [36. Graf dziennej dystrybucji sprzedaży, 1:16:48](#anchor-image-wtip-min11648)
- [37. Zawijaj i Wywołaj akcję, 1:19:52](#anchor-image-wtip-min11952)
...
*Uczenie się od firma MYOB: Wzorce projektowe dla aplikacji SaaS na Azure SQL Database-BRK3120*

[![Slajd powitalny][image-wtip-min00003-brk3120-whole-welcome]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1)

- Tytuł: Uczenie się od firma MYOB: Wzorce projektowe dla aplikacji SaaS na Azure SQL Database
...
#### <a name="4-multi-tenant-web-app-00500"></a>4. Aplikacja internetowa z wieloma dzierżawcami, 0:05:00
[![Wingtip SaaS: Aplikacja internetowa z wieloma dzierżawcami][image-wtip-min00505-web-app]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=300)
...
#### <a name="6-per-tenant-cost-scale-isolation-recovery-00658"></a>6. Koszt dla dzierżawy (skala, izolacja, odzyskiwanie), 0:06:58
...
#### <a name="12-live-app-form-showing-dojo-02010"></a>12. Formularz usługi Live App pokazujący Dojo, 0:20:10
...
#### <a name="13-myob-and-not-a-dba-in-sight-02506"></a>13. Firma MYOB, a nie w szczegółowe informacje o 0:25:06
...
#### <a name="17-canonical-hybrid-multi-tenant-saas-app-04604"></a>17. Kanoniczna hybrydowa aplikacja wielodostępna SaaS, 0:46:04
...
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. Dzierżawy i dołączanie, 0:56:19
...
#### <a name="25-demo-of-management-scripts-provisioning-a-single-tenant-05936"></a>25. Demonstracja skryptów zarządzania aprowizacji pojedynczej dzierżawy, 0:59:36
...
#### <a name="29-elastic-pool-monitoring-10632"></a>29. Monitorowanie puli elastycznej, 1:06:32
...
#### <a name="32-distributed-query-across-tenant-databases-11118"></a>32. Zapytania rozproszone w bazach danych dzierżaw, 1:11:18
...
#### <a name="33-demo-of-ticket-generation-11228"></a>33. Demonstracja generowania biletów, 1:12:28
...
#### <a name="35-extract-tenant-data-into-sql-dw-11546"></a>35. Wyodrębnienie danych dzierżawy do programu SQL DW 1:15:46
...
#### <a name="37-wrap-up-and-call-to-action-11743"></a>37. Zawijaj i Wywołaj akcję, 1:17:43
...
[image-wtip-min00505-web-app]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min00505-wingtip-saas-app-mt-web.png "Wingtip SaaS: Aplikacja internetowa z wieloma dzierżawcami"
