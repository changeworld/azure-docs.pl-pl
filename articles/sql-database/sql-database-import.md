...
- Importowanie do bazy danych w puli elastycznej nie jest obsługiwane. Można zaimportować danych do pojedyncze bazy danych, a następnie przenieść bazę danych do puli.
