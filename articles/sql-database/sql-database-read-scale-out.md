...
Aby uzyskać więcej informacji, zobacz [baz danych — Utwórz lub zaktualizuj](/rest/api/sql/databases/createorupdate).
...
- Aby dowiedzieć się, jak ustawić odczytu skalowalnego w poziomie przy użyciu interfejsu API REST, zobacz [baz danych — Utwórz lub zaktualizuj](/rest/api/sql/databases/createorupdate).
