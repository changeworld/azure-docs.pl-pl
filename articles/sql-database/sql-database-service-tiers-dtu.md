...
||Basic|Standardowa (Standard)|Premium|
| :-- | --: |--:| --:|
...
|Procesor CPU|Niska|Niski, średni, wysoki|Średni, wysoki|
...
|Przetwarzanie OLTP w pamięci|ND|ND|Obsługiwane|
|||||
...
| Standardowa (Standard) |Transakcje na minutę |90 percentyl o 1,0 s |
| Basic |Transakcje na godzinę |80th percentyl o 2,0 sekund |
