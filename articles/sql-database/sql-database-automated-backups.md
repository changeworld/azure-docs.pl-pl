...
Wystąpienie zarządzane pobiera automatycznie początkową kopię zapasową z `CHECKSUM` z baz danych przywróconych przy użyciu natywnego `RESTORE` polecenia lub usługi migracji danych po zakończeniu migracji.
