...
| is_column_permission | is_column_permission_s | Flaga wskazująca, czy jest to uprawnienie poziomu kolumna. 1 = true, 0 = false | Bitowe | string |
