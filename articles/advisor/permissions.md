...
| **Rola** | **Wyświetlanie zaleceń** | **Edytuj reguły** | **Edytuj konfigurację subskrypcji** | **Edytuj konfigurację grupy zasobów**| **Odrzuć i odroczyć zalecenia**|
|---|:---:|:---:|:---:|:---:|:---:|
