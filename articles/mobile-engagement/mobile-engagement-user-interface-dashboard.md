...
* Wykresy można dodać do pustego pulpitu nawigacyjnego, wybierając akcję "Wyślij do pulpitu nawigacyjnego" z menu dowolnego wykresu, w sekcji analizy interfejsu użytkownika, który chcesz wyświetlić na pulpicie nawigacyjnym koło zębate.

## <a name="-add-a-dashboard"></a>+ (Dodawanie pulpitu nawigacyjnego)
* Element menu wstążki "+" służy do tworzenia nowego pulpitu nawigacyjnego, który będzie wyświetlany w menu wstążki.

## <a name="gear-menu"></a>Menu narzędzia
* W menu narzędzia pulpitu nawigacyjnego służy do usuwania, Zmień nazwę udziału lub harmonogram (odbioru poczty E-mail) pulpitu nawigacyjnego. Opcja harmonogramu zdefiniuj harmonogram, w którym chcesz otrzymywać pocztą e-mail niestandardowym pulpicie nawigacyjnym. Można zaplanować ich otrzymać codziennie, co tydzień lub co miesiąc. Można wybrać dzień i dzień tygodnia lub dzień miesiąca, gdy chcesz otrzymywać wiadomości e-mail. Adres e-mail i strefy czasowej są oparte na ustawienia, które zostały skonfigurowane w sekcji Moje konto w Interfejsie użytkownika.
