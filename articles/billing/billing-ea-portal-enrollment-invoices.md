...
## <a name="incorrect-overage-invoice"></a>Niepoprawna faktura nadwyżkowa

Jeśli uważasz, że wystawiono dla Ciebie nieprawidłową fakturę nadwyżkową, zobacz temat [Omówienie rachunku za umowę Azure Enterprise Agreement](billing-understand-your-bill-ea.md), który pomoże Ci w uzgodnieniu opłat za użycie platformy Azure. Jeśli uważasz, że firma Microsoft błędnie naliczyła opłaty nadwyżkowe, skontaktuj się z zespołem pomocy technicznej.

## <a name="change-a-po-number-for-an-overage-invoice"></a>Zmiana numeru zamówienia zakupu na fakturze nadwyżkowej

W witrynie Azure EA Portal automatycznie generowany jest domyślny numer zamówienia zakupu, o ile administrator umowy EA nie ustawił tego numeru przed datą wystawienia faktury. Administrator umowy EA może zaktualizować numer zamówienia w witrynie Azure EA Portal, logując się i przechodząc do obszaru **Raporty**. Administrator umowy EA może zaktualizować numer zamówienia zakupu. W prawym górnym rogu, gdzie widoczny jest numer zamówienia zakupu, należy kliknąć ikonę ołówka i zaktualizować informacje.

Administrator umowy EA może zaktualizować numer zamówienia zakupu w bieżącym kwartale rozliczeniowym, przed utworzeniem faktury. Może także zaktualizować numer zamówienia zakupu w ciągu siedmiu dni od otrzymania automatycznej wiadomości e-mail z powiadomieniem o fakturze.

Jeśli administrator umowy EA nie zaktualizował numeru zamówienia zakupu, a jest wymagany nowy numer zamówienia zakupu, jedyną opcją jest rozliczenie bieżącej faktury i ponowne wystawienie faktury ze zmienionymi danymi. Jeśli jako klient musisz zaktualizować numer zamówienia zakupu, skontaktuj się ze swoim partnerem w celu uzyskania pomocy.
...
Wszystkie środki i korekty zastosowane do rejestracji są widoczne w portalu [https://ea.azure.com](https://ea.azure.com) w sekcji **Raporty**. Jeśli masz określone pytanie dotyczące konkretnej kwoty środków, skontaktuj się z [pomocą techniczną witryny Azure EA Portal](https://support.microsoft.com/supportrequestform/cf791efa-485b-95a3-6fad-3daf9cd4027c).

## <a name="request-an-invoice-copy"></a>Żądanie kopii faktury

Aby zażądać kopii faktury, skontaktuj się z partnerem.

## <a name="understand-your-bill"></a>Opis zawartości rachunku
...
_Opłaty rozliczane oddzielnie_ oraz _usługi platformy Azure Marketplace_ odnoszą się do usług innych firm, wdrażanych z platformy Azure Marketplace. Główna różnica między tymi dwoma typami usług dotyczy sposobu fakturowania, wynikającego ze struktury umów z zewnętrznymi wydawcami.

Użycie usług innych firm jest widoczne na fakturze w sekcji **Opłaty rozliczane oddzielnie**. Opłaty za to użycie są odejmowane od salda zobowiązania pieniężnego platformy Azure. Aby zapoznać się z listą usług innych firm, zobacz temat [Usługi odsprzedawców w witrynie Azure Marketplace korzystają teraz ze zobowiązania pieniężnego platformy Azure](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/).

Opłaty za użycie widoczne na fakturze w sekcji **Azure Marketplace** są rozliczane osobno. Nie można ich regulować przy użyciu zobowiązania pieniężnego. Natomiast wszystkie opłaty — w tym za usługi platformy Marketplace, użycie nadwyżkowe i opłaty rozliczane oddzielnie — są skonsolidowane na jednej fakturze.

Otrzymasz jedną fakturę za nadwyżkowe użycie na platformie Azure oraz zakupy usług innych firm na platformie Marketplace.

Po całkowitym wykorzystaniu zobowiązania pieniężnego opłaty za użycie są rozliczane w cyklu miesięcznym lub kwartalnym. Jeśli rejestracja rozpoczęła się przed 1 maja 2018 r., stosowany jest próg 150% zobowiązania pieniężnego, a użycie nadwyżkowe jest rozliczane co kwartał. Jeśli rejestracja rozpoczęła się po 1 maja 2018 r., wszystkie nadwyżki są rozliczane miesięcznie.
