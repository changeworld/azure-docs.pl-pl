...
Gdy utworzysz nowe, możesz zauważyć niewielkie wstrzymanie weryfikacji na koncie karty kredytowej. Zostanie ono usunięte w ciągu trzech do pięciu dni. Jeśli martwisz się o zarządzanie kosztami, przeczytaj więcej na temat [zapobiegania nieoczekiwanym kosztom](billing-getting-started.md).
