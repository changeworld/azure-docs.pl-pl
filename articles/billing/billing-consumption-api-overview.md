...
Aby uzyskać więcej informacji, zobacz temat specyfikacji technicznej [API salda](https://docs.microsoft.com/rest/api/consumption/getbalancesbybillingaccount).
