...
1. Wyszukaj pozycję **Zarządzanie kosztami i rozliczenia**.
    ...
    ![Zrzut ekranu przedstawiający wyszukiwanie zarządzania kosztami i rozliczeniami ](./media/billing-payment-features-azure-portal/search-bar.png)

1. Na liście **Moje subskrypcje** wybierz subskrypcję, do której chcesz dodać kartę kredytową.
    ![Zrzut ekranu przedstawiający przegląd siatki Moje subskrypcje](./media/billing-payment-features-azure-portal/cost-management-billing-overview-x.png)

1. Wybierz pozycję **Formy płatności**.

    ![Zrzut ekranu przedstawiający wybrany blok Formy płatności.](./media/billing-payment-features-azure-portal/subscription-payment-methods-blade.png)
...
1. W lewym górnym rogu wybierz pozycję „+”, aby dodać kartę kredytową.
    ...
    ![Zrzut ekranu przedstawiający symbol plusa](./media/billing-payment-features-azure-portal/subscription-payment-methods-plus.png)

1. Wprowadź szczegóły karty kredytowej w formularzu po prawej stronie.

    ![Zrzut ekranu przedstawiający formularz dodawania karty kredytowej.](./media/billing-payment-features-azure-portal/subscription-add-payment-method-x.png)
...
1. Aby ustawić tę kartę jako aktywną formę płatności, zaznacz pole wyboru obok pola **Ustaw jako moją aktywną formę płatności** znajdującego się powyżej formularza. Ta karta stanie się aktywnym instrumentem płatniczym dla wszystkich subskrypcji używających tej karty jako wybranej subskrypcji.
    ...
    ![Zrzut ekranu przedstawiający pole wyboru służące do ustawiania karty jako aktywnej formy płatności.](./media/billing-payment-features-azure-portal/subscription-make-active-payment-method-x.png)
...
1. Zaznacz pole obok karty, którą chcesz ustawić jako aktywną formę płatności.
    ...
    ![Zrzut ekranu przedstawiający zaznaczone pole obok karty kredytowej](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-x.png)

1. Na pasku poleceń kliknij przycisk **Ustaw aktywną**.

    ![Zrzut ekranu przedstawiający przycisk Ustaw aktywną](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-set-active.png)
...
![Zrzut ekranu przedstawiający wybraną kartę kredytową](./media/billing-payment-features-azure-portal/subscription-edit-payment-method-x.png)
...
1. Na pasku poleceń kliknij przycisk **Usuń**.
    ...
    ![Zrzut ekranu pokazujący przycisk Usuń](./media/billing-payment-features-azure-portal/subscription-checked-payment-method-delete.png)
...
1. Wybierz pozycję **Płatność za pomocą faktury** na pasku poleceń.
    ...
    ![Zrzut ekranu przedstawiający wybrany blok Formy płatności.](./media/billing-payment-features-azure-portal/subscription-payment-methods-pay-by-invoice.png)

1. Wprowadź adres dla formy płatności za pomocą faktury.
1. Kliknij przycisk **Dalej**.

Jeśli chcesz uzyskać zgodę na płatności za pomocą faktury, zobacz artykuł [Dowiedz się, jak płacić za pomocą faktury](billing-how-to-pay-by-invoice.md).
...
1. Na liście **Moje subskrypcje** wybierz subskrypcję Visual Studio Enterprise.
    ...
    ![Zrzut ekranu przedstawiający przegląd siatki Moje subskrypcje](./media/billing-payment-features-azure-portal/cost-management-overview-msdn-x.png)

1. W przeglądzie subskrypcji kliknij pomarańczowy baner, aby usunąć limit wydatków.
    
    ![Zrzut ekranu przedstawiający baner umożliwiający usunięcie limitu wydatków](./media/billing-payment-features-azure-portal/msdn-remove-spending-limit-banner-x.png)

1. Wybierz, czy chcesz usunąć limit wydatków na czas nieokreślony, czy tylko w bieżącym okresie rozliczeniowym.

   ![Zrzut ekranu przedstawiający blok usuwania limitu wydatków](./media/billing-payment-features-azure-portal/remove-spending-limit-blade-x.png)
...
1. Na liście **Moje subskrypcje** wybierz subskrypcję platformy Azure w ramach programu licencjonowania Open.
    ...
    ![Zrzut ekranu przedstawiający przegląd siatki Moje subskrypcje](./media/billing-payment-features-azure-portal/cost-management-overview-aio-x.png)

1. Wybierz pozycję **Historia środków**.
    
    ![Zrzut ekranu przedstawiający historię środków](./media/billing-payment-features-azure-portal/aio-credit-history-blade.png)

1. W lewym górnym rogu wybierz pozycję „+”, aby dodać więcej środków.

    ![Zrzut ekranu przedstawiający przycisk Dodaj środki](./media/billing-payment-features-azure-portal/aio-credit-history-plus.png)
...
1. Wybierz typ formy płatności z listy rozwijanej. Możesz dodać klucz produktu lub zakupić środki przy użyciu karty kredytowej.
    ...
    ![Zrzut ekranu przedstawiający listę rozwijaną formy płatności w bloku dodawania środków](./media/billing-payment-features-azure-portal/add-credits-select-payment-method.png)
...
- Dowiedz się więcej na temat [analizowania i zapobiegania nieoczekiwanym kosztom w witrynie Azure Portal](billing-getting-started.md)
