...
Aby uzyskać więcej informacji, zobacz [Dodawanie, aktualizowanie lub usuwanie karty kredytowej dla platformy Azure](billing-how-to-change-credit-card.md).
...
- Jeśli chcesz uregulować opłaty za korzystanie z platformy Azure, zobacz [Rozwiązywanie problemu z zaległym saldem za subskrypcję platformy Azure](billing-azure-subscription-past-due-balance.md).
