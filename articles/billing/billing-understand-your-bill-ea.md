...
- **Opłatach w portalu Marketplace**: Azure zakupów w portalu Marketplace i użycia nie są objęte środków Twojej organizacji i są rozliczane osobno. Administrator przedsiębiorstwa może włączać i wyłączać zakupów w portalu Marketplace w organizacji w witrynie Enterprise Portal. 
