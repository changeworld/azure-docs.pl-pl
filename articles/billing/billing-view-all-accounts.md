...
### <a name="microsoft-online-services-program"></a>Microsoft Online Services Program
 ...
 ![Zrzut ekranu przedstawiający hierarchię programu MOSP](./media/billing-view-all-accounts/mosp-hierarchy.png)
...
![Zrzut ekranu przedstawiający hierarchię umowy EA](./media/billing-view-all-accounts/ea-hierarchy.png)
...
![Zrzut ekranu przedstawiający hierarchię umowy MCA](./media/billing-view-all-accounts/mca-hierarchy.png)
...
![Zrzut ekranu przedstawiający hierarchię umowy MPA](./media/billing-view-all-accounts/mpa-hierarchy.png)
...
3. Na stronie przeglądu wybierz pozycję **Przełącz zakres**.
   ...
   ![Zrzut ekranu przedstawiający zakresy rozliczeniowe](./media/billing-view-all-accounts/overview-select-scopes.png)
...
4. Wybierz zakres, aby wyświetlić szczegóły.
   ...
   ![Zrzut ekranu przedstawiający zakresy rozliczeniowe](./media/billing-view-all-accounts/list-of-scopes.png)
