...
Problem może wystąpić przy próbie aktualizacji konta z informacjami o płatności w witrynie Microsoft Azure Portal lub w Centrum konta. Przed jego rozwiązaniem należy wziąć pod uwagę poniższe wskazówki:

- Upewnij się, że informacje podane w profilu konta platformy Azure (w tym kontaktowy adres e-mail, adres i numer telefonu) są poprawne.
...
Aby usunąć wszelkie błędy, wybierz problem, który występuje podczas próby zarejestrowania się na platformie Azure.
