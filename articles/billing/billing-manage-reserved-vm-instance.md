...
![Przykład szczegółów zamówienia rezerwacji z wyróżnionym identyfikatorem zamówienia rezerwacji ](./media/billing-manage-reserved-vm-instance/reservation-order-details.png)
...
2. Wybierz pozycję **Wszystkie usługi** > [**Rezerwacje**](https://portal.azure.com/#blade/Microsoft_Azure_Reservations/ReservationsBrowseBlade) i zwróć uwagę na wartość **Wykorzystanie (%)** dla rezerwacji.  
  ![Obraz przedstawiający listę rezerwacji](./media/billing-manage-reserved-vm-instance/reservation-list.png)
3. Wybierz rezerwację.
...
- [Understand how the Red Hat Enterprise Linux software plan discount is applied (Informacje na temat sposobu stosowania rabatu na plan oprogramowania Red Hat Enterprise Linux)](../billing/billing-understand-rhel-reservation-charges.md)
- [Understand how the SUSE Linux Enterprise software plan discount is applied (Informacje na temat sposobu stosowania rabatu na plan oprogramowania SUSE Linux Enterprise)](../billing/billing-understand-suse-reservation-charges.md)
