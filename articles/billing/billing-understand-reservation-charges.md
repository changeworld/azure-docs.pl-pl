...
Aby uzyskać informacje dotyczące wystąpień zarezerwowanych maszyny wirtualnej, zobacz [Objaśnienie rabatu na wystąpienia zarezerwowane maszyny wirtualnej platformy Azure](billing-understand-vm-reservation-charges.md).
