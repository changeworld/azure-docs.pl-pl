...
Ten artykuł nie dotyczy klientów platformy Azure z Umowa Enterprise (klienci z umowami EA). Jeśli jesteś klientem z umową EA, zobacz [Opis rachunku dla klientów platformy Azure z Umowa Enterprise](billing-understand-your-bill-ea.md).

Ten artykuł nie dotyczy klientów platformy Azure z [umową klienta firmy Microsoft](#check-access-to-a-microsoft-customer-agreement). Jeśli masz umowę klienta firmy Microsoft, zobacz temat informacje o opłatach za [Korzystanie z platformy Azure na fakturze umowy dla klientów firmy Microsoft](billing-mca-understand-your-bill.md).
...
1. Filtruj według przedziału czasu.
...
Usługi zewnętrzne lub opłaty za witrynę Marketplace są przeznaczone dla zasobów utworzonych przez dostawców oprogramowania innych firm. Te zasoby są dostępne do użycia w portalu Azure Marketplace. Na przykład Zapora Barracuda to zasób portalu Azure Marketplace oferowany przez inną firmę. Wszystkie opłaty za zaporę i odpowiadające im liczniki są wyświetlane jako opłaty za usługi zewnętrzne.
