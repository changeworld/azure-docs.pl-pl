---
title: Ponowne aktywowanie wyłączonej platformy Azure dla studentów subskrypcji | Dokumentacja firmy Microsoft
description: Wyjaśnia, dlaczego Twojej subskrypcji Azure for Students jest wyłączona i jak uaktywnić go ponownie.
services: ''
documentationcenter: ''
...
1. Zaloguj się przy użyciu subskrypcji platformy Azure dla studentów poświadczenia konta.
2. Na stronie saldo zawiera informacje dotyczące używanych i pozostałe środki. Pod wykresem środków, można znaleźć daty wygaśnięcia środków.  
   
    ![Zrzut ekranu pokazujący informacji środki platformy Azure dla studentów subskrypcji](./media/billing-azurestudents-subscription-disabled/azurestudents-credit-balance.png)

3. Aby sprawdzić użycie usług, które zużywają środków platformy Azure, wybierz **użycia** w lewym obszarze nawigacji wybierz Twojej subskrypcji Azure for Students.

    ![Zrzut ekranu przedstawiający informacje o użyciu platformy Azure dla studentów środków](./media/billing-azurestudents-subscription-disabled/azurestudents-credit-usage.png)
