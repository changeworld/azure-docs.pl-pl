...
Windows 8.1 (x64) |
Windows 8 (x64) |
Windows 7 (x64) | Z dodatkiem SP1 lub nowszym (Windows 7 RTM nie jest obsługiwany)
...
--- | --- | --- |
14.04 LTS | 9.26 | 3.13.0-24-Generic do 3.13.0-170-generic,<br/>3.16.0-25-Generic do 3.16.0-77-generic,<br/>3.19.0-18-Generic do 3.19.0-80-generic,<br/>4.2.0-18-Generic do 4.2.0-42-generic,<br/>4.4.0-21-Generic do 4.4.0-148-generic,<br/>4.15.0-1023-Azure do 4.15.0-1045-azure |
14.04 LTS | 9.25 | 3.13.0-24-Generic do 3.13.0-169-generic,<br/>3.16.0-25-Generic do 3.16.0-77-generic,<br/>3.19.0-18-Generic do 3.19.0-80-generic,<br/>4.2.0-18-Generic do 4.2.0-42-generic,<br/>4.4.0-21-Generic do 4.4.0-146-generic,<br/>4.15.0-1023-Azure do 4.15.0-1042-azure |
...
**Wydania** | **Wersja usługi mobilności** | **Wersja jądra** |
--- | --- | --- |
Debian 7 | 9.23,9.24,9.25,9.26 | 3.2.0-4-AMD64 do 3.2.0-6-amd64, 3.16.0-0.bpo.4-amd64 |
|||
Debian 8 | 9.25, 9.26 | 3.16.0-4-AMD64 do 3.16.0-8-amd64, 4.9.0-0.bpo.4-amd64 do 4.9.0-0.bpo.8-amd64 |
Debian 8 | 9.23, 9.24 | 3.16.0-4-AMD64 do 3.16.0-7-amd64, 4.9.0-0.bpo.4-amd64 do 4.9.0-0.bpo.8-amd64 |
...
Konta magazynu ogólnego przeznaczenia w wersji 2 (zarówno gorąca i chłodna warstwa) | Yes | Wzrost kosztów transakcji znacznie w porównaniu do ogólnego przeznaczenia w wersji 1 konta magazynu
