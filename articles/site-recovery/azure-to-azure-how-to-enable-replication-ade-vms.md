...
1. Przejdź do **strony głównej** > **magazyny** kluczy > **ContosoWeb2KeyVault > zasad dostępu**.
...
Możesz użyć [skryptu](#copy-disk-encryption-keys-to-the-dr-region-by-using-the-powershell-script) , aby skopiować klucze szyfrowania do regionu docelowego, a następnie zaktualizować docelowe ustawienia szyfrowania w **magazynie usługi Recovery Services** > *zreplikowane elementy* > **Właściwości** > **obliczenia i sieć**.
...
**Jak naprawić:** Przejdź do **strony głównej** > **magazyny** kluczy > **ContosotargetKeyvault** > **zasad dostępu** i Dodaj odpowiednie uprawnienia.
