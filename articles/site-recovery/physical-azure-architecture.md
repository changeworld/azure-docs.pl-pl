---
title: Serwer fizyczny z platformą architektura replikacji platformy Azure w usłudze Azure Site Recovery | Dokumentacja firmy Microsoft
description: Ten artykuł zawiera omówienie składników i architektury używanych podczas replikowania lokalnych serwerów fizycznych na platformę Azure za pomocą usługi Azure Site Recovery
...
ms.locfileid: "37920944"
---
# <a name="physical-server-to-azure-replication-architecture"></a>Serwer fizyczny z platformą architektura replikacji platformy Azure
...
- Należy skonfigurować infrastrukturę powrotu po awarii, w tym:
    ...
    - **Zasady powrotu po awarii**: aby móc przeprowadzić ponowną replikację do lokacji lokalnej, należy utworzyć zasady powrotu po awarii. Ten został utworzony automatycznie podczas tworzenia zasad replikacji ze środowiska lokalnego do platformy Azure.
    - **Infrastruktura VMware**: infrastruktura VMware są potrzeby powrotu po awarii. Nie można powracać po awarii do serwera fizycznego.
