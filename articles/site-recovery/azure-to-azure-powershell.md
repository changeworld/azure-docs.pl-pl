...
W przypadku migracji do platformy można ustawić kontekst magazynu do nowo utworzonego magazynu: 
...
Za pomocą polecenia cmdlet Remove-ASRReplicationProtectedItem, można wyłączyć replikacji.
