...
|---------|---------|---------|---------|--------|
|Pakiet zbiorczy 36 *     |   5.1.4150.0  |  9.24.5211.1   |  5.1.4150.0  | 2.0.9160.0
...
* Informacje o wersji jest w toku. Zapoznaj się z odpowiednim uaktualniania dokumentów Uaktualnij składniki usługi Site Recovery.
