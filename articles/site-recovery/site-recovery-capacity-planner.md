...
description: W tym artykule jest używane do szacowania wydajności podczas replikacji przy użyciu usługi Azure Site Recovery
...
ms.locfileid: "37920665"
---
# <a name="plan-capacity-for-protecting-hyper-v-vms-with-site-recovery"></a>Planowanie pojemności na potrzeby ochrony maszyn wirtualnych funkcji Hyper-V w usłudze Site Recovery
...
1. Pobierz i Otwórz [planista wydajności usługi Site Recovery](http://aka.ms/asr-capacity-planner-excel). Musisz uruchomić makra. Po wyświetleniu monitu wybierz odpowiednie opcje, Włącz edytowanie i zawartości.
