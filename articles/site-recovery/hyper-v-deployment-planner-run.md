...
- **Klaster funkcji Hyper-V**: Gdy nazwa klastra funkcji Hyper-V znajduje się w pliku listy serwera, narzędzie znajdzie wszystkie węzły klastra funkcji Hyper-V i pobierze informacje o istniejących maszynach wirtualnych na poszczególnych hostów funkcji Hyper-V.
...
Usługa Azure Site Recovery nie obsługuje maszyn wirtualnych z dyskami iSCSI oraz pass-through. Narzędzie nie wykrywa i profilu dyski iSCSI oraz pass-through dołączone do maszyn wirtualnych.
