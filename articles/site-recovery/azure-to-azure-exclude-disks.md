---
title: Azure Site Recovery — wykluczanie dysków podczas replikacji maszyn wirtualnych platformy Azure przy użyciu Azure PowerShell | Microsoft Docs
