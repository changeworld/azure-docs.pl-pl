...
Usługa Azure Cosmos DB w dziennikach **DataPlaneRequests** kategorii są przechowywane w **insights — dzienniki dataplanerequests** kontenera na koncie magazynu, podane. 
