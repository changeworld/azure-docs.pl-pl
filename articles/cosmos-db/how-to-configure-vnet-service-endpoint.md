...
1. Zainstaluj [programu Azure PowerShell](https://docs.microsoft.com/powershell/azure/azurerm/install-azurerm-ps) i [Zaloguj](https://docs.microsoft.com/powershell/azure/authenticate-azureps).  
