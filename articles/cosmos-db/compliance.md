...
| --- | --- | --- | --- |
| Certyfikacja STAR CSA | DoD SRG poziom 2 | HIPAA BAA | Niesklasyfikowany IRAP Australii |
| CSA STAR zaświadczania | FedRAMP Moderate | HITRUST | Niemcy C5|
...
| CSA STAR zaświadczania| DoD SRG poziom 2| HITRUST  | 
