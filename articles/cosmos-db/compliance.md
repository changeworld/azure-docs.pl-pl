...
| --- | --- | --- | --- |
| Certyfikacja CSA STAR | DoD SRG poziom 2 | HIPAA BAA | Australia — program IRAP |
| CSA STAR Attestation | FedRAMP Moderate | HITRUST | Niemcy C5|
...
| --- | --- | --- | --- |
| Certyfikacja CSA STAR | CJIS| HIPAA BAA | 
| CSA STAR Attestation| DoD SRG poziom 2| HITRUST  | 
