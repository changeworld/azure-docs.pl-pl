...
ms.locfileid: "53253514"
---
# <a name="quickstart-build-a-cassandra-app-with-python-and-azure-cosmos-db"></a>Szybki start: tworzenie aplikacji Cassandra przy użyciu języka Python i usługi Azure Cosmos DB
