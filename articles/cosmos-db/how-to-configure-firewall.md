...
Dostęp do Azure Portal można włączyć, wybierając opcję **Akceptuj połączenia z poziomu publicznych centrów danych platformy Azure** , jak pokazano na poniższym zrzucie ekranu: 
