...
1. **Zasady połączenia: Użyj trybu bezpośredniego połączenia**
   ...
   * W trybie bezpośrednim
     ...
     Tryb Direct obsługuje łączność za pośrednictwem protokołów TCP i HTTPS. Obecnie bezpośrednie jest obsługiwana w programie .NET Standard 2.0 tylko na platformy Windows. Podczas korzystania z trybu bezpośrednich, istnieją dwie opcje protokołu:
