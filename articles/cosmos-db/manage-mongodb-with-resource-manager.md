...
ms.locfileid: "65077773"
---
# <a name="create-azure-cosmos-db-api-for-mongodb-resources-from-a-resource-manager-template"></a>Tworzenie interfejsu API usługi Azure Cosmos DB dla bazy danych MongoDB zasobów z szablonu usługi Resource Manager

Dowiedz się, jak tworzenie interfejsu API usługi Azure Cosmos DB dla zasobów bazy danych MongoDB przy użyciu szablonu usługi Azure Resource Manager. Poniższy przykład tworzy konto usługi Azure Cosmos DB dla interfejsu API usługi MongoDB z [szablonu szybkiego startu platformy Azure](https://aka.ms/mongodb-arm-qs). Ten szablon utworzy konta usługi Azure Cosmos dla interfejsu API usługi MongoDB z dwie kolekcje, które współużytkują 400 jednostek RU/s przepływności w poziomie bazy danych.
