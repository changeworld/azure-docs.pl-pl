...
ms.locfileid: "53251061"
---
# <a name="quickstart-build-a-cassandra-app-with-nodejs-and-azure-cosmos-db"></a>Szybki start: tworzenie aplikacji Cassandra przy użyciu platformy Node.js i usługi Azure Cosmos DB
