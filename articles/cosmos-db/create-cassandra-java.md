...
ms.locfileid: "54039525"
---
# <a name="quickstart-build-a-cassandra-app-with-java-and-azure-cosmos-db"></a>Szybki start: tworzenie aplikacji Cassandra przy użyciu języka Java i usługi Azure Cosmos DB
