...
Usługa Azure Cosmos DB oferuje pięć dobrze zdefiniowanych poziomów spójności do wyboru w celu osiągnięcia kompromisu między spójnością, wydajnością i dostępnością. Wysoki poziom spójności zapewnia synchroniczne replikowanie danych i trwałość w każdym regionie, w którym skonfigurowano konto usługi Cosmos. Jednak taka konfiguracja zapewnia najwyższy poziom trwałości kosztem wydajności i dostępności. Aby w aplikacji kontrolować poziom trwałości danych lub obniżyć go w zależności od potrzeb aplikacji bez ograniczania dostępności, możliwe jest zastosowanie synchronizacji niestandardowej w warstwie aplikacji w celu osiągnięcia żądanego poziomu trwałości.
