---
title: Tworzenie bazy danych i kontenera interfejsu API SQL (Core) dla usługi Azure Cosmos DB
description: Tworzenie bazy danych i kontenera interfejsu API SQL (Core) dla usługi Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
---
# <a name="create-an-azure-cosmos-sql-core-api-account-database-and-container-using-azure-cli"></a>Tworzenie konta, bazy danych i kontenera interfejsu API usługi Azure Cosmos SQL (Core) przy użyciu interfejsu wiersza polecenia platformy Azure
