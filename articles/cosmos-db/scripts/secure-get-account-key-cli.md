...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#az-cosmosdb-list-keys) | Tworzy serwer logiczny hostujący bazę danych SQL. |
