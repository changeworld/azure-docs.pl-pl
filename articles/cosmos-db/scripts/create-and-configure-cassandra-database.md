---
title: Skrypt programu Azure PowerShell — tworzenie konta interfejsu API Cassandra usługi Azure Cosmos DB | Microsoft Docs
...
ms.locfileid: "41917581"
---
# <a name="azure-cosmos-db-create-a-cassandra-api-account-using-powershell"></a>Azure Cosmos DB: tworzenie konta interfejsu API Cassandra przy użyciu programu PowerShell
