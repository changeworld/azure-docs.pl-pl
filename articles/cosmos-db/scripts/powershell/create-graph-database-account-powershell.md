---
title: Skrypt programu Azure PowerShell — Tworzenie konta usługi Azure Cosmos DB — interfejs API Gremlin
description: Skrypt programu Azure PowerShell przykładowy — Tworzenie konta usługi Azure Cosmos DB — interfejs API Gremlin
