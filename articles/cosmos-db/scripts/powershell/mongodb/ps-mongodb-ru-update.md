---
title: Azure PowerShell skryptu — Azure Cosmos DB aktualizacji RU/s dla interfejsu API MongoDB
description: Azure PowerShell skryptu — Azure Cosmos DB aktualizacji RU/s dla interfejsu API MongoDB
author: markjbrown
