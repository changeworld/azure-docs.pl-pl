...
Kiedy używać [oficjalne sterownik MongoDB Java](http://mongodb.github.io/mongo-java-driver/), mogą wykonywać polecenia przez wywołanie metody `runCommand` metody w `MongoDatabase` obiektu:
