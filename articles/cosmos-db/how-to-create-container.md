...
W tym artykule omówiono różne sposoby tworzenia kontenera (kolekcji, tabeli lub grafu). Możesz użyć witryny Azure Portal, interfejsu wiersza polecenia platformy Azure lub obsługiwanych zestawów SDK. W tym artykule pokazano, jak utworzyć kontener, określić klucz partycji i aprowizować przepływność.

## <a name="create-a-container-by-using-azure-portal"></a>Tworzenie kontenera przy użyciu witryny Azure Portal
...
1. [Utwórz nowe konto usługi Azure Cosmos DB](create-mongodb-dotnet.md#create-a-database-account) lub wybierz istniejące konto.
...
1. [Utwórz nowe konto usługi Azure Cosmos DB](create-cassandra-dotnet.md#create-a-database-account) lub wybierz istniejące konto.
...
1. [Utwórz nowe konto usługi Azure Cosmos DB](create-graph-dotnet.md#create-a-database-account) lub wybierz istniejące konto.
...
1. [Utwórz nowe konto usługi Azure Cosmos DB](create-table-dotnet.md#create-a-database-account) lub wybierz istniejące konto.
...
## <a name="create-a-container-by-using-azure-cli"></a>Tworzenie kontenera przy użyciu interfejsu wiersza polecenia platformy Azure
...
## <a name="create-a-container-by-using-net-sdk"></a>Tworzenie kontenera przy użyciu zestawu .NET SDK
