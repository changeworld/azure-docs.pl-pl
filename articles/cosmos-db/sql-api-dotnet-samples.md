---
title: 'Azure Cosmos DB: przykłady platformy .NET dla interfejsu SQL API | Microsoft Docs'
...
Ostatnie przykładowe rozwiązania do wykonywania operacji CRUD i innych typowych działań na zasobach usługi Azure Cosmos DB można znaleźć w repozytorium [azure-documentdb-dotnet](https://github.com/Azure/azure-documentdb-dotnet/tree/master/samples/code-samples) w witrynie GitHub. Ten artykuł zawiera:
...
Aby uzyskać więcej informacji o pisaniu zapytań, zobacz [SQL query within Azure Cosmos DB (Zapytania SQL w usłudze Azure Cosmos DB)](sql-api-sql-query.md).
