...
description: W tym artykule opisano przypadki użycia dla bramy pola danych platformy Azure, rozwiązanie magazynu urządzenie wirtualne, które pozwala na przesyłanie danych do platformy Azure
services: databox
author: alkohli
ms.service: databox
ms.topic: article
