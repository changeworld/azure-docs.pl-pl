...
* Instalowanie zestawu Microsoft Azure SDK dla platformy .NET w wersji 2.7.1 lub nowszej za pomocą [Instalatora platformy sieci Web](http://www.microsoft.com/web/downloads/platform.aspx).
* Zainstaluj [usługi Azure Stream Analytics tools for Visual Studio](http://aka.ms/asatoolsvs).
