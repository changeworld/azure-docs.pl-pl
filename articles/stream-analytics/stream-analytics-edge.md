...
5. Ustawienia opcjonalne
    1. **Określanie kolejności zdarzeń**. W portalu, można skonfigurować zasady poza kolejnością. Dokumentacja jest dostępna [tutaj](https://docs.microsoft.com/stream-analytics-query/time-skew-policies-azure-stream-analytics).
