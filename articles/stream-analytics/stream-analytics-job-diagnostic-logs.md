---
title: Rozwiązywanie problemów z usługi Azure Stream Analytics przy użyciu dzienników diagnostycznych
description: W tym artykule opisano sposób analizowania dzienników diagnostyki w Azure Stream Analytics.
