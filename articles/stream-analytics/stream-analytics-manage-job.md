...
2. Wybierz pozycję **Utwórz zasób** > **Internet rzeczy** > **Event Hubs**.  
   ...
   ![Tworzenie centrum zdarzeń usługi Azure Event Hub](media/stream-analytics-manage-job/find-eh.png)
...
4. **Zapisz** zapytanie.  
   ...
   ![Definiowanie zapytania usługi Stream Analytics](media/stream-analytics-manage-job/define-query.png)
