...
Możesz [pobrać pakiet](https://www.npmjs.com/package/azure-streamanalytics-cicd) bezpośrednio lub zainstalować go [globalnie](https://docs.npmjs.com/downloading-and-installing-packages-globally) za pomocą polecenia `npm install -g azure-streamanalytics-cicd`. Jest to zalecane rozwiązanie, które może być również używane w zadaniu skryptu interfejsu wiersza polecenia platformy Azure dla potoku kompilacji w **potokach usługi Azure DevOps**.
