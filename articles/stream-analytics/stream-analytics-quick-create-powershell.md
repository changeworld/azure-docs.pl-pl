...
3. Użyj polecenia [New-AzStorageContainer](https://docs.microsoft.com/powershell/module/azure.storage/new-AzStoragecontainer), aby utworzyć nowy kontener magazynu.
