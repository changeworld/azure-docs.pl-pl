...
Narzędzia Stream Analytics tools for Visual Studio obsługuje obecnie danych wyjściowych (wersja zapoznawcza) dla magazynu usługi Azure Data Lake Storage i blob storage. Aby wyświetlić wynik, po prostu kliknij dwukrotnie węzeł danych wyjściowych na diagramie zadania w **widok zadania** i wprowadź odpowiednie poświadczenia.
