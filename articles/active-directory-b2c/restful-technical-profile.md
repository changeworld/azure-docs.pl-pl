...
| version | Tak | 1.0.0 |
| status | Tak | 409 |
| kod | Nie | Kod błędu od dostawcy punktu końcowego RESTful, który jest wyświetlany po włączeniu `DebugMode`. |
