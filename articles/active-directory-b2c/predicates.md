...
- **StrongPassword** weryfikuje IsLengthBetween8And64 DisallowedWhitespace, AllowedAADCharacters,. Ostatnią grupę `CharacterClasses` uruchamia dodatkowy zestaw predykaty z `MatchAtLeast` ustawiony na wartość 3. Hasło użytkownika musi zawierać od 8 do 16 znaków i trzy z następujących znaków: małe litery, wielkie litery, liczby lub Symbol.
