---
title: Złożoność hasła — Azure Active Directory B2C | Microsoft Docs
...
| Silne | Hasło, które ma co najmniej 8 do 64 znaków. Wymaga 3 z 4 z małych i wielkich liter, cyfr lub symboli. |
| Niestandardowa | Ta opcja zapewnia największą kontrolę nad regułami złożoności haseł.  Umożliwia skonfigurowanie długości niestandardowej.  Umożliwia również akceptowanie haseł tylko do numerów (PIN). |
...
- **2 z 4: Małe litery, wielkie litery, cyfry (0-9), symbol** zapewnia, że hasło zawiera co najmniej dwa typy znaków. Na przykład liczba i małe litery.
- **3 z 4: Małe litery, wielkie litery, cyfry (0-9), symbol** zapewnia, że hasło zawiera co najmniej dwa typy znaków. Na przykład liczba, małe litery i wielkie litery.
- **4 z 4: Małe litery, wielkie litery, cyfry (0-9), symbol** zapewnia, że hasło zawiera wszystkie typy znaków.
