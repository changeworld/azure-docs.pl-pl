...
- [Wyświetl listę wszystkich zasad struktury zaufania skonfigurowanych w dzierżawie](https://docs.microsoft.com/graph/api/trustframework-list-trustframeworkpolicies.md)
