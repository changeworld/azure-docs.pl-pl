...
W powiązanym artykule [utworzysz usługę RESTful](rest-api-claims-exchange-dotnet.md) , która współdziała z Azure Active Directory B2C (Azure AD B2C).
...
* Wykonaj kroki opisane w artykule [integracja z usługą integracji interfejsów API REST](rest-api-claims-exchange-dotnet.md) .
...
7. W polu **hasło** wpisz hasło certyfikatu.
    ...
    ![Przekaż klucz zasad na stronie Tworzenie klucza w Azure Portal](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-upload.png)
...
5. Bezpośrednio po elemencie `<Metadata>` zamykającym Dodaj następujący fragment kodu XML:
    ...
    ![Ustaw elementy XML uwierzytelniania ClientCertificate](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-tech-profile.png)
...
3. Przetestuj proces, wpisując **test** w **podanym polu Nazwa** .
    ...
    ![Podano wyróżnione pole tekstowe nazwy i pokazany błąd sprawdzania poprawności danych wejściowych](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-test.png)
...
![Dodawanie kodu sprawdzania poprawności certyfikatu](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-code.png)
...
Jeśli musisz rozwiązać ten krok, zobacz [zbieranie dzienników przy użyciu Application Insights](troubleshoot-with-application-insights.md).
