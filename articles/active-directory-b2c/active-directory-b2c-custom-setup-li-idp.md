...
3. Dodaj następującego dostawcę oświadczeń, który wysyła żądanie do interfejsu API `/emailAddress` usługi LinkedIn. Aby można było autoryzować to żądanie, wymagany jest token dostępu do serwisu LinkedIn.
