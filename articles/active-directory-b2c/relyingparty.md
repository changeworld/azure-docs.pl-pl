...
| Atrybut | Wymagany | Opis |
| --------- | -------- | ----------- |
| Name (Nazwa) | Yes | Nazwa pary klucz wartość. |
...
| Atrybut | Wymagany | Opis |
| --------- | -------- | ----------- |
| ClaimTypeReferenceId | Yes | Odwołanie do elementu **ClaimType** zdefiniowanego już w sekcji **ClaimsSchema** w pliku zasad. |
