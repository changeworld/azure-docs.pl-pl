...
| Atrybut | Wymagane | Opis |
| --------- | -------- | ----------- |
| Język | Yes | Ciąg, który zawiera obsługiwanego języka dla zasad zgodnie z RFC 5646 - znaczniki identyfikacji języków. |
| LocalizedResourcesReferenceId | Yes | Identyfikator **LocalizedResources** elementu. |
