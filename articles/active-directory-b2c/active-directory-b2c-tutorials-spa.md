...
1. Upewnij się, że używasz katalogu zawierającego dzierżawcę Azure AD B2C, wybierając pozycję **katalog i filtr subskrypcji** w górnym menu i wybierając katalog zawierający dzierżawcę.
