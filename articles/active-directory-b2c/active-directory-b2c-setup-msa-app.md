...
Aby użyć konta Microsoft jako [dostawcy tożsamości](active-directory-b2c-reference-oidc.md) w usłudze Azure Active Directory (Azure AD) B2C, musisz utworzyć aplikację w dzierżawie usługi Azure AD. Dzierżawy usługi Azure AD nie jest taka sama jak dzierżawy usługi Azure AD B2C. Jeśli nie masz jeszcze konta Microsoft, możesz pobrać pojedynczo [ https://www.live.com/ ](https://www.live.com/).
