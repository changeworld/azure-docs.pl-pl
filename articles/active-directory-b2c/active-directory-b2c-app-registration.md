...
Dowiedz się więcej na temat sposobu tokenów dostępu są używane przez aplikacje udzielić uprawnień do interfejsów API w [zażądał tokeny dostępu](active-directory-b2c-access-tokens.md)
