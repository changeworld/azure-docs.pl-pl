...
W tym artykule opisano sposób włączania logowania dla użytkowników z organizacji Azure Active Directory (Azure AD) przy użyciu [zasad niestandardowych](active-directory-b2c-overview-custom.md) w usłudze Azure Active Directory (Azure AD) B2C.
...
1. Usługa Azure AD korzysta z protokołu Connect OpenID Connect, więc upewnij się, że jest `OpenIdConnect`to wartość dla protokołu.
