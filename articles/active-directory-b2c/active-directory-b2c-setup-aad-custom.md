...
5. Ustaw wartość **METADANYCH** do `https://login.windows.net/your-tenant/.well-known/openid-configuration`, gdzie `your-tenant` jest nazwa dzierżawy usługi Azure AD (contoso.com).
