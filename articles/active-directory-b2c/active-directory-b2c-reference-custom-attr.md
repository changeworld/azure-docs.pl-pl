...
2. Upewnij się, że używasz katalogu, który zawiera Twoją dzierżawę usługi Azure AD B2C, przełączając się na niego w prawym górnym rogu witryny Azure Portal. Wybierz informacje o subskrypcji, a następnie wybierz pozycję **Przełącz katalog**.
    ...
    ![Dzierżawy B2C wyróżnione filtr katalogów i subskrypcji](./media/active-directory-b2c-reference-custom-attr/select-directory.PNG)
...
4. Wybierz **atrybutów użytkownika** , a następnie wybierz atrybut niestandardowy (na przykład "ShoeSize"). Kliknij polecenie **Zapisz**.
