---
title: Skonfiguruj konto i zaloguj się za pomocą OpenID Connect Connect-Azure Active Directory B2C | Microsoft Docs
...
* **Imię**: Wprowadź wartość, która zawiera *imię* użytkownika.
