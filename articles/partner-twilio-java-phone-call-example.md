...
1. Uzyskiwanie konta usługi Twilio i uwierzytelnianie tokenu. Aby rozpocząć pracę z usługą Twilio, ocenić ceny na [ http://www.twilio.com/pricing ] [ twilio_pricing]. Możesz zarejestrować się w [ https://www.twilio.com/try-twilio ] [ try_twilio]. Aby uzyskać informacji na temat interfejsów API dostarczonych przez usługi Twilio, zobacz [ http://www.twilio.com/api ] [ twilio_api].
