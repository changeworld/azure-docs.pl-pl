...
|Element|Typ|Opis|
|-------------|----------|-----------|
|`id`|Ciąg|The ID of the webhook event.|
|`timestamp`|Data i godzina|The time at which the webhook event was triggered.|
|`action`|Ciąg|The action that triggered the webhook event.|
...
|Element|Typ|Opis|
|------------------|----------|-----------|
|`mediaType`|Ciąg|The MIME type of the referenced object.|
|`size`|Int32|The number of bytes of the content. Same as Length field.|
|`digest`|Ciąg|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`length`|Int32|The number of bytes of the content. Same as Size field.|
|`repository`|Ciąg|The repository name.|
|`tag`|Ciąg|The image tag name.|

### <a name="request"></a>request

|Element|Typ|Opis|
|------------------|----------|-----------|
|`id`|Ciąg|The ID of the request that initiated the event.|
|`host`|Ciąg|The externally accessible hostname of the registry instance, as specified by the HTTP host header on incoming requests.|
|`method`|Ciąg|The request method that generated the event.|
|`useragent`|Ciąg|The user agent header of the request.|
...
|`digest`|Ciąg|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`repository`|Ciąg|The repository name.|
|`tag`|Ciąg|The chart tag name.|
|`name`|Ciąg|The chart name.|
|`version`|Ciąg|The chart version.|
