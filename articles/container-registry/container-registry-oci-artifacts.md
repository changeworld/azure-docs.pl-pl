---
title: Wypychanie artefaktów OCI do prywatnego rejestru kontenerów platformy Azure
...
`oras pull` Uruchom polecenie, aby ściągnąć artefakt z rejestru.
