...
Musisz mieć również zainstalowane lokalnie środowisko Docker. Docker provides packages that easily configure Docker on any [macOS][docker-mac], [Windows][docker-windows], or [Linux][docker-linux] system.
