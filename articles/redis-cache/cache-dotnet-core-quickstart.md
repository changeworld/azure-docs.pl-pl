---
title: 'Szybki start: jak korzystać z usługi Azure Redis Cache przy użyciu aplikacji platformy .NET Core | Microsoft Docs'
description: Z tego przewodnika Szybki start dowiesz się, jak uzyskiwać dostęp do usługi Azure Redis Cache w aplikacjach platformy .NET Core
...
ms.locfileid: "34660609"
---
# <a name="quickstart-use-azure-redis-cache-with-a-net-core-app"></a>Szybki start: korzystanie z usługi Azure Redis Cache przy użyciu aplikacji platformy .NET Core



W tym przewodniku Szybki start opisano rozpoczęcie pracy z usługą Microsoft Azure Redis Cache na platformie .NET Core. Usługa Microsoft Azure Redis Cache jest oparta na popularnej pamięci podręcznej Redis typu open source. Umożliwia dostęp do bezpiecznej, dedykowanej pamięci podręcznej Redis, zarządzanej przez firmę Microsoft. Pamięć podręczna utworzona przy użyciu usługi Azure Redis Cache jest dostępna z poziomu dowolnej aplikacji w ramach platformy Microsoft Azure.
...
![Ukończona aplikacja konsolowa](./media/cache-dotnet-core-quickstart/cache-console-app-complete.png)
...
Dodaj następujące elementy członkowskie do klasy `Program` w pliku *Program.cs*. Ten kod inicjuje konfigurację do uzyskiwania dostępu do wpisu tajnego użytkownika dla parametrów połączenia pamięci podręcznej redis.
...
W tym przewodniku Szybki start przedstawiono sposób użycia usługi Azure Redis Cache z poziomu aplikacji platformy .NET Core. Przejdź do kolejnego Szybkiego startu, w którym wyjaśniono użycie usługi Microsoft Azure Redis Cache z poziomu aplikacji internetowej ASP.NET.
