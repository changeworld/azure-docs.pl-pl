...
![Zbiorczy kontenerów na przykład węzeł](./media/container-insights-analyze/containers-nodes-containerstotal.png)
...
![Przykład przechodzenie do szczegółów z węzła do kontrolera w widoku wydajności](./media/container-insights-analyze/drill-down-controller-node.png)
