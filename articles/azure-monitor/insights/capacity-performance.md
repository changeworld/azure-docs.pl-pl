...
| [Konto usługi Azure Storage](../../log-analytics/log-analytics-azure-storage.md) | Nie | Usługa Azure storage nie obejmuje dane dotyczące pojemności i wydajności.|
