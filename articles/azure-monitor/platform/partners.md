...
Circonus to platforma monitorowania i analizy mikrousług opracowana na potrzeby wdrożenia lokalnego lub SaaS. Jest to w pełni zautomatyzowana platforma zorientowana na interfejsy API, która jest bardziej skalowalna i niezawodna niż systemy, które monitoruje. Opracowane na potrzeby DevOps, Circonus dostarcza alerty, wykresy, pulpity nawigacyjne i inteligencję uczenia maszynowego, które umożliwiają optymalizację biznesową. Circonus monitoruje Microsoft Azure zasoby w chmurze i ich aplikacje w czasie rzeczywistym. Za pomocą Circonus można zbierać i śledzić metryki dla zmiennych, które mają być mierzone dla zasobów i aplikacji. Dzięki usłudze Circonus możesz uzyskać wgląd w zasoby platformy Azure, wydajność aplikacji i kondycję operacyjną na całym systemie.
...
- [Przesyłanie strumieniowe dzienników diagnostycznych do usługi innej niż firmy Microsoft](../../azure-monitor/platform/resource-logs-stream-event-hubs.md)
...
[logicmonitor-doc]: https://www.logicmonitor.com/lmcloud-azure/ "Dokumentacja monitora logiki."
...
[turbonomic-doc]: https://turbonomic.com/solutions/technologies/azure-cloud/ "Platforma turbonomic wprowadzenie."
