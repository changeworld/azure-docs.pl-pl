...
- Ważność dla reguł alertów dziennika przesunie się z: *Krytyczne, ostrzegawcze & informacyjne*, do *wartości ważności 0, 1 & 2*. Wraz z opcją tworzenia/aktualizacji reguł alertów o ważności 3 i 4.
