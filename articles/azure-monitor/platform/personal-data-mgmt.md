...
- Aby dowiedzieć się więcej na temat jak Application Insights dane są zbierane, przetwarzane i zabezpieczane, zobacz [bezpieczeństwo danych w usłudze Application Insights](../../application-insights/app-insights-data-retention-privacy.md).
