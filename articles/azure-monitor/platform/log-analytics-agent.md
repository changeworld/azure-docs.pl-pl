...
| Hybrydowy komputer z systemem Linux| [Instalacja ręczna](agent-linux.md)|Zainstaluj agenta dla systemu Linux wywołującego skrypt otoki hostowany w witrynie GitHub lub ręcznie Pobierz i Zainstaluj agenta. | 
