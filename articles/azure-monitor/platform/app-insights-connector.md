...
- Użyj [wyszukiwanie w dzienniku](../../log-analytics/log-analytics-queries.md) Aby wyświetlić szczegółowe informacje o aplikacjach Application Insights.
