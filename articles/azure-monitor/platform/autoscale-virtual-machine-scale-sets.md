...
[Zarządzanie funkcją automatycznego skalowania przy użyciu programu PowerShell](../../monitoring-and-diagnostics/insights-powershell-samples.md#create-and-manage-autoscale-settings)
