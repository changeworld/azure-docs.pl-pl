...
![Użycie i szacunkowe koszty](media/data-usage/usage-estimated-cost-dashboard-01.png)<br>
...
![Wyświetl dzienniki](media/data-usage/logs.png)<br>
...
Korzystać z tych zapytań oszczędnie skanowania różnych typres danych dane są kosztowne do wykonania. To zapytanie zastąpi stary sposób wykonywanie zapytania dla tego typu danych użycia. 
