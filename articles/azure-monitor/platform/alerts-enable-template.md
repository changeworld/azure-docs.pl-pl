...
> [!NOTE]
> 
> W tym artykule opisano tworzenie **klasycznego alertów dotyczących metryk** przy użyciu szablonów usługi Resource Manager. Jeśli potrzebujesz do tworzenia [nowszych alertów metryk](../../monitoring-and-diagnostics/monitoring-near-real-time-metric-alerts.md) przy użyciu szablonów, [w tym artykule](alerts-metric-create-templates.md) udostępnia szczegółowe informacje.
>
