...
- [Tworzenie klasycznego alertu metryki za pomocą szablonu usługi Resource Manager](../../monitoring-and-diagnostics/monitoring-enable-alerts-using-template.md).
