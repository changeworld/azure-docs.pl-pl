...
Obecnie można tworzyć nowsze alerty metryk tylko w szablonach Azure Portal, [interfejsu API REST](https://docs.microsoft.com/rest/api/monitor/metricalerts/)lub [Menedżer zasobów](../../azure-monitor/platform/alerts-metric-create-templates.md). Wkrótce będzie dostępna obsługa konfigurowania nowszych alertów przy użyciu programu PowerShell i interfejsu wiersza polecenia platformy Azure w wersji 2,0 lub nowszej.
...
|Microsoft.DataFactory/datafactories| Tak| [Fabryki danych v1](../../azure-monitor/platform/metrics-supported.md#microsoftdatafactorydatafactories)|
|Microsoft.DataFactory/factories     |   Tak     |[Fabryki danych v2](../../azure-monitor/platform/metrics-supported.md#microsoftdatafactoryfactories)|
|Microsoft.DBforMySQL/servers     |   ND      |[Baza danych dla programu MySQL](../../azure-monitor/platform/metrics-supported.md#microsoftdbformysqlservers)|
|Microsoft.DBforPostgreSQL/servers     |    ND     | [Baza danych dla PostgreSQL](../../azure-monitor/platform/metrics-supported.md#microsoftdbforpostgresqlservers)|
...
|Microsoft.KeyVault/vaults| Nie | [Magazynów](../../azure-monitor/platform/metrics-supported.md#microsoftkeyvaultvaults)|
...
|Microsoft.OperationalInsights/workspaces| Tak|[Log Analytics obszary robocze](../../azure-monitor/platform/metrics-supported.md#microsoftoperationalinsightsworkspaces)|
|Microsoft.PowerBIDedicated/capacities | ND | [Produkcyjnych](../../azure-monitor/platform/metrics-supported.md#microsoftpowerbidedicatedcapacities)|
...
|Microsoft.ServiceBus/namespaces     |  Tak       |[Service Bus](../../azure-monitor/platform/metrics-supported.md#microsoftservicebusnamespaces)|
...
| Microsoft.Web/sites/slots | Tak | [App Service gniazd](../../azure-monitor/platform/metrics-supported.md#microsoftwebsitesslots)|
...
* Dowiedz się więcej o [](../../azure-monitor/platform/alerts-overview.md)nowych alertach.
