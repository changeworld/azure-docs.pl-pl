...
Dołączanie                                    |`SELECT * FROM dependencies JOIN exceptions ON dependencies.operation_Id = exceptions.operation_Id`|<code>dependencies <br>&#124; join (exceptions) on operation_Id == operation_Id</code>


## <a name="next-steps"></a>Kolejne kroki

- Przejdź przez lekcje [Pisanie zapytań dzienników w usłudze Azure Monitor](get-started-queries.md).
