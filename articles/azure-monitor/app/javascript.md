...
Aby uzyskać pełną listę parametrów konfiguracji, zobacz [strony GitHub](https://github.com/microsoft/applicationinsights-js#configuration). Niektóre dostępne parametry obejmują:
