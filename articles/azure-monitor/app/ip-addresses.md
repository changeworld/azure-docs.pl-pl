...
| Stream metryki na żywo |rt.services.visualstudio.com<br/>rt.applicationinsights.microsoft.com |23.96.28.38<br/>13.92.40.198 |443 |
...
Jest to lista adresów, z którego [testy sieci web dostępności](../../azure-monitor/app/monitor-web-app-availability.md) są uruchamiane. Jeśli chcesz uruchomić testy sieci web w aplikacji, ale serwer sieci web jest ograniczona do obsługującego określonych klientów, będzie mieć pozwalającą na ruch przychodzący z naszych dostępności serwerów testowych.
...
| Media CDN | applicationanalyticsmedia.azureedge.net | Dynamiczne | 80,443 |
