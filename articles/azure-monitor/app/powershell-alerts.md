...
Można zautomatyzować konfigurację [alerty](../../azure-monitor/app/alerts.md) w [usługi Application Insights](../../application-insights/app-insights-overview.md).
