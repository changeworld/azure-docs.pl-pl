...
Aby zapoznać się z metryk wydajności systemu Linux w [usługi Application Insights](../../application-insights/app-insights-overview.md), zainstaluj [zebrane](https://collectd.org/), wraz z jej usługi Application Insights wtyczki. To rozwiązanie typu open-source zbiera różne statystyki systemu i sieciowych.
