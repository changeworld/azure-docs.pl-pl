---
title: Inteligentne wykrywanie — zmniejszenie współczynnika ważności śledzenia w usłudze Azure Application Insights | Microsoft Docs
...
Ten typ powiadomienia może zostać wyświetlony w przypadku, gdy stosunek między "dobrymi" śladami (ślady zarejestrowane na poziomie *informacji* lub *pełnym*) i "złe" ślady (ślady zarejestrowane z poziomem *ostrzeżenia*, *błąd*lub *krytyczny*) to spadek konkretny dzień w porównaniu z linią bazową obliczoną w ciągu ostatnich siedmiu dni.
