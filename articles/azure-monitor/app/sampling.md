...
Funkcję próbkowania domyślne można wyłączyć podczas dodawania usługi Application Insights w metodzie ```ConfigureServices```przy użyciu ```ApplicationInsightsServiceOptions```:
