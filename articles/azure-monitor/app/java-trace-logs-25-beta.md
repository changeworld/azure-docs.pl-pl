---
title: Eksplorowanie dzienników śledzenia Java na platformie Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Wyszukaj ślady Log4J lub Logback w Application Insights (2.5.0-BETA)
...
ms.locfileid: "68298362"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>Eksplorowanie dzienników śledzenia Java w Application Insights (2.5.0-BETA)
...
## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>Uwaga: Jeśli używasz agenta Java Application Insights
