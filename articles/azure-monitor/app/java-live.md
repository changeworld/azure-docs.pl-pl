...
2. Utwórz nowy zasób usługi Application Insights i Ustaw typ aplikacji do aplikacji sieci web Java.
    ...
    ![Wypełnij nazwę, wybierz aplikację internetową Java i kliknij przycisk Utwórz](./media/java-live/02-create.png)
...
4. Otwórz nowy zasób i pobrać jego klucza instrumentacji. Wkrótce będzie trzeba wkleić ten klucz do projektu kodu.
    ...
    ![W opisie nowego zasobu kliknij opcję Właściwości i skopiuj klucz instrumentacji](./media/java-live/03-key.png)
...
Konieczne może być [ustawić wyjątki, aby wysyłać dane wychodzące](../../azure-monitor/app/ip-addresses.md).
...
![dane przykładowe](./media/java-live/5-results.png)
...
* [Konfigurowanie testów sieci web](../../azure-monitor/app/monitor-web-app-availability.md) aby upewnić się, że aplikacja stale działa i odpowiada.
* [Przechwytywanie danych śledzenia dziennika](java-trace-logs.md)
