...
- Zapytanie dla ról i uzyskać identyfikator roli którą chcesz przypisać do funkcji zdefiniowanej przez użytkownika; Przekaż go do roli o identyfikatorze poniżej.
