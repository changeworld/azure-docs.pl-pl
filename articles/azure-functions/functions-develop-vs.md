...
* Konto usługi Azure Storage. Aby utworzyć konto magazynu, zobacz [Tworzenie konta magazynu](../storage/common/storage-create-storage-account.md#create-a-storage-account).
