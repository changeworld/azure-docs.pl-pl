...
* Wyślij żądanie HTTP POST do `https://{functionappname}.azurewebsites.net/admin/host/synctriggers?code=<API_KEY>` przy użyciu [klucza głównego](functions-bindings-http-webhook-trigger.md#authorization-keys).
