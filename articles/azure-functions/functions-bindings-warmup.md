...
|---------|---------|----------------------|
| **type** | nd.| Required - must be set to `warmupTrigger`. |
| **direction** | nd.| Required - must be set to `in`. |
| **name** | nd.| Required - the variable name used in function code.|
