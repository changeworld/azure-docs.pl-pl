...
Aby wdrożyć aplikację funkcji w języku Python na platformie Azure, można użyć [skryptu niestandardowego rozwiązania Travis CI](https://docs.travis-ci.com/user/deployment/script/) z repozytorium GitHub. Poniżej znajduje się przykład `.travis.yaml` skryptu w procesie kompilacji i publikowania.
