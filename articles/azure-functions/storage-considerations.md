...
|---------|---------|
| [Azure Blob Storage](/storage/blobs/storage-blobs-overview.md)     | Zachowaj stan powiązań i klucze funkcji.  <br/>Używane także przez [centra zadań w Durable Functions](durable/durable-functions-task-hubs.md). |
