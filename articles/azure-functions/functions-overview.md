...
Mimo że zawsze możesz bezpośrednio korzystać z wyposażono usług, integracja z innymi usługami odbywa się przy użyciu powiązań. Powiązania zapewniają [deklaratywny dostęp do różnorodnych usług platformy Azure i innych firm](./functions-triggers-bindings.md).
