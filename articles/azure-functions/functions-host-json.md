...
Formanty [próbkowania funkcji w usłudze Application Insights](functions-monitoring.md#configure-sampling). W wersji 2.x, to ustawienie jest elementem podrzędnym [rejestrowania](#logging).
