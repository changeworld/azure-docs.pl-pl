...
Aby rejestrować dane wyjściowe do usługi [przesyłanie strumieniowe dzienników](../app-service/web-sites-enable-diagnostic-log.md) w F#, funkcji powinno przyjmować argument typu [ILogger](https://docs.microsoft.com/dotnet/api/microsoft.extensions.logging.ilogger). W celu zachowania spójności, firma Microsoft zaleca, nosi nazwę tego argumentu `log`. Na przykład:
