...
Szablon może pomóc rozpocząć pisanie pierwszego definicja interfejsu OpenAPI. Funkcja szablonu definicji tworzy rozrzedzoną definicję interfejsu OpenAPI za pomocą wszystkie metadane w pliku function.json dla poszczególnych funkcji wyzwalacza HTTP. Musisz podać więcej informacji na temat interfejsu API z [specyfikacji interfejsu OpenAPI](http://swagger.io/specification/), takie jak szablony żądań i odpowiedzi.
...
|:----|:-----|:-----|
|[Host](http://swagger.io/specification/#fixed-fields-15)|**Ustawienia aplikacji funkcji** > **ustawień usługi App Service** > **Przegląd** > **adresu URL**|*Nie istnieje*
|[Ścieżki](http://swagger.io/specification/#paths-object-29)|**Integracja** > **wybrane metody HTTP**|Powiązania: trasy
