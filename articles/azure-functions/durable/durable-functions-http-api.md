...
| wejście           | JSON      | Dane JSON, używane do inicjowania wystąpienia. To pole jest `null` Jeśli `showInput` parametr ciągu zapytania jest równa `false`.|
