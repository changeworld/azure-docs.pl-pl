...
| Pole              | Parameter type  | Opis |
|--------------------|-----------------|-------------|
| **`functionName`** | Adres URL             | The name of the orchestrator function to start. |
| **`instanceId`**   | Adres URL             | Optional parameter. The ID of the orchestration instance. If not specified, the orchestrator function will start with a random instance ID. |
| **`{content}`**    | Request content | Opcjonalny. The JSON-formatted orchestrator function input. |
...
| Pole                   | Parameter type  | Opis |
|-------------------------|-----------------|-------------|
| **`instanceId`**        | Adres URL             | The ID of the orchestration instance. |
...
| Pole                  | Typ danych | Opis |
|------------------------|-----------|-------------|
| **`instancesDeleted`** | liczba całkowita   | The number of instances deleted. For the single instance case, this value should always be `1`. |
...
| Pole                   | Typ danych | Opis |
|-------------------------|-----------|-------------|
| **`instancesDeleted`**  | liczba całkowita   | The number of instances deleted. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | Adres URL             | The ID of the orchestration instance. |
| **`eventName`**   | Adres URL             | The name of the event that the target orchestration instance is waiting on. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | Adres URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Opcjonalny. The reason for terminating the orchestration instance. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | Adres URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Opcjonalny. The reason for rewinding the orchestration instance. |
...
| Pole             | Parameter type  | Opis |
|-------------------|-----------------|-------------|
| **`entityType`**  | Adres URL             | The type of the entity. |
| **`entityKey`**   | Adres URL             | The unique name of the entity. |
| **`op`**          | Query string    | Opcjonalny. The name of the user-defined operation to invoke. |
| **`{content}`**   | Request content | The JSON-formatted event payload. |
