...
1. Wybierz pozycję wyzwalacz http, `TurbineRepair` wpisz **nazwę**funkcji, wybierz `Function` pozycję **[poziom uwierzytelniania](functions-bindings-http-webhook.md#http-auth)** , a następnie wybierz pozycję **Utwórz**.  
...
1. Użyj ustawień API Management określonych w tabeli poniżej obrazu.
    ...
    | **Location** | Zachodnie stany USA | Wybierz lokalizację zachodnie stany USA. |
