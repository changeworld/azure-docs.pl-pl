...
|---------|---------|----------------------|
|**type** |nd.| Musi być równa `notificationHub`. |
|**direction** |nd.| Musi być równa `out`. | 
|**Nazwa** |nd.| Nazwa zmiennej używana w kodzie funkcji dla komunikatu centrum powiadomień. |
