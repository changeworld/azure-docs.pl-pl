...
Klucz instrumentacji usługi Application Insights, jeśli używasz usługi Application Insights. Zobacz [Monitoruj funkcje platformy Azure](functions-monitoring.md).
