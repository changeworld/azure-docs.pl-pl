...
Wyślij kilka wyzwalaczy [wyzwolić metadanych](/azure/azure-functions/functions-triggers-bindings#trigger-metadata-properties) wraz z danych wejściowych. Można użyć adnotacji `@BindingName` do powiązania do wyzwolenia metadanych
