...
Jeśli nie masz subskrypcji platformy Azure, przed kontynuowaniem utwórz [bezpłatne konto](https://azure.microsoft.com/free/?ref=microsoft.com&utm_source=microsoft.com&utm_medium=docs&utm_campaign=visualstudio).

Aby opublikować projekt, musisz mieć aplikację funkcji w swojej subskrypcji platformy Azure. Aplikację funkcji w ramach subskrypcji możesz utworzyć bezpośrednio w programie Visual Studio.
