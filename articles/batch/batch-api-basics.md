...
* **Zadania**: w katalogu elementy **robocze** katalog jest tworzony dla każdego zadania, które jest uruchamiane w węźle. Jest on dostępny przez odwołanie się do zmiennej środowiskowej `AZ_BATCH_TASK_DIR`.
