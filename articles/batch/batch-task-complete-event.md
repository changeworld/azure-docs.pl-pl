---
title: Zdarzenie ukończenia zadania usługi Azure Batch
description: Odwołanie do zdarzenia ukończenia zadania usługi Batch. To zdarzenie jest emitowane po zakończeniu zadania, niezależnie od kodu zakończenia.
services: batch
author: LauraBrenner
manager: evansma
ms.assetid: ''
...
ms.locfileid: "77022923"
---
# <a name="task-complete-event"></a>Zdarzenie ukończenia zadania

 To zdarzenie jest emitowane po zakończeniu zadania, niezależnie od kodu zakończenia. To zdarzenie może służyć do określenia czasu trwania zadania, gdzie zadanie zostało uruchomiony, i czy został ponowiony.
