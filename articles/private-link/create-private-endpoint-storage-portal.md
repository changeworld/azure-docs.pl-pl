...
2. Wprowadź wartość @ no__t-0 spowoduje to wyświetlenie komunikatu podobnego do tego:
    ```azurepowershell
    Server:  UnKnown
...
3. Wprowadź wartość *Webresourcename* FOR **wpisz nazwę grupy zasobów** i wybierz pozycję **Usuń**. 
