...
Utwórz aplikację w grupie zasobów przy użyciu polecenia `az mesh deployment create`.  Jeśli używasz konsoli programu Bash, uruchom następujące polecenie:
