...
Można cconfigure przekierowanie dla odbiornika za pomocą [AzureRmApplicationGatewayRedirectConfiguration Dodaj](/powershell/module/azurerm.network/add-azurermapplicationgatewayredirectconfiguration). 
...
![Lokacja contoso testu bramy aplikacji](./media/redirect-internal-site-powershell/application-gateway-iistest.png)
