...
Możesz cconfigure przekierowanie dla odbiornika przy użyciu [polecenie Add-AzureRmApplicationGatewayRedirectConfiguration](/powershell/module/azurerm.network/add-azurermapplicationgatewayredirectconfiguration). 
