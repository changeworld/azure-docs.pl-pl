---
title: Samouczek — Tworzenie bramy aplikacji za pomocą zapory aplikacji sieci Web — Azure Portal | Microsoft Docs
...
Jeśli wolisz, możesz wykonać ten samouczek przy użyciu [Azure PowerShell](tutorial-restrict-web-traffic-powershell.md) lub [interfejsu wiersza polecenia platformy Azure](tutorial-restrict-web-traffic-cli.md).
...
1. Na karcie **podstawowe** wprowadź następujące wartości następujących ustawień bramy aplikacji:
   ...
   - **Warstwa**: Wybierz **WAF v2**
     ...
     ![Utwórz nową bramę aplikacji: Ustawienia podstawowe](./media/application-gateway-web-application-firewall-portal/application-gateway-create-basics.png)
...
1. Na stronie przeglądowej Znajdź publiczny adres IP bramy aplikacji.  ![Rejestruj publiczny adres IP bramy aplikacji](./media/application-gateway-create-gateway-portal/application-gateway-record-ag-address.png) 
