...
Azure portal umożliwia tworzenie [brama aplikacji w](overview.md) z [zapory aplikacji sieci web](waf-overview.md) (WAF). Używa zapory aplikacji sieci Web [OWASP](https://www.owasp.org/index.php/Category:OWASP_ModSecurity_Core_Rule_Set_Project) zasady ochrony aplikacji. Reguły obejmują ochronę przed ataki, takie jak iniekcja kodu SQL, atakami skryptów między witrynami i hijacks sesji.
...
![Przykład zapory aplikacji sieci Web](./media/create-waf-portal/scenario-waf.png)
...
3. Wprowadź wartości dla bramy aplikacji:
    ...
    ![Utwórz nową bramę aplikacji](./media/create-waf-portal/application-gateway-create.png)
...
5. Kliknij przycisk **wybierz sieć wirtualną**, kliknij przycisk **Utwórz nowy**, a następnie wprowadź wartości dla sieci wirtualnej:
    ...
    ![Tworzenie sieci wirtualnej](./media/create-waf-portal/application-gateway-vnet.png)
...
2. Kliknij przycisk **podsieci**, a następnie kliknij przycisk **podsieci**.
    ...
    ![Tworzenie podsieci](./media/create-waf-portal/application-gateway-subnet.png)
...
1. Otwórz powłokę interakcyjne i upewnij się, że jest ustawiona na **PowerShell**.
    ...
    ![Zainstaluj rozszerzenia niestandardowego](./media/create-waf-portal/application-gateway-extension.png)
...
3. Kliknij przycisk **docelowy Dodaj** dodawania każdej maszyny wirtualnej, który został utworzony do puli wewnętrznej bazy danych.
    ...
    ![Dodawanie serwerów wewnętrznej bazy danych](./media/create-waf-portal/application-gateway-backend.png)
...
7. Kliknij pozycję **Zapisz**.
    ...
    ![Skonfiguruj diagnostyki](./media/create-waf-portal/application-gateway-diagnostics.png)
...
1. Znajdź publicznego adresu IP dla bramy aplikacji na ekran Przegląd. Kliknij przycisk **wszystkie zasoby** , a następnie kliknij przycisk **myAGPublicIPAddress**.
    ...
    ![Zarejestruj publiczny adres IP bramy aplikacji](./media/create-waf-portal/application-gateway-record-ag-address.png)

2. Skopiuj publiczny adres IP, a następnie wklej go na pasku adresu przeglądarki.

    ![Brama aplikacji w testu](./media/create-waf-portal/application-gateway-iistest.png)
