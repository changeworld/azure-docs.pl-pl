...
Ten samouczek wymaga programu Azure PowerShell module w wersji 3.6 lub nowszej można utworzyć certyfikatu i zainstalować usługi IIS. Uruchom polecenie `Get-Module -ListAvailable AzureRM`, aby dowiedzieć się, jaka wersja jest używana. Jeśli konieczne będzie uaktualnienie, zobacz [Instalowanie modułu Azure PowerShell](/powershell/azure/install-azurerm-ps). Aby uruchamiać polecenia w tym samouczku, trzeba będzie również uruchomić `Login-AzureRmAccount` do utworzenia połączenia z platformą Azure.
