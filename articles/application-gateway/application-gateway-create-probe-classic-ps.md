...
Jeśli chcesz skonfigurować funkcję TLS (Transport Layer Security), wcześniej znaną jako odciążanie ssl (Secure Sockets Layer), zobacz [Konfigurowanie bramy aplikacji dla odciążania protokołu TLS](application-gateway-ssl.md).
