...
Usługa Application gateway zapewnia możliwości, które umożliwia użytkownikom do zastępowania nagłówka hosta HTTP żądania na podstawie nazwy hosta zaplecza. Ta funkcja umożliwia obsługę wielodostępnych zapleczy np. aplikacji platformy Azure usługi web apps i API management. Ta funkcja jest dostępna zarówno dla v1 i v2 standardowa i jednostki SKU zapory aplikacji sieci Web. 
