...
![Ostrzeżenie bezpieczne](./media/redirect-http-to-https-cli/application-gateway-secure.png)
...
![Podstawowy adres URL testu bramy aplikacji](./media/redirect-http-to-https-cli/application-gateway-nginxtest.png)
