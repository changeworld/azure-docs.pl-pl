...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Przewodnik Cloud Adoption Framework dla platformy Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Bezpłatne kursy z zakresu platformy Azure organizowane przez firmę Pluralsight</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="visually-hidden">Dokumentacja platformy Microsoft Azure</h1>
        <ul class="pivots">
            <li>
                        ...
                        <ul id="get-started1" class="cardsL">
                            ...
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Zasoby związane z zabezpieczeniami i zarządzaniem</h3>
                                                <ul class="noBullet">
                                            ...
                                            <div class="cardText">
                                               ...
                                               <h4>Modele aplikacji</h4>
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/aks/">Mikrousługi na platformie Kubernetes</a></li>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">Baza danych SQL dla brzegu</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">Program SQL Server na maszynie wirtualnej platformy Azure</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics (dawniej SQL DW)</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/machine-learning/">Uczenie maszynowe </a></li>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Narzędzia do zarządzania</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Aplikacja mobilna platformy Azure </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Rozwijanie umiejętności dzięki środowisku Microsoft Learn</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/tour-azure-portal/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/tour-azure-services-and-features.svg" alt=""> Przewodnik po usługach i funkcjach platformy Azure </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> Reguły przetwarzania w chmurze </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/control-azure-services-with-cli/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/control-azure-services-with-cli.svg" alt=""> Sterowanie usługami platformy Azure przy użyciu interfejsu wiersza polecenia </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> Automatyzowanie zadań platformy Azure za pomocą skryptów programu PowerShell </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/browse/?products=azure">Więcej interakcyjnych zasobów szkoleniowych...</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Wyświetl wszystkie usługi platformy Azure<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul id="products">
                    <li>
                        <a data-default="true" href="#all">Wszystkie</a>
                        <ul id="all" class="directory">
                            <li>
                                <div class="group">
                                    <h3>SI i uczenie maszynowe</h3>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/computer-vision/">
                                                ...
                                                <p>Interfejs API przetwarzania obrazów</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/emotion/home">
                                                ...
                                                <p>Interfejs API rozpoznawania emocji</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cognitive-services/face/">
                                                <img src="media/index/API_Face.svg" alt="" />
                                                <p>Interfejs API rozpoznawania twarzy</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics (dawniej SQL DW)</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/hdinsight/spark/apache-spark-overview">
                                                <img src="media/index/hdinsight.svg" alt="" />
                                                <p>Apache Spark dla usługi Azure HDInsight</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/hdinsight/storm/apache-storm-overview">
                                                <img src="media/index/hdinsight.svg" alt="" />
                                                <p>Apache Storm dla usługi HDInsight</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/hdinsight/r-server/r-server-overview">
                                                <img src="media/index/hdinsight.svg" alt="" />
                                                <p>Program R Server dla usługi HDInsight</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/blockchain/tokens/">
                                                ...
                                                <p>Tokeny usługi Azure Blockchain</p>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Program SQL Server w usłudze Virtual Machines</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/workloads/sap/hana-overview-architecture">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Oprogramowanie SAP HANA na platformie Azure — duże wystąpienia</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/integrations">
                                                ...
                                                <p>Integracja narzędzi deweloperskich</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                                                <img src="https://docs.microsoft.com/media/common/i_cligeneric.svg" alt="" />
                                                <p>Interfejs wiersza polecenia</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/blockchain-workbench">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/active-directory-domain-services">
                                                <img src="media/index/ActiveDirectory.svg" alt="" />
                                                <p>Azure Active Directory dla usług Domain Services</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/iot-suite/">
                                                ...
                                                <p>Akceleratory rozwiązań IoT</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                ...
                                                <p>Aplikacja mobilna platformy Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Przesyłanie strumieniowe na żywo i na żądanie</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/azure-stack/">
                                                <img src="media/index/azure-stack.svg" alt="" />
                                                <p>Operator usługi Azure Stack</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/azure-stack/user">
                                                <img src="media/index/azure-stack.svg" alt="" />
                                                <p>Użytkownik usługi Azure Stack</p>
                                            </a>
                                        </li>                                        <li>
                                            <a href="/azure-stack/asdk/">
                                                <img src="media/index/azure-stack.svg" alt="" />
                                                <p>Zestaw Azure Stack Development Kit (ASDK)</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Migracja</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/dedicated-hsm">
                                                ...
                                                <p>Dedykowany moduł HSM platformy Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-network/ddos-protection-overview">
                                        ...
                                        <li>
                                            <a href="/azure/asc-for-iot/">
                                                ...
                                                <p>Azure Security Center dla IoT</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Suwerenne chmury</h3>
                                    <ul>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/azure-signalr/">
                                                ...
                                                <p>Usługa Azure SignalR Service</p>
                                            </a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zapewnij aplikacjom, witrynom internetowym i botom inteligencję pozwalającą im widzieć, słyszeć, mówić i interpretować</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie i wdrażanie modeli uczenia maszynowego i sztucznej inteligencji oraz zarządzanie nimi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics (dawniej SQL DW)</h3>
                                                    <p>Nieograniczona usługa analizy z niezrównanym czasem uzyskiwania wyników</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Analiza w czasie rzeczywistym w przypadku szybkich strumieni danych z aplikacji i urządzeń</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Spark dla usługi Azure HDInsight</h3>
                                                    <p>Platforma Apache Spark w chmurze dla wdrożeń o kluczowym znaczeniu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Storm dla usługi Azure HDInsight</h3>
                                                    <p>Uproszczone przetwarzanie strumienia w czasie rzeczywistym dla danych big data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Program R Server dla usługi Azure HDInsight</h3>
                                                    <p>Analiza predykcyjna, uczenie maszynowe i modelowanie statystyczne danych big data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Usługa plików NFS klasy korporacyjnej bazująca na usługach firmy NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Prosta i bezpieczna usługa do udostępniania danych big data organizacjom zewnętrznym</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#blockchain">Łańcuch bloków</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Usługa Azure Blockchain</h3>
                                                    <p>Tworzenie, nadzorowanie i rozwijanie sieci łańcucha bloków konsorcjum</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bez wysiłku połącz łańcuch bloków z chmurą</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tokeny usługi Azure Blockchain</h3>
                                                    <p>Łatwe definiowanie i tworzenie tokenów opartych na rejestrze oraz zarządzanie nimi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Program SQL Server w usłudze Virtual Machines</h3>
                                                    <p>Hostowanie firmowych aplikacji programu SQL Server w chmurze</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Oprogramowanie SAP HANA na platformie Azure — duże wystąpienia</h3>
                                                    <p>Uruchamianie największych obciążeń SAP HANA spośród wszystkich dostawców chmury w hiperskali</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>W pełni zarządzana usługa OpenShift obsługiwana wspólnie z firmą Red Hat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cognitive Services</h3>
                                                    <p>Korzystanie z kontenerów usług Azure Cognitive Services z platformami Docker, Kubernetes, AKS i Container Instances</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Łatwo wdrażaj i uruchamiaj konteneryzowane aplikacje internetowe z możliwością skalowania w miarę rozwoju firmy</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Szybkie tworzenie w środowisku Kubernetes za pomocą kontenerów i mikrousług</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Aparat relacyjnej bazy danych zoptymalizowany pod kątem wdrożeń IoT i brzegowych.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zarządzana usługa bazy danych MariaDB dla deweloperów aplikacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Upraszczanie migracji do chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>W pełni funkcjonalne zintegrowane środowisko projektowe (IDE) dla systemów Android, iOS i Windows oraz Internetu i chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Program Visual Studio Code to lekki, ale zaawansowany edytor kodu źródłowego, który działa lokalnie na komputerze i jest dostępny w systemach Windows, macOS i Linux.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Zestawy SDK</h3>
                                                    <p>Tworzenie aplikacji w chmurze za pomocą języków programowania, które już znasz</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integracja narzędzi deweloperskich</h3>
                                                    <p>Narzędzia innych firm pomocne podczas programowania na platformie Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Interfejs wiersza polecenia</h3>
                                                    <p>Uzyskiwanie dostępu do chmury bezpośrednio z poziomu narzędzi wiersza polecenia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Szybki i skalowalny magazyn parametrów na potrzeby usługi App Configuration</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Wykrywanie, klasyfikowanie i diagnozowanie problemów z usługami i aplikacjami internetowymi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie laboratoriów w chmurze na potrzeby klas, tworzenia oprogramowania i testowania oraz inne scenariusze (dawniej DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Szybsze dostarczanie aplikacji przez automatyzację ich cykli życia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integracja narzędzi deweloperskich</h3>
                                                    <p>Rozszerzanie platformy Azure przy użyciu popularnych rozszerzeń</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Szybkie wdrażanie dowolnego języka na dowolnej platformie na platformie Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie i wdrażanie zasad organizacyjnych w celu kontrolowania poufnych informacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Active Directory dla usług Domain Services</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Dowiedz się, jak zabezpieczyć rozwiązania w chmurze na platformie Azure, korzystając z naszych najlepszych rozwiązań i wskazówek</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#integration">Integracja</a>
...
<li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Szybkie tworzenie cyfrowych rozwiązań dla rolnictwa w chmurze.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rozwiązania i przypadki użycia dla branży usług finansowych.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Opieka zdrowotna i nauki przyrodnicze</h3>
                                                    <p>Rozwiązania i przypadki użycia dla branży opieki zdrowotnej i nauk przyrodniczych.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Produkcja</h3>
                                                    <p>Rozwiązania i przypadki użycia dla branży produkcyjnej.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rozwiązania i przypadki użycia dla branży handlu detalicznego.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Jesteś nowym użytkownikiem usługi Azure IoT?</h3>
                                                    <p>Zacznij tutaj, aby dowiedzieć się, która usługa spełnia Twoje wymagania</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Central</h3>
                                                    <p>Przyspieszanie tworzenia rozwiązań IoT</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Łączenie urządzeń z rozwiązaniem IoT bez pisania kodu urządzenia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Akceleratory rozwiązań IoT</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie cyfrowych replik miejsc i infrastruktury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Zarządzanie i ład</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Zabezpieczenia i zgodność</h3>
                                                    <p>Wykrywanie zagrożeń i zapobieganie im przy użyciu zaawansowanych zabezpieczeń w chmurze</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Portal</h3>
                                                    <p>Tworzenie i monitorowanie wszystkich produktów platformy Azure oraz zarządzanie nimi przy użyciu pojedynczej, ujednoliconej konsoli</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Upraszczanie zarządzania zasobami aplikacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Usprawnianie administrowania platformą Azure za pomocą powłoki opartej na przeglądarce</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aplikacja mobilna platformy Azure</h3>
                                                    <p>Zachowanie łączności ze swoimi zasobami na platformie Azure — wszędzie i o dowolnej porze</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Wdrażanie i aktualizowanie środowisk w chmurze w sposób powtarzalny przy użyciu artefaktów składalnych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Badanie zasobów na dużą skalę za pomocą rozbudowanego języka zapytań</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Migrate</h3>
                                                    <p>Łatwe odnajdywanie i ocenianie lokalnych maszyn wirtualnych, migrowanie ich na platformę Azure oraz dobieranie ich odpowiedniego rozmiaru</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zarządzanie zasobami klientów na dużą skalę</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Kodowanie</h3>
                                                    <p>Kodowanie w jakości studyjnej ze skalowaniem oferowanym przez chmurę</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Przesyłanie strumieniowe na żywo i na żądanie</h3>
                                                    <p>Dostarczaj zawartość do praktycznie wszystkich urządzeń na skalę, która spełnia potrzeby biznesowe</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Jeden odtwarzacz do odtwarzania wszystkiego</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bezpieczne dostarczanie zawartości przy użyciu technologii AES, PlayReady, Widevine i Fairplay</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Uzyskiwanie szczegółowych informacji z plików wideo dzięki usługom przetwarzania obrazów i mowy</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Multimedia jeszcze bardziej dostępne i prostsze do odnalezienia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Stack</h3>
                                                    <p>Rozszerz usługi platformy Azure i możliwości na środowisko lokalne, aby tworzyć oraz wdrażać aplikacje chmury hybrydowej i aplikacje brzegowe ponad granicami chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Operator usługi Azure Stack</h3>
                                                    <p>Dowiedz się, jak zarządzać infrastrukturą zintegrowanych systemów usługi Azure Stack i oferować usługi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="/azure/azure-stack/user">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Użytkownik usługi Azure Stack</h3>
                                                <p>Korzystanie z usług i kompilowanie aplikacji na potrzeby usługi Azure Stack</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="/azure-stack/asdk/">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Zestaw Azure Stack Development Kit (ASDK)</h3>
                                                <p>Środowisko nieprodukcyjne do oceny i testowania</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <li>
                        <a href="#mixed">Rzeczywistość mieszana</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Digital Twins</h3>
                                                    <p>Tworzenie rozwiązań IoT do analizy przestrzennej następnej generacji</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie środowisk rzeczywistości mieszanej z orientacją przestrzenną dla wielu użytkowników</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tworzenie własnego rozwiązania przy użyciu wszechstronnego urządzenia detekcyjnego</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin</h3>
                                                    <p>Szybciej twórz imponujące aplikacje mobilne z obsługą chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Chroń aplikacje przez atakami DDoS (Distributed Denial of Service, rozproszona odmowa usługi)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Oparta na chmurze usługa zabezpieczeń sieci o wysokiej dostępności i skalowalności</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wirtualna sieć WAN</h3>
                                                    <p>Tworzenie bezpiecznej łączności z oddziałami w skali globalnej</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Skalowalny i bezpieczny punkt wejścia do dostarczania aplikacji globalnych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Bastion</h3>
                                                    <p>Bezpieczna i bezproblemowa łączność z maszynami wirtualnymi za pośrednictwem protokołu SSL przez witrynę Azure Portal bez publicznego adresu IP</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Zapora aplikacji internetowej</h3>
                                                    <p>Centralna ochrona aplikacji internetowych przed typowymi atakami wykorzystującymi luki i lukami w zabezpieczeniach</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Optymalna łączność z Internetem na potrzeby dostępu do sieci firmy Microsoft</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ocena wpływu zmian infrastruktury sieci na wydajność klientów</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Link prywatny platformy Azure</h3>
                                                    <p>Prywatny dostęp do usług hostowanych na platformie Azure z zachowaniem danych w sieci firmy Microsoft</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Globalnie dystrybuowana usługa zarządzania zabezpieczeniami</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Dedykowany moduł HSM</h3>
                                                    <p>Używanie magazynu kluczy kryptograficznych na platformie Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ochrona przedsiębiorstwa przed zagrożeniami w chmurze i środowisku lokalnym</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zarządzanie dostępem do zasobów platformy Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Security Center dla IoT</h3>
                                                    <p>Dowiedz się, jak ujednolicić zarządzanie zabezpieczeniami i włączyć zaawansowaną ochronę przed zagrożeniami w rozwiązaniu IoT</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#other">Suwerenne chmury</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Dyski zarządzane</h3>
                                                    <p>Trwały, bezpieczny magazyn obsługujących maszyny wirtualne platformy Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Uruchamianie elastycznych obciążeń opartych na plikach na platformie Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Avere vFXT</h3>
                                                    <p>Uruchamianie opartych na plikach obciążeń o wysokiej wydajności na platformie Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rozwiązanie do optymalizacji magazynu hybrydowego w środowiskach obliczeń o wysokiej wydajności</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Łatwe zarządzanie magazynem z dowolnego miejsca za pomocą systemów Windows, macOS i Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ekonomiczne i bezpieczne przechowywanie w chmurze rzadko używanych danych</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>Sieciowe usługi plików klasy korporacyjnej bazujące na usługach firmy NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Szybkie tworzenie i wdrażanie aplikacji internetowych o kluczowym znaczeniu w odpowiedniej skali</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Usługa Azure SignalR Service</h3>
                                                    <p>Łatwe dodawanie funkcji internetowych czasu rzeczywistego</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows Virtual Desktop</h3>
                                                    <p>Udostępnianie zwirtualizowanego środowiska pulpitu na dowolnym urządzeniu w skali chmury</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Platforma Azure dla deweloperów platformy .NET </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Platforma Azure dla deweloperów języka Python </h3>
                                                <p>
                                                    <a href="/azure/python">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">Dokumentacja interfejsu API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Platforma Azure dla deweloperów środowiska Node.js </h3>
                                                <p>
                                                    <a href="/azure/javascript/">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/javascript/api/overview/azure/">Dokumentacja interfejsu API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Platforma Azure dla deweloperów języka Java </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Platforma Azure dla deweloperów języka Go </h3>
                                                <p>
                                                    <a href="/azure/go/">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="https://godoc.org/github.com/Azure/azure-sdk-for-go">Dokumentacja interfejsu API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Interfejsy API REST platformy Azure </h3>
                                                <p>
                                                    <a href="/rest/api">Dokumentacja interfejsu API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="container">
                                    <h2>Narzędzia do zarządzania</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Interfejs wiersza polecenia platformy Azure </h3>
                                                <p>
                                                    <a href="/cli/azure">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="/cli/azure/reference-index">Dokumentacja</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure Portal</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">Wprowadzenie</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Aplikacja mobilna platformy Azure</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">Wprowadzenie</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=navigation+cta&utm_content=download+vs2017">Pobierz dla systemu Windows</a>
                                                </p>
                                                 <p>
                                                    <a href="https://visualstudio.microsoft.com/vs/mac/">Pobierz dla komputerów Mac</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Docker </h3>
                                                ...
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Pobierz dla usługi Azure DevOps</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Narzędzia języka Java </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/api/overview/azure/maven/readme">Wtyczki usługi Maven</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/azure/java-azure-tools">IntelliJ i Eclipse</a>
                                                </p>
                                                <p>
...
Azure Resource Manager </h3>
                                                ...
                                                <p>
                                                    <a href="https://azure.microsoft.com/resources/templates/">Przykładowe szablony</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/templates/">Dokumentacja</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://storageexplorer.com">Eksplorator magazynu</a>
                                                </h3>
                                                <p>
                                                    <a href="/azure/vs-azure-tools-storage-manage-with-storage-explorer">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=722418">Pobierz dla systemu Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708342">Pobierz dla komputerów Mac</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708343">Pobierz dla systemu Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Zestaw Service Fabric SDK i narzędzia </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Pobierz dla systemu Windows</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Pobierz dla systemu Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-mac">Pobierz dla systemu Mac OS X</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-cli">Pobierz interfejs wiersza polecenia usługi Service Fabric </a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Narzędzia SQL </h3>
                                                <p>
                                                    <a href="/sql/azure-data-studio/download">Azure Data Studio <sup>WERSJA ZAPOZNAWCZA</sup></a>
                                                </p>
                                                <p>
                                                ...
                                                <p>
                                                    <a href="/sql/tools/overview-sql-tools">Zobacz wszystkie narzędzia SQL</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure Dev Spaces </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/azure-dev-spaces">Wprowadzenie</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore">Pobieranie dla platformy .NET Core i programu VS Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore-visualstudio">Pobieranie dla platformy .NET Core i programu Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-nodejs">Pobieranie dla środowiska Node.js</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
