...
Poniżej znajduje się przykładowy kod w języku Python. Należy pamiętać, że token dostępu użyty w tym przykładzie jest taki sam, że został odebrany podczas uwierzytelniania
