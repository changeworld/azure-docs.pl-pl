...
Aby uzyskać więcej informacji na temat integracji danych czujników, zobacz Integracja [danych czujników](sensor-partner-integration.md) i integracja z partnerem obrazów — zobacz [integracja z partnerem obrazów](imagery-partner-integration.md).
