...
Blok **harmonogram aktualizacji** umożliwia wyznaczenie okna obsługi dla pamięci podręcznej warstwy Premium. Po określeniu okna obsługi wszystkie aktualizacje serwera Redis są wykonywane w tym oknie. 
