...
- Utworzenie identyfikatora aplikacji usługi Azure Active Directory, który generuje klucz identyfikatora aplikacji używany przez usługę DMS do połączenia z obiektem docelowym wystąpienia zarządzanego usługi Azure Database i kontenerem usługi Azure Storage. Aby uzyskać więcej informacji, zobacz artykuł [Use portal to create an Azure Active Directory application and service principal that can access resources (Tworzenie aplikacji usługi Azure Active Directory i jednostki usługi, które mogą uzyskać dostęp do zasobów, w portalu)](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-create-service-principal-portal).
...
1.  Na ekranie **Szczegóły lokalizacji docelowej migracji** należy określić **identyfikator aplikacji** i **klucz**, którego może użyć wystąpienie usługi DMS, aby nawiązać połączenie z wystąpieniem docelowym wystąpienia zarządzanego usługi Azure SQL Database i kontem usługi Azure Storage.
...
Po przywróceniu kopii zapasowej całej bazy danych w wystąpieniu docelowym wystąpienia zarządzanego usługi Azure SQL Database baza danych jest dostępna do celów migracji jednorazowej.
