---
title: 'Samouczek: Migrowanie programu SQL Server w trybie online do pojedynczej bazy danych SQL'
...
---
# <a name="tutorial-migrate-sql-server-to-a-single-database-or-pooled-database-in-azure-sql-database-online-using-dms"></a>Samouczek: Migrowanie programu SQL Server do pojedynczej bazy danych lub puli bazy danych w bazie danych SQL w trybie online usługi Azure przy użyciu usługi DMS
...
- Pobierz i zainstaluj [program SQL Server 2012 lub nowszy](https://www.microsoft.com/sql-server/sql-server-downloads).
...
- Upewnij się, że poświadczenia używane do łączenia się z docelowym wystąpieniem bazy danych SQL platformy Azure mają uprawnienia CONTROL DATABASE w przypadku wystąpienia docelowej bazy danych SQL.
...
Aby ocenić lokalną bazę danych, wykonaj następujące kroki:
...
5. Wybierz istniejącą sieć wirtualną lub utwórz nową.
    ...
    Sieć wirtualna zapewnia usługę migracji bazy danych platformy Azure z dostępem do źródłowego programu SQL Server i docelowego wystąpienia bazy danych SQL azure.
