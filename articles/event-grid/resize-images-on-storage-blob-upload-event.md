...
Aby dowiedzieć się więcej na temat tej funkcji, zobacz [pliki function.json i index.js](https://github.com/Azure-Samples/storage-blob-resize-function-node/tree/master/Thumbnail).
