...
> [!NOTE]
> Za pomocą certyfikatów z podpisem własnym do sprawdzania poprawności nie jest obsługiwane. Zamiast tego użyj podpisanego certyfikatu od urzędu certyfikacji (CA).
