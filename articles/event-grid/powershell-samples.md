...
description: Przykłady programu Azure PowerShell dla usługi Event Grid
services: event-grid
author: tfitzmac
manager: timlt
...
| [Tworzenie tematu niestandardowego](scripts/event-grid-powershell-create-custom-topic.md) | Tworzy dysk zarządzany na podstawie specjalnego dysku VHD jako dysk systemu operacyjnego lub na podstawie dysku VHD z danymi jako dysk danych.  |
| | |
