---
title: Zdarzenia usługi Blob Storage dla usługi Azure Event Grid przy użyciu witryny Azure Portal | Microsoft Docs
description: Tworzenie konta usługi Blob Storage i subskrybowanie jego zdarzeń przy użyciu usługi Azure Event Grid i witryny Azure Portal.
services: event-grid
keywords: ''
author: tfitzmac
ms.author: tomfitz
...
1. Zdarzenie zostało wyzwolone, a usługa Event Grid wysłała komunikat do punktu końcowego skonfigurowanego podczas subskrybowania. Wyświetl aplikację internetową i zwróć uwagę, że otrzymano zdarzenie utworzone przez obiekt blob. 
