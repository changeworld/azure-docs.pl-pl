...
description: Ten artykuł zawiera przykładowy skrypt interfejsu wiersza polecenia platformy Azure, który pokazuje, jak subskrybować zdarzenia usługi Azure Event Grid dla grupy zasobów.
services: event-grid
