...
description: Ten artykuł zawiera przykładowy skrypt interfejsu wiersza polecenia platformy Azure, który pokazuje, jak subskrybować zdarzenia w usłudze Event Grid dla tematu niestandardowego.
services: event-grid
