...
| Operator | Konfigurowanie automatycznego aprowizowania | Ta operacja odpowiada pierwszej fazy automatycznego aprowizowania.<br><br>**Przewodniki Szybki Start**: wykonywania roli operatora Konfigurowanie usługi Device Provisioning i IoT Hub wystąpienia w ramach subskrypcji platformy Azure. | Konfigurowanie automatycznego aprowizowania |
|  | Rejestrowanie tożsamości urządzenia | Ta operacja odpowiada drugiej fazy automatycznego aprowizowania.<br><br>**Przewodniki Szybki Start**: wykonaj roli operatora rejestrowania symulowanego urządzenia w wystąpieniu usługi Device Provisioning Service. Tożsamość urządzenia jest określana przez metodę zaświadczania jest symulowane w przewodniku Szybki Start (TPM lub X.509). Zobacz szczegóły zaświadczania rola dla deweloperów. | 
...
> [!NOTE]
> Opcjonalnie, producent można również wykonać operacji "Rejestrowanie tożsamości urządzenia", przy użyciu interfejsów API usługi aprowizacji urządzeń (zamiast przy użyciu operatora). Szczegółowe omówienie tej sekwencjonowania i nie tylko zobacz [Zero touch rejestracji urządzeń w usłudze wideo usługi Azure IoT](https://myignite.microsoft.com/sessions/55087) (rozpoczyna się od znacznika 41:00)
