...
Uruchom program Visual Studio. W menu **File** (Plik) kliknij pozycję **New** (Nowe), a następnie kliknij pozycję **Project** (Projekt). Utwórz aplikację konsolową platformy .NET Core.
