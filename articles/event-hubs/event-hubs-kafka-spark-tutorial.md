---
title: Łączenie aplikacji Apache Spark i usługi Azure Event Hubs z obsługą platformy Kafka | Microsoft Docs
description: Korzystanie z platformy Apache Spark z usługą Azure Event Hubs dla platformy Kafka.
services: event-hubs
