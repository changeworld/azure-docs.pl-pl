---
title: Odbieranie zdarzeń z usługi Azure Event Hubs za pomocą języka Go | Dokumentacja firmy Microsoft
description: Wprowadzenie do odbierania zdarzeń z usługi Event Hubs za pomocą języka Go
services: event-hubs
author: joshgav
manager: kamalb
