---
title: Usługi Azure Event Hubs pobieranie parametrów połączenia | Dokumentacja firmy Microsoft
description: Pobieranie parametrów połączenia usługi Azure Event Hubs
services: event-hubs
