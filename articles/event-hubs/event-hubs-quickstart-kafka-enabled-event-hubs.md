...
description: Ten artykuł zawiera informacje na temat przesyłania strumieniowego do usługi Azure Event Hubs przy użyciu protokołu Kafka i interfejsów API.
services: event-hubs
author: basilhariri
ms.author: bahariri
