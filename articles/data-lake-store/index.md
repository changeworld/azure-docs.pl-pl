...
<ul class="panelContent cardsW">
    ...
                        <p><a href="https://docs.microsoft.com/python/api/azure.mgmt.datalake.store?view=azure-python">Python (zarządzanie kontem)</a></p>
                        <p><a href="https://azure-datalake-store.readthedocs.io/en/latest">Python (zarządzanie systemem plików)</a></p>
                    </div>
                </div>
            </div>
        </div>
