...
# [Dokumentacja dotycząca przełączania na usługę Data Lake Storage Gen2](https://docs.microsoft.com/azure/storage/data-lake-storage/introduction)
...
### [Korzystanie z Eksploratora usługi Storage](data-lake-store-in-storage-explorer.md)
...
### [Migrowanie usługi Data Lake Storage Gen1 między regionami](data-lake-store-migration-cross-region.md)
...
# Dokumentacja
## [Przykłady kodu](https://azure.microsoft.com/resources/samples/?service=data-lake-store)
...
## [Python (zarządzanie systemem plików)](https://azure-datalake-store.readthedocs.io/en/latest)
