...
2. Przypisz grupy zabezpieczeń usługi AAD do konta usługi Azure Data Lake Storage Gen1. Ta opcja kontroluje dostęp do konta Data Lake Storage Gen1 z portalu i zarządzanie operacji z portalu lub interfejsów API.
...
* **Konto usługi Azure Data Lake Storage Gen1**. Aby uzyskać instrukcje na temat jej tworzenia, zobacz [Rozpoczynanie pracy z usługą Azure Data Lake Store](data-lake-store-get-started-portal.md)
...
2. W bloku konta usługi Data Lake Store kliknij **kontrola dostępu (IAM)**. Blok domyślnie wyświetla właściciele subskrypcji jako właściciel.
    ...
    ![Przypisz grupy zabezpieczeń do konta usługi Azure Data Lake Storage Gen1](./media/data-lake-store-secure-data/adl.select.user.icon.png "Przypisz grupę zabezpieczeń do konta usługi Azure Data Lake Storage Gen1")
...
6. Grupy zabezpieczeń/użytkownika ma teraz dostęp do konta usługi Azure Data Lake Storage Gen1. Jeśli chcesz uzyskać dostęp do określonych użytkowników, możesz je dodać do grupy zabezpieczeń. Podobnie jeśli chcesz odwołać prawa dostępu dla użytkownika, można je usunąć z grupy zabezpieczeń. Można także przypisać wiele grup zabezpieczeń do konta. 

## <a name="filepermissions"></a>Przypisywanie użytkowników lub grup zabezpieczeń jako list ACL do systemu plików usługi Azure Data Lake Storage Gen1
...
Azure Data Lake Storage Gen1 pozwala na dalsze blokowanie dostępu do magazynu danych na poziomie sieci. Możesz Włącz zaporę, określ adres IP lub zdefiniować zakres adresów IP z zaufanych klientów. Po włączeniu tylko klienci, którzy mają adresy IP zdefiniowanego zakresu można połączyć z magazynem.

![Dostęp do ustawień zapory i IP](./media/data-lake-store-secure-data/firewall-ip-access.png "zapory adresów IP i ustawienia")

## <a name="remove-security-groups-for-an-azure-data-lake-storage-gen1-account"></a>Usuwanie grupy zabezpieczeń dla konta usługi Azure Data Lake Storage Gen1
Po usunięciu grupy zabezpieczeń z kont usługi Azure Data Lake Storage Gen1 tylko zmienić dostęp do operacji zarządzania na koncie przy użyciu witryny Azure Portal i interfejsów API usługi Azure Resource Manager.  
...
## <a name="remove-security-group-acls-from-azure-data-lake-storage-gen1-file-system"></a>Usuń grupę zabezpieczeń listy kontroli dostępu w systemie plików usługi Azure Data Lake Storage Gen1
Podczas usuwania grupy zabezpieczeń listy kontroli dostępu w systemie plików usługi Azure Data Lake Store, możesz zmienić dostęp do danych w Gen1 magazynu programu Data Lake.
