...
description: Ten temat zawiera omówienie Azure Media Services punktów końcowych przesyłania strumieniowego.
...
Azure Media Services dodano następujące właściwości do jednostki punktu końcowego przesyłania strumieniowego: **CdnProvider**, **CdnProfile**, **StreamingEndpointVersion**. Szczegółowe omówienie tych właściwości można znaleźć w temacie [](https://docs.microsoft.com/rest/api/media/operations/streamingendpoint). 
...
|--------------|----------|-----------------|-----------------|-----------------|
|Klasyczny|1.0|0|Nie dotyczy|Wolne|
