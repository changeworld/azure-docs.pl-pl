...
* Można znaleźć informacje dla deweloperów w [przewodnik dewelopera usługi Azure Active Directory](../../active-directory/active-directory-developers-guide.md).
