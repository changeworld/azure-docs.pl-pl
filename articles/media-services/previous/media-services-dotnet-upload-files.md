...
ms.locfileid: "55984226"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Przekazywanie plików na konto usługi Media Services przy użyciu platformy .NET (starsza wersja)
