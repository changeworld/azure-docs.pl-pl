...
Zobacz [przykładowe repozytorium kodu,](https://github.com/Azure-Samples/media-services-video-indexer/tree/master/Embedding%20widgets) które zawiera przykłady interfejsu API i widżetów indeksatora wideo:
