...
* Konto wersji próbnej: Video Indexer używa wewnętrznego konta Custom Vision do tworzenia modelu i łączenia go z kontem Video Indexer. 
...
Jeśli masz konto płatne Video Indexer, musisz najpierw połączyć konto Custom Vision. Jeśli nie masz już konta Custom Vision, utwórz je. Aby uzyskać więcej informacji, zobacz [Custom Vision](https://docs.microsoft.com/azure/cognitive-services/custom-vision-service/home).
...
1. Oznacz i Przeszkol model.
    ...
    1. Oznacz wykryty znak, edytując jego nazwę. Gdy znak jest przeszkolony do modelu, zostanie on rozpoznany jako następne wideo indeksowane z tym modelem. 
    ...
    1. Po zakończeniu edycji wszystkich żądanych nazw musisz nauczyć się modelu.
        ...
        * Konta próbne: Otwórz stronę Dostosowywanie i kliknij kartę animowane znaki i kliknij posiadany model przycisku **uczenia** .
        * Płatne konta: Otwórz stronę Dostosowywanie i kliknij kartę animowane znaki. W przypadku odpowiedniego modelu kliknij link **Edytuj w Custom Vision** . Następnie zostanie przekierowany do strony modelu w Custom Vision. Kliknij przycisk "uczenie", aby wyszkolić model. 
