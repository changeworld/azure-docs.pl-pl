...
Ten skrypt umożliwia utworzenie konta usługi Azure Media Services.
...
| **az ams account create** | Tworzy konto usługi Media Services. |
| **az ams account sp create** | Tworzy jednostkę usługi i hasło oraz konfiguruje je na potrzeby dostępu do usługi Azure Media Services. |
