---
title: Analiza multimediów platformy Azure | Dokumentacja firmy Microsoft
...
ms.locfileid: "46498695"
---
# <a name="media-intelligence"></a>Inteligentna analiza multimediów

Interfejs API v3 usługi Azure Media Services REST umożliwia analizowanie zawartości audio i wideo. Aby analizować zawartość, musisz utworzyć **Przekształcanie** i Prześlij **zadania** który używa tych ustawień: **AudioAnalyzerPreset** lub **VideoAnalyzerPreset** . 
