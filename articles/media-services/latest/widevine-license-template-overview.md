---
title: Omówienie szablon licencji Azure Media Services przy użyciu metody Widevine | Dokumentacja firmy Microsoft
...
| Name (Nazwa) | Wartość | Opis |
| --- | --- | --- |
| policy_overrides&#46;can_play |Wartość logiczną PRAWDA lub FAŁSZ |Wskazuje, że odtwarzanie zawartości jest dozwolone. Wartość domyślna to false. |
| policy_overrides&#46;can_persist |Wartość logiczną PRAWDA lub FAŁSZ |Wskazuje, że licencja może utrwalone nieulotnej pamięci masowej w trybie offline. Wartość domyślna to false. |
| policy_overrides&#46;can_renew |Wartość logiczną PRAWDA lub FAŁSZ |Wskazuje, że odnowienia licencji jest dozwolone. Jeśli PRAWDA, czas trwania licencji można przedłużyć pulsu. Wartość domyślna to false. |
...
Usługa Media Services udostępnia klasę, która umożliwia skonfigurowanie licencji Widevine. Do utworzenia licencji, należy przekazać ciąg JSON do [WidevineTemplate](https://docs.microsoft.com/dotnet/api/microsoft.azure.management.media.models.contentkeypolicywidevineconfiguration.widevinetemplate?view=azure-dotnet#Microsoft_Azure_Management_Media_Models_ContentKeyPolicyWidevineConfiguration_WidevineTemplate).

Aby skonfigurować szablon, który można wykonywać następujące czynności:

1.  Bezpośrednio konstrukcja/kodowania ciągu JSON (które mogą być podatne na błędy);
...
2.  Konstrukcja niezbędne klasy z właściwościami mapowanie na atrybutach JSON i utworzyć ich wystąpienia przed rozpoczęciem serializacji je do ciągu JSON. Poniżej znajduje się przykład tego rodzaju oraz sposób ich wystąpienia i serializacji.
