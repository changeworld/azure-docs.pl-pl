...
description: Szczegółowe wyjaśnienie sposobu tworzenia i lokalizowania kotwic przy użyciu czujników na urządzeniach w celu-C.
author: bucurb
manager: dacoghl
...
ms.locfileid: "74277237"
---
# <a name="how-to-create-and-locate-anchors-using-on-device-sensors-in-objective-c"></a>Jak utworzyć i zlokalizować kotwice przy użyciu czujników na urządzeniach w celu-C
