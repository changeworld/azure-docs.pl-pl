---
title: Tworzenie & lokalizowanie zakotwiczeń w języku C++/NDK
description: Szczegółowe wyjaśnienie sposobu tworzenia i lokalizowania zakotwiczeń przy użyciu zakotwiczeń przestrzennych platformy Azure w języku C++/NDK.
...
---
# <a name="how-to-create-and-locate-anchors-using-azure-spatial-anchors-in-cndk"></a>Jak tworzyć i lokalizować kotwice przy użyciu zakotwiczeń przestrzennych platformy Azure w języku C++/NDK
...
Usługa Azure Spatial Anchors umożliwia udostępnianie kotwic na całym świecie między różnymi urządzeniami. Obsługuje kilka różnych środowisk programistów. W tym artykule przyjrzymy się, jak użyć zestawu SDK zakotwiczenia przestrzennego platformy Azure w języku C++/NDK, aby:
...
Dowiedz się więcej o strukturze [konfiguracji sessionconfiguration.](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/sessionconfiguration)
...
Dowiedz się więcej o [delegata TokenRequiredDelegate.](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/tokenrequireddelegate)
...
Dowiedz się więcej o [delegata SessionUpdatedDelegate.](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/sessionupdateddelegate)
...
Dowiedz się więcej o [AppProperties](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/cloudspatialanchor#appproperties) metody.
...
Dowiedz się więcej o [expiration](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/cloudspatialanchor#expiration) metody.
...
Dowiedz się więcej o [delegata AnchorLocated.](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/anchorlocateddelegate)
...
Dowiedz się więcej o [stop](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#stop) metody.
...
Dowiedz się więcej o [metodzie Resetowanie.](https://docs.microsoft.com/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#reset)
