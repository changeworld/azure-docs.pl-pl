...
description: Skalowanie zasobów obliczeniowych w usłudze Azure SQL Data Warehouse przy użyciu języka T-SQL i programu SQL Server Management Studio (SSMS). Skalowanie zasobów obliczeniowych w poziomie zapewnia lepszą wydajność, a ich ponowne przeskalowanie pozwala ograniczyć koszty.
...
W usłudze SQL Data Warehouse można zwiększyć lub zmniejszyć zasoby obliczeniowe przez odpowiednie dostosowanie jednostek magazynu danych. Postępując według czynności opisanych w przewodniku Szybki start: [tworzenie i łączenie — portal](create-data-warehouse-portal.md) utworzono bazę danych **mySampleDataWarehouse** z 400 jednostkami DWU. Poniższe kroki umożliwiają dostosowanie jednostek DWU dla bazy danych **mySampleDataWarehouse**.
