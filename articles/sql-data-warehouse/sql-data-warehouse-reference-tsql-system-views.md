...
description: Linki do dokumentacji dotyczącej widoków systemu obsługiwanych w usłudze SQL Analytics.
...
ms.locfileid: "78198307"
---
# <a name="system-views-supported-in-sql-analytics"></a>Widoki systemowe obsługiwane w analizie SQL
Linki do dokumentacji dotyczącej instrukcji języka T-SQL obsługiwanych w usłudze SQL Analytics.

## <a name="sql-analytics-catalog-views"></a>Widoki wykazu usługi SQL Analytics
...
## <a name="sql-server-dmvs-applicable-to-sql-analytics"></a>SQL Server widoków DMV mające zastosowanie do analiz SQL
Poniższe widoków DMV mają zastosowanie do analiz SQL, ale muszą być wykonywane przez połączenie z bazą danych **Master** .
...
## <a name="sql-server-dmvs-available-in-sql-analytics"></a>SQL Server widoków DMV dostępne w usłudze SQL Analytics
Program SQL Analytics uwidacznia wiele SQL Server dynamicznych widoków zarządzania (widoków DMV). Te widoki, które są zgłaszane w analizie SQL, zgłaszają stan baz danych SQL działających w ramach dystrybucji.

Usługi SQL Analytics i Parallel Data Warehouse (PDW) używają tych samych widoków systemowych. Każdy DMV ma kolumnę o nazwie pdw_node_id, która jest identyfikatorem węzła obliczeniowego. 
...
| Nazwa DMV w analizie SQL | SQL Server artykułu Transact-SQL|
|:--- |:--- |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-analytics"></a>SQL Server widoków DMV 2016 dostępne w analizie SQL
Poniższe widoków DMV mają zastosowanie do analiz SQL, ale muszą być wykonywane przez połączenie z bazą danych **Master** .
...
Aby uzyskać więcej informacji, zobacz [instrukcje języka t-SQL w programie SQL Analytics](sql-data-warehouse-reference-tsql-statements.md)i [elementy językowe t-SQL w usłudze SQL Analytics](sql-data-warehouse-reference-tsql-language-elements.md).
