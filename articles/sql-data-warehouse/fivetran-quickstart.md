...
* Przewożąc.
* Baza danych.
* Użytkownik (nazwa użytkownika powinna być **fivetran\@_server_name_**  , gdzie *server_name* jest częścią identyfikatora URI hosta platformy Azure: ***server_name *. Database. Windows. NET**).
* Hasło.
