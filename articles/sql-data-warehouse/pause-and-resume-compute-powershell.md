...
Aby sprawdzić stan magazynu danych, należy użyć [Get-AzureRmSqlDatabaseActivity](https://docs.microsoft.com/powershell/module/azurerm.sql/Get-AzureRmSqlDatabaseActivity#description) polecenia cmdlet.
