...
ms.locfileid: "51579715"
---
# <a name="whats-new-in-azure-sql-data-warehouse-october-2018"></a>Co nowego w usłudze Azure SQL Data Warehouse? Października 2018 r.
...
## <a name="instant-data-movement"></a>Przenoszenie danych błyskawiczne 
Oprócz losowa błyskawiczne przenoszenia danych została rozszerzona do emisji i partycji przenoszenia.

## <a name="scale-up-column-store-columnstore-metadata-memory-management-sql-server"></a>Skalowania w górę Store kolumny: Zarządzanie pamięcią (SQL Server) dla magazynu kolumn metadanych
Zarządzanie pamięcią zoptymalizowanego dla kolumny magazynu metadanych 
