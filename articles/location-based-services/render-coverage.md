...
---
# <a name="azure-location-based-services---render-coverage"></a>Usługi - pokrycia renderowania na podstawie lokalizacji platformy Azure

Ten artykuł zawiera informacja o pokryciu Azure lokalizacji na podstawie usług renderowania. 

Zapoznaj się z pokrycia [ **Geokodowanie**](geocoding-coverage.md).  
Zapoznaj się z pokrycia [ **ruchu**](traffic-coverage.md).  
Zapoznaj się z pokrycia [ **Routing**](routing-coverage.md).
...
## <a name="render-coverage-of-raster-tiles"></a>Renderowanie pokrycia Kafelki rastrowe

Poniższa tabela zawiera informacja o pokryciu Azure lokalizacji na podstawie usług renderowania z rastrowe Kafelki.

|Region|Renderowanie — Unified Kafelki rastrowe|
|--- |:---: |
| **Afryka**                         |                |
|Algieria|✓ |
|Angola|✓ |
...
## <a name="render-coverage-of-vector-tiles"></a>Renderowanie pokrycia Kafelki wektora 

Poniższa tabela zawiera informacja o pokryciu Azure lokalizacji na podstawie usług renderowania z wektora Kafelki.

|Region|Renderowanie — Unified Kafelki wektora|
|--- |:---: |
| **Afryka**                         |                |
|Algieria|✓|
|Angola|✓|
...
|Saint Kitts i Nevis|✓|
|Saint Lucia|✓|
|Wyspa Świętej s pole (część francuska)|✓|
