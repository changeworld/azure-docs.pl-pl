---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Audit if Network Watcher is not enabled for region (Przeprowadź inspekcję stanu włączenia usługi Network Watcher w danym regionie) | Microsoft Docs
description: Te przykładowe zasady w formacie JSON przeprowadzają inspekcję stanu włączenia usługi Network Watcher w danym regionie.
...
ms.locfileid: "34602571"
---
# <a name="audit-if-network-watcher-is-not-enabled-for-region"></a>Przeprowadzanie inspekcji stanu włączenia usługi Network Watcher w danym regionie
