---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Allowed Express Route SKUs (Dozwolone jednostki SKU usługi Express Route) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga, aby usługa Express Route używała zatwierdzonej jednostki SKU.
...
---
# <a name="allowed-express-route-skus"></a>Dozwolone jednostki SKU usługi Express Route

Ta zasada wymaga, aby usługa Express Route używała zatwierdzonej jednostki SKU. Należy określić tablicę dozwolonych jednostek SKU.
