---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — inspekcja przezroczystego szyfrowania danych dla usługi SQL Database | Microsoft Docs
description: Te przykładowe zasady w formacie JSON sprawdzają, czy usługa SQL Database nie ma włączonego przezroczystego szyfrowania danych.
