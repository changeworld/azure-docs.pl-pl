---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Not allowed resource types (Niedozwolone typy zasobów) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON uniemożliwia wdrażanie określonych typów zasobów.
