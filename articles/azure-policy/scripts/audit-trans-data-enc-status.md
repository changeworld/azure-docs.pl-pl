---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Audit transparent data encryption status (Przeprowadź inspekcję stanu przezroczystego szyfrowania danych) | Microsoft Docs
...
ms.locfileid: "34602282"
---
# <a name="audit-transparent-data-encryption-status"></a>Inspekcja stanu przezroczystego szyfrowania danych

Te zasady sprawdzają, czy usługa SQL Database nie ma włączonego przezroczystego szyfrowania danych.
