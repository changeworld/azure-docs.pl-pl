---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — No user defined route table (Nie zezwalaj na tabelę tras zdefiniowaną przez użytkownika) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON uniemożliwia wdrażanie sieci wirtualnych przy użyciu tabeli tras zdefiniowanej przez użytkownika.
