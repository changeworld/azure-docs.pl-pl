---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Audit VM not using managed disk (Sprawdź, czy maszyna wirtualna nie używa dysku zarządzanego) | Microsoft Docs
