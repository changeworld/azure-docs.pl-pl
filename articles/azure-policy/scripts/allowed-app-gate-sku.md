---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Allowed application gateway SKUs (Dozwolone jednostki SKU bramy aplikacji) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga, aby bramy aplikacji używały zatwierdzonej jednostki SKU.
