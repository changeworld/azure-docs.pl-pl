---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Allow custom VM image from a resource group (Zezwalaj na korzystanie z niestandardowego obrazu maszyny wirtualnej pochodzącego z grupy zasobów) | Microsoft Docs
description: Te przykładowe zasady w formacie JSON wymagają, aby niestandardowe obrazy pochodziły z zatwierdzonej grupy zasobów.
...
---
# <a name="allow-custom-vm-image-from-a-resource-group"></a>Zezwalanie na korzystanie z niestandardowego obrazu maszyny wirtualnej pochodzącego z grupy zasobów

Te przykładowe zasady w formacie JSON wymagają, aby niestandardowe obrazy pochodziły z zatwierdzonej grupy zasobów. Należy określić nazwę zatwierdzonej grupy zasobów.
...
Dodatkowe przykładowe szablony usługi Azure Policy można znaleźć w dokumentacji usługi Azure Policy
