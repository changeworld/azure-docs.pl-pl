---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Apply tag and its default value (Zastosuj tag i jego wartość domyślną) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON dołącza określoną nazwę i wartość tagu, jeśli nie podano tagu.
