---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Audit SQL DB level audit Setting (Przeprowadź inspekcję ustawień inspekcji na poziomie usługi SQL DB) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON sprawdza, czy ustawienia inspekcji usługi SQL Database nie są zgodne z określonym ustawieniem.
