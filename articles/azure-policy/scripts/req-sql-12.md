---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Require SQL Server version 12.0 (Wymagaj programu SQL Server w wersji 12.0) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga używania wersji 12.0 programu SQL Server.
