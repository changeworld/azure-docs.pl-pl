---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Require storage account encryption (Wymagaj szyfrowania konta magazynu) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga szyfrowania obiektów blob na koncie magazynu.
...
ms.locfileid: "34602367"
---
# <a name="require-storage-account-encryption"></a>Wymaganie szyfrowania konta magazynu

Ta zasada wymaga szyfrowania obiektów blob na koncie magazynu.
