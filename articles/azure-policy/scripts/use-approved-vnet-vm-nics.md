---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Use approved vNet for VM network interfaces (Użyj zatwierdzonej sieci wirtualnej dla interfejsów sieciowych maszyny wirtualnej) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga używania zatwierdzonej sieci wirtualnej przez interfejsy sieciowe.
