---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — NSG x on every subnet (Sieciowa grupa zabezpieczeń X w każdej podsieci) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga, aby dana sieciowa grupa zabezpieczeń była używana w każdej podsieci wirtualnej.
