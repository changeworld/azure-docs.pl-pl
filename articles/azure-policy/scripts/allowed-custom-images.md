---
title: Przykład zasad Azure Policy — zatwierdzone obrazy maszyny wirtualnych
description: Te zasady wymagają, aby w środowisku były wdrażane tylko zatwierdzone niestandardowe obrazy.
...
- Przejrzyj dodatkowe [przykłady zasad Azure Policy](../json-samples.md)
- Przejrzyj temat [Struktura definicji zasad Azure Policy](../policy-definition.md)
- Zobacz dodatkowe przykłady usługi Azure Policy dla maszyn wirtualnych na stronie [Apply policies to Windows VMs (Stosowanie zasad na maszynach wirtualnych z systemem Windows)](../../virtual-machines/windows/policy.md)