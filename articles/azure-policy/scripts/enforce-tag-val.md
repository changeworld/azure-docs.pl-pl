---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Enforce tag and its value (Wymuś tag i jego wartość) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga określonej nazwy i wartości tagu.
