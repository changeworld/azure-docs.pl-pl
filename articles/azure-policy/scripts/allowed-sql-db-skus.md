---
title: Przykładowe zasady usługi Azure Policy w formacie JSON — Allowed SQL DB SKUs (Dozwolone jednostki SKU usługi SQL DB) | Microsoft Docs
description: Ta przykładowa zasada w formacie JSON wymaga, aby bazy danych SQL używały zatwierdzonych jednostek SKU.
