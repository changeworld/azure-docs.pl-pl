...
Z opartej na rolach kontroli dostępu (RBAC), należy zdefiniować dostęp dla użytkowników, grup i nazwy główne usług poprzez przypisywanie ról w określonym zakresie. W tym artykule opisano, jak zarządzać dostępem przy użyciu programu Azure PowerShell.
...
![Zrzut ekranu PowerShell-Get AzureRmRoleDefinition - RBAC](./media/role-assignments-powershell/1-get-azure-rm-role-definition1.png)
...
![Zrzut ekranu PowerShell-Get AzureRmRoleDefinition dla konkretnej roli - RBAC](./media/role-assignments-powershell/1-get-azure-rm-role-definition2.png)
...
![Zrzut ekranu PowerShell-Get AzureRmRoleAssignment dla grupy zasobów - RBAC](./media/role-assignments-powershell/4-get-azure-rm-role-assignment1.png)
...
![Zrzut ekranu PowerShell-Get AzureRmRoleAssignment dla użytkownika — RBAC](./media/role-assignments-powershell/4-get-azure-rm-role-assignment2.png)
...
![Zrzut ekranu PowerShell — nowy AzureRmRoleAssignment - RBAC](./media/role-assignments-powershell/2-new-azure-rm-role-assignment2.png)
...
![Zrzut ekranu PowerShell — nowy AzureRmRoleAssignment - RBAC](./media/role-assignments-powershell/2-new-azure-rm-role-assignment3.png)
...
![Zrzut ekranu PowerShell — nowy AzureRmRoleAssignment - RBAC](./media/role-assignments-powershell/2-new-azure-rm-role-assignment4.png)
...
![Zrzut ekranu PowerShell-Remove AzureRmRoleAssignment - RBAC](./media/role-assignments-powershell/3-remove-azure-rm-role-assignment.png)
...
![Zrzut ekranu PowerShell-Get AzureRmRoleDefinition - RBAC](./media/role-assignments-powershell/2-new-azurermroledefinition.png)
...
![Zrzut ekranu PowerShell-Set AzureRmRoleDefinition - RBAC](./media/role-assignments-powershell/3-set-azurermroledefinition-1.png)
...
![Zrzut ekranu PowerShell-Set AzureRmRoleDefinition - RBAC](./media/role-assignments-powershell/3-set-azurermroledefinition-2.png)
...
![Zrzut ekranu PowerShell-Remove AzureRmRoleDefinition - RBAC](./media/role-assignments-powershell/4-remove-azurermroledefinition.png)
...
![Zrzut ekranu PowerShell-Get AzureRmRoleDefinition - RBAC](./media/role-assignments-powershell/5-get-azurermroledefinition-1.png)
...
![Zrzut ekranu PowerShell-Get AzureRmRoleDefinition - RBAC](./media/role-assignments-powershell/5-get-azurermroledefinition2.png)
