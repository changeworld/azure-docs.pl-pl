...
![Relacja między elementami usługi Azure Active Directory — diagram](./media/overview/rbac_aad.png)
...
[Wbudowane role RBAC](built-in-roles.md) Wyświetla listę ról, które są dostępne w systemie Azure. Określa operacje i zakresem, który każdego wbudowana rola przyznaje użytkownikom. Jeśli szukasz definiować własne role, aby uzyskać większą kontrolę, zobacz sposób tworzenia [niestandardowych ról w Azure RBAC](custom-roles.md).
...
Portalu Azure i nowych interfejsów API usługi Azure Resource Manager obsługuje Azure RBAC. Użytkownicy i aplikacje, które są przypisane role RBAC nie można użyć Azure Klasyczny model wdrażania przy użyciu interfejsów API.
...
* Rozpoczynanie pracy z [opartej na rolach kontroli dostępu w portalu Azure](role-assignments-portal.md).
