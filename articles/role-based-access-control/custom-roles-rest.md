---
title: Tworzenie lub aktualizowanie ról niestandardowych dla zasobów platformy Azure przy użyciu interfejsu API REST — Azure | Microsoft Docs
