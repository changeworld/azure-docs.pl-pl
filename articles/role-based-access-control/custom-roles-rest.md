---
title: Tworzenie niestandardowych lub niezaktualizowanych ról dla zasobów platformy Azure przy użyciu interfejsu API REST — Azure | Microsoft Docs
