...
> | Akcja | Microsoft. aadiam/metricDefinitions/odczyt | Odczytywanie definicji metryk na poziomie dzierżawy |
> | Akcja | Microsoft. aadiam/Metrics/Read | Odczytywanie metryk na poziomie dzierżawy |
...
> | Akcja | Microsoft. Advisor/generateRecommendations/akcja | Pobiera stan zaleceń generowania |
...
> | Akcja | Microsoft. ApiManagement/Service/authorizationServers/listSecrets/Action | Pobiera wpisy tajne dla serwera autoryzacji. |
> | Akcja | Microsoft.ApiManagement/service/authorizationServers/read | Wyświetla kolekcję serwerów autoryzacji zdefiniowanych w ramach wystąpienia usługi. lub pobiera szczegóły serwera autoryzacji bez wpisów tajnych. |
...
> | Akcja | Microsoft. ApiManagement/Service/Gateways/API/Delete | Usuwa określony interfejs API z określonej bramy. |
...
> | Akcja | Microsoft. ApiManagement/Service/Gateways/hostnameConfigurations/Read | Wyświetla listę konfiguracji nazwy hosta dla określonej bramy. |
...
> | Akcja | Microsoft. ApiManagement/Service/skojarzeni/listSecrets/Action | Pobiera wpisy tajne dostawcy tożsamości. |
> | Akcja | Microsoft.ApiManagement/service/identityProviders/read | Wyświetla kolekcję dostawców tożsamości skonfigurowanych w określonym wystąpieniu usługi. lub pobiera szczegóły konfiguracji dostawcy tożsamości bez wpisów tajnych. |
...
> | Akcja | Microsoft. ApiManagement/Service/openidConnectProviders/listSecrets/Action | Pobiera określone wpisy tajne dostawcy połączenia OpenID Connect. |
> | Akcja | Microsoft.ApiManagement/service/openidConnectProviders/read | Listy wszystkich dostawców połączeń OpenID Connect. lub pobiera określonego dostawcę połączenia OpenID Connect bez wpisów tajnych. |
...
> | Akcja | Microsoft. ApiManagement/Service/portalsettings/listSecrets/Action | Pobiera klucz weryfikacji ustawień delegowania portalu. |
> | Akcja | Microsoft.ApiManagement/service/portalsettings/read | Wyświetla kolekcję ustawień portalu. lub uzyskaj ustawienia logowania dla portalu lub uzyskaj ustawienia rejestracji w portalu lub uzyskaj ustawienia delegowania dla portalu. |
...
> | Akcja | Microsoft. ApiManagement/Service/Properties/listSecrets/Action | Pobiera wpisy tajne właściwości określonej przez jego identyfikator. |
...
> | Akcja | Microsoft. ApiManagement/Service/subscriptions/listSecrets/Action | Pobiera określone klucze subskrypcji. |
> | Akcja | Microsoft.ApiManagement/service/subscriptions/read | Wyświetla wszystkie subskrypcje wystąpienia usługi API Management. lub pobiera określoną jednostkę subskrypcji (bez kluczy). |
...
> | Akcja | Microsoft. ApiManagement/Service/dzierżawca/listSecrets/akcja | Pobierz szczegóły informacji o dostępie dzierżawy |
...
> | Akcja | Microsoft.ApiManagement/service/write | Utwórz lub zaktualizuj wystąpienie usługi API Management |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. AppConfiguration/checkNameAvailability/odczyt | Sprawdź, czy nazwa zasobu jest dostępna do użycia. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/Delete | Usuwa magazyn konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/eventGridFilters/Delete | Usuwa filtr siatki zdarzeń magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/eventGridFilters/Read | Pobiera właściwości określonego filtru siatki zdarzeń magazynu konfiguracji lub wyświetla wszystkie filtry siatki zdarzeń magazynu konfiguracji w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/eventGridFilters/Write | Utwórz lub zaktualizuj filtr siatki zdarzeń magazynu konfiguracji o określonych parametrach. |
> | Akcja dataaction | Microsoft. AppConfiguration/configurationStores/wartość/usuwanie | Usuwa istniejącą wartość klucza z magazynu konfiguracji. |
> | Akcja dataaction | Microsoft. AppConfiguration/configurationStores/wartość/odczyt | Odczytuje klucz-wartość z magazynu konfiguracji. |
> | Akcja dataaction | Microsoft. AppConfiguration/configurationStores/wartość/zapis | Tworzy lub aktualizuje klucz-wartość w magazynie konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/ListKeys/akcja | Wyświetla listę kluczy interfejsu API dla określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/ListKeyValue/akcja | Wyświetla listę klucz-wartość dla określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/Delete | Usuń serwer proxy połączenia prywatnego punktu końcowego w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/Read | Pobierz serwer proxy połączenia prywatnego punktu końcowego w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/Validate/akcja | Sprawdź poprawność serwera proxy połączenia prywatnego punktu końcowego w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/Write | Utwórz lub zaktualizuj serwer proxy połączenia prywatnego punktu końcowego w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateEndpointConnections/Delete | Usuń połączenie prywatnego punktu końcowego z określonym magazynem konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateEndpointConnections/Read | Uzyskaj połączenie prywatnego punktu końcowego lub Wyświetl listę prywatnych połączeń punktów końcowych w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateEndpointConnections/Write | Zatwierdź lub Odrzuć połączenie prywatnego punktu końcowego w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/PrivateEndpointConnectionsApproval/akcja | Autozatwierdzanie prywatnego połączenia punktu końcowego w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/privateLinkResources/Read | Wyświetla listę wszystkich prywatnych zasobów linków w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/Providers/Microsoft. Insights/diagnosticSettings/Read | Odczytaj wszystkie wartości ustawień diagnostycznych dla magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/Providers/Microsoft. Insights/diagnosticSettings/Write | Zapisz/Zastąp ustawienia diagnostyczne dla konfiguracji aplikacji firmy Microsoft. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/Providers/Microsoft. Insights/metricDefinitions/Read | Pobierz wszystkie definicje metryk dla konfiguracji aplikacji firmy Microsoft. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/odczyt | Pobiera właściwości określonego magazynu konfiguracji lub wyświetla listę wszystkich magazynów konfiguracji w ramach określonej grupy zasobów lub subskrypcji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/RegenerateKey/akcja | Generuje ponownie klucz interfejsu API dla określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/syncTasks/Delete | Usuwa zadanie synchronizacji magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/syncTasks/Read | Pobiera właściwości określonego zadania synchronizacji magazynu konfiguracji lub wyświetla wszystkie zadania synchronizacji magazynu konfiguracji w ramach określonego magazynu konfiguracji. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/syncTasks/Write | Utwórz lub zaktualizuj zadanie synchronizacji magazynu konfiguracji z określonymi parametrami. |
> | Akcja | Microsoft. AppConfiguration/configurationStores/Write | Utwórz lub zaktualizuj magazyn konfiguracji o określonych parametrach. |
> | Akcja | Microsoft. AppConfiguration/Locations/operationsStatus/Read | Pobierz stan operacji. |
> | Akcja | Microsoft. AppConfiguration/Operations/Read | Wyświetla wszystkie operacje obsługiwane przez konfigurację aplikacji firmy Microsoft. |
> | Akcja | Microsoft. AppConfiguration/Register/Action | Rejestruje subskrypcję do korzystania z konfiguracji aplikacji firmy Microsoft. |
...
> | Akcja | Microsoft. rozliczenia/faktury/pobieranie/akcja | Pobierz fakturę przy użyciu linku pobierania z listy |
> | Akcja | Microsoft. rozliczenia/faktury/odczyt |  |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. BingMaps/listCommunicationPreference/Action | Pobiera Preferencje komunikacji dla właściciela Microsoft. BingMaps |
> | Akcja | Microsoft.BingMaps/mapApis/Delete | Usuwa zasób dla elementu Microsoft. BingMaps/mapApis |
> | Akcja | Microsoft.BingMaps/mapApis/listSecrets/action | Wystaw wpisy tajne dla Microsoft. BingMaps/mapApis |
> | Akcja | Microsoft. BingMaps/mapApis/listUsageMetrics/akcja | Utwórz listę metryk dla Microsoft. BingMaps/mapApis |
> | Akcja | Microsoft.BingMaps/mapApis/Read | Pobiera zasób dla elementu Microsoft. BingMaps/mapApis |
> | Akcja | Microsoft.BingMaps/mapApis/regenerateKey/action | Generuj ponownie klucze dla elementu Microsoft. BingMaps/mapApis |
> | Akcja | Microsoft.BingMaps/mapApis/Write | Aktualizuje zasób dla elementu Microsoft. BingMaps/mapApis |
> | Akcja | Microsoft.BingMaps/Operations/read | Wyświetlanie listy operacji dla Microsoft. BingMaps |
> | Akcja | Microsoft. BingMaps/updateCommunicationPreference/Action | Aktualizuje Preferencje komunikacji dla właściciela Microsoft. BingMaps |
...
> | Akcja | Microsoft. łańcucha bloków/cordaMembers/Delete | Usuwa istniejący łańcucha bloków. |
> | Akcja | Microsoft. łańcucha bloków/cordaMembers/odczyt | Pobiera lub Wyświetla istniejące elementy członkowskie łańcucha bloków. |
> | Akcja | Microsoft. łańcucha bloków/cordaMembers/Write | Tworzy lub aktualizuje członka łańcucha bloków. |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. BotService/botServices/Channels/Delete | Usuwanie kanału usługi bot |
> | Akcja | Microsoft. BotService/botServices/Channels/listchannelwithkeys/Action | Wyświetl listę kanałów Botservice z wpisami tajnymi |
> | Akcja | Microsoft. BotService/botServices/Channels/Read | Odczytaj kanał usługi bot |
> | Akcja | Microsoft. BotService/botServices/Channels/Write | Napisz kanał usługi bot |
> | Akcja | Microsoft. BotService/botServices/Connections/Delete | Usuwanie połączenia usługi bot |
> | Akcja | Microsoft. BotService/botServices/Connections/listwithsecrets/Write | Napisz listę połączeń usługi bot  |
> | Akcja | Microsoft. BotService/botServices/Connections/Read | Odczytaj połączenie usługi bot Service |
> | Akcja | Microsoft. BotService/botServices/Connections/Write | Napisz połączenie usługi bot Service |
...
> | Akcja | Microsoft. BotService/checknameavailability/Action | Sprawdź dostępność nazwy bot |
> | Akcja | Microsoft. BotService/listauthserviceproviders/Action | Wyświetl listę dostawców usługi uwierzytelniania |
...
> | Akcja | Microsoft. Pojemność/reservationorders/mergeoperationresults/odczyt | Sondowanie dowolnej operacji scalania |
...
> | Akcja | Microsoft. Pojemność/reservationorders/splitoperationresults/odczyt | Sondowanie operacji podziału |
...
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/ContentModerator/ProcessText/ekran/akcja | Operacja wykryje braki w ponad 100 językach i dopasowuje je do niestandardowych i udostępnionych zabronionych elementów. |
...
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/CustomVision. przewidywania/projekty/obrazy/pliki/akcja | Ten interfejs API akceptuje partię plików i opcjonalnie Tagi do tworzenia obrazów. Istnieje limit 64 obrazów i 20 tagów. |
...
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/CustomVision. przewidywania/projekty/obrazy/przewidywania/akcja | Ten interfejs API tworzy partię obrazów z określonych zapowiadanych obrazów. Istnieje limit 64 obrazów i 20 tagów. |
...
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/CustomVision. przewidywania/projekty/obrazy/sugerowane/liczba/akcja | Ten interfejs API przyjmuje identyfikatory tagów, aby uzyskać liczbę nieoznakowanych obrazów według sugerowanych tagów dla danego progu. |
...
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/CustomVision. przewidywania/projekty/obrazy/adresy URL/akcja | Ten interfejs API akceptuje wsadowe adresy URL i opcjonalne Tagi do tworzenia obrazów. Istnieje limit 64 obrazów i 20 tagów. |
...
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/Front/migawka/Zastosuj/akcja | Zastosuj migawkę dostarczającą identyfikator obiektu określony przez użytkownika. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/Front/Snapshot/Delete | Usuń migawkę. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/Front/Snapshot/Read | Pobierz stan operacji migawki. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/Front/Snapshot/Take/Action | Utwórz migawkę obiektu. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/Front/Snapshot/Write | Aktualizowanie właściwości migawki. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/Front/snapshots/Read | Wyświetl listę wszystkich dostępnych migawek użytkownika z informacjami. * |
...
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Alters/Read | Pobierz zmiany z środowiska uruchomieniowego. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Alters/Write | Zastąp dane zmian. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/endpointkeys/Read | Pobiera klucze punktów końcowych dla punktu końcowego |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/endpointkeys/refreshkeys/Action | Ponowne generowanie klucza punktu końcowego. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/endpointsettings/Read | Pobiera ustawienia punktu końcowego dla punktu końcowego |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/endpointsettings/Write | Aktualizowanie punktu końcowego seettings dla punktu końcowego. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/Create/Write | Operacja asynchroniczna do utworzenia nowej bazy wiedzy. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/Delete | Usuwa baza danych i wszystkie jej dane. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/Download/Read | Pobierz baza wiedzy. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/generateanswer/Action | GenerateAnswer wywołanie zapytania do bazy wiedzy. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/Publish/Action | Publikuje wszystkie zmiany w indeksie testu bazy wiedzy do jej indeksu produkcyjnego. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/Read | Pobiera listę bazy wiedzy lub szczegóły konkretnej bazy wiedzy. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/pociąg/akcja | Połącz połączenie, aby dodać sugestie do bazy wiedzy. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Knowledge Bases/Write | Operacja asynchroniczna do modyfikowania bazy wiedzy lub zastępowania zawartości bazy wiedzy. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/Operations/Read | Pobiera szczegóły określonej długotrwałej operacji. |
> | Akcja dataaction | Microsoft. CognitiveServices/accounts/QnAMaker/root/Action | QnA Maker |
...
> | Akcja dataaction | Microsoft.CognitiveServices/accounts/TextAnalytics/keyphrases/action | Interfejs API zwraca listę ciągów oznaczających kluczowe punkty w tekście wejściowym. |
> | Akcja dataaction | Microsoft.CognitiveServices/accounts/TextAnalytics/languages/action | Interfejs API zwraca wykryty język i wynik liczbowy z zakresu od 0 do 1. Wyniki zbliżone do 1 wskazują na 100% pewności, że zidentyfikowany język ma wartość true. Obsługiwana jest łączna liczba języków 120. |
...
> | Akcja | Microsoft. CognitiveServices/Locations/operationresults/Read | Odczytaj stan operacji asynchronicznej. |
...
> | Akcja | Microsoft. Commerce/rejestr/akcja | Zarejestruj subskrypcję usługi Microsoft Commerce UsageAggregate |
> | Akcja | Microsoft. Commerce/Wyrejestrowanie/akcja | Wyrejestruj subskrypcję usługi Microsoft Commerce UsageAggregate |
...
> | Akcja | Microsoft. COMPUTE/Galerie/aplikacje/usuwanie | Usuwa aplikację galerii |
> | Akcja | Microsoft. COMPUTE/Galerie/aplikacje/odczyt | Pobiera właściwości aplikacji galerii |
> | Akcja | Microsoft. COMPUTE/Galerie/aplikacje/wersje/Usuń | Usuwa wersję aplikacji galerii |
> | Akcja | Microsoft. COMPUTE/Galerie/aplikacje/wersje/odczyt | Pobiera właściwości wersji aplikacji galerii |
> | Akcja | Microsoft. COMPUTE/Galerie/aplikacje/wersje/zapis | Tworzy nową wersję aplikacji galerii lub aktualizuje istniejącą |
> | Akcja | Microsoft. COMPUTE/Galerie/aplikacje/zapis | Tworzy nową aplikację galerii lub aktualizuje istniejącą |
...
> | Akcja | Microsoft. COMPUTE/Locations/vsmOperations/Read | Pobiera stan operacji asynchronicznej zestawu skalowania maszyn wirtualnych z rozszerzeniem usługi środowiska uruchomieniowego maszyny wirtualnej |
...
> | Akcja | Microsoft. COMPUTE/virtualMachines/assessPatches/akcja | Ocenia maszynę wirtualną i znajduje listę dostępnych dla niej poprawek aktualizacji systemu operacyjnego. |
> | Akcja | Microsoft. COMPUTE/virtualMachines/cancelPatchInstallation/akcja | Anuluje trwającą operację Zainstaluj poprawkę aktualizacji systemu operacyjnego na maszynie wirtualnej. |
...
> | Akcja | Microsoft. COMPUTE/virtualMachines/installPatches/akcja | Instaluje dostępne poprawki aktualizacji systemu operacyjnego na maszynie wirtualnej na podstawie parametrów dostarczonych przez użytkownika. Wyniki oceny zawierające listę dostępnych poprawek zostaną również odświeżone w ramach tego elementu. |
...
> | Akcja | Microsoft. COMPUTE/virtualMachineScaleSets/rozszerzenia/role/odczyt | Pobiera właściwości roli w zestawie skalowania maszyn wirtualnych z rozszerzeniem usługi środowiska uruchomieniowego maszyny wirtualnej |
> | Akcja | Microsoft. COMPUTE/virtualMachineScaleSets/Extensions/role/Write | Aktualizuje właściwości istniejącej roli w zestawie skalowania maszyn wirtualnych przy użyciu rozszerzenia usługi środowiska uruchomieniowego maszyny wirtualnej |
...
> | Akcja | Microsoft. COMPUTE/virtualMachineScaleSets/rollingUpgrades/akcja | Anuluje stopniowe uaktualnianie zestawu skalowania maszyn wirtualnych |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. zużycie/aggregatedcost/odczyt | Utwórz listę AggregatedCost dla grupy zarządzania. |
...
> | Akcja | Microsoft. zużycie/externalBillingAccounts/Tagi/odczyt | Lista tagów dla umów EA i Subscriptions. |
> | Akcja | Microsoft. zużycie/externalSubscriptions/Tagi/odczyt | Lista tagów dla umów EA i Subscriptions. |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. ContainerInstance/containerGroups/Containers/buildlogs/Read | Pobierz dzienniki kompilacji dla określonego kontenera. |
...
> | Akcja | Microsoft. ContainerRegistry/rejestry/generateCredentials/akcja | Generuj klucze dla tokenu określonego rejestru kontenerów. |
...
> | Akcja | Microsoft. ContainerRegistry/rejestry/privateEndpointConnectionProxies/usuwanie | Usuń serwer proxy połączenia prywatnego punktu końcowego (tylko dostawca NRP) |
> | Akcja | Microsoft. ContainerRegistry/rejestry/privateEndpointConnectionProxies/operationStatuses/odczyt | Pobieranie stanu operacji asynchronicznej serwera proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. ContainerRegistry/rejestry/privateEndpointConnectionProxies/odczyt | Pobierz serwer proxy połączenia prywatnego punktu końcowego (tylko dostawca NRP) |
> | Akcja | Microsoft. ContainerRegistry/rejestry/privateEndpointConnectionProxies/weryfikacja/akcja | Sprawdź poprawność serwera proxy połączenia prywatnego punktu końcowego (tylko NRP) |
> | Akcja | Microsoft. ContainerRegistry/rejestry/privateEndpointConnectionProxies/zapis | Tworzenie prywatnego serwera proxy połączenia punktu końcowego (tylko dostawca NRP) |
...
> | Akcja | Microsoft. ContainerRegistry/kancelarie/Kwarantanna/odczyt | Ściąganie lub pobieranie obrazów z kwarantanny z rejestru kontenerów |
> | Akcja | Microsoft. ContainerRegistry/kancelarie/Kwarantanna/zapis | Zapisywanie/modyfikowanie stanu kwarantanny obrazów z kwarantanny |
...
> | Akcja | Microsoft. ContainerRegistry/rejestry/scopeMaps/usuwanie | Usuwa mapę zakresu z rejestru kontenerów. |
...
> | Akcja | Microsoft. ContainerRegistry/rejestry/scopeMaps/odczyt | Pobiera właściwości określonej mapy zakresu lub wyświetla wszystkie mapy zakresu dla określonego rejestru kontenerów. |
> | Akcja | Microsoft. ContainerRegistry/rejestry/scopeMaps/zapis | Tworzy lub aktualizuje mapę zakresu dla rejestru kontenerów o określonych parametrach. |
...
> | Akcja | Microsoft. ContainerRegistry/rejestry/tokeny/usuwanie | Usuwa token z rejestru kontenerów. |
> | Akcja | Microsoft. ContainerRegistry/rejestry/tokeny/operationStatuses/odczyt | Pobiera stan operacji asynchronicznej tokenu. |
> | Akcja | Microsoft. ContainerRegistry/rejestry/tokeny/odczyt | Pobiera właściwości określonego tokenu lub wyświetla wszystkie tokeny dla określonego rejestru kontenerów. |
> | Akcja | Microsoft. ContainerRegistry/rejestry/tokeny/zapis | Tworzy lub aktualizuje token dla rejestru kontenerów o określonych parametrach. |
...
> | Akcja | Microsoft. ContainerService/managedClusters/availableAgentPoolVersions/Read | Pobiera dostępne wersje puli agentów klastra |
...
> | Akcja | Microsoft. ContainerService/managedClusters/listClusterMonitoringUserCredential/akcja | Wyświetlanie clusterMonitoringUser poświadczenia zarządzanego klastra |
...
> | Akcja | Microsoft. ContainerService/managedClusters/rotateClusterCertificates/akcja | Obracanie certyfikatów zarządzanego klastra |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. CostManagement/alerty/zapis | Aktualizowanie alertów. |
...
> | Akcja | Microsoft. CostManagement/externalBillingAccounts/Dimensions/Read | Wyświetl listę wszystkich obsługiwanych wymiarów dla zewnętrznego BillingAccounts. |
...
> | Akcja | Microsoft. CostManagement/externalBillingAccounts/Prognoza/akcja | Prognozowanie danych użycia dla zewnętrznego BillingAccounts. |
> | Akcja | Microsoft. CostManagement/externalBillingAccounts/Prognoza/odczyt | Prognozowanie danych użycia dla zewnętrznego BillingAccounts. |
> | Akcja | Microsoft. CostManagement/externalBillingAccounts/kwerenda/akcja | Wykonywanie zapytań dotyczących danych użycia dla zewnętrznego BillingAccounts. |
> | Akcja | Microsoft. CostManagement/externalBillingAccounts/Query/Read | Wykonywanie zapytań dotyczących danych użycia dla zewnętrznego BillingAccounts. |
...
> | Akcja | Microsoft. CostManagement/externalSubscriptions/Dimensions/Read | Wyświetl listę wszystkich obsługiwanych wymiarów dla zewnętrznej subskrypcji. |
> | Akcja | Microsoft. CostManagement/externalSubscriptions/Prognoza/akcja | Prognozowanie danych użycia dla zewnętrznego BillingAccounts. |
...
> | Akcja | Microsoft. CostManagement/externalSubscriptions/kwerenda/akcja | Wykonywanie zapytań dotyczących danych użycia dla zewnętrznej subskrypcji. |
...
> | Akcja | Microsoft. CostManagement/Prognoza/akcja | Prognozowanie danych użycia według zakresu. |
...
> | Akcja | Microsoft. CostManagement/widoki/akcja | Utwórz widok. |
> | Akcja | Microsoft. CostManagement/widoki/usuwanie | Usuń zapisane widoki. |
> | Akcja | Microsoft. CostManagement/widoki/odczyt | Wyświetl listę wszystkich zapisanych widoków. |
> | Akcja | Microsoft. CostManagement/widoki/zapis | Aktualizuj widok. |
...
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/kontenery/usuwanie | Usuwa kontenery |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/kontenery/operationResults/Read | Wyświetla lub pobiera wynik operacji |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/kontenery/odczyt | Wyświetla lub pobiera kontenery |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/kontenery/odświeżanie/akcja | Odśwież metadane kontenera przy użyciu danych z chmury |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/kontenery/zapis | Tworzy lub aktualizuje kontenery |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Delete | Usuwa konta magazynu |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/operationResults/Read | Wyświetla lub pobiera wynik operacji |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Read | Wyświetla lub pobiera konta magazynu |
> | Akcja | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Write | Tworzy lub aktualizuje konta magazynu |
...
> | Akcja | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Tworzy lub aktualizuje urządzenia Data Box Edge |
> | Akcja | Microsoft. DataBoxEdge/jednostki SKU/odczyt | Wyświetla lub pobiera jednostki SKU |
...
> | Akcja | Microsoft. datakosteks/Locations/operationstatuses/Read | Odczytuje stan operacji dla zasobu. |
> | Akcja | Microsoft. datakosteks/Operations/Read | Pobiera listę operacji. |
...
> | Akcja | Microsoft. datacegły/obszary robocze/storageEncryption/Usuń | Wyłącza szyfrowanie klucza zarządzanego przez klienta na zarządzanym koncie magazynu obszaru roboczego datakostki |
> | Akcja | Microsoft. datacegły/obszary robocze/storageEncryption/Write | Włącza szyfrowanie klucza zarządzanego przez klienta na zarządzanym koncie magazynu obszaru roboczego datakostki |
...
> | Akcja | Microsoft. datacegły/obszary robocze/virtualNetworkPeerings/Usuń | Usuwa komunikację równorzędną sieci wirtualnej |
> | Akcja | Microsoft. datacegły/obszary robocze/virtualNetworkPeerings/odczyt | Pobiera komunikację równorzędną sieci wirtualnej. |
> | Akcja | Microsoft. datacegły/obszary robocze/virtualNetworkPeerings/Write | Dodawanie lub modyfikowanie komunikacji równorzędnej sieci wirtualnej |
...
> | Akcja | Microsoft. DataFactory/Factors/addDataFlowToDebugSession/Action | Dodaj przepływ danych do sesji debugowania na potrzeby wersji zapoznawczej. |
...
> | Akcja | Microsoft. DataFactory/Factors/executeDataFlowDebugCommand/Action | Polecenie wykonania debugowania przepływu danych. |
...
> | Akcja | Microsoft. DataFactory/Factors/operationResults/Read | Pobiera wyniki operacji. |
...
> | Akcja | Microsoft. DataFactory/Factors/querydataflowdebugsessions/Action | Wysyła zapytanie do sesji debugowania przepływu danych. |
...
> | Akcja | Microsoft. DataFactory/Factors/querytriggers/Action | Bada wyzwalacze. |
> | Akcja | Microsoft.DataFactory/factories/read | Odczytuje Data Factory. |
> | Akcja | Microsoft. DataFactory/Factors/sandboxpipelineruns/Action | Wysyła zapytanie do przebiegów potoku debugowania. |
> | Akcja | Microsoft. DataFactory/Factors/sandboxpipelineruns/Read | Pobiera informacje o uruchamianiu debugowania dla potoku. |
...
> | Akcja | Microsoft. DataFactory/fabryki/wyzwalacze/geteventsubscriptionstatus/akcja | Stan subskrypcji zdarzenia. |
...
> | Akcja | Microsoft. DataFactory/fabryki/wyzwalacze/SubscribeToEvents/akcja | Subskrybuj zdarzenia. |
> | Akcja | Microsoft. DataFactory/Factors/Triggers/triggerruns/Read | Odczytuje uruchomienia wyzwalacza. |
> | Akcja | Microsoft. DataFactory/fabryki/wyzwalacze/UnsubscribeFromEvents/akcja | Anuluj subskrypcję zdarzeń. |
...
> | Akcja | Microsoft. datamigration/Services/getHybridDownloadLink/Action | Pobiera link pobierania pakietu roboczego DMS z Blob Storage RP. |
...
> | Akcja | Microsoft. DBforMariaDB/Locations/privateEndpointConnectionAzureAsyncOperation/Read | Pobiera wynik operacji połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMariaDB/Locations/privateEndpointConnectionOperationResults/Read | Pobiera wynik operacji połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMariaDB/Locations/privateEndpointConnectionProxyAzureAsyncOperation/Read | Pobiera wynik operacji serwera proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMariaDB/Locations/privateEndpointConnectionProxyOperationResults/Read | Pobiera wynik operacji serwera proxy połączenia prywatnego punktu końcowego |
...
> | Akcja | Microsoft. DBforMariaDB/Locations/serverKeyAzureAsyncOperation/Read | Pobiera operacje w toku dla kluczy serwera przezroczystego szyfrowania danych |
> | Akcja | Microsoft. DBforMariaDB/Locations/serverKeyOperationResults/Read | Pobiera operacje w toku dla kluczy serwera przezroczystego szyfrowania danych |
...
> | Akcja | Microsoft. DBforMariaDB/serwery/klucze/usuwanie | Usuwa istniejący klucz serwera. |
> | Akcja | Microsoft. DBforMariaDB/serwery/klucze/odczyt | Zwróć listę kluczy serwera lub pobiera właściwości dla określonego klucza serwera. |
> | Akcja | Microsoft. DBforMariaDB/serwery/klucze/zapis | Tworzy klucz z określonymi parametrami lub aktualizuje właściwości lub Tagi dla określonego klucza serwera. |
> | Akcja | Microsoft.DBforMariaDB/servers/logFiles/read | Zwróć listę plików dziennika MariaDB. |
> | Akcja | Microsoft. DBforMariaDB/serwery/privateEndpointConnectionProxies/usuwanie | Usuwa istniejący serwer proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMariaDB/serwery/privateEndpointConnectionProxies/odczyt | Zwraca listę proxy połączeń prywatnych punktów końcowych lub pobiera właściwości dla określonego serwera proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. DBforMariaDB/Servers/privateEndpointConnectionProxies/Validate/Action | Sprawdza poprawność wywołania połączenia z prywatnym punktem końcowym po stronie NRP |
> | Akcja | Microsoft. DBforMariaDB/serwery/privateEndpointConnectionProxies/zapis | Tworzy prywatny serwer proxy połączenia z określonymi parametrami lub aktualizuje właściwości lub Tagi dla określonego serwera proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. DBforMariaDB/serwery/privateEndpointConnections/usuwanie | Usuwa istniejące połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMariaDB/serwery/privateEndpointConnections/odczyt | Zwraca listę połączeń prywatnych punktów końcowych lub pobiera właściwości dla określonego połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. DBforMariaDB/serwery/privateEndpointConnections/zapis | Zatwierdza lub odrzuca istniejące połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMariaDB/serwery/privateLinkResources/odczyt | Pobierz zasoby linku prywatnego dla odpowiedniego serwera MariaDB |
...
> | Akcja | Microsoft. DBforMySQL/Locations/privateEndpointConnectionAzureAsyncOperation/Read | Pobiera wynik operacji połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMySQL/Locations/privateEndpointConnectionOperationResults/Read | Pobiera wynik operacji połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMySQL/Locations/privateEndpointConnectionProxyAzureAsyncOperation/Read | Pobiera wynik operacji serwera proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMySQL/Locations/privateEndpointConnectionProxyOperationResults/Read | Pobiera wynik operacji serwera proxy połączenia prywatnego punktu końcowego |
...
> | Akcja | Microsoft. DBforMySQL/Locations/serverKeyAzureAsyncOperation/Read | Pobiera operacje w toku dla kluczy serwera przezroczystego szyfrowania danych |
> | Akcja | Microsoft. DBforMySQL/Locations/serverKeyOperationResults/Read | Pobiera operacje w toku dla kluczy serwera przezroczystego szyfrowania danych |
...
> | Akcja | Microsoft. DBforMySQL/serwery/klucze/usuwanie | Usuwa istniejący klucz serwera. |
> | Akcja | Microsoft. DBforMySQL/serwery/klucze/odczyt | Zwróć listę kluczy serwera lub pobiera właściwości dla określonego klucza serwera. |
> | Akcja | Microsoft. DBforMySQL/serwery/klucze/zapis | Tworzy klucz z określonymi parametrami lub aktualizuje właściwości lub Tagi dla określonego klucza serwera. |
> | Akcja | Microsoft.DBforMySQL/servers/logFiles/read | Zwróć listę plików dziennika programu MySQL. |
> | Akcja | Microsoft. DBforMySQL/serwery/privateEndpointConnectionProxies/usuwanie | Usuwa istniejący serwer proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMySQL/serwery/privateEndpointConnectionProxies/odczyt | Zwraca listę proxy połączeń prywatnych punktów końcowych lub pobiera właściwości dla określonego serwera proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. DBforMySQL/Servers/privateEndpointConnectionProxies/Validate/Action | Sprawdza poprawność wywołania połączenia z prywatnym punktem końcowym po stronie NRP |
> | Akcja | Microsoft. DBforMySQL/serwery/privateEndpointConnectionProxies/zapis | Tworzy prywatny serwer proxy połączenia z określonymi parametrami lub aktualizuje właściwości lub Tagi dla określonego serwera proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. DBforMySQL/serwery/privateEndpointConnections/usuwanie | Usuwa istniejące połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMySQL/serwery/privateEndpointConnections/odczyt | Zwraca listę połączeń prywatnych punktów końcowych lub pobiera właściwości dla określonego połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. DBforMySQL/serwery/privateEndpointConnections/zapis | Zatwierdza lub odrzuca istniejące połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. DBforMySQL/serwery/privateLinkResources/odczyt | Pobierz zasoby linku prywatnego dla odpowiedniego serwera MySQL |
...
> | Akcja | Microsoft. DBforPostgreSQL/Locations/serverKeyAzureAsyncOperation/Read | Pobiera operacje w toku dla kluczy serwera przezroczystego szyfrowania danych |
> | Akcja | Microsoft. DBforPostgreSQL/Locations/serverKeyOperationResults/Read | Pobiera operacje w toku dla kluczy serwera przezroczystego szyfrowania danych |
...
> | Akcja | Microsoft. DBforPostgreSQL/serwery/klucze/usuwanie | Usuwa istniejący klucz serwera. |
> | Akcja | Microsoft. DBforPostgreSQL/serwery/klucze/odczyt | Zwróć listę kluczy serwera lub pobiera właściwości dla określonego klucza serwera. |
> | Akcja | Microsoft. DBforPostgreSQL/serwery/klucze/zapis | Tworzy klucz z określonymi parametrami lub aktualizuje właściwości lub Tagi dla określonego klucza serwera. |
...
> | Akcja | Microsoft. Devices/elasticPools/eventGridFilters/Delete | Usuwa filtr Event Grid Pula elastyczna |
> | Akcja | Microsoft. Devices/elasticPools/eventGridFilters/odczyt | Pobiera Filtr Event Grid Pula elastyczna |
> | Akcja | Microsoft. Devices/elasticPools/eventGridFilters/Write | Utwórz nowy lub zaktualizuj istniejący filtr Event Grid Pula elastyczna |
...
> | Akcja | Microsoft. Devices/elasticPools/iotHubTenants/securitySettings/operationResults/Read | Pobierz wynik operacji asynchronicznego Put dla usługi IoT dzierżawca SecuritySettings |
> | Akcja | Microsoft. Devices/elasticPools/iotHubTenants/securitySettings/Read | Pobieranie ustawień Azure Security Center w usłudze IoT dzierżawcy |
> | Akcja | Microsoft. Devices/elasticPools/iotHubTenants/securitySettings/Write | Aktualizowanie ustawień Azure Security Center w usłudze centrum dzierżaw IoT |
...
> | Akcja | Microsoft. Devices/iotHubs/securitySettings/operationResults/Read | Pobieranie wyniku asynchronicznej operacji Put dla usługi IoT Hub SecuritySettings |
> | Akcja | Microsoft. Devices/iotHubs/securitySettings/odczyt | Pobieranie ustawień Azure Security Center w usłudze IoT Hub |
> | Akcja | Microsoft. Devices/iotHubs/securitySettings/Write | Aktualizowanie ustawień Azure Security Center w usłudze IoT Hub |
...
> | Akcja | Microsoft. DevSpaces/Locations/checkContainerHostMapping/Read | Sprawdź istniejące mapowanie kontrolera dla hosta kontenera |
...
> | Akcja | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | Generuje szablon Azure Resource Manager dla danego artefaktu, przekazuje wymagane pliki na konto magazynu i sprawdza poprawność wygenerowanego artefaktu. |
...
> | Akcja | Microsoft. wspólny/Labs/virtualMachines/ClearArtifactResults/Action | Czyści wyniki artefaktu maszyny wirtualnej. |
...
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Delete | Usuń przestrzeń kluczy Cassandra. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Read | Odczytaj Cassandra przestrzeń kluczy lub Wyświetl wszystkie Cassandrae przestrzenie kluczy. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/tabele/usuwanie | Usuń tabelę Cassandra. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/tabele/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/tabele/odczyt | Odczytaj tabelę Cassandra lub listę wszystkich tabel Cassandra. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/tabele/throughputSettings/operationResults/odczyt | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/tabele/throughputSettings/Read | Odczytaj Cassandraą przepływność tabeli. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/tabele/throughputSettings/Write | Aktualizowanie przepływności tabeli Cassandra. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/tabele/zapis | Utwórz lub zaktualizuj tabelę Cassandra. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/Read | Odczytaj Cassandraą przepływność przestrzeni kluczy. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/Write | Zaktualizuj przepływność przestrzeni kluczy Cassandra. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Write | Utwórz przestrzeń kluczy Cassandra. |
...
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Delete | Usuń bazę danych Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/wykresy/usuwanie | Usuwanie grafu Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Grafs/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/wykresy/odczyt | Odczytaj Gremlin Graph lub Wyświetl wszystkie wykresy Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Grafs/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Grafs/throughputSettings/Read | Odczytaj przepływność grafu Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/wykresy/throughputSettings/Write | Aktualizowanie przepływności grafu Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/wykresy/zapis | Utwórz lub zaktualizuj Graf Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Read | Odczytaj bazę danych Gremlin lub Wyświetl listę wszystkich baz danych Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/Read | Odczytaj przepływność bazy danych Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/Write | Aktualizowanie przepływności bazy danych Gremlin. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Write | Utwórz bazę danych Gremlin. |
...
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/kolekcje/usuwanie | Usuń kolekcję MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/Read | Odczytaj kolekcję MongoDB lub Wyświetl listę wszystkich kolekcji MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/throughputSettings/Read | Odczytaj przepływność kolekcji MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/throughputSettings/Write | Aktualizowanie przepływności kolekcji MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/Write | Utwórz lub zaktualizuj kolekcję MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Delete | Usuń bazę danych MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Read | Odczytaj bazę danych MongoDB lub Wyświetl listę wszystkich baz danych MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/Read | Odczytaj przepływność bazy danych MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/Write | Aktualizowanie przepływności bazy danych MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Write | Utwórz bazę danych MongoDB. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/Delete | Usuwanie obszaru roboczego notesu |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/listConnectionInfo/Action | Wyświetlanie informacji o połączeniu dla obszaru roboczego notesu |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/operationResults/Read | Odczytywanie stanu operacji asynchronicznej w obszarach roboczych notesu |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/Read | Odczytywanie obszaru roboczego notesu |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/Write | Utwórz lub zaktualizuj obszar roboczy notesu |
...
> | Akcja | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/operationResults/read | Odczyt stanu operacji asynchronicznej serwera proxy połączenia prywatnego punktu końcowego |
...
> | Akcja | Microsoft. DocumentDB/databaseAccounts/privateEndpointConnections/Delete | Usuwanie połączenia prywatnego punktu końcowego konta bazy danych |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/privateEndpointConnections/operationResults/Read | Odczytaj stan operacji asynchronicznej privateEndpointConnenctions |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/privateEndpointConnections/Read | Odczytaj połączenie prywatnego punktu końcowego lub Wyświetl listę wszystkich połączeń prywatnych punktów końcowych konta bazy danych |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/privateEndpointConnections/Write | Utwórz lub zaktualizuj połączenie prywatnego punktu końcowego konta bazy danych |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/privateLinkResources/Read | Odczytaj zasób link prywatny lub Wyświetl listę wszystkich prywatnych zasobów linku konta bazy danych |
...
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/Delete | Usuń kontener SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/Read | Odczytaj kontener SQL lub listę wszystkich kontenerów SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/storedProcedures/Delete | Usuń procedurę składowaną SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/storedProcedures/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/storedProcedures/Read | Przeczytaj procedurę składowaną SQL lub listę wszystkich procedur przechowywanych w programie SQL Server. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/storedProcedures/Write | Utwórz lub zaktualizuj procedurę składowaną SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/throughputSettings/Read | Odczytaj przepływność kontenera SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/throughputSettings/Write | Zaktualizuj przepływność kontenera SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/Triggers/Delete | Usuwanie wyzwalacza SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/Triggers/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/Triggers/Read | Odczytaj wyzwalacz SQL lub Wyświetl listę wszystkich wyzwalaczy SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/Triggers/Write | Utwórz lub zaktualizuj wyzwalacz SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/userDefinedFunctions/Delete | Usuwanie funkcji zdefiniowanej przez użytkownika SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/userDefinedFunctions/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/userDefinedFunctions/Read | Odczytaj funkcję zdefiniowaną przez użytkownika SQL lub listę wszystkich funkcji zdefiniowanych przez użytkownika SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/userDefinedFunctions/Write | Utwórz lub zaktualizuj funkcję zdefiniowaną przez użytkownika SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Containers/Write | Utwórz lub zaktualizuj kontener SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Delete | Usuwanie bazy danych SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Read | Odczytaj bazę danych SQL lub listę wszystkich baz danych SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/throughputSettings/Read | Odczytaj przepływność bazy danych SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/throughputSettings/Write | Aktualizowanie przepływności bazy danych SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/sqldatabases/Write | Utwórz bazę danych SQL. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/tabele/usuwanie | Usuń tabelę. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/tabele/operationResults/odczyt | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/tabele/odczyt | Odczytaj tabelę lub listę wszystkich tabel. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/Tables/throughputSettings/operationResults/Read | Stan odczytu operacji asynchronicznej. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/tabele/throughputSettings/odczyt | Odczytaj tabelę przepływność. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/Tables/throughputSettings/Write | Aktualizowanie przepływności tabeli. |
> | Akcja | Microsoft. DocumentDB/databaseAccounts/tabele/zapis | Utwórz lub zaktualizuj tabelę. |
...
> | Akcja | Microsoft. EventHub/klastry/przestrzenie nazw/odczyt | Wyświetl listę identyfikatorów Azure Resource Manager nazw dla przestrzeni nazw w klastrze. |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. HybridCompute/Locations/operationresults/Read | Odczytuje stan operacji dotyczącej dostawcy zasobów Microsoft. HybridCompute |
> | Akcja | Microsoft. HybridCompute/Machines/Delete | Usuwa maszyny usługi Azure Arc |
> | Akcja | Microsoft. HybridCompute/Machines/Extensions/Delete | Usuwa rozszerzenia usługi Azure Arc |
> | Akcja | Microsoft. HybridCompute/Machines/Extensions/Read | Odczytuje wszystkie rozszerzenia usługi Azure Arc |
> | Akcja | Microsoft. HybridCompute/komputery/rozszerzenia/zapis | Instaluje lub aktualizuje rozszerzenia usługi Azure Arc |
> | Akcja | Microsoft. HybridCompute/Machines/Read | Odczytaj wszystkie maszyny usługi Azure Arc |
> | Akcja | Microsoft. HybridCompute/Machines/reconnect/Action | Ponownie nawiązuje połączenie z maszynami usługi Azure Arc |
> | Akcja | Microsoft. HybridCompute/Machines/Write | Zapisuje maszyny usługi Azure Arc |
> | Akcja | Microsoft. HybridCompute/Operations/Read | Odczytaj wszystkie operacje dotyczące usługi Azure ARC dla serwerów |
> | Akcja | Microsoft. HybridCompute/Register/Action | Rejestruje subskrypcję dostawcy zasobów Microsoft. HybridCompute |
> | Akcja | Microsoft. HybridCompute/Unregister/Action | Wyrejestrowuje subskrypcję dla dostawcy zasobów Microsoft. HybridCompute |
...
> | Akcja | Microsoft. Insights/Components/Providers/Microsoft. Insights/diagnosticSettings/Read | Odczytaj ustawienie diagnostyczne zasobu |
> | Akcja | Microsoft. Insights/Components/Providers/Microsoft. Insights/diagnosticSettings/Write | Utwórz lub zaktualizuj ustawienie diagnostyczne zasobu |
> | Akcja | Microsoft. Insights/Components/Providers/Microsoft. Insights/logDefinitions/Read | Odczytaj definicje dzienników |
...
> | Akcja | Microsoft. Insights/DataCollectionRuleAssociations/Delete | Usuwanie skojarzenia zasobu z regułą zbierania danych |
> | Akcja | Microsoft. Insights/DataCollectionRuleAssociations/Read | Odczytaj skojarzenie zasobu z regułą zbierania danych |
> | Akcja | Microsoft. Insights/DataCollectionRuleAssociations/Write | Utwórz lub zaktualizuj skojarzenie zasobu z regułą zbierania danych |
> | Akcja dataaction | Microsoft. Insights/DataCollectionRules/Data/zapis | Wysyłanie danych do reguły zbierania danych |
> | Akcja | Microsoft. Insights/DataCollectionRules/Delete | Usuwanie reguły zbierania danych |
> | Akcja | Microsoft. Insights/DataCollectionRules/Read | Odczytaj regułę zbierania danych |
> | Akcja | Microsoft. Insights/DataCollectionRules/Write | Utwórz lub zaktualizuj regułę zbierania danych |
...
> | Akcja | Microsoft. Insights/webskoroszyts/Write | Utwórz lub zaktualizuj skoroszyt prywatny |
> | Akcja | Microsoft. Insights/Operations/Read | Operacje odczytu |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/Delete | Usuń prywatny zakres linków |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Delete | Usuwanie serwera proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Read | Odczytaj prywatny serwer proxy połączenia |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Validate/Action | Weryfikowanie prywatnego serwera proxy połączenia punktu końcowego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Write | Utwórz lub zaktualizuj serwer proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnections/Delete | Usuwanie połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnections/Read | Odczytaj połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnections/Write | Utwórz lub zaktualizuj połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/PrivateLinkResources/Read | Odczytaj zasób łącza prywatnego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/Read | Odczytaj prywatny zakres linków |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/ScopedResources/Delete | Usuwanie zasobu w zakresie linku prywatnego |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/ScopedResources/Read | Odczytaj zasób z zakresem prywatnego linku |
> | Akcja | Microsoft. Insights/PrivateLinkScopes/ScopedResources/Write | Utwórz lub zaktualizuj zasób z określonym zakresem linku prywatnego |
...
> | Akcja dataaction | Microsoft./magazyny/magazynu/certificatecas/usuwanie | Usuwanie certyfikatu issuseer |
> | Akcja dataaction | Microsoft./magazyny/magazynu/certificatecas/odczyt | Odczytaj certyfikat issuseer |
> | Akcja dataaction | Microsoft./magazyny kluczy/magazynu/certificatecas/zapis | Zapisz certyfikat issuseer |
> | Akcja dataaction | Microsoft./magazyny kluczy/magazynu/certificatecontacts/zapis | Zarządzanie kontaktem z certyfikatem |
> | Akcja dataaction | Microsoft./magazyny/magazynu/Certyfikaty/kopie zapasowe/akcja | Utwórz plik kopii zapasowej certyfikatu. Plik może służyć do przywrócenia certyfikatu w Key Vault tej samej subskrypcji. Mogą być stosowane ograniczenia. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/Certyfikaty/tworzenie/akcja | Tworzy nowy certyfikat. |
> | Akcja dataaction | Microsoft./magazyny kluczy/magazynu/Certyfikaty/usuwanie | Usuń certyfikat. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/Certyfikaty/import/akcja | Importuje istniejący prawidłowy certyfikat zawierający klucz prywatny do Azure Key Vault. Certyfikat do zaimportowania może być w formacie PFX lub PEM. |
> | Akcja dataaction | Microsoft.//magazyny/magazynu/Certyfikaty/Przeczyść/akcja | Przeczyszcza certyfikat, uniemożliwiając jego odzyskanie. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/Certyfikaty/Odczytaj | Wyświetl listę certyfikatów w określonym magazynie kluczy lub Uzyskaj informacje o certyfikacie. |
> | Akcja dataaction | Microsoft./magazyny kluczy/magazynu/Certyfikaty/odzyskiwanie/akcja | Odzyskuje usunięty certyfikat. Operacja wykonuje cofnięcie operacji usuwania. Operacja jest stosowana w magazynach włączonych do usuwania nietrwałego i musi zostać wystawiona w czasie trwania okresu przechowywania. |
> | Akcja dataaction | Microsoft./magazyny kluczy/magazynu/Certyfikaty/przywracanie/akcja | Przywraca kopię zapasową certyfikatu i wszystkie jego wersje do magazynu. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/Certyfikaty/aktualizacje/akcja | Aktualizuje określone atrybuty skojarzone z danym certyfikatem. |
...
> | Akcja dataaction | Microsoft.//magazyny/magazynu/klucze/kopia zapasowa/akcja | Utwórz plik kopii zapasowej klucza. Plik może zostać użyty do przywrócenia klucza w Key Vault tej samej subskrypcji. Mogą być stosowane ograniczenia. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/tworzenie/akcja | Tworzy nowy klucz. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/odszyfrowywanie/akcja | Odszyfruj tekst szyfrowany przy użyciu klucza. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/klucze/usuwanie | Usuń klucz. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/szyfrowanie/akcja | Szyfruj zwykły tekst za pomocą klucza. Należy pamiętać, że jeśli klucz jest asymetryczny, ta operacja może być wykonywana przez podmioty zabezpieczeń z dostępem do odczytu. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/import/akcja | Importuje klucz utworzony zewnętrznie, zapisuje go i zwraca parametry klucza i atrybuty do klienta. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/Przeczyść/akcja | Przeczyszcza klucz, uniemożliwiając jego odzyskanie. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/klucze/odczyt | Wyświetl listę kluczy w określonym magazynie lub Odczytaj właściwości i materiał publiczny klucza.<br>W przypadku kluczy asymetrycznych ta operacja ujawnia klucz publiczny i obejmuje możliwość wykonywania algorytmów kluczy publicznych, takich jak szyfrowanie i Weryfikowanie podpisu.<br>Klucze prywatne i klucze symetryczne nigdy nie są ujawniane. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/odzyskiwanie/akcja | Odzyskuje usunięty klucz. Operacja wykonuje cofnięcie operacji usuwania. Operacja jest stosowana w magazynach włączonych do usuwania nietrwałego i musi zostać wystawiona w czasie trwania okresu przechowywania. |
> | Akcja dataaction | Microsoft.//magazyny/magazynu/klucze/przywracanie/akcja | Przywraca klucz kopii zapasowej i wszystkie jego wersje do magazynu. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/akcja | Podpisz skrót przy użyciu klucza. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/odpakowywanie/akcja | Odpakuj klucz symetryczny z kluczem Key Vault. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/aktualizacje/akcja | Aktualizuje określone atrybuty skojarzone z danym kluczem. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/weryfikacja/akcja | Sprawdź skrót. Należy pamiętać, że jeśli klucz jest asymetryczny, ta operacja może być wykonywana przez podmioty zabezpieczeń z dostępem do odczytu. |
> | Akcja dataaction | Microsoft. Keys/magazyny/klucze/Zawijanie/akcja | Zawiń klucz symetryczny z kluczem Key Vault. Należy pamiętać, że jeśli klucz Key Vault jest asymetryczny, tę operację można wykonać z dostępem do odczytu. |
> | Akcja | Microsoft.KeyVault/vaults/read | Wyświetlanie właściwości magazynu kluczy |
> | Akcja dataaction | Microsoft./magazyny/magazynu/wpisy tajne/tworzenie kopii zapasowej/akcja | Utwórz plik kopii zapasowej klucza tajnego. Plik może zostać użyty do przywrócenia klucza tajnego w Key Vault tej samej subskrypcji. Mogą być stosowane ograniczenia. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/wpisy tajne/usuwanie | Usuń wpis tajny. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/wpisy tajne/getsecret/Action | Pobierz wartość wpisu tajnego. |
> | Akcja dataaction | Microsoft.//magazyny/magazynu/wpisy tajne/akcja | Przeczyszcza wpis tajny, uniemożliwiając jego odzyskanie. |
> | Akcja | Microsoft.KeyVault/vaults/secrets/read | Wyświetl właściwości wpisu tajnego, ale nie jego wartość. |
> | Akcja dataaction | Microsoft.//magazyny/magazynu/wpisy tajne/readMetadata/akcja | Wyświetlaj listę lub Wyświetl właściwości wpisu tajnego, ale nie jego wartość. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/wpisy tajne/odzyskiwanie/akcja | Odzyskiwanie usuniętego klucza tajnego. Operacja wykonuje cofnięcie operacji usuwania. Operacja jest stosowana w magazynach włączonych do usuwania nietrwałego i musi zostać wystawiona w czasie trwania okresu przechowywania. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/wpisy tajne/przywracanie/akcja | Przywraca kopię zapasową wpisu tajnego oraz wszystkie jego wersje do magazynu. |
> | Akcja dataaction | Microsoft., magazyn/magazyny/wpisy tajne/niejawne/akcja | Utwórz nowy wpis tajny. |
> | Akcja dataaction | Microsoft./magazyny/magazynu/wpisy tajne/aktualizacja/akcja | Aktualizuje określone atrybuty skojarzone z danym wpisem tajnym. |
...
> | Akcja | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/delete | Usuwa dołączony zasób konfiguracji bazy danych. |
> | Akcja | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/read | Odczytuje zasób konfiguracji dołączonej bazy danych. |
> | Akcja | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/write | Zapisuje dołączony zasób konfiguracji bazy danych. |
...
> | Akcja | Microsoft.Kusto/Clusters/Databases/DataConnections/write | Zapisuje zasób połączenia danych. |
...
> | Akcja | Microsoft. Kusto/klastry/bazy danych/EventHubConnections/usuwanie | Usuwa zasób połączenia centrum zdarzeń. |
> | Akcja | Microsoft. Kusto/klastry/bazy danych/EventHubConnections/odczyt | Odczytuje zasób połączeń centrum zdarzeń. |
> | Akcja | Microsoft. Kusto/klastry/bazy danych/EventHubConnections/zapis | Zapisuje zasób połączenia centrum zdarzeń. |
...
> | Akcja | Microsoft. Kusto/klastry/bazy danych/PrincipalAssignments/usuwanie | Usuwa zasób przydziałów głównych baz danych. |
> | Akcja | Microsoft. Kusto/klastry/bazy danych/PrincipalAssignments/odczyt | Odczytuje zasób głównych przydziałów bazy danych. |
> | Akcja | Microsoft. Kusto/klastry/bazy danych/PrincipalAssignments/zapis | Zapisuje zasób z przydziałami głównych baz danych. |
> | Akcja | Microsoft.Kusto/Clusters/Databases/read | Odczytuje zasób bazy danych. |
> | Akcja | Microsoft.Kusto/Clusters/Databases/RemovePrincipals/action | Usuwa podmioty zabezpieczeń bazy danych. |
> | Akcja | Microsoft.Kusto/Clusters/Databases/write | Zapisuje zasób bazy danych. |
> | Akcja | Microsoft. Kusto/klastry/połączenia dataconnections/Delete | Usuwa zasób połączenia danych klastra. |
> | Akcja | Microsoft. Kusto/klastry/połączenia dataconnections/Read | Odczytuje zasób połączeń danych klastra. |
> | Akcja | Microsoft. Kusto/klastry/połączenia dataconnections/Write | Zapisuje zasób połączenia danych klastra. |
...
> | Akcja | Microsoft. Kusto/klastry/DetachFollowerDatabases/akcja | Odłącza bazy danych programu. |
> | Akcja | Microsoft. Kusto/klastry/DiagnoseVirtualNetwork/akcja | Diagnozuje stan łączności sieciowej dla zasobów zewnętrznych, od których zależy usługa. |
> | Akcja | Microsoft. Kusto/klastry/ListFollowerDatabases/akcja | Wyświetla listę baz danych programu. |
> | Akcja | Microsoft. Kusto/klastry/PrincipalAssignments/usuwanie | Usuwa zasób przydziałów głównych klastra. |
> | Akcja | Microsoft. Kusto/klastry/PrincipalAssignments/odczyt | Odczytuje zasób głównych przydziałów klastra. |
> | Akcja | Microsoft. Kusto/klastry/PrincipalAssignments/zapis | Zapisuje zasób głównych przydziałów klastra. |
> | Akcja | Microsoft.Kusto/Clusters/read | Odczytuje zasób klastra. |
> | Akcja | Microsoft.Kusto/Clusters/SKUs/read | Odczytuje zasób jednostki SKU klastra. |
...
> | Akcja | Microsoft.Kusto/Clusters/write | Zapisuje zasób klastra. |
> | Akcja | Microsoft.Kusto/Locations/CheckNameAvailability/action | Sprawdza dostępność nazwy zasobu. |
> | Akcja | Microsoft. Kusto/Locations/GetNetworkPolicies/Action | Pobiera zasady dotyczące opcji sieciowych |
> | Akcja | Microsoft.Kusto/locations/operationresults/read | Odczytuje zasoby operacji |
> | Akcja | Microsoft.Kusto/Operations/read | Odczytuje zasoby operacji |
...
> | Akcja | Microsoft. LabServices/labAccounts/GetPricingAndAvailability/akcja | Skorzystaj z cen i dostępności kombinacji rozmiarów, lokalizacje geograficzne i systemów operacyjnych dla konta laboratorium. |
...
> | Akcja | Microsoft. LabServices/labAccounts/GetRestrictionsAndUsage/akcja | Pobierz podstawowe ograniczenia i użycie dla tej subskrypcji |
...
> | Akcja | Microsoft. LabServices/labAccounts/Labs/GetLabPricingAndAvailability/Action | Pobierz ceny za jednostkę laboratoryjną dla tego laboratorium i dostępność, która wskazuje, czy to laboratorium może skalować w górę. |
...
> | Akcja | Microsoft. LabServices/users/UserSettings/akcja | Aktualizuje i zwraca osobiste ustawienia użytkownika. |
...
> | Akcja | Microsoft. Logic/integrationAccounts/Groups/Delete | Usuwa grupę na koncie integracji. |
> | Akcja | Microsoft. Logic/integrationAccounts/Groups/Read | Odczytuje grupę na koncie integracji. |
> | Akcja | Microsoft. Logic/integrationAccounts/Groups/Write | Tworzy lub aktualizuje grupę na koncie integracji. |
...
> | Akcja | Microsoft. Logic/integrationAccounts/rosettaNetProcessConfigurations/Delete | Usuwa konfigurację procesu RosettaNet na koncie integracji. |
> | Akcja | Microsoft. Logic/integrationAccounts/rosettaNetProcessConfigurations/odczyt | Odczytuje konfigurację procesu RosettaNet na koncie integracji. |
> | Akcja | Microsoft. Logic/integrationAccounts/rosettaNetProcessConfigurations/Write | Tworzy lub aktualizuje konfigurację procesu RosettaNet na koncie integracji. |
> | Akcja | Microsoft. Logic/integrationAccounts/Schedules/Delete | Usuwa harmonogram na koncie integracji. |
> | Akcja | Microsoft. Logic/integrationAccounts/Schedules/Read | Odczytuje harmonogram na koncie integracji. |
> | Akcja | Microsoft. Logic/integrationAccounts/Schedules/Write | Tworzy lub aktualizuje harmonogram na koncie integracji. |
...
> | Akcja | Microsoft.Logic/integrationAccounts/sessions/read | Odczytuje sesję na koncie integracji. |
...
> | Akcja | Microsoft. Logic/integrationServiceEnvironments/availableManagedApis/odczyt | Odczytuje dostępne zarządzane interfejsy API środowiska usługi integracji. |
...
> | Akcja | Microsoft. Logic/integrationServiceEnvironments/managedApis/Join/Action | Sprzęga środowisko usługi integracji zarządzanym interfejsem API. |
> | Akcja | Microsoft. Logic/integrationServiceEnvironments/managedApis/operationStatuses/Read | Odczytuje stan operacji zarządzanego interfejsu API środowiska usługi integracji. |
...
> | Akcja | Microsoft. Logic/integrationServiceEnvironments/managedApis/Write | Tworzy lub aktualizuje zarządzany interfejs API środowiska usługi integracji. |
...
> | Akcja | Microsoft. logiki/przepływy pracy/detektory/odczyt | Odczytuje Detektor przepływu pracy. |
...
> | Akcja | Microsoft. MachineLearningServices/lokalizacje/przydziały/odczyt | Pobiera przydziały aktualnie przypisanych obszarów roboczych na podstawie VMFamily. |
> | Akcja | Microsoft. MachineLearningServices/Locations/updateQuotas/Action | Aktualizowanie przydziału dla każdej rodziny maszyn wirtualnych w obszarze roboczym. |
...
> | Akcja | Microsoft. MachineLearningServices/obszary robocze/obliczenia/ponowne uruchomienie/akcja | Uruchom ponownie zasób obliczeniowy w obszarze roboczym Machine Learning Services |
> | Akcja | Microsoft. MachineLearningServices/obszary robocze/obliczenia/uruchomienie/akcja | Uruchom zasób obliczeniowy w obszarze roboczym Machine Learning Services |
> | Akcja | Microsoft. MachineLearningServices/obszary robocze/obliczenia/akcja | Zatrzymaj zasób obliczeniowy w obszarze roboczym Machine Learning Services |
...
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/zestawy danych/zarejestrowane/profil/zapis | Tworzy lub aktualizuje profile zestawów danych dla zarejestrowanego zestawu obiektów w obszarze roboczym Machine Learning Services |
...
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/zestawy danych/zarejestrowane/przeczytane | Pobiera schemat DataSet dla zarejestrowanych zestawów danych w obszarach roboczych Machine Learning Services |
...
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/zestawy danych/Wyrejestrowanie/profil/zapis | Tworzy lub aktualizuje profile zestawu danych dla niezarejestrowanych zestawów w Machine Learning Services obszarach roboczych |
...
> | Akcja dataaction | Microsoft. MachineLearningServices/Workspaces/DataSets/Unregistered/Read | Pobiera schemat DataSet dla niezarejestrowanego zestawu danych w obszarze roboczym Machine Learning Services |
...
> | Akcja | Microsoft. MachineLearningServices/Workspaces/eventGridFilters/Read | Pobierz filtr Event Grid dla określonego obszaru roboczego |
...
> | Akcja | Microsoft. MachineLearningServices/obszary robocze/funkcje/odczyt | Pobiera wszystkie włączone funkcje dla obszaru roboczego Machine Learning Services |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykiety/eksport/akcja | Eksportuj etykiety projektów etykietowania w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykietowanie/etykiety/odczyt | Pobiera etykiety projektów etykietowania w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykietki/etykiety/Odrzuć/akcja | Odrzuć etykiety projektów etykietowania w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykietowanie/etykiety/zapis | Tworzy etykiety projektów etykietowania w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykietowanie/projekty/usuwanie | Usuwa projekt etykietowania w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykiety/projekty/odczyt | Pobiera projekt etykietowania w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykiety/projekty/podsumowanie/odczyt | Pobiera podsumowanie projektu etykietowania w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/obszary robocze/etykiety/projekty/zapis | Tworzy lub aktualizuje projekt etykietowania w obszarze roboczym Machine Learning Services |
...
> | Akcja dataaction | Microsoft. MachineLearningServices/Workspaces/Metadata/Secret/Delete | Usuwa wpisy tajne w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/Workspaces/Metadata/Secret/Read | Pobiera wpisy tajne w Machine Learning Services obszarach roboczych |
> | Akcja dataaction | Microsoft. MachineLearningServices/Workspaces/Metadata/Secret/Write | Tworzy lub aktualizuje wpisy tajne w obszarze roboczym Machine Learning Services |
...
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateEndpointConnectionProxies/Delete | Usuwanie serwera proxy połączenia do prywatnego zasobu punktu końcowego dostawcy Microsoft. Network |
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateEndpointConnectionProxies/Read | Wyświetlanie stanu serwera proxy połączenia do prywatnego zasobu punktu końcowego dostawcy Microsoft. Network |
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateEndpointConnectionProxies/Validate/Action | Weryfikowanie serwera proxy połączenia do prywatnego zasobu punktu końcowego dostawcy Microsoft. Network |
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateEndpointConnectionProxies/Write | Zmiana stanu serwera proxy połączenia na prywatny zasób punktu końcowego firmy Microsoft. Network Provider |
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateEndpointConnections/Delete | Usuń połączenie z prywatnym zasobem punktu końcowego dostawcy Microsoft. Network |
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateEndpointConnections/Read | Wyświetlanie stanu połączenia z prywatnym zasobem punktu końcowego firmy Microsoft. Network Provider |
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateEndpointConnections/Write | Zmiana stanu połączenia z prywatnym zasobem punktu końcowego dostawcy Microsoft. Network |
> | Akcja | Microsoft. MachineLearningServices/obszary robocze/PrivateEndpointConnectionsApproval/akcja | Zatwierdź lub Odrzuć połączenie z prywatnym zasobem punktu końcowego dostawcy Microsoft. Network |
> | Akcja | Microsoft. MachineLearningServices/Workspaces/privateLinkResources/Read | Pobiera dostępne zasoby prywatnego linku dla określonego wystąpienia Machine Learning Services obszarów roboczych |
...
> | Akcja | Microsoft. ManagedIdentity/Operations/Read | Wyświetla listę operacji dostępnych w dostawcy zasobów Microsoft. ManagedIdentity |
...
> | Akcja | Microsoft. Management/managementGroups/Descendants/Read | Pobiera wszystkie elementy podrzędne (Grupy zarządzania, subskrypcje) grupy zarządzania. |
> | Akcja | Microsoft.Management/managementGroups/read | Wyświetl listę grup zarządzania dla uwierzytelnionego użytkownika. |
> | Akcja | Microsoft. Management/managementGroups/Settings/Delete | Usuwa ustawienia hierarchii grupy zarządzania. |
> | Akcja | Microsoft. Management/managementGroups/Settings/Read | Wyświetla listę istniejących ustawień hierarchii grupy zarządzania. |
> | Akcja | Microsoft. Management/managementGroups/Settings/Write | Tworzy lub aktualizuje ustawienia hierarchii grup zarządzania. |
...
> | Akcja | Microsoft. Migrowanie/assessmentprojects/importcollectors/usuwanie | Usuwa moduł zbierający importu |
> | Akcja | Microsoft. Migrowanie/assessmentprojects/importcollectors/odczyt | Pobiera właściwości modułu zbierającego importu |
> | Akcja | Microsoft. Migruj/assessmentprojects/importcollectors/Write | Tworzy nowy moduł zbierający importu lub aktualizuje istniejący moduł zbierający importu |
...
> | Akcja | Microsoft. Migrowanie/assessmentprojects/servercollectors/odczyt | Pobiera właściwości modułu zbierającego serwery |
> | Akcja | Microsoft. Migruj/assessmentprojects/servercollectors/Write | Tworzy nowy moduł zbierający serwer lub aktualizuje istniejący moduł zbierający serwer |
...
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Convert/akcja | Rozpocznij konwersję zasobów |
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Convert/Delete | Zatrzymaj konwersję zasobów |
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Convert/Read | Pobierz właściwości konwersji zasobów |
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Diagnostic/odczyt | Połącz z inspektorem renderowania zdalnego |
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/managesessions/akcja | Rozpocznij sesje |
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/managesessions/Delete | Zatrzymaj sesje |
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/managesessions/Read | Pobierz właściwości sesji |
> | Akcja | Microsoft. MixedReality/remoteRenderingAccounts/Providers/Microsoft. Insights/metricDefinitions/Read | Pobiera dostępne metryki dla elementu Microsoft. MixedReality/remoteRenderingAccounts |
> | Akcja dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Render/odczyt | Nawiązywanie połączenia z sesją |
...
> | Akcja | Microsoft. NetApp/netAppAccounts/accountBackups/Delete | Usuwa zasób kopii zapasowej konta. |
> | Akcja | Microsoft. NetApp/netAppAccounts/accountBackups/Read | Odczytuje zasób kopii zapasowej konta. |
> | Akcja | Microsoft. NetApp/netAppAccounts/accountBackups/Write | Zapisuje zasób kopii zapasowej konta. |
> | Akcja | Microsoft. NetApp/netAppAccounts/backupPolicies/Delete | Usuwa zasób zasad kopii zapasowych. |
> | Akcja | Microsoft. NetApp/netAppAccounts/backupPolicies/Read | Odczytuje zasób zasad kopii zapasowych. |
> | Akcja | Microsoft. NetApp/netAppAccounts/backupPolicies/Write | Zapisuje zasób zasad kopii zapasowych. |
...
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/Volumes/AuthorizeReplication/Action | Autoryzuj replikację woluminu źródłowego |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/woluminy/kopie zapasowe/usuwanie | Usuwa zasób kopii zapasowej. |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/woluminy/kopie zapasowe/odczyt | Odczytuje zasób kopii zapasowej. |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/woluminy/kopie zapasowe/zapis | Zapisuje zasób kopii zapasowej. |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/Volumes/Break/Action | Relacje replikacji woluminu Break |
> | Akcja | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/delete | Usuwa zasób woluminu. |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/Volumes/DeleteReplication/Action | Usuń replikację na woluminie docelowym |
> | Akcja | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/read | Odczytuje zasób woluminu. |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/Volumes/ReplicationStatus/Action | Odczytuje stan replikacji woluminu. |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/Volumes/ResyncReplication/Action | Ponownie zsynchronizuj replikację na woluminie docelowym |
> | Akcja | Microsoft. NetApp/netAppAccounts/capacityPools/Volumes/Revert/Action | Przywróć wolumin do określonej migawki |
...
> | Akcja | Microsoft. NetApp/netAppAccounts/snapshotPolicies/Delete | Usuwa zasób zasad migawek. |
> | Akcja | Microsoft. NetApp/netAppAccounts/snapshotPolicies/ListVolumes/Action | Wyświetl listę woluminów podłączonych do zasad migawek |
> | Akcja | Microsoft. NetApp/netAppAccounts/snapshotPolicies/Read | Odczytuje zasób zasad migawek. |
> | Akcja | Microsoft. NetApp/netAppAccounts/snapshotPolicies/Write | Zapisuje zasób zasad migawek. |
> | Akcja | Microsoft. NetApp/netAppAccounts/magazyny/odczyt | Odczytuje zasób magazynu. |
...
> | Akcja | Microsoft. NetApp/Register/Action | Akcja rejestracji subskrypcji |
...
> | Akcja | Microsoft. Network/bastionHosts/createShareableLinks/akcja | Tworzy adresy URL możliwe do udostępniania dla maszyn wirtualnych w ramach bastionu i zwraca adresy URL |
> | Akcja | Microsoft. Network/bastionHosts/Delete | Usuwa hosta bastionu |
> | Akcja | Microsoft. Network/bastionHosts/deleteShareableLinks/akcja | Usuwa adresy URL możliwe do udostępnienia dla podanych maszyn wirtualnych w ramach bastionu |
> | Akcja | Microsoft. Network/bastionHosts/disconnectactivesessions/akcja | Odłączanie określonych aktywnych sesji na hoście bastionu |
> | Akcja | Microsoft. Network/bastionHosts/getactivesessions/akcja | Pobieranie aktywnych sesji na hoście bastionu |
> | Akcja | Microsoft. Network/bastionHosts/getShareableLinks/akcja | Zwraca adresy URL możliwe do udostępniania dla określonych maszyn wirtualnych w podsieci bastionu pod warunkiem, że ich adresy URL są tworzone |
...
> | Akcja | Microsoft. Network/Connections/startpacketcapture/Action | Uruchamia przechwycenie pakietu połączenia bramy Virtual Network. |
> | Akcja | Microsoft. Network/Connections/stoppacketcapture/Action | Powoduje zatrzymanie przechwytywania pakietu połączenia bramy Virtual Network. |
...
> | Akcja | Microsoft. Network/frontDoorWebApplicationFirewallPolicies/Join/Action | Sprzęga zasady zapory aplikacji sieci Web. Brak alertów. |
...
> | Akcja | Microsoft. Network/ipAllocations/Delete | Usuwa element IpAllocation |
> | Akcja | Microsoft. Network/ipAllocations/odczyt | Pobierz IpAllocation |
> | Akcja | Microsoft. Network/ipAllocations/Write | Tworzy IpAllocation lub aktualizuje istniejący IpAllocation |
> | Akcja | Microsoft. Network/ipGroups/Delete | Usuwa IpGroup |
> | Akcja | Microsoft. Network/ipGroups/Join/Action | Sprzęga IpGroup. Brak alertów. |
> | Akcja | Microsoft. Network/ipGroups/odczyt | Pobiera IpGroup |
> | Akcja | Microsoft. Network/ipGroups/updateReferences/akcja | Aktualizowanie odwołań w IpGroup |
> | Akcja | Microsoft. Network/ipGroups/Validate/akcja | Sprawdza poprawność elementu IpGroup |
> | Akcja | Microsoft. Network/ipGroups/Write | Tworzy IpGroup lub aktualizuje istniejący IpGroups |
...
> | Akcja | Microsoft. Network/Locations/batchNotifyPrivateEndpointsForResourceMove/Action | Powiadamia o prywatnym punkcie końcowym w partiach na potrzeby przenoszenia zasobów. |
...
> | Akcja | Microsoft. Network/networkInterfaces/UpdateParentNicAttachmentOnElasticNic/akcja | Aktualizuje nadrzędną kartę sieciową skojarzoną z elastyczną kartą sieciową |
...
> | Akcja | Microsoft. Network/networkWatchers/flowLogs/Delete | Usuwa dziennik przepływu |
> | Akcja | Microsoft. Network/networkWatchers/flowLogs/odczyt | Pobierz szczegóły dziennika przepływu |
> | Akcja | Microsoft. Network/networkWatchers/flowLogs/Write | Tworzy dziennik przepływu |
...
> | Akcja | Microsoft. Network/p2sVpnGateways/disconnectp2svpnconnections/akcja | Rozłączanie połączeń sieci VPN P2S |
...
> | Akcja | Microsoft. Network/privateDnsZones/Join/Action | Sprzęga strefę Prywatna strefa DNS |
...
> | Akcja | Microsoft. Network/privateEndpoints/privateDnsZoneConfigs/Write | Umieszcza konfigurację Prywatna strefa DNS strefy |
...
> | Akcja | Microsoft. Network/virtualHubs/effectiveRoutes/akcja | Pobiera obowiązującą trasę skonfigurowaną w koncentratorze wirtualnym |
...
> | Akcja | Microsoft. Network/virtualnetworkgateways/disconnectvirtualnetworkgatewayvpnconnections/akcja | Rozłączanie połączeń sieci VPN bramy sieci wirtualnej |
...
> | Akcja | Microsoft. Network/virtualnetworkgateways/startpacketcapture/akcja | Uruchamia przechwytywanie pakietów bramy Virtual Network. |
> | Akcja | Microsoft. Network/virtualnetworkgateways/stoppacketcapture/akcja | Powoduje zatrzymanie przechwytywania pakietu Virtual Network Gateway. |
...
> | Akcja | Microsoft. Network/virtualRouters/Komunikacja równorzędna/usuwanie | Usuwa element VirtualRouterPeering |
> | Akcja | Microsoft. Network/virtualRouters/Peers/Read | Pobiera VirtualRouterPeering |
> | Akcja | Microsoft. Network/virtualRouters/Peers/Write | Tworzy VirtualRouterPeering lub aktualizuje istniejący VirtualRouterPeering |
...
> | Akcja | Microsoft.network/virtualWans/p2sVpnServerConfigurations/delete | Usuwa P2SVpnServerConfiguration wirtualnej sieci WAN |
> | Akcja | Microsoft.Network/virtualWans/p2sVpnServerConfigurations/read | Pobiera wirtualną P2SVpnServerConfiguration sieci WAN |
> | Akcja | Microsoft.network/virtualWans/p2sVpnServerConfigurations/write | Tworzy wirtualną P2SVpnServerConfiguration sieci WAN lub aktualizuje istniejącą wirtualną sieć WAN P2SVpnServerConfiguration |
...
> | Akcja | Microsoft. OffAzure/HyperVSites/Summary/Read | Pobiera podsumowanie lokacji funkcji Hyper-V |
...
> | Akcja | Microsoft. OffAzure/ImportSites/Delete | Usuwa witrynę importowania |
> | Akcja | Microsoft. OffAzure/ImportSites/exporturi/akcja | Pobiera identyfikator URI sygnatury dostępu współdzielonego do eksportowania plików CSV maszyn. |
> | Akcja | Microsoft. OffAzure/ImportSites/importuri/akcja | Pobiera identyfikator URI sygnatury dostępu współdzielonego w celu zaimportowania pliku CSV maszyn. |
> | Akcja | Microsoft. OffAzure/ImportSites/Jobs/odczyt | Pobiera właściwości zadań importu |
> | Akcja | Microsoft. OffAzure/ImportSites/Machines/Delete | Usuwa maszynę importu |
> | Akcja | Microsoft. OffAzure/ImportSites/Machines/Read | Pobiera właściwości maszyn importu |
> | Akcja | Microsoft. OffAzure/ImportSites/odczyt | Pobiera właściwości witryny importowania |
> | Akcja | Microsoft. OffAzure/ImportSites/Write | Tworzy lub aktualizuje witrynę importu |
...
> | Akcja | Microsoft. OffAzure/ServerSites/Delete | Usuwa lokację serwera |
...
> | Akcja | Microsoft. OffAzure/ServerSites/Summary/Read | Pobiera podsumowanie lokacji serwera |
...
> | Akcja | Microsoft. OffAzure/VMwareSites/clientGroupMembers/akcja | Wyświetla listę członków grupy klientów dla wybranej grupy klientów. |
> | Akcja | Microsoft.OffAzure/VMwareSites/delete | Usuwa witrynę programu VMware |
> | Akcja | Microsoft. OffAzure/VMwareSites/exportapplications/akcja | Eksportuje dane aplikacji i ról VMware do xls |
> | Akcja | Microsoft. OffAzure/VMwareSites/generateCoarseMap/akcja | Generuje mapę grubą dla listy maszyn |
> | Akcja | Microsoft. OffAzure/VMwareSites/generateDetailedMap/akcja | Generuje szczegółową mapę programu VMware Gruba |
> | Akcja | Microsoft. OffAzure/VMwareSites/GetApplications/Action | Pobiera informacje o aplikacji dla wybranych maszyn |
...
> | Akcja | Microsoft. OffAzure/VMwareSites/Machines/Applications/Read | Pobiera właściwości aplikacji maszyn VMware |
...
> | Akcja | Microsoft. OffAzure/VMwareSites/serverGroupMembers/akcja | Wyświetla listę członków grupy serwerów dla wybranej grupy serwerów. |
> | Akcja | Microsoft. OffAzure/VMwareSites/Summary/Read | Pobiera Podsumowanie witryny programu VMware |
> | Akcja | Microsoft. OffAzure/VMwareSites/updateProperties/akcja | Aktualizuje właściwości maszyn w lokacji |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. operationalinsights/availableservicetiers/odczyt | Pobierz dostępne warstwy usług. |
...
> | Akcja | Microsoft. operationalinsights/Locations/operationStatuses/Read | Uzyskaj Log Analytics stanu operacji asynchronicznej platformy Azure. |
...
> | Akcja | Microsoft. operationalinsights/obszary robocze/eksport/usuwanie | Usuń określony eksport danych. |
> | Akcja | Microsoft. operationalinsights/Workspaces/DataExport/odczyt | Pobierz konkretny eksport danych. |
> | Akcja | Microsoft. operationalinsights/obszary robocze/eksport/zapis | Utwórz lub zaktualizuj eksport danych. |
...
> | Akcja | Microsoft. operationalinsights/Workspaces/privateEndpointConnectionProxies/Delete | Usuń serwer proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. operationalinsights/Workspaces/privateEndpointConnectionProxies/Read | Pobierz serwer proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. operationalinsights/Workspaces/privateEndpointConnectionProxies/Validate/Action | Sprawdź poprawność serwera proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. operationalinsights/Workspaces/privateEndpointConnectionProxies/Write | Umieść serwer proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. operationalinsights/Workspaces/privateEndpointConnections/Delete | Usuń serwer proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. operationalinsights/Workspaces/privateEndpointConnections/Read | Pobierz serwer proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. operationalinsights/Workspaces/privateEndpointConnections/Write | Umieść serwer proxy połączenia prywatnego punktu końcowego. |
> | Akcja | Microsoft. operationalinsights/Workspaces/privateLinkResources/Read | Pobierz Log Analytics zasoby łączy prywatnych. |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/AegDeliveryFailureLogs/Read | Odczytaj dane z tabeli AegDeliveryFailureLogs |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/AegPublishFailureLogs/Read | Odczytaj dane z tabeli AegPublishFailureLogs |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/AppServiceAuditLogs/Read | Odczytaj dane z tabeli AppServiceAuditLogs |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/AppServiceConsoleLogs/Read | Odczytaj dane z tabeli AppServiceConsoleLogs |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/availabilityResults/Read | Odczytaj dane z tabeli availabilityResults |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/browserTimings/Read | Odczytaj dane z tabeli browserTimings |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/customEvents/Read | Odczytaj dane z tabeli customEvents |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/customMetrics/Read | Odczytaj dane z tabeli customMetrics |
...
> | Akcja | Microsoft. OperationalInsights/obszary robocze/zapytania/zależności/odczyt | Odczytaj dane z tabeli zależności |
...
> | Akcja | Microsoft. OperationalInsights/obszary robocze/zapytania/DHCP/odczyt | Odczytywanie danych z tabeli DHCP |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/FunctionAppLogs/Read | Odczytaj dane z tabeli FunctionAppLogs |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/IntuneDeviceComplianceOrg/Read | Odczytaj dane z tabeli IntuneDeviceComplianceOrg |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/IoTHubDistributedTracing/Read | Odczytaj dane z tabeli IoTHubDistributedTracing |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/KubeMonAgentEvents/Read | Odczytaj dane z tabeli KubeMonAgentEvents |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/MicrosoftAzureBastionAuditLogs/Read | Odczytaj dane z tabeli MicrosoftAzureBastionAuditLogs |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/MicrosoftDataShareReceivedSnapshotLog/Read | Odczytaj dane z tabeli MicrosoftDataShareReceivedSnapshotLog |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/MicrosoftDataShareSentSnapshotLog/Read | Odczytaj dane z tabeli MicrosoftDataShareSentSnapshotLog |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/MicrosoftDynamicsTelemetryPerformanceLogs/Read | Odczytaj dane z tabeli MicrosoftDynamicsTelemetryPerformanceLogs |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/MicrosoftDynamicsTelemetrySystemMetricsLogs/Read | Odczytaj dane z tabeli MicrosoftDynamicsTelemetrySystemMetricsLogs |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/pageViews/Read | Odczytaj dane z tabeli pageViews |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/perf/Read | Odczytaj dane z tabeli wydajności |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/liczniki wydajności/Read | Odczytaj dane z tabeli liczniki wydajności |
...
> | Akcja | Microsoft. OperationalInsights/obszary robocze/zapytania/żądania/odczyt | Odczytaj dane z tabeli Requests |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/SignalRServiceDiagnosticLogs/Read | Odczytaj dane z tabeli SignalRServiceDiagnosticLogs |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/StorageBlobLogs/Read | Odczytaj dane z tabeli StorageBlobLogs |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/StorageFileLogs/Read | Odczytaj dane z tabeli StorageFileLogs |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/StorageQueueLogs/Read | Odczytaj dane z tabeli StorageQueueLogs |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/StorageTableLogs/Read | Odczytaj dane z tabeli StorageTableLogs |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/systemEvents/Read | Odczytaj dane z tabeli systemEvents |
...
> | Akcja | Microsoft. OperationalInsights/obszary robocze/zapytania/ślady/odczyt | Odczytaj dane z tabeli TRACES |
...
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/VMComputer/Read | Odczytaj dane z tabeli VMComputer |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/VMConnection/Read | Odczytaj dane z tabeli VMConnection |
> | Akcja | Microsoft. OperationalInsights/Workspaces/Query/VMProcess/Read | Odczytaj dane z tabeli VMProcess |
...
> | Akcja | Microsoft. operationalinsights/Workspaces/scopedPrivateLinkProxies/Delete | Usuń serwer proxy prywatnego linku z zakresem. |
> | Akcja | Microsoft. operationalinsights/Workspaces/scopedPrivateLinkProxies/Read | Pobierz prywatny serwer proxy linku z zakresem. |
> | Akcja | Microsoft. operationalinsights/Workspaces/scopedPrivateLinkProxies/Write | Umieść serwer proxy linku prywatnego z zakresem. |
...
> | Akcja | Microsoft. PolicyInsights/policyMetadata/odczyt | Pobieranie zasobów metadanych zasad. |
...
> | Akcja | Microsoft. recoveryservices/magazyny/backupEncryptionConfigs/odczyt | Pobiera konfigurację szyfrowania zasobów kopii zapasowej. |
> | Akcja | Microsoft. recoveryservices/magazyny/backupEncryptionConfigs/zapis | Aktualizuje konfigurację szyfrowania zasobów kopii zapasowej |
...
> | Akcja | Microsoft. RecoveryServices/magazyny/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/resync/akcja | Ponownie zsynchronizować |
...
> | Akcja | Microsoft. RecoveryServices/magazyny/replicationOperationStatus/odczyt | Odczytaj wszystkie Stany operacji replikacji magazynu |
...
> | Akcja | Microsoft. Relay/przestrzenie nazw/networkrulesets/Read | Pobiera zasób NetworkRuleSet |
> | Akcja | Microsoft. Relay/przestrzenie nazw/networkrulesets/Write | Utwórz zasób reguły sieci wirtualnej |
...
> | Akcja | Microsoft. ResourceHealth/powiadomienia/odczyt | Odbiera powiadomienia Azure Resource Manager |
...
> | Akcja | Microsoft. resources/checkPolicyCompliance/Read | Sprawdź stan zgodności danego zasobu względem zasad zasobów. |
...
> | Akcja | Microsoft. resources/deploymentScripts/Delete | Usuwa skrypt wdrożenia |
> | Akcja | Microsoft. resources/deploymentScripts/Logs/odczyt | Pobiera lub wyświetla dzienniki skryptów wdrażania |
> | Akcja | Microsoft. resources/deploymentScripts/Read | Pobiera lub wyświetla skrypty wdrażania |
> | Akcja | Microsoft. resources/deploymentScripts/Write | Tworzy lub aktualizuje skrypt wdrożenia |
...
> | Akcja | Microsoft. Search/searchServices/privateEndpointConnectionProxies/Delete | Usuwa istniejący serwer proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. Search/searchServices/privateEndpointConnectionProxies/Read | Zwraca listę proxy połączeń prywatnych punktów końcowych lub pobiera właściwości dla określonego serwera proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. Search/searchServices/privateEndpointConnectionProxies/Validate/Action | Sprawdza poprawność wywołania połączenia z prywatnym punktem końcowym po stronie NRP |
> | Akcja | Microsoft. Search/searchServices/privateEndpointConnectionProxies/Write | Tworzy prywatny serwer proxy połączenia z określonymi parametrami lub aktualizuje właściwości lub Tagi dla określonego serwera proxy połączenia prywatnego punktu końcowego |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. SecurityInsights/agregacje/odczyt | Pobiera informacje zagregowane |
> | Akcja | Microsoft. SecurityInsights/alertRules/Actions/Delete | Usuwa akcje odpowiedzi reguły alertu |
> | Akcja | Microsoft. SecurityInsights/alertRules/Actions/Read | Pobiera akcje odpowiedzi reguły alertu |
> | Akcja | Microsoft. SecurityInsights/alertRules/Actions/Write | Aktualizuje akcje odpowiedzi reguły alertu |
> | Akcja | Microsoft. SecurityInsights/alertRules/Delete | Usuwa reguły alertów |
> | Akcja | Microsoft. SecurityInsights/alertRules/odczyt | Pobiera reguły alertów |
> | Akcja | Microsoft. SecurityInsights/alertRules/Write | Aktualizuje reguły alertów |
> | Akcja | Microsoft. SecurityInsights/zakładki/Usuń | Usuwa zakładki |
> | Akcja | Microsoft. SecurityInsights/zakładki/rozwiń/akcja | Pobiera powiązane jednostki jednostki według określonego rozwinięcia |
> | Akcja | Microsoft. SecurityInsights/zakładki/odczyt | Pobiera zakładki |
> | Akcja | Microsoft. SecurityInsights/zakładki/zapis | Aktualizuje zakładki |
> | Akcja | Microsoft. SecurityInsights/sprawy/Komentarze/odczyt | Pobiera komentarze dotyczące wielkości liter |
> | Akcja | Microsoft. SecurityInsights/sprawy/Komentarze/zapis | Tworzy Komentarze do wielkości liter |
> | Akcja | Microsoft. SecurityInsights/przypadki/usuwanie | Usuwa wielkość liter |
> | Akcja | Microsoft. SecurityInsights/przypadki/badania/odczyt | Pobiera badania przypadku |
> | Akcja | Microsoft. SecurityInsights/przypadki/badania/zapis | Aktualizuje metadane przypadku |
> | Akcja | Microsoft. SecurityInsights/przypadki/odczyt | Pobiera wielkość liter |
> | Akcja | Microsoft. SecurityInsights/sprawy/zapis | Aktualizuje przypadek |
> | Akcja | Microsoft. SecurityInsights/dataconnecters/Delete | Usuwa Łącznik danych |
> | Akcja | Microsoft. SecurityInsights/dataconnecters/odczyt | Pobiera łączniki danych |
> | Akcja | Microsoft. SecurityInsights/dataconnecters/Write | Aktualizuje Łącznik danych |
> | Akcja | Microsoft. SecurityInsights/incydenty/Komentarze/odczyt | Pobiera Komentarze zdarzenia |
> | Akcja | Microsoft. SecurityInsights/incydenty/Komentarze/zapis | Tworzy komentarz dotyczący zdarzenia |
> | Akcja | Microsoft. SecurityInsights/incydenty/usuwanie | Usuwa zdarzenie |
> | Akcja | Microsoft. SecurityInsights/incydenty/odczyt | Pobiera zdarzenie |
> | Akcja | Microsoft. SecurityInsights/incydenty/relacje/usuwanie | Usuwa relację między incydentem a powiązanymi zasobami |
> | Akcja | Microsoft. SecurityInsights/incydenty/relacje/odczyt | Pobiera relację między incydentem a powiązanymi zasobami |
> | Akcja | Microsoft. SecurityInsights/incydenty/relacje/zapis | Aktualizuje relację między incydentem a powiązanymi zasobami |
> | Akcja | Microsoft. SecurityInsights/incydenty/zapis | Aktualizuje zdarzenie |
> | Akcja | Microsoft. SecurityInsights/Register/Action | Rejestruje subskrypcję na platformie Azure wskaźnikowej |
> | Akcja | Microsoft. SecurityInsights/Settings/Read | Pobiera ustawienia |
> | Akcja | Microsoft. SecurityInsights/Settings/Write | Ustawienia aktualizacji |
> | Akcja | Microsoft. SecurityInsights/Unregister/Action | Wyrejestrowuje subskrypcję z platformy Azure — wskaźnik |
...
> | Akcja | Microsoft.SignalRService/locations/operationresults/signalr/read | Zbadaj wynik operacji asynchronicznej opartej na lokalizacji |
> | Akcja | Microsoft.SignalRService/locations/operationStatuses/operationId/read | Badanie stanu operacji asynchronicznej opartej na lokalizacji |
> | Akcja | Microsoft.SignalRService/locations/usages/read | Pobierz użycie przydziału dla usługi Azure Signal Service |
> | Akcja | Microsoft.SignalRService/operationresults/read | Zbadaj wynik operacji asynchronicznej na poziomie dostawcy |
> | Akcja | Microsoft. SignalRService/Operations/Read | Wyświetl listę operacji usługi Azure Signal Service. |
> | Akcja | Microsoft.SignalRService/operationstatus/read | Zapytanie o stan asynchronicznej operacji na poziomie dostawcy |
...
> | Akcja | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/Delete | Usuwanie serwera proxy połączenia prywatnego punktu końcowego |
> | Akcja | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/odczyt | Odczytaj prywatny serwer proxy Connetionego punktu końcowego |
> | Akcja | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/Validate/akcja | Weryfikowanie prywatnego serwera proxy połączenia punktu końcowego |
> | Akcja | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/Write | Tworzenie prywatnego serwera proxy połączenia punktu końcowego |
> | Akcja | Microsoft. SignalRService/Signaler/privateEndpointConnections/odczyt | Odczytaj połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. SignalRService/Signaler/privateEndpointConnections/Write | Zatwierdź lub Odrzuć połączenie prywatnego punktu końcowego |
> | Akcja | Microsoft. SignalRService/Signaler/privateLinkResources/odczyt | Wyświetl listę wszystkich prywatnych zasobów linku sygnalizującego |
...
> | Akcja | Microsoft. Solutions/Operations/Read | Pobiera listę operacji. |
...
> | Akcja | Microsoft. SQL/Locations/longTermRetentionManagedInstanceBackups/Read | Zwraca listę kopii zapasowych wystąpienia zarządzanego LTR dla określonej lokalizacji  |
> | Akcja | Microsoft. SQL/Locations/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/Delete | Usuwa kopię zapasową LTR dla bazy danych wystąpienia zarządzanego |
> | Akcja | Microsoft. SQL/Locations/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/Read | Zwraca listę kopii zapasowych odnoszących się do bazy danych wystąpienia zarządzanego |
> | Akcja | Microsoft. SQL/Locations/longTermRetentionManagedInstances/longTermRetentionManagedInstanceBackups/Read | Zwraca listę kopii zapasowych wystąpienia zarządzanego LTR dla określonego wystąpienia zarządzanego |
...
> | Akcja | Microsoft. SQL/Locations/managedInstanceLongTermRetentionPolicyAzureAsyncOperation/Read | Pobiera stan długotrwałej operacji zasad przechowywania dla zarządzanej bazy danych |
> | Akcja | Microsoft. SQL/Locations/managedInstanceLongTermRetentionPolicyOperationResults/Read | Pobiera stan długotrwałej operacji zasad przechowywania dla zarządzanej bazy danych |
> | Akcja | Microsoft. SQL/Locations/managedShortTermRetentionPolicyOperationResults/Read | Pobiera stan krótkoterminowej operacji zasad przechowywania |
...
> | Akcja | Microsoft. SQL/Locations/serverAdministratorAzureAsyncOperation/Read | Wyniki operacji asynchronicznej administratora Azure Active Directory serwera |
> | Akcja | Microsoft. SQL/Locations/serverAdministratorOperationResults/Read | Wyniki operacji administratora serwera Azure Active Directory |
...
> | Akcja | Microsoft. SQL/Locations/shortTermRetentionPolicyOperationResults/Read | Pobiera stan krótkoterminowej operacji zasad przechowywania |
...
> | Akcja | Microsoft. SQL/Locations/transparentDataEncryptionAzureAsyncOperation/Read | Pobiera operacje w toku dotyczące przezroczystego szyfrowania danych logicznej bazy danych |
> | Akcja | Microsoft. SQL/Locations/transparentDataEncryptionOperationResults/Read | Pobiera operacje w toku dotyczące przezroczystego szyfrowania danych logicznej bazy danych |
...
> | Akcja | Microsoft. SQL/managedInstances/Databases/backupLongTermRetentionPolicies/Read | Pobiera długoterminowe zasady przechowywania dla zarządzanej bazy danych |
> | Akcja | Microsoft. SQL/managedInstances/Databases/backupLongTermRetentionPolicies/Write | Aktualizuje długoterminowe zasady przechowywania dla zarządzanej bazy danych |
...
> | Akcja | Microsoft. SQL/managedInstances/Databases/completeRestore/Action | Kończy operację przywracania zarządzanej bazy danych |
...
> | Akcja | Microsoft.Sql/managedInstances/databases/schemas/read | Pobierz schemat zarządzanej bazy danych. (tylko schemat) |
> | Akcja | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/read | Pobierz kolumnę zarządzanej bazy danych (tylko schemat) |
...
> | Akcja | Microsoft.Sql/managedInstances/databases/schemas/tables/read | Pobierz tabelę zarządzanej bazy danych (tylko schemat) |
...
> | Akcja | Microsoft. SQL/managedInstances/inaccessibleManagedDatabases/odczyt | Pobiera listę niedostępnych zarządzanych baz danych w wystąpieniu zarządzanym |
...
> | Akcja | Microsoft. SQL/managedInstances/Operations/Cancel/Action | Anuluje wystąpienie zarządzane usługi Azure SQL oczekujące na operację asynchroniczną, która nie została jeszcze zakończona. |
> | Akcja | Microsoft. SQL/managedInstances/Operations/Read | Pobierz operacje wystąpienia zarządzanego |
...
> | Akcja | Microsoft.Sql/servers/administratorOperationResults/read | Pobiera operacje w toku dla administratorów serwera |
...
> | Akcja | Microsoft. SQL/serwery/bazy danych/rozszerzenia/importExtensionOperationResults/odczyt | Pobiera operacje importu w toku |
...
> | Akcja | Microsoft.Sql/servers/databases/schemas/read | Pobierz schemat bazy danych (tylko schemat). |
> | Akcja | Microsoft.Sql/servers/databases/schemas/tables/columns/read | Pobierz kolumnę bazy danych (tylko schemat). |
...
> | Akcja | Microsoft.Sql/servers/databases/schemas/tables/read | Pobierz tabelę bazy danych (tylko schemat). |
...
> | Akcja | Microsoft. SQL/serwery/bazy danych/transparentDataEncryption/odczyt | Pobierz szczegóły logicznej bazy danych Transparent Data Encryption w danej zarządzanej bazie danych |
> | Akcja | Microsoft. SQL/serwery/bazy danych/transparentDataEncryption/Write | Zmień Transparent Data Encryption bazy danych dla danej logicznej bazy danych |
...
> | Akcja | Microsoft. SQL/serwery/bazy danych/workloadGroups/Usuń | Odrzuca określoną grupę obciążeń. |
> | Akcja | Microsoft. SQL/serwery/bazy danych/workloadGroups/odczyt | Wyświetla listę grup obciążeń dla wybranej bazy danych. |
> | Akcja | Microsoft. SQL/serwery/bazy danych/workloadGroups/workloadClassifiers/Delete | Odrzuca określony klasyfikator obciążeń. |
> | Akcja | Microsoft. SQL/serwery/bazy danych/workloadGroups/workloadClassifiers/odczyt | Wyświetla listę klasyfikatorów obciążeń dla wybranej bazy danych. |
> | Akcja | Microsoft. SQL/serwery/bazy danych/workloadGroups/workloadClassifiers/zapis | Ustawia właściwości dla określonego klasyfikatora obciążeń. |
> | Akcja | Microsoft. SQL/serwery/bazy danych/workloadGroups/Write | Ustawia właściwości dla określonej grupy obciążeń. |
...
> | Akcja | Microsoft. SQL/serwery/operacje/odczyt | Zwróć listę operacji wykonanych na serwerze |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. SqlVirtualMachine/Locations/availabilityGroupListenerOperationResults/Read | Pobierz wynik operacji odbiornika grupy dostępności |
> | Akcja | Microsoft. SqlVirtualMachine/Locations/sqlVirtualMachineGroupOperationResults/Read | Pobierz wynik operacji grupy maszyn wirtualnych SQL |
> | Akcja | Microsoft. SqlVirtualMachine/Locations/sqlVirtualMachineOperationResults/Read | Pobierz wynik operacji maszyny wirtualnej SQL |
> | Akcja | Microsoft. SqlVirtualMachine/Operations/Read |  |
> | Akcja | Microsoft. SqlVirtualMachine/Register/Action | Zarejestruj subskrypcję za pomocą dostawcy zasobów Microsoft. SqlVirtualMachine |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/Delete | Usuń istniejący odbiornik grupy dostępności |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/Read | Pobierz szczegóły odbiornika grupy dostępności SQL w danej grupie maszyn wirtualnych SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/Write | Utwórz nowe lub zmiany właściwości istniejącego odbiornika grupy dostępności SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachineGroups/Delete | Usuń istniejącą grupę maszyn wirtualnych SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachineGroups/odczyt | Szczegóły pobrania grupy maszyn wirtualnych SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachineGroups/sqlVirtualMachines/Read | Wyświetlanie listy maszyn wirtualnych SQL według określonej grupy wirtualnych maszyn wirtualnych SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachineGroups/Write | Utwórz nowe lub zmień właściwości istniejącej grupy maszyn wirtualnych SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachines/Delete | Usuń istniejącą maszynę wirtualną SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachines/odczyt | Pobierz szczegóły maszyny wirtualnej SQL |
> | Akcja | Microsoft. SqlVirtualMachine/sqlVirtualMachines/Write | Utwórz nowe lub zmień właściwości istniejącej maszyny wirtualnej SQL |
> | Akcja | Microsoft. SqlVirtualMachine/Unregister/Action | Wyrejestrowywanie subskrypcji z dostawcą zasobów Microsoft. SqlVirtualMachine |
...
> | Akcja dataaction | Microsoft. Storage/storageAccounts/blobServices/kontenery/obiekty blob/manageOwnership/akcja | Zmienia własność obiektu BLOB |
> | Akcja dataaction | Microsoft. Storage/storageAccounts/blobServices/kontenery/obiekty blob/modifyPermissions/akcja | Modyfikuje uprawnienia obiektu BLOB |
> | Akcja dataaction | Microsoft. Storage/storageAccounts/blobServices/Containers/Blobs/Move/Action | Przenosi obiekt BLOB z jednej ścieżki do innej |
...
> | Akcja | Microsoft. Storage/storageAccounts/dataSharePolicies/Delete |  |
> | Akcja | Microsoft. Storage/storageAccounts/dataSharePolicies/odczyt |  |
> | Akcja | Microsoft. Storage/storageAccounts/dataSharePolicies/odczyt |  |
> | Akcja | Microsoft. Storage/storageAccounts/dataSharePolicies/Write |  |
...
> | Akcja | Microsoft. Storage/storageAccounts/fileServices/udziały/akcja |  |
...
> | Akcja | Microsoft. storagesync/storageSyncServices/syncGroups/cloudEndpoints/triggerChangeDetection/Action | Wywołaj tę akcję, aby wyzwolić wykrywanie zmian w udziale plików punktu końcowego w chmurze |
...
> | Akcja | Microsoft.StorSimple/managers/migrateClassicToResourceManager/action | Migrowanie z wersji klasycznej do Menedżera zasobów |
...
> | Akcja | Microsoft. StreamAnalytics/streamingjobs/PublishEdgePackage/akcja | Publikowanie pakietu Edge dla zadania Stream Analytics |
> | Akcja | Microsoft. StreamAnalytics/streamingjobs/odczyt | Odczytaj Stream Analytics zadania |
> | Akcja | Microsoft. StreamAnalytics/streamingjobs/Skala/akcja | Skalowanie zadania Stream Analytics |
...
> | Typ akcji | Operacja | Opis |
> | --- | --- | --- |
> | Akcja | Microsoft. Support/checkNameAvailability/Action | Sprawdza, czy nazwa jest prawidłowa i czy nie jest używana dla typu zasobu |
> | Akcja | Microsoft. Support/operationresults/Read | Pobierz wynik operacji |
> | Akcja | Microsoft. Support/Operations/Read | Wyświetla listę operacji dostępnych w ramach dostawcy zasobów Microsoft. Support |
> | Akcja | Microsoft. Support/operationsstatus/Read | Pobierz stan operacji |
> | Akcja | Microsoft.Support/register/action | Rejestruje dostawcę zasobów pomocy technicznej |
> | Akcja | Microsoft. Support/Services/problemClassifications/Read | Pobiera listę klasyfikacji problemów dostępnych dla usługi platformy Azure |
> | Akcja | Microsoft. Pomoc techniczna/usługi/odczyt | Pobiera listę usług platformy Azure dostępnych do obsługi |
> | Akcja | Microsoft. Support/supportTickets/Communications/Read | Pobiera listę komunikacji biletów pomocy technicznej |
> | Akcja | Microsoft. Support/supportTickets/Communications/Write | Tworzy komunikację biletów pomocy technicznej |
> | Akcja | Microsoft.Support/supportTickets/read | Pobiera listę biletów pomocy technicznej. |
> | Akcja | Microsoft.Support/supportTickets/write | Tworzy bilet pomocy technicznej asynchronicznie lub aktualizuje go. Można utworzyć bilet pomocy technicznej dotyczący problemów technicznych, rozliczeń, limitów przydziału lub problemów związanych z zarządzaniem subskrypcją. Możesz zaktualizować ważność i szczegóły kontaktu dla istniejących biletów pomocy technicznej. |
...
> | Akcja | Microsoft. Web/hostingEnvironments/eventGridFilters/Delete | Usuń filtr Event Grid w środowisku hostingu. |
> | Akcja | Microsoft. Web/hostingEnvironments/eventGridFilters/odczyt | Pobierz filtr Event Grid w środowisku hostingu. |
> | Akcja | Microsoft. Web/hostingEnvironments/eventGridFilters/zapis | Umieść filtr Event Grid w środowisku hostingu. |
...
> | Akcja | Microsoft. Web/Sites/szczeliny/rozszerzenia/odczyt | Pobierz rozszerzenia Web Apps miejsc. |
> | Akcja | Microsoft. Web/Sites/szczeliny/rozszerzenia/zapis | Aktualizowanie rozszerzeń Web Apps miejsc. |
