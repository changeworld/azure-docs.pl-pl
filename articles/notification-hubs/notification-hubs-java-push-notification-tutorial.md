...
Do wewnętrznej bazy danych należy wykonywać tylko jedno wywołanie: CreateOrUpdateInstallation, jest w pełni idempotentne, więc możesz ponowić próbę, jeśli to konieczne.
