...
1.   Zanotuj hasło **Wpis tajny aplikacji** oraz **Identyfikator zabezpieczeń (SID) pakietu**.
        ...
        >[!WARNING]
        >Wpis tajny aplikacji i identyfikator SID pakietu są ważnymi poświadczeniami zabezpieczeń. Nie udostępniaj nikomu tych wartości ani nie rozpowszechniaj ich razem z aplikacją.
