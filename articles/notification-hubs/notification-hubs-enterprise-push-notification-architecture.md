...
1. [Notification Hubs — samouczek aplikacji uniwersalnych Windows] — w tym samouczku wyjaśniono, jak skonfigurować aplikację Windows Store i zarejestrować, a następnie odbierają powiadomienia przy użyciu usługi Notification Hubs.
...
1. **ReceiveAndSendNotification**
    ...
    d. ReceiveMessageAndSendNotification jest używany do odczytu komunikatu z tematu przy użyciu swojej subskrypcji i jeśli odczytu zakończy się pomyślnie do wysłania do aplikacji mobilnych, korzystanie z platformy Azure następnie pracowali powiadomień (w przykładowym scenariuszu natywnych wyskakujące powiadomienie Windows) Usługa Notification Hubs.
...
1. **EnterprisePushMobileApp**
    ...
    c. Upewnij się, że następujące usługi Notification Hubs kodu rejestracyjnego jest wywoływana w jej uruchamiania (po zastąpieniu *HubName* i *DefaultListenSharedAccessSignature*:
...
[Usługą Azure Mobile Services]: http://azure.microsoft.com/documentation/services/mobile-services/
[Azure Service Bus]: http://azure.microsoft.com/documentation/articles/fundamentals-service-bus-hybrid-solutions/
[Usługa Service Bus Pub/Sub programowania]: http://azure.microsoft.com/documentation/articles/service-bus-dotnet-how-to-use-topics-subscriptions/
[Zadanie WebJob platformy Azure]: ../app-service/web-sites-create-web-jobs.md
[Notification Hubs — samouczek aplikacji uniwersalnych Windows]: http://azure.microsoft.com/documentation/articles/notification-hubs-windows-store-dotnet-get-started/
