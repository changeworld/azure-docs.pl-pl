...
* **Usługi dla deweloperów**: opracowuje modułowego i ogólny usług, które może być ponownie wiedząc i używany w wielu aplikacjach typu tej samej lub różnych typów. Na przykład usługa kolejki może służyć do tworzenia biletów aplikacji (Pomoc techniczna) lub aplikacji handlu elektronicznego (koszyka).
