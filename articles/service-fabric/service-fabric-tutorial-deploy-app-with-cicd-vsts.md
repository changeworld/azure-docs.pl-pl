...
Wybierz pozycję **Azure DevOps Git** jako źródło, projekt **Voting**, repozytorium **Voting** i domyślną gałąź **master** lub ręczne i zaplanowane kompilacje.  Następnie kliknij pozycję **Kontynuuj**.
