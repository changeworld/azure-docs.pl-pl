---
title: Azure Service Fabric interfejsu wiersza polecenia — interfejs sfctl | Dokumentacja firmy Microsoft
description: W tym artykule opisano polecenia sfctl interfejsu wiersza polecenia usługi Service Fabric.
...
| [compose](service-fabric-sfctl-compose.md) | Tworzenie, usuwanie i zarządzać aplikacjami narzędzia Docker Compose. |
...
| [partition](service-fabric-sfctl-partition.md) | Zapytanie partycji i zarządzania nimi dla dowolnej usługi. |
| [Właściwość](service-fabric-sfctl-property.md) | Właściwości Store i zapytania w obszarze nazw usługi Service Fabric. |
| [repliki](service-fabric-sfctl-replica.md) | Zarządzaj replik, które należą do partycji usługi. |
| [rpm](service-fabric-sfctl-rpm.md) | Zapytania i wysyłanie poleceń do usługi Menedżer naprawy. |
| [sa-cluster](service-fabric-sfctl-sa-cluster.md) | Zarządzaj autonomicznych klastrów usługi Service Fabric. |
| [service](service-fabric-sfctl-service.md) | Tworzenie, usuwanie i zarządzać usługą, typy usług i pakietów usługi. |
