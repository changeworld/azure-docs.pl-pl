...
| wybierz z listy pozycję | Nawiązuje połączenie z punktem końcowym klastra Service Fabric. |
...
| upgrade—rollback | Wycofywanie uaktualnienia klastra Service Fabric. |
