...
|type|Anonimowy complexType|
|content|1 element (y), atrybuty: 0|
|określonych|lokalnie w polu [complextypetype](service-fabric-service-model-schema-complex-types.md#servicetype-complextype)|
|name|LoadMetrics|
|{1&gt;minOccurs&lt;1}|0|
