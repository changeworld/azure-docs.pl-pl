...
|Atrybut|Wartość|
|---|---|
|type|[Typ obrazu](service-fabric-service-model-schema-complex-types.md#imagetype-complextype)|
|content|0 elementy, atrybuty (0)|
...
|Atrybut|Wartość|
|---|---|
|type|[Zgodność](service-fabric-service-model-schema-complex-types.md#parametertype-complextype)|
|content|0 elementy, atrybuty (0)|
