---
title: Typy złożone schematu XML modelu usługi Service Fabric platformy Azure | Microsoft Docs
...
Jeśli kontener ma włączone HEALTHCHECK i Docker Reports health_status dla tego kontenera, Service Fabric uruchomi ponownie kontener, gdy health_status zgłoszone przez platformę Docker jest w złej kondycji.
...
Limity pamięci w MB. Wartość musi być dodatnią liczbą całkowitą. Pakiety kodu (kontenery lub procesy) nie mogą przydzielać pamięci ponad ten limit. Podjęcie próby takiego przydzielenia spowoduje wyjątek braku pamięci.
...
Całkowita ilość pamięci wymiany, która może być używana w MB. Wartość musi być dodatnią liczbą całkowitą.
...
Limit niezmienny (w MB) dla zarządzania pamięcią wymuszany tylko w przypadku wykrycia rywalizacji o pamięć w węźle. Wartość musi być dodatnią liczbą całkowitą.
...
Względna waga procesora CPU. Wartość musi być dodatnią liczbą całkowitą.
...
Procent użycia dostępnych procesorów (tylko system Windows). Wartość musi być dodatnią liczbą całkowitą. Jeśli dla pakietu usługi są określone limity procesora CPU, ten parametr jest skutecznie ignorowany.
...
Maksymalna szybkość operacji we/wy (odczyt i zapis) w odniesieniu do IOps, które mogą być używane. Wartość musi być dodatnią liczbą całkowitą.
...
Maksymalna wartość operacji we/wy (w bajtach na sekundę), która może być używana (odczyt i zapis). Wartość musi być dodatnią liczbą całkowitą.
...
Przydział dysku dla kontenerów.  Wartość musi być dodatnią liczbą całkowitą.
...
Limity pamięci jądra w bajtach.  Wartość musi być dodatnią liczbą całkowitą.  Zwróć uwagę, że jest to system Linux, a Docker w systemie Windows, jeśli jest ustawiony.
...
Rozmiar/dev/SHM w bajtach. W przypadku pominięcia system używa 64 MB.  Wartość musi być dodatnią liczbą całkowitą.  Zauważ, że jest to specyficzne dla systemu Linux, ale platforma Docker nie będzie w przypadku określenia błędu.  Jest on po prostu ignorowany.
...
Prawa do udzielenia: Odczytaj, Zmień lub pełna. Wartość domyślna to Read.
...
Limit CPU w liczbie rdzeni logicznych. Wartość musi być dodatnią liczbą całkowitą.
...
#### <a name="memoryinmb"></a>MemoryInMB
Limity pamięci w MB. Wartość musi być dodatnią liczbą całkowitą.
...
Określa maksymalny dopuszczalny procent usług w złej kondycji, zanim aplikacja zostanie uznana za złą. Domyślny procent: 0.
...
Określa maksymalny dopuszczalny procent partycji w złej kondycji, zanim usługa zostanie uznana za złą. Domyślny procent: 0.
...
Określa maksymalny dopuszczalny procent replik w złej kondycji, zanim partycja zostanie uznana za złą. Domyślny procent: 0.
