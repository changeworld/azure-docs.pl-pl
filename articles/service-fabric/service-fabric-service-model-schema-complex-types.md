...
Określ domyślne konto dla wszystkich pakietów kodu usługi czy don t mają szczególne RunAsPolicy, zdefiniowane w sekcji ServiceManifestImport.
|Atrybut|Wartość|
|---|---|
...
|Atrybut|Wartość|
|---|---|
|content|9 następującą liczbę elementów, atrybutów 5|
|Definicja|Globalnie|
...
Tryb izolacji dla kontenerów. Prawidłowe wartości to domyślne, proces lub hostów systemu Windows 10 — na funkcji Hyper-v (obsługiwana tylko w przypadku kontenerów Windows), obsługiwane jest tylko trybu izolacji funkcji Hyper-V, więc kontener działa w trybie izolacji funkcji Hyper-V, niezależnie od jej ustawień trybu izolacji.
|Atrybut|Wartość|
|---|---|
|name|Izolacja|
|Użyj|opcjonalne|
...
NetworkType. Obecnie jedynym obsługiwanym typem jest "Otwarte".
|Atrybut|Wartość|
|---|---|
|name|NetworkType|
|Użyj|Wymagane|
...
|Atrybut|Wartość|
|---|---|
|content|3 elementy, atrybuty (10)|
|Definicja|Globalnie|
...
#### <a name="port"></a>Port
Port zostaną zastąpione w manifeście usługi
|Atrybut|Wartość|
|---|---|
|name|Port|
|type|xs:String|
...
Protokół dla punktu końcowego. Punkty końcowe HTTPS musi mieć również EndpointCertificate i EndpointBindingPolicy zadeklarowane w manifeście aplikacji. Nie można zmienić Protokół w dalszej części uaktualnienie aplikacji. 
|Atrybut|Wartość|
|---|---|
|name|Protokół|
|type|xs:String|
...
|Atrybut|Wartość|
|---|---|
|content|18 elementy, atrybuty (0)|
|Definicja|Globalnie|
...
|Atrybut|Wartość|
|---|---|
|content|0 następującą liczbę elementów, atrybutów 9|
|Definicja|Globalnie|
...
Prawa do udzielania, domyślne jest do odczytu.
|Atrybut|Wartość|
|---|---|
|name|GrantRights|
|default|Odczyt|
...
Typ zasobu, zdefiniowany w manifeście usługi, punkt końcowy lub certyfikatów.
|Atrybut|Wartość|
|---|---|
|name|ResourceType|
|Użyj|opcjonalne|
...
|Atrybut|Wartość|
|---|---|
|content|8 następującą liczbę elementów, atrybutów 4|
|Definicja|Globalnie|
...
Określa maksymalną wartość procentową tolerowana usługi w złej kondycji, zanim aplikacja jest uznawana za złą. Domyślna wartość procentowa: 0.
|Atrybut|Wartość|
|---|---|
...
Określa maksymalną wartość procentową tolerowana partycje w złej kondycji, zanim usługa jest uznawana za złą. Domyślna wartość procentowa: 0.
|Atrybut|Wartość|
|---|---|
...
Określa maksymalną wartość procentową tolerowana repliki w złej kondycji, zanim partycji jest określana jako zła. Domyślna wartość procentowa: 0.
|Atrybut|Wartość|
|---|---|
