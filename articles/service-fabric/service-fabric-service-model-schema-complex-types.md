...
#### <a name="version"></a>Wersja
Zdefiniowane przez użytkownika ciąg wersji na potrzeby dokumentu manifestu klastra.
|Atrybut|Wartość|
|---|---|
|name|Wersja|
|Użyj|wymagane|
...
Tryb izolacji dla kontenera. Prawidłowe wartości to domyślnie procesu oraz funkcji Hyper-v (obsługiwane tylko dla kontenerów systemu windows).
|Atrybut|Wartość|
|---|---|
|type|xs:String|
|name|Izolacja|
...
Nazwa punktu końcowego, który musi być zadeklarowana w sekcji zasobów tego manifestu usługi.
|Atrybut|Wartość|
|---|---|
|name|EndpointRef|
...
Tworzenie wersji systemu operacyjnego. na przykład: 1809 dla RS1
|Atrybut|Wartość|
|---|---|
|type|xs:String|
...
Limity całkowitej ilości pamięci (pamięci + wymiany) w Megabajtach.
|Atrybut|Wartość|
|---|---|
|type|xs:String|
|name|MemorySwapInMB|
...
Limity zmienne pamięci w MB. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|type|xs:String|
...
Można używać procent dostępne procesory CPU (tylko system windows). Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|type|xs:String|
|name|CpuPercent|
...
Maksymalna szybkość we/wy pod względem IOps. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|type|xs:String|
|name|MaximumIOps|
...
Maksymalna przepustowość we/wy. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|type|xs:String|
...
Blok względną wagę we/wy. Musi być dodatnią liczbą całkowitą od 10 do 1000.
|Atrybut|Wartość|
|---|---|
|type|xs:String|
|name|BlockIOWeight|
...
Identyfikator typu grupy usług, na przykład "ActorQueueSGType" zdefiniowane przez użytkownika. Ta wartość jest używana w pliku ApplicationManifest.xml, aby zidentyfikować grupę usługi.
|Atrybut|Wartość|
|---|---|
...
Identyfikator tego manifestu usługi bez strukturalnych ciągu.
|Atrybut|Wartość|
|---|---|
|default||
|name|ManifestId|
...
#### <a name="servicetypename"></a>ServiceTypeName
Identyfikator typu usługi zdefiniowane przez użytkownika. Na przykład "QueueType" lub "CalculatorType". Ta wartość jest używana w pliku ApplicationManifest.xml do identyfikowania usługi.
|Atrybut|Wartość|
|---|---|
|name|ServiceTypeName|
|Użyj|wymagane|
