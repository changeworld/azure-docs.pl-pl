...
#### <a name="nodetyperef"></a>elementu nodeTypeRef
|Atrybut|Wartość|
|---|---|
|name|elementu nodeTypeRef|
|type|xs:String|
|Użyj|wymagane|
...
#### <a name="fabricsettings"></a>Element FabricSettings
|Atrybut|Wartość|
|---|---|
...
#### <a name="sectionname"></a>Parametrami SectionName
Nazwa sekcji ConfigPackage Settings.xml.
|Atrybut|Wartość|
|---|---|
|name|Parametrami SectionName|
|Użyj|wymagane|

#### <a name="mountpoint"></a>Punkt instalacji
|Atrybut|Wartość|
|---|---|
...
W tym artykule opisano zasady sieciowe, łącznie z pakietu usługi, dotyczące zasad sieci kontenera.
...
Limity pamięci w Megabajtach. Musi być dodatnią liczbą całkowitą. Pakiety kodu (kontenery lub procesy) nie mogą przydzielać pamięci ponad ten limit. Podjęcie próby takiego przydzielenia spowoduje wyjątek braku pamięci.
|Atrybut|Wartość|
|---|---|
|name|MemoryInMB|
|type|xs:String|
...
Całkowita ilość pamięci wymiany, które mogą być używane w MB. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|name|MemorySwapInMB|
|type|xs:String|
...
Miękki limit (w MB) dla nadzoru pamięci, który jest wymuszany, tylko wtedy, gdy wykryto rywalizacji o zasoby pamięci w węźle. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
...
Można używać procent dostępne procesory CPU (tylko Windows). Musi być dodatnią liczbą całkowitą. Jeśli podano limity procesora CPU dla pakietu z tego parametru skutecznie jest ignorowana.
|Atrybut|Wartość|
|---|---|
|name|CpuPercent|
|type|xs:String|
...
Maksymalna we/wy (Odczyt i zapis) pod kątem operacji We/Wy, które mogą być używane. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|name|MaximumIOps|
|type|xs:String|
...
Maksymalna operacji wejścia/wyjścia (w bajtach na sekundę) mogą być używane (Odczyt i zapis). Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
...
Limity pamięci jądra w bajtach.  Musi być dodatnią liczbą całkowitą.  Należy pamiętać, jest określone w systemie Linux i docker w systemie windows zgłosi błąd, jeśli ta opcja jest ustawiona.
|Atrybut|Wartość|
|---|---|
...
Rozmiar/dev/shm w bajtach. Jeśli argument jest pominięty, wówczas system używa 64MB.  Musi być dodatnią liczbą całkowitą.  Należy zauważyć, że to Linux określonych, jednak będą platformy docker nie generowanie błędu po podjęciu określony.  Jest po prostu ignorowane.
|Atrybut|Wartość|
|---|---|
|name|ShmSizeInMB|
|type|xs:String|
...
Procesor CPU limit liczby rdzeni logicznych. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|name|CpuCores|
|type|xs:String|
...
#### <a name="memoryinmb"></a>MemoryInMB
Limity pamięci w Megabajtach. Musi być dodatnią liczbą całkowitą.
|Atrybut|Wartość|
|---|---|
|name|MemoryInMB|
|type|xs:String|
...
#### <a name="nodename"></a>nodeName
Jest to nazwa węzła, do której uaktualnić sieci szkieletowej jest happe
|Atrybut|Wartość|
|---|---|
|name|nodeName|
|type|xs:String|
