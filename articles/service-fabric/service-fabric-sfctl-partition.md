---
title: Interfejs wiersza polecenia platformy Azure Service Fabric — partycja sfctl | Microsoft Docs
description: Zawiera Service Fabric opis poleceń partycji sfctl interfejsu wiersza polecenia.
...
| health | Pobiera kondycję określonej partycji Service Fabric. |
| info | Pobiera informacje o partycji Service Fabric. |
| list | Pobiera listę partycji usługi Service Fabric. |
| load | Pobiera informacje o ładowaniu określonej partycji Service Fabric. |
