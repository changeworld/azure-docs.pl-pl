...
* Konfigurowanie integracji usługi Log Analytics z usługą Service Fabric: [Konfigurowanie usługi Log Analytics dla klastra](service-fabric-diagnostics-oms-setup.md)
* Dowiedz się, jak skonfigurować usługi Log Analytics w celu monitorowania kontenerów: [Monitorowanie i Diagnostyka kontenerów Windows w usłudze Azure Service Fabric](service-fabric-tutorial-monitoring-wincontainers.md).
