---
title: Service Fabric platformy Azure z VS Code Wprowadzenie | Microsoft Docs
...
* Service Fabric: Utwórz aplikację 
* Service Fabric: Publikowanie aplikacji 
* Service Fabric: Wdróż aplikację 
* Service Fabric: Usuń aplikację  
* Service Fabric: Kompilowanie aplikacji 
* Service Fabric: Wyczyść aplikację 

### <a name="service-fabric-create-application"></a>Service Fabric: Utwórz aplikację

**Service Fabric: Polecenie Create** Application tworzy nową aplikację Service Fabric w bieżącym obszarze roboczym. W zależności od tego, które generatory narzędzia Yeoman są zainstalowane na komputerze deweloperskim, można utworzyć kilka typów aplikacji Service Fabric, w tym C#Java, kontenerów i projektów Gości. 

1.  **Wybierz Service Fabric: Dodaj usługę** — polecenie
...
**Service Fabric: Polecenie Dodaj** usługę dodaje nową usługę do istniejącej aplikacji Service Fabric. Aplikacja, do której zostanie dodana usługa, musi być katalogiem głównym obszaru roboczego. 

1.  **Wybierz Service Fabric: Dodaj polecenie** usługi.
...
**Service Fabric: Polecenie Publikuj** aplikację wdraża aplikację Service Fabric w klastrze zdalnym. Klaster docelowy może być bezpiecznym lub niezabezpieczonym klastrem. Jeśli parametry nie są ustawione w pliku Cloud. JSON, aplikacja jest wdrażana w klastrze lokalnym.
...
3.  **Wybierz Service Fabric: Polecenie publikowania** aplikacji.
...
**Service Fabric: Polecenie Wdróż** aplikację służy do wdrażania aplikacji Service Fabric w klastrze lokalnym. Przed użyciem polecenia upewnij się, że klaster lokalny jest uruchomiony. 

1. **Wybierz Service Fabric: Polecenie wdrożenia** aplikacji
...
3. Możesz również użyć **Service Fabric: Polecenie publikowania** aplikacji bez parametrów ustawionych w pliku Cloud. JSON do wdrożenia w klastrze lokalnym.
...
**Service Fabric: Polecenie Usuń** aplikację usuwa aplikację Service Fabric z klastra, który został wcześniej wdrożony, przy użyciu rozszerzenia vs Code. 

1.  **Wybierz Service Fabric: Usuń polecenie** aplikacji.
...
**Service Fabric: Polecenie Build** Application umożliwia tworzenie aplikacji w języku C# Java lub Service Fabric. 
...
2.  **Wybierz Service Fabric: Kompiluj polecenie** aplikacji.
3.  Dane wyjściowe procesu kompilacji są zapisywane w zintegrowanym terminalu.

### <a name="service-fabric-clean-application"></a>Service Fabric: Wyczyść aplikację
**Service Fabric: Polecenie Oczyść** aplikację usuwa wszystkie pliki jar i biblioteki natywne, które zostały wygenerowane przez kompilację. Prawidłowy tylko dla aplikacji Java. 

1.  Przed wykonaniem tego polecenia upewnij się, że jesteś w folderze głównym aplikacji. 
2.  **Wybierz Service Fabric: Wyczyść polecenie** aplikacji.
