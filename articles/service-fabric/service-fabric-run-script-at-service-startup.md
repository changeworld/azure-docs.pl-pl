...
---
# <a name="run-a-service-startup-script-as-a-local-user-or-system-account"></a>Uruchom skrypt uruchamiania usługi jako konto użytkownika lub systemu lokalnego
