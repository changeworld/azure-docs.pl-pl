---
title: Azure Service Fabric usługi modelu XML schematu elementu grup | Dokumentacja firmy Microsoft
description: Opisuje grup elementu schematu XML modelu usługi sieć szkieletowa usług.
...
## <a name="partitiondescriptiongroup-group"></a>PartitionDescriptionGroup grupy
Definiuje schemat partycjonowania dla usługi.

|Atrybut|Wartość|
|---|---|
|Zawartość|3 elementów:|
...
## <a name="scalingpolicymechanismgroup-group"></a>ScalingPolicyMechanismGroup grupy
Definiuje mechanizm skalowania.

|Atrybut|Wartość|
|---|---|
|Zawartość|2 elementów:|
...
## <a name="scalingpolicytriggergroup-group"></a>ScalingPolicyTriggerGroup grupy
