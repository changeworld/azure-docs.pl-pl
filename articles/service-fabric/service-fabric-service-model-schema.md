---
title: Opisy schematów XML modelu usługi sieci szkieletowej usługi Azure
description: Opis schematu XML modelu usługi sieci szkieletowej usług, w tym lokalizacji i podsumowania składników.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-documentation"></a>Dokumentacja schematu XML modelu usługi
Ten artykuł dokumentuje plik schematu ServiceFabricServiceModel.xsd zainstalowany przy sdk sieci szkieletowej usług.  Domyślnie plik schematu jest instalowany w *pliku C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Powiązania obszaru nazw

|Prefiks|Identyfikator URI obszaru nazw|
|---|---|
|Xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Podsumowanie komponentów 
Następujące składniki są zdefiniowane w ServiceFabricServiceModel.xsd:
- [257 elementów](service-fabric-service-model-schema-elements.md)
- [112 complexTypy](service-fabric-service-model-schema-complex-types.md)
- [1 prosteTyty](service-fabric-service-model-schema-simple-types.md)
