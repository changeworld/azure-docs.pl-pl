---
title: Azure opisy schemat XML modelu usługi Service Fabric service | Dokumentacja firmy Microsoft
description: W tym artykule opisano schemat XML modelu usług usługi Service Fabric.
...
W tym artykule opisano pliku schematu ServiceFabricServiceModel.xsd zainstalowane za pomocą zestawu SDK usługi Service Fabric.  Domyślnie plik schematu jest instalowany na *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Powiązania Namespace
...
- [112 complexType](service-fabric-service-model-schema-complex-types.md)
- [1 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 grup — element](service-fabric-service-model-schema-element-groups.md)
