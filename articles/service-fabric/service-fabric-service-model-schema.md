...
W tym artykule omówiono pliku schematu ServiceFabricServiceModel.xsd zainstalowane przy użyciu zestawu SDK sieci szkieletowej usług.  Domyślnie plik schematu jest instalowany na *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace powiązania
|Prefiks|Identyfikator URI Namespace|
|---|---|
|xs|http://www.w3.org/2001/XMLSchema|
|Brak|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>Składnik podsumowania 
Następujące składniki są zdefiniowane w http://schemas.microsoft.com/2011/01/fabric przestrzeni nazw w ServiceFabricServiceModel.xsd:
- [elementy 293](service-fabric-service-model-schema-elements.md)
- [elementy complexType 103](service-fabric-service-model-schema-complex-types.md)
- [1 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 elementu grupy](service-fabric-service-model-schema-element-groups.md)
- [16 grupy atrybutów](service-fabric-service-model-schema-attribute-groups.md)
