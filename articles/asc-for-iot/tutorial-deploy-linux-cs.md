---
title: Samouczek dotyczący instalacji i wdrażania systemu Linux C# agenta usługi Azure Security Center w wersji zapoznawczej IoT | Dokumentacja firmy Microsoft
...
ms.locfileid: "58541601"
---
# <a name="tutorial-deploy-asc-for-iot-c-based-security-agent-for-linux"></a>Samouczek: Wdrażanie usługi ASC dla IoT C#— na podstawie zabezpieczeń agenta dla systemu Linux
...
W tym samouczku wyjaśniono, jak zainstalować i wdrożyć usługi ASC dla IoT C#-agent zabezpieczenia oparty na w systemie Linux.
