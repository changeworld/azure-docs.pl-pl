---
title: 'Szybki start: tworzenie bliźniaczej reprezentacji modułu zabezpieczeń'
...
1. Ręczna edycja każdego modułu bliźniaczej reprezentacji indywidualnie z określonymi konfiguracjami dla każdego urządzenia.
