---
title: Opis agregacji zdarzeń Usługi Azure Security Center dla zdarzeń IoT| Dokumenty firmy Microsoft
...
Usługa Azure Security Center dla agentów zabezpieczeń IoT zbiera dane i zdarzenia systemowe z urządzenia lokalnego i wysyła te dane do chmury platformy Azure w celu przetwarzania i analizy. Agent zabezpieczeń zbiera wiele typów zdarzeń urządzenia, w tym nowy proces i nowe zdarzenia połączenia. Zarówno nowy proces, jak i nowe zdarzenia połączenia mogą się legalnie często występować na urządzeniu w ciągu sekundy, a chociaż ważne dla niezawodnego i kompleksowego bezpieczeństwa, liczba wiadomości, które agenci bezpieczeństwa są zmuszeni wysyłać, może szybko dotrzeć lub przekroczyć Centrum IoT limitów kwot i kosztów. Jednak te zdarzenia zawierają bardzo cenne informacje zabezpieczające, które mają kluczowe znaczenie dla ochrony urządzenia.
