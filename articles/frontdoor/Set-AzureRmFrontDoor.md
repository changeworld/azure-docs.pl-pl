...
ms.locfileid: "47048240"
---
# Zestaw AzureRmFrontDoor
Zaktualizuj moduł równoważenia obciążenia drzwi
...
## OPIS
**AzureRmFrontDoor zestaw** polecenie cmdlet do aktualizacji drzwiami frontowymi modułu równoważenia obciążenia. Jeśli nie podano parametrów wejściowych, stare parametrów przy użyciu istniejących drzwiami frontowymi będą używane.

## PRZYKŁADY

### Przykład 1: aktualizowanie istniejących drzwiami frontowymi FrontDoorName i ResourceGroupName.
```powershell
...
Aktualizowanie istniejących FrontDoor.

### Przykład 2: aktualizowanie istniejących drzwiami frontowymi z obiektem PSFrontDoor.
```powershell
...
### Przykład 3: aktualizowanie istniejących drzwiami frontowymi za pomocą ResourceId
```powershell
...
Stan operacyjny drzwiami frontowymi modułu równoważenia obciążenia.
...
### -InputObject
Obiekt wejściu do zaktualizowania.
...
### — Nazwa
Nazwa wejściu do zaktualizowania.
...
### -ResourceId
Identyfikator zasobu wejściu do zaktualizowania
