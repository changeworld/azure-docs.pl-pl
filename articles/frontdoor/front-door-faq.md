...
Dowiedz się więcej na temat wszystkich udokumentowanych [limitów czasu i limitów dla usługi Azure front-drzwi](https://docs.microsoft.com/azure/azure-subscription-service-limits#azure-front-door-service-limits).
