...
ms.locfileid: "47048010"
---
# Nowe AzureRmFrontDoorBackendObject
Utwórz obiekt PSBackend
...
## OPIS
Utwórz obiekt PSBackend drzwiami frontowymi tworzenia
...
### -Adres
Lokalizacja wewnętrznej bazy danych (adres IP lub nazwa FQDN)
...
### -BackendHostHeader
Wartość do użycia jako nagłówek hosta, wysyłane do wewnętrznej bazy danych. Wartość domyślna to adresów zaplecza.
...
Określa, czy włączyć, użyj tego wewnętrznej bazy danych. Wartość domyślna jest włączona.
...
Musi należeć do zakresu od 1 do 65535.
...
### -HttpsPort
Numer portu TCP protokołu HTTPS.
Musi należeć do zakresu od 1 do 65535.
Wartością domyślną jest 443
...
### — Priorytet
Priorytet na potrzeby równoważenia obciążenia.
Musi należeć do zakresu od 1 do 5.
...
### -Weight
Waga punktu końcowego dla celów równoważenia obciążenia.
Musi należeć do zakresu od 1 do 1000.
