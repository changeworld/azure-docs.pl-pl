...
ms.locfileid: "47047927"
---
# Zestaw AzureRmFrontDoorFireWallPolicy
Aktualizuj zasady zapory aplikacji sieci Web
...
## OPIS
**AzureRmFrontDoor zestaw** polecenie cmdlet do aktualizacji istniejących zasad zapory aplikacji sieci Web. Jeśli nie podano parametrów wejściowych, stare parametrów z istniejących zasad zapory aplikacji sieci Web będą używane.

## PRZYKŁADY

### Przykład 1: aktualizowanie istniejących zasad zapory aplikacji sieci Web
```powershell
...
Aktualizowanie istniejących zasad zapory aplikacji sieci Web

### Przykład 2: aktualizowanie istniejących zasad zapory aplikacji sieci Web
```powershell
...
### Przykład 3: aktualizowanie istniejących zasad zapory aplikacji sieci Web
```powershell
...
### Przykład 4: Aktualizacja wszystkich zasad zapory aplikacji sieci Web w $resourceGroup
```powershell
...
Aktualizacja wszystkich zasad zapory aplikacji sieci Web w $resourceGroup

## PARAMETRY

### -Elementu Customrule
Reguły niestandardowe wewnątrz zasad
...
Czy zasady są w włączony stan lub wyłączone.
Możliwe wartości to: "Wyłączone", "Enabled"
...
### -ManagedRule
Zarządzane reguły wewnątrz zasad
...
### — Tryb
W tym artykule opisano, jeśli jest w trybie wykrywania lub zapobiegania na poziomie zasad.
Możliwe wartości to: "Zapobieganie", "Wykrywania"
