...
ms.locfileid: "47047776"
---
# Nowe AzureRmFrontDoorMatchConditionObject
Utwórz obiekt MatchCondition do tworzenia zasad zapory aplikacji sieci Web
...
### -NegateCondition
Opisuje, czy jest to zanegowania warunku nie wartość domyślna to false
...
### -OperatorProperty
W tym artykule opisano operatora do dopasowania.
Możliwe wartości to: "Any", "IPMatch", "GeoMatch", "Contains", "Równe", "Mniejsze", "Równe", "Równy", "Większe", "Zaczyna się od", "EndsWith"
...
### -Selektor
Nazwa selektorze RequestHeader lub RequestBody do dopasowania
