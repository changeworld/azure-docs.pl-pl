...
ms.locfileid: "47048142"
---
# Nowe AzureRmFrontDoor

Tworzenie nowego modułu równoważenia obciążenia Azure drzwiami frontowymi
...
## OPIS
**New AzureRmFrontDoor** polecenie cmdlet tworzy nowy moduł równoważenia obciążenia Azure drzwiami frontowymi w określonej grupie zasobów w ramach bieżącej subskrypcji

## PRZYKŁADY

### Przykład 1: Tworzenie drzwiami frontowymi na podstawie podanych parametrów.
```powershell
...
Utwórz drzwiami frontowymi na podstawie podanych parametrów.

## PARAMETRY

### -Ustawień
Backendpools dostępne reguły routingu.
...
Atrybut EnabledState drzwiami frontowymi modułu równoważenia obciążenia.
...
### -FrontendEndpoint
Punkty końcowe frontonu jest dostępna dla reguły routingu.
...
### -HealthProbeSetting
Skojarzony z tym wystąpieniem drzwiami frontowymi ustawienia sondy kondycji.
...
Ustawienia skojarzone z tym wystąpieniem drzwiami frontowymi równoważenia obciążenia.
...
### -ResourceGroupName
Nazwa grupy zasobów, której zostanie utworzony drzwiami frontowymi.
...
### -RoutingRule
Reguły routingu są skojarzone z tym FrontDoor
