...
Można zmodyfikować pobrany plik XML profilu i dodać **\<trasę >\<includeroutes >\<destination >\<mask > \</route >\</includeroutes >\</destionation >\</mask >** Tagi
