...
2. Wybierz pozycję **+ Dodaj** , aby otworzyć stronę **Dodawanie połączenia** .
   ...
   ![Dodaj połączenie](./media/vpn-gateway-howto-vnet-vnet-resource-manager-portal/vnet1-to-vnet4.png "Dodawanie połączenia")
