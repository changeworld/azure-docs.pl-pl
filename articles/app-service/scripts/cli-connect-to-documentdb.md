---
title: Przykładowy skrypt interfejsu wiersza polecenia platformy Azure — łączenie aplikacji z usługą MongoDB (Cosmos DB) | Microsoft Docs
description: Przykładowy skrypt interfejsu wiersza polecenia platformy Azure — łączenie aplikacji z usługą MongoDB (Cosmos DB)
services: appservice
...
Ten przykładowy skrypt tworzy konto usługi Azure Cosmos DB przy użyciu interfejsu API usługi Cosmos DB dla usługi MongoDB oraz aplikacji usługi App Service. Następnie skrypt łączy parametry połączenia usługi MongoDB z aplikacją internetową przy użyciu ustawień aplikacji.
