---
title: Migrowanie aktywnej nazwy DNS do usługi Azure App Service | Dokumentacja firmy Microsoft
...
ms.locfileid: "38307300"
---
# <a name="migrate-an-active-dns-name-to-azure-app-service"></a>Migrowanie aktywnej nazwy DNS do usługi Azure App Service

W tym artykule dowiesz się, jak przeprowadzić migrację aktywnej nazwy DNS na [usługi Azure App Service](../app-service/app-service-web-overview.md) bez żadnych przestojów.
...
Jeśli nie masz Boisz się o przestoje w rozpoznawania nazw DNS, zobacz [mapowanie istniejącej niestandardowej nazwy DNS w usłudze Azure Web Apps](app-service-web-tutorial-custom-domain.md).
