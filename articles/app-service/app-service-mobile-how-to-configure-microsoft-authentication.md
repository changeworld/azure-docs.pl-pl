...
3. Kliknij przycisk **Dodaj aplikację**, następnie wpisz nazwę aplikacji i kliknij przycisk **Utwórz**.
...
## <a name="secrets"> </a>Dodaj informacje o Microsoft Account do aplikacji usługi aplikacji
