...
Czasami operacji zamiany zajmuje trochę czasu, takie jak kiedy aplikację, która jest wymieniany ma czas rozgrzewania długie. Można uzyskać więcej informacji na temat operacji wymiany w [dziennika aktywności](../azure-monitor/platform/activity-logs-overview.md) w [witryny Azure portal](https://portal.azure.com).
