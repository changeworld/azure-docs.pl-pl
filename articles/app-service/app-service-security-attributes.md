...
| Atrybut zabezpieczeń | Tak/Nie | Uwagi |
|---|---|--|
| Obsługa punktu końcowego usługi| Yes | Obecnie dostępne w wersji zapoznawczej dla usługi App Service. Zobacz [ograniczenia dostępu do usługi Azure App Service](app-service-ip-restrictions.md). |
