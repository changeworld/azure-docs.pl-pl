...
Ten artykuł ułatwia rozwiązywanie problemów z wydajnością aplikacji sieci web powolne w [usługi Azure App Service](https://go.microsoft.com/fwlink/?LinkId=529714).
