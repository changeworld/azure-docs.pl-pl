...
Aby użyć interfejsu wiersza polecenia platformy Azure, musisz [zainstalować Azure CLI 2.0](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest) na tym komputerze.
