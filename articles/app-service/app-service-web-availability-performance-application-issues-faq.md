...
Wiele czynników może przyczynić się do obniżyć wydajność aplikacji. Aby uzyskać szczegółowe kroki rozwiązywania problemów, zobacz [wydajność aplikacji sieci web powolne Rozwiązywanie problemów](app-service-web-troubleshoot-performance-degradation.md).
...
Aby uzyskać więcej informacji na temat połączeń wychodzących w aplikacji sieci web, zobacz wpis w blogu dotyczący [wychodzące połączenia w usłudze Azure websites](http://www.freekpaans.nl/2015/08/starving-outgoing-connections-on-windows-azure-web-sites/).
