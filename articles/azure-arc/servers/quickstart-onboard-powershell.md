...
* Jeśli Agent został już zainstalowany, wykonaj polecenie `/opt/azcmagent/bin/hybridrp_proxy add https://{proxy-url}:{proxy-port}`, które konfiguruje serwer proxy i ponownie uruchamia agenta.
