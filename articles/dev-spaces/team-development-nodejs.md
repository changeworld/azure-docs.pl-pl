---
title: Programowanie zespołowe za pomocą Azure Dev Spaces przy użyciu oprogramowania node. js i VS Code
...
ms.locfileid: "74129279"
---
# <a name="team-development-with-azure-dev-spaces-using-nodejs-and-vs-code"></a>Programowanie zespołowe za pomocą Azure Dev Spaces przy użyciu środowiska Node. js i VS Code
...
Przejdź do okna VS Code dla `mywebapi` i dokonaj edycji kodu do domyślnego programu obsługi GET `/` w `server.js`, na przykład:
