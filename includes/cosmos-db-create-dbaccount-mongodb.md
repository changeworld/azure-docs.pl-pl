...
3. W bloku **Nowe konto** określ bazę danych **MongoDB** jako interfejs API i wprowadź żądaną konfigurację dla konta usługi Azure Cosmos DB.
    ...
    * **Grupa zasobów** to nazwa grupy zasobów dla Twojego konta usługi Azure Cosmos DB. Wybierz pozycję **Utwórz nową**, a następnie wprowadź nazwę nowej grupy zasobów dla konta. Dla uproszczenia można użyć takiej samej nazwy jak identyfikator.
