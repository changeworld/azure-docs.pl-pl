...
| Zasób | Limit |
| --- | :--- |
| Standardowe grupy kontenerów sku na region na [subskrypcję](../articles/billing-buy-sign-up-azure-subscription.md) | 100<sup>1</sup> |
| Dedykowane grupy kontenerów sku na region na [subskrypcję](../articles/billing-buy-sign-up-azure-subscription.md) | 0<sup>1</sup> |
| Liczba kontenerów na grupę kontenerów | 60 |
| Liczba woluminów na grupę kontenerów | 20 |
| Porty na adres IP | 5 |
| Rozmiar dziennika wystąpienia kontenera — wystąpienie z uruchomieniem | 4 MB |
| Rozmiar dziennika wystąpienia kontenera — zatrzymane wystąpienie | 16 KB lub 1000 linii |
