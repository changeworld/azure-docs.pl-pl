...
**Nowsze zalecenie dotyczące rozmiaru**: [Seria Av2](../articles/virtual-machines/windows/sizes-general.md#av2-series)
...
|Rozmiar — rozmiar\nazwa | vCPU |Pamięć|Karty sieciowe (maks.)|Maksymalny rozmiar dysku tymczasowego |Maksymalnie z dyski z danymi (1023 GB każdego)|Maksymalnie z liczba operacji we/wy na sekundę (300 na dysk)|
|---|---|---|---|---|---|---|
...
| Rozmiar | vCPU | Pamięć: GiB | Magazyn tymczasowy (HDD): GiB | Maksymalna liczba dysków danych | Maksymalna przepływność dysków danych: liczba operacji we/wy na sekundę | Maksymalna liczba kart sieciowych/oczekiwana przepustowość sieci (MB/s)  |
| --- | --- | --- | --- | --- | --- | --- |
...
| Rozmiar | vCPU | Pamięć: GiB | Magazyn tymczasowy (HDD): GiB | Maksymalna liczba dysków danych | Maksymalna przepływność dysków danych: liczba operacji we/wy na sekundę | Maksymalna liczba kart interfejsów sieciowych|
| --- | --- | --- | --- | --- | --- | --- |
...
<sup>1</sup> W przypadku aplikacji MPI dedykowana sieć zaplecza RDMA jest włączana za pomocą sieci InfiniBand z QDR, która zapewnia bardzo małe opóźnienia i wysoką przepustowość.  

<br>

### <a name="d-series"></a>Seria D  

**Nowsze zalecenie dotyczące rozmiaru**: [Seria Dv3](../articles/virtual-machines/windows/sizes-general.md#dv3-series-1)
...
**Nowsze zalecenie dotyczące rozmiaru**: [Seria DSv3](https://docs.microsoft.com/azure/virtual-machines/windows/sizes-general#dsv3-series-1)
...
| Rozmiar          | vCPU | Pamięć (GiB) | Magazyn tymczasowy (GiB) | Maksymalna liczba dysków danych | Maksymalna przepływność magazynu (IOPS/MB/s) | Maksymalna przepływność dysku w pamięci podręcznej (IOPS/MB/s) | Maksymalna liczba kart sieciowych/oczekiwana przepustowość sieci (MB/s) | 
|----------------|-----------|-------------|--------------------------|----------------|-------------------------------------------------------------|-------------------------------------------|------------------------------| 
