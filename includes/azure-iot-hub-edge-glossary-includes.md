...
Urządzenia brzegowe IoT mieć zainstalowane środowisko uruchomieniowe krawędzi IoT i są oznaczone jako **urządzenia IoT** w szczegółowych informacji o urządzeniu. Dowiedz się, jak [wdrażanie Azure IoT Edge na urządzeniu symulowane w systemie Linux — Podgląd](https://docs.microsoft.com/azure/iot-edge/tutorial-simulate-device-linux).
...
Dokument Json zawierający informacje do skopiowania w co najmniej jeden IoT urządzenia brzegowe twin(s) modułu wdrażania zestaw modułów, trasy i skojarzone modułu żądana właściwości.
...
Środowisko uruchomieniowe krawędzi IoT zawiera wszystko, co Microsoft dystrybuuje instalowanego na urządzenia IoT. Zawiera agenta krawędzi, Centrum krawędzi i demona zabezpieczeń IoT krawędzi.
