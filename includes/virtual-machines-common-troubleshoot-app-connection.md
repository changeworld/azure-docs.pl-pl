...
* [Rozwiązywanie problemów z połączeniami pulpitu zdalnego na podstawie Windows maszyny wirtualnej platformy Azure](../articles/virtual-machines/windows/troubleshoot-rdp-connection.md)
* [Rozwiązywanie problemów z połączeniami protokołu Secure Shell (SSH) opartą na systemie Linux maszyny wirtualnej platformy Azure](../articles/virtual-machines/linux/troubleshoot-ssh-connection.md).

> [!NOTE]
> Platforma Azure ma dwa różne modele wdrażania do tworzenia i pracy z zasobami: [usługi Resource Manager i Model Klasyczny](../articles/resource-manager-deployment-model.md). W tym artykule przedstawiono oba modele, ale firma Microsoft zaleca przeprowadzanie większości nowych wdrożeń z zastosowaniem modelu wdrażania przy użyciu usługi Azure Resource Manager.
...
* Utwórz ponownie punkt końcowy / reguły zapory / reguł Sieciowej grupy zabezpieczeń sieciowych
  * [Model usługi Resource Manager — Zarządzanie sieciowymi grupami zabezpieczeń](../articles/virtual-network/manage-network-security-group.md)
  * [Model klasyczny — punkty końcowe zarządzających usługami w chmurze](../articles/cloud-services/cloud-services-enable-communication-role-instances.md)
* Łączenie z innej lokalizacji, np. innej sieci wirtualnej platformy Azure
* Ponowne wdrażanie maszyny wirtualnej
  * [Ponowne wdrażanie maszyny Wirtualnej Windows](../articles/virtual-machines/windows/redeploy-to-new-node.md)
  * [Ponowne wdrażanie maszyny Wirtualnej systemu Linux](../articles/virtual-machines/linux/redeploy-to-new-node.md)
...
* W przypadku maszyn wirtualnych utworzonych za pomocą klasycznego modelu wdrażania:
  ...
  * Aby uzyskać więcej informacji, zobacz [jak się punkty końcowe do maszyny wirtualnej](../articles/virtual-machines/windows/classic/setup-endpoints.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json).
* W przypadku maszyn wirtualnych utworzonych za pomocą modelu wdrażania usługi Resource Manager:
  ...
  * Aby uzyskać więcej informacji, zobacz [co to jest sieciowa grupa zabezpieczeń?](../articles/virtual-network/security-overview.md)
