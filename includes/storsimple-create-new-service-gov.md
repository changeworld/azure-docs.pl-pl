...
3. W wyświetlonym formularzu wykonaj następujące czynności:
   ...
   2. Wypełnij pole **Lokalizacja** dla usługi. Lokalizacja odwołuje się do regionu geograficznego, w której chcesz wdrożyć urządzenie. Wybierz **Iowa Govt USA** lub **Govt Virgina USA**.
   ...
   4. Wybierz opcję **Utwórz nowe konto magazynu**, aby automatycznie utworzyć konto magazynu w usłudze. To konto magazynu będzie miało specjalną nazwę, np. „storsimplebwv8c6dcnf”.
