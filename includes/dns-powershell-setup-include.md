...
Otwórz konsolę programu PowerShell i połącz się ze swoim kontem. Aby uzyskać więcej informacji, zobacz [Zaloguj](/azure/install-az-ps.md?view=azps-1.2.0#sign-in)(/ powershell/azure/install-az-ps?view=azps-1.4.0#sign-in).
