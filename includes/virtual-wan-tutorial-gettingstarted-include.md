...
1. Tworzenie lokacji
2. Tworzenie koncentratorów
3. Kojarzenia lokacji z koncentratorami
4. Pobieranie pliku
5. Łączenie koncentratorów z siecią wirtualną (opcjonalne w przypadku niektórych konfiguracji)