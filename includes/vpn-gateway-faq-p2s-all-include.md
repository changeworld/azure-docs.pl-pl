...
### <a name="what-should-i-do-if-i-am-getting-a-certificate-mismatch-when-connecting"></a>Co należy zrobić, jeśli podczas nawiązywania połączenia występuje niezgodność certyfikatu?
