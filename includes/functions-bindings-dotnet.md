...
ms.locfileid: "60713528"
---
Poniższa tabela zawiera listę atrybutów powiązania, które są dostępne w projekcie biblioteki klas usługi Azure Functions i wyzwalaczy. Wszystkie atrybuty są w przestrzeni nazw `Microsoft.Azure.WebJobs`.
