...
* Musisz autoryzować się tego nowego Identyfikatora klienta musi mieć następujące uprawnienia dostępu: **uzyskać**, **wrapKey**, **unwrapKey**. Jest to zrobić za pomocą [AzKeyVaultAccessPolicy zestaw](https://docs.microsoft.com/powershell/module/azurerm.keyvault/Set-AzKeyVaultAccessPolicy) polecenia cmdlet. Aby uzyskać więcej informacji, zobacz [Zezwól aplikacji na używanie klucza lub klucza tajnego](../articles/key-vault/key-vault-get-started.md#authorize).
