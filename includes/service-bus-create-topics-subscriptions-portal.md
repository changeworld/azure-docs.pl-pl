...
## <a name="create-a-subscription-to-the-topic"></a>Tworzenie subskrypcji tematu
...
3. Na stronie **Tworzenie subskrypcji** wpisz **nazwę** subskrypcji, a następnie wybierz pozycję **Utwórz**. 
