...
Lsv2 serii funkcje wysokiej przepływności, małego opóźnienia, jest bezpośrednio zamapowany Magazyn lokalny NVMe systemem [AMD EPYC<sup>TM</sup> 7551 procesora](https://www.amd.com/en/products/epyc-7000-series) ze wszystkich rdzeni zwiększanie wyniku 2.55 GHz, a maksymalna boost GHz 3.0. Maszyny wirtualne z serii Lsv2 są dostępne w rozmiarach od 8 do 80 procesora wirtualnego vCPU w jednoczesnych konfiguracji wielowątkowości.  Brak pojemności 8 GiB pamięci na procesor wirtualny vCPU i jedno urządzenie M.2 dyski SSD NVMe 1.92TB na 8 wirtualnych procesorów CPU, i do 19,2 TB (10x1.92TB) dostępna w wersji 2 L80s.
...
Magazyn Preminu buforowania: Nieobsługiwane

| Rozmiar          | Procesor wirtualny | Pamięć (GiB) | Dysku tymczasowego<sup>1</sup> (GiB) | Dyski NVMe | Przepływność dysków NVMe<sup>2</sup> (odczytu na SEKUNDĘ / MB/s) | Rozmiar pamięci podręcznej hosta<sup>3</sup> | Dyski z danymi maksymalna | Maksymalna liczba kart sieciowych / oczekiwana przepustowość sieci (MB/s) | 
|---------------|-----------|-------------|--------------------------|----------------|---------------------------------------------------|-------------------------------------------|------------------------------|------------------------------| 
| Standard_L8s_v2   |  8 |  64 |  80 |  1x1.92 TB  | 340,000 / 2000 | ND | 16 | 2 / 3,200  | 
| Standard_L16s_v2  | 16 | 128 | 160 |  2x1.92 TB  | 680,000 / 4 500 | ND | 32 | 4 / 6400  | 
...
| Standard_L80s_v2  | 80 | 640 | 800 | 10x1.92TB   | 3.4 M / 22 000   | ND | 32 | 8 / 32000 |
