...
2. Użyj ustawień aplikacji funkcji podanych w tabeli pod obrazem.
    ...
    | **[Application Insights](../articles/azure-functions/functions-monitoring.md)** | Domyślne | Usługa Application Insights jest domyślnie włączona. Wybierz lokalizację blisko aplikacji funkcji.  |
