...
| --- | --- | --- |
|   D15_v2  |   Wyłączone     |   D15_v2 and D15i_v2 |    
|   D15_v2  |   Włączone  |   D15_v2 series and D15i_v2 will all receive the RI benefit. |    
|   D14_v2  |   Włączone  |   D15_v2 series and D15i_v2 will all receive the RI benefit. |    
...
| RI |  Instance Size Flexibility | Benefit eligibility |   
| --- | --- | --- |
| D15_v2 |  Wyłączone |   D15_v2 only  
| D15_v2 |  Włączone |    D15_v2 series will receive the RI benefit. The new D15i_v2 will not be eligible for RI benefit from this RI type. | 
| D15i_v2 |     Wyłączone | D15i_v2 only |  
| D15i_v2 |     Włączone  | D15i_v2 only | 
