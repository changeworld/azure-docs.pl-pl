...
| Zabezpieczenie domyślne | Publiczny adres IP, publiczne punkty końcowe Load Balancer i wewnętrzne punkty końcowe Load Balancer są zamykane do przepływów przychodzących, chyba że jest to dozwolone przez grupę zabezpieczeń sieci. | Otwórz domyślnie. Opcjonalna Grupa zabezpieczeń sieci. |
