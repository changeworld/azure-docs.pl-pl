...
Wybierz pozycję **Utwórz nową dzierżawę usługi Azure AD B2C**. Ustawienia określone w poniższej tabeli użyj nazwy firmy Contoso jako przykład. Należy podać własną nazwę organizacji i nazwa dzierżawy unikatowy, podczas tworzenia dzierżawy.  
...
| **Początkowa nazwa domeny** |  ContosoB2CTenant | Nazwa domeny dla dzierżawy usługi B2C. Domyślnie obejmuje początkowej nazwy domeny. onmicrosoft.com. Jeśli tworzysz to dzierżawa testowa, wybierz nazwę nieprodukcyjną, taką jak ContosoB2CTesting. |
