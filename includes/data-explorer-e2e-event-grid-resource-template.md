...
ms.locfileid: "73057288"
---
## <a name="azure-resource-manager-template"></a>Szablon usługi Azure Resource Manager

W tym artykule szablon Azure Resource Manager służy do tworzenia grupy zasobów, konta magazynu i kontenera, centrum zdarzeń oraz klastra Eksplorator danych platformy Azure i bazy danych. Zapisz następującą zawartość w pliku o nazwie `template.json`, który zostanie użyty do uruchomienia przykładu kodu.
