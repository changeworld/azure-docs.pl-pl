...
Aby znaleźć wersję programu PowerShell, które uruchamiasz lokalnie, użyj polecenia cmdlet "Get-Module - ListAvailable AzureRM". Jeśli konieczne będzie uaktualnienie, zobacz [Instalowanie modułu programu Azure PowerShell](/powershell/azure/install-azurerm-ps). Aby uzyskać więcej informacji, zobacz [Instalowanie i konfigurowanie programu Azure PowerShell](/powershell/azure/overview).