...
Ten przewodnik przedstawia, jak natywną aplikację .NET Desktop Windows (XAML) można uzyskać token dostępu i wywołania interfejsu API programu Microsoft Graph lub innych interfejsów API, które wymagają tokenów dostępu z punktu końcowego usługi Azure Active Directory w wersji 2.
