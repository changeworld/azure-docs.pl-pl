...
3. W oknie dialogowym **Tworzenie przestrzeni nazw** wykonaj następujące czynności: 
    1. Wprowadź **nazwę przestrzeni nazw**. System od razu sprawdza, czy nazwa jest dostępna. Aby uzyskać listę reguł nazewnictwa przestrzeni nazw, zobacz [Tworzenie interfejsu API REST przestrzeni nazw](/rest/api/servicebus/create-namespace).
