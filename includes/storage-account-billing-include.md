...
Koszty magazynu są obliczane na podstawie następujących czynników: regionu/lokalizacji, typu konta, warstwy dostępu, pojemności magazynu, schematu replikacji, transakcji magazynu i danych wychodzących.
...
* **Dane** wychodzące odnoszą się do wszystkich danych transferowanych z regionu platformy Azure. Jeśli do danych na koncie magazynu uzyskuje się dostęp za pośrednictwem aplikacji, która nie działa w tym samym regionie, naliczane są opłaty za wyjście danych. Aby uzyskać informacje o korzystaniu z grup zasobów w celu grupowania danych i usług w tym samym regionie w celu ograniczenia opłat za ruch wychodzący, zobacz [co to jest Grupa zasobów platformy Azure?](https://docs.microsoft.com/azure/cloud-adoption-framework/govern/resource-consistency/resource-access-management#what-is-an-azure-resource-group). 
