...
- **Certyfikat przedsiębiorstwa:**
  ...
  - Jeśli używasz rozwiązania z certyfikatem przedsiębiorstwa, wygeneruj certyfikat klienta przy użyciu nazwy pospolitej formatu wartości nazwy *\@yourdomain. com*. Użyj tego formatu zamiast formatu *nazwa domeny\nazwa użytkownika*.
