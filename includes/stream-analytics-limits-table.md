...
| --- | --- | --- |
| Maksymalna liczba jednostek przesyłania strumieniowego na subskrypcję na region |200 |Żądanie zwiększenia jednostek przesyłania strumieniowego dla subskrypcji powyżej wartości 200 jest możliwe, kontaktując się z [Microsoft Support](https://support.microsoft.com/en-us). |
