...
> [!TIP]
> Można wykonać poniższe polecenia programu PowerShell, aby wygenerować sygnaturę dostępu współdzielonego usługi dla konta magazynu (zamienić posiadaczy miejsc i udzielić potrzebnego uprawnienia): `$context = New-AzStorageContext -StorageAccountName <accountName> -StorageAccountKey <accountKey>`
