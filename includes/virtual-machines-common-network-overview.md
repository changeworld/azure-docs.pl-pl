...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Użyj [AzureRmNetworkInterface nowy](/powershell/module/azurerm.network/new-azurermnetworkinterface) z **- PublicIpAddressId** parametr, aby dostarczyć identyfikator publiczny adres IP, która została wcześniej utworzona. |
| [Interfejs wiersza polecenia platformy Azure](../articles/virtual-machines/linux/multiple-nics.md) | Aby dostarczyć identyfikator publiczny adres IP, która została wcześniej utworzona, użyj [tworzenie kart interfejsu sieciowego az](https://docs.microsoft.com/cli/azure/network/nic#create) z **— adres ip publicznego** parametru. |
