...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Użyj [New AzNetworkInterface](https://docs.microsoft.com/powershell/module/azurerm.network/new-aznetworkinterface) z **- PublicIpAddressId** parametru, aby podać identyfikator publiczny adres IP, która została wcześniej utworzona. |
...
| [Azure PowerShell](../articles/virtual-network/virtual-network-deploy-static-pip-arm-ps.md) | Możesz użyć [New AzPublicIpAddress](https://docs.microsoft.com/powershell/module/azurerm.network/new-azpublicipaddress) z **— metodę AllocationMethod** parametr jako dynamicznym lub statycznym. |
...
| [Azure PowerShell](../articles/virtual-network/quick-create-powershell.md) | Możesz użyć [New AzVirtualNetworkSubnetConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzVirtualNetworkSubnetConfig) i [New AzVirtualNetwork](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzVirtualNetwork) utworzyć podsieć i sieć wirtualną. Można również użyć [AzVirtualNetworkSubnetConfig Dodaj](https://docs.microsoft.com/powershell/module/azurerm.network/add-azvirtualnetworksubnetconfig) dodać podsieć do istniejącej sieci wirtualnej. |
...
| [Azure PowerShell](../articles/virtual-network/tutorial-filter-network-traffic.md) | Użyj [New AzNetworkSecurityRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzNetworkSecurityRuleConfig) i podaj wymagane informacje dotyczące reguły. Użyj [New AzNetworkSecurityGroup](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzNetworkSecurityGroup) do utworzenia sieciowej grupy zabezpieczeń. Użyj [AzVirtualNetworkSubnetConfig zestaw](https://docs.microsoft.com/powershell/module/azurerm.network/Set-AzVirtualNetworkSubnetConfig) skonfigurować sieciowej grupy zabezpieczeń dla podsieci. Użyj [AzVirtualNetwork zestaw](https://docs.microsoft.com/powershell/module/azurerm.network/set-azvirtualnetwork) można dodać sieciowej grupy zabezpieczeń do sieci wirtualnej. |
