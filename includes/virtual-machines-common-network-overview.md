...
Możesz utworzyć Maszynę wirtualną z wieloma kartami sieciowymi i Dodaj lub usuń karty sieciowe w całym cyklu życia maszyny wirtualnej. Wiele kart sieciowych umożliwia maszyny Wirtualnej w celu połączenia do różnych podsieci oraz wysyłania i odbierania ruchu za pośrednictwem najbardziej odpowiedniego interfejsu.
...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Użyj [New-AzureRmNetworkInterface](/powershell/module/azurerm.network/new-azurermnetworkinterface) z **- PublicIpAddressId** parametru, aby podać identyfikator publiczny adres IP, która została wcześniej utworzona. |
| [Interfejs wiersza polecenia platformy Azure](../articles/virtual-machines/linux/multiple-nics.md) | Aby podać identyfikator publiczny adres IP, która została wcześniej utworzona, użyj [tworzenie az sieciowego](https://docs.microsoft.com/cli/azure/network/nic#create) z **--public-ip-address** parametru. |
...
| [Azure PowerShell](../articles/load-balancer/load-balancer-get-started-internet-arm-ps.md) | Aby podać identyfikator publiczny adres IP, która została wcześniej utworzona, użyj [New-AzureRmLoadBalancerFrontendIpConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerFrontendIpConfig) z **- PublicIpAddress** parametru. Użyj polecenia [New-AzureRmLoadBalancerBackendAddressPoolConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerBackendAddressPoolConfig), aby utworzyć konfigurację puli adresów zaplecza. Użyj polecenia [New-AzureRmLoadBalancerInboundNatRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerInboundNatRuleConfig), aby utworzyć reguły NAT dla ruchu przychodzącego przy użyciu utworzonej konfiguracji adresów IP frontonu. Użyj polecenia [New-AzureRmLoadBalancerProbeConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerProbeConfig), aby utworzyć wymagane sondy. Użyj polecenia [New-AzureRmLoadBalancerRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerRuleConfig), aby utworzyć konfigurację modułu równoważenia obciążenia. Użyj polecenia [New-AzureRmLoadBalancer](/powershell/module/azurerm.network/new-azurermloadbalancer), aby utworzyć moduł równoważenia obciążenia.|
...
| [Azure PowerShell](../articles/load-balancer/load-balancer-get-started-ilb-arm-ps.md) | Użyj polecenia [New-AzureRmLoadBalancerFrontendIpConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerFrontendIpConfig) z parametrem **-PrivateIpAddress**, aby podać prywatny adres IP w podsieci. Użyj polecenia [New-AzureRmLoadBalancerBackendAddressPoolConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerBackendAddressPoolConfig), aby utworzyć konfigurację puli adresów zaplecza. Użyj polecenia [New-AzureRmLoadBalancerInboundNatRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerInboundNatRuleConfig), aby utworzyć reguły NAT dla ruchu przychodzącego przy użyciu utworzonej konfiguracji adresów IP frontonu. Użyj polecenia [New-AzureRmLoadBalancerProbeConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerProbeConfig), aby utworzyć wymagane sondy. Użyj polecenia [New-AzureRmLoadBalancerRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzureRmLoadBalancerRuleConfig), aby utworzyć konfigurację modułu równoważenia obciążenia. Użyj polecenia [New-AzureRmLoadBalancer](/powershell/module/azurerm.network/new-azurermloadbalancer), aby utworzyć moduł równoważenia obciążenia.|
