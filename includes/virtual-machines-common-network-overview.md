...
| Metoda | Opis |
| ------ | ----------- |
| Azure Portal | [W Azure Portal można zrównoważyć obciążenie ruchem wewnętrznym przy użyciu podstawowego modułu równoważenia obciążenia](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md). |
