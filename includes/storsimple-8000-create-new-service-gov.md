...
ms.locfileid: "66118190"
---
#### <a name="to-create-a-new-service"></a>Aby utworzyć nową usługę
1. Użyj poświadczeń konta Microsoft do logowania się w [portalu platformy Microsoft Azure dla instytucji rządowych](https://portal.azure.us/).
2. W portalu dla instytucji rządowych, kliknij przycisk **+** a następnie w witrynie marketplace kliknij **holograficznych**. Wyszukaj pozycję _Urządzenie fizyczne StorSimple_. Wybierz i kliknij pozycję **Seria urządzeń fizycznych StorSimple**, a następnie kliknij pozycję **Utwórz**. Alternatywnie w portalu dla instytucji rządowych, kliknij przycisk **+** a następnie w obszarze **magazynu**, kliknij przycisk **seria urządzeń fizycznych StorSimple**.
