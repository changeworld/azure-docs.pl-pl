...
3. W bloku **Menedżer urządzeń StorSimple** wykonaj następujące kroki:
   ...
   4. Wypełnij pole **Lokalizacja** dla usługi. Lokalizacja odwołuje się do regionu geograficznego, w której chcesz wdrożyć urządzenie. Wybierz **USGov Iowa** lub **USGov Virgina**.
