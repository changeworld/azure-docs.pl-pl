...
* [RogueWave opartych na systemie CentOS HPC](https://azuremarketplace.microsoft.com/marketplace/apps/RogueWave.CentOSbased74HPC?tab=Overview)
...
*  [Aparat serwera siatki TIBCO](https://azuremarketplace.microsoft.com/marketplace/apps/tibco-software.gridserverlinuxengine?tab=Overview)
...
* [Renderowanie aplikacji](../articles/batch/batch-rendering-service.md) w usłudze Azure Batch, takich jak Autodesk Maya, 3ds Max i Arnold, Chaos Group V-Ray i Blender
...
Wydajne zarządzanie typowych obciążeń z łatwością podczas tworzenia i optymalizowania HPC klastrów na maszynach wirtualnych platformy Azure za pomocą [Azure CycleCloud](https://docs.microsoft.com/azure/cyclecloud/overview).
...
Obciążenia na dużą skalę usługi Batch i HPC mają wymagania dla magazynu danych i dostępu, które przekraczają możliwości chmury tradycyjnych systemów plików. 

Więcej informacji:

* [VFXT Avere dla platformy Azure](../articles/avere-vfxt/avere-vfxt-overview.md) 
* [Równoległe systemy plików wirtualnych na platformie Azure](https://azure.microsoft.com/resources/parallel-virtual-file-systems-on-microsoft-azure/) tym [Lustre](http://lustre.org/) i [BeeGFS](http://www.beegfs.com/content/).
...
* [Usługa Machine Learning](../articles/machine-learning/service/overview-what-is-azure-ml.md)
...
* Dowiedz się więcej na temat rozwiązania platformy Azure dla [o wysokiej wydajności obliczeniowej](https://azure.microsoft.com/solutions/high-performance-computing/), [renderowania](https://azure.microsoft.com/solutions/big-compute/rendering/), [bankowości i rynków kapitałowych](https://finance.azure.com/), i [genomics](https://enterprise.microsoft.com/industries/health/genomics/).

* Dowiedz się więcej o [architektury rozwiązań dużych obliczeń](https://azure.microsoft.com/solutions/architecture/?solution=high-performance-computing) na platformie Azure.
