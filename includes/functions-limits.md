...
| --- | --- | --- | --- |
| Skalowanie w poziomie | Sterowane zdarzeniami | Sterowane zdarzeniami | [Ręczne/automatyczne skalowanie](../articles/app-service/web-sites-scale.md) | 
