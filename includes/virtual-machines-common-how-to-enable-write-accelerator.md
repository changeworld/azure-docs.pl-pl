...
Accelerator to funkcje, które jest pierwsze wprowadzanie M serii maszyn wirtualnych na magazyn Azure dysków zarządzanych w warstwie Premium wyłącznie zapisu. Accelerator zapisu nie jest dostępna z żadnych innych maszyn wirtualnych serii na platformie Azure, z wyjątkiem serii M. Jako nazwa stany, celem funkcji jest zwiększyć czas oczekiwania operacji We/Wy zapisu w usłudze Azure Premium Storage. 
...
Zapisu akceleratora ma być używane jako woluminy, które zawierają dziennika transakcji lub wykonaj ponownie dzienniki systemu DBMS. Nie zaleca się na użytek akceleratora zapisu Azure woluminach danych DBMS jako funkcja została zoptymalizowana do można użyć w odniesieniu do dysków dziennika.

Azure akceleratora zapisu działa tylko w połączeniu z [dyskach zarządzanych Azure](https://azure.microsoft.com/services/managed-disks/). 
...
Włączania zapisu akceleratora działających dysków, nie powinno być konieczne dla programu SAP związane z konfiguracji maszyny Wirtualnej
