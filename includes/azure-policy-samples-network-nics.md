...
ms.locfileid: "67183377"
---
### <a name="network-interfaces"></a>Interfejsy sieciowe

|  |  |
|---------|---------|
| [NSG X on every NIC](../articles/governance/policy/samples/nsg-on-nic.md) (Sieciowa grupa zabezpieczeń X na każdej karcie sieciowej) | Wymaga, aby określona sieciowa grupa zabezpieczeń była używana z każdym wirtualnym interfejsem sieciowym. Należy określić identyfikator sieciowej grupy zabezpieczeń do użycia. |
