...
1. Wybierz nowy wykres **Eksploratora** > **New Graph**danych .
...
2. Na stronie **Dodaj graf** wprowadź ustawienia dla nowego grafu.
    ...
    Klucz partycji| /pk |Wszystkie konta usługi Cosmos DB potrzebują klucza partycji do skalowania w poziomie. Dowiedz się, jak wybrać odpowiedni klucz partycji w [artykule Partycjonowanie danych wykresu](https://docs.microsoft.com/azure/cosmos-db/graph-partitioning).
