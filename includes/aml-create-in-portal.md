...
1. W lewym górnym rogu portalu, wybierz **Utwórz zasób**.
   ...
   ![Tworzenie zasobu w witrynie Azure Portal](./media/aml-create-in-portal/portal-create-a-resource-05-2019.png)
...
1. Na pasku wyszukiwania wprowadź **uczenia maszynowego**. Wybierz **obszaru roboczego usługi Machine Learning** wynik wyszukiwania.
   ...
   ![Wyszukiwania dla obszaru roboczego](./media/aml-create-in-portal/allservices-search-05-2019.png)

1. W **obszar roboczy usługi uczenie Maszynowe** okienku wybierz **Utwórz** do rozpoczęcia.

    ![Przycisk Utwórz](./media/aml-create-in-portal/portal-create-button-05-2019.png)
...
1. W **obszar roboczy usługi uczenie Maszynowe** okienku konfigurowanie obszaru roboczego.
   ...
   Grupa zasobów | Użyj istniejącej grupy zasobów w ramach subskrypcji, lub wprowadź nazwę, aby utworzyć nową grupę zasobów. Grupa zasobów zawiera powiązane zasoby rozwiązania platformy Azure. W tym przykładzie używamy **docs aml**. 
   ...
   ![Tworzenie obszaru roboczego](./media/aml-create-in-portal/workspace-create-main-tab-05-2019.png)

1. Aby rozpocząć proces tworzenia, wybierz opcję **przeglądu + Utwórz**.

    ![Przycisk Utwórz](./media/aml-create-in-portal/workspace-create-main-review-button-05-2019.png)
...
1. Przejrzyj konfigurację obszaru roboczego. Jeśli jest on poprawny, wybierz opcję **Utwórz**. Może upłynąć kilka minut, aby utworzyć obszar roboczy.
    ...
    ![Przycisk Utwórz](./media/aml-create-in-portal/workspace-create-review-tab-05-2019.png)
...
1. Po zakończeniu procesu pojawi się komunikat o powodzeniu wdrożenia. Jest również obecny w sekcji powiadomienia. Aby wyświetlić nowy obszar roboczy, wybierz **przejdź do zasobu**.
   ...
   ![Stan tworzenia obszaru roboczego](./media/aml-create-in-portal/notifications-05-2019.png)
