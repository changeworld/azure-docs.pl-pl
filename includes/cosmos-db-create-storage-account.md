...
Można również utworzyć konto magazynu platformy Azure przy użyciu [programu Azure PowerShell](../articles/storage/common/storage-powershell-guide-full.md) lub [interfejsu wiersza polecenia Azure](../articles/storage/common/storage-azure-cli.md).
