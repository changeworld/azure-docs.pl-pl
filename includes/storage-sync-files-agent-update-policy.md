...
Istnieją trzy zatwierdzone i przetestowane sposobów instalowania aktualizacji agenta usługi Azure File Sync. Te aktualizacji pracy ścieżki dla wersji głównych i pomocniczych.
...
3. **Pobierz najnowsze Instalatora agenta usługi Azure File Sync z [Microsoft Download Center](https://go.microsoft.com/fwlink/?linkid=858257). Pobierz Instalatora jest pakiet Microsoft Installer lub pliku wykonywalnego msi.**  
    Aby uaktualnić istniejącą instalację agenta usługi Azure File Sync, odinstalować starszej wersji, a następnie zainstaluj najnowszą wersję z pobranego Instalatora. Rejestracja serwera, grupy synchronizacji i inne ustawienia są obsługiwane przez Instalatora usługi Azure File Sync.
