...
1. Po utworzeniu szablonu obrazu można utworzyć obraz. W konstruktorze obrazów w tle program używa szablonu i plików źródłowych do tworzenia maszyny wirtualnej (D1v2), sieci, publicznego adresu IP i magazynu w IT_\<DestinationResourceGroup > _\<templateName > grupę zasobów.
