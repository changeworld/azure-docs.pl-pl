...
ms.locfileid: "47048246"
---
Jeśli napotkasz problemy podczas wykonywania żadnych operacji na galerie obrazów udostępnionych, definicje obrazu i wersje obrazów należy ponownie uruchom polecenie niepowodzeniem w trybie debugowania. Tryb debugowania jest aktywowana przez przekazanie **— debugowania** przełączyć się z interfejsem wiersza polecenia i **-Debug** Przełącz przy użyciu programu PowerShell. Po zlokalizowaniu błąd, postępuj zgodnie z tym dokumentem, aby rozwiązać problemy z błędami.
...
| Tworzenie galerii w lub "region źródła"   | Replikacja rersion do lub "region docelowy" |
|----------------------------------------|-------------------------------------------|
