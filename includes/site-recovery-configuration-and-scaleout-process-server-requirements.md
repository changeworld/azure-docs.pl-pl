...
IIS | — Brak wstępnie istniejącej domyślnej witryny sieci Web. <br> — Żadna istniejąca witryna sieci Web lub aplikacja nasłuchu na porcie 443. <br>-Włącz [uwierzytelnianie anonimowe](https://technet.microsoft.com/library/cc731244(v=ws.10).aspx). <br> -Włącz ustawienie [FastCGI](https://technet.microsoft.com/library/cc753077(v=ws.10).aspx) .
| 
...
MySQL | Należy zainstalować MySQL. Można zainstalować go ręcznie lub Azure Site Recovery może go zainstalować. (Aby uzyskać więcej informacji, zobacz [Konfigurowanie ustawień](../articles/site-recovery/vmware-azure-deploy-configuration-server.md#configure-settings)).
...
--- | --- | --- | --- | ---
8 procesorów wirtualnych vCPU<br/><br/> 2 gniazda * 4 rdzenie \@ 2,5 GHz | 16 GB | 300 GB | 500 GB lub mniej | < 100 maszyn
12 procesorów wirtualnych vCPU<br/><br/> 2% SOCKS * 6 rdzeni \@ 2,5 GHz | 18 GB | 600 GB | 500 GB do 1 TB | 100 do 150 maszyn
16 procesorów wirtualnych vCPU<br/><br/> 2\. SOCKS * 8 rdzeni \@ 2,5 GHz | 32 GB | 1 TB | od 1 do 2 TB | 150 do 200 maszyn
